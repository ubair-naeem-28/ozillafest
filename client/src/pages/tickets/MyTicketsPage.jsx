...
const trustBadges = ['🔒 256-Bit SSL Secured', '🎟️ Verified QR Pass', '⭐ Official Festival Entry', '⚡ Instant Scan Ready']
      ...
      <section className="my-tickets-shell">
        ...
        <div className="ticket-wallet-dashboard">
          <article className="ticket-wallet-profile">
            ...
            <div>
              <p>Welcome Back,</p>
              <h2>{displayName}</h2>
              <div className="ticket-wallet-tags">
                <span>Verified Holder</span>
                <span>Official Pass Holder</span>
                <span>{tickets.length > 2 ? 'VIP Loyalty' : tickets.length > 0 ? 'Gold Member' : 'Festival Member'}</span>
              </div>
            </div>
          </article>
          ...
          <article className="ticket-wallet-countdown">
            ...
            <div className="wallet-countdown-row">
        ...
        {loading ? (
          <div className="ticket-wallet-loading">
            ...
            <h2>Loading Your Passes...</h2>
            <p>Fetching your verified QR tickets from the blockchain vault.</p>
          </div>
        ) : tickets.length === 0 ? (
          ...
          <div className="ticket-wallet-passes-section">
            <div className="ticket-wallet-section-heading">
              <p>OFFICIAL DIGITAL PASSES</p>
              <h2>Active Festival Tickets</h2>
            </div>
        ...
        <div className="ticket-wallet-extras">
          ...
          <article className="ticket-wallet-card">
            <p>Verification Journey</p>
            <div className="ticket-wallet-timeline">
              {timelineSteps.map((step, index) => (
                <span key={step} className={index < 4 ? 'is-active' : ''}>{step}</span>
              ))}
            </div>
          </article>
