...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function rp(i,e,t){const n=new Float32Array(Zn),r=new z(0,1,0);return new mn({name:"SphericalGaussianBlur",defines:{n:Zn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Xr(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Ho(){return new mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Xr(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Wo(){return new mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xr(),fragmentShader:`
	...
	`}class Wl extends fn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ol(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Qi(5,5,5),s=new mn({name:"CubemapFromEquirect",uniforms:Li(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Ot,blending:An});s.uniforms.tEquirect.value=t;const a=new rn(r,s),o=t.minFilter;return t.minFilter===Jn&&(t.minFilter=Pt),new ld(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,r);e.setRenderTarget(s)}}function sp(i){let e=new WeakMap,t=new WeakMap,n=null;function r(u,g=!1){return u==null?null:g?a(u):s(u)}function s(u){if(u&&u.isTexture){const g=u.mapping;if(g===Qr||g===es)if(e.has(u)){const M=e.get(u).texture;return o(M,u.mapping)}else{const M=u.image;if(M&&M.height>0){const b=new Wl(M.height);return b.fromEquirectangularTexture(i,u),e.set(u,b),u.addEventListener("dispose",c),o(b.texture,u.mapping)}else return null}}return u}function a(u){if(u&&u.isTexture){const g=u.mapping,M=g===Qr||g===es,b=g===ei||g===Ci;if(M||b){let m=t.get(u);const h=m!==void 0?m.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==h)return n===null&&(n=new ko(i)),m=M?n.fromEquirectangular(u,m):n.fromCubemap(u,m),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),m.texture;if(m!==void 0)return m.texture;{const R=u.image;return M&&R&&R.height>0||b&&R&&l(R)?(n===null&&(n=new ko(i)),m=M?n.fromEquirectangular(u):n.fromCubemap(u),m.texture.pmremVersion=u.pmremVersion,t.set(u,m),u.addEventListener("dispose",d),m.texture):null}}}return u}function o(u,g){return g===Qr?u.mapping=ei:g===es&&(u.mapping=Ci),u}function l(u){let g=0;const M=6;for(let b=0;b<M;b++)u[b]!==void 0&&g++;return g===M}function c(u){const g=u.target;g.removeEventListener("dispose",c);const M=e.get(g);M!==void 0&&(e.delete(g),M.dispose())}function d(u){const g=u.target;g.removeEventListener("dispose",d);const M=t.get(g);M!==void 0&&(t.delete(g),M.dispose())}function p(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:p}}function ap(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Ti("WebGLRenderer: "+n+" extension not supported."),r}}}function op(i,e,t,n){const r={},s=new WeakMap;function a(p){const u=p.target;u.index!==null&&e.remove(u.index);for(const M in u.attributes)e.remove(u.attributes[M]);u.removeEventListener("dispose",a),delete r[u.id];const g=s.get(u);g&&(e.remove(g),s.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function o(p,u){return r[u.id]===!0||(u.addEventListener("dispose",a),r[u.id]=!0,t.memory.geometries++),u}function l(p){const u=p.attributes;for(const g in u)e.update(u[g],i.ARRAY_BUFFER)}function c(p){const u=[],g=p.index,M=p.attributes.position;let b=0;if(M===void 0)return;if(g!==null){const R=g.array;b=g.version;for(let A=0,S=R.length;A<S;A+=3){const w=R[A+0],y=R[A+1],C=R[A+2];u.push(w,y,y,C,C,w)}}else{const R=M.array;b=M.version;for(let A=0,S=R.length/3-1;A<S;A+=3){const w=A+0,y=A+1,C=A+2;u.push(w,y,y,C,C,w)}}const m=new(M.count>=65535?Nl:Dl)(u,1);m.version=b;const h=s.get(p);h&&e.remove(h),s.set(p,m)}function d(p){const u=s.get(p);if(u){const g=p.index;g!==null&&u.version<g.version&&c(p)}else c(p);return s.get(p)}return{get:o,update:l,getWireframeAttribute:d}}function lp(i,e,t){let n;function r(p){n=p}let s,a;function o(p){s=p.type,a=p.bytesPerElement}function l(p,u){i.drawElements(n,u,s,p*a),t.update(u,n,1)}function c(p,u,g){g!==0&&(i.drawElementsInstanced(n,u,s,p*a,g),t.update(u,n,g))}function d(p,u,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,u,0,s,p,0,g);let b=0;for(let m=0;m<g;m++)b+=u[m];t.update(b,n,1)}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=d}function cp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:Qe("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function up(i,e,t){const n=new WeakMap,r=new ft;function s(a,o,l){const c=a.morphTargetInfluences,d=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,p=d!==void 0?d.length:0;let u=n.get(o);if(u===void 0||u.count!==p){let T=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",T)};u!==void 0&&u.texture.dispose();const g=o.morphAttributes.position!==void 0,M=o.morphAttributes.normal!==void 0,b=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],h=o.morphAttributes.normal||[],R=o.morphAttributes.color||[];let A=0;g===!0&&(A=1),M===!0&&(A=2),b===!0&&(A=3);let S=o.attributes.position.count*A,w=1;S>e.maxTextureSize&&(w=Math.ceil(S/e.maxTextureSize),S=e.maxTextureSize);const y=new Float32Array(S*w*4*p),C=new Pl(y,S,w,p);C.type=en,C.needsUpdate=!0;const _=A*4;for(let I=0;I<p;I++){const D=m[I],B=h[I],Z=R[I],j=S*w*4*I;for(let V=0;V<D.count;V++){const Y=V*_;g===!0&&(r.fromBufferAttribute(D,V),y[j+Y+0]=r.x,y[j+Y+1]=r.y,y[j+Y+2]=r.z,y[j+Y+3]=0),M===!0&&(r.fromBufferAttribute(B,V),y[j+Y+4]=r.x,y[j+Y+5]=r.y,y[j+Y+6]=r.z,y[j+Y+7]=0),b===!0&&(r.fromBufferAttribute(Z,V),y[j+Y+8]=r.x,y[j+Y+9]=r.y,y[j+Y+10]=r.z,y[j+Y+11]=Z.itemSize===4?r.w:1)}}u={count:p,texture:C,size:new Ke(S,w)},n.set(o,u),o.addEventListener("dispose",T)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let g=0;for(let b=0;b<c.length;b++)g+=c[b];const M=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",M),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",u.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",u.size)}return{update:s}}function dp(i,e,t,n,r){let s=new WeakMap;function a(c){const d=r.render.frame,p=c.geometry,u=e.get(c,p);if(s.get(u)!==d&&(e.update(u),s.set(u,d)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==d&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,d))),c.isSkinnedMesh){const g=c.skeleton;s.get(g)!==d&&(g.update(),s.set(g,d))}return u}function o(){s=new WeakMap}function l(c){const d=c.target;d.removeEventListener("dispose",l),n.releaseStatesOfObject(d),t.remove(d.instanceMatrix),d.instanceColor!==null&&t.remove(d.instanceColor)}return{update:a,dispose:o}}const hp={[ml]:"LINEAR_TONE_MAPPING",[gl]:"REINHARD_TONE_MAPPING",[_l]:"CINEON_TONE_MAPPING",[xl]:"ACES_FILMIC_TONE_MAPPING",[Ml]:"AGX_TONE_MAPPING",[Sl]:"NEUTRAL_TONE_MAPPING",[vl]:"CUSTOM_TONE_MAPPING"};function fp(i,e,t,n,r,s){const a=new fn(e,t,{type:i,depthBuffer:r,stencilBuffer:s,samples:n?4:0,depthTexture:r?new Pi(e,t):void 0}),o=new fn(e,t,{type:wn,depthBuffer:!1,stencilBuffer:!1}),l=new gn;l.setAttribute("position",new jt([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new jt([0,2,0,0,2,0],2));const c=new sd({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),d=new rn(l,c),p=new kl(-1,1,1,-1,0,1);let u=null,g=null,M=!1,b,m=null,h=[],R=!1;this.setSize=function(A,S){a.setSize(A,S),o.setSize(A,S);for(let w=0;w<h.length;w++){const y=h[w];y.setSize&&y.setSize(A,S)}},this.setEffects=function(A){h=A,R=h.length>0&&h[0].isRenderPass===!0;const S=a.width,w=a.height;for(let y=0;y<h.length;y++){const C=h[y];C.setSize&&C.setSize(S,w)}},this.begin=function(A,S){if(M||A.toneMapping===hn&&h.length===0)return!1;if(m=S,S!==null){const w=S.width,y=S.height;(a.width!==w||a.height!==y)&&this.setSize(w,y)}return R===!1&&A.setRenderTarget(a),b=A.toneMapping,A.toneMapping=hn,!0},this.hasRenderPass=function(){return R},this.end=function(A,S){A.toneMapping=b,M=!0;let w=a,y=o;for(let C=0;C<h.length;C++){const _=h[C];if(_.enabled!==!1&&(_.render(A,y,w,S),_.needsSwap!==!1)){const T=w;w=y,y=T}}if(u!==A.outputColorSpace||g!==A.toneMapping){u=A.outputColorSpace,g=A.toneMapping,c.defines={},je.getTransfer(u)===it&&(c.defines.SRGB_TRANSFER="");const C=hp[g];C&&(c.defines[C]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=w.texture,A.setRenderTarget(m),A.render(d,p),m=null,M=!1},this.isCompositing=function(){return M},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),l.dispose(),c.dispose()}}const Xl=new Dt,Ea=new Pi(1,1),ql=new Pl,Yl=new Nu,jl=new Ol,Xo=[],qo=[],Yo=new Float32Array(16),jo=new Float32Array(9),$o=new Float32Array(4);function Di(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Xo[r];if(s===void 0&&(s=new Float32Array(r),Xo[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function vt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Mt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function qr(i,e){let t=qo[e];t===void 0&&(t=new Int32Array(e),qo[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function pp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function mp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2fv(this.addr,e),Mt(t,e)}}function gp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(vt(t,e))return;i.uniform3fv(this.addr,e),Mt(t,e)}}function _p(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4fv(this.addr,e),Mt(t,e)}}function xp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Mt(t,e)}else{if(vt(t,n))return;$o.set(n),i.uniformMatrix2fv(this.addr,!1,$o),Mt(t,n)}}function vp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Mt(t,e)}else{if(vt(t,n))return;jo.set(n),i.uniformMatrix3fv(this.addr,!1,jo),Mt(t,n)}}function Mp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Mt(t,e)}else{if(vt(t,n))return;Yo.set(n),i.uniformMatrix4fv(this.addr,!1,Yo),Mt(t,n)}}function Sp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Ep(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2iv(this.addr,e),Mt(t,e)}}function bp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(vt(t,e))return;i.uniform3iv(this.addr,e),Mt(t,e)}}function yp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4iv(this.addr,e),Mt(t,e)}}function Tp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Ap(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2uiv(this.addr,e),Mt(t,e)}}function Rp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(vt(t,e))return;i.uniform3uiv(this.addr,e),Mt(t,e)}}function wp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4uiv(this.addr,e),Mt(t,e)}}function Cp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(Ea.compareFunction=t.isReversedDepthBuffer()?Ua:Na,s=Ea):s=Xl,t.setTexture2D(e||s,r)}function Pp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Yl,r)}function Lp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||jl,r)}function Ip(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||ql,r)}function Dp(i){switch(i){case 5126:return pp;case 35664:return mp;case 35665:return gp;case 35666:return _p;case 35674:return xp;case 35675:return vp;case 35676:return Mp;case 5124:case 35670:return Sp;case 35667:case 35671:return Ep;case 35668:case 35672:return bp;case 35669:case 35673:return yp;case 5125:return Tp;case 36294:return Ap;case 36295:return Rp;case 36296:return wp;case 35678:case 36198:case 36298:case 36306:case 35682:return Cp;case 35679:case 36299:case 36307:return Pp;case 35680:case 36300:case 36308:case 36293:return Lp;case 36289:case 36303:case 36311:case 36292:return Ip}}function Np(i,e){i.uniform1fv(this.addr,e)}function Up(i,e){const t=Di(e,this.size,2);i.uniform2fv(this.addr,t)}function Fp(i,e){const t=Di(e,this.size,3);i.uniform3fv(this.addr,t)}function Op(i,e){const t=Di(e,this.size,4);i.uniform4fv(this.addr,t)}function Bp(i,e){const t=Di(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function zp(i,e){const t=Di(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Vp(i,e){const t=Di(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function kp(i,e){i.uniform1iv(this.addr,e)}function Gp(i,e){i.uniform2iv(this.addr,e)}function Hp(i,e){i.uniform3iv(this.addr,e)}function Wp(i,e){i.uniform4iv(this.addr,e)}function Xp(i,e){i.uniform1uiv(this.addr,e)}function qp(i,e){i.uniform2uiv(this.addr,e)}function Yp(i,e){i.uniform3uiv(this.addr,e)}function jp(i,e){i.uniform4uiv(this.addr,e)}function $p(i,e,t){const n=this.cache,r=e.length,s=qr(t,r);vt(n,s)||(i.uniform1iv(this.addr,s),Mt(n,s));let a;this.type===i.SAMPLER_2D_SHADOW?a=Ea:a=Xl;for(let o=0;o!==r;++o)t.setTexture2D(e[o]||a,s[o])}function Kp(i,e,t){const n=this.cache,r=e.length,s=qr(t,r);vt(n,s)||(i.uniform1iv(this.addr,s),Mt(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Yl,s[a])}function Zp(i,e,t){const n=this.cache,r=e.length,s=qr(t,r);vt(n,s)||(i.uniform1iv(this.addr,s),Mt(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||jl,s[a])}function Jp(i,e,t){const n=this.cache,r=e.length,s=qr(t,r);vt(n,s)||(i.uniform1iv(this.addr,s),Mt(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||ql,s[a])}function Qp(i){switch(i){case 5126:return Np;case 35664:return Up;case 35665:return Fp;case 35666:return Op;case 35674:return Bp;case 35675:return zp;case 35676:return Vp;case 5124:case 35670:return kp;case 35667:case 35671:return Gp;case 35668:case 35672:return Hp;case 35669:case 35673:return Wp;case 5125:return Xp;case 36294:return qp;case 36295:return Yp;case 36296:return jp;case 35678:case 36198:case 36298:case 36306:case 35682:return $p;case 35679:case 36299:case 36307:return Kp;case 35680:case 36300:case 36308:case 36293:return Zp;case 36289:case 36303:case 36311:case 36292:return Jp}}class em{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Dp(t.type)}}class tm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Qp(t.type)}}class nm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const Ps=/(\w+)(\])?(\[|\.)?/g;function Ko(i,e){i.seq.push(e),i.map[e.id]=e}function im(i,e,t){const n=i.name,r=n.length;for(Ps.lastIndex=0;;){const s=Ps.exec(n),a=Ps.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){Ko(t,c===void 0?new em(o,i,e):new tm(o,i,e));break}else{let p=t.map[o];p===void 0&&(p=new nm(o),Ko(t,p)),t=p}}}class Nr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);im(o,l,this)}const r=[],s=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(a):s.push(a);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function Zo(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const rm=37297;let sm=0;function am(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Jo=new Be;function om(i){je._getMatrix(Jo,je.workingColorSpace,i);const e=`mat3( ${Jo.elements.map(t=>t.toFixed(4))} )`;switch(je.getTransfer(i)){case Br:return[e,"LinearTransferOETF"];case it:return[e,"sRGBTransferOETF"];default:return Fe("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Qo(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=(i.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`
...
`)}const cm={[ml]:"Linear",[gl]:"Reinhard",[_l]:"Cineon",[xl]:"ACESFilmic",[Ml]:"AgX",[Sl]:"Neutral",[vl]:"Custom"};function um(i,e){const t=cm[e];return t===void 0?(Fe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const wr=new z;function dm(){je.getLuminanceCoefficients(wr);const i=wr.x.toFixed(4),e=wr.y.toFixed(4),t=wr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const Mm={[Cr]:"SHADOWMAP_TYPE_PCF",[Wi]:"SHADOWMAP_TYPE_VSM"};function Sm(i){return Mm[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Em={[ei]:"ENVMAP_TYPE_CUBE",[Ci]:"ENVMAP_TYPE_CUBE",[Gr]:"ENVMAP_TYPE_CUBE_UV"};function bm(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Em[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const ym={[Ci]:"ENVMAP_MODE_REFRACTION"};function Tm(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":ym[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Am={[pl]:"ENVMAP_BLENDING_MULTIPLY",[hu]:"ENVMAP_BLENDING_MIX",[fu]:"ENVMAP_BLENDING_ADD"};function Rm(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Am[i.combine]||"ENVMAP_BLENDING_NONE"}function wm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Cm(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Sm(t),c=bm(t),d=Tm(t),p=Rm(t),u=wm(t),g=hm(t),M=fm(s),b=r.createProgram();let m,h,R=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+h);const A=R+m+a,S=R+h+o,w=Zo(r,r.VERTEX_SHADER,A),y=Zo(r,r.FRAGMENT_SHADER,S);r.attachShader(b,w),r.attachShader(b,y),t.index0AttributeName!==void 0?r.bindAttribLocation(b,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function C(D){if(i.debug.checkShaderErrors){const B=r.getProgramInfoLog(b)||"",Z=r.getShaderInfoLog(w)||"",j=r.getShaderInfoLog(y)||"",V=B.trim(),Y=Z.trim(),W=j.trim();let Q=!0,te=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if(Q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,b,w,y);else{const de=Qo(r,w,"vertex"),he=Qo(r,y,"fragment");Qe("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
...
}`;class eg{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Bl(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new mn({vertexShader:Jm,fragmentShader:Qm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new rn(new Wr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class tg extends ii{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,d=null,p=null,u=null,g=null,M=null;const b=typeof XRWebGLBinding<"u",m=new eg,h={},R=t.getContextAttributes();let A=null,S=null;const w=[],y=[],C=new Ke;let _=null;const T=new qt;T.viewport=new ft;const I=new qt;I.viewport=new ft;const D=[T,I],B=new cd;let Z=null,j=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(F){let ie=w[F];return ie===void 0&&(ie=new cs,w[F]=ie),ie.getTargetRaySpace()},this.getControllerGrip=function(F){let ie=w[F];return ie===void 0&&(ie=new cs,w[F]=ie),ie.getGripSpace()},this.getHand=function(F){let ie=w[F];return ie===void 0&&(ie=new cs,w[F]=ie),ie.getHandSpace()};function V(F){const ie=y.indexOf(F.inputSource);if(ie===-1)return;const ee=w[ie];ee!==void 0&&(ee.update(F.inputSource,F.frame,c||a),ee.dispatchEvent({type:F.type,data:F.inputSource}))}function Y(){r.removeEventListener("select",V),r.removeEventListener("selectstart",V),r.removeEventListener("selectend",V),r.removeEventListener("squeeze",V),r.removeEventListener("squeezestart",V),r.removeEventListener("squeezeend",V),r.removeEventListener("end",Y),r.removeEventListener("inputsourceschange",W);for(let F=0;F<w.length;F++){const ie=y[F];ie!==null&&(y[F]=null,w[F].disconnect(ie))}Z=null,j=null,m.reset();for(const F in h)delete h[F];e.setRenderTarget(A),g=null,u=null,p=null,r=null,S=null,ge.stop(),n.isPresenting=!1,e.setPixelRatio(_),e.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(F){s=F,n.isPresenting===!0&&Fe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(F){o=F,n.isPresenting===!0&&Fe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(F){c=F},this.getBaseLayer=function(){return u!==null?u:g},this.getBinding=function(){return p===null&&b&&(p=new XRWebGLBinding(r,t)),p},this.getFrame=function(){return M},this.getSession=function(){return r},this.setSession=async function(F){if(r=F,r!==null){if(A=e.getRenderTarget(),r.addEventListener("select",V),r.addEventListener("selectstart",V),r.addEventListener("selectend",V),r.addEventListener("squeeze",V),r.addEventListener("squeezestart",V),r.addEventListener("squeezeend",V),r.addEventListener("end",Y),r.addEventListener("inputsourceschange",W),R.xrCompatible!==!0&&await t.makeXRCompatible(),_=e.getPixelRatio(),e.getSize(C),b&&"createProjectionLayer"in XRWebGLBinding.prototype){let ee=null,ye=null,Ce=null;R.depth&&(Ce=R.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ee=R.stencil?Qn:Cn,ye=R.stencil?ji:pn);const Te={colorFormat:t.RGBA8,depthFormat:Ce,scaleFactor:s};p=this.getBinding(),u=p.createProjectionLayer(Te),r.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),S=new fn(u.textureWidth,u.textureHeight,{format:tn,type:Yt,depthTexture:new Pi(u.textureWidth,u.textureHeight,ye,void 0,void 0,void 0,void 0,void 0,void 0,ee),stencilBuffer:R.stencil,colorSpace:e.outputColorSpace,samples:R.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{const ee={antialias:R.antialias,alpha:!0,depth:R.depth,stencil:R.stencil,framebufferScaleFactor:s};g=new XRWebGLLayer(r,t,ee),r.updateRenderState({baseLayer:g}),e.setPixelRatio(1),e.setSize(g.framebufferWidth,g.framebufferHeight,!1),S=new fn(g.framebufferWidth,g.framebufferHeight,{format:tn,type:Yt,colorSpace:e.outputColorSpace,stencilBuffer:R.stencil,resolveDepthBuffer:g.ignoreDepthValues===!1,resolveStencilBuffer:g.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),ge.setContext(r),ge.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function W(F){for(let ie=0;ie<F.removed.length;ie++){const ee=F.removed[ie],ye=y.indexOf(ee);ye>=0&&(y[ye]=null,w[ye].disconnect(ee))}for(let ie=0;ie<F.added.length;ie++){const ee=F.added[ie];let ye=y.indexOf(ee);if(ye===-1){for(let Te=0;Te<w.length;Te++)if(Te>=y.length){y.push(ee),ye=Te;break}else if(y[Te]===null){y[Te]=ee,ye=Te;break}if(ye===-1)break}const Ce=w[ye];Ce&&Ce.connect(ee)}}const Q=new z,te=new z;function de(F,ie,ee){Q.setFromMatrixPosition(ie.matrixWorld),te.setFromMatrixPosition(ee.matrixWorld);const ye=Q.distanceTo(te),Ce=ie.projectionMatrix.elements,Te=ee.projectionMatrix.elements,Ze=Ce[14]/(Ce[10]-1),Ie=Ce[14]/(Ce[10]+1),ze=(Ce[9]+1)/Ce[5],Oe=(Ce[9]-1)/Ce[5],qe=(Ce[8]-1)/Ce[0],ct=(Te[8]+1)/Te[0],dt=Ze*qe,gt=Ze*ct,xt=ye/(-qe+ct),Ne=xt*-qe;if(ie.matrixWorld.decompose(F.position,F.quaternion,F.scale),F.translateX(Ne),F.translateZ(xt),F.matrixWorld.compose(F.position,F.quaternion,F.scale),F.matrixWorldInverse.copy(F.matrixWorld).invert(),Ce[10]===-1)F.projectionMatrix.copy(ie.projectionMatrix),F.projectionMatrixInverse.copy(ie.projectionMatrixInverse);else{const Ue=Ze+xt,P=Ie+xt,Ve=dt-Ne,we=gt+(ye-Ne),E=ze*Ie/P*Ue,f=Oe*Ie/P*Ue;F.projectionMatrix.makePerspective(Ve,we,E,f,Ue,P),F.projectionMatrixInverse.copy(F.projectionMatrix).invert()}}function he(F,ie){ie===null?F.matrixWorld.copy(F.matrix):F.matrixWorld.multiplyMatrices(ie.matrixWorld,F.matrix),F.matrixWorldInverse.copy(F.matrixWorld).invert()}this.updateCamera=function(F){if(r===null)return;let ie=F.near,ee=F.far;m.texture!==null&&(m.depthNear>0&&(ie=m.depthNear),m.depthFar>0&&(ee=m.depthFar)),B.near=I.near=T.near=ie,B.far=I.far=T.far=ee,(Z!==B.near||j!==B.far)&&(r.updateRenderState({depthNear:B.near,depthFar:B.far}),Z=B.near,j=B.far),B.layers.mask=F.layers.mask|6,T.layers.mask=B.layers.mask&-5,I.layers.mask=B.layers.mask&-3;const ye=F.parent,Ce=B.cameras;he(B,ye);for(let Te=0;Te<Ce.length;Te++)he(Ce[Te],ye);Ce.length===2?de(B,T,I):B.projectionMatrix.copy(T.projectionMatrix),xe(F,B,ye)};function xe(F,ie,ee){ee===null?F.matrix.copy(ie.matrixWorld):(F.matrix.copy(ee.matrixWorld),F.matrix.invert(),F.matrix.multiply(ie.matrixWorld)),F.matrix.decompose(F.position,F.quaternion,F.scale),F.updateMatrixWorld(!0),F.projectionMatrix.copy(ie.projectionMatrix),F.projectionMatrixInverse.copy(ie.projectionMatrixInverse),F.isPerspectiveCamera&&(F.fov=Sa*2*Math.atan(1/F.projectionMatrix.elements[5]),F.zoom=1)}this.getCamera=function(){return B},this.getFoveation=function(){if(!(u===null&&g===null))return l},this.setFoveation=function(F){l=F,u!==null&&(u.fixedFoveation=F),g!==null&&g.fixedFoveation!==void 0&&(g.fixedFoveation=F)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(B)},this.getCameraTexture=function(F){return h[F]};let We=null;function nt(F,ie){if(d=ie.getViewerPose(c||a),M=ie,d!==null){const ee=d.views;g!==null&&(e.setRenderTargetFramebuffer(S,g.framebuffer),e.setRenderTarget(S));let ye=!1;ee.length!==B.cameras.length&&(B.cameras.length=0,ye=!0);for(let Ie=0;Ie<ee.length;Ie++){const ze=ee[Ie];let Oe=null;if(g!==null)Oe=g.getViewport(ze);else{const ct=p.getViewSubImage(u,ze);Oe=ct.viewport,Ie===0&&(e.setRenderTargetTextures(S,ct.colorTexture,ct.depthStencilTexture),e.setRenderTarget(S))}let qe=D[Ie];qe===void 0&&(qe=new qt,qe.layers.enable(Ie),qe.viewport=new ft,D[Ie]=qe),qe.matrix.fromArray(ze.transform.matrix),qe.matrix.decompose(qe.position,qe.quaternion,qe.scale),qe.projectionMatrix.fromArray(ze.projectionMatrix),qe.projectionMatrixInverse.copy(qe.projectionMatrix).invert(),qe.viewport.set(Oe.x,Oe.y,Oe.width,Oe.height),Ie===0&&(B.matrix.copy(qe.matrix),B.matrix.decompose(B.position,B.quaternion,B.scale)),ye===!0&&B.cameras.push(qe)}const Ce=r.enabledFeatures;if(Ce&&Ce.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&b){p=n.getBinding();const Ie=p.getDepthInformation(ee[0]);Ie&&Ie.isValid&&Ie.texture&&m.init(Ie,r.renderState)}if(Ce&&Ce.includes("camera-access")&&b){e.state.unbindTexture(),p=n.getBinding();for(let Ie=0;Ie<ee.length;Ie++){const ze=ee[Ie].camera;if(ze){let Oe=h[ze];Oe||(Oe=new Bl,h[ze]=Oe);const qe=p.getCameraImage(ze);Oe.sourceTexture=qe}}}}for(let ee=0;ee<w.length;ee++){const ye=y[ee],Ce=w[ee];ye!==null&&Ce!==void 0&&Ce.update(ye,ie,c||a)}We&&We(F,ie),ie.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ie}),M=null}const ge=new Gl;ge.setAnimationLoop(nt),this.setAnimationLoop=function(F){We=F},this.dispose=function(){}}}const ng=new ut,$l=new Be;$l.set(-1,0,0,0,1,0,0,0,1);function ig(i,e){function t(m,h){m.matrixAutoUpdate===!0&&m.updateMatrix(),h.value.copy(m.matrix)}function n(m,h){h.color.getRGB(m.fogColor.value,zl(i)),h.isFog?(m.fogNear.value=h.near,m.fogFar.value=h.far):h.isFogExp2&&(m.fogDensity.value=h.density)}function r(m,h,R,A,S){h.isNodeMaterial?h.uniformsNeedUpdate=!1:h.isMeshBasicMaterial?s(m,h):h.isMeshLambertMaterial?(s(m,h),h.envMap&&(m.envMapIntensity.value=h.envMapIntensity)):h.isMeshToonMaterial?(s(m,h),p(m,h)):h.isMeshPhongMaterial?(s(m,h),d(m,h),h.envMap&&(m.envMapIntensity.value=h.envMapIntensity)):h.isMeshStandardMaterial?(s(m,h),u(m,h),h.isMeshPhysicalMaterial&&g(m,h,S)):h.isMeshMatcapMaterial?(s(m,h),M(m,h)):h.isMeshDepthMaterial?s(m,h):h.isMeshDistanceMaterial?(s(m,h),b(m,h)):h.isMeshNormalMaterial?s(m,h):h.isLineBasicMaterial?(a(m,h),h.isLineDashedMaterial&&o(m,h)):h.isPointsMaterial?l(m,h,R,A):h.isSpriteMaterial?c(m,h):h.isShadowMaterial?(m.color.value.copy(h.color),m.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(m,h){m.opacity.value=h.opacity,h.color&&m.diffuse.value.copy(h.color),h.emissive&&m.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(m.map.value=h.map,t(h.map,m.mapTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.bumpMap&&(m.bumpMap.value=h.bumpMap,t(h.bumpMap,m.bumpMapTransform),m.bumpScale.value=h.bumpScale,h.side===Ot&&(m.bumpScale.value*=-1)),h.normalMap&&(m.normalMap.value=h.normalMap,t(h.normalMap,m.normalMapTransform),m.normalScale.value.copy(h.normalScale),h.side===Ot&&m.normalScale.value.negate()),h.displacementMap&&(m.displacementMap.value=h.displacementMap,t(h.displacementMap,m.displacementMapTransform),m.displacementScale.value=h.displacementScale,m.displacementBias.value=h.displacementBias),h.emissiveMap&&(m.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,m.emissiveMapTransform)),h.specularMap&&(m.specularMap.value=h.specularMap,t(h.specularMap,m.specularMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest);const R=e.get(h),A=R.envMap,S=R.envMapRotation;A&&(m.envMap.value=A,m.envMapRotation.value.setFromMatrix4(ng.makeRotationFromEuler(S)).transpose(),A.isCubeTexture&&A.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply($l),m.reflectivity.value=h.reflectivity,m.ior.value=h.ior,m.refractionRatio.value=h.refractionRatio),h.lightMap&&(m.lightMap.value=h.lightMap,m.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,m.lightMapTransform)),h.aoMap&&(m.aoMap.value=h.aoMap,m.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,m.aoMapTransform))}function a(m,h){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,h.map&&(m.map.value=h.map,t(h.map,m.mapTransform))}function o(m,h){m.dashSize.value=h.dashSize,m.totalSize.value=h.dashSize+h.gapSize,m.scale.value=h.scale}function l(m,h,R,A){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,m.size.value=h.size*R,m.scale.value=A*.5,h.map&&(m.map.value=h.map,t(h.map,m.uvTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest)}function c(m,h){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,m.rotation.value=h.rotation,h.map&&(m.map.value=h.map,t(h.map,m.mapTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest)}function d(m,h){m.specular.value.copy(h.specular),m.shininess.value=Math.max(h.shininess,1e-4)}function p(m,h){h.gradientMap&&(m.gradientMap.value=h.gradientMap)}function u(m,h){m.metalness.value=h.metalness,h.metalnessMap&&(m.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,m.metalnessMapTransform)),m.roughness.value=h.roughness,h.roughnessMap&&(m.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,m.roughnessMapTransform)),h.envMap&&(m.envMapIntensity.value=h.envMapIntensity)}function g(m,h,R){m.ior.value=h.ior,h.sheen>0&&(m.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),m.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(m.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,m.sheenColorMapTransform)),h.sheenRoughnessMap&&(m.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,m.sheenRoughnessMapTransform))),h.clearcoat>0&&(m.clearcoat.value=h.clearcoat,m.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(m.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,m.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(m.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Ot&&m.clearcoatNormalScale.value.negate())),h.dispersion>0&&(m.dispersion.value=h.dispersion),h.iridescence>0&&(m.iridescence.value=h.iridescence,m.iridescenceIOR.value=h.iridescenceIOR,m.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(m.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,m.iridescenceMapTransform)),h.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),h.transmission>0&&(m.transmission.value=h.transmission,m.transmissionSamplerMap.value=R.texture,m.transmissionSamplerSize.value.set(R.width,R.height),h.transmissionMap&&(m.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,m.transmissionMapTransform)),m.thickness.value=h.thickness,h.thicknessMap&&(m.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=h.attenuationDistance,m.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(m.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(m.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=h.specularIntensity,m.specularColor.value.copy(h.specularColor),h.specularColorMap&&(m.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,m.specularColorMapTransform)),h.specularIntensityMap&&(m.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,m.specularIntensityMapTransform))}function M(m,h){h.matcap&&(m.matcap.value=h.matcap)}function b(m,h){const R=e.get(h).light;m.referencePosition.value.setFromMatrixPosition(R.matrixWorld),m.nearDistance.value=R.shadow.camera.near,m.farDistance.value=R.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function rg(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(S,w){const y=w.program;n.uniformBlockBinding(S,y)}function c(S,w){let y=r[S.id];y===void 0&&(m(S),y=d(S),r[S.id]=y,S.addEventListener("dispose",R));const C=w.program;n.updateUBOMapping(S,C);const _=e.render.frame;s[S.id]!==_&&(u(S),s[S.id]=_)}function d(S){const w=p();S.__bindingPointIndex=w;const y=i.createBuffer(),C=S.__size,_=S.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,C,_),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,w,y),y}function p(){for(let S=0;S<o;S++)if(a.indexOf(S)===-1)return a.push(S),S;return Qe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(S){const w=r[S.id],y=S.uniforms,C=S.__cache;i.bindBuffer(i.UNIFORM_BUFFER,w);for(let _=0,T=y.length;_<T;_++){const I=y[_];if(Array.isArray(I))for(let D=0,B=I.length;D<B;D++)g(I[D],_,D,C);else g(I,_,0,C)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function g(S,w,y,C){if(b(S,w,y,C)===!0){const _=S.__offset,T=S.value;if(Array.isArray(T)){let I=0;for(let D=0;D<T.length;D++){const B=T[D],Z=h(B);M(B,S.__data,I),typeof B!="number"&&typeof B!="boolean"&&!B.isMatrix3&&!ArrayBuffer.isView(B)&&(I+=Z.storage/Float32Array.BYTES_PER_ELEMENT)}}else M(T,S.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,_,S.__data)}}function M(S,w,y){typeof S=="number"||typeof S=="boolean"?w[0]=S:S.isMatrix3?(w[0]=S.elements[0],w[1]=S.elements[1],w[2]=S.elements[2],w[3]=0,w[4]=S.elements[3],w[5]=S.elements[4],w[6]=S.elements[5],w[7]=0,w[8]=S.elements[6],w[9]=S.elements[7],w[10]=S.elements[8],w[11]=0):ArrayBuffer.isView(S)?w.set(new S.constructor(S.buffer,S.byteOffset,w.length)):S.toArray(w,y)}function b(S,w,y,C){const _=S.value,T=w+"_"+y;if(C[T]===void 0)return typeof _=="number"||typeof _=="boolean"?C[T]=_:ArrayBuffer.isView(_)?C[T]=_.slice():C[T]=_.clone(),!0;{const I=C[T];if(typeof _=="number"||typeof _=="boolean"){if(I!==_)return C[T]=_,!0}else{if(ArrayBuffer.isView(_))return!0;if(I.equals(_)===!1)return I.copy(_),!0}}return!1}function m(S){const w=S.uniforms;let y=0;const C=16;for(let T=0,I=w.length;T<I;T++){const D=Array.isArray(w[T])?w[T]:[w[T]];for(let B=0,Z=D.length;B<Z;B++){const j=D[B],V=Array.isArray(j.value)?j.value:[j.value];for(let Y=0,W=V.length;Y<W;Y++){const Q=V[Y],te=h(Q),de=y%C,he=de%te.boundary,xe=de+he;y+=he,xe!==0&&C-xe<te.storage&&(y+=C-xe),j.__data=new Float32Array(te.storage/Float32Array.BYTES_PER_ELEMENT),j.__offset=y,y+=te.storage}}}const _=y%C;return _>0&&(y+=C-_),S.__size=y,S.__cache={},this}function h(S){const w={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(w.boundary=4,w.storage=4):S.isVector2?(w.boundary=8,w.storage=8):S.isVector3||S.isColor?(w.boundary=16,w.storage=12):S.isVector4?(w.boundary=16,w.storage=16):S.isMatrix3?(w.boundary=48,w.storage=48):S.isMatrix4?(w.boundary=64,w.storage=64):S.isTexture?Fe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(S)?(w.boundary=16,w.storage=S.byteLength):Fe("WebGLRenderer: Unsupported uniform value type.",S),w}function R(S){const w=S.target;w.removeEventListener("dispose",R);const y=a.indexOf(w.__bindingPointIndex);a.splice(y,1),i.deleteBuffer(r[w.id]),delete r[w.id],delete s[w.id]}function A(){for(const S in r)i.deleteBuffer(r[S]);a=[],r={},s={}}return{bind:l,update:c,dispose:A}}const sg=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let ln=null;function ag(){return ln===null&&(ln=new Ul(sg,16,16,ti,wn),ln.name="DFG_LUT",ln.minFilter=Pt,ln.magFilter=Pt,ln.wrapS=Tn,ln.wrapT=Tn,ln.generateMipmaps=!1,ln.needsUpdate=!0),ln}class og{constructor(e={}){const{canvas:t=Tu(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:g=Yt}=e;this.isWebGLRenderer=!0;let M;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");M=n.getContextAttributes().alpha}else M=a;const b=g,m=new Set([Da,Ia,La]),h=new Set([Yt,pn,Yi,ji,wa,Ca]),R=new Uint32Array(4),A=new Int32Array(4),S=new z;let w=null,y=null;const C=[],_=[];let T=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=hn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const I=this;let D=!1,B=null,Z=null,j=null,V=null;this._outputColorSpace=Xt;let Y=0,W=0,Q=null,te=-1,de=null;const he=new ft,xe=new ft;let We=null;const nt=new tt(0);let ge=0,F=t.width,ie=t.height,ee=1,ye=null,Ce=null;const Te=new ft(0,0,F,ie),Ze=new ft(0,0,F,ie);let Ie=!1;const ze=new Fl;let Oe=!1,qe=!1;const ct=new ut,dt=new z,gt=new ft,xt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ne=!1;function Ue(){return Q===null?ee:1}let P=n;function Ve(x,U){return t.getContext(x,U)}try{const x={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Aa}`),t.addEventListener("webglcontextlost",rt,!1),t.addEventListener("webglcontextrestored",et,!1),t.addEventListener("webglcontextcreationerror",Ut,!1),P===null){const U="webgl2";if(P=Ve(U,x),P===null)throw Ve(U)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(x){throw Qe("WebGLRenderer: "+x.message),x}let we,E,f,N,O,X,ne,le,q,K,re,_e,ae,oe,be,Ae,De,L,ce,$,se,ue,J;function Me(){we=new ap(P),we.init(),se=new Zm(P,we),E=new Jf(P,we,e,se),f=new $m(P,we),E.reversedDepthBuffer&&u&&f.buffers.depth.setReversed(!0),Z=P.createFramebuffer(),j=P.createFramebuffer(),V=P.createFramebuffer(),N=new cp(P),O=new Um,X=new Km(P,we,f,O,E,se,N),ne=new sp(I),le=new hd(P),ue=new Kf(P,le),q=new op(P,le,N,ue),K=new dp(P,q,le,ue,N),L=new up(P,E,X),be=new Qf(O),re=new Nm(I,ne,we,E,ue,be),_e=new ig(I,O),ae=new Om,oe=new Hm(we),De=new $f(I,ne,f,K,M,l),Ae=new jm(I,K,E),J=new rg(P,N,E,f),ce=new Zf(P,we,N),$=new lp(P,we,N),N.programs=re.programs,I.capabilities=E,I.extensions=we,I.properties=O,I.renderLists=ae,I.shadowMap=Ae,I.state=f,I.info=N}Me(),b!==Yt&&(T=new fp(b,t.width,t.height,o,r,s));const ve=new tg(I,P);this.xr=ve,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){const x=we.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){const x=we.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return ee},this.setPixelRatio=function(x){x!==void 0&&(ee=x,this.setSize(F,ie,!1))},this.getSize=function(x){return x.set(F,ie)},this.setSize=function(x,U,H=!0){if(ve.isPresenting){Fe("WebGLRenderer: Can't change size while VR device is presenting.");return}F=x,ie=U,t.width=Math.floor(x*ee),t.height=Math.floor(U*ee),H===!0&&(t.style.width=x+"px",t.style.height=U+"px"),T!==null&&T.setSize(t.width,t.height),this.setViewport(0,0,x,U)},this.getDrawingBufferSize=function(x){return x.set(F*ee,ie*ee).floor()},this.setDrawingBufferSize=function(x,U,H){F=x,ie=U,ee=H,t.width=Math.floor(x*H),t.height=Math.floor(U*H),this.setViewport(0,0,x,U)},this.setEffects=function(x){if(b===Yt){Qe("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(x){for(let U=0;U<x.length;U++)if(x[U].isOutputPass===!0){Fe("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}T.setEffects(x||[])},this.getCurrentViewport=function(x){return x.copy(he)},this.getViewport=function(x){return x.copy(Te)},this.setViewport=function(x,U,H,k){x.isVector4?Te.set(x.x,x.y,x.z,x.w):Te.set(x,U,H,k),f.viewport(he.copy(Te).multiplyScalar(ee).round())},this.getScissor=function(x){return x.copy(Ze)},this.setScissor=function(x,U,H,k){x.isVector4?Ze.set(x.x,x.y,x.z,x.w):Ze.set(x,U,H,k),f.scissor(xe.copy(Ze).multiplyScalar(ee).round())},this.getScissorTest=function(){return Ie},this.setScissorTest=function(x){f.setScissorTest(Ie=x)},this.setOpaqueSort=function(x){ye=x},this.setTransparentSort=function(x){Ce=x},this.getClearColor=function(x){return x.copy(De.getClearColor())},this.setClearColor=function(){De.setClearColor(...arguments)},this.getClearAlpha=function(){return De.getClearAlpha()},this.setClearAlpha=function(){De.setClearAlpha(...arguments)},this.clear=function(x=!0,U=!0,H=!0){let k=0;if(x){let G=!1;if(Q!==null){const me=Q.texture.format;G=m.has(me)}if(G){const me=Q.texture.type,Ee=h.has(me),pe=De.getClearColor(),Re=De.getClearAlpha(),Pe=pe.r,Ge=pe.g,Xe=pe.b;Ee?(R[0]=Pe,R[1]=Ge,R[2]=Xe,R[3]=Re,P.clearBufferuiv(P.COLOR,0,R)):(A[0]=Pe,A[1]=Ge,A[2]=Xe,A[3]=Re,P.clearBufferiv(P.COLOR,0,A))}else k|=P.COLOR_BUFFER_BIT}U&&(k|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),H&&(k|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),k!==0&&P.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(x){x.setRenderer(this),B=x},this.dispose=function(){t.removeEventListener("webglcontextlost",rt,!1),t.removeEventListener("webglcontextrestored",et,!1),t.removeEventListener("webglcontextcreationerror",Ut,!1),De.dispose(),ae.dispose(),oe.dispose(),O.dispose(),ne.dispose(),K.dispose(),ue.dispose(),J.dispose(),re.dispose(),ve.dispose(),ve.removeEventListener("sessionstart",qa),ve.removeEventListener("sessionend",Ya),Hn.stop()};function rt(x){x.preventDefault(),go("WebGLRenderer: Context Lost."),D=!0}function et(){go("WebGLRenderer: Context Restored."),D=!1;const x=N.autoReset,U=Ae.enabled,H=Ae.autoUpdate,k=Ae.needsUpdate,G=Ae.type;Me(),N.autoReset=x,Ae.enabled=U,Ae.autoUpdate=H,Ae.needsUpdate=k,Ae.type=G}function Ut(x){Qe("WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function St(x){const U=x.target;U.removeEventListener("dispose",St),Kl(U)}function Kl(x){Zl(x),O.remove(x)}function Zl(x){const U=O.get(x).programs;U!==void 0&&(U.forEach(function(H){re.releaseProgram(H)}),x.isShaderMaterial&&re.releaseShaderCache(x))}this.renderBufferDirect=function(x,U,H,k,G,me){U===null&&(U=xt);const Ee=G.isMesh&&G.matrixWorld.determinantAffine()<0,pe=ec(x,U,H,k,G);f.setMaterial(k,Ee);let Re=H.index,Pe=1;if(k.wireframe===!0){if(Re=q.getWireframeAttribute(H),Re===void 0)return;Pe=2}const Ge=H.drawRange,Xe=H.attributes.position;let Le=Ge.start*Pe,st=(Ge.start+Ge.count)*Pe;me!==null&&(Le=Math.max(Le,me.start*Pe),st=Math.min(st,(me.start+me.count)*Pe)),Re!==null?(Le=Math.max(Le,0),st=Math.min(st,Re.count)):Xe!=null&&(Le=Math.max(Le,0),st=Math.min(st,Xe.count));const pt=st-Le;if(pt<0||pt===1/0)return;ue.setup(G,k,pe,H,Re);let ht,at=ce;if(Re!==null&&(ht=le.get(Re),at=$,at.setIndex(ht)),G.isMesh)k.wireframe===!0?(f.setLineWidth(k.wireframeLinewidth*Ue()),at.setMode(P.LINES)):at.setMode(P.TRIANGLES);else if(G.isLine){let Rt=k.linewidth;Rt===void 0&&(Rt=1),f.setLineWidth(Rt*Ue()),G.isLineSegments?at.setMode(P.LINES):G.isLineLoop?at.setMode(P.LINE_LOOP):at.setMode(P.LINE_STRIP)}else G.isPoints?at.setMode(P.POINTS):G.isSprite&&at.setMode(P.TRIANGLES);if(G.isBatchedMesh)if(we.get("WEBGL_multi_draw"))at.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const Rt=G._multiDrawStarts,Se=G._multiDrawCounts,zt=G._multiDrawCount,Je=Re?le.get(Re).bytesPerElement:1,Ht=O.get(k).currentProgram.getUniforms();for(let sn=0;sn<zt;sn++)Ht.setValue(P,"_gl_DrawID",sn),at.render(Rt[sn]/Je,Se[sn])}else if(G.isInstancedMesh)at.renderInstances(Le,pt,G.count);else if(H.isInstancedBufferGeometry){const Rt=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,Se=Math.min(H.instanceCount,Rt);at.renderInstances(Le,pt,Se)}else at.render(Le,pt)};function Xa(x,U,H){x.transparent===!0&&x.side===yn&&x.forceSinglePass===!1?(x.side=Ot,x.needsUpdate=!0,tr(x,U,H),x.side=Gn,x.needsUpdate=!0,tr(x,U,H),x.side=yn):tr(x,U,H)}this.compile=function(x,U,H=null){H===null&&(H=x),y=oe.get(H),y.init(U),_.push(y),H.traverseVisible(function(G){G.isLight&&G.layers.test(U.layers)&&(y.pushLight(G),G.castShadow&&y.pushShadow(G))}),x!==H&&x.traverseVisible(function(G){G.isLight&&G.layers.test(U.layers)&&(y.pushLight(G),G.castShadow&&y.pushShadow(G))}),y.setupLights();const k=new Set;return x.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const me=G.material;if(me)if(Array.isArray(me))for(let Ee=0;Ee<me.length;Ee++){const pe=me[Ee];Xa(pe,H,G),k.add(pe)}else Xa(me,H,G),k.add(me)}),y=_.pop(),k},this.compileAsync=function(x,U,H=null){const k=this.compile(x,U,H);return new Promise(G=>{function me(){if(k.forEach(function(Ee){O.get(Ee).currentProgram.isReady()&&k.delete(Ee)}),k.size===0){G(x);return}setTimeout(me,10)}we.get("KHR_parallel_shader_compile")!==null?me():setTimeout(me,10)})};let Yr=null;function Jl(x){Yr&&Yr(x)}function qa(){Hn.stop()}function Ya(){Hn.start()}const Hn=new Gl;Hn.setAnimationLoop(Jl),typeof self<"u"&&Hn.setContext(self),this.setAnimationLoop=function(x){Yr=x,ve.setAnimationLoop(x),x===null?Hn.stop():Hn.start()},ve.addEventListener("sessionstart",qa),ve.addEventListener("sessionend",Ya),this.render=function(x,U){if(U!==void 0&&U.isCamera!==!0){Qe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;B!==null&&B.renderStart(x,U);const H=ve.enabled===!0&&ve.isPresenting===!0,k=T!==null&&(Q===null||H)&&T.begin(I,Q);if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),ve.enabled===!0&&ve.isPresenting===!0&&(T===null||T.isCompositing()===!1)&&(ve.cameraAutoUpdate===!0&&ve.updateCamera(U),U=ve.getCamera()),x.isScene===!0&&x.onBeforeRender(I,x,U,Q),y=oe.get(x,_.length),y.init(U),y.state.textureUnits=X.getTextureUnits(),_.push(y),ct.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),ze.setFromProjectionMatrix(ct,dn,U.reversedDepth),qe=this.localClippingEnabled,Oe=be.init(this.clippingPlanes,qe),w=ae.get(x,C.length),w.init(),C.push(w),ve.enabled===!0&&ve.isPresenting===!0){const Ee=I.xr.getDepthSensingMesh();Ee!==null&&jr(Ee,U,-1/0,I.sortObjects)}jr(x,U,0,I.sortObjects),w.finish(),I.sortObjects===!0&&w.sort(ye,Ce,U.reversedDepth),Ne=ve.enabled===!1||ve.isPresenting===!1||ve.hasDepthSensing()===!1,Ne&&De.addToRenderList(w,x),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Oe===!0&&be.beginShadows();const G=y.state.shadowsArray;if(Ae.render(G,x,U),Oe===!0&&be.endShadows(),(k&&T.hasRenderPass())===!1){const Ee=w.opaque,pe=w.transmissive;if(y.setupLights(),U.isArrayCamera){const Re=U.cameras;if(pe.length>0)for(let Pe=0,Ge=Re.length;Pe<Ge;Pe++){const Xe=Re[Pe];$a(Ee,pe,x,Xe)}Ne&&De.render(x);for(let Pe=0,Ge=Re.length;Pe<Ge;Pe++){const Xe=Re[Pe];ja(w,x,Xe,Xe.viewport)}}else pe.length>0&&$a(Ee,pe,x,U),Ne&&De.render(x),ja(w,x,U)}Q!==null&&W===0&&(X.updateMultisampleRenderTarget(Q),X.updateRenderTargetMipmap(Q)),k&&T.end(I),x.isScene===!0&&x.onAfterRender(I,x,U),ue.resetDefaultState(),te=-1,de=null,_.pop(),_.length>0?(y=_[_.length-1],X.setTextureUnits(y.state.textureUnits),Oe===!0&&be.setGlobalState(I.clippingPlanes,y.state.camera)):y=null,C.pop(),C.length>0?w=C[C.length-1]:w=null,B!==null&&B.renderEnd()};function jr(x,U,H,k){if(x.visible===!1)return;if(x.layers.test(U.layers)){if(x.isGroup)H=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(U);else if(x.isLightProbeGrid)y.pushLightProbeGrid(x);else if(x.isLight)y.pushLight(x),x.castShadow&&y.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||ze.intersectsSprite(x)){k&&gt.setFromMatrixPosition(x.matrixWorld).applyMatrix4(ct);const Ee=K.update(x),pe=x.material;pe.visible&&w.push(x,Ee,pe,H,gt.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||ze.intersectsObject(x))){const Ee=K.update(x),pe=x.material;if(k&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),gt.copy(x.boundingSphere.center)):(Ee.boundingSphere===null&&Ee.computeBoundingSphere(),gt.copy(Ee.boundingSphere.center)),gt.applyMatrix4(x.matrixWorld).applyMatrix4(ct)),Array.isArray(pe)){const Re=Ee.groups;for(let Pe=0,Ge=Re.length;Pe<Ge;Pe++){const Xe=Re[Pe],Le=pe[Xe.materialIndex];Le&&Le.visible&&w.push(x,Ee,Le,H,gt.z,Xe)}}else pe.visible&&w.push(x,Ee,pe,H,gt.z,null)}}const me=x.children;for(let Ee=0,pe=me.length;Ee<pe;Ee++)jr(me[Ee],U,H,k)}function ja(x,U,H,k){const{opaque:G,transmissive:me,transparent:Ee}=x;y.setupLightsView(H),Oe===!0&&be.setGlobalState(I.clippingPlanes,H),k&&f.viewport(he.copy(k)),G.length>0&&er(G,U,H),me.length>0&&er(me,U,H),Ee.length>0&&er(Ee,U,H),f.buffers.depth.setTest(!0),f.buffers.depth.setMask(!0),f.buffers.color.setMask(!0),f.setPolygonOffset(!1)}function $a(x,U,H,k){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;if(y.state.transmissionRenderTarget[k.id]===void 0){const Le=we.has("EXT_color_buffer_half_float")||we.has("EXT_color_buffer_float");y.state.transmissionRenderTarget[k.id]=new fn(1,1,{generateMipmaps:!0,type:Le?wn:Yt,minFilter:Jn,samples:Math.max(4,E.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:je.workingColorSpace})}const me=y.state.transmissionRenderTarget[k.id],Ee=k.viewport||he;me.setSize(Ee.z*I.transmissionResolutionScale,Ee.w*I.transmissionResolutionScale);const pe=I.getRenderTarget(),Re=I.getActiveCubeFace(),Pe=I.getActiveMipmapLevel();I.setRenderTarget(me),I.getClearColor(nt),ge=I.getClearAlpha(),ge<1&&I.setClearColor(16777215,.5),I.clear(),Ne&&De.render(H);const Ge=I.toneMapping;I.toneMapping=hn;const Xe=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),y.setupLightsView(k),Oe===!0&&be.setGlobalState(I.clippingPlanes,k),er(x,H,k),X.updateMultisampleRenderTarget(me),X.updateRenderTargetMipmap(me),we.has("WEBGL_multisampled_render_to_texture")===!1){let Le=!1;for(let st=0,pt=U.length;st<pt;st++){const ht=U[st],{object:at,geometry:Rt,material:Se,group:zt}=ht;if(Se.side===yn&&at.layers.test(k.layers)){const Je=Se.side;Se.side=Ot,Se.needsUpdate=!0,Ka(at,H,k,Rt,Se,zt),Se.side=Je,Se.needsUpdate=!0,Le=!0}}Le===!0&&(X.updateMultisampleRenderTarget(me),X.updateRenderTargetMipmap(me))}I.setRenderTarget(pe,Re,Pe),I.setClearColor(nt,ge),Xe!==void 0&&(k.viewport=Xe),I.toneMapping=Ge}function er(x,U,H){const k=U.isScene===!0?U.overrideMaterial:null;for(let G=0,me=x.length;G<me;G++){const Ee=x[G],{object:pe,geometry:Re,group:Pe}=Ee;let Ge=Ee.material;Ge.allowOverride===!0&&k!==null&&(Ge=k),pe.layers.test(H.layers)&&Ka(pe,U,H,Re,Ge,Pe)}}function Ka(x,U,H,k,G,me){x.onBeforeRender(I,U,H,k,G,me),x.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),G.onBeforeRender(I,U,H,k,x,me),G.transparent===!0&&G.side===yn&&G.forceSinglePass===!1?(G.side=Ot,G.needsUpdate=!0,I.renderBufferDirect(H,U,k,G,x,me),G.side=Gn,G.needsUpdate=!0,I.renderBufferDirect(H,U,k,G,x,me),G.side=yn):I.renderBufferDirect(H,U,k,G,x,me),x.onAfterRender(I,U,H,k,G,me)}function tr(x,U,H){U.isScene!==!0&&(U=xt);const k=O.get(x),G=y.state.lights,me=y.state.shadowsArray,Ee=G.state.version,pe=re.getParameters(x,G.state,me,U,H,y.state.lightProbeGridArray),Re=re.getProgramCacheKey(pe);let Pe=k.programs;k.environment=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?U.environment:null,k.fog=U.fog;const Ge=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap;k.envMap=ne.get(x.envMap||k.environment,Ge),k.envMapRotation=k.environment!==null&&x.envMap===null?U.environmentRotation:x.envMapRotation,Pe===void 0&&(x.addEventListener("dispose",St),Pe=new Map,k.programs=Pe);let Xe=Pe.get(Re);if(Xe!==void 0){if(k.currentProgram===Xe&&k.lightsStateVersion===Ee)return Ja(x,pe),Xe}else pe.uniforms=re.getUniforms(x),B!==null&&x.isNodeMaterial&&B.build(x,H,pe),x.onBeforeCompile(pe,I),Xe=re.acquireProgram(pe,Re),Pe.set(Re,Xe),k.uniforms=pe.uniforms;const Le=k.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(Le.clippingPlanes=be.uniform),Ja(x,pe),k.needsLights=nc(x),k.lightsStateVersion=Ee,k.needsLights&&(Le.ambientLightColor.value=G.state.ambient,Le.lightProbe.value=G.state.probe,Le.directionalLights.value=G.state.directional,Le.directionalLightShadows.value=G.state.directionalShadow,Le.spotLights.value=G.state.spot,Le.spotLightShadows.value=G.state.spotShadow,Le.rectAreaLights.value=G.state.rectArea,Le.ltc_1.value=G.state.rectAreaLTC1,Le.ltc_2.value=G.state.rectAreaLTC2,Le.pointLights.value=G.state.point,Le.pointLightShadows.value=G.state.pointShadow,Le.hemisphereLights.value=G.state.hemi,Le.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Le.spotLightMatrix.value=G.state.spotLightMatrix,Le.spotLightMap.value=G.state.spotLightMap,Le.pointShadowMatrix.value=G.state.pointShadowMatrix),k.lightProbeGrid=y.state.lightProbeGridArray.length>0,k.currentProgram=Xe,k.uniformsList=null,Xe}function Za(x){if(x.uniformsList===null){const U=x.currentProgram.getUniforms();x.uniformsList=Nr.seqWithValue(U.seq,x.uniforms)}return x.uniformsList}function Ja(x,U){const H=O.get(x);H.outputColorSpace=U.outputColorSpace,H.batching=U.batching,H.batchingColor=U.batchingColor,H.instancing=U.instancing,H.instancingColor=U.instancingColor,H.instancingMorph=U.instancingMorph,H.skinning=U.skinning,H.morphTargets=U.morphTargets,H.morphNormals=U.morphNormals,H.morphColors=U.morphColors,H.morphTargetsCount=U.morphTargetsCount,H.numClippingPlanes=U.numClippingPlanes,H.numIntersection=U.numClipIntersection,H.vertexAlphas=U.vertexAlphas,H.vertexTangents=U.vertexTangents,H.toneMapping=U.toneMapping}function Ql(x,U){if(x.length===0)return null;if(x.length===1)return x[0].texture!==null?x[0]:null;S.setFromMatrixPosition(U.matrixWorld);for(let H=0,k=x.length;H<k;H++){const G=x[H];if(G.texture!==null&&G.boundingBox.containsPoint(S))return G}return null}function ec(x,U,H,k,G){U.isScene!==!0&&(U=xt),X.resetTextureUnits();const me=U.fog,Ee=k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial?U.environment:null,pe=Q===null?I.outputColorSpace:Q.isXRRenderTarget===!0?Q.texture.colorSpace:je.workingColorSpace,Re=k.isMeshStandardMaterial||k.isMeshLambertMaterial&&!k.envMap||k.isMeshPhongMaterial&&!k.envMap,Pe=ne.get(k.envMap||Ee,Re),Ge=k.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,Xe=!!H.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),Le=!!H.morphAttributes.position,st=!!H.morphAttributes.normal,pt=!!H.morphAttributes.color;let ht=hn;k.toneMapped&&(Q===null||Q.isXRRenderTarget===!0)&&(ht=I.toneMapping);const at=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,Rt=at!==void 0?at.length:0,Se=O.get(k),zt=y.state.lights;if(Oe===!0&&(qe===!0||x!==de)){const lt=x===de&&k.id===te;be.setState(k,x,lt)}let Je=!1;k.version===Se.__version?(Se.needsLights&&Se.lightsStateVersion!==zt.state.version||Se.outputColorSpace!==pe||G.isBatchedMesh&&Se.batching===!1||!G.isBatchedMesh&&Se.batching===!0||G.isBatchedMesh&&Se.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&Se.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&Se.instancing===!1||!G.isInstancedMesh&&Se.instancing===!0||G.isSkinnedMesh&&Se.skinning===!1||!G.isSkinnedMesh&&Se.skinning===!0||G.isInstancedMesh&&Se.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&Se.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&Se.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&Se.instancingMorph===!1&&G.morphTexture!==null||Se.envMap!==Pe||k.fog===!0&&Se.fog!==me||Se.numClippingPlanes!==void 0&&(Se.numClippingPlanes!==be.numPlanes||Se.numIntersection!==be.numIntersection)||Se.vertexAlphas!==Ge||Se.vertexTangents!==Xe||Se.morphTargets!==Le||Se.morphNormals!==st||Se.morphColors!==pt||Se.toneMapping!==ht||Se.morphTargetsCount!==Rt||!!Se.lightProbeGrid!=y.state.lightProbeGridArray.length>0)&&(Je=!0):(Je=!0,Se.__version=k.version);let Ht=Se.currentProgram;Je===!0&&(Ht=tr(k,U,G),B&&k.isNodeMaterial&&B.onUpdateProgram(k,Ht,Se));let sn=!1,Pn=!1,si=!1;const ot=Ht.getUniforms(),mt=Se.uniforms;if(f.useProgram(Ht.program)&&(sn=!0,Pn=!0,si=!0),k.id!==te&&(te=k.id,Pn=!0),Se.needsLights){const lt=Ql(y.state.lightProbeGridArray,G);Se.lightProbeGrid!==lt&&(Se.lightProbeGrid=lt,Pn=!0)}if(sn||de!==x){f.buffers.depth.getReversed()&&x.reversedDepth!==!0&&(x._reversedDepth=!0,x.updateProjectionMatrix()),ot.setValue(P,"projectionMatrix",x.projectionMatrix),ot.setValue(P,"viewMatrix",x.matrixWorldInverse);const In=ot.map.cameraPosition;In!==void 0&&In.setValue(P,dt.setFromMatrixPosition(x.matrixWorld)),E.logarithmicDepthBuffer&&ot.setValue(P,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&ot.setValue(P,"isOrthographic",x.isOrthographicCamera===!0),de!==x&&(de=x,Pn=!0,si=!0)}if(Se.needsLights&&(zt.state.directionalShadowMap.length>0&&ot.setValue(P,"directionalShadowMap",zt.state.directionalShadowMap,X),zt.state.spotShadowMap.length>0&&ot.setValue(P,"spotShadowMap",zt.state.spotShadowMap,X),zt.state.pointShadowMap.length>0&&ot.setValue(P,"pointShadowMap",zt.state.pointShadowMap,X)),G.isSkinnedMesh){ot.setOptional(P,G,"bindMatrix"),ot.setOptional(P,G,"bindMatrixInverse");const lt=G.skeleton;lt&&(lt.boneTexture===null&&lt.computeBoneTexture(),ot.setValue(P,"boneTexture",lt.boneTexture,X))}G.isBatchedMesh&&(ot.setOptional(P,G,"batchingTexture"),ot.setValue(P,"batchingTexture",G._matricesTexture,X),ot.setOptional(P,G,"batchingIdTexture"),ot.setValue(P,"batchingIdTexture",G._indirectTexture,X),ot.setOptional(P,G,"batchingColorTexture"),G._colorsTexture!==null&&ot.setValue(P,"batchingColorTexture",G._colorsTexture,X));const Ln=H.morphAttributes;if((Ln.position!==void 0||Ln.normal!==void 0||Ln.color!==void 0)&&L.update(G,H,Ht),(Pn||Se.receiveShadow!==G.receiveShadow)&&(Se.receiveShadow=G.receiveShadow,ot.setValue(P,"receiveShadow",G.receiveShadow)),(k.isMeshStandardMaterial||k.isMeshLambertMaterial||k.isMeshPhongMaterial)&&k.envMap===null&&U.environment!==null&&(mt.envMapIntensity.value=U.environmentIntensity),mt.dfgLUT!==void 0&&(mt.dfgLUT.value=ag()),Pn){if(ot.setValue(P,"toneMappingExposure",I.toneMappingExposure),Se.needsLights&&tc(mt,si),me&&k.fog===!0&&_e.refreshFogUniforms(mt,me),_e.refreshMaterialUniforms(mt,k,ee,ie,y.state.transmissionRenderTarget[x.id]),Se.needsLights&&Se.lightProbeGrid){const lt=Se.lightProbeGrid;mt.probesSH.value=lt.texture,mt.probesMin.value.copy(lt.boundingBox.min),mt.probesMax.value.copy(lt.boundingBox.max),mt.probesResolution.value.copy(lt.resolution)}Nr.upload(P,Za(Se),mt,X)}if(k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(Nr.upload(P,Za(Se),mt,X),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&ot.setValue(P,"center",G.center),ot.setValue(P,"modelViewMatrix",G.modelViewMatrix),ot.setValue(P,"normalMatrix",G.normalMatrix),ot.setValue(P,"modelMatrix",G.matrixWorld),k.uniformsGroups!==void 0){const lt=k.uniformsGroups;for(let In=0,ai=lt.length;In<ai;In++){const Qa=lt[In];J.update(Qa,Ht),J.bind(Qa,Ht)}}return Ht}function tc(x,U){x.ambientLightColor.needsUpdate=U,x.lightProbe.needsUpdate=U,x.directionalLights.needsUpdate=U,x.directionalLightShadows.needsUpdate=U,x.pointLights.needsUpdate=U,x.pointLightShadows.needsUpdate=U,x.spotLights.needsUpdate=U,x.spotLightShadows.needsUpdate=U,x.rectAreaLights.needsUpdate=U,x.hemisphereLights.needsUpdate=U}function nc(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return Y},this.getActiveMipmapLevel=function(){return W},this.getRenderTarget=function(){return Q},this.setRenderTargetTextures=function(x,U,H){const k=O.get(x);k.__autoAllocateDepthBuffer=x.resolveDepthBuffer===!1,k.__autoAllocateDepthBuffer===!1&&(k.__useRenderToTexture=!1),O.get(x.texture).__webglTexture=U,O.get(x.depthTexture).__webglTexture=k.__autoAllocateDepthBuffer?void 0:H,k.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(x,U){const H=O.get(x);H.__webglFramebuffer=U,H.__useDefaultFramebuffer=U===void 0},this.setRenderTarget=function(x,U=0,H=0){Q=x,Y=U,W=H;let k=null,G=!1,me=!1;if(x){const pe=O.get(x);if(pe.__useDefaultFramebuffer!==void 0){f.bindFramebuffer(P.FRAMEBUFFER,pe.__webglFramebuffer),he.copy(x.viewport),xe.copy(x.scissor),We=x.scissorTest,f.viewport(he),f.scissor(xe),f.setScissorTest(We),te=-1;return}else if(pe.__webglFramebuffer===void 0)X.setupRenderTarget(x);else if(pe.__hasExternalTextures)X.rebindTextures(x,O.get(x.texture).__webglTexture,O.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){const Ge=x.depthTexture;if(pe.__boundDepthTexture!==Ge){if(Ge!==null&&O.has(Ge)&&(x.width!==Ge.image.width||x.height!==Ge.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");X.setupDepthRenderbuffer(x)}}const Re=x.texture;(Re.isData3DTexture||Re.isDataArrayTexture||Re.isCompressedArrayTexture)&&(me=!0);const Pe=O.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(Pe[U])?k=Pe[U][H]:k=Pe[U],G=!0):x.samples>0&&X.useMultisampledRTT(x)===!1?k=O.get(x).__webglMultisampledFramebuffer:Array.isArray(Pe)?k=Pe[H]:k=Pe,he.copy(x.viewport),xe.copy(x.scissor),We=x.scissorTest}else he.copy(Te).multiplyScalar(ee).floor(),xe.copy(Ze).multiplyScalar(ee).floor(),We=Ie;if(H!==0&&(k=Z),f.bindFramebuffer(P.FRAMEBUFFER,k)&&f.drawBuffers(x,k),f.viewport(he),f.scissor(xe),f.setScissorTest(We),G){const pe=O.get(x.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+U,pe.__webglTexture,H)}else if(me){const pe=U;for(let Re=0;Re<x.textures.length;Re++){const Pe=O.get(x.textures[Re]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+Re,Pe.__webglTexture,H,pe)}}else if(x!==null&&H!==0){const pe=O.get(x.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,pe.__webglTexture,H)}te=-1},this.readRenderTargetPixels=function(x,U,H,k,G,me,Ee,pe=0){if(!(x&&x.isWebGLRenderTarget)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Re=O.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&Ee!==void 0&&(Re=Re[Ee]),Re){f.bindFramebuffer(P.FRAMEBUFFER,Re);try{const Pe=x.textures[pe],Ge=Pe.format,Xe=Pe.type;if(x.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+pe),!E.textureFormatReadable(Ge)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!E.textureTypeReadable(Xe)){Qe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=x.width-k&&H>=0&&H<=x.height-G&&P.readPixels(U,H,k,G,se.convert(Ge),se.convert(Xe),me)}finally{const Pe=Q!==null?O.get(Q).__webglFramebuffer:null;f.bindFramebuffer(P.FRAMEBUFFER,Pe)}}},this.readRenderTargetPixelsAsync=async function(x,U,H,k,G,me,Ee,pe=0){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Re=O.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&Ee!==void 0&&(Re=Re[Ee]),Re)if(U>=0&&U<=x.width-k&&H>=0&&H<=x.height-G){f.bindFramebuffer(P.FRAMEBUFFER,Re);const Pe=x.textures[pe],Ge=Pe.format,Xe=Pe.type;if(x.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+pe),!E.textureFormatReadable(Ge))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!E.textureTypeReadable(Xe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Le=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,Le),P.bufferData(P.PIXEL_PACK_BUFFER,me.byteLength,P.STREAM_READ),P.readPixels(U,H,k,G,se.convert(Ge),se.convert(Xe),0);const st=Q!==null?O.get(Q).__webglFramebuffer:null;f.bindFramebuffer(P.FRAMEBUFFER,st);const pt=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await Au(P,pt,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,Le),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,me),P.deleteBuffer(Le),P.deleteSync(pt),me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(x,U=null,H=0){const k=Math.pow(2,-H),G=Math.floor(x.image.width*k),me=Math.floor(x.image.height*k),Ee=U!==null?U.x:0,pe=U!==null?U.y:0;X.setTexture2D(x,0),P.copyTexSubImage2D(P.TEXTURE_2D,H,0,0,Ee,pe,G,me),f.unbindTexture()},this.copyTextureToTexture=function(x,U,H=null,k=null,G=0,me=0){let Ee,pe,Re,Pe,Ge,Xe,Le,st,pt;const ht=x.isCompressedTexture?x.mipmaps[me]:x.image;if(H!==null)Ee=H.max.x-H.min.x,pe=H.max.y-H.min.y,Re=H.isBox3?H.max.z-H.min.z:1,Pe=H.min.x,Ge=H.min.y,Xe=H.isBox3?H.min.z:0;else{const mt=Math.pow(2,-G);Ee=Math.floor(ht.width*mt),pe=Math.floor(ht.height*mt),x.isDataArrayTexture?Re=ht.depth:x.isData3DTexture?Re=Math.floor(ht.depth*mt):Re=1,Pe=0,Ge=0,Xe=0}k!==null?(Le=k.x,st=k.y,pt=k.z):(Le=0,st=0,pt=0);const at=se.convert(U.format),Rt=se.convert(U.type);let Se;U.isData3DTexture?(X.setTexture3D(U,0),Se=P.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(X.setTexture2DArray(U,0),Se=P.TEXTURE_2D_ARRAY):(X.setTexture2D(U,0),Se=P.TEXTURE_2D),f.activeTexture(P.TEXTURE0),f.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,U.flipY),f.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),f.pixelStorei(P.UNPACK_ALIGNMENT,U.unpackAlignment);const zt=f.getParameter(P.UNPACK_ROW_LENGTH),Je=f.getParameter(P.UNPACK_IMAGE_HEIGHT),Ht=f.getParameter(P.UNPACK_SKIP_PIXELS),sn=f.getParameter(P.UNPACK_SKIP_ROWS),Pn=f.getParameter(P.UNPACK_SKIP_IMAGES);f.pixelStorei(P.UNPACK_ROW_LENGTH,ht.width),f.pixelStorei(P.UNPACK_IMAGE_HEIGHT,ht.height),f.pixelStorei(P.UNPACK_SKIP_PIXELS,Pe),f.pixelStorei(P.UNPACK_SKIP_ROWS,Ge),f.pixelStorei(P.UNPACK_SKIP_IMAGES,Xe);const si=x.isDataArrayTexture||x.isData3DTexture,ot=U.isDataArrayTexture||U.isData3DTexture;if(x.isDepthTexture){const mt=O.get(x),Ln=O.get(U),lt=O.get(mt.__renderTarget),In=O.get(Ln.__renderTarget);f.bindFramebuffer(P.READ_FRAMEBUFFER,lt.__webglFramebuffer),f.bindFramebuffer(P.DRAW_FRAMEBUFFER,In.__webglFramebuffer);for(let ai=0;ai<Re;ai++)si&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,O.get(x).__webglTexture,G,Xe+ai),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,O.get(U).__webglTexture,me,pt+ai)),P.blitFramebuffer(Pe,Ge,Ee,pe,Le,st,Ee,pe,P.DEPTH_BUFFER_BIT,P.NEAREST);f.bindFramebuffer(P.READ_FRAMEBUFFER,null),f.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(G!==0||x.isRenderTargetTexture||O.has(x)){const mt=O.get(x),Ln=O.get(U);f.bindFramebuffer(P.READ_FRAMEBUFFER,j),f.bindFramebuffer(P.DRAW_FRAMEBUFFER,V);for(let lt=0;lt<Re;lt++)si?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,mt.__webglTexture,G,Xe+lt):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,mt.__webglTexture,G),ot?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Ln.__webglTexture,me,pt+lt):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Ln.__webglTexture,me),G!==0?P.blitFramebuffer(Pe,Ge,Ee,pe,Le,st,Ee,pe,P.COLOR_BUFFER_BIT,P.NEAREST):ot?P.copyTexSubImage3D(Se,me,Le,st,pt+lt,Pe,Ge,Ee,pe):P.copyTexSubImage2D(Se,me,Le,st,Pe,Ge,Ee,pe);f.bindFramebuffer(P.READ_FRAMEBUFFER,null),f.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else ot?x.isDataTexture||x.isData3DTexture?P.texSubImage3D(Se,me,Le,st,pt,Ee,pe,Re,at,Rt,ht.data):U.isCompressedArrayTexture?P.compressedTexSubImage3D(Se,me,Le,st,pt,Ee,pe,Re,at,ht.data):P.texSubImage3D(Se,me,Le,st,pt,Ee,pe,Re,at,Rt,ht):x.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,me,Le,st,Ee,pe,at,Rt,ht.data):x.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,me,Le,st,ht.width,ht.height,at,ht.data):P.texSubImage2D(P.TEXTURE_2D,me,Le,st,Ee,pe,at,Rt,ht);f.pixelStorei(P.UNPACK_ROW_LENGTH,zt),f.pixelStorei(P.UNPACK_IMAGE_HEIGHT,Je),f.pixelStorei(P.UNPACK_SKIP_PIXELS,Ht),f.pixelStorei(P.UNPACK_SKIP_ROWS,sn),f.pixelStorei(P.UNPACK_SKIP_IMAGES,Pn),me===0&&U.generateMipmaps&&P.generateMipmap(Se),f.unbindTexture()},this.initRenderTarget=function(x){O.get(x).__webglFramebuffer===void 0&&X.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?X.setTextureCube(x,0):x.isData3DTexture?X.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?X.setTexture2DArray(x,0):X.setTexture2D(x,0),f.unbindTexture()},this.resetState=function(){Y=0,W=0,Q=null,f.reset(),ue.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return dn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=je._getDrawingBufferColorSpace(e),t.unpackColorSpace=je._getUnpackColorSpace()}}function lg(){const i=ke.useRef(null);return ke.useEffect(()=>{const e=i.current;if(!e)return;let t=null,n=!0;const r=new Gu,s=window.innerWidth,a=window.innerHeight,o=new qt(60,s/a,.1,1e3);o.position.set(0,0,90);const l=new og({alpha:!0,antialias:!1,powerPreference:"high-performance"});l.setSize(s,a),l.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),l.setClearColor(0,0),e.appendChild(l.domElement);const c=s<768,d=c?1800:3800,p=.85,u=new Bt,g=new z,M=new tt,b=new za(c?.35:.28),m=new Oa({color:16777215,transparent:!0,opacity:.75}),h=new Ku(b,m,d);h.instanceMatrix.setUsage(bu),r.add(h);const R=[];for(let ge=0;ge<d;ge++)R.push(new z((Math.random()-.5)*140,(Math.random()-.5)*140,(Math.random()-.5)*140));const A=c?70:95,S=2.5,w=1.2,y=1.4,C=1.8,_=16,T=.12,I=.32,D=.55,B=.68,Z=.78,j=.9,V=.97;let Y=0,W=0,Q=0,te=0;const de=ge=>{Q=(ge.clientX/window.innerWidth-.5)*2,te=(ge.clientY/window.innerHeight-.5)*2};window.addEventListener("mousemove",de,{passive:!0});const he=()=>{const ge=window.innerWidth,F=window.innerHeight;o.aspect=ge/F,o.updateProjectionMatrix(),l.setSize(ge,F),l.setPixelRatio(Math.min(window.devicePixelRatio,1.5))};window.addEventListener("resize",he,{passive:!0});const xe=()=>{n=!document.hidden};document.addEventListener("visibilitychange",xe);const We=new ud,nt=()=>{if(t=requestAnimationFrame(nt),!n)return;const ge=We.getElapsedTime()*p;Y+=(Q-Y)*.05,W+=(te-W)*.05,o.position.x=Y*12,o.position.y=-W*12,o.lookAt(0,0,0);for(let F=0;F<d;F++){const ie=F/d,ee=Math.abs(Math.sin(F*12.9898)*43758.5453)%1,ye=Math.abs(Math.sin(F*78.233)*12543.123)%1,Ce=Math.abs(Math.sin(F*45.164)*98765.432)%1,Te=Math.abs(Math.sin(F*33.719)*54321.987)%1,Ze=Math.abs(Math.sin(F*61.431)*31415.9265)%1;let Ie=0,ze=0,Oe=0;if(ie<T){const Ne=A*.22,Ue=ee*6.2831853,P=ye*2-1,Ve=Math.sqrt(Math.max(0,1-P*P)),we=Math.cbrt(Math.max(Ce,1e-4))*Ne,E=Math.sin(ge*3+Te*6.283)*Ne*.03,f=we+E;Ie=f*Ve*Math.cos(Ue),ze=f*Ve*Math.sin(Ue),Oe=f*P;const N=Math.pow(.5+.5*Math.sin(ge*S*4+Ze*18.85),6),O=.5+.5*N;M.setHSL(Math.max(0,.14-N*.05),1,Math.min(.95,.55+O*.4))}else if(ie<I){const Ne=A*.22,Ue=A*.46,P=Ne+ee*(Ue-Ne),Ve=ye*6.2831853+Math.sin(ge*.03+Ce*6.283)*.3,we=Ce*2-1,E=Math.sqrt(Math.max(0,1-we*we)),f=Math.sin(ge*.08+Te*6.283)*A*.02,N=P+f;Ie=N*E*Math.cos(Ve),ze=N*E*Math.sin(Ve),Oe=N*we,M.setHSL(.06,.9,.25+Ze*.1)}else if(ie<D){const Ne=A*.46,Ue=A*.72,P=Ne+ee*(Ue-Ne),Ve=ye*6.2831853,we=Ce*2-1,E=Math.sqrt(Math.max(0,1-we*we)),f=Math.sin(Ve*6+ge*w*.5)+Math.sin(we*18+ge*w*.4+Te*6.283)+Math.sin((Ve+we)*12-ge*w*.6),N=f*w*A*.015,O=P+N;Ie=O*E*Math.cos(Ve+N*.01),ze=O*E*Math.sin(Ve+N*.01),Oe=O*we;const X=(f+3)/6;M.setHSL(Math.max(0,.08-X*.02),1,.3+X*.35)}else if(ie<B){const Ne=A*.76,Ue=ee*6.2831853,P=ye*2-1,Ve=Math.sqrt(Math.max(0,1-P*P)),we=Math.sin(Ue*24+ge*.6)+Math.sin(P*30-ge*.5+Ce*6.283)+Math.sin(Ue*17+P*13+ge*.4),E=Math.sin(Ue*3+Te*6.283)+Math.sin(P*4+ge*.05),f=Math.max(0,-E-1.1)*.8,N=Ne+we*A*.004;Ie=N*Ve*Math.cos(Ue),ze=N*Ve*Math.sin(Ue),Oe=N*P;const O=.6+we*.1-f;M.setHSL(.13,.9,Math.max(.08,Math.min(.85,O)))}else if(ie<Z){const Ne=A*.79,Ue=ee*6.2831853,P=ye*2-1,Ve=Math.sqrt(Math.max(0,1-P*P)),we=A*.05,E=Math.abs(Math.sin(ge*2+Ce*18.85))*we,f=Ne+E;Ie=f*Ve*Math.cos(Ue),ze=f*Ve*Math.sin(Ue),Oe=f*P,M.setHSL(.98,.85,.35+E/Math.max(we,1e-4)*.25)}else if(ie<j)if(Ze<.5){const Ne=Math.floor(F%_),Ue=Math.abs(Math.sin(Ne*17.17)*6543.21)%1,P=Math.abs(Math.sin(Ne*29.71)*7654.32)%1,Ve=Math.abs(Math.sin(Ne*53.13)*8765.43)%1,we=Math.abs(Math.sin(Ne*71.91)*9876.54)%1,E=P*2-1,f=Math.sqrt(Math.max(0,1-E*E)),N=Ue*6.2831853,O=f*Math.cos(N),X=f*Math.sin(N),ne=E,le=0,q=1,K=.15;let re=q*ne-K*X,_e=K*O-le*ne,ae=le*X-q*O;const oe=Math.max(Math.sqrt(re*re+_e*_e+ae*ae),1e-5);re/=oe,_e/=oe,ae/=oe;let be=X*ae-ne*_e,Ae=ne*re-O*ae,De=O*_e-X*re;const L=Math.max(Math.sqrt(be*be+Ae*Ae+De*De),1e-5);be/=L,Ae/=L,De/=L;const ce=.2+Ve*.35,$=ee,se=($-.5)*ce*2;let ue=re*Math.cos(se)+be*Math.sin(se),J=_e*Math.cos(se)+Ae*Math.sin(se),Me=ae*Math.cos(se)+De*Math.sin(se);const ve=Math.max(Math.sqrt(ue*ue+J*J+Me*Me),1e-5);ue/=ve,J/=ve,Me/=ve;const rt=Math.cos(($-.5)*3.14159),et=.6+.4*Math.sin(ge*.4*y+we*6.283),Ut=A*(.1+Ve*.15)*Math.max(.1,y)*et,St=A*.8+Ut*rt;Ie=ue*St,ze=J*St,Oe=Me*St,M.setHSL(.52,.95,.65+rt*.25)}else{const Ne=ee*6.2831853,Ue=ye*2-1,P=Math.sqrt(Math.max(0,1-Ue*Ue)),Ve=(ge*C*.6+Ce*18)%18,we=A*.82+Ve*A*.05;Ie=we*P*Math.cos(Ne),ze=we*P*Math.sin(Ne),Oe=we*Ue;const E=Math.max(0,1-Ve/18);M.setHSL(.56,.85,.45+E*.45)}else if(ie<V){const Ne=Math.floor(F%_),Ue=Math.abs(Math.sin(Ne*21.31)*5432.19)%1,P=Math.abs(Math.sin(Ne*37.77)*6321.98)%1,Ve=Math.abs(Math.sin(Ne*59.59)*7219.87)%1,we=Math.abs(Math.sin(Ne*83.13)*8123.65)%1,E=P*2-1,f=Math.sqrt(Math.max(0,1-E*E)),N=Ue*6.2831853,O=f*Math.cos(N),X=f*Math.sin(N),ne=E,le=.15,q=0,K=1;let re=q*ne-K*X,_e=K*O-le*ne,ae=le*X-q*O;const oe=Math.max(Math.sqrt(re*re+_e*_e+ae*ae),1e-5);re/=oe,_e/=oe,ae/=oe;let be=X*ae-ne*_e,Ae=ne*re-O*ae,De=O*_e-X*re;const L=Math.max(Math.sqrt(be*be+Ae*Ae+De*De),1e-5);be/=L,Ae/=L,De/=L;const ce=.3+Ve*.5,$=ee,se=($-.5)*ce*2;let ue=re*Math.cos(se)+be*Math.sin(se),J=_e*Math.cos(se)+Ae*Math.sin(se),Me=ae*Math.cos(se)+De*Math.sin(se);const ve=Math.max(Math.sqrt(ue*ue+J*J+Me*Me),1e-5);ue/=ve,J/=ve,Me/=ve;const rt=Math.cos(($-.5)*3.14159),et=.5+.5*Math.sin(ge*.5*y+we*6.283),Ut=A*(.2+Ve*.3)*Math.max(.1,y)*et,St=A*.79+Ut*rt;Ie=ue*St,ze=J*St,Oe=Me*St,M.setHSL(Math.max(0,.05-et*.02),1,.55+et*.35+rt*.1)}else{const Ne=ee*6.2831853,Ue=ye*2-1,P=Math.sqrt(Math.max(0,1-Ue*Ue)),Ve=(ge*C*1.1+Ce*70)%70,we=A*.95+Ve*A*.045;Ie=we*P*Math.cos(Ne),ze=we*P*Math.sin(Ne),Oe=we*Ue;const E=Math.max(0,1-Ve/70);M.setHSL(.58,.85,.4+E*.45)}const qe=ge*.035,ct=Math.cos(qe),dt=Math.sin(qe),gt=Ie*ct-ze*dt,xt=Ie*dt+ze*ct;g.set(gt,xt,Oe),R[F].lerp(g,.12),u.position.copy(R[F]),u.updateMatrix(),h.setMatrixAt(F,u.matrix),h.setColorAt(F,M)}h.instanceMatrix.needsUpdate=!0,h.instanceColor&&(h.instanceColor.needsUpdate=!0),l.render(r,o)};return nt(),()=>{cancelAnimationFrame(t),window.removeEventListener("mousemove",de),window.removeEventListener("resize",he),document.removeEventListener("visibilitychange",xe),b.dispose(),m.dispose(),l.dispose(),e&&l.domElement&&e.contains(l.domElement)&&e.removeChild(l.domElement)}},[]),v.jsx("div",{ref:i,style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:0,pointerEvents:"none",overflow:"hidden"},"aria-hidden":"true"})}function cg(){const i="/ozillafest/".replace(/\/$/,"");return v.jsx(lc,{basename:i||void 0,future:{v7_startTransition:!0,v7_relativeSplatPath:!0},children:v.jsxs(mc,{children:[v.jsx(lg,{}),v.jsx(Wc,{})]})})}class ug extends ke.Component{constructor(e){super(e),this.state={error:null}}static getDerivedStateFromError(e){return{error:e}}componentDidCatch(e,t){console.error("Application render failed:",e,t)}render(){return this.state.error?v.jsxs("main",{style:{padding:"32px",fontFamily:"Arial, sans-serif"},children:[v.jsx("h1",{style:{color:"#7c2d12",marginBottom:"12px"},children:"Ozilla Festival could not render"}),v.jsx("p",{style:{color:"#444",marginBottom:"16px"},children:"Check the browser console for the full error details."}),v.jsx("pre",{style:{whiteSpace:"pre-wrap",background:"#fff7ed",border:"1px solid #fed7aa",padding:"16px",borderRadius:"6px",color:"#7c2d12"},children:this.state.error.message})]}):this.props.children}}Is.createRoot(document.getElementById("root")).render(v.jsx(qi.StrictMode,{children:v.jsx(ug,{children:v.jsx(hc,{clientId:"placeholder-client-id",children:v.jsx(cg,{})})})}));export{Pc as L,Ec as P,ir as a,Ri as b,Gt as c,vc as g,un as t,Ta as u};
