const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/UserDashboardPage-DL9lAVCU.js","assets/vendor-motion-BW8tmsoW.js","assets/vendor-react-DycaHlXR.js","assets/PageHeader-Cr0bo0tp.js","assets/vendor-utils-BRCtA9qj.js","assets/AdminDashboardPage-KbwJxJnB.js","assets/AdminTicketReviewPage-BtS1BJSH.js"])))=>i.map(i=>d[i]);
var _a=Object.defineProperty;var Ba=(t,a,r)=>a in t?_a(t,a,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[a]=r;var Vt=(t,a,r)=>Ba(t,typeof a!="symbol"?a+"":a,r);import{j as e,u as Na,m as oe,a as qt,b as $a,A as Ha}from"./vendor-motion-BW8tmsoW.js";import{a as Ua,r as m,R as gt,u as Ke,N as xe,O as ut,L as J,b as ct,c as Ga,d as Wa,e as Sa,f as Va,g as Q,B as qa}from"./vendor-react-DycaHlXR.js";import{a as Ya,Q as Xa}from"./vendor-utils-BRCtA9qj.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function r(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(i){if(i.ep)return;i.ep=!0;const l=r(i);fetch(i.href,l)}})();var Dt={},Yt=Ua;Dt.createRoot=Yt.createRoot,Dt.hydrateRoot=Yt.hydrateRoot;function Za(t={}){const{nonce:a,locale:r,onScriptLoadSuccess:s,onScriptLoadError:i}=t,[l,n]=m.useState(!1),o=m.useRef(s);o.current=s;const c=m.useRef(i);return c.current=i,m.useEffect(()=>{const g=document.createElement("script");return g.src="https://accounts.google.com/gsi/client",r&&(g.src+=`?hl=${r}`),g.async=!0,g.defer=!0,g.nonce=a,g.onload=()=>{var u;n(!0),(u=o.current)===null||u===void 0||u.call(o)},g.onerror=()=>{var u;n(!1),(u=c.current)===null||u===void 0||u.call(c)},document.body.appendChild(g),()=>{document.body.removeChild(g)}},[a]),l}const Ka=m.createContext(null);function Ja({clientId:t,nonce:a,locale:r,onScriptLoadSuccess:s,onScriptLoadError:i,children:l}){const n=Za({nonce:a,onScriptLoadSuccess:s,onScriptLoadError:i,locale:r}),o=m.useMemo(()=>({locale:r,clientId:t,scriptLoadedSuccessfully:n}),[t,n]);return gt.createElement(Ka.Provider,{value:o},l)}const Tt="prism_token",ke={getToken(){return localStorage.getItem(Tt)},setToken(t){localStorage.setItem(Tt,t)},removeToken(){localStorage.removeItem(Tt)}};function Aa(){return"https://ozillafest.onrender.com/api"}const Pa=Aa(),Hi=Pa.replace(/\/api\/?$/,""),te=Ya.create({baseURL:Pa,headers:{"Content-Type":"application/json"}});te.interceptors.request.use(t=>{t.baseURL=Aa();const a=ke.getToken();return a&&(t.headers.Authorization=`Bearer ${a}`),t},t=>Promise.reject(t));te.interceptors.response.use(t=>t,t=>(t.response?.status===401&&ke.removeToken(),Promise.reject(t)));const Te={AUTH:{LOGIN:"/auth/login",REGISTER:"/auth/register",LOGOUT:"/auth/logout",SEND_OTP:"/auth/resend-otp",RESEND_OTP:"/auth/resend-otp",VERIFY_OTP:"/auth/verify-otp",FORGOT_PASSWORD:"/auth/forgot-password",RESET_PASSWORD:"/auth/reset-password",GOOGLE:"/auth/google",GOOGLE_CODE_LOGIN:"/auth/google/code-login",GOOGLE_TOKEN_LOGIN:"/auth/google/token-login",GOOGLE_CONFIG:"/auth/google/config",ME:"/auth/me",PROFILE:"/auth/profile"},TICKETS:{MY_TICKETS:"/tickets/my-tickets",REQUEST:"/tickets/request",BY_ID:"/tickets/:id",PAYMENT_PROOF:"/tickets/:id/payment-proof",VERIFY:"/tickets/:id/verify"},CONTENT:{EVENTS:"/content/events",EVENT_BY_ID:"/content/events/:id",SPONSORS:"/content/sponsors",FACILITIES:"/content/facilities",CONTACT:"/content/contact"}},Ta="ozilla_local_users";let lt=!1;function Ee(t){return String(t||"").toLowerCase().trim()}function $e(t){return String(t||"").trim()}function We(){try{const t=localStorage.getItem(Ta),a=t?JSON.parse(t):[];return Array.isArray(a)?a:[]}catch{return[]}}function Ve(t){localStorage.setItem(Ta,JSON.stringify(t))}function Qa(t){const a={sub:t.id,email:t.email,mode:"local-fallback"};return`local.${btoa(JSON.stringify(a))}`}function Et(t){const a=String(t||"");if(!a)return null;if(a.startsWith("local."))try{return JSON.parse(atob(a.slice(6)))}catch{return null}const r=a.split(".");if(r.length===3)try{return JSON.parse(atob(r[1]))}catch{return null}return null}function jt(t){return{id:t.id,firstName:t.firstName,lastName:t.lastName,name:t.name||`${t.firstName||""} ${t.lastName||""}`.trim(),email:t.email,phone:t.phone,role:t.role||"user"}}function nt(t={}){const a=String(t.firstName||"Local").trim()||"Local",r=String(t.lastName||"User").trim()||"User",s=Ee(t.email||"local@ozillafestival.com"),i=$e(t.phone||"+923000000000");return{id:t.id||`local-user-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,firstName:a,lastName:r,name:`${a} ${r}`.trim(),email:s,phone:i,password:String(t.password||""),role:"user"}}function _t(t){return!t?.response&&(t?.code==="ERR_NETWORK"||t?.message?.includes("Network Error")||t?.message?.includes("ECONNREFUSED"))}function Ct(t){return _t(t)?(lt=!0,!0):!1}function ot(t){const a=jt(t);return{token:Qa(a),user:a,mode:"local-fallback"}}const Ze={async login(t){const a=String(t?.email||t?.phone||t?.identifier||"").trim(),r=Ee(a),s=$e(a),i=String(t?.password||"").trim();try{const l=await te.post(Te.AUTH.LOGIN,{email:a,password:i});if(l?.data?.token){const n=We(),o=n.findIndex(g=>Ee(g.email)===r||$e(g.phone)===s),c={id:l.data.user?.id||`user-${Date.now()}`,firstName:l.data.user?.firstName||"",lastName:l.data.user?.lastName||"",name:l.data.user?.name||"",email:l.data.user?.email?Ee(l.data.user.email):r,phone:l.data.user?.phone?$e(l.data.user.phone):s,password:i,role:l.data.user?.role||"user"};return o>=0?(n[o]=c,Ve(n)):Ve([c,...n]),l.data}return l.data}catch(l){const n=We(),o=n.find(g=>(Ee(g.email)===r||$e(g.phone)===s)&&g.password===i);if(o)return lt=!0,ot(o);const c=n.find(g=>Ee(g.email)===r||$e(g.phone)===s);if(c&&c.password!==i){const g=new Error("Invalid credentials. Please check your password.");throw g.response={status:401,data:{message:"Invalid credentials. Please check your password."}},g}throw l}},async register(t){const a=Ee(t?.email),r=$e(t?.phone),s=String(t?.password||"").trim(),i=We(),l=i.find(o=>Ee(o.email)===a),n=i.find(o=>$e(o.phone)===r);try{const o=await te.post(Te.AUTH.REGISTER,{...t,email:a,phone:r,password:s});if(o?.data?.token){const c=nt({id:o.data.user?.id,firstName:t.firstName,lastName:t.lastName,email:a,phone:r,password:s}),g=i.filter(u=>Ee(u.email)!==a&&$e(u.phone)!==r);Ve([c,...g])}return o.data}catch(o){if(o?.response?.status===409||o?.response?.data?.message)throw o;if(l){const g=new Error("Account already exists with this email. Please log in.");throw g.response={status:409,data:{message:"Account already exists with this email. Please log in."}},g}if(n){const g=new Error("Account already exists with this phone number. Please log in.");throw g.response={status:409,data:{message:"Account already exists with this phone number. Please log in."}},g}const c=nt({...t,email:a,phone:r,password:s});return Ve([c,...i]),lt=!0,ot(c)}},async sendOtp(t){const a=Ee(t);try{return(await te.post(Te.AUTH.SEND_OTP,{email:a})).data}catch(r){if(r?.response?.status===404)try{return(await te.post(Te.AUTH.RESEND_OTP,{email:a})).data}catch(s){if(s?.response?.data?.message)throw s}if(r?.response?.data?.message)throw r;if(_t(r)){const s=new Error("Cannot connect to backend server. Please ensure the backend server is running and reachable.");throw s.response={status:503,data:{message:"Cannot connect to backend server. Please ensure the backend server is running and reachable."}},s}throw r}},async resendOtp(t){return this.sendOtp(t)},async verifyOtp(t){const a=Ee(t?.email),r=String(t?.otp||"").trim();try{return(await te.post(Te.AUTH.VERIFY_OTP,{email:a,otp:r})).data}catch(s){if(s?.response?.data?.message)throw s;if(_t(s)){const i=new Error("Cannot connect to backend server at http://localhost:5000. Please ensure the backend server is running.");throw i.response={status:503,data:{message:"Cannot connect to backend server at http://localhost:5000. Please ensure the backend server is running."}},i}throw s}},async getCurrentUser(){const t=ke.getToken();if(!t){const a=new Error("Unauthorized");throw a.response={status:401,data:{message:"Unauthorized"}},a}try{return(await te.get(Te.AUTH.ME)).data}catch(a){const r=Et(t);if(r?.mode==="local-fallback"||String(t||"").startsWith("local.")){const i=We().find(l=>l.id===r?.sub||Ee(l.email)===Ee(r?.email));if(i)return jt(i)}throw ke.removeToken(),a}},async logout(){ke.removeToken();try{localStorage.removeItem("ozilla_local_users")}catch{}try{return(await te.post(Te.AUTH.LOGOUT)).data}catch{return{message:"Logged out successfully"}}},async forgotPassword(t){return(await te.post(Te.AUTH.FORGOT_PASSWORD,{email:t})).data},async resetPassword(t){return(await te.post(Te.AUTH.RESET_PASSWORD,t)).data},async getGoogleConfig(){try{return(await te.get(Te.AUTH.GOOGLE_CONFIG)).data?.clientId||null}catch{return null}},async googleAuth(t,a){if(lt){if(!a?.email)throw new Error("Google account email is required");const r=nt(a),s=We();return s.some(i=>i.email===r.email)||Ve([r,...s]),ot(r)}try{return(await te.post(Te.AUTH.GOOGLE,{token:t,profile:a})).data}catch(r){if(Ct(r)&&a?.email){const s=nt(a);return ot(s)}throw r}},async googleCodeLogin(t,a="postmessage",r){if(lt){if(!r?.email)throw new Error("Google account email is required");const s=nt(r),i=We();return i.some(l=>l.email===s.email)||Ve([s,...i]),ot(s)}try{return(await te.post(Te.AUTH.GOOGLE_CODE_LOGIN,{code:t,redirectUri:a,profile:r})).data}catch(s){if(Ct(s)&&r?.email){const i=nt(r);return ot(i)}throw s}},async googleTokenLogin(t,a){return this.googleAuth(t,a)},async updateProfile(t){if(lt){const a=ke.getToken(),r=Et(a),s=We(),i=s.findIndex(o=>o.id===r?.sub||o.email===r?.email);if(i===-1){const o=new Error("Unauthorized");throw o.response={status:401,data:{message:"Unauthorized"}},o}const l=s[i],n={...l,firstName:typeof t?.firstName=="string"?t.firstName.trim():l.firstName,lastName:typeof t?.lastName=="string"?t.lastName.trim():l.lastName,phone:typeof t?.phone=="string"?t.phone.trim():l.phone};return n.name=`${n.firstName||""} ${n.lastName||""}`.trim()||l.name,s[i]=n,Ve(s),{message:"Profile updated successfully",user:jt(n)}}try{return(await te.put(Te.AUTH.PROFILE,t)).data}catch(a){if(Ct(a)){const r=ke.getToken(),s=Et(r),i=We(),l=i.findIndex(c=>c.id===s?.sub||c.email===s?.email);if(l===-1){const c=new Error("Unauthorized");throw c.response={status:401,data:{message:"Unauthorized"}},c}const n=i[l],o={...n,firstName:typeof t?.firstName=="string"?t.firstName.trim():n.firstName,lastName:typeof t?.lastName=="string"?t.lastName.trim():n.lastName,phone:typeof t?.phone=="string"?t.phone.trim():n.phone};return o.name=`${o.firstName||""} ${o.lastName||""}`.trim()||n.name,i[l]=o,Ve(i),{message:"Profile updated successfully",user:jt(o)}}throw a}}},Ea=m.createContext(null);function er({children:t}){const[a,r]=m.useState(null),[s,i]=m.useState(!0);m.useEffect(()=>{l()},[]);const l=async()=>{try{if(ke.getToken()){const k=await Ze.getCurrentUser();r(k)}}catch{ke.removeToken()}finally{i(!1)}},n=async y=>{const k=await Ze.login(y);return ke.setToken(k.token),r(k.user),k},o=async y=>{const k=await Ze.register(y);return ke.setToken(k.token),r(k.user),k},c=()=>{Ze.logout().catch(()=>{}),ke.removeToken(),r(null)},g=a?.role==="admin"||["ubair1100@gmail.com","admin@ozillafestival.com","muhammadubair@gmail.com","admin@prism.com"].includes(String(a?.email||"").toLowerCase().trim()),u={user:a,isAdmin:g,loading:s,login:n,register:o,logout:c,checkAuth:l};return e.jsx(Ea.Provider,{value:u,children:t})}const tr="modulepreload",ar=function(t){return"/ozillafest/"+t},Xt={},$t=function(a,r,s){let i=Promise.resolve();if(r&&r.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),o=n?.nonce||n?.getAttribute("nonce");i=Promise.allSettled(r.map(c=>{if(c=ar(c),c in Xt)return;Xt[c]=!0;const g=c.endsWith(".css"),u=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const y=document.createElement("link");if(y.rel=g?"stylesheet":tr,g||(y.as="script"),y.crossOrigin="",y.href=c,o&&y.setAttribute("nonce",o),document.head.appendChild(y),g)return new Promise((k,A)=>{y.addEventListener("load",k),y.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${c}`)))})}))}function l(n){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=n,window.dispatchEvent(o),!o.defaultPrevented)throw n}return i.then(n=>{for(const o of n||[])o.status==="rejected"&&l(o.reason);return a().catch(l)})};function Je(){const t=m.useContext(Ea);if(!t)throw new Error("useAuth must be used within an AuthProvider");return t}function rr({children:t}){const{user:a,loading:r}=Je(),s=Ke();if(r)return e.jsx("div",{className:"flex items-center justify-center min-h-screen",children:"Loading..."});if(!a){const i=`${s.pathname}${s.search}`,l=new URLSearchParams({returnTo:i}).toString();return e.jsx(xe,{to:`/login?${l}`,replace:!0})}return t||e.jsx(ut,{})}function St(t,a="/dashboard"){if(!t||typeof t!="string")return a;let r=t.trim();if(r.startsWith("//")||/^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(r))return a;r.startsWith("/ozillafest")&&(r=r.slice(11)),r.startsWith("/")||(r=`/${r}`);const s=r.split("?")[0].replace(/\/$/,"");return!s||s==="/login"||s==="/register"?a:r}function sr({children:t}){const{user:a,loading:r}=Je(),s=Ke();if(r)return e.jsx("div",{className:"flex items-center justify-center min-h-screen",children:"Loading..."});if(a){const l=new URLSearchParams(s.search).get("returnTo"),n=St(l,"/dashboard");return e.jsx(xe,{to:n,replace:!0})}return t||e.jsx(ut,{})}function V(t){if(!t||typeof t!="string"||t.startsWith("http://")||t.startsWith("https://")||t.startsWith("data:")||t.startsWith("blob:"))return t;const a="/ozillafest/",r=a.endsWith("/")?a:`${a}/`,s=t.replace(/^\/+/,"");return s.startsWith("assets/")||s.startsWith("favicon")?`${r}${s}`:t.startsWith("/")?`${r}${s}`:t}function ir({className:t="",nodeColor:a="#EC4899",lineColor:r="236, 72, 153",secondaryColor:s="255, 90, 31",maxDistance:i=135,speed:l=.5}){const n=m.useRef(null);return m.useEffect(()=>{const o=n.current;if(!o)return;const c=o.getContext("2d",{alpha:!0});if(!c)return;let g=null,u=!0,y=!1,k=o.width=o.parentElement?.clientWidth||window.innerWidth,A=o.height=o.parentElement?.clientHeight||window.innerHeight;const p=k<768?18:34,b=340,x=450,M=i*i;let j={x:k/2,y:A/2,active:!1},f={rotX:0,rotY:0,targetRotX:0,targetRotY:0};const d=[];for(let $=0;$<p;$++)d.push({x:(Math.random()-.5)*k*1.1,y:(Math.random()-.5)*A*1.1,z:(Math.random()-.5)*x,vx:(Math.random()-.5)*l*.7,vy:(Math.random()-.5)*l*.7,vz:(Math.random()-.5)*l*.7,radius:Math.random()*1.8+1.2,colorType:Math.random()>.4?"primary":"secondary"});const _=()=>{o.parentElement&&(k=o.width=o.parentElement.clientWidth||window.innerWidth,A=o.height=o.parentElement.clientHeight||window.innerHeight)};window.addEventListener("resize",_,{passive:!0});const I=$=>{if(!u)return;const T=o.getBoundingClientRect();j.x=$.clientX-T.left,j.y=$.clientY-T.top,j.active=!0;const H=(j.x-k/2)/(k/2),Z=(j.y-A/2)/(A/2);f.targetRotY=H*.14,f.targetRotX=-Z*.14},P=()=>{j.active=!1,f.targetRotX=0,f.targetRotY=0};window.addEventListener("mousemove",I,{passive:!0}),window.addEventListener("mouseleave",P,{passive:!0});const h=()=>{if(!u||document.hidden){y=!1;return}c.clearRect(0,0,k,A),f.rotX+=(f.targetRotX-f.rotX)*.05,f.rotY+=(f.targetRotY-f.rotY)*.05;const $=Math.cos(f.rotY),T=Math.sin(f.rotY),H=Math.cos(f.rotX),Z=Math.sin(f.rotX),U=k/2,F=A/2,O=k*.65,Y=A*.65,de=x*.55,N=[];for(let D=0;D<p;D++){const E=d[D];E.x+=E.vx,E.y+=E.vy,E.z+=E.vz,(E.x<-O||E.x>O)&&(E.vx*=-1),(E.y<-Y||E.y>Y)&&(E.vy*=-1),(E.z<-de||E.z>de)&&(E.vz*=-1);const re=E.x*$-E.z*T,ee=E.z*$+E.x*T,B=E.y*H-ee*Z,le=ee*H+E.y*Z,se=le+x;if(se<=0)continue;const ie=b/(b+se*.65),pe=U+re*ie,je=F+B*ie,ve=Math.max(.18,Math.min(.85,(le+x)/(x*1.4)));N.push({x:pe,y:je,scale:ie,alpha:ve,radius:Math.max(1.2,E.radius*ie),colorType:E.colorType})}const z=N.length;for(let D=0;D<z;D++){const E=N[D];let re=0;for(let ee=D+1;ee<z&&re<3;ee++){const B=N[ee],le=E.x-B.x,se=E.y-B.y,ie=le*le+se*se;if(ie<M){re++;const pe=Math.sqrt(ie),je=(1-pe/i)*.4*Math.min(E.alpha,B.alpha),ve=E.colorType==="primary"?r:s;c.beginPath(),c.moveTo(E.x,E.y),c.lineTo(B.x,B.y),c.strokeStyle=`rgba(${ve}, ${je})`,c.lineWidth=Math.max(.5,(1-pe/i)*1.2),c.stroke()}}}for(let D=0;D<z;D++){const E=N[D],re=E.colorType==="primary"?`rgba(${r}, ${E.alpha})`:`rgba(${s}, ${E.alpha})`;c.beginPath(),c.arc(E.x,E.y,E.radius,0,Math.PI*2),c.fillStyle=re,c.fill()}g=requestAnimationFrame(h)},w=()=>{!y&&u&&!document.hidden&&(y=!0,g=requestAnimationFrame(h))},L=()=>{y=!1,g&&(cancelAnimationFrame(g),g=null)};let R=null;"IntersectionObserver"in window?(R=new IntersectionObserver(([$])=>{u=$.isIntersecting,u?w():L()},{threshold:.05}),R.observe(o)):w();const q=()=>{document.hidden?L():u&&w()};return document.addEventListener("visibilitychange",q),()=>{L(),window.removeEventListener("resize",_),window.removeEventListener("mousemove",I),window.removeEventListener("mouseleave",P),document.removeEventListener("visibilitychange",q),R&&R.disconnect()}},[a,r,s,i,l]),e.jsx("canvas",{ref:n,className:`plexus-net-canvas ${t}`,"aria-hidden":"true",style:{position:"absolute",inset:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:1,willChange:"transform"}})}const Ht=gt.memo(ir);function Lt({children:t}){const a=Ke(),r=a.pathname==="/login",s=a.pathname==="/register",[i,l]=m.useState({x:0,y:0}),[n,o]=m.useState({x:50,y:42}),c=u=>{if(u.pointerType==="touch")return;const y=u.currentTarget.getBoundingClientRect(),k=(u.clientX-y.left)/y.width,A=(u.clientY-y.top)/y.height;l({x:(.5-A)*10,y:(k-.5)*10}),o({x:k*100,y:A*100})},g=()=>{l({x:0,y:0}),o({x:50,y:42})};return e.jsxs("main",{className:`kx-page auth-page ${r?"auth-page-login":""} ${s?"auth-page-register":""}`,children:[e.jsx(Ht,{nodeColor:"#EC4899",lineColor:"236, 72, 153",secondaryColor:"255, 90, 31",maxDistance:130,speed:.4}),e.jsx("div",{className:"kx-grid","aria-hidden":"true"}),e.jsx("div",{className:"kx-noise","aria-hidden":"true"}),e.jsx("div",{className:"kx-halo kx-halo-top","aria-hidden":"true"}),e.jsx("div",{className:"kx-halo kx-halo-bottom","aria-hidden":"true"}),e.jsx("div",{className:"kx-orb kx-orb-left","aria-hidden":"true"}),e.jsx("div",{className:"kx-orb kx-orb-right","aria-hidden":"true"}),e.jsxs("section",{className:`kx-stage ${s?"kx-stage-wide":""}`,children:[e.jsx("div",{className:"kx-tilt",onPointerMove:c,onPointerLeave:g,onPointerCancel:g,style:{transform:`rotateX(${i.x}deg) rotateY(${i.y}deg)`},children:e.jsxs("div",{className:"kx-card-shell",children:[e.jsx("div",{className:"kx-shadow","aria-hidden":"true"}),e.jsxs("div",{className:"kx-runners","aria-hidden":"true",children:[e.jsx("span",{className:"kx-runner kx-runner-top"}),e.jsx("span",{className:"kx-runner kx-runner-right"}),e.jsx("span",{className:"kx-runner kx-runner-bottom"}),e.jsx("span",{className:"kx-runner kx-runner-left"})]}),e.jsxs("article",{className:"kx-card",children:[e.jsx("div",{className:"kx-pointer-glow","aria-hidden":"true",style:{left:`${n.x}%`,top:`${n.y}%`}}),e.jsx("div",{className:"kx-card-pattern","aria-hidden":"true"}),e.jsxs("header",{className:"kx-header",children:[e.jsx(J,{to:"/",className:"kx-logo-link","aria-label":"OZILLA FEST Home",children:e.jsxs("div",{className:"kx-logo",children:[e.jsx("img",{src:V("/assets/ozilla/logo.png"),alt:"OZILLA FEST Logo",onError:u=>{u.currentTarget.src=V("/assets/logo.jpeg")}}),e.jsx("i",{"aria-hidden":"true"})]})}),e.jsx("span",{className:"kx-tag",children:"PAKISTAN'S PREMIER MUSIC FESTIVAL"}),e.jsx("h1",{className:"kx-title",children:r?"Welcome Back":"Join OZILLA FEST"}),e.jsx("p",{className:"kx-subtitle",children:r?"Sign in to access your passes, tickets & workspace":"Create your account for the ultimate festival experience"}),e.jsxs("div",{className:"kx-tabs",children:[e.jsx(J,{to:`/login${a.search}`,className:`kx-tab-btn ${r?"active":""}`,children:"Sign In"}),e.jsx(J,{to:`/register${a.search}`,className:`kx-tab-btn ${s?"active":""}`,children:"Create Account"})]})]}),e.jsx("div",{className:"kx-card-body",children:t||e.jsx(ut,{})})]})]})}),e.jsxs("div",{className:"auth-center-ribbon",children:[e.jsx("span",{children:"📅 Nov 01, 2026"}),e.jsx("span",{children:"📍 Lahore, Pakistan"}),e.jsx("span",{children:"⭐ 10,000+ Fans"})]})]})]})}function nr({children:t,className:a="",onClick:r,mouseX:s,spring:i,distance:l,magnification:n,baseItemSize:o,label:c}){const g=m.useRef(null),u=Na(0),y=qt(s,x=>{if(x===1/0||!g.current)return l;const M=g.current.getBoundingClientRect(),j=M.left+M.width/2;return x-j}),k=qt(y,[-l,0,l],[o,n,o]),A=$a(k,i),v=x=>{(x.key==="Enter"||x.key===" ")&&(x.preventDefault(),r?.())},p=()=>{u.set(1)},b=()=>{u.set(0)};return e.jsx(oe.div,{ref:g,style:{width:A,height:A},onHoverStart:p,onHoverEnd:b,onFocus:p,onBlur:b,onClick:r,className:`dock-item ${a}`,tabIndex:0,role:"button","aria-haspopup":"true","aria-label":c,onKeyDown:v,children:m.Children.map(t,x=>m.cloneElement(x,{isHovered:u}))})}function or({children:t,className:a="",...r}){const{isHovered:s}=r,[i,l]=m.useState(!1);return m.useEffect(()=>{if(!s)return;const n=s.on("change",o=>{l(o===1)});return()=>n()},[s]),e.jsx(Ha,{children:i&&e.jsx(oe.div,{initial:{opacity:0,y:-4,scale:.85},animate:{opacity:1,y:0,scale:1},exit:{opacity:0,y:-4,scale:.85},transition:{duration:.15},className:`dock-label ${a}`,role:"tooltip",style:{x:"-50%"},children:t})})}function lr({children:t,className:a=""}){return e.jsx("div",{className:`dock-icon ${a}`,children:t})}function cr({items:t,className:a="",spring:r={mass:.1,stiffness:220,damping:18},magnification:s=52,distance:i=120,panelHeight:l=44,baseItemSize:n=36}){const o=Na(1/0),c=Ke(),g=ct();return e.jsx("div",{className:"dock-outer",children:e.jsx(oe.div,{onMouseMove:u=>o.set(u.clientX),onMouseLeave:()=>o.set(1/0),className:`dock-panel ${a}`,style:{height:l},role:"toolbar","aria-label":"Application dock",children:t.map((u,y)=>{const k=c.pathname===u.to||u.to!=="/"&&c.pathname.startsWith(u.to)||u.to==="/"&&c.pathname==="/dashboard";return e.jsxs(nr,{onClick:()=>{u.onClick?.(),u.to&&g(u.to)},className:`${u.className||""} ${k?"active":""}`,mouseX:o,spring:r,distance:i,magnification:s,baseItemSize:n,label:u.label,children:[e.jsx(lr,{children:u.icon}),e.jsx(or,{children:u.label})]},u.to||y)})})})}function ye({path:t,size:a=24,viewBox:r="0 0 24 24",fill:s="none",stroke:i="currentColor",strokeWidth:l=1.8}){return e.jsx("svg",{width:a,height:a,viewBox:r,fill:s,stroke:i,strokeWidth:l,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:t})}const yt={home:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 10.5 12 3l9 7.5"}),e.jsx("path",{d:"M5 9.5V21h14V9.5"}),e.jsx("path",{d:"M9 21v-6h6v6"})]})}),calendar:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"3",y:"4",width:"18",height:"18",rx:"2"}),e.jsx("path",{d:"M16 2v4M8 2v4M3 10h18"})]})}),mic:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"9",y:"2",width:"6",height:"12",rx:"3"}),e.jsx("path",{d:"M5 10a7 7 0 0 0 14 0"}),e.jsx("path",{d:"M12 17v5"})]})}),clock:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("circle",{cx:"12",cy:"12",r:"9"}),e.jsx("path",{d:"M12 7v5l3 3"})]})}),history:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 12a9 9 0 1 0 3-6.7"}),e.jsx("path",{d:"M3 4v5h5"}),e.jsx("path",{d:"M12 8v4l3 2"})]})}),hotels:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M2 21V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v16"}),e.jsx("path",{d:"M2 21h20"}),e.jsx("path",{d:"M6 7h4M6 11h4M14 7h4M14 11h4M6 15h4M14 15h4M6 19h4M14 19h4"})]})}),restaurants:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M4 21v-8a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v8"}),e.jsx("path",{d:"M2 21h20"}),e.jsx("path",{d:"M8 9V3M12 9V3M16 9V3"}),e.jsx("path",{d:"M4 13h16"})]})}),discounts:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M20.6 13.4 12 22 2 12 3.5 4.5 11 3l9.6 10.4Z"}),e.jsx("circle",{cx:"8",cy:"8",r:"1.5"}),e.jsx("path",{d:"m15.5 5.5 4 4"})]})}),facilities:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 21V7l6-4 6 4v14"}),e.jsx("path",{d:"M15 21V9h6v12"}),e.jsx("path",{d:"M3 21h18"}),e.jsx("path",{d:"M7 10h3M7 14h3M7 18h3"})]})}),sponsorship:e.jsx(ye,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M12 21s-7.5-4.6-10-9.2C.6 8.6 3 5 6.5 5c2 0 3.5 1 5.5 3 2-2 3.5-3 5.5-3C21 5 23.4 8.6 22 11.8 19.5 16.4 12 21 12 21Z"})})}),sparkle:e.jsx(ye,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"m12 3-1.9 5.8a2 2 0 0 1-1.3 1.3L3 12l5.8 1.9a2 2 0 0 1 1.3 1.3L12 21l1.9-5.8a2 2 0 0 1 1.3-1.3L21 12l-5.8-1.9a2 2 0 0 1-1.3-1.3Z"})})}),ticket:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 9V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v3a3 3 0 0 0 0 6v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3a3 3 0 0 0 0-6Z"}),e.jsx("path",{d:"M13 5v2M13 11v2M13 17v2"})]})}),contact:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m3 7 9 6 9-6"})]})}),shield:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M12 22s8-3.6 8-10V5l-8-3-8 3v7c0 6.4 8 10 8 10Z"}),e.jsx("path",{d:"m9 11.5 2 2 4-4"})]})}),user:e.jsx(ye,{path:e.jsxs(e.Fragment,{children:[e.jsx("circle",{cx:"12",cy:"8",r:"4"}),e.jsx("path",{d:"M4 21c0-4 4-6 8-6s8 2 8 6"})]})}),menu:e.jsx(ye,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M3 6h18M3 12h18M3 18h18"})})}),close:e.jsx(ye,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M5 5l14 14M19 5 5 19"})})})},dr=[{label:"Home",to:"/#home",icon:"home"},{label:"Ticket Portal",to:"/tickets",icon:"ticket",cta:!0},{label:"Schedule",to:"/schedule",icon:"calendar"},{label:"Lineup",to:"/#celebrities",icon:"mic"},{label:"VIP Passes",to:"/#vip-experience",icon:"ticket"},{label:"Hotels",to:"/hotels",icon:"hotels"},{label:"Facilities",to:"/#facilities",icon:"facilities"},{label:"Sponsorship",to:"/#sponsorship",icon:"sponsorship"},{label:"Atmosphere",to:"/#about",icon:"sparkle"},{label:"My Tickets",to:"/tickets/my-tickets",icon:"ticket"}];function Zt(t){return t?.firstName||t?.name||t?.email||"Account"}function Ca(){const{user:t,isAdmin:a,logout:r}=Je(),s=ct(),i=Ke(),[l,n]=m.useState(!1),[o,c]=m.useState(!1),[g,u]=m.useState(!1),y=m.useRef(null),k=gt.useMemo(()=>{const p=[...dr];return a&&p.push({label:"Admin",to:"/admin/dashboard",icon:"shield"}),p},[a]),A=gt.useMemo(()=>k.map(p=>({label:p.label,to:p.to,icon:yt[p.icon],className:p.cta?"dock-item-cta":""})),[k]);m.useEffect(()=>{const p=()=>{y.current||(y.current=window.requestAnimationFrame(()=>{n(window.scrollY>12),y.current=null}))};return p(),window.addEventListener("scroll",p,{passive:!0}),()=>{window.removeEventListener("scroll",p),y.current&&window.cancelAnimationFrame(y.current)}},[]),m.useEffect(()=>{c(!1),u(!1)},[i.pathname]);const v=()=>{r(),s("/")};return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:`dock-site-header ${l?"scrolled":""}`,children:e.jsxs("div",{className:"dock-site-header-inner",children:[e.jsxs(J,{to:"/",className:"dock-site-brand","aria-label":"Ozilla Fest home",children:[e.jsx("span",{className:"dock-site-brand-logo",children:e.jsx("img",{src:V("/assets/ozilla/logo.png"),alt:"Ozilla Fest",onError:p=>{p.currentTarget.src=V("/assets/company-logo.jpeg")}})}),e.jsx("div",{className:"dock-site-brand-text",children:e.jsx("strong",{children:"OZILLA FEST"})})]}),e.jsx("div",{className:"dock-header-center",children:e.jsx(cr,{items:A,className:"dock-nav",magnification:58,distance:140,panelHeight:62,baseItemSize:44,spring:{mass:.1,stiffness:260,damping:19}})}),e.jsxs("div",{className:"dock-site-header-actions",children:[t?e.jsxs("div",{className:`dock-account ${g?"open":""}`,children:[e.jsxs("button",{type:"button",className:"dock-account-button",onClick:()=>u(p=>!p),"aria-expanded":g,"aria-label":"Account menu",children:[e.jsx("span",{className:"dock-account-avatar",children:String(Zt(t)).slice(0,1).toUpperCase()}),e.jsx("strong",{children:Zt(t)})]}),e.jsxs("div",{className:"dock-account-menu",children:[e.jsx(J,{to:"/account",children:"Account"}),e.jsx(J,{to:"/tickets/my-tickets",children:"My Tickets"}),a&&e.jsx(J,{to:"/admin/dashboard",children:"Admin Dashboard"}),e.jsx("button",{type:"button",onClick:v,children:"Logout"})]})]}):e.jsxs(e.Fragment,{children:[e.jsx(J,{to:"/login",className:"dock-site-login-btn",children:"Login"}),e.jsx(J,{to:"/register",className:"dock-site-register-btn",children:"Sign Up"})]}),e.jsx("button",{type:"button",className:`dock-mobile-toggle ${o?"open":""}`,"aria-label":o?"Close menu":"Open menu","aria-expanded":o,onClick:()=>c(p=>!p),children:o?yt.close:yt.menu})]})]})}),e.jsx("div",{className:`dock-mobile-overlay ${o?"open":""}`,onClick:()=>c(!1),children:e.jsxs("div",{className:`dock-mobile-panel ${o?"open":""}`,onClick:p=>p.stopPropagation(),children:[e.jsxs("div",{className:"dock-mobile-header",children:[e.jsx("div",{children:e.jsx("h2",{children:"Menu"})}),e.jsx("button",{type:"button",className:"dock-mobile-close",onClick:()=>c(!1),"aria-label":"Close menu",children:"x"})]}),e.jsx("div",{className:"dock-mobile-links",children:k.map(p=>e.jsxs(Ga,{to:p.to,className:p.cta?"dock-mobile-link-cta":"",onClick:()=>c(!1),children:[e.jsx("span",{className:"dock-mobile-link-icon",children:yt[p.icon]}),e.jsx("span",{children:p.label}),p.cta&&e.jsx("span",{className:"dock-mobile-badge",children:"PASSES"})]},p.to))}),e.jsx("div",{className:"dock-mobile-auth",children:t?e.jsx("button",{type:"button",onClick:()=>{v(),c(!1)},children:"Logout"}):e.jsxs(e.Fragment,{children:[e.jsx(J,{to:"/login",onClick:()=>c(!1),children:"Login"}),e.jsx(J,{to:"/register",onClick:()=>c(!1),children:"Sign Up"})]})})]})})]})}const pr=[{label:"Headline Artists",href:"/#celebrities"},{label:"VIP & Ticket Passes",href:"/tickets"},{label:"The Festival Vibe",href:"/#about"},{label:"World-Class Facilities",href:"/#facilities"},{label:"My Digital Passes",href:"/tickets/my-tickets"}],mr=[{label:"Instagram",href:"https://www.instagram.com/ozillafestival"}],fr=[{label:"Sponsorship Inquiries",href:"/#sponsorship"},{label:"QR Ticket Verification",href:"/verification/OZ-2026-PREVIEW"},{label:"Hotel & Travel Partners",href:"/hotels"},{label:"Privacy & Terms",href:"/privacy"}];function La(){return e.jsxs(e.Fragment,{children:[e.jsxs("footer",{className:"kex-footer",children:[e.jsx("div",{className:"kex-bg-glow","aria-hidden":"true"}),e.jsx("div",{className:"kex-bg-overlay","aria-hidden":"true"}),e.jsxs("div",{className:"kex-container",children:[e.jsxs("div",{className:"kex-nav-grid",children:[e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"MENU"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:pr.map(t=>e.jsx("li",{children:t.href.startsWith("/#")?e.jsx("a",{href:t.href,children:t.label}):e.jsx(J,{to:t.href,children:t.label})},t.label))})]}),e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"SOCIALS"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:mr.map(t=>e.jsx("li",{children:e.jsx("a",{href:t.href,target:"_blank",rel:"noopener noreferrer",children:t.label})},t.label))})]}),e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"RESOURCES"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:fr.map(t=>e.jsx("li",{children:t.href.startsWith("/#")?e.jsx("a",{href:t.href,children:t.label}):e.jsx(J,{to:t.href,children:t.label})},t.label))}),e.jsx("div",{className:"kex-action-wrap",children:e.jsx("a",{href:"mailto:ozillafestival@gmail.com",className:"kex-pill-btn",children:"Send a message"})})]})]}),e.jsx("div",{className:"kex-hero-word-wrap","aria-hidden":"true",children:e.jsx("span",{className:"kex-hero-word",children:"OZILLA FEST"})}),e.jsxs("div",{className:"kex-bottom-row",children:[e.jsxs("div",{className:"kex-bottom-links",children:[e.jsx(J,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"·"}),e.jsx(J,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"·"}),e.jsx(J,{to:"/verification/OZ-2026-PREVIEW",children:"QR Verification"})]}),e.jsx("p",{className:"kex-bottom-copy",children:"© 2026 OZILLA FEST & Prism Entertainment. All rights reserved."})]})]})]}),e.jsx("style",{children:gr})]})}const gr=`
...
`;function Fe({children:t}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-transparent text-white overflow-x-hidden w-full relative z-[1]",children:[e.jsx(Ca,{}),e.jsx("div",{className:"flex-1 w-full overflow-x-hidden bg-transparent",children:t||e.jsx(ut,{})}),e.jsx(La,{})]})}function It({children:t}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-transparent text-white overflow-x-hidden w-full font-['Plus_Jakarta_Sans',sans-serif] dock-app-shell relative z-[1]",children:[e.jsx(Ca,{}),e.jsx("main",{className:"flex-1 px-4 sm:px-6 py-6 md:py-10 app-main app-content dock-app-content bg-transparent",children:e.jsx("div",{className:"w-full max-w-[1280px] mx-auto",children:t||e.jsx(ut,{})})}),e.jsx(La,{})]})}function Ia(){return e.jsx("div",{className:"flex items-center justify-center min-h-[200px]",children:e.jsx("div",{className:"animate-spin rounded-full h-16 w-16 border-4 border-purple-600 border-t-transparent"})})}let vt;function ur(){return window.google?.accounts?.id||window.google?.accounts?.oauth2?Promise.resolve(window.google):vt||(vt=new Promise((t,a)=>{const r=document.querySelector('script[data-google-identity="true"]');if(r){r.addEventListener("load",()=>t(window.google),{once:!0}),r.addEventListener("error",()=>a(new Error("Failed to load Google Identity script")),{once:!0});return}const s=document.createElement("script");s.src="https://accounts.google.com/gsi/client",s.async=!0,s.defer=!0,s.dataset.googleIdentity="true",s.onload=()=>t(window.google),s.onerror=()=>a(new Error("Failed to load Google Identity script")),document.head.appendChild(s)}),vt)}async function hr(t){const a=await fetch("https://www.googleapis.com/oauth2/v3/userinfo",{headers:{Authorization:`Bearer ${t}`}});if(!a.ok)throw new Error("Failed to fetch Google profile");return a.json()}async function Ra({clientId:t,onProfile:a,onError:r}){if(t.includes("placeholder")||t.includes("your_google"))throw new Error("Google Client ID is not configured. Please add GOOGLE_CLIENT_ID in Render or VITE_GOOGLE_CLIENT_ID in client/.env");if(await ur(),!window.google?.accounts?.oauth2?.initTokenClient)throw new Error("Google Identity Services library is unavailable");return new Promise((s,i)=>{window.google.accounts.oauth2.initTokenClient({client_id:t,scope:"openid email profile",prompt:"select_account",callback:async n=>{try{if(n?.error)throw n.error==="popup_closed_by_user"?new Error("Google sign-in was cancelled"):new Error(n.error_description||n.error||"Google login failed");if(!n?.access_token)throw new Error("Google sign-in was cancelled");const o=await hr(n.access_token);if(!o?.email)throw new Error("Could not retrieve email from selected Google account");a&&await a(o,n.access_token),s(o)}catch(o){r&&r(o),i(o)}},error_callback:n=>{const o=new Error(n?.message||"Google account chooser popup failed");r&&r(o),i(o)}}).requestAccessToken({prompt:"select_account"})})}function xr(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m4 7 8 6 8-6"})]})}function br(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"4",y:"10",width:"16",height:"11",rx:"2"}),e.jsx("path",{d:"M8 10V7a4 4 0 0 1 8 0v3"})]})}function yr({hidden:t=!1,...a}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...a,children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"}),t&&e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}function vr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M5 12h14M13 6l6 6-6 6"})})}function wr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"m5 12 4 4L19 6"})})}function kr(t){return e.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",...t,children:[e.jsx("path",{fill:"#4285F4",d:"M21.6 12.23c0-.71-.06-1.4-.18-2.06H12v3.9h5.38a4.6 4.6 0 0 1-2 3.01v2.53h3.23c1.9-1.75 2.99-4.32 2.99-7.38Z"}),e.jsx("path",{fill:"#34A853",d:"M12 22c2.7 0 4.97-.9 6.62-2.39l-3.23-2.53c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.61-4.13H3.05v2.61A10 10 0 0 0 12 22Z"}),e.jsx("path",{fill:"#FBBC05",d:"M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.3.31-1.91V7.48H3.05A10 10 0 0 0 2 12c0 1.61.39 3.14 1.05 4.52l3.34-2.61Z"}),e.jsx("path",{fill:"#EA4335",d:"M12 5.96c1.47 0 2.79.51 3.82 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.95 5.48l3.34 2.61C7.18 7.72 9.39 5.96 12 5.96Z"})]})}function jr(){const t=ct(),a=Ke(),{login:r,checkAuth:s}=Je(),i="231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com",l=new URLSearchParams(a.search).get("returnTo"),n=St(l,"/dashboard"),[o,c]=m.useState({email:"",password:""}),[g,u]=m.useState(null),[y,k]=m.useState(!1),[A,v]=m.useState(!0),[p,b]=m.useState(""),[x,M]=m.useState(""),[j,f]=m.useState(!1),[d,_]=m.useState(!1),I=w=>{M(""),c(L=>({...L,[w.target.name]:w.target.value}))},P=async w=>{if(w.preventDefault(),!(j||d)){b(""),M(""),f(!0);try{await r({email:String(o.email||"").trim().toLowerCase(),password:String(o.password||"")}),M("Login successful. Preparing your festival workspace..."),await new Promise(L=>setTimeout(L,450)),t(n)}catch(L){b(L.response?.data?.message||L.message||"Invalid email or password")}finally{f(!1)}}},h=async()=>{b(""),M(""),_(!0);try{await Ra({clientId:i||"231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com",onProfile:async(L,R)=>{const q=await Ze.googleAuth(R,L);ke.setToken(q.token),await s(),M(`Google sign-in successful as ${L.email}. Redirecting...`),await new Promise($=>setTimeout($,450)),t(n)}})}catch(w){const L=w.response?.data?.message||w.message||"Google sign-in failed";!L.toLowerCase().includes("cancel")&&!L.toLowerCase().includes("closed")&&b(L)}finally{_(!1)}};return e.jsxs("form",{onSubmit:P,className:"kx-form",children:[p&&e.jsx("div",{className:"kx-alert kx-alert-error",role:"alert",children:p}),x&&e.jsx("div",{className:"kx-alert kx-alert-success",role:"alert",children:x}),e.jsxs("button",{type:"button",className:"kx-google",onClick:h,disabled:d||j,children:[e.jsx(kr,{}),e.jsx("span",{children:d?"Connecting to Google...":"Continue with Google"}),e.jsx("i",{"aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-divider",children:[e.jsx("span",{}),e.jsx("em",{children:"or sign in with email"}),e.jsx("span",{})]}),e.jsxs("label",{className:`kx-field ${g==="email"?"kx-focused":""}`,children:[e.jsx(xr,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"email",value:o.email,placeholder:"Email or Mobile Number",autoComplete:"username",required:!0,onChange:I,onFocus:()=>u("email"),onBlur:()=>u(null)}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("label",{className:`kx-field ${g==="password"?"kx-focused":""}`,children:[e.jsx(br,{className:"kx-field-icon"}),e.jsx("input",{type:y?"text":"password",name:"password",value:o.password,placeholder:"Password",autoComplete:"current-password",required:!0,onChange:I,onFocus:()=>u("password"),onBlur:()=>u(null)}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>k(w=>!w),"aria-label":y?"Hide password":"Show password",children:e.jsx(yr,{hidden:y})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-meta",children:[e.jsxs("label",{className:"kx-remember",children:[e.jsx("input",{type:"checkbox",checked:A,onChange:w=>v(w.target.checked)}),e.jsx("span",{className:"kx-checkbox",children:A&&e.jsx(wr,{})}),e.jsx("span",{children:"Remember me"})]}),e.jsx("a",{href:"#forgot-password",className:"kx-forgot-link",children:"Forgot password?"})]}),e.jsxs("button",{className:"kx-sign-in",type:"submit",disabled:j||d,children:[e.jsx("span",{className:"kx-button-glow","aria-hidden":"true"}),e.jsx("span",{className:"kx-button-sheen","aria-hidden":"true"}),j?e.jsx("span",{className:"kx-spinner","aria-label":"Signing in..."}):e.jsxs("span",{className:"kx-button-copy",children:["Sign in",e.jsx(vr,{})]})]}),e.jsxs("p",{className:"kx-signup",children:["Don't have an account?"," ",e.jsx(J,{to:`/register?${new URLSearchParams({returnTo:n}).toString()}`,children:"Create account"})]}),e.jsxs("div",{className:"kx-trust-grid","aria-label":"Security indicators",children:[e.jsx("span",{children:"🔒 Secure Login"}),e.jsx("span",{children:"⚡ Fast Access"}),e.jsx("span",{children:"🛡️ Protected"}),e.jsx("span",{children:"✓ Verified"})]})]})}function Nr(){return e.jsxs("div",{className:"auth-form-container",children:[e.jsx(jr,{}),e.jsxs("div",{className:"auth-footer-links",children:[e.jsx(J,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"•"}),e.jsx(J,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"•"}),e.jsx(J,{to:"/#contact",children:"Need Help?"})]})]})}function Kt(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("path",{d:"M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"}),e.jsx("circle",{cx:"12",cy:"7",r:"4"})]})}function Sr(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m4 7 8 6 8-6"})]})}function Ar(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"})})}function Jt(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"4",y:"10",width:"16",height:"11",rx:"2"}),e.jsx("path",{d:"M8 10V7a4 4 0 0 1 8 0v3"})]})}function Qt({hidden:t=!1,...a}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...a,children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"}),t&&e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}function Pr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M5 12h14M13 6l6 6-6 6"})})}function Tr(t){return e.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",...t,children:[e.jsx("path",{fill:"#4285F4",d:"M21.6 12.23c0-.71-.06-1.4-.18-2.06H12v3.9h5.38a4.6 4.6 0 0 1-2 3.01v2.53h3.23c1.9-1.75 2.99-4.32 2.99-7.38Z"}),e.jsx("path",{fill:"#34A853",d:"M12 22c2.7 0 4.97-.9 6.62-2.39l-3.23-2.53c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.61-4.13H3.05v2.61A10 10 0 0 0 12 22Z"}),e.jsx("path",{fill:"#FBBC05",d:"M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.3.31-1.91V7.48H3.05A10 10 0 0 0 2 12c0 1.61.39 3.14 1.05 4.52l3.34-2.61Z"}),e.jsx("path",{fill:"#EA4335",d:"M12 5.96c1.47 0 2.79.51 3.82 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.95 5.48l3.34 2.61C7.18 7.72 9.39 5.96 12 5.96Z"})]})}const ea=()=>new Promise(t=>setTimeout(t,450));function Er(){const t=ct(),a=Ke(),{register:r,checkAuth:s}=Je(),i="231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com",l=new URLSearchParams(a.search).get("returnTo"),n=St(l,"/dashboard"),[o,c]=m.useState({firstName:"",lastName:"",email:"",phone:"",password:"",confirmPassword:""}),[g,u]=m.useState(null),[y,k]=m.useState(""),[A,v]=m.useState(!1),[p,b]=m.useState(!1),[x,M]=m.useState(!1),[j,f]=m.useState(!1),[d,_]=m.useState(0),[I,P]=m.useState(""),[h,w]=m.useState(""),[L,R]=m.useState(!1),[q,$]=m.useState(!1),[T,H]=m.useState(!1),[Z,U]=m.useState(!1),[F,O]=m.useState({email:!1,phone:!1,password:!1,confirmPassword:!1}),Y=/^\S+@\S+\.\S+$/.test(o.email),de=/^(\+?\d{1,3})?[\s-]?\d{10,12}$/.test(o.phone.replace(/\s+/g,"")),N={upper:/[A-Z]/.test(o.password),lower:/[a-z]/.test(o.password),number:/\d/.test(o.password),special:/[^A-Za-z0-9]/.test(o.password),length:o.password.length>=8},z=Object.values(N).filter(Boolean).length,D=z===5,E=o.confirmPassword.length>0&&o.password===o.confirmPassword,re=o.password.length>0,ee=m.useMemo(()=>re?z<=2?{label:"Weak",className:"weak",percent:28}:z===3?{label:"Medium",className:"medium",percent:52}:z===4?{label:"Strong",className:"strong",percent:78}:{label:"Excellent",className:"excellent",percent:100}:{label:"Start typing",className:"empty",percent:8},[re,z]),B=[{key:"upper",text:"Uppercase letter",met:N.upper},{key:"lower",text:"Lowercase letter",met:N.lower},{key:"number",text:"Number",met:N.number},{key:"special",text:"Special character",met:N.special},{key:"length",text:"8+ characters",met:N.length}],le=o.firstName.trim()&&o.lastName.trim()&&Y&&de&&D&&E&&p&&!L&&!q;m.useEffect(()=>{if(d<=0)return;const S=window.setInterval(()=>{_(C=>Math.max(0,C-1))},1e3);return()=>window.clearInterval(S)},[d]);const se=()=>{P(""),w("")},ie=S=>{const{name:C,value:K}=S.target;se(),c(X=>({...X,[C]:K})),C==="email"&&(k(""),v(!1),b(!1),_(0)),C in F&&K.length>0&&O(X=>({...X,[C]:!0}))},pe=S=>{const{name:C}=S.target;u(null),C in F&&O(K=>({...K,[C]:!0}))},je=async()=>{if(se(),!Y){O(S=>({...S,email:!0})),P("Please enter a valid email address before sending OTP.");return}M(!0);try{const S=await Ze.sendOtp(o.email);S?.emailDelivery==="failed"||typeof S?.message=="string"&&S.message.toLowerCase().includes("delivery failed")&&!S?.devOtp?(v(!1),P(S.emailError||"Email delivery failed: SMTP credentials (SMTP_USER and SMTP_PASS) are not configured on the backend server.")):(v(!0),b(!1),_(60),S?.devOtp?k(String(S.devOtp)):k(""),w(S.message||"OTP code has been sent to your email. Please check your inbox."))}catch(S){P(S.response?.data?.message||S.message||"Unable to send OTP.")}finally{M(!1)}},ve=async()=>{if(se(),!Y||y.trim().length<4){P("Enter the OTP sent to your email.");return}f(!0);try{const S=await Ze.verifyOtp({email:o.email,otp:y});b(!0),w(S.message||"Email verified successfully.")}catch(S){b(!1),P(S.response?.data?.message||S.message||"OTP verification failed.")}finally{f(!1)}},ae=async S=>{if(S.preventDefault(),se(),!Y){O(C=>({...C,email:!0})),P("Please enter a valid email address.");return}if(!p){P("Please verify your email OTP before creating your account.");return}if(!de){O(C=>({...C,phone:!0})),P("Please enter a valid mobile number.");return}if(!D){O(C=>({...C,password:!0})),P("Please satisfy all password requirements.");return}if(!E){O(C=>({...C,confirmPassword:!0})),P("Passwords do not match.");return}R(!0);try{await r({firstName:o.firstName,lastName:o.lastName,name:`${o.firstName} ${o.lastName}`.trim(),email:o.email,phone:o.phone,password:o.password}),w("Account created successfully. Preparing your festival workspace..."),await ea(),t(n)}catch(C){const K=C.response?.status,X=C.response?.data?.message||"Registration failed",ce=X.toLowerCase();K===409||ce.includes("already")||ce.includes("exists")?P("Account already exists with this email or phone number"):P(X)}finally{R(!1)}},G=async()=>{se(),$(!0);try{await Ra({clientId:i||"231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com",onProfile:async(C,K)=>{const X=await Ze.googleAuth(K,C);ke.setToken(X.token),await s(),w(`Google sign-up verified as ${C.email}. Welcome to OZILLA FEST!`),await ea(),t(n)}})}catch(S){const C=S.response?.data?.message||S.message||"Google sign-up failed";!C.toLowerCase().includes("cancel")&&!C.toLowerCase().includes("closed")&&P(C)}finally{$(!1)}};return e.jsxs("form",{onSubmit:ae,className:"kx-form",children:[I&&e.jsx("div",{className:"kx-alert kx-alert-error",role:"alert",children:I}),h&&e.jsx("div",{className:"kx-alert kx-alert-success",role:"alert",children:h}),e.jsxs("button",{type:"button",className:"kx-google",onClick:G,disabled:q||L,children:[e.jsx(Tr,{}),e.jsx("span",{children:q?"Connecting to Google...":"Sign up with Google"}),e.jsx("i",{"aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-divider",children:[e.jsx("span",{}),e.jsx("em",{children:"or register with email"}),e.jsx("span",{})]}),e.jsxs("div",{className:"kx-grid-row",children:[e.jsxs("label",{className:`kx-field ${g==="firstName"?"kx-focused":""}`,children:[e.jsx(Kt,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"firstName",value:o.firstName,placeholder:"First Name",autoComplete:"given-name",required:!0,onChange:ie,onFocus:()=>u("firstName"),onBlur:pe}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("label",{className:`kx-field ${g==="lastName"?"kx-focused":""}`,children:[e.jsx(Kt,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"lastName",value:o.lastName,placeholder:"Last Name",autoComplete:"family-name",required:!0,onChange:ie,onFocus:()=>u("lastName"),onBlur:pe}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]})]}),e.jsxs("label",{className:`kx-field ${g==="email"?"kx-focused":""} ${F.email&&!Y?"kx-field-invalid":""}`,children:[e.jsx(Sr,{className:"kx-field-icon"}),e.jsx("input",{type:"email",name:"email",value:o.email,placeholder:"Email address",autoComplete:"email",required:!0,onChange:ie,onFocus:()=>u("email"),onBlur:pe}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),F.email&&!Y&&e.jsx("p",{className:"kx-field-error-msg",children:"Please enter a valid email address."}),e.jsxs("div",{className:`kx-otp-box ${p?"kx-otp-verified":""}`,children:[e.jsxs("div",{className:"kx-otp-meta",children:[e.jsx("span",{className:"kx-otp-kicker",children:"Email Verification"}),e.jsx("strong",{children:p?"✓ Email verified":A?"Enter 6-digit code":"Verify email before submit"}),e.jsx("span",{className:"kx-otp-subtext",children:p?"Security verified":d>0?`Resend available in ${d}s`:"Code will be sent to your email"})]}),e.jsxs("div",{className:"kx-otp-controls",children:[e.jsx("button",{type:"button",className:"kx-otp-btn",onClick:je,disabled:x||!Y||p||d>0,children:x?"Sending...":A?"Resend OTP":"Send OTP"}),e.jsx("input",{type:"text",value:y,onChange:S=>{se(),k(S.target.value.replace(/\D/g,"").slice(0,6)),b(!1)},className:"kx-otp-input",placeholder:"Enter 6-digit OTP",inputMode:"numeric",autoComplete:"one-time-code",disabled:!A||p}),e.jsx("button",{type:"button",className:"kx-otp-btn kx-otp-btn-accent",onClick:ve,disabled:!A||p||j,children:j?"Verifying...":p?"Verified":"Verify"})]})]}),e.jsxs("label",{className:`kx-field ${g==="phone"?"kx-focused":""} ${F.phone&&!de?"kx-field-invalid":""}`,children:[e.jsx(Ar,{className:"kx-field-icon"}),e.jsx("input",{type:"tel",name:"phone",value:o.phone,placeholder:"Phone (+92 3XX XXXXXXX)",autoComplete:"tel",required:!0,onChange:ie,onFocus:()=>u("phone"),onBlur:pe}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),F.phone&&!de&&e.jsx("p",{className:"kx-field-error-msg",children:"Please enter a valid mobile number."}),e.jsxs("label",{className:`kx-field ${g==="password"?"kx-focused":""} ${F.password&&!D?"kx-field-invalid":""}`,children:[e.jsx(Jt,{className:"kx-field-icon"}),e.jsx("input",{type:T?"text":"password",name:"password",value:o.password,placeholder:"Create Password",autoComplete:"new-password",required:!0,onChange:ie,onFocus:()=>u("password"),onBlur:pe}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>H(S=>!S),"aria-label":T?"Hide password":"Show password",children:e.jsx(Qt,{hidden:T})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("div",{className:`kx-strength kx-strength-${ee.className}`,children:[e.jsxs("div",{className:"kx-strength-header",children:[e.jsx("span",{children:"Password Strength"}),e.jsx("strong",{children:ee.label})]}),e.jsx("div",{className:"kx-strength-bar-track",children:e.jsx("span",{style:{width:`${ee.percent}%`}})})]}),e.jsx("ul",{className:"kx-pwd-rules",children:B.map(S=>{const C=S.met?"kx-rule-met":re?"kx-rule-unmet":"kx-rule-neutral";return e.jsxs("li",{className:`kx-pwd-rule ${C}`,children:[e.jsx("span",{className:"kx-rule-badge",children:S.met?"✓":"•"}),e.jsx("span",{children:S.text})]},S.key)})}),e.jsxs("label",{className:`kx-field ${g==="confirmPassword"?"kx-focused":""} ${F.confirmPassword&&!E?"kx-field-invalid":""}`,children:[e.jsx(Jt,{className:"kx-field-icon"}),e.jsx("input",{type:Z?"text":"password",name:"confirmPassword",value:o.confirmPassword,placeholder:"Confirm Password",autoComplete:"new-password",required:!0,onChange:ie,onFocus:()=>u("confirmPassword"),onBlur:pe}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>U(S=>!S),"aria-label":Z?"Hide confirm password":"Show confirm password",children:e.jsx(Qt,{hidden:Z})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),F.confirmPassword&&!E&&e.jsx("p",{className:"kx-field-error-msg",children:"Passwords do not match."}),e.jsxs("button",{className:"kx-sign-in",type:"submit",disabled:!le,children:[e.jsx("span",{className:"kx-button-glow","aria-hidden":"true"}),e.jsx("span",{className:"kx-button-sheen","aria-hidden":"true"}),L?e.jsx("span",{className:"kx-spinner","aria-label":"Creating account..."}):e.jsxs("span",{className:"kx-button-copy",children:["Create Account",e.jsx(Pr,{})]})]}),e.jsxs("p",{className:"kx-signup",children:["Already have an account?"," ",e.jsx(J,{to:`/login?${new URLSearchParams({returnTo:n}).toString()}`,children:"Sign In"})]}),e.jsxs("div",{className:"kx-trust-grid","aria-label":"Security indicators",children:[e.jsx("span",{children:"🔒 Secure Sign Up"}),e.jsx("span",{children:"⚡ Instant Access"}),e.jsx("span",{children:"🛡️ Protected"}),e.jsx("span",{children:"✓ Google Verified"})]})]})}function Cr(){return e.jsxs("div",{className:"auth-form-container",children:[e.jsx(Er,{}),e.jsxs("div",{className:"auth-footer-links",children:[e.jsx(J,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"•"}),e.jsx(J,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"•"}),e.jsx(J,{to:"/#contact",children:"Need Help?"})]})]})}function Lr(){const[t]=Wa(),a=ct(),{checkAuth:r}=Je(),[s,i]=m.useState("Signing you in with Google...");return m.useEffect(()=>{(async()=>{const n=t.get("token"),o=t.get("error"),c=t.get("returnTo"),g=St(c,"/dashboard");if(o){i(o==="google_not_configured"?"Google sign-in is not configured on server yet. Please add GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in server/.env.":"Google sign-in failed. Please try again.");const u=new URLSearchParams({returnTo:g}).toString();setTimeout(()=>a(`/login?${u}`,{replace:!0}),1200);return}if(!n){i("Google sign-in token not found. Please try again.");const u=new URLSearchParams({returnTo:g}).toString();setTimeout(()=>a(`/login?${u}`,{replace:!0}),1200);return}ke.setToken(n),await r(),a(g,{replace:!0})})()},[r,a,t]),e.jsx("div",{className:"auth-page",children:e.jsxs("div",{className:"auth-card",children:[e.jsx("h1",{className:"auth-title",children:"Google Sign-In"}),e.jsx("p",{className:"auth-subtitle",children:s})]})})}const Ir={hotels:[{name:"Pearl Continental Hotel (PC)",location:"Lahore, Punjab, Pakistan",rates:"Premium city-center business and leisure rates",offer:"Flexible booking options with conference and dining access.",website:"https://www.expedia.com/Lahore-Hotels-Pearl-Continental-Lahore.h6062.Hotel-Information?chkin=2026-07-23&chkout=2026-07-24&x_pwa=1&rfrr=HSR&pwa_ts=1783538185568&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=2068&destination=Lahore%2C+Punjab%2C+Pakistan&destType=MARKET&neighborhoodId=553248633981712959&selected=6062&latLong=31.554606%2C74.357155&sort=RECOMMENDED&top_dp=124&top_cur=USD&semcid=US.UB.BING.PT-c-EN.HOTEL&semdtl=a1429012176.b11315017303776210.g1kwd-82189323842618%3Aloc-144.e1c.m18d15bbf2af6c1d752fa9d1bc0e925b82.r1dbbc4399e805d7a471af9bb50c0eca6a53815556874c850795d8066b3e568804.c1.j1142691.k1152882.d182188878595064.h1e.i1.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&userIntent=&selectedRoomType=314006270&selectedRatePlan=380046345&categorySearch=any_option&searchId=60a6b42e-b43b-44af-a668-54a0fbd95022",image:V("/assets/hotels/Pearl-Continental-Lahore.jpg"),showImage:!0,description:"A flagship five-star property known for premium hospitality, executive facilities, and large event spaces.",facilities:["Luxury Rooms & Suites","Restaurants & Coffee Lounge","Swimming Pool","Fitness Center"],contact:"Reservations: +92 42 111 505 505",rating:"4.5/5"},{name:"Ramada by Wyndham Lahore",location:"Lahore, Punjab, Pakistan",rates:"Business-friendly international chain pricing",offer:"Comfort-focused stay packages with central access.",website:"https://www.guestreservations.com/ramada-by-wyndham-lahore-gulberg-ii/booking?utm_source=microsoft&utm_medium=cpc&utm_campaign=318380766&msclkid=2639f60cc7641752938d9c426507dbb5&ctTriggered=true",image:V("/assets/hotels/Ramada-by-Wyndham-Lahore-Gulberg-II.jpg"),showImage:!0,description:"An international-branded stay option designed for business travelers and families seeking modern comfort.",facilities:["Comfort Rooms","All-Day Dining","Meeting Facilities","Wi-Fi Access"],contact:"Reservations: +92 42 111 111 211",rating:"4.3/5"},{name:"Hotel Indigo Lahore",location:"Lahore, Punjab, Pakistan",rates:"Boutique premium rates for curated city stays",offer:"Lifestyle stay experience with modern interiors and city vibe.",website:"https://indigoheights.com/",image:V("/assets/hotels/Hotel-Indigo.jpg"),showImage:!0,description:"A contemporary boutique-style hotel brand experience offering design-led rooms and premium hospitality.",facilities:["Designer Rooms","Signature Dining","Fitness Facilities","Business Services"],contact:"Reservations: +92 42 111 111 111",rating:"4.4/5"},{name:"Hotel One Gulberg Lahore",location:"Lahore, Punjab, Pakistan",rates:"Upper-midscale corporate and family packages",offer:"Value-focused business stays in a prime Lahore district.",website:"https://www.guestreservations.com/hotel-one-gulberg-lahore/booking?utm_source=microsoft&utm_medium=cpc&utm_campaign=318380766&msclkid=3d22881e8b211d72a380e25028093b5b",image:V("/assets/hotels/Hotel-One-Gulberg-Lahore.jpg"),showImage:!0,description:"A trusted local hospitality brand known for practical comfort, business convenience, and central location.",facilities:["Business-Friendly Rooms","Breakfast Service","Meeting Room","24/7 Front Desk"],contact:"Reservations: +92 42 111 111 563",rating:"4.2/5"},{name:"Luxus Grand Hotel (LC)",location:"Lahore, Punjab, Pakistan",rates:"Executive and leisure stay rates",offer:"City-center premium rooms with event-friendly access.",website:"https://www.expedia.com/Lahore-Hotels-Luxus-Grand-Hotel.h16225098.Hotel-Information?chkin=2026-07-23&chkout=2026-07-24&x_pwa=1&rfrr=HSR&pwa_ts=1783538679588&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=2068&destination=Lahore%2C+Punjab%2C+Pakistan&destType=MARKET&selected=16225098&latLong=31.554606%2C74.357155&sort=RECOMMENDED&top_dp=50&top_cur=USD&semcid=US.UB.BING.PT-c-EN.HOTEL&semdtl=a1429012176.b11317216326895908.g1kwd-82326765629610%3Aloc-144.e1c.m1f413ae58b13f11ee7d78c41612f456b3.r17441980d01bf266109c2845e02c5e619d691d9360faf76d1fb0b3ff083f73b12.c1.j1142691.k1152882.d182326298507125.h1e.i1.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&userIntent=&selectedRoomType=201690559&selectedRatePlan=208425873&categorySearch=any_option&searchId=b938991e-d9ee-47cd-a5b9-bfbbe22962a7",image:V("/assets/hotels/Luxus-Grand-Hotel.jpg"),showImage:!0,description:"A modern luxury hotel in Lahore offering upscale rooms, contemporary dining, and premium guest services.",facilities:["Premium Rooms","Restaurant & Cafe","Concierge Support","Airport Transfer Assistance"],contact:"Reservations: +92 42 111 589 879",rating:"4.4/5"},{name:"Nishat Hotel Lahore",location:"Lahore, Punjab, Pakistan",rates:"Premium luxury rates with lifestyle amenities",offer:"High-end accommodation with shopping and dining proximity.",website:"https://www.booking.com/hotel/pk/the-nishat.en-gb.html?aid=2276380&label=msn-G%2AualcbtRsY8_D6yMU0tng-80333218529225%3Atikwd-80333372562144%3Aloc-144%3Aneo%3Amte%3Alp142691%3Adec%3Acid578349423%3Aagid1285329581450391%3Aclkid91bc1c0fd2ae13842aa77641760a897b&sid=d2e80396e6c920f70a72e21ba196f068&all_sr_blocks=112449101_204759422_0_2_0_670390&checkin=2026-07-14&checkout=2026-07-15&dest_id=-2767043&dest_type=city&dist=0&group_adults=2&group_children=0&hapos=1&highlighted_blocks=112449101_204759422_0_2_0_670390&hpos=1&matching_block_id=112449101_204759422_0_2_0_670390&no_rooms=1&req_adults=2&req_children=0&room1=A%2CA&sb_price_type=total&sr_order=popularity&sr_pri_blocks=112449101_204759422_0_2_0_670390_3300000&srepoch=1783539000&srpvid=7c17890e04e000e0&type=total&ucfs=1&",image:V("/assets/hotels/Nishat.jpg"),showImage:!0,description:"A luxury Lahore hospitality brand recognized for refined interiors, premium service standards, and prime locations.",facilities:["Luxury Suites","Fine Dining","Spa & Wellness","Event and Meeting Spaces"],contact:"Reservations: +92 42 111 647 428",rating:"4.6/5"}]};V("/assets/ozilla/talwinder.jpg"),V("/assets/ozilla/talwinder.jpg"),V("/assets/ozilla/Imran-Khan.jpg"),V("/assets/ozilla/Imran-Khan.jpg"),V("/assets/ozilla/Bohemia.jpg"),V("/assets/ozilla/Bohemia.jpg"),V("/assets/ozilla/hassan-raheem.jpg"),V("/assets/ozilla/hassan-raheem.jpg");const ta=[{name:"TALWINDER",isHeadliner:!0,genre:"Indie Pop / Punjabi Fusion",stage:"Main Prism Stage",bpm:"128 BPM",vibe:"Euphoric Night",src:V("/assets/ozilla/talwinder.jpg"),image:V("/assets/ozilla/talwinder.jpg"),offsetY:0},{name:"IMRAN KHAN",isHeadliner:!1,genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",src:V("/assets/ozilla/Imran-Khan.jpg"),image:V("/assets/ozilla/Imran-Khan.jpg"),offsetY:0},{name:"BOHEMIA",isHeadliner:!1,genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",src:V("/assets/ozilla/Bohemia.jpg"),image:V("/assets/ozilla/Bohemia.jpg"),offsetY:0},{name:"HASSAN RAHEEM",isHeadliner:!1,genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",src:V("/assets/ozilla/hassan-raheem.jpg"),image:V("/assets/ozilla/hassan-raheem.jpg"),offsetY:0}],aa=1.28,ra=.78;function qe(t,a,r){return Math.min(r,Math.max(a,t))}function sa(t){if(!t)return null;if(typeof t=="string")return t||null;const a=t.src||t.image;return typeof a=="string"&&a?a:null}function Rr(t){return sa(t&&typeof t=="object"&&(t.image||t.src)||t)}function zr(t){if(t&&typeof t=="object"&&"offsetY"in t){const a=t.offsetY;return typeof a=="number"&&isFinite(a)?a:0}return 0}function Mr({items:t=ta,images:a,slideWidth:r=320,slideHeight:s=440,spacing:i=2.4,direction:l="right",smoothness:n=8.5,radius:o=24,dim:c=5,background:g="transparent",sensitivity:u=5,autoPlay:y=!1,autoPlayInterval:k=3500,style:A,onItemClick:v}){const p=m.useRef(null),b=m.useRef([]),x=m.useRef(0),M=m.useRef(0),[j,f]=m.useState(0),[d,_]=m.useState(!1),[I,P]=m.useState(0),h=t&&t.length>0?t:a&&a.length>0?a:ta,w=m.useMemo(()=>h.map((N,z)=>({...N,src:Rr(N),offsetY:zr(N),name:N.name||`Artist ${z+1}`,genre:N.genre||"Live Performer",stage:N.stage||"Ozilla Arena",bpm:N.bpm||"128 BPM",vibe:N.vibe||"Festival Energy",isHeadliner:!!N.isHeadliner})),[h]),L=j>0&&j<640?Math.min(r,250):j<1024?Math.min(r,290):r,R=j>0&&j<640?Math.round(L*1.36):s,q=L+qe(i,0,10)*18,$=.15-qe(n,0,10)/10*.11,T=qe(c,0,10)/10*.75,H=.4+qe(u,0,10)/10*1.1,Z=.6+qe(u,0,10)/10*1.6,U=l==="left",F=m.useRef({count:w.length,step:q,slideWidth:L,width:j,ease:$,maxScale:aa,minScale:ra,dim:T,loop:!1,flip:U});F.current={count:w.length,step:q,slideWidth:L,width:j,ease:$,maxScale:aa,minScale:ra,dim:T,loop:!1,flip:U};const O=m.useRef({wheelMultiplier:H,dragMultiplier:Z,flip:U});O.current={wheelMultiplier:H,dragMultiplier:Z,flip:U},m.useEffect(()=>{const N=p.current;if(!N)return;const z=new ResizeObserver(D=>{D[0]&&f(D[0].contentRect.width)});return z.observe(N),f(N.getBoundingClientRect().width),()=>z.disconnect()},[]),m.useEffect(()=>{b.current.length=w.length},[w.length]),m.useEffect(()=>{if(!y||d||w.length<=1)return;const N=setInterval(()=>{P(z=>{const D=(z+1)%w.length;return x.current=D*q,D})},k);return()=>clearInterval(N)},[y,d,w.length,q,k]),m.useEffect(()=>{let N=0,z=0,D=!0,E=null;const re=ee=>{if(N=requestAnimationFrame(re),!D){z=ee;return}const B=F.current,le=z?Math.min((ee-z)/1e3,.1):1/60;if(z=ee,!B.count||B.step<=0||B.width<=0)return;const se=(B.count-1)*B.step;x.current=qe(x.current,0,se);const ie=1-Math.pow(1-B.ease,le*60);M.current+=(x.current-M.current)*ie;const pe=Math.round(M.current/B.step);pe>=0&&pe<B.count&&P(pe);const je=(B.width-B.slideWidth)/2,ve=B.width/2;for(let ae=0;ae<B.count;ae+=1){const G=b.current[ae];if(!G)continue;const C=ae*B.step-M.current+je,K=C+B.slideWidth/2-ve;let X,ce;K>0?(X=Math.min(B.maxScale,1+K/B.width*.45),ce=(X-1)*B.slideWidth*.35):(X=Math.max(B.minScale,1+K/B.width*.5),ce=0);const Le=B.flip?B.width-B.slideWidth-(C+ce):C+ce;if(G.style.transform=`translate3d(${Le}px, -50%, 0) scale(${X})`,B.dim>0&&X<1){const Ne=(1-X)/Math.max(.001,1-B.minScale);G.style.opacity=String(Math.max(.45,1-Ne*B.dim*.6))}else G.style.opacity="1"}};return typeof IntersectionObserver<"u"&&p.current&&(E=new IntersectionObserver(ee=>{ee[0]&&(D=ee[0].isIntersecting)},{rootMargin:"100px"}),E.observe(p.current)),N=requestAnimationFrame(re),()=>{cancelAnimationFrame(N),E&&E.disconnect()}},[]),m.useEffect(()=>{const N=p.current;if(!N)return;const z=D=>{D.preventDefault();const E=Math.abs(D.deltaX)>Math.abs(D.deltaY)?D.deltaX:D.deltaY;x.current+=E*O.current.wheelMultiplier};return N.addEventListener("wheel",z,{passive:!1}),()=>N.removeEventListener("wheel",z)},[]),m.useEffect(()=>{const N=p.current;if(!N)return;let z=null,D=0;const E=B=>{if(z===null){z=B.pointerId,D=B.clientX;try{N.setPointerCapture(B.pointerId)}catch{}}},re=B=>{if(z!==B.pointerId)return;const le=B.clientX-D;D=B.clientX,x.current+=(O.current.flip?le:-le)*O.current.dragMultiplier},ee=B=>{if(z===B.pointerId){z=null;try{N.hasPointerCapture(B.pointerId)&&N.releasePointerCapture(B.pointerId)}catch{}}};return N.addEventListener("pointerdown",E),N.addEventListener("pointermove",re),N.addEventListener("pointerup",ee),N.addEventListener("pointercancel",ee),()=>{N.removeEventListener("pointerdown",E),N.removeEventListener("pointermove",re),N.removeEventListener("pointerup",ee),N.removeEventListener("pointercancel",ee)}},[]);const Y=m.useCallback(N=>{const z=qe(N,0,w.length-1);x.current=z*q,P(z)},[w.length,q]),de=m.useCallback(N=>{const z=qe(I+(N==="left"?-1:1),0,w.length-1);Y(z)},[I,Y,w.length]);return e.jsxs("div",{style:{position:"relative",width:"100%",display:"flex",flexDirection:"column",alignItems:"center",margin:"1.2rem 0"},onMouseEnter:()=>_(!0),onMouseLeave:()=>_(!1),children:[e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",flexWrap:"wrap",gap:"8px",marginBottom:"1rem",zIndex:10},children:w.map((N,z)=>{const D=z===I;return e.jsx("button",{type:"button",onClick:()=>Y(z),style:{padding:"6px 14px",borderRadius:"999px",border:D?"1px solid #ff8a3d":"1px solid rgba(255, 255, 255, 0.12)",background:D?"linear-gradient(135deg, rgba(255, 138, 61, 0.32), rgba(255, 90, 31, 0.22))":"rgba(20, 10, 6, 0.55)",color:D?"#ffbd59":"rgba(255, 255, 255, 0.65)",fontSize:"0.78rem",fontWeight:D?"850":"650",letterSpacing:"0.04em",cursor:"pointer",transition:"all 200ms ease",backdropFilter:"blur(8px)",boxShadow:D?"0 0 16px rgba(255, 138, 61, 0.35)":"none"},children:N.name},N.name)})}),e.jsx("div",{ref:p,className:"smooth-scroll-slider-viewport",style:{position:"relative",width:"100%",height:`${R+50}px`,overflow:"hidden",background:g,cursor:"grab",touchAction:"pan-y",opacity:j>0?1:0,transition:"opacity 0.35s ease",userSelect:"none",...A},children:w.map((N,z)=>{const D=N.isHeadliner,E=z===I;return e.jsxs("div",{ref:re=>{b.current[z]=re},onClick:()=>{Y(z),v&&v(N,z)},style:{position:"absolute",top:"50%",left:0,width:`${L}px`,height:`${R}px`,borderRadius:`${o}px`,overflow:"hidden",background:"#130c0a",border:E?"1.5px solid rgba(255, 138, 61, 0.85)":D?"1px solid rgba(255, 138, 61, 0.45)":"1px solid rgba(255, 255, 255, 0.12)",boxShadow:E?"0 26px 65px rgba(0,0,0,0.9), 0 0 35px rgba(255, 90, 31, 0.4)":"0 18px 45px rgba(0,0,0,0.75)",willChange:"transform, filter",transform:"translate3d(0, -50%, 0)",cursor:"pointer",transition:"border-color 250ms ease, box-shadow 250ms ease"},children:[N.src?e.jsx("img",{src:N.src,alt:N.name,draggable:!1,onError:re=>{re.currentTarget.src=V("/assets/prism-auth-visual.jpg")},style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:`50% calc(50% + ${N.offsetY}px)`,display:"block",userSelect:"none"}}):null,e.jsxs("div",{style:{position:"absolute",top:"12px",left:"12px",right:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",zIndex:3},children:[D?e.jsx("span",{style:{display:"inline-flex",alignItems:"center",gap:"4px",padding:"4px 10px",borderRadius:"999px",background:"linear-gradient(135deg, #ff8a3d, #ff5a1f)",color:"#fff",fontSize:"0.68rem",fontWeight:"900",letterSpacing:"0.06em",textTransform:"uppercase",boxShadow:"0 4px 14px rgba(255, 90, 31, 0.45)"},children:"★ MAIN HEADLINER"}):e.jsx("span",{style:{padding:"3px 9px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.65)",backdropFilter:"blur(8px)",color:"#f6eee8",fontSize:"0.66rem",fontWeight:"700",border:"1px solid rgba(255,255,255,0.12)"},children:N.stage}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",gap:"2px",height:"14px",padding:"3px 6px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.55)",backdropFilter:"blur(6px)"},children:[e.jsx("span",{className:"sss-eq-bar sss-eq-1"}),e.jsx("span",{className:"sss-eq-bar sss-eq-2"}),e.jsx("span",{className:"sss-eq-bar sss-eq-3"})]})]}),e.jsxs("div",{style:{position:"absolute",inset:0,background:"linear-gradient(180deg, rgba(0,0,0,0.08) 0%, transparent 40%, rgba(10,5,3,0.72) 65%, rgba(6,3,2,0.96) 100%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:"16px 14px",zIndex:2},children:[e.jsx("span",{style:{display:"inline-block",width:"fit-content",padding:"2px 8px",borderRadius:"999px",background:"rgba(255, 138, 61, 0.18)",border:"1px solid rgba(255, 138, 61, 0.35)",color:"#ffbd59",fontSize:"0.68rem",fontWeight:"800",letterSpacing:"0.04em",textTransform:"uppercase",marginBottom:"6px"},children:N.genre}),e.jsx("h3",{style:{margin:0,color:"#ffffff",fontSize:"1.28rem",fontWeight:"900",letterSpacing:"-0.02em",lineHeight:1.15,textTransform:"uppercase",textShadow:"0 2px 10px rgba(0,0,0,0.7)"},children:N.name}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginTop:"8px",paddingTop:"6px",borderTop:"1px solid rgba(255,255,255,0.1)",color:"rgba(255, 255, 255, 0.72)",fontSize:"0.68rem",fontWeight:"700"},children:[e.jsxs("span",{children:["⚡ ",N.bpm]}),e.jsxs("span",{children:["♫ ",N.vibe]})]})]})]},N.name)})}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"1rem",marginTop:"0.8rem",zIndex:10},children:[e.jsx("button",{type:"button",onClick:()=>de("left"),disabled:I===0,"aria-label":"Previous artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:I===0?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:I===0?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:I===0?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:I===0?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:N=>{I>0&&(N.currentTarget.style.transform="scale(1.1)",N.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:N=>{N.currentTarget.style.transform="scale(1)",N.currentTarget.style.borderColor=I===0?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"‹"}),e.jsx("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:w.map((N,z)=>e.jsx("span",{onClick:()=>Y(z),style:{width:z===I?"20px":"6px",height:"6px",borderRadius:"999px",backgroundColor:z===I?"#ff8a3d":"rgba(255, 255, 255, 0.25)",cursor:"pointer",transition:"all 250ms ease"}},z))}),e.jsx("button",{type:"button",onClick:()=>de("right"),disabled:I===w.length-1,"aria-label":"Next artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:I===w.length-1?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:I===w.length-1?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:I===w.length-1?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:I===w.length-1?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:N=>{I<w.length-1&&(N.currentTarget.style.transform="scale(1.1)",N.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:N=>{N.currentTarget.style.transform="scale(1)",N.currentTarget.style.borderColor=I===w.length-1?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"›"})]}),e.jsx("style",{children:`
      ...
      `})]})}const et={color:"#ff8a3d",rounded:24,thickness:2.5,borderSize:45,glow:85,movement:"continuous",speed:16},Fr=2,Bt=[{blur:8,opacity:.5,reach:.3},{blur:15,opacity:.3,reach:.6},{blur:40,opacity:.18,reach:1}],Or=Math.max(...Bt.map(t=>t.blur)),ia=36;function Rt(t,a){const r=Math.max(0,Math.min(1,a));if(typeof t!="string")return`rgba(0,0,0,${r})`;const s=t.trim(),i=s.match(/^#([0-9a-f]{3,8})$/i);if(i){let n=i[1];(n.length===3||n.length===4)&&(n=n.split("").map(c=>c+c).join(""));const o=parseInt(n.slice(0,6),16);return Number.isFinite(o)?`rgba(${o>>16&255},${o>>8&255},${o&255},${r})`:`rgba(0,0,0,${r})`}const l=s.match(/^rgba?\(([^)]+)\)/i);if(l){const n=l[1].split(",").map(o=>parseFloat(o));if(n.length>=3&&n.slice(0,3).every(Number.isFinite))return`rgba(${n[0]},${n[1]},${n[2]},${r})`}return`rgba(0,0,0,${r})`}function Dr(t,a,r){const s=(t%1+1)%1*2*(a+r);return s<a?[s,0]:s<a+r?[a,s-a]:s<a*2+r?[a-(s-a-r),r]:[0,r-(s-a*2-r)]}function na(t,a,r){const s=2*(a+r),i=[0,a/s,(a+r)/s,(a*2+r)/s];return Math.floor(t/4)+i[(t%4+4)%4]}function _r(t,a,r){const[s,i]=Dr(t,a,r);return Math.atan2(s-a/2,r/2-i)*180/Math.PI}const oa=24,Br=.015;function zt(t,a,r,s,i){const l=r>0?r:100,n=s>0?s:100,o=Math.max(0,Math.min(100,a)),c=Math.max(Br,o/100*.5),g=o/100,u=[];let y=0,k=0,A=0;for(let p=0;p<=oa;p++){const b=p/oa,x=_r(t+(b-.5)*c,l,n);if(p===0)y=x;else{let f=x-k;for(;f>180;)f-=360;for(;f<-180;)f+=360;A+=f}k=x;const M=Math.abs(b-.5)*2,j=g>=1||M<=g?1:1-(M-g)/(1-g);u.push(`${Rt(i,j*j*(3-2*j))} ${A.toFixed(2)}deg`)}const v=A.toFixed(2);return u.push(`${Rt(i,0)} ${v}deg`),u.push(`${Rt(i,0)} 360deg`),`conic-gradient(from ${y.toFixed(2)}deg at 50% 50%, ${u.join(", ")})`}const la=30,$r=4,ca=3,Hr=.35,Ur=[.72,.16,.18,1.05],Gr=[.65,0,.35,1];function za(t){const[a,r,s,i]=t;if(a===r&&s===i)return n=>n;const l=(n,o,c)=>{const g=1-c;return 3*g*g*c*n+3*g*c*c*o+c*c*c};return n=>{const o=Math.max(0,Math.min(1,n));let c=o;for(let g=0;g<8;g++){const u=l(a,s,c)-o,y=1-c,k=3*y*y*a+6*y*c*(s-a)+3*c*c*(1-s);if(Math.abs(k)<1e-6)break;c-=u/k,c=Math.max(0,Math.min(1,c))}return l(r,i,c)}}const Wr=za(Ur),Vr=za(Gr),da={WebkitMaskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",WebkitMaskClip:"content-box, border-box",WebkitMaskComposite:"xor",maskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",maskClip:"content-box, border-box",maskComposite:"exclude"};function tt({color:t=et.color,rounded:a=et.rounded,thickness:r=et.thickness,borderSize:s=et.borderSize,glow:i=et.glow,movement:l=et.movement,speed:n=et.speed,style:o,className:c=""}){const g=m.useRef(null),u=m.useRef(null),y=m.useRef({speed:n,movement:l,borderSize:s,color:t});y.current={speed:n,movement:l,borderSize:s,color:t};const k=m.useRef(null),A=m.useRef({w:0,h:0}),[v,p]=m.useState({w:0,h:0});m.useEffect(()=>{const P=k.current;if(!P||typeof ResizeObserver>"u")return;const h=new ResizeObserver(()=>{const w=P.getBoundingClientRect();w.width===A.current.w&&w.height===A.current.h||(A.current={w:w.width,h:w.height},p(A.current))});return h.observe(P),()=>h.disconnect()},[]),m.useEffect(()=>{const P=k.current;let h=!0,w=null;typeof IntersectionObserver<"u"&&P&&(w=new IntersectionObserver(Z=>{Z[0]&&(h=Z[0].isIntersecting)},{rootMargin:"100px"}),w.observe(P));let L=0,R=performance.now(),q=0,$=0,T=0;const H=Z=>{if(L=requestAnimationFrame(H),!h||typeof document<"u"&&document.hidden){R=Z;return}const U=Math.min(.05,Math.max(0,(Z-R)/1e3));R=Z;const F=y.current,O=Math.max(0,Math.min(20,F.speed));if(O>0){const Y=F.movement==="step",de=Y?ca+(Hr-ca)*(O-1)/19:(la+($r-la)*(O-1)/19)/4;for(T+=U/de;T>=1;)T-=1,$+=1;const N=Y?Wr(Math.min(1,T*2)):Vr(T),{w:z,h:D}=A.current,E=z>0?z:100,re=D>0?D:100,ee=na($,E,re),B=na($+1,E,re);q=ee+(B-ee)*N;const le=g.current;le&&le.style.setProperty("--arc",zt(q,F.borderSize,z,D,F.color));const se=u.current;se&&se.style.setProperty("--arc",zt(q+.5,F.borderSize,z,D,F.color))}};return L=requestAnimationFrame(H),()=>{cancelAnimationFrame(L),w&&w.disconnect()}},[]);const b=Math.max(1,Math.min(10,r)),x=Math.max(0,Math.min(100,a))/100*(Math.min(v.w||200,v.h||200)/2),M=Math.max(0,Math.min(100,i))/100,j=P=>b+M*ia*P,f=10+ia+Or*2,d=(P,h=0)=>e.jsx("div",{style:{position:"absolute",inset:h-P,boxSizing:"border-box",padding:P,borderRadius:x>0?x+P:0,background:"var(--arc)",...da}}),_=(P,h,w,L)=>e.jsx("div",{style:{position:"absolute",inset:-f,boxSizing:"border-box",padding:f,borderRadius:x>0?x+f:0,opacity:L,mixBlendMode:"plus-lighter",filter:w?`blur(${w.toFixed(1)}px)`:"none",WebkitFilter:w?`blur(${w.toFixed(1)}px)`:"none",...da},children:d(h,f)},P),I=(P,h)=>e.jsxs("div",{ref:h,style:{position:"absolute",inset:0,overflow:"visible",pointerEvents:"none","--arc":zt(P,s,v.w,v.h,t)},children:[M>0&&(v.w>0&&v.w<600?[Bt[0]].map((w,L)=>_(`glow-${L}`,j(w.reach),w.blur*.7,w.opacity*1.2)):Bt.map((w,L)=>_(`glow-${L}`,j(w.reach),w.blur,w.opacity))),Array.from({length:Fr}).map((w,L)=>e.jsx("div",{style:{position:"absolute",inset:0,mixBlendMode:"plus-lighter"},children:d(b)},`edge-${L}`))]});return e.jsxs("div",{ref:k,className:`neon-border-overlay ${c}`,style:{position:"absolute",inset:0,width:"100%",height:"100%",flexShrink:0,borderRadius:x,pointerEvents:"none",zIndex:1,...o},children:[I(0,g),I(.5,u)]})}const qr=1.5,Yr=42,Xr=Math.PI*2,Zr=300,Kr=300,Jr=2,Qr=5e3,es=3.2,ts=.05,as=3,rs=1.35,ss=.08,is=.5,ns=.24,os=.35,ls=Xr*.75,cs=2,Ma=3,wt=720,ds=`
...
`;function pa(t){if(!t)return[1,1,1,1];let a=String(t).trim();const r=a.match(/^var\(\s*[^,)]+\s*,\s*(.+)\)$/i);r&&(a=r[1].trim());const s=a.match(/^rgba?\(([^)]+)\)$/i);if(s){const l=s[1].split(/[,\s/]+/).filter(Boolean).map(parseFloat);return[(l[0]||0)/255,(l[1]||0)/255,(l[2]||0)/255,l.length>3&&isFinite(l[3])?l[3]:1]}let i=a.replace("#","");return(i.length===3||i.length===4)&&(i=i.split("").map(l=>l+l).join("")),i.length<6?[1,1,1,1]:[parseInt(i.slice(0,2),16)/255,parseInt(i.slice(2,4),16)/255,parseInt(i.slice(4,6),16)/255,i.length>=8?parseInt(i.slice(6,8),16)/255:1]}function gs(t){return()=>{t|=0,t=t+1831565813|0;let a=Math.imul(t^t>>>15,1|t);return a=a+Math.imul(a^a>>>7,61|a)^a,((a^a>>>14)>>>0)/4294967296}}function ma(t,a,r){const s=t.createShader(a);return s?(t.shaderSource(s,r),t.compileShader(s),t.getShaderParameter(s,t.COMPILE_STATUS)||console.warn("VortexDustFall shader:",t.getShaderInfoLog(s)),s):null}function fa(t,a,r){const s=t.createProgram();if(!s)return null;const i=ma(t,t.VERTEX_SHADER,a),l=ma(t,t.FRAGMENT_SHADER,r);return!i||!l?null:(t.attachShader(s,i),t.attachShader(s,l),t.linkProgram(s),t.getProgramParameter(s,t.LINK_STATUS)||console.warn("VortexDustFall link:",t.getProgramInfoLog(s)),s)}const us={radius:195,thickness:16},hs={height:165,spin:38,spray:0},xs={scatter:280,blur:0},bs={amount:103,transition:{type:"tween",duration:.6,ease:"easeOut"}};function ys({background:t="transparent",baseColor:a="#FFA733",accentColor:r="#FFE082",density:s=145,dotSize:i=130,speed:l=48,distance:n=1450,tilt:o=7,ring:c={},fall:g={},field:u={},hover:y={},style:k={},className:A="",children:v}){const p={...us,...c},b={...hs,...g},x={...xs,...u},M={...bs,...y},j=m.useRef(null),f=m.useRef(null),d=m.useRef({x:0,y:0,active:0}),_=m.useRef({baseColor:a,accentColor:r,density:s,dotSize:i,speed:l,distance:n,tilt:o,ring:p,fall:b,field:x,hover:M});return _.current={baseColor:a,accentColor:r,density:s,dotSize:i,speed:l,distance:n,tilt:o,ring:p,fall:b,field:x,hover:M},m.useEffect(()=>{const I=j.current,P=f.current;if(!I||!P)return;const h=P.getContext("webgl",{alpha:!0,antialias:!1,premultipliedAlpha:!0,depth:!1});if(!h)return;const w=fa(h,ds,ps),L=fa(h,ms,fs);if(!w||!L)return;const R=(G,S)=>h.getUniformLocation(G,S),q={a:h.getAttribLocation(w,"aA"),b:h.getAttribLocation(w,"aB")},$={res:R(w,"uRes"),focal:R(w,"uFocal"),phase:R(w,"uPhase"),radius:R(w,"uRadius"),rise:R(w,"uRise"),fallD:R(w,"uFall"),spinTurns:R(w,"uSpinTurns"),scatter:R(w,"uScatter"),dotWorld:R(w,"uDotWorld"),blurK:R(w,"uBlurK"),camDist:R(w,"uCamDist"),tilt:R(w,"uTilt"),yPx:R(w,"uYPx"),alpha:R(w,"uAlpha"),color:R(w,"uColor")},T={ring:h.getAttribLocation(L,"aRing")},H={res:R(L,"uRes"),focal:R(L,"uFocal"),radius:R(L,"uRadius"),camDist:R(L,"uCamDist"),tilt:R(L,"uTilt"),yPx:R(L,"uYPx"),thick:R(L,"uThick"),seg:R(L,"uSeg"),color:R(L,"uColor"),alpha:R(L,"uAlpha")},Z=h.createBuffer(),U=h.createBuffer();let F=-1,O=0;const Y=G=>{const S=P.clientWidth||I.clientWidth||(typeof window<"u"?window.innerWidth:1200),C=S<768,K=S>=768&&S<1024,X=C?1800:K?8500:Math.round(G*Zr);O=Math.max(1e3,X);const ce=new Float32Array(O*4),Le=new Float32Array(O*2),Ne=gs(85840071);for(let we=0;we<O;we++)ce[we*4]=Ne(),ce[we*4+1]=Ne(),ce[we*4+2]=Ne(),ce[we*4+3]=Ne(),Le[we*2]=Ne(),Le[we*2+1]=Ne();h.bindBuffer(h.ARRAY_BUFFER,Z),h.bufferData(h.ARRAY_BUFFER,ce,h.STATIC_DRAW),h.bindBuffer(h.ARRAY_BUFFER,U),h.bufferData(h.ARRAY_BUFFER,Le,h.STATIC_DRAW),F=G},de=h.createBuffer(),N=(wt+1)*2;{const G=new Float32Array(N*2);for(let S=0;S<=wt;S++){const C=S/wt;G[S*4]=C,G[S*4+1]=-1,G[S*4+2]=C,G[S*4+3]=1}h.bindBuffer(h.ARRAY_BUFFER,de),h.bufferData(h.ARRAY_BUFFER,G,h.STATIC_DRAW)}h.disable(h.DEPTH_TEST),h.enable(h.BLEND),h.blendFunc(h.ONE,h.ONE);let z=!0,D=null;typeof IntersectionObserver<"u"&&I&&(D=new IntersectionObserver(G=>{G[0]&&(z=G[0].isIntersecting)},{rootMargin:"100px"}),D.observe(I));let E=1,re=0;const ee=()=>{const G=typeof window<"u"&&window.innerWidth<768;E=Math.min(window.devicePixelRatio||1,G?.85:qr);const S=P.clientWidth||I.clientWidth||1,C=P.clientHeight||I.clientHeight||1,K=Math.max(1,Math.round(S*E)),X=Math.max(1,Math.round(C*E));(P.width!==K||P.height!==X)&&(P.width=K,P.height=X),h.viewport(0,0,K,X),Math.abs(re-S)>50&&(re=S,Y(_.current.density))};ee();const B=new ResizeObserver(ee);B.observe(P);let le=0,se=performance.now(),ie=0,pe=0,je=0,ve=0;const ae=G=>{if(ie=requestAnimationFrame(ae),!z||typeof document<"u"&&document.hidden){se=G;return}const S=Math.min((G-se)/1e3,.05);se=G;const C=_.current;if(C.density!==F&&Y(C.density),O===0)return;const K=Math.max(.05,C.hover.transition?.duration??.6),X=1-Math.exp(-S/K),ce=d.current;pe+=(ce.x-pe)*X,je+=(ce.y-je)*X,ve+=(ce.active-ve)*X;const Le=(C.hover.amount||100)/100,Ne=1+ve*Le*.6;le=(le+S*(C.speed/50*Ne)/es)%1;const we=P.width,De=P.height,_e=P.clientWidth||I.clientWidth||1200,Re=_e<768,dt=_e>=768&&_e<1024,Qe=De/(2*Math.tan(Yr/2*Math.PI/180)),pt=we/Math.max(De,1),mt=pt<1?Math.max(.32,pt/1.4):dt?.85:1,Ae=Kr*(C.ring.radius/100)*mt,ft=Ae*(Re?1.1:C.fall.height/100),ht=ft*(C.fall.spray/400),xt=De*(Re?.22:ns),At=C.fall.spin/100*1.5,ze=Ae*(C.field.scatter/100)*(Re?.08:.15),bt=Jr*(C.dotSize/100)*(Re?.65:1),He=Qr*(C.field.blur/100),Ue=Re?Math.min(C.ring.thickness*E,9*E):C.ring.thickness*E,W=C.tilt*Math.PI/180+je*Le*ve*(10*Math.PI/180),ne=(Re?C.distance*1.05:C.distance)-ve*Le*150,[ue,Pe,be,Ie]=pa(C.baseColor),[Ge,st,Me,it]=pa(C.accentColor);h.clearColor(0,0,0,0),h.clear(h.COLOR_BUFFER_BIT),h.useProgram(w),h.uniform2f($.res,we,De),h.uniform1f($.focal,Qe),h.uniform1f($.phase,le),h.uniform1f($.radius,Ae),h.uniform1f($.rise,ht),h.uniform1f($.fallD,ft),h.uniform1f($.spinTurns,At),h.uniform1f($.scatter,ze),h.uniform1f($.dotWorld,bt*E),h.uniform1f($.blurK,He*E),h.uniform1f($.camDist,ne),h.uniform1f($.tilt,W),h.uniform1f($.yPx,xt),h.uniform1f($.alpha,Ie),h.uniform3f($.color,ue,Pe,be),h.bindBuffer(h.ARRAY_BUFFER,Z),h.enableVertexAttribArray(q.a),h.vertexAttribPointer(q.a,4,h.FLOAT,!1,0,0),h.bindBuffer(h.ARRAY_BUFFER,U),h.enableVertexAttribArray(q.b),h.vertexAttribPointer(q.b,2,h.FLOAT,!1,0,0),h.drawArrays(h.POINTS,0,O),h.useProgram(L),h.uniform2f(H.res,we,De),h.uniform1f(H.focal,Qe),h.uniform1f(H.radius,Ae),h.uniform1f(H.camDist,ne),h.uniform1f(H.tilt,W),h.uniform1f(H.yPx,xt),h.uniform1f(H.thick,Ue),h.uniform1f(H.seg,wt),h.uniform3f(H.color,Ge,st,Me),h.uniform1f(H.alpha,it),h.bindBuffer(h.ARRAY_BUFFER,de),h.enableVertexAttribArray(T.ring),h.vertexAttribPointer(T.ring,2,h.FLOAT,!1,0,0),h.drawArrays(h.TRIANGLE_STRIP,0,N)};return ie=requestAnimationFrame(ae),()=>{cancelAnimationFrame(ie),B.disconnect(),D&&D.disconnect(),h.deleteBuffer(Z),h.deleteBuffer(U),h.deleteBuffer(de),h.deleteProgram(w),h.deleteProgram(L)}},[]),e.jsxs("div",{ref:j,className:`vortex-dust-container ${A}`,onPointerMove:I=>{const P=I.currentTarget.getBoundingClientRect();P.width<=0||P.height<=0||(d.current={x:(I.clientX-P.left)/P.width*2-1,y:-((I.clientY-P.top)/P.height*2-1),active:1})},onPointerLeave:()=>{d.current={x:0,y:0,active:0}},style:{position:"absolute",inset:0,width:"100%",height:"100%",overflow:"hidden",pointerEvents:"none",background:t,...k},children:[e.jsx("canvas",{ref:f,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}}),v&&e.jsx("div",{style:{position:"relative",zIndex:2,pointerEvents:"auto",width:"100%",height:"100%"},children:v})]})}const vs=[{name:"TALWINDER",isHeadliner:!0,genre:"Indie Pop / Punjabi Fusion",stage:"Main Prism Stage",bpm:"128 BPM",vibe:"Euphoric Night",image:V("/assets/ozilla/talwinder.jpg")},{name:"IMRAN KHAN",genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",image:V("/assets/ozilla/Imran-Khan.jpg")},{name:"BOHEMIA",genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",image:V("/assets/ozilla/Bohemia.jpg")},{name:"HASSAN RAHEEM",genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",image:V("/assets/ozilla/hassan-raheem.jpg")}],ws=[{id:"general",name:"General Pass",badge:"STANDARD ACCESS",price:"PKR 4,500",sub:"Full 1-day festival admission",isFeatured:!1,perks:["Access to All 4 Music Stages","Food & Beats Street Access","Festival Photo Booths & Activations","Instant Digital QR Pass"],ctaText:"Get General Pass",ctaLink:"/tickets"},{id:"vip",name:"VIP Experience",badge:"MOST POPULAR",price:"PKR 12,500",sub:"Elevated front-row & lounge access",isFeatured:!0,perks:["Priority Front Stage Viewing Deck","Private VIP Artist Lounge Access","Dedicated Fast-Track Entry Gate","Complimentary Food & Drink Voucher","20% Partner Hotel & Dining Discounts","Holographic VIP Commemorative Pass"],ctaText:"Book VIP Pass →",ctaLink:"/tickets"},{id:"platinum",name:"All-Access Platinum",badge:"EXCLUSIVE ALL-ACCESS",price:"PKR 25,000",sub:"Ultimate luxury hospitality package",isFeatured:!1,perks:["Backstage & Artist Lounge Access","Valet Reserved Parking Spot","Gourmet Catering & Open Mocktail Bar","Exclusive Afterparty Invitation","Dedicated Hospitality Concierge","Full Merchandise Gift Bundle"],ctaText:"Reserve Platinum Pass",ctaLink:"/tickets"}],ks=[{badge:"100kW SOUND SYSTEM",title:"4 Mega Sound Stages",desc:"Explosive stage arenas for Indie Pop, Punjabi Rap, Desi Hip-Hop, and non-stop EDM beats."},{badge:"HEADLINE CELEBRITIES",title:"Star-Studded Lineup",desc:"Live stadium sets by Talwinder, Imran Khan, Bohemia, Hassan Raheem, and top artists."},{badge:"CULINARY & NIGHT BAZAAR",title:"Food & Beats Street",desc:"50+ curated gourmet food stalls, wood-fired artisan eats, and craft mocktail lounges."},{badge:"ALL-ACCESS HOSPITALITY",title:"VIP Lounge & Deck Access",desc:"Elevated front-stage viewing decks, private artist lounges, and fast-track VIP gates."}],js=[{name:"OZILLA FEST 2026: The Flagship",date:"November 1, 2026",location:"Lahore, Pakistan",status:"FEATURED FESTIVAL",description:"Flagship festival with 4 mega stages, 20+ star artists, and 10,000+ live crowd."},{name:"Celebrity Night Live Concert",date:"February 2027",location:"Lahore, Pakistan",status:"UPCOMING CONCERT",description:"High-octane stadium night with headline Punjabi artists and 360° laser shows."},{name:"Ozilla Basant Beats Season 2",date:"March 2027",location:"Lahore, Pakistan",status:"SEASONAL FESTIVAL",description:"Cultural music fusion festival with live pop sets, color activations, and street eats."}],Ns=[{name:"Ozilla Season 1: The Bass Awakening",status:"Sold Out · 6,500+ Fans",detail:"Debut open-air music festival in Lahore featuring indie fusion acts and 2 live mega stages."},{name:"Ozilla Season 2: Neon Nights",status:"Sold Out · 8,500+ Fans",detail:"High-energy night festival with headline celebrity acts and artisan night food street."}],Ss=[{name:"Ozilla Debut: The Sound Awakening",year:"2023",badge:"SOLD OUT DEBUT",description:"Historic launch in Lahore uniting 6,000+ fans for live indie music and night market culture.",highlights:["6,000+ Attendees","2 Live Stages","Indie & Desi Fusion"],venue:"Lahore Expo Center",date:"December 12, 2023"},{name:"Ozilla Season 2: Neon Nights",year:"2024",badge:"RECORD 8,500+ CROWD",description:"Season 2 expansion with 4 live stages, celebrity headliners, and 360° laser canopy.",highlights:["8,500+ Fans","4 Live Stages","Celebrity Headliners"],venue:"DHA Sports Complex, Lahore",date:"November 9, 2024"},{name:"Ozilla Basant Cultural Beats",year:"2025",badge:"SPRING FESTIVAL",description:"Seasonal spring music festival with live acoustic sets, DJ arenas, and artisan bazaar.",highlights:["Cultural Sets","Live DJ Stages","Food Hub"],venue:"Gulberg Cultural District, Lahore",date:"March 15, 2025"},{name:"OZILLA FEST 2026 (The Grand Edition)",year:"2026",badge:"FLAGSHIP 10,000+ EDITION",description:"Monumental flagship edition with 4 stages, 20+ star artists, and 100kW laser sound arrays.",highlights:["10,000+ Crowd","4 Mega Stages","Talwinder & Imran Khan"],venue:"Lahore, Punjab",date:"November 1, 2026"},{name:"OZILLA FEST 2027: Arena Tour",year:"2027",badge:"NATIONWIDE TOUR",description:"Nationwide arena tour expansion bringing the signature Ozilla concert experience across Pakistan.",highlights:["Arena Tour","Multi-City Stages","Star Acts"],venue:"Lahore, Karachi & Islamabad",date:"November 14, 2027"}],As=[{tier:"Title Sponsor",price:"PREMIUM",badge:"FLAGSHIP PARTNER",accent:"#ffbd59",tagline:"Maximum Brand Dominance",isFeatured:!0,ctaText:"Claim Title Partnership",perks:["Exclusive brand naming rights","Main stage backdrop placement","VIP lounge & deck co-branding","30-second main stage video slot","Dedicated social & press campaigns"]},{tier:"Gold Sponsor",price:"HIGH IMPACT",badge:"STAGE ACTIVATION",accent:"#ff8a3d",tagline:"High-Energy Ground Presence",isFeatured:!1,ctaText:"Become Gold Sponsor",perks:["Exclusive brand activation zone","Perimeter banner placements","Digital festival app features","Influencer co-branding & mentions","On-ground brand booth space"]},{tier:"Silver Sponsor",price:"GROWTH",badge:"BRAND PARTNER",accent:"#cbd5e1",tagline:"Targeted Festival Engagement",isFeatured:!1,ctaText:"Join Silver Tier",perks:["Official festival website branding","Social media shoutouts","Sampling booth at food street","Newsletter sponsor placement","10 complimentary festival passes"]},{tier:"Media Partner",price:"CUSTOM",badge:"BROADCAST & PRESS",accent:"#ec4899",tagline:"Official Media Rights",isFeatured:!1,ctaText:"Apply For Press Pass",perks:["Official media coverage rights","All-access artist press passes","Exclusive backstage interview access","Press release announcement feature","Dedicated creator lounge access"]}],Ps=[{badge:"100kW SOUND ARRAY",title:"Main Concert Arena",desc:"Stadium-grade concert sound arrays, 360° lasers, and cryogenic live jets.",accent:"#ff5a1f"},{badge:"50+ FOOD SPOTS",title:"Food & Beats Street",desc:"50+ night food stalls, wood-fired artisan eats, and gourmet smash burgers.",accent:"#ffbd59"},{badge:"24/7 RAPID CARE",title:"Medical & First Aid Hub",desc:"Fully equipped medical stations and certified paramedic response teams.",accent:"#ef4444"},{badge:"VALET & VIP GATES",title:"Managed VIP Parking",desc:"Fast-track valet lanes and direct express entry for VIP pass holders.",accent:"#f59e0b"},{badge:"CREATOR LIGHTING",title:"Holographic Photo Booths",desc:"Interactive neon backdrops and 360° video spinners for creator moments.",accent:"#ec4899"},{badge:"INCLUSIVE VENUE",title:"Full Venue Accessibility",desc:"Elevated viewing decks, step-free ramps, and on-ground guest assistance.",accent:"#3b82f6"},{badge:"PROFESSIONAL SQUAD",title:"Crowd Safety & Security",desc:"Trained festival security squad, CCTV monitoring, and RFID gate checks.",accent:"#10b981"},{badge:"GIGABIT HIGH-SPEED",title:"Ultra-Fast Festival Wi-Fi",desc:"High-density wireless zones across all stages and food streets.",accent:"#06b6d4"}],Ts=[{value:"10,000+",label:"Music Lovers",sub:"Packed Live Crowd"},{value:"20+",label:"Star Performers",sub:"Celebrity & Indie Acts"},{value:"4",label:"Mega Stages",sub:"Non-stop Beats"},{value:"50+",label:"Food & Stalls",sub:"Culinary & Brand Hub"}];function Es(t){const[a,r]=m.useState(()=>{const s=Math.max(new Date(t)-Date.now(),0);return{days:Math.floor(s/864e5),hours:Math.floor(s/36e5%24),minutes:Math.floor(s/6e4%60),seconds:Math.floor(s/1e3%60)}});return m.useEffect(()=>{const s=setInterval(()=>{const i=Math.max(new Date(t)-Date.now(),0);r({days:Math.floor(i/864e5),hours:Math.floor(i/36e5%24),minutes:Math.floor(i/6e4%60),seconds:Math.floor(i/1e3%60)})},1e3);return()=>clearInterval(s)},[t]),a}function Cs(){const t=Ke(),a=Es("2026-11-01T18:00:00+05:00");return m.useEffect(()=>{const r=t.hash?.replace("#","");r?setTimeout(()=>{const s=document.getElementById(r);s&&s.scrollIntoView({behavior:"smooth",block:"start"})},150):window.scrollTo({top:0,behavior:"smooth"})},[t.hash]),e.jsxs("main",{className:"sp-main",children:[e.jsxs("section",{id:"home",className:"sp-hero","aria-label":"Ozilla Fest",children:[e.jsx(ys,{baseColor:"#ff8a3d",accentColor:"#ffbd59",density:125,speed:46,tilt:7}),e.jsx("div",{className:"sp-hero-ambient-glow"}),e.jsxs("div",{className:"sp-hero-content",children:[e.jsxs(oe.div,{className:"sp-hero-badge",initial:{opacity:0,y:-20,scale:.9},animate:{opacity:1,y:0,scale:1},transition:{duration:.6},children:[e.jsx("span",{children:"✨"}),e.jsx("strong",{children:"OZILLA FEST 2026 · LAHORE"})]}),e.jsx(oe.h1,{className:"sp-hero-title",initial:{opacity:0,y:25},animate:{opacity:1,y:0},transition:{duration:.7,delay:.12},children:"OZILLA FEST"}),e.jsxs(oe.p,{className:"sp-hero-subtitle",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.7,delay:.25},children:[e.jsx("strong",{className:"sp-hero-sub-highlight",children:"Pakistan's Flagship Music & Cultural Phenomenon."}),e.jsx("span",{className:"sp-hero-sub-detail",children:"4 Electrified Mega Stages · Headline Celebrities · High-Octane Sound Under the Lahore Night Sky."})]}),e.jsxs(oe.div,{className:"sp-hero-meta-strip",initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{duration:.6,delay:.4},children:[e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsxs("span",{className:"sp-meta-header",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"DATE"})]}),e.jsx("strong",{children:"NOV 01, 2026"})]}),e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsxs("span",{className:"sp-meta-header",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"CITY"})]}),e.jsx("strong",{children:"LAHORE, PK"})]}),e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsxs("span",{className:"sp-meta-header",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"PRODUCTION"})]}),e.jsx("strong",{children:"4 MEGA STAGES"})]}),e.jsxs("div",{className:"sp-hero-meta-pill sp-meta-featured",children:[e.jsxs("span",{className:"sp-meta-header",children:[e.jsx("span",{className:"sp-meta-dot sp-dot-gold"}),e.jsx("span",{className:"sp-meta-label",children:"PASSES"})]}),e.jsx("strong",{children:"INSTANT QR PASS"})]})]}),e.jsxs(oe.div,{className:"sp-hero-actions",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6,delay:.55},children:[e.jsx(oe.a,{className:"sp-btn-ember",href:"#celebrities",whileHover:{scale:1.04},whileTap:{scale:.97},children:"Explore Lineup ⚡"}),e.jsx(oe.div,{whileHover:{scale:1.04},whileTap:{scale:.97},children:e.jsx(J,{className:"sp-btn-ghost",to:"/tickets",children:"Get VIP Passes 🎟️"})})]})]})]}),e.jsx("section",{className:"festival-stats-strip","aria-label":"Festival Highlights",children:e.jsx("div",{className:"sp-container",children:e.jsx("div",{className:"stats-inner-grid",children:Ts.map((r,s)=>e.jsxs(oe.div,{className:"stat-card",whileHover:{y:-5,scale:1.02},children:[e.jsx("strong",{className:"stat-val",children:r.value}),e.jsx("span",{className:"stat-label",children:r.label}),e.jsx("small",{className:"stat-sub",children:r.sub})]},r.label))})})}),e.jsx("section",{id:"celebrities",className:"sp-section sp-section-celebrities","aria-label":"Celebrities Lineup",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",children:[e.jsx("span",{className:"sp-eyebrow",children:"Live on the Ozilla Stage"}),e.jsx("h2",{className:"sp-section-title",children:"Celebrity Singers & Performers"}),e.jsx("p",{className:"sp-section-subtitle",children:"Four powerhouse headline performers, one premium Lahore festival atmosphere, and an amphitheatre built for unforgettable crowd moments."})]}),e.jsx("div",{className:"sp-celebrity-slider-wrap",style:{margin:"1rem 0 3.5rem 0"},children:e.jsx(Mr,{items:vs,slideWidth:320,slideHeight:440,spacing:2.6,smoothness:8.5,dim:6,sensitivity:5,autoPlay:!0,autoPlaySpeed:1.2})}),e.jsxs("div",{className:"sp-countdown-banner",children:[e.jsx("div",{className:"sp-countdown-header",children:e.jsxs("span",{className:"sp-countdown-eyebrow",children:[e.jsx("span",{className:"sp-countdown-pulse"}),"COUNTDOWN TO THE FIRST BEAT DROP"]})}),e.jsx("div",{className:"sp-countdown-grid",children:[["Days",a.days],["Hours",a.hours],["Minutes",a.minutes],["Seconds",a.seconds]].map(([r,s])=>e.jsxs(oe.div,{className:"sp-countdown-card",whileHover:{scale:1.05,y:-4},transition:{type:"spring",stiffness:350},children:[e.jsx("strong",{children:String(s).padStart(2,"0")}),e.jsx("span",{children:r}),e.jsx("div",{className:"sp-countdown-glow-line"})]},r))})]})]})}),e.jsx("section",{id:"vip-experience",className:"sp-section sp-section-pricing","aria-label":"Festival Passes",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",style:{textAlign:"center"},children:[e.jsx("span",{className:"sp-eyebrow",children:"CHOOSE YOUR ACCESS"}),e.jsx("h2",{className:"sp-section-title",children:"Festival Passes & VIP Tiers"}),e.jsx("p",{className:"sp-section-subtitle",style:{margin:"0 auto"},children:"Select your festival experience tier. Instant dynamic QR pass generated upon reservation with guaranteed fast-track admission."})]}),e.jsx("div",{className:"sp-pricing-grid",children:ws.map(r=>e.jsxs(oe.div,{className:`sp-pricing-card ${r.isFeatured?"sp-featured-pricing":""}`,whileHover:{y:-8},children:[r.isFeatured&&e.jsx("div",{className:"sp-pricing-popular-tag",children:"MOST POPULAR ACCESS"}),e.jsxs("div",{className:"sp-pricing-header",children:[e.jsx("span",{className:"sp-tier-badge",children:r.badge}),e.jsx("h3",{children:r.name}),e.jsx("div",{className:"sp-pricing-cost",children:e.jsx("strong",{children:r.price})}),e.jsx("p",{className:"sp-pricing-sub",children:r.sub})]}),e.jsx("div",{className:"sp-pricing-divider"}),e.jsx("ul",{className:"sp-pricing-features",children:r.perks.map(s=>e.jsxs("li",{children:[e.jsx("span",{className:"sp-perk-check",children:"✓"}),e.jsx("span",{children:s})]},s))}),e.jsx(J,{to:r.ctaLink,className:r.isFeatured?"sp-btn-ember w-full":"sp-btn-ghost w-full",style:{textAlign:"center",marginTop:"auto"},children:r.ctaText})]},r.id))})]})}),e.jsx("section",{id:"about",className:"sp-section sp-section-about","aria-label":"About Ozilla",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",children:[e.jsx("span",{className:"sp-eyebrow",children:"⚡ THE ULTIMATE LIVE EXPERIENCE"}),e.jsx("h2",{className:"sp-section-title",children:"The Ozilla Fest Atmosphere"}),e.jsx("p",{className:"sp-section-subtitle",children:"Pakistan's flagship open-air music & cultural festival. 4 electrified stages, 100kW concert sound, headline celebrity acts, gourmet food street, and unmatched crowd energy under the Lahore night sky."})]}),e.jsx("div",{className:"sp-pillars-grid",children:ks.map(r=>e.jsxs(oe.div,{className:"sp-pillar-card",whileHover:{y:-8,scale:1.02},children:[e.jsx("div",{className:"sp-pillar-glow-accent"}),e.jsx("div",{className:"sp-pillar-top",children:e.jsx("span",{className:"sp-pillar-badge",children:r.badge})}),e.jsx("h3",{className:"sp-pillar-title",children:r.title}),e.jsx("p",{className:"sp-pillar-desc",children:r.desc}),e.jsx("div",{className:"sp-pillar-glow-line"})]},r.title))}),e.jsxs("div",{className:"sp-festival-vibe-banner",style:{position:"relative",overflow:"hidden"},children:[e.jsx(tt,{color:"#ff7a29",rounded:32,thickness:2.8,borderSize:50,glow:85}),e.jsxs("div",{className:"sp-vibe-left",style:{position:"relative",zIndex:2},children:[e.jsxs("span",{className:"sp-vibe-eyebrow",children:[e.jsx("span",{className:"sp-countdown-pulse"}),"FESTIVAL HIGHLIGHTS"]}),e.jsx("h3",{children:"What Makes Ozilla Legendary"}),e.jsx("p",{children:"Non-stop beats from golden hour to midnight, surrounded by festival activations and pure music culture."}),e.jsxs("div",{className:"sp-vibe-actions",children:[e.jsx(oe.a,{href:"#celebrities",className:"sp-btn-ember",whileHover:{scale:1.04},whileTap:{scale:.97},children:"Explore Lineup →"}),e.jsx(oe.div,{whileHover:{scale:1.04},whileTap:{scale:.97},children:e.jsx(J,{to:"/tickets",className:"sp-btn-ghost",children:"Book Festival Passes"})})]})]}),e.jsx("div",{className:"sp-vibe-tags-grid",style:{position:"relative",zIndex:2},children:[{text:"4 Mega Music Stages",isMain:!0,icon:"⚡"},{text:"100kW Laser & Sound",isMain:!0,icon:"🔊"},{text:"20+ Star Performers",isMain:!0,icon:"👑"},{text:"Verified QR Instant Passes",isMain:!0,icon:"🎟️"},{text:"10,000+ Music Lovers",isMain:!1,icon:"👥"},{text:"50+ Food & Beats Stalls",isMain:!1,icon:"🍔"},{text:"VIP Artist Lounge & Deck",isMain:!1,icon:"✨"},{text:"Exclusive Partner Discounts",isMain:!1,icon:"🏷️"}].map(r=>e.jsxs(oe.div,{className:`sp-vibe-tag ${r.isMain?"sp-vibe-main":"sp-vibe-secondary"}`,whileHover:{scale:1.03,x:3},whileTap:{scale:.98},children:[e.jsx("span",{className:"sp-vibe-tag-icon",children:r.icon}),e.jsx("span",{className:"sp-vibe-tag-text",children:r.text}),r.isMain&&e.jsx("span",{className:"sp-vibe-tag-dot"})]},r.text))})]})]})}),e.jsx("section",{id:"events",className:"sp-section sp-section-events","aria-label":"Past Events",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",children:[e.jsx("span",{className:"sp-eyebrow",children:"Previous Editions"}),e.jsx("h2",{className:"sp-section-title",children:"Past Festival Milestones"}),e.jsx("p",{className:"sp-section-subtitle",children:"A legacy of sold-out stadium energy, breakthrough artist sets, and unforgettable Lahore nights."})]}),e.jsx("div",{className:"sp-events-grid",children:Ns.map(r=>e.jsxs(oe.div,{className:"sp-glass-card sp-past-event-card",style:{position:"relative",overflow:"hidden"},whileHover:{y:-6},children:[e.jsx(tt,{color:"#ff8a3d",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column",height:"100%"},children:[e.jsxs("div",{className:"sp-card-header",children:[e.jsx("h3",{children:r.name}),e.jsx("span",{className:"sp-pill-badge",children:r.status})]}),e.jsx("p",{className:"sp-card-desc",children:r.detail}),e.jsxs("div",{className:"sp-card-footer-eq",children:[e.jsx("span",{children:"LIVE ARCHIVE"}),e.jsxs("div",{className:"celeb-mini-eq",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})]})]},r.name))})]})}),e.jsx("section",{id:"future-events",className:"sp-section sp-section-future","aria-label":"Upcoming Events",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",children:[e.jsx("span",{className:"sp-eyebrow",children:"Upcoming Concert Tour"}),e.jsx("h2",{className:"sp-section-title",children:"Future Festival Editions"}),e.jsx("p",{className:"sp-section-subtitle",children:"Mark your calendar for upcoming major festival editions, celebrity concert nights, and arena dates."})]}),e.jsx("div",{className:"sp-future-grid",children:js.map(r=>e.jsxs(oe.div,{className:"sp-glass-card sp-future-card",style:{position:"relative",overflow:"hidden"},whileHover:{y:-6},children:[e.jsx(tt,{color:"#ff9e42",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column",height:"100%"},children:[e.jsx("span",{className:"sp-pill-badge",children:r.status}),e.jsx("h3",{style:{marginTop:"0.8rem"},children:r.name}),e.jsxs("p",{className:"sp-meta-text",children:["📍 ",r.date," · ",r.location]}),e.jsx("p",{className:"sp-card-desc",style:{flex:1},children:r.description}),e.jsx(J,{to:"/tickets",className:"sp-accent-link",children:"Get Tickets →"})]})]},r.name))})]})}),e.jsx("section",{id:"history",className:"sp-section sp-section-history","aria-label":"Festival History",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header sp-timeline-banner-header",style:{position:"relative",overflow:"hidden"},children:[e.jsx(tt,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"Festival Legacy"}),e.jsx("h2",{className:"sp-section-title",children:"Our Editions & Timeline"}),e.jsx("p",{className:"sp-section-subtitle",children:"From our underground debut to Pakistan's biggest stadium concert experience."})]})]}),e.jsx("div",{className:"sp-timeline",children:Ss.map(r=>e.jsxs("div",{className:"sp-timeline-item",children:[e.jsxs("div",{className:"sp-timeline-node-wrap",children:[e.jsx("div",{className:"sp-timeline-icon",children:e.jsx("span",{className:"sp-timeline-year-pill",children:r.year})}),e.jsx("div",{className:"sp-timeline-pulse-ring"})]}),e.jsxs("div",{className:"sp-glass-card sp-timeline-content",children:[e.jsxs("div",{className:"sp-timeline-top-row",children:[e.jsx("div",{className:"sp-meta-text",children:e.jsx("span",{className:"sp-year-highlight",children:r.date})}),e.jsx("span",{className:"sp-timeline-badge",children:r.badge})]}),e.jsx("h3",{className:"sp-timeline-heading",children:r.name}),e.jsx("p",{className:"sp-card-desc",children:r.description}),e.jsx("div",{className:"sp-tag-cloud",children:r.highlights.map(s=>e.jsx("span",{className:"sp-tag sp-timeline-tag",children:s},s))}),e.jsxs("div",{className:"sp-timeline-footer",children:[e.jsx("p",{className:"sp-venue-text",children:r.venue}),e.jsxs("div",{className:"celeb-mini-eq",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})]})]},r.name))})]})}),e.jsx("section",{id:"facilities",className:"sp-section sp-section-facilities","aria-label":"Facilities",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header sp-facilities-header-banner",style:{position:"relative",overflow:"hidden"},children:[e.jsx(tt,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"⚡ FESTIVAL VENUE & PRODUCTION"}),e.jsx("h2",{className:"sp-section-title",children:"World-Class Festival Facilities"}),e.jsx("p",{className:"sp-section-subtitle",children:"Built for a seamless 10,000+ attendee experience with concert-grade sound, medical support, VIP hospitality, and creator amenities."})]})]}),e.jsx("div",{className:"sp-facilities-grid",children:Ps.map(r=>e.jsxs(oe.div,{className:"sp-glass-card sp-facility-card",style:{position:"relative",overflow:"hidden"},whileHover:{y:-8,scale:1.02},children:[e.jsx(tt,{color:r.accent||"#ff8a3d",rounded:20,thickness:2.2,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,width:"100%"},children:[e.jsx("div",{className:"sp-facility-top",children:e.jsx("span",{className:"sp-facility-badge",style:{color:r.accent,borderColor:`${r.accent}44`,background:`${r.accent}14`},children:r.badge})}),e.jsx("h3",{className:"sp-facility-title",children:r.title}),e.jsx("p",{className:"sp-card-desc",children:r.desc})]}),e.jsx("div",{className:"sp-facility-glow-bar",style:{background:`linear-gradient(90deg, ${r.accent}, transparent)`}})]},r.title))})]})}),e.jsx("section",{id:"sponsorship",className:"sp-section sp-section-sponsorship","aria-label":"Sponsorships",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header sp-sponsorship-header-banner",style:{position:"relative",overflow:"hidden",textAlign:"center"},children:[e.jsx(tt,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"BRAND COLLABORATIONS"}),e.jsx("h2",{className:"sp-section-title",children:"Sponsorship & Brand Packages"}),e.jsx("p",{className:"sp-section-subtitle",style:{margin:"0 auto"},children:"Partner with Pakistan's biggest live music festival. Gain unparalleled on-ground brand presence, digital engagement, and VIP hospitality."})]})]}),e.jsx("div",{className:"sp-sponsorship-grid",children:As.map(r=>e.jsxs(oe.div,{className:`sp-glass-card sp-sponsor-card ${r.isFeatured?"sp-sponsor-featured":""}`,whileHover:{y:-10,scale:1.02},children:[r.isFeatured&&e.jsx("div",{className:"sp-sponsor-popular-tag",children:"MOST PRESTIGIOUS TIER"}),e.jsx("div",{className:"sp-sponsor-top",children:e.jsx("span",{className:"sp-sponsor-badge",style:{color:r.accent,borderColor:`${r.accent}44`,background:`${r.accent}14`},children:r.badge})}),e.jsxs("div",{className:"sp-sponsor-header",children:[e.jsx("h3",{children:r.tier}),e.jsx("div",{className:"sp-sponsor-price-tag",style:{color:r.accent},children:r.price}),e.jsx("p",{className:"sp-sponsor-tagline",children:r.tagline})]}),e.jsx("div",{className:"sp-sponsor-divider"}),e.jsx("ul",{className:"sp-sponsor-perks",children:r.perks.map(s=>e.jsxs("li",{children:[e.jsx("span",{className:"sp-check",style:{color:r.accent},children:"✓"}),e.jsx("span",{children:s})]},s))}),e.jsx(oe.div,{whileHover:{scale:1.04},whileTap:{scale:.96},style:{marginTop:"auto",paddingTop:"1.2rem"},children:e.jsx(J,{to:"/tickets",className:r.isFeatured?"sp-btn-ember w-full":"sp-btn-ghost w-full",style:{textAlign:"center"},children:r.ctaText})}),e.jsx("div",{className:"sp-sponsor-glow-bottom",style:{background:`linear-gradient(90deg, ${r.accent}, transparent)`}})]},r.tier))})]})}),e.jsx("style",{children:`
      ...
      `})]})}function Gt({type:t,message:a,onClose:r}){const s={success:"bg-green-100 border-green-500 text-green-700",error:"bg-red-100 border-red-500 text-red-700",warning:"bg-yellow-100 border-yellow-500 text-yellow-700",info:"bg-blue-100 border-blue-500 text-blue-700"}[t]||"bg-gray-100 border-gray-500 text-gray-700";return e.jsxs("div",{className:`${s} border-l-4 p-4 rounded mb-4 flex justify-between items-center`,children:[e.jsx("p",{children:a}),r&&e.jsx("button",{onClick:r,className:"ml-4 font-bold hover:opacity-75",children:"×"})]})}const Ys=["Personal Info","Ticket Details","Payment Checkout","QR Pass"],Xs={ticketType:"General",day:"Day 1",quantity:1,subtotal:1,serviceFee:0,discount:0,total:1,benefits:["Festival entry","Food court access","Partner discount offers"]};function Zs(){const t=ct(),{user:a}=Je(),{requestTicket:r,payWithCard:s,payWithJazzCash:i,payWithEasypaisa:l,initiatePayFastCheckout:n,completePayFastGateway:o,loading:c}=Ut(),[g,u]=m.useState(null),[y,k]=m.useState(!1),[A,v]=m.useState("payfast"),[p,b]=m.useState(null),[x,M]=m.useState(!1),[j,f]=m.useState(Xs),[d,_]=m.useState(null),[I,P]=m.useState(!0),h=y?3:2;`${a?.firstName||""} ${a?.lastName||""}`.trim()||a?.name||a?.email;const w=!!d?.soldOut;m.useEffect(()=>{let U=!0;return(async()=>{P(!0);try{const O=await Se.getAvailability();if(!U)return;_(O),O?.soldOut&&u({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."})}catch{U&&_(null)}finally{U&&P(!1)}})(),()=>{U=!1}},[]);const L=()=>{if(w){u({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."});return}t(`/login?returnTo=${encodeURIComponent("/tickets")}`)},R=async U=>{if(w){u({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."});return}try{const F=await r(U);b(F),k(!0),u({type:"success",message:"Ticket reserved! Please complete payment below."});const O=await Se.getAvailability().catch(()=>null);O&&_(O)}catch(F){const O=F?.response?.data?.message||F?.message||"Failed to request ticket. Please try again.";F?.response?.data?.availability&&_(F.response.data.availability),u({type:"error",message:O})}},q=async U=>{if(!p?.id){u({type:"error",message:"Ticket session expired. Please retry."});return}try{await s(p.id,U),u({type:"success",message:`Payment of PKR ${j.total.toLocaleString()} successful! Your QR pass is ready.`}),t(`/tickets/view/${p.id}`)}catch(F){const O=F?.response?.data?.message||F?.message||"Failed to process card payment.";u({type:"error",message:O})}},$=async U=>{if(!p?.id){u({type:"error",message:"Ticket session expired. Please retry."});return}try{await i(p.id,U),u({type:"success",message:"JazzCash payment successful! Your QR pass is ready."}),t(`/tickets/view/${p.id}`)}catch(F){const O=F?.response?.data?.message||F?.message||"Failed to process JazzCash payment.";u({type:"error",message:O})}},T=async U=>{if(!p?.id){u({type:"error",message:"Ticket session expired. Please retry."});return}try{await l(p.id,U),u({type:"success",message:"Easypaisa payment successful! Your QR pass is ready."}),t(`/tickets/view/${p.id}`)}catch(F){const O=F?.response?.data?.message||F?.message||"Failed to process Easypaisa payment.";u({type:"error",message:O})}},H=async()=>{if(!p?.id){u({type:"error",message:"Ticket session expired. Please retry."});return}try{await n(p.id),M(!0)}catch(U){u({type:"error",message:U?.response?.data?.message||U?.message||"Failed to initiate PayFast session."})}},Z=async U=>{if(p?.id)try{await o(p.id,U),M(!1),u({type:"success",message:`PayFast payment of PKR ${j.total.toLocaleString()} confirmed! Official QR pass generated.`}),t(`/tickets/view/${p.id}?payment=success`)}catch(F){u({type:"error",message:F?.response?.data?.message||F?.message||"Failed to verify PayFast transaction."})}};return e.jsxs("main",{className:"ticket-portal-clean",children:[e.jsxs("section",{className:"ticket-clean-hero",children:[e.jsx(Ht,{nodeColor:"#EC4899",lineColor:"236, 72, 153",secondaryColor:"255, 90, 31",maxDistance:140,speed:.5}),e.jsx("div",{className:"hero-glow-blob"}),e.jsxs("div",{className:"ticket-clean-hero-content",children:[e.jsx("span",{className:"hero-eyebrow",children:"OZILLA FEST 2026"}),e.jsx("h1",{className:"hero-title",children:"Book Your Festival Passes"}),e.jsx("p",{className:"hero-subtitle",children:"Instant digital QR pass with access to 4 live stages, headline artists, and VIP amenities in Lahore."}),e.jsxs("div",{className:"hero-tags",children:[e.jsx("span",{children:"📅 Nov 01, 2026"}),e.jsx("span",{children:"📍 Lahore"}),e.jsx("span",{children:"⚡ Instant QR Pass"})]})]})]}),e.jsxs("section",{className:"ticket-clean-shell",children:[g&&e.jsx(Gt,{type:g.type,message:g.message,onClose:()=>u(null)}),e.jsx("div",{className:"ticket-clean-stepper",children:Ys.map((U,F)=>e.jsxs("div",{className:`step-item ${F+1<=h?"is-active":""}`,children:[e.jsx("span",{className:"step-num",children:F+1}),e.jsx("span",{className:"step-text",children:U})]},U))}),w?e.jsxs("div",{className:"ticket-sold-out-box",style:{background:"linear-gradient(135deg, rgba(239, 68, 68, 0.15) 0%, rgba(30, 10, 15, 0.95) 100%)",border:"2px solid #ef4444",borderRadius:"24px",padding:"48px 24px",textAlign:"center",boxShadow:"0 20px 50px rgba(239, 68, 68, 0.25)",margin:"20px 0 40px"},children:[e.jsx("div",{style:{display:"inline-flex",alignItems:"center",gap:"8px",background:"#ef4444",color:"#ffffff",padding:"6px 16px",borderRadius:"9999px",fontSize:"13px",fontWeight:"800",letterSpacing:"2px",textTransform:"uppercase",marginBottom:"16px"},children:"🔒 PORTAL LOCKED"}),e.jsx("h2",{style:{fontSize:"clamp(26px, 5vw, 40px)",fontWeight:"900",color:"#ffffff",margin:"0 0 12px"},children:"Tickets Are Officially Sold Out!"}),e.jsxs("p",{style:{color:"#d1d5db",maxWidth:"600px",margin:"0 auto 24px",fontSize:"16px",lineHeight:"1.6"},children:["All General, VIP, and Premium passes for ",e.jsx("strong",{children:"OZILLA FEST 2026"})," have been fully booked. The ticket booking system is locked to prevent overbooking."]}),e.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:"14px",flexWrap:"wrap"},children:[e.jsx("button",{type:"button",onClick:()=>t("/#sponsorship"),style:{background:"linear-gradient(135deg, #d4af37 0%, #aa8420 100%)",color:"#111827",padding:"12px 28px",borderRadius:"12px",fontWeight:"700",fontSize:"14px",border:"none",cursor:"pointer"},children:"Inquire Corporate / Sponsor Passes"}),e.jsx("button",{type:"button",onClick:()=>t("/schedule"),style:{background:"rgba(255,255,255,0.08)",color:"#ffffff",border:"1px solid rgba(255,255,255,0.2)",padding:"12px 24px",borderRadius:"12px",fontWeight:"600",fontSize:"14px",cursor:"pointer"},children:"View Festival Schedule"})]})]}):a?e.jsxs("div",{className:"ticket-main-grid",children:[e.jsxs("div",{className:"ticket-form-card",children:[e.jsxs("div",{className:"ticket-form-header",children:[e.jsx("h2",{children:y?"Payment Checkout":"Pass Reservation"}),e.jsx("span",{className:"ticket-badge-pill",children:"Official Portal"})]}),y?e.jsxs("div",{className:"ticket-payment-wrapper",children:[e.jsx(qs,{activeMethod:A,onSelectMethod:v}),A==="payfast"&&e.jsx(Ws,{amount:j.total,onProceed:H,loading:c,onBack:()=>k(!1)}),A==="card"&&e.jsx(Bs,{amount:j.total,onSubmit:q,loading:c,onBack:()=>k(!1)}),A==="jazzcash"&&e.jsx(Hs,{amount:j.total,onSubmit:$,loading:c,onBack:()=>k(!1)}),A==="easypaisa"&&e.jsx(Gs,{amount:j.total,onSubmit:T,loading:c,onBack:()=>k(!1)})]}):e.jsx(Ms,{onSubmit:R,loading:c,profileDefaults:a,onBookingChange:f,availability:d,availabilityLoading:I})]}),e.jsx(Vs,{isOpen:x,onClose:()=>M(!1),ticket:p,amount:j.total,onComplete:Z}),e.jsx("aside",{className:"ticket-sidebar",children:e.jsxs("div",{className:"ticket-sidebar-summary",children:[e.jsx("h3",{children:"Order Summary"}),e.jsxs("div",{className:"summary-pass-type",children:[e.jsxs("strong",{children:[j.ticketType," Pass"]}),e.jsx("span",{children:j.day})]}),e.jsxs("div",{className:"summary-rows",children:[e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Quantity"}),e.jsx("strong",{children:j.quantity})]}),e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Price"}),e.jsxs("strong",{children:["PKR ",j.subtotal.toLocaleString()]})]}),e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Fee"}),e.jsx("strong",{style:{color:"#10b981"},children:"Free (PKR 0)"})]}),j.discount>0&&e.jsxs("div",{className:"summary-row summary-discount",children:[e.jsx("span",{children:"Discount"}),e.jsxs("strong",{children:["- PKR ",j.discount.toLocaleString()]})]})]}),e.jsxs("div",{className:"summary-total-row",children:[e.jsx("span",{children:"Grand Total"}),e.jsxs("strong",{children:["PKR ",j.total.toLocaleString()]})]}),e.jsx("div",{className:"summary-pass-badge",children:e.jsx("span",{children:"🎟️ Verified Digital QR Pass"})})]})})]}):e.jsxs("div",{className:"ticket-auth-prompt",children:[e.jsxs("div",{children:[e.jsx("h2",{children:"Sign in to Book Passes"}),e.jsx("p",{children:"Secure ticket purchasing requires an account for verified QR pass generation."})]}),e.jsx("button",{type:"button",onClick:L,className:"ticket-primary-button",children:"Sign In to Continue →"})]})]}),e.jsx("style",{children:`
        .ticket-portal-clean {
          position: relative;
          min-height: 100vh;
          padding: 0 0 3rem;
...
`;function va(t,a,r){const s=t.createShader(a);return s?(t.shaderSource(s,r),t.compileShader(s),t.getShaderParameter(s,t.COMPILE_STATUS)?s:(console.error("ParticleDrift shader:",t.getShaderInfoLog(s)),t.deleteShader(s),null)):null}function wa(t,a,r){const s=va(t,t.VERTEX_SHADER,a),i=va(t,t.FRAGMENT_SHADER,r);if(!s||!i)return null;const l=t.createProgram();return l?(t.attachShader(l,s),t.attachShader(l,i),t.linkProgram(l),t.getProgramParameter(l,t.LINK_STATUS)?l:(console.error("ParticleDrift link:",t.getProgramInfoLog(l)),null)):null}function ka(t,a){if(!t)return a;const r=String(t).trim();if(r.charAt(0)==="#"){let i=r.slice(1);if((i.length===3||i.length===4)&&(i=i[0]+i[0]+i[1]+i[1]+i[2]+i[2]),i.length>=6){const l=parseInt(i.slice(0,2),16),n=parseInt(i.slice(2,4),16),o=parseInt(i.slice(4,6),16);if(!isNaN(l)&&!isNaN(n)&&!isNaN(o))return[l/255,n/255,o/255]}return a}const s=r.match(/[\d.]+/g);return s&&s.length>=3?[Math.min(255,parseFloat(s[0]))/255,Math.min(255,parseFloat(s[1]))/255,Math.min(255,parseFloat(s[2]))/255]:a}function Be(t,a){return typeof t=="number"&&isFinite(t)?t:a}function rt(t,a,r){return t<a?a:t>r?r:t}function Ri(t){let a=t>>>0;return function(){a+=1831565813;let r=a;return r=Math.imul(r^r>>>15,r|1),r^=r+Math.imul(r^r>>>7,r|61),((r^r>>>14)>>>0)/4294967296}}const Ot=[[0,-1],[1,-1],[1,1],[0,-1],[1,1],[0,1]];function zi({style:t,background:a="transparent",baseColor:r="#F84400",accentColor:s="#ECECEC",density:i=235,dotSize:l=14,speed:n=100,direction:o=0,hover:c=200,linkDistance:g=202,linkThickness:u=2.5,width:y,height:k,isFixed:A=!0}){const v=m.useRef(null),p=m.useRef(null),b=m.useRef({w:0,h:0});b.current={w:Be(y,0),h:Be(k,0)};const x=m.useRef({x:-1e4,y:-1e4}),M=m.useRef({});M.current={base:r,accent:s,density:Math.round(rt(Be(i,90),10,400)),dotSize:rt(Be(l,5),1,24),speed:rt(Be(n,50),0,100)/50,direction:rt(Be(o,0),0,360),hover:rt(Be(c,100),0,200)/100,linkDistance:rt(Be(g,120),0,400),linkThickness:rt(Be(u,1),.5,8)},m.useEffect(()=>{const f=p.current;if(!f)return;const d=f.getContext("webgl",{alpha:!0,antialias:!1,depth:!1,premultipliedAlpha:!0});if(!d){console.error("ParticleDrift: WebGL unavailable");return}const _=wa(d,Ei,Ci),I=wa(d,Li,Ii);if(!_||!I)return;const P=new Map,h=(ae,G)=>{const S=(ae===_?"L:":"D:")+G;return P.has(S)||P.set(S,d.getUniformLocation(ae,G)),P.get(S)},w=new Float32Array(Ye*6*2),L=new Float32Array(Ye*6*2),R=new Float32Array(Ye*6*2),q=new Float32Array(Ye*6*3);for(let ae=0;ae<Ye;ae++)for(let G=0;G<6;G++){const S=(ae*6+G)*2;R[S]=Ot[G][0],R[S+1]=Ot[G][1]}const $=d.createBuffer(),T=d.createBuffer(),H=d.createBuffer(),Z=d.createBuffer();d.bindBuffer(d.ARRAY_BUFFER,$),d.bufferData(d.ARRAY_BUFFER,w.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,T),d.bufferData(d.ARRAY_BUFFER,L.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,H),d.bufferData(d.ARRAY_BUFFER,R,d.STATIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,Z),d.bufferData(d.ARRAY_BUFFER,q.byteLength,d.DYNAMIC_DRAW);const U=Ri(20260824);let F=0,O=new Float32Array(0),Y=new Float32Array(0),de=new Float32Array(0),N=new Float32Array(0),z=new Float32Array(0);const D=d.createBuffer(),E=d.createBuffer(),re=(ae,G,S)=>{F=ae,O=new Float32Array(ae),Y=new Float32Array(ae),de=new Float32Array(ae),N=new Float32Array(ae*2),z=new Float32Array(ae);for(let C=0;C<ae;C++)O[C]=U()*G,Y[C]=U()*S,de[C]=(U()*.4+.1)*60;d.bindBuffer(d.ARRAY_BUFFER,D),d.bufferData(d.ARRAY_BUFFER,N.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,E),d.bufferData(d.ARRAY_BUFFER,z.byteLength,d.DYNAMIC_DRAW)};let ee=0,B=performance.now(),le=-1,se=0,ie=0;const pe=ae=>{if(ee=requestAnimationFrame(pe),typeof document<"u"&&document.hidden){B=ae;return}const G=Math.min(.05,(ae-B)/1e3);B=ae;const S=M.current,C=S.speed,K=b.current.w||f.clientWidth||(typeof window<"u"?window.innerWidth:1200),X=b.current.h||f.clientHeight||(typeof window<"u"?window.innerHeight:800),ce=K<768,Le=K>=768&&K<1024,Ne=Math.min(window.devicePixelRatio||1,ce?.75:Ti),we=Math.max(1,Math.round(K*Ne)),De=Math.max(1,Math.round(X*Ne));(f.width!==we||f.height!==De)&&(f.width=we,f.height=De),d.viewport(0,0,we,De);let _e=S.density,Re=S.linkDistance,dt=S.dotSize;if(ce?(_e=42,Re=95,dt=Math.min(S.dotSize,7)):Le&&(_e=Math.max(80,Math.min(Math.round(S.density*.5),110)),Re=Math.min(S.linkDistance,145),dt=Math.min(S.dotSize,10)),_e!==le&&(re(_e,K,X),le=_e),K!==se||X!==ie){const W=K/Math.max(se||K,1),ne=X/Math.max(ie||X,1);for(let ue=0;ue<F;ue++)O[ue]*=W,Y[ue]*=ne;se=K,ie=X}const Qe=x.current,pt=S.hover,mt=(ce?100:180)*(pt>0?1:0),Ae=Re,ft=ce?Math.min(S.linkThickness,1.6):S.linkThickness,ht=S.direction*Math.PI/180,xt=Math.sin(ht),At=Math.cos(ht);let ze=0;const bt=(W,ne,ue,Pe,be,Ie,Ge,st)=>{if(!(ze>=Ye)){for(let Me=0;Me<6;Me++){const it=(ze*6+Me)*2,Pt=(ze*6+Me)*3;w[it]=W,w[it+1]=ne,L[it]=ue,L[it+1]=Pe,q[Pt]=Ot[Me][0]===0?be:Ie,q[Pt+1]=Ge,q[Pt+2]=st}ze++}};for(let W=0;W<F;W++){O[W]+=de[W]*xt*G*C,Y[W]+=de[W]*At*G*C,O[W]<-Xe?(O[W]=K+Xe,Y[W]=U()*X):O[W]>K+Xe&&(O[W]=-Xe,Y[W]=U()*X),Y[W]<-Xe?(Y[W]=X+Xe,O[W]=U()*K):Y[W]>X+Xe&&(Y[W]=-Xe,O[W]=U()*K);const ne=Qe.x-O[W],ue=Qe.y-Y[W],Pe=Math.sqrt(ne*ne+ue*ue),be=mt>0&&Pe<mt?1:0;if(be===1){const Ie=.5*(1-Pe/mt)*pt;bt(O[W],Y[W],Qe.x,Qe.y,Ie,Ie,1,ft)}N[W*2]=O[W],N[W*2+1]=Y[W],z[W]=be}if(Ae>0){const W=Ae*Ae;for(let ne=0;ne<F&&ze<Ye;ne++){const ue=O[ne],Pe=Y[ne];for(let be=ne+1;be<F&&ze<Ye;be++){const Ie=ue-O[be];if(Ie>Ae||Ie<-Ae)continue;const Ge=Pe-Y[be];if(Ge>Ae||Ge<-Ae)continue;const st=Ie*Ie+Ge*Ge;if(st>=W)continue;const Me=.15*(1-Math.sqrt(st)/Ae);bt(ue,Pe,O[be],Y[be],Me,Me,0,ft)}}}d.clearColor(0,0,0,0),d.clear(d.COLOR_BUFFER_BIT),d.disable(d.DEPTH_TEST),d.enable(d.BLEND),d.blendFunc(d.ONE,d.ONE_MINUS_SRC_ALPHA);const He=ka(S.base,[.973,.267,0]),Ue=ka(S.accent,[.925,.925,.925]);if(ze>0){d.useProgram(_);const W=ze*6;d.bindBuffer(d.ARRAY_BUFFER,$),d.bufferSubData(d.ARRAY_BUFFER,0,w.subarray(0,W*2));const ne=d.getAttribLocation(_,"a_p0");d.enableVertexAttribArray(ne),d.vertexAttribPointer(ne,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,T),d.bufferSubData(d.ARRAY_BUFFER,0,L.subarray(0,W*2));const ue=d.getAttribLocation(_,"a_p1");d.enableVertexAttribArray(ue),d.vertexAttribPointer(ue,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,H);const Pe=d.getAttribLocation(_,"a_corner");d.enableVertexAttribArray(Pe),d.vertexAttribPointer(Pe,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,Z),d.bufferSubData(d.ARRAY_BUFFER,0,q.subarray(0,W*3));const be=d.getAttribLocation(_,"a_shade");d.enableVertexAttribArray(be),d.vertexAttribPointer(be,3,d.FLOAT,!1,0,0),d.uniform2f(h(_,"uSize"),K,X),d.uniform3f(h(_,"uBase"),He[0],He[1],He[2]),d.uniform3f(h(_,"uAccent"),Ue[0],Ue[1],Ue[2]),d.drawArrays(d.TRIANGLES,0,W),d.disableVertexAttribArray(ne),d.disableVertexAttribArray(ue),d.disableVertexAttribArray(Pe),d.disableVertexAttribArray(be)}if(F>0){d.useProgram(I),d.bindBuffer(d.ARRAY_BUFFER,D),d.bufferSubData(d.ARRAY_BUFFER,0,N);const W=d.getAttribLocation(I,"a_pos");d.enableVertexAttribArray(W),d.vertexAttribPointer(W,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,E),d.bufferSubData(d.ARRAY_BUFFER,0,z);const ne=d.getAttribLocation(I,"a_lit");d.enableVertexAttribArray(ne),d.vertexAttribPointer(ne,1,d.FLOAT,!1,0,0),d.uniform2f(h(I,"uSize"),K,X),d.uniform1f(h(I,"uDpr"),Ne),d.uniform1f(h(I,"uDot"),dt),d.uniform1f(h(I,"uRestAlpha"),.4),d.uniform3f(h(I,"uBase"),He[0],He[1],He[2]),d.uniform3f(h(I,"uAccent"),Ue[0],Ue[1],Ue[2]),d.drawArrays(d.POINTS,0,F),d.disableVertexAttribArray(W),d.disableVertexAttribArray(ne)}},je=ae=>{const G=f.getBoundingClientRect();if(G.width<=0||G.height<=0)return;const S=b.current.w||f.clientWidth||window.innerWidth||1200,C=b.current.h||f.clientHeight||window.innerHeight||800;x.current.x=(ae.clientX-G.left)/G.width*S,x.current.y=(ae.clientY-G.top)/G.height*C},ve=()=>{x.current.x=-1e4,x.current.y=-1e4};return window.addEventListener("pointermove",je,{passive:!0}),window.addEventListener("pointerleave",ve,{passive:!0}),ee=requestAnimationFrame(pe),()=>{cancelAnimationFrame(ee),window.removeEventListener("pointermove",je),window.removeEventListener("pointerleave",ve),d.deleteBuffer($),d.deleteBuffer(T),d.deleteBuffer(H),d.deleteBuffer(Z),d.deleteBuffer(D),d.deleteBuffer(E),d.deleteProgram(_),d.deleteProgram(I)}},[]);const j=A?{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:0,pointerEvents:"none",overflow:"hidden",background:a,isolation:"isolate",...t}:{position:"relative",overflow:"hidden",background:a,isolation:"isolate",width:typeof y=="number"&&y>0?y:"100%",height:typeof k=="number"&&k>0?k:"100%",...t};return e.jsx("div",{ref:v,style:j,"aria-hidden":"true",children:e.jsx("canvas",{ref:p,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}})})}function Mi(){const t="/ozillafest/".replace(/\/$/,"");return e.jsx(qa,{basename:t||void 0,future:{v7_startTransition:!0,v7_relativeSplatPath:!0},children:e.jsxs(er,{children:[e.jsx(zi,{}),e.jsx(Pi,{})]})})}const ja=(t="")=>{const a=String(t).toLowerCase();return a.includes("importing a module script failed")||a.includes("failed to fetch dynamically imported module")||a.includes("loading chunk")||a.includes("failed to load module script")||a.includes("error loading dynamically imported module")||a.includes("mime type")||a.includes("dynamically imported")};class Fi extends m.Component{constructor(r){super(r);Vt(this,"handleReload",()=>{sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload()});this.state={error:null}}static getDerivedStateFromError(r){return{error:r}}componentDidCatch(r,s){if(console.error("Application render error:",r,s),ja(r?.message)){const i=Number(sessionStorage.getItem("chunk_reload_ts")||0);Date.now()-i>8e3&&(sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload())}}render(){if(this.state.error){const r=ja(this.state.error?.message);return e.jsxs("main",{style:{padding:"32px 20px",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',maxWidth:"540px",margin:"60px auto",textAlign:"center",backgroundColor:"#121118",color:"#f3f4f6",borderRadius:"16px",border:"1px solid rgba(255,255,255,0.1)",boxShadow:"0 20px 50px rgba(0,0,0,0.5)"},children:[e.jsx("h2",{style:{color:"#f97316",marginBottom:"12px",fontSize:"1.4rem"},children:r?"New Update Available":"Ozilla Festival could not render"}),e.jsx("p",{style:{color:"#9ca3af",marginBottom:"20px",fontSize:"0.95rem",lineHeight:"1.5"},children:r?"A fresh update has been deployed. Please tap refresh to load the latest version.":"Please refresh the page to reload the application."}),e.jsx("button",{type:"button",onClick:this.handleReload,style:{padding:"12px 28px",backgroundColor:"#ea580c",color:"#ffffff",border:"none",borderRadius:"999px",cursor:"pointer",fontWeight:"700",fontSize:"1rem",boxShadow:"0 4px 14px rgba(234, 88, 12, 0.4)",transition:"transform 0.15s ease"},children:"Refresh Website"})]})}return this.props.children}}if(typeof window<"u"){const t=a=>{const r=String(a?.message||a?.reason?.message||"").toLowerCase();if(r.includes("importing a module script failed")||r.includes("failed to fetch dynamically imported module")||r.includes("loading chunk")||r.includes("failed to load module script")){const s=Number(sessionStorage.getItem("chunk_reload_ts")||0);Date.now()-s>8e3&&(sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload())}};window.addEventListener("error",t),window.addEventListener("unhandledrejection",t)}const Oi="231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com";Dt.createRoot(document.getElementById("root")).render(e.jsx(gt.StrictMode,{children:e.jsx(Fi,{children:e.jsx(Ja,{clientId:Oi,children:e.jsx(Mi,{})})})}));export{Gt as A,Ut as a,te as b,Hi as c,Ks as f,Se as t,Je as u};
