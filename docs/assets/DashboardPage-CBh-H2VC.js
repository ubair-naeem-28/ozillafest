import{j as e,m as h}from"./vendor-motion-DHTbcX3O.js";import{r as u,u as ot,L as he}from"./vendor-react-6MXTWAEx.js";import{b as I}from"./index-DjWMnghM.js";import{o as lt}from"./ozillaProfessionalContent-ZVEKGzFZ.js";import"./vendor-utils-Bub7y9MC.js";I("/assets/ozilla/talwinder.jpg"),I("/assets/ozilla/talwinder.jpg"),I("/assets/ozilla/Imran-Khan.jpg"),I("/assets/ozilla/Imran-Khan.jpg"),I("/assets/ozilla/Bohemia.jpg"),I("/assets/ozilla/Bohemia.jpg"),I("/assets/ozilla/hassan-raheem.jpg"),I("/assets/ozilla/hassan-raheem.jpg");const Re=[{name:"TALWINDER",isHeadliner:!0,genre:"Indie Pop / Punjabi Fusion",stage:"Main Prism Stage",bpm:"128 BPM",vibe:"Euphoric Night",src:I("/assets/ozilla/talwinder.jpg"),image:I("/assets/ozilla/talwinder.jpg"),offsetY:0},{name:"IMRAN KHAN",isHeadliner:!1,genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",src:I("/assets/ozilla/Imran-Khan.jpg"),image:I("/assets/ozilla/Imran-Khan.jpg"),offsetY:0},{name:"BOHEMIA",isHeadliner:!1,genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",src:I("/assets/ozilla/Bohemia.jpg"),image:I("/assets/ozilla/Bohemia.jpg"),offsetY:0},{name:"HASSAN RAHEEM",isHeadliner:!1,genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",src:I("/assets/ozilla/hassan-raheem.jpg"),image:I("/assets/ozilla/hassan-raheem.jpg"),offsetY:0}],Pe=1.28,Te=.78;function le(i,n,t){return Math.min(t,Math.max(n,i))}function ze(i){if(!i)return null;if(typeof i=="string")return i||null;const n=i.src||i.image;return typeof n=="string"&&n?n:null}function ct(i){return ze(i&&typeof i=="object"&&(i.image||i.src)||i)}function pt(i){if(i&&typeof i=="object"&&"offsetY"in i){const n=i.offsetY;return typeof n=="number"&&isFinite(n)?n:0}return 0}function dt({items:i=Re,images:n,slideWidth:t=320,slideHeight:r=440,spacing:l=2.4,direction:y="right",smoothness:w=8.5,radius:k=24,dim:v=5,background:R="transparent",sensitivity:D=5,autoPlay:L=!1,autoPlayInterval:B=3500,style:H,onItemClick:U}){const O=u.useRef(null),_=u.useRef([]),E=u.useRef(0),V=u.useRef(0),[T,z]=u.useState(0),[re,ie]=u.useState(!1),[f,p]=u.useState(0),a=i&&i.length>0?i:n&&n.length>0?n:Re,o=u.useMemo(()=>a.map((s,c)=>({...s,src:ct(s),offsetY:pt(s),name:s.name||`Artist ${c+1}`,genre:s.genre||"Live Performer",stage:s.stage||"Ozilla Arena",bpm:s.bpm||"128 BPM",vibe:s.vibe||"Festival Energy",isHeadliner:!!s.isHeadliner})),[a]),x=T>0&&T<640?Math.min(t,250):T<1024?Math.min(t,290):t,b=T>0&&T<640?Math.round(x*1.36):r,F=x+le(l,0,10)*18,N=.15-le(w,0,10)/10*.11,K=le(v,0,10)/10*.75,M=.4+le(D,0,10)/10*1.1,G=.6+le(D,0,10)/10*1.6,Q=y==="left",W=u.useRef({count:o.length,step:F,slideWidth:x,width:T,ease:N,maxScale:Pe,minScale:Te,dim:K,loop:!1,flip:Q});W.current={count:o.length,step:F,slideWidth:x,width:T,ease:N,maxScale:Pe,minScale:Te,dim:K,loop:!1,flip:Q};const C=u.useRef({wheelMultiplier:M,dragMultiplier:G,flip:Q});C.current={wheelMultiplier:M,dragMultiplier:G,flip:Q},u.useEffect(()=>{const s=O.current;if(!s)return;const c=new ResizeObserver(m=>{m[0]&&z(m[0].contentRect.width)});return c.observe(s),z(s.getBoundingClientRect().width),()=>c.disconnect()},[]),u.useEffect(()=>{_.current.length=o.length},[o.length]),u.useEffect(()=>{if(!L||re||o.length<=1)return;const s=setInterval(()=>{p(c=>{const m=(c+1)%o.length;return E.current=m*F,m})},B);return()=>clearInterval(s)},[L,re,o.length,F,B]),u.useEffect(()=>{let s=0,c=0;const m=S=>{s=requestAnimationFrame(m);const d=W.current,Y=c?Math.min((S-c)/1e3,.1):1/60;if(c=S,!d.count||d.step<=0||d.width<=0)return;const P=(d.count-1)*d.step;E.current=le(E.current,0,P);const Z=1-Math.pow(1-d.ease,Y*60);V.current+=(E.current-V.current)*Z;const ee=Math.round(V.current/d.step);ee>=0&&ee<d.count&&p(ee);const fe=(d.width-d.slideWidth)/2,ue=d.width/2;for(let ne=0;ne<d.count;ne+=1){const te=_.current[ne];if(!te)continue;const j=ne*d.step-V.current+fe,A=j+d.slideWidth/2-ue;let g,$;A>0?(g=Math.min(d.maxScale,1+A/d.width*.45),$=(g-1)*d.slideWidth*.35):(g=Math.max(d.minScale,1+A/d.width*.5),$=0);const ce=d.flip?d.width-d.slideWidth-(j+$):j+$;if(te.style.transform=`translate3d(${ce}px, -50%, 0) scale(${g})`,d.dim>0&&g<1){const J=(1-g)/Math.max(.001,1-d.minScale);te.style.filter=`brightness(${Math.max(.35,1-J*d.dim)})`}else te.style.filter="none"}};return s=requestAnimationFrame(m),()=>cancelAnimationFrame(s)},[]),u.useEffect(()=>{const s=O.current;if(!s)return;const c=m=>{m.preventDefault();const S=Math.abs(m.deltaX)>Math.abs(m.deltaY)?m.deltaX:m.deltaY;E.current+=S*C.current.wheelMultiplier};return s.addEventListener("wheel",c,{passive:!1}),()=>s.removeEventListener("wheel",c)},[]),u.useEffect(()=>{const s=O.current;if(!s)return;let c=null,m=0;const S=P=>{if(c===null){c=P.pointerId,m=P.clientX;try{s.setPointerCapture(P.pointerId)}catch{}}},d=P=>{if(c!==P.pointerId)return;const Z=P.clientX-m;m=P.clientX,E.current+=(C.current.flip?Z:-Z)*C.current.dragMultiplier},Y=P=>{if(c===P.pointerId){c=null;try{s.hasPointerCapture(P.pointerId)&&s.releasePointerCapture(P.pointerId)}catch{}}};return s.addEventListener("pointerdown",S),s.addEventListener("pointermove",d),s.addEventListener("pointerup",Y),s.addEventListener("pointercancel",Y),()=>{s.removeEventListener("pointerdown",S),s.removeEventListener("pointermove",d),s.removeEventListener("pointerup",Y),s.removeEventListener("pointercancel",Y)}},[]);const X=u.useCallback(s=>{const c=le(s,0,o.length-1);E.current=c*F,p(c)},[o.length,F]),se=u.useCallback(s=>{const c=le(f+(s==="left"?-1:1),0,o.length-1);X(c)},[f,X,o.length]);return e.jsxs("div",{style:{position:"relative",width:"100%",display:"flex",flexDirection:"column",alignItems:"center",margin:"1.2rem 0"},onMouseEnter:()=>ie(!0),onMouseLeave:()=>ie(!1),children:[e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",flexWrap:"wrap",gap:"8px",marginBottom:"1rem",zIndex:10},children:o.map((s,c)=>{const m=c===f;return e.jsx("button",{type:"button",onClick:()=>X(c),style:{padding:"6px 14px",borderRadius:"999px",border:m?"1px solid #ff8a3d":"1px solid rgba(255, 255, 255, 0.12)",background:m?"linear-gradient(135deg, rgba(255, 138, 61, 0.32), rgba(255, 90, 31, 0.22))":"rgba(20, 10, 6, 0.55)",color:m?"#ffbd59":"rgba(255, 255, 255, 0.65)",fontSize:"0.78rem",fontWeight:m?"850":"650",letterSpacing:"0.04em",cursor:"pointer",transition:"all 200ms ease",backdropFilter:"blur(8px)",boxShadow:m?"0 0 16px rgba(255, 138, 61, 0.35)":"none"},children:s.name},s.name)})}),e.jsx("div",{ref:O,className:"smooth-scroll-slider-viewport",style:{position:"relative",width:"100%",height:`${b+50}px`,overflow:"hidden",background:R,cursor:"grab",touchAction:"pan-y",opacity:T>0?1:0,transition:"opacity 0.35s ease",userSelect:"none",...H},children:o.map((s,c)=>{const m=s.isHeadliner,S=c===f;return e.jsxs("div",{ref:d=>{_.current[c]=d},onClick:()=>{X(c),U&&U(s,c)},style:{position:"absolute",top:"50%",left:0,width:`${x}px`,height:`${b}px`,borderRadius:`${k}px`,overflow:"hidden",background:"#130c0a",border:S?"1.5px solid rgba(255, 138, 61, 0.85)":m?"1px solid rgba(255, 138, 61, 0.45)":"1px solid rgba(255, 255, 255, 0.12)",boxShadow:S?"0 26px 65px rgba(0,0,0,0.9), 0 0 35px rgba(255, 90, 31, 0.4)":"0 18px 45px rgba(0,0,0,0.75)",willChange:"transform, filter",transform:"translate3d(0, -50%, 0)",cursor:"pointer",transition:"border-color 250ms ease, box-shadow 250ms ease"},children:[s.src?e.jsx("img",{src:s.src,alt:s.name,draggable:!1,onError:d=>{d.currentTarget.src=I("/assets/prism-auth-visual.jpg")},style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:`50% calc(50% + ${s.offsetY}px)`,display:"block",userSelect:"none"}}):null,e.jsxs("div",{style:{position:"absolute",top:"12px",left:"12px",right:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",zIndex:3},children:[m?e.jsx("span",{style:{display:"inline-flex",alignItems:"center",gap:"4px",padding:"4px 10px",borderRadius:"999px",background:"linear-gradient(135deg, #ff8a3d, #ff5a1f)",color:"#fff",fontSize:"0.68rem",fontWeight:"900",letterSpacing:"0.06em",textTransform:"uppercase",boxShadow:"0 4px 14px rgba(255, 90, 31, 0.45)"},children:"★ MAIN HEADLINER"}):e.jsx("span",{style:{padding:"3px 9px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.65)",backdropFilter:"blur(8px)",color:"#f6eee8",fontSize:"0.66rem",fontWeight:"700",border:"1px solid rgba(255,255,255,0.12)"},children:s.stage}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",gap:"2px",height:"14px",padding:"3px 6px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.55)",backdropFilter:"blur(6px)"},children:[e.jsx("span",{className:"sss-eq-bar sss-eq-1"}),e.jsx("span",{className:"sss-eq-bar sss-eq-2"}),e.jsx("span",{className:"sss-eq-bar sss-eq-3"})]})]}),e.jsxs("div",{style:{position:"absolute",inset:0,background:"linear-gradient(180deg, rgba(0,0,0,0.08) 0%, transparent 40%, rgba(10,5,3,0.72) 65%, rgba(6,3,2,0.96) 100%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:"16px 14px",zIndex:2},children:[e.jsx("span",{style:{display:"inline-block",width:"fit-content",padding:"2px 8px",borderRadius:"999px",background:"rgba(255, 138, 61, 0.18)",border:"1px solid rgba(255, 138, 61, 0.35)",color:"#ffbd59",fontSize:"0.68rem",fontWeight:"800",letterSpacing:"0.04em",textTransform:"uppercase",marginBottom:"6px"},children:s.genre}),e.jsx("h3",{style:{margin:0,color:"#ffffff",fontSize:"1.28rem",fontWeight:"900",letterSpacing:"-0.02em",lineHeight:1.15,textTransform:"uppercase",textShadow:"0 2px 10px rgba(0,0,0,0.7)"},children:s.name}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginTop:"8px",paddingTop:"6px",borderTop:"1px solid rgba(255,255,255,0.1)",color:"rgba(255, 255, 255, 0.72)",fontSize:"0.68rem",fontWeight:"700"},children:[e.jsxs("span",{children:["⚡ ",s.bpm]}),e.jsxs("span",{children:["♫ ",s.vibe]})]})]})]},s.name)})}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"1rem",marginTop:"0.8rem",zIndex:10},children:[e.jsx("button",{type:"button",onClick:()=>se("left"),disabled:f===0,"aria-label":"Previous artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:f===0?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:f===0?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:f===0?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:f===0?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:s=>{f>0&&(s.currentTarget.style.transform="scale(1.1)",s.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:s=>{s.currentTarget.style.transform="scale(1)",s.currentTarget.style.borderColor=f===0?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"‹"}),e.jsx("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:o.map((s,c)=>e.jsx("span",{onClick:()=>X(c),style:{width:c===f?"20px":"6px",height:"6px",borderRadius:"999px",backgroundColor:c===f?"#ff8a3d":"rgba(255, 255, 255, 0.25)",cursor:"pointer",transition:"all 250ms ease"}},c))}),e.jsx("button",{type:"button",onClick:()=>se("right"),disabled:f===o.length-1,"aria-label":"Next artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:f===o.length-1?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:f===o.length-1?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:f===o.length-1?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:f===o.length-1?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:s=>{f<o.length-1&&(s.currentTarget.style.transform="scale(1.1)",s.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:s=>{s.currentTarget.style.transform="scale(1)",s.currentTarget.style.borderColor=f===o.length-1?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"›"})]}),e.jsx("style",{children:`
        .sss-eq-bar {
          width: 2px;
          border-radius: 999px;
          background: #ff8a3d;
      ...
      `})]})}const de={color:"#ff8a3d",rounded:24,thickness:2.5,borderSize:45,glow:85,movement:"continuous",speed:16},mt=2,Ge=[{blur:8,opacity:.5,reach:.3},{blur:15,opacity:.3,reach:.6},{blur:40,opacity:.18,reach:1}],ft=Math.max(...Ge.map(i=>i.blur)),Me=36;function we(i,n){const t=Math.max(0,Math.min(1,n));if(typeof i!="string")return`rgba(0,0,0,${t})`;const r=i.trim(),l=r.match(/^#([0-9a-f]{3,8})$/i);if(l){let w=l[1];(w.length===3||w.length===4)&&(w=w.split("").map(v=>v+v).join(""));const k=parseInt(w.slice(0,6),16);return Number.isFinite(k)?`rgba(${k>>16&255},${k>>8&255},${k&255},${t})`:`rgba(0,0,0,${t})`}const y=r.match(/^rgba?\(([^)]+)\)/i);if(y){const w=y[1].split(",").map(k=>parseFloat(k));if(w.length>=3&&w.slice(0,3).every(Number.isFinite))return`rgba(${w[0]},${w[1]},${w[2]},${t})`}return`rgba(0,0,0,${t})`}function gt(i,n,t){const r=(i%1+1)%1*2*(n+t);return r<n?[r,0]:r<n+t?[n,r-n]:r<n*2+t?[n-(r-n-t),t]:[0,t-(r-n*2-t)]}function Fe(i,n,t){const r=2*(n+t),l=[0,n/r,(n+t)/r,(n*2+t)/r];return Math.floor(i/4)+l[(i%4+4)%4]}function ht(i,n,t){const[r,l]=gt(i,n,t);return Math.atan2(r-n/2,t/2-l)*180/Math.PI}const Ce=24,ut=.015;function je(i,n,t,r,l){const y=t>0?t:100,w=r>0?r:100,k=Math.max(0,Math.min(100,n)),v=Math.max(ut,k/100*.5),R=k/100,D=[];let L=0,B=0,H=0;for(let O=0;O<=Ce;O++){const _=O/Ce,E=ht(i+(_-.5)*v,y,w);if(O===0)L=E;else{let z=E-B;for(;z>180;)z-=360;for(;z<-180;)z+=360;H+=z}B=E;const V=Math.abs(_-.5)*2,T=R>=1||V<=R?1:1-(V-R)/(1-R);D.push(`${we(l,T*T*(3-2*T))} ${H.toFixed(2)}deg`)}const U=H.toFixed(2);return D.push(`${we(l,0)} ${U}deg`),D.push(`${we(l,0)} 360deg`),`conic-gradient(from ${L.toFixed(2)}deg at 50% 50%, ${D.join(", ")})`}const De=30,bt=4,Le=3,xt=.35,yt=[.72,.16,.18,1.05],vt=[.65,0,.35,1];function Ue(i){const[n,t,r,l]=i;if(n===t&&r===l)return w=>w;const y=(w,k,v)=>{const R=1-v;return 3*R*R*v*w+3*R*v*v*k+v*v*v};return w=>{const k=Math.max(0,Math.min(1,w));let v=k;for(let R=0;R<8;R++){const D=y(n,r,v)-k,L=1-v,B=3*L*L*n+6*L*v*(r-n)+3*v*v*(1-r);if(Math.abs(B)<1e-6)break;v-=D/B,v=Math.max(0,Math.min(1,v))}return y(t,l,v)}}const wt=Ue(yt),jt=Ue(vt),Be={WebkitMaskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",WebkitMaskClip:"content-box, border-box",WebkitMaskComposite:"xor",maskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",maskClip:"content-box, border-box",maskComposite:"exclude"};function ae({color:i=de.color,rounded:n=de.rounded,thickness:t=de.thickness,borderSize:r=de.borderSize,glow:l=de.glow,movement:y=de.movement,speed:w=de.speed,style:k,className:v=""}){const R=u.useRef(null),D=u.useRef(null),L=u.useRef({speed:w,movement:y,borderSize:r,color:i});L.current={speed:w,movement:y,borderSize:r,color:i};const B=u.useRef(null),H=u.useRef({w:0,h:0}),[U,O]=u.useState({w:0,h:0});u.useEffect(()=>{const p=B.current;if(!p||typeof ResizeObserver>"u")return;const a=new ResizeObserver(()=>{const o=p.getBoundingClientRect();o.width===H.current.w&&o.height===H.current.h||(H.current={w:o.width,h:o.height},O(H.current))});return a.observe(p),()=>a.disconnect()},[]),u.useEffect(()=>{const p=B.current;let a=!0,o=null;typeof IntersectionObserver<"u"&&p&&(o=new IntersectionObserver(G=>{G[0]&&(a=G[0].isIntersecting)},{rootMargin:"100px"}),o.observe(p));let x=0,b=performance.now(),F=0,N=0,K=0;const M=G=>{if(x=requestAnimationFrame(M),!a||typeof document<"u"&&document.hidden){b=G;return}const Q=Math.min(.05,Math.max(0,(G-b)/1e3));b=G;const W=L.current,C=Math.max(0,Math.min(20,W.speed));if(C>0){const X=W.movement==="step",se=X?Le+(xt-Le)*(C-1)/19:(De+(bt-De)*(C-1)/19)/4;for(K+=Q/se;K>=1;)K-=1,N+=1;const s=X?wt(Math.min(1,K*2)):jt(K),{w:c,h:m}=H.current,S=c>0?c:100,d=m>0?m:100,Y=Fe(N,S,d),P=Fe(N+1,S,d);F=Y+(P-Y)*s;const Z=R.current;Z&&Z.style.setProperty("--arc",je(F,W.borderSize,c,m,W.color));const ee=D.current;ee&&ee.style.setProperty("--arc",je(F+.5,W.borderSize,c,m,W.color))}};return x=requestAnimationFrame(M),()=>{cancelAnimationFrame(x),o&&o.disconnect()}},[]);const _=Math.max(1,Math.min(10,t)),E=Math.max(0,Math.min(100,n))/100*(Math.min(U.w||200,U.h||200)/2),V=Math.max(0,Math.min(100,l))/100,T=p=>_+V*Me*p,z=10+Me+ft*2,re=(p,a=0)=>e.jsx("div",{style:{position:"absolute",inset:a-p,boxSizing:"border-box",padding:p,borderRadius:E>0?E+p:0,background:"var(--arc)",...Be}}),ie=(p,a,o,x)=>e.jsx("div",{style:{position:"absolute",inset:-z,boxSizing:"border-box",padding:z,borderRadius:E>0?E+z:0,opacity:x,mixBlendMode:"plus-lighter",filter:o?`blur(${o.toFixed(1)}px)`:"none",WebkitFilter:o?`blur(${o.toFixed(1)}px)`:"none",...Be},children:re(a,z)},p),f=(p,a)=>e.jsxs("div",{ref:a,style:{position:"absolute",inset:0,overflow:"visible",pointerEvents:"none","--arc":je(p,r,U.w,U.h,i)},children:[V>0&&Ge.map((o,x)=>ie(`glow-${x}`,T(o.reach),o.blur,o.opacity)),Array.from({length:mt}).map((o,x)=>e.jsx("div",{style:{position:"absolute",inset:0,mixBlendMode:"plus-lighter"},children:re(_)},`edge-${x}`))]});return e.jsxs("div",{ref:B,className:`neon-border-overlay ${v}`,style:{position:"absolute",inset:0,width:"100%",height:"100%",flexShrink:0,borderRadius:E,pointerEvents:"none",zIndex:1,...k},children:[f(0,R),f(.5,D)]})}const Nt=1.5,St=42,At=Math.PI*2,kt=300,It=300,Et=2,Rt=5e3,Pt=3.2,Tt=.05,zt=3,Mt=1.35,Ft=.08,Ct=.5,Dt=.24,Lt=.35,Bt=At*.75,Ot=2,_e=3,xe=720,Ht=`
