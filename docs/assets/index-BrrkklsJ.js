const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/UserDashboardPage-DWhbJy4z.js","assets/vendor-motion-BW8tmsoW.js","assets/vendor-react-DycaHlXR.js","assets/PageHeader-Cr0bo0tp.js","assets/vendor-utils-BRCtA9qj.js","assets/AdminDashboardPage-iku1c0zX.js","assets/AdminTicketReviewPage-BxECJFls.js"])))=>i.map(i=>d[i]);
var _a=Object.defineProperty;var Ba=(t,a,r)=>a in t?_a(t,a,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[a]=r;var Yt=(t,a,r)=>Ba(t,typeof a!="symbol"?a+"":a,r);import{j as e,u as Na,m as ce,a as qt,b as $a,A as Ha}from"./vendor-motion-BW8tmsoW.js";import{a as Ua,r as m,R as gt,u as Ke,N as ye,O as ut,L as X,b as ct,c as Ga,d as Wa,e as Sa,f as Va,g as K,B as Ya}from"./vendor-react-DycaHlXR.js";import{a as qa,Q as Xa}from"./vendor-utils-BRCtA9qj.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function r(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(i){if(i.ep)return;i.ep=!0;const l=r(i);fetch(i.href,l)}})();var _t={},Xt=Ua;_t.createRoot=Xt.createRoot,_t.hydrateRoot=Xt.hydrateRoot;function Za(t={}){const{nonce:a,locale:r,onScriptLoadSuccess:s,onScriptLoadError:i}=t,[l,n]=m.useState(!1),o=m.useRef(s);o.current=s;const c=m.useRef(i);return c.current=i,m.useEffect(()=>{const g=document.createElement("script");return g.src="https://accounts.google.com/gsi/client",r&&(g.src+=`?hl=${r}`),g.async=!0,g.defer=!0,g.nonce=a,g.onload=()=>{var u;n(!0),(u=o.current)===null||u===void 0||u.call(o)},g.onerror=()=>{var u;n(!1),(u=c.current)===null||u===void 0||u.call(c)},document.body.appendChild(g),()=>{document.body.removeChild(g)}},[a]),l}const Ka=m.createContext(null);function Ja({clientId:t,nonce:a,locale:r,onScriptLoadSuccess:s,onScriptLoadError:i,children:l}){const n=Za({nonce:a,onScriptLoadSuccess:s,onScriptLoadError:i,locale:r}),o=m.useMemo(()=>({locale:r,clientId:t,scriptLoadedSuccessfully:n}),[t,n]);return gt.createElement(Ka.Provider,{value:o},l)}const Et="prism_token",Ne={getToken(){return localStorage.getItem(Et)},setToken(t){localStorage.setItem(Et,t)},removeToken(){localStorage.removeItem(Et)}};function Aa(){return"https://ozillafest.onrender.com/api"}const Pa=Aa(),Hi=Pa.replace(/\/api\/?$/,""),ee=qa.create({baseURL:Pa,headers:{"Content-Type":"application/json"}});ee.interceptors.request.use(t=>{t.baseURL=Aa();const a=Ne.getToken();return a&&(t.headers.Authorization=`Bearer ${a}`),t},t=>Promise.reject(t));ee.interceptors.response.use(t=>t,t=>(t.response?.status===401&&Ne.removeToken(),Promise.reject(t)));const Ee={AUTH:{LOGIN:"/auth/login",REGISTER:"/auth/register",LOGOUT:"/auth/logout",SEND_OTP:"/auth/resend-otp",RESEND_OTP:"/auth/resend-otp",VERIFY_OTP:"/auth/verify-otp",FORGOT_PASSWORD:"/auth/forgot-password",RESET_PASSWORD:"/auth/reset-password",GOOGLE:"/auth/google",GOOGLE_CODE_LOGIN:"/auth/google/code-login",GOOGLE_TOKEN_LOGIN:"/auth/google/token-login",GOOGLE_CONFIG:"/auth/google/config",ME:"/auth/me",PROFILE:"/auth/profile"},TICKETS:{MY_TICKETS:"/tickets/my-tickets",REQUEST:"/tickets/request",BY_ID:"/tickets/:id",PAYMENT_PROOF:"/tickets/:id/payment-proof",VERIFY:"/tickets/:id/verify"},CONTENT:{EVENTS:"/content/events",EVENT_BY_ID:"/content/events/:id",SPONSORS:"/content/sponsors",FACILITIES:"/content/facilities",CONTACT:"/content/contact"}},Ta="ozilla_local_users";let lt=!1;function Ce(t){return String(t||"").toLowerCase().trim()}function $e(t){return String(t||"").trim()}function We(){try{const t=localStorage.getItem(Ta),a=t?JSON.parse(t):[];return Array.isArray(a)?a:[]}catch{return[]}}function Ve(t){localStorage.setItem(Ta,JSON.stringify(t))}function Qa(t){const a={sub:t.id,email:t.email,mode:"local-fallback"};return`local.${btoa(JSON.stringify(a))}`}function Ct(t){const a=String(t||"");if(!a)return null;if(a.startsWith("local."))try{return JSON.parse(atob(a.slice(6)))}catch{return null}const r=a.split(".");if(r.length===3)try{return JSON.parse(atob(r[1]))}catch{return null}return null}function jt(t){return{id:t.id,firstName:t.firstName,lastName:t.lastName,name:t.name||`${t.firstName||""} ${t.lastName||""}`.trim(),email:t.email,phone:t.phone,role:t.role||"user"}}function nt(t={}){const a=String(t.firstName||"Local").trim()||"Local",r=String(t.lastName||"User").trim()||"User",s=Ce(t.email||"local@ozillafestival.com"),i=$e(t.phone||"+923000000000");return{id:t.id||`local-user-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,firstName:a,lastName:r,name:`${a} ${r}`.trim(),email:s,phone:i,password:String(t.password||""),role:"user"}}function Bt(t){return!t?.response&&(t?.code==="ERR_NETWORK"||t?.message?.includes("Network Error")||t?.message?.includes("ECONNREFUSED"))}function Lt(t){return Bt(t)?(lt=!0,!0):!1}function ot(t){const a=jt(t);return{token:Qa(a),user:a,mode:"local-fallback"}}const Ze={async login(t){const a=String(t?.email||t?.phone||t?.identifier||"").trim(),r=Ce(a),s=$e(a),i=String(t?.password||"").trim();try{const l=await ee.post(Ee.AUTH.LOGIN,{email:a,password:i});if(l?.data?.token){const n=We(),o=n.findIndex(g=>Ce(g.email)===r||$e(g.phone)===s),c={id:l.data.user?.id||`user-${Date.now()}`,firstName:l.data.user?.firstName||"",lastName:l.data.user?.lastName||"",name:l.data.user?.name||"",email:l.data.user?.email?Ce(l.data.user.email):r,phone:l.data.user?.phone?$e(l.data.user.phone):s,password:i,role:l.data.user?.role||"user"};return o>=0?(n[o]=c,Ve(n)):Ve([c,...n]),l.data}return l.data}catch(l){const n=We(),o=n.find(g=>(Ce(g.email)===r||$e(g.phone)===s)&&g.password===i);if(o)return lt=!0,ot(o);const c=n.find(g=>Ce(g.email)===r||$e(g.phone)===s);if(c&&c.password!==i){const g=new Error("Invalid credentials. Please check your password.");throw g.response={status:401,data:{message:"Invalid credentials. Please check your password."}},g}throw l}},async register(t){const a=Ce(t?.email),r=$e(t?.phone),s=String(t?.password||"").trim(),i=We(),l=i.find(o=>Ce(o.email)===a),n=i.find(o=>$e(o.phone)===r);try{const o=await ee.post(Ee.AUTH.REGISTER,{...t,email:a,phone:r,password:s});if(o?.data?.token){const c=nt({id:o.data.user?.id,firstName:t.firstName,lastName:t.lastName,email:a,phone:r,password:s}),g=i.filter(u=>Ce(u.email)!==a&&$e(u.phone)!==r);Ve([c,...g])}return o.data}catch(o){if(o?.response?.status===409||o?.response?.data?.message)throw o;if(l){const g=new Error("Account already exists with this email. Please log in.");throw g.response={status:409,data:{message:"Account already exists with this email. Please log in."}},g}if(n){const g=new Error("Account already exists with this phone number. Please log in.");throw g.response={status:409,data:{message:"Account already exists with this phone number. Please log in."}},g}const c=nt({...t,email:a,phone:r,password:s});return Ve([c,...i]),lt=!0,ot(c)}},async sendOtp(t){const a=Ce(t);try{return(await ee.post(Ee.AUTH.SEND_OTP,{email:a})).data}catch(r){if(r?.response?.status===404)try{return(await ee.post(Ee.AUTH.RESEND_OTP,{email:a})).data}catch(s){if(s?.response?.data?.message)throw s}if(r?.response?.data?.message)throw r;if(Bt(r)){const s=new Error("Cannot connect to backend server. Please ensure the backend server is running and reachable.");throw s.response={status:503,data:{message:"Cannot connect to backend server. Please ensure the backend server is running and reachable."}},s}throw r}},async resendOtp(t){return this.sendOtp(t)},async verifyOtp(t){const a=Ce(t?.email),r=String(t?.otp||"").trim();try{return(await ee.post(Ee.AUTH.VERIFY_OTP,{email:a,otp:r})).data}catch(s){if(s?.response?.data?.message)throw s;if(Bt(s)){const i=new Error("Cannot connect to backend server at http://localhost:5000. Please ensure the backend server is running.");throw i.response={status:503,data:{message:"Cannot connect to backend server at http://localhost:5000. Please ensure the backend server is running."}},i}throw s}},async getCurrentUser(){const t=Ne.getToken();if(!t){const a=new Error("Unauthorized");throw a.response={status:401,data:{message:"Unauthorized"}},a}try{return(await ee.get(Ee.AUTH.ME)).data}catch(a){const r=Ct(t);if(r?.mode==="local-fallback"||String(t||"").startsWith("local.")){const i=We().find(l=>l.id===r?.sub||Ce(l.email)===Ce(r?.email));if(i)return jt(i)}throw Ne.removeToken(),a}},async logout(){Ne.removeToken();try{localStorage.removeItem("ozilla_local_users")}catch{}try{return(await ee.post(Ee.AUTH.LOGOUT)).data}catch{return{message:"Logged out successfully"}}},async forgotPassword(t){return(await ee.post(Ee.AUTH.FORGOT_PASSWORD,{email:t})).data},async resetPassword(t){return(await ee.post(Ee.AUTH.RESET_PASSWORD,t)).data},async getGoogleConfig(){try{return(await ee.get(Ee.AUTH.GOOGLE_CONFIG)).data?.clientId||null}catch{return null}},async googleAuth(t,a){if(lt){if(!a?.email)throw new Error("Google account email is required");const r=nt(a),s=We();return s.some(i=>i.email===r.email)||Ve([r,...s]),ot(r)}try{return(await ee.post(Ee.AUTH.GOOGLE,{token:t,profile:a})).data}catch(r){if(Lt(r)&&a?.email){const s=nt(a);return ot(s)}throw r}},async googleCodeLogin(t,a="postmessage",r){if(lt){if(!r?.email)throw new Error("Google account email is required");const s=nt(r),i=We();return i.some(l=>l.email===s.email)||Ve([s,...i]),ot(s)}try{return(await ee.post(Ee.AUTH.GOOGLE_CODE_LOGIN,{code:t,redirectUri:a,profile:r})).data}catch(s){if(Lt(s)&&r?.email){const i=nt(r);return ot(i)}throw s}},async googleTokenLogin(t,a){return this.googleAuth(t,a)},async updateProfile(t){if(lt){const a=Ne.getToken(),r=Ct(a),s=We(),i=s.findIndex(o=>o.id===r?.sub||o.email===r?.email);if(i===-1){const o=new Error("Unauthorized");throw o.response={status:401,data:{message:"Unauthorized"}},o}const l=s[i],n={...l,firstName:typeof t?.firstName=="string"?t.firstName.trim():l.firstName,lastName:typeof t?.lastName=="string"?t.lastName.trim():l.lastName,phone:typeof t?.phone=="string"?t.phone.trim():l.phone};return n.name=`${n.firstName||""} ${n.lastName||""}`.trim()||l.name,s[i]=n,Ve(s),{message:"Profile updated successfully",user:jt(n)}}try{return(await ee.put(Ee.AUTH.PROFILE,t)).data}catch(a){if(Lt(a)){const r=Ne.getToken(),s=Ct(r),i=We(),l=i.findIndex(c=>c.id===s?.sub||c.email===s?.email);if(l===-1){const c=new Error("Unauthorized");throw c.response={status:401,data:{message:"Unauthorized"}},c}const n=i[l],o={...n,firstName:typeof t?.firstName=="string"?t.firstName.trim():n.firstName,lastName:typeof t?.lastName=="string"?t.lastName.trim():n.lastName,phone:typeof t?.phone=="string"?t.phone.trim():n.phone};return o.name=`${o.firstName||""} ${o.lastName||""}`.trim()||n.name,i[l]=o,Ve(i),{message:"Profile updated successfully",user:jt(o)}}throw a}}},Ea=m.createContext(null);function er({children:t}){const[a,r]=m.useState(null),[s,i]=m.useState(!0);m.useEffect(()=>{l()},[]);const l=async()=>{try{if(Ne.getToken()){const k=await Ze.getCurrentUser();r(k)}}catch{Ne.removeToken()}finally{i(!1)}},n=async y=>{const k=await Ze.login(y);return Ne.setToken(k.token),r(k.user),k},o=async y=>{const k=await Ze.register(y);return Ne.setToken(k.token),r(k.user),k},c=()=>{Ze.logout().catch(()=>{}),Ne.removeToken(),r(null)},g=a?.role==="admin"||["ubair1100@gmail.com","admin@ozillafestival.com","muhammadubair@gmail.com","admin@prism.com"].includes(String(a?.email||"").toLowerCase().trim()),u={user:a,isAdmin:g,loading:s,login:n,register:o,logout:c,checkAuth:l};return e.jsx(Ea.Provider,{value:u,children:t})}const tr="modulepreload",ar=function(t){return"/ozillafest/"+t},Zt={},Ht=function(a,r,s){let i=Promise.resolve();if(r&&r.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),o=n?.nonce||n?.getAttribute("nonce");i=Promise.allSettled(r.map(c=>{if(c=ar(c),c in Zt)return;Zt[c]=!0;const g=c.endsWith(".css"),u=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const y=document.createElement("link");if(y.rel=g?"stylesheet":tr,g||(y.as="script"),y.crossOrigin="",y.href=c,o&&y.setAttribute("nonce",o),document.head.appendChild(y),g)return new Promise((k,E)=>{y.addEventListener("load",k),y.addEventListener("error",()=>E(new Error(`Unable to preload CSS for ${c}`)))})}))}function l(n){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=n,window.dispatchEvent(o),!o.defaultPrevented)throw n}return i.then(n=>{for(const o of n||[])o.status==="rejected"&&l(o.reason);return a().catch(l)})};function Je(){const t=m.useContext(Ea);if(!t)throw new Error("useAuth must be used within an AuthProvider");return t}function rr({children:t}){const{user:a,loading:r}=Je(),s=Ke();if(r)return e.jsx("div",{className:"flex items-center justify-center min-h-screen",children:"Loading..."});if(!a){const i=`${s.pathname}${s.search}`,l=new URLSearchParams({returnTo:i}).toString();return e.jsx(ye,{to:`/login?${l}`,replace:!0})}return t||e.jsx(ut,{})}function At(t,a="/dashboard"){if(!t||typeof t!="string")return a;let r=t.trim();if(r.startsWith("//")||/^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(r))return a;r.startsWith("/ozillafest")&&(r=r.slice(11)),r.startsWith("/")||(r=`/${r}`);const s=r.split("?")[0].replace(/\/$/,"");return!s||s==="/login"||s==="/register"?a:r}function sr({children:t}){const{user:a,loading:r}=Je(),s=Ke();if(r)return e.jsx("div",{className:"flex items-center justify-center min-h-screen",children:"Loading..."});if(a){const l=new URLSearchParams(s.search).get("returnTo"),n=At(l,"/dashboard");return e.jsx(ye,{to:n,replace:!0})}return t||e.jsx(ut,{})}function W(t){if(!t||typeof t!="string"||t.startsWith("http://")||t.startsWith("https://")||t.startsWith("data:")||t.startsWith("blob:"))return t;const a="/ozillafest/",r=a.endsWith("/")?a:`${a}/`,s=t.replace(/^\/+/,"");return s.startsWith("assets/")||s.startsWith("favicon")?`${r}${s}`:t.startsWith("/")?`${r}${s}`:t}function ir({className:t="",nodeColor:a="#EC4899",lineColor:r="236, 72, 153",secondaryColor:s="255, 90, 31",maxDistance:i=135,speed:l=.5}){const n=m.useRef(null);return m.useEffect(()=>{const o=n.current;if(!o)return;const c=o.getContext("2d",{alpha:!0});if(!c)return;let g=null,u=!0,y=!1,k=o.width=o.parentElement?.clientWidth||window.innerWidth,E=o.height=o.parentElement?.clientHeight||window.innerHeight;const p=k<768?18:34,b=340,x=450,I=i*i;let A={x:k/2,y:E/2,active:!1},f={rotX:0,rotY:0,targetRotX:0,targetRotY:0};const d=[];for(let O=0;O<p;O++)d.push({x:(Math.random()-.5)*k*1.1,y:(Math.random()-.5)*E*1.1,z:(Math.random()-.5)*x,vx:(Math.random()-.5)*l*.7,vy:(Math.random()-.5)*l*.7,vz:(Math.random()-.5)*l*.7,radius:Math.random()*1.8+1.2,colorType:Math.random()>.4?"primary":"secondary"});const F=()=>{o.parentElement&&(k=o.width=o.parentElement.clientWidth||window.innerWidth,E=o.height=o.parentElement.clientHeight||window.innerHeight)};window.addEventListener("resize",F,{passive:!0});const B=O=>{if(!u)return;const C=o.getBoundingClientRect();A.x=O.clientX-C.left,A.y=O.clientY-C.top,A.active=!0;const $=(A.x-k/2)/(k/2),Y=(A.y-E/2)/(E/2);f.targetRotY=$*.14,f.targetRotX=-Y*.14},N=()=>{A.active=!1,f.targetRotX=0,f.targetRotY=0};window.addEventListener("mousemove",B,{passive:!0}),window.addEventListener("mouseleave",N,{passive:!0});const h=()=>{if(!u||document.hidden){y=!1;return}c.clearRect(0,0,k,E),f.rotX+=(f.targetRotX-f.rotX)*.05,f.rotY+=(f.targetRotY-f.rotY)*.05;const O=Math.cos(f.rotY),C=Math.sin(f.rotY),$=Math.cos(f.rotX),Y=Math.sin(f.rotX),H=k/2,M=E/2,D=k*.65,q=E*.65,oe=x*.55,te=[];for(let v=0;v<p;v++){const j=d[v];j.x+=j.vx,j.y+=j.vy,j.z+=j.vz,(j.x<-D||j.x>D)&&(j.vx*=-1),(j.y<-q||j.y>q)&&(j.vy*=-1),(j.z<-oe||j.z>oe)&&(j.vz*=-1);const _=j.x*O-j.z*C,J=j.z*O+j.x*C,re=j.y*$-J*Y,ae=J*$+j.y*Y,z=ae+x;if(z<=0)continue;const ie=b/(b+z*.65),me=H+_*ie,Se=M+re*ie,ue=Math.max(.18,Math.min(.85,(ae+x)/(x*1.4)));te.push({x:me,y:Se,scale:ie,alpha:ue,radius:Math.max(1.2,j.radius*ie),colorType:j.colorType})}const ne=te.length;for(let v=0;v<ne;v++){const j=te[v];let _=0;for(let J=v+1;J<ne&&_<3;J++){const re=te[J],ae=j.x-re.x,z=j.y-re.y,ie=ae*ae+z*z;if(ie<I){_++;const me=Math.sqrt(ie),Se=(1-me/i)*.4*Math.min(j.alpha,re.alpha),ue=j.colorType==="primary"?r:s;c.beginPath(),c.moveTo(j.x,j.y),c.lineTo(re.x,re.y),c.strokeStyle=`rgba(${ue}, ${Se})`,c.lineWidth=Math.max(.5,(1-me/i)*1.2),c.stroke()}}}for(let v=0;v<ne;v++){const j=te[v],_=j.colorType==="primary"?`rgba(${r}, ${j.alpha})`:`rgba(${s}, ${j.alpha})`;c.beginPath(),c.arc(j.x,j.y,j.radius,0,Math.PI*2),c.fillStyle=_,c.fill()}g=requestAnimationFrame(h)},P=()=>{!y&&u&&!document.hidden&&(y=!0,g=requestAnimationFrame(h))},T=()=>{y=!1,g&&(cancelAnimationFrame(g),g=null)};let R=null;"IntersectionObserver"in window?(R=new IntersectionObserver(([O])=>{u=O.isIntersecting,u?P():T()},{threshold:.05}),R.observe(o)):P();const V=()=>{document.hidden?T():u&&P()};return document.addEventListener("visibilitychange",V),()=>{T(),window.removeEventListener("resize",F),window.removeEventListener("mousemove",B),window.removeEventListener("mouseleave",N),document.removeEventListener("visibilitychange",V),R&&R.disconnect()}},[a,r,s,i,l]),e.jsx("canvas",{ref:n,className:`plexus-net-canvas ${t}`,"aria-hidden":"true",style:{position:"absolute",inset:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:1,willChange:"transform"}})}const Ut=gt.memo(ir);function Rt({children:t}){const a=Ke(),r=a.pathname==="/login",s=a.pathname==="/register",[i,l]=m.useState({x:0,y:0}),[n,o]=m.useState({x:50,y:42}),c=u=>{if(u.pointerType==="touch")return;const y=u.currentTarget.getBoundingClientRect(),k=(u.clientX-y.left)/y.width,E=(u.clientY-y.top)/y.height;l({x:(.5-E)*10,y:(k-.5)*10}),o({x:k*100,y:E*100})},g=()=>{l({x:0,y:0}),o({x:50,y:42})};return e.jsxs("main",{className:`kx-page auth-page ${r?"auth-page-login":""} ${s?"auth-page-register":""}`,children:[e.jsx(Ut,{nodeColor:"#EC4899",lineColor:"236, 72, 153",secondaryColor:"255, 90, 31",maxDistance:130,speed:.4}),e.jsx("div",{className:"kx-grid","aria-hidden":"true"}),e.jsx("div",{className:"kx-noise","aria-hidden":"true"}),e.jsx("div",{className:"kx-halo kx-halo-top","aria-hidden":"true"}),e.jsx("div",{className:"kx-halo kx-halo-bottom","aria-hidden":"true"}),e.jsx("div",{className:"kx-orb kx-orb-left","aria-hidden":"true"}),e.jsx("div",{className:"kx-orb kx-orb-right","aria-hidden":"true"}),e.jsxs("section",{className:`kx-stage ${s?"kx-stage-wide":""}`,children:[e.jsx("div",{className:"kx-tilt",onPointerMove:c,onPointerLeave:g,onPointerCancel:g,style:{transform:`rotateX(${i.x}deg) rotateY(${i.y}deg)`},children:e.jsxs("div",{className:"kx-card-shell",children:[e.jsx("div",{className:"kx-shadow","aria-hidden":"true"}),e.jsxs("div",{className:"kx-runners","aria-hidden":"true",children:[e.jsx("span",{className:"kx-runner kx-runner-top"}),e.jsx("span",{className:"kx-runner kx-runner-right"}),e.jsx("span",{className:"kx-runner kx-runner-bottom"}),e.jsx("span",{className:"kx-runner kx-runner-left"})]}),e.jsxs("article",{className:"kx-card",children:[e.jsx("div",{className:"kx-pointer-glow","aria-hidden":"true",style:{left:`${n.x}%`,top:`${n.y}%`}}),e.jsx("div",{className:"kx-card-pattern","aria-hidden":"true"}),e.jsxs("header",{className:"kx-header",children:[e.jsx(X,{to:"/",className:"kx-logo-link","aria-label":"OZILLA FEST Home",children:e.jsxs("div",{className:"kx-logo",children:[e.jsx("img",{src:W("/assets/ozilla/logo.png"),alt:"OZILLA FEST Logo",onError:u=>{u.currentTarget.src=W("/assets/logo.jpeg")}}),e.jsx("i",{"aria-hidden":"true"})]})}),e.jsx("span",{className:"kx-tag",children:"PAKISTAN'S PREMIER MUSIC FESTIVAL"}),e.jsx("h1",{className:"kx-title",children:r?"Welcome Back":"Join OZILLA FEST"}),e.jsx("p",{className:"kx-subtitle",children:r?"Sign in to access your passes, tickets & workspace":"Create your account for the ultimate festival experience"}),e.jsxs("div",{className:"kx-tabs",children:[e.jsx(X,{to:`/login${a.search}`,className:`kx-tab-btn ${r?"active":""}`,children:"Sign In"}),e.jsx(X,{to:`/register${a.search}`,className:`kx-tab-btn ${s?"active":""}`,children:"Create Account"})]})]}),e.jsx("div",{className:"kx-card-body",children:t||e.jsx(ut,{})})]})]})}),e.jsxs("div",{className:"auth-center-ribbon",children:[e.jsx("span",{children:"📅 Nov 01, 2026"}),e.jsx("span",{children:"📍 Lahore, Pakistan"}),e.jsx("span",{children:"⭐ 10,000+ Fans"})]})]})]})}function nr({children:t,className:a="",onClick:r,mouseX:s,spring:i,distance:l,magnification:n,baseItemSize:o,label:c}){const g=m.useRef(null),u=Na(0),y=qt(s,x=>{if(x===1/0||!g.current)return l;const I=g.current.getBoundingClientRect(),A=I.left+I.width/2;return x-A}),k=qt(y,[-l,0,l],[o,n,o]),E=$a(k,i),w=x=>{(x.key==="Enter"||x.key===" ")&&(x.preventDefault(),r?.())},p=()=>{u.set(1)},b=()=>{u.set(0)};return e.jsx(ce.div,{ref:g,style:{width:E,height:E},onHoverStart:p,onHoverEnd:b,onFocus:p,onBlur:b,onClick:r,className:`dock-item ${a}`,tabIndex:0,role:"button","aria-haspopup":"true","aria-label":c,onKeyDown:w,children:m.Children.map(t,x=>m.cloneElement(x,{isHovered:u}))})}function or({children:t,className:a="",...r}){const{isHovered:s}=r,[i,l]=m.useState(!1);return m.useEffect(()=>{if(!s)return;const n=s.on("change",o=>{l(o===1)});return()=>n()},[s]),e.jsx(Ha,{children:i&&e.jsx(ce.div,{initial:{opacity:0,y:-4,scale:.85},animate:{opacity:1,y:0,scale:1},exit:{opacity:0,y:-4,scale:.85},transition:{duration:.15},className:`dock-label ${a}`,role:"tooltip",style:{x:"-50%"},children:t})})}function lr({children:t,className:a=""}){return e.jsx("div",{className:`dock-icon ${a}`,children:t})}function cr({items:t,className:a="",spring:r={mass:.1,stiffness:220,damping:18},magnification:s=52,distance:i=120,panelHeight:l=44,baseItemSize:n=36}){const o=Na(1/0),c=Ke(),g=ct();return e.jsx("div",{className:"dock-outer",children:e.jsx(ce.div,{onMouseMove:u=>o.set(u.clientX),onMouseLeave:()=>o.set(1/0),className:`dock-panel ${a}`,style:{height:l},role:"toolbar","aria-label":"Application dock",children:t.map((u,y)=>{const k=c.pathname===u.to||u.to!=="/"&&c.pathname.startsWith(u.to)||u.to==="/"&&c.pathname==="/dashboard";return e.jsxs(nr,{onClick:()=>{u.onClick?.(),u.to&&g(u.to)},className:`${u.className||""} ${k?"active":""}`,mouseX:o,spring:r,distance:i,magnification:s,baseItemSize:n,label:u.label,children:[e.jsx(lr,{children:u.icon}),e.jsx(or,{children:u.label})]},u.to||y)})})})}function ke({path:t,size:a=24,viewBox:r="0 0 24 24",fill:s="none",stroke:i="currentColor",strokeWidth:l=1.8}){return e.jsx("svg",{width:a,height:a,viewBox:r,fill:s,stroke:i,strokeWidth:l,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:t})}const yt={home:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 10.5 12 3l9 7.5"}),e.jsx("path",{d:"M5 9.5V21h14V9.5"}),e.jsx("path",{d:"M9 21v-6h6v6"})]})}),calendar:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"3",y:"4",width:"18",height:"18",rx:"2"}),e.jsx("path",{d:"M16 2v4M8 2v4M3 10h18"})]})}),mic:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"9",y:"2",width:"6",height:"12",rx:"3"}),e.jsx("path",{d:"M5 10a7 7 0 0 0 14 0"}),e.jsx("path",{d:"M12 17v5"})]})}),clock:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("circle",{cx:"12",cy:"12",r:"9"}),e.jsx("path",{d:"M12 7v5l3 3"})]})}),history:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 12a9 9 0 1 0 3-6.7"}),e.jsx("path",{d:"M3 4v5h5"}),e.jsx("path",{d:"M12 8v4l3 2"})]})}),hotels:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M2 21V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v16"}),e.jsx("path",{d:"M2 21h20"}),e.jsx("path",{d:"M6 7h4M6 11h4M14 7h4M14 11h4M6 15h4M14 15h4M6 19h4M14 19h4"})]})}),restaurants:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M4 21v-8a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v8"}),e.jsx("path",{d:"M2 21h20"}),e.jsx("path",{d:"M8 9V3M12 9V3M16 9V3"}),e.jsx("path",{d:"M4 13h16"})]})}),discounts:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M20.6 13.4 12 22 2 12 3.5 4.5 11 3l9.6 10.4Z"}),e.jsx("circle",{cx:"8",cy:"8",r:"1.5"}),e.jsx("path",{d:"m15.5 5.5 4 4"})]})}),facilities:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 21V7l6-4 6 4v14"}),e.jsx("path",{d:"M15 21V9h6v12"}),e.jsx("path",{d:"M3 21h18"}),e.jsx("path",{d:"M7 10h3M7 14h3M7 18h3"})]})}),sponsorship:e.jsx(ke,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M12 21s-7.5-4.6-10-9.2C.6 8.6 3 5 6.5 5c2 0 3.5 1 5.5 3 2-2 3.5-3 5.5-3C21 5 23.4 8.6 22 11.8 19.5 16.4 12 21 12 21Z"})})}),sparkle:e.jsx(ke,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"m12 3-1.9 5.8a2 2 0 0 1-1.3 1.3L3 12l5.8 1.9a2 2 0 0 1 1.3 1.3L12 21l1.9-5.8a2 2 0 0 1 1.3-1.3L21 12l-5.8-1.9a2 2 0 0 1-1.3-1.3Z"})})}),ticket:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 9V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v3a3 3 0 0 0 0 6v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3a3 3 0 0 0 0-6Z"}),e.jsx("path",{d:"M13 5v2M13 11v2M13 17v2"})]})}),contact:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m3 7 9 6 9-6"})]})}),shield:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M12 22s8-3.6 8-10V5l-8-3-8 3v7c0 6.4 8 10 8 10Z"}),e.jsx("path",{d:"m9 11.5 2 2 4-4"})]})}),user:e.jsx(ke,{path:e.jsxs(e.Fragment,{children:[e.jsx("circle",{cx:"12",cy:"8",r:"4"}),e.jsx("path",{d:"M4 21c0-4 4-6 8-6s8 2 8 6"})]})}),menu:e.jsx(ke,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M3 6h18M3 12h18M3 18h18"})})}),close:e.jsx(ke,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M5 5l14 14M19 5 5 19"})})})},dr=[{label:"Home",to:"/#home",icon:"home"},{label:"Ticket Portal",to:"/tickets",icon:"ticket",cta:!0},{label:"Schedule",to:"/schedule",icon:"calendar"},{label:"Lineup",to:"/#celebrities",icon:"mic"},{label:"VIP Passes",to:"/#vip-experience",icon:"ticket"},{label:"Hotels",to:"/hotels",icon:"hotels"},{label:"Facilities",to:"/#facilities",icon:"facilities"},{label:"Sponsorship",to:"/#sponsorship",icon:"sponsorship"},{label:"Atmosphere",to:"/#about",icon:"sparkle"},{label:"My Tickets",to:"/tickets/my-tickets",icon:"ticket"}];function Kt(t){return t?.firstName||t?.name||t?.email||"Account"}function Ca(){const{user:t,isAdmin:a,logout:r}=Je(),s=ct(),i=Ke(),[l,n]=m.useState(!1),[o,c]=m.useState(!1),[g,u]=m.useState(!1),y=m.useRef(null),k=gt.useMemo(()=>{const p=[...dr];return a&&p.push({label:"Admin",to:"/admin/dashboard",icon:"shield"}),p},[a]),E=gt.useMemo(()=>k.map(p=>({label:p.label,to:p.to,icon:yt[p.icon],className:p.cta?"dock-item-cta":""})),[k]);m.useEffect(()=>{const p=()=>{y.current||(y.current=window.requestAnimationFrame(()=>{n(window.scrollY>12),y.current=null}))};return p(),window.addEventListener("scroll",p,{passive:!0}),()=>{window.removeEventListener("scroll",p),y.current&&window.cancelAnimationFrame(y.current)}},[]),m.useEffect(()=>{c(!1),u(!1)},[i.pathname]);const w=()=>{r(),s("/")};return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:`dock-site-header ${l?"scrolled":""}`,children:e.jsxs("div",{className:"dock-site-header-inner",children:[e.jsxs(X,{to:"/",className:"dock-site-brand","aria-label":"Ozilla Fest home",children:[e.jsx("span",{className:"dock-site-brand-logo",children:e.jsx("img",{src:W("/assets/ozilla/logo.png"),alt:"Ozilla Fest",onError:p=>{p.currentTarget.src=W("/assets/company-logo.jpeg")}})}),e.jsx("div",{className:"dock-site-brand-text",children:e.jsx("strong",{children:"OZILLA FEST"})})]}),e.jsx("div",{className:"dock-header-center",children:e.jsx(cr,{items:E,className:"dock-nav",magnification:58,distance:140,panelHeight:62,baseItemSize:44,spring:{mass:.1,stiffness:260,damping:19}})}),e.jsxs("div",{className:"dock-site-header-actions",children:[t?e.jsxs("div",{className:`dock-account ${g?"open":""}`,children:[e.jsxs("button",{type:"button",className:"dock-account-button",onClick:()=>u(p=>!p),"aria-expanded":g,"aria-label":"Account menu",children:[e.jsx("span",{className:"dock-account-avatar",children:String(Kt(t)).slice(0,1).toUpperCase()}),e.jsx("strong",{children:Kt(t)})]}),e.jsxs("div",{className:"dock-account-menu",children:[e.jsx(X,{to:"/account",children:"Account"}),e.jsx(X,{to:"/tickets/my-tickets",children:"My Tickets"}),a&&e.jsx(X,{to:"/admin/dashboard",children:"Admin Dashboard"}),e.jsx("button",{type:"button",onClick:w,children:"Logout"})]})]}):e.jsxs(e.Fragment,{children:[e.jsx(X,{to:"/login",className:"dock-site-login-btn",children:"Login"}),e.jsx(X,{to:"/register",className:"dock-site-register-btn",children:"Sign Up"})]}),e.jsx("button",{type:"button",className:`dock-mobile-toggle ${o?"open":""}`,"aria-label":o?"Close menu":"Open menu","aria-expanded":o,onClick:()=>c(p=>!p),children:o?yt.close:yt.menu})]})]})}),e.jsx("div",{className:`dock-mobile-overlay ${o?"open":""}`,onClick:()=>c(!1),children:e.jsxs("div",{className:`dock-mobile-panel ${o?"open":""}`,onClick:p=>p.stopPropagation(),children:[e.jsxs("div",{className:"dock-mobile-header",children:[e.jsx("div",{children:e.jsx("h2",{children:"Menu"})}),e.jsx("button",{type:"button",className:"dock-mobile-close",onClick:()=>c(!1),"aria-label":"Close menu",children:"x"})]}),e.jsx("div",{className:"dock-mobile-links",children:k.map(p=>e.jsxs(Ga,{to:p.to,className:p.cta?"dock-mobile-link-cta":"",onClick:()=>c(!1),children:[e.jsx("span",{className:"dock-mobile-link-icon",children:yt[p.icon]}),e.jsx("span",{children:p.label}),p.cta&&e.jsx("span",{className:"dock-mobile-badge",children:"PASSES"})]},p.to))}),e.jsx("div",{className:"dock-mobile-auth",children:t?e.jsx("button",{type:"button",onClick:()=>{w(),c(!1)},children:"Logout"}):e.jsxs(e.Fragment,{children:[e.jsx(X,{to:"/login",onClick:()=>c(!1),children:"Login"}),e.jsx(X,{to:"/register",onClick:()=>c(!1),children:"Sign Up"})]})})]})})]})}const pr=[{label:"Headline Artists",href:"/#celebrities"},{label:"VIP & Ticket Passes",href:"/tickets"},{label:"The Festival Vibe",href:"/#about"},{label:"World-Class Facilities",href:"/#facilities"},{label:"My Digital Passes",href:"/tickets/my-tickets"}],mr=[{label:"Instagram",href:"https://www.instagram.com/ozillafestival"}],fr=[{label:"Sponsorship Inquiries",href:"/#sponsorship"},{label:"QR Ticket Verification",href:"/verification/OZ-2026-PREVIEW"},{label:"Hotel & Travel Partners",href:"/hotels"},{label:"Privacy & Terms",href:"/privacy"}];function La(){return e.jsxs(e.Fragment,{children:[e.jsxs("footer",{className:"kex-footer",children:[e.jsx("div",{className:"kex-bg-glow","aria-hidden":"true"}),e.jsx("div",{className:"kex-bg-overlay","aria-hidden":"true"}),e.jsxs("div",{className:"kex-container",children:[e.jsxs("div",{className:"kex-nav-grid",children:[e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"MENU"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:pr.map(t=>e.jsx("li",{children:t.href.startsWith("/#")?e.jsx("a",{href:t.href,children:t.label}):e.jsx(X,{to:t.href,children:t.label})},t.label))})]}),e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"SOCIALS"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:mr.map(t=>e.jsx("li",{children:e.jsx("a",{href:t.href,target:"_blank",rel:"noopener noreferrer",children:t.label})},t.label))})]}),e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"RESOURCES"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:fr.map(t=>e.jsx("li",{children:t.href.startsWith("/#")?e.jsx("a",{href:t.href,children:t.label}):e.jsx(X,{to:t.href,children:t.label})},t.label))}),e.jsx("div",{className:"kex-action-wrap",children:e.jsx("a",{href:"mailto:ozillafestival@gmail.com",className:"kex-pill-btn",children:"Send a message"})})]})]}),e.jsx("div",{className:"kex-hero-word-wrap","aria-hidden":"true",children:e.jsx("span",{className:"kex-hero-word",children:"OZILLA FEST"})}),e.jsxs("div",{className:"kex-bottom-row",children:[e.jsxs("div",{className:"kex-bottom-links",children:[e.jsx(X,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"·"}),e.jsx(X,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"·"}),e.jsx(X,{to:"/verification/OZ-2026-PREVIEW",children:"QR Verification"})]}),e.jsx("p",{className:"kex-bottom-copy",children:"© 2026 OZILLA FEST & Prism Entertainment. All rights reserved."})]})]})]}),e.jsx("style",{children:gr})]})}const gr=`
...
`;function Oe({children:t}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-transparent text-white overflow-x-hidden w-full relative z-[1]",children:[e.jsx(Ca,{}),e.jsx("div",{className:"flex-1 w-full overflow-x-hidden bg-transparent",children:t||e.jsx(ut,{})}),e.jsx(La,{})]})}function It({children:t}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-transparent text-white overflow-x-hidden w-full font-['Plus_Jakarta_Sans',sans-serif] dock-app-shell relative z-[1]",children:[e.jsx(Ca,{}),e.jsx("main",{className:"flex-1 px-4 sm:px-6 py-6 md:py-10 app-main app-content dock-app-content bg-transparent",children:e.jsx("div",{className:"w-full max-w-[1280px] mx-auto",children:t||e.jsx(ut,{})})}),e.jsx(La,{})]})}function Ra(){return e.jsx("div",{className:"flex items-center justify-center min-h-[200px]",children:e.jsx("div",{className:"animate-spin rounded-full h-16 w-16 border-4 border-purple-600 border-t-transparent"})})}let vt;function ur(){return window.google?.accounts?.id||window.google?.accounts?.oauth2?Promise.resolve(window.google):vt||(vt=new Promise((t,a)=>{const r=document.querySelector('script[data-google-identity="true"]');if(r){r.addEventListener("load",()=>t(window.google),{once:!0}),r.addEventListener("error",()=>a(new Error("Failed to load Google Identity script")),{once:!0});return}const s=document.createElement("script");s.src="https://accounts.google.com/gsi/client",s.async=!0,s.defer=!0,s.dataset.googleIdentity="true",s.onload=()=>t(window.google),s.onerror=()=>a(new Error("Failed to load Google Identity script")),document.head.appendChild(s)}),vt)}async function hr(t){const a=await fetch("https://www.googleapis.com/oauth2/v3/userinfo",{headers:{Authorization:`Bearer ${t}`}});if(!a.ok)throw new Error("Failed to fetch Google profile");return a.json()}async function Ia({clientId:t,onProfile:a,onError:r}){if(t.includes("placeholder")||t.includes("your_google"))throw new Error("Google Client ID is not configured. Please add GOOGLE_CLIENT_ID in Render or VITE_GOOGLE_CLIENT_ID in client/.env");if(await ur(),!window.google?.accounts?.oauth2?.initTokenClient)throw new Error("Google Identity Services library is unavailable");return new Promise((s,i)=>{window.google.accounts.oauth2.initTokenClient({client_id:t,scope:"openid email profile",prompt:"select_account",callback:async n=>{try{if(n?.error)throw n.error==="popup_closed_by_user"?new Error("Google sign-in was cancelled"):new Error(n.error_description||n.error||"Google login failed");if(!n?.access_token)throw new Error("Google sign-in was cancelled");const o=await hr(n.access_token);if(!o?.email)throw new Error("Could not retrieve email from selected Google account");a&&await a(o,n.access_token),s(o)}catch(o){r&&r(o),i(o)}},error_callback:n=>{const o=new Error(n?.message||"Google account chooser popup failed");r&&r(o),i(o)}}).requestAccessToken({prompt:"select_account"})})}function xr(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m4 7 8 6 8-6"})]})}function br(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"4",y:"10",width:"16",height:"11",rx:"2"}),e.jsx("path",{d:"M8 10V7a4 4 0 0 1 8 0v3"})]})}function yr({hidden:t=!1,...a}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...a,children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"}),t&&e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}function vr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M5 12h14M13 6l6 6-6 6"})})}function wr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"m5 12 4 4L19 6"})})}function kr(t){return e.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",...t,children:[e.jsx("path",{fill:"#4285F4",d:"M21.6 12.23c0-.71-.06-1.4-.18-2.06H12v3.9h5.38a4.6 4.6 0 0 1-2 3.01v2.53h3.23c1.9-1.75 2.99-4.32 2.99-7.38Z"}),e.jsx("path",{fill:"#34A853",d:"M12 22c2.7 0 4.97-.9 6.62-2.39l-3.23-2.53c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.61-4.13H3.05v2.61A10 10 0 0 0 12 22Z"}),e.jsx("path",{fill:"#FBBC05",d:"M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.3.31-1.91V7.48H3.05A10 10 0 0 0 2 12c0 1.61.39 3.14 1.05 4.52l3.34-2.61Z"}),e.jsx("path",{fill:"#EA4335",d:"M12 5.96c1.47 0 2.79.51 3.82 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.95 5.48l3.34 2.61C7.18 7.72 9.39 5.96 12 5.96Z"})]})}function jr(){const t=ct(),a=Ke(),{login:r,checkAuth:s}=Je(),i="231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com",l=new URLSearchParams(a.search).get("returnTo"),n=At(l,"/dashboard"),[o,c]=m.useState({email:"",password:""}),[g,u]=m.useState(null),[y,k]=m.useState(!1),[E,w]=m.useState(!0),[p,b]=m.useState(""),[x,I]=m.useState(""),[A,f]=m.useState(!1),[d,F]=m.useState(!1),B=P=>{I(""),c(T=>({...T,[P.target.name]:P.target.value}))},N=async P=>{if(P.preventDefault(),!(A||d)){b(""),I(""),f(!0);try{await r({email:String(o.email||"").trim().toLowerCase(),password:String(o.password||"")}),I("Login successful. Preparing your festival workspace..."),await new Promise(T=>setTimeout(T,450)),t(n)}catch(T){b(T.response?.data?.message||T.message||"Invalid email or password")}finally{f(!1)}}},h=async()=>{b(""),I(""),F(!0);try{await Ia({clientId:i||"231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com",onProfile:async(T,R)=>{const V=await Ze.googleAuth(R,T);Ne.setToken(V.token),await s(),I(`Google sign-in successful as ${T.email}. Redirecting...`),await new Promise(O=>setTimeout(O,450)),t(n)}})}catch(P){const T=P.response?.data?.message||P.message||"Google sign-in failed";!T.toLowerCase().includes("cancel")&&!T.toLowerCase().includes("closed")&&b(T)}finally{F(!1)}};return e.jsxs("form",{onSubmit:N,className:"kx-form",children:[p&&e.jsx("div",{className:"kx-alert kx-alert-error",role:"alert",children:p}),x&&e.jsx("div",{className:"kx-alert kx-alert-success",role:"alert",children:x}),e.jsxs("button",{type:"button",className:"kx-google",onClick:h,disabled:d||A,children:[e.jsx(kr,{}),e.jsx("span",{children:d?"Connecting to Google...":"Continue with Google"}),e.jsx("i",{"aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-divider",children:[e.jsx("span",{}),e.jsx("em",{children:"or sign in with email"}),e.jsx("span",{})]}),e.jsxs("label",{className:`kx-field ${g==="email"?"kx-focused":""}`,children:[e.jsx(xr,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"email",value:o.email,placeholder:"Email or Mobile Number",autoComplete:"username",required:!0,onChange:B,onFocus:()=>u("email"),onBlur:()=>u(null)}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("label",{className:`kx-field ${g==="password"?"kx-focused":""}`,children:[e.jsx(br,{className:"kx-field-icon"}),e.jsx("input",{type:y?"text":"password",name:"password",value:o.password,placeholder:"Password",autoComplete:"current-password",required:!0,onChange:B,onFocus:()=>u("password"),onBlur:()=>u(null)}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>k(P=>!P),"aria-label":y?"Hide password":"Show password",children:e.jsx(yr,{hidden:y})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-meta",children:[e.jsxs("label",{className:"kx-remember",children:[e.jsx("input",{type:"checkbox",checked:E,onChange:P=>w(P.target.checked)}),e.jsx("span",{className:"kx-checkbox",children:E&&e.jsx(wr,{})}),e.jsx("span",{children:"Remember me"})]}),e.jsx("a",{href:"#forgot-password",className:"kx-forgot-link",children:"Forgot password?"})]}),e.jsxs("button",{className:"kx-sign-in",type:"submit",disabled:A||d,children:[e.jsx("span",{className:"kx-button-glow","aria-hidden":"true"}),e.jsx("span",{className:"kx-button-sheen","aria-hidden":"true"}),A?e.jsx("span",{className:"kx-spinner","aria-label":"Signing in..."}):e.jsxs("span",{className:"kx-button-copy",children:["Sign in",e.jsx(vr,{})]})]}),e.jsxs("p",{className:"kx-signup",children:["Don't have an account?"," ",e.jsx(X,{to:`/register?${new URLSearchParams({returnTo:n}).toString()}`,children:"Create account"})]}),e.jsxs("div",{className:"kx-trust-grid","aria-label":"Security indicators",children:[e.jsx("span",{children:"🔒 Secure Login"}),e.jsx("span",{children:"⚡ Fast Access"}),e.jsx("span",{children:"🛡️ Protected"}),e.jsx("span",{children:"✓ Verified"})]})]})}function Nr(){return e.jsxs("div",{className:"auth-form-container",children:[e.jsx(jr,{}),e.jsxs("div",{className:"auth-footer-links",children:[e.jsx(X,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"•"}),e.jsx(X,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"•"}),e.jsx(X,{to:"/#contact",children:"Need Help?"})]})]})}function Jt(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("path",{d:"M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"}),e.jsx("circle",{cx:"12",cy:"7",r:"4"})]})}function Sr(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m4 7 8 6 8-6"})]})}function Ar(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"})})}function Qt(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"4",y:"10",width:"16",height:"11",rx:"2"}),e.jsx("path",{d:"M8 10V7a4 4 0 0 1 8 0v3"})]})}function ea({hidden:t=!1,...a}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...a,children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"}),t&&e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}function Pr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M5 12h14M13 6l6 6-6 6"})})}function Tr(t){return e.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",...t,children:[e.jsx("path",{fill:"#4285F4",d:"M21.6 12.23c0-.71-.06-1.4-.18-2.06H12v3.9h5.38a4.6 4.6 0 0 1-2 3.01v2.53h3.23c1.9-1.75 2.99-4.32 2.99-7.38Z"}),e.jsx("path",{fill:"#34A853",d:"M12 22c2.7 0 4.97-.9 6.62-2.39l-3.23-2.53c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.61-4.13H3.05v2.61A10 10 0 0 0 12 22Z"}),e.jsx("path",{fill:"#FBBC05",d:"M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.3.31-1.91V7.48H3.05A10 10 0 0 0 2 12c0 1.61.39 3.14 1.05 4.52l3.34-2.61Z"}),e.jsx("path",{fill:"#EA4335",d:"M12 5.96c1.47 0 2.79.51 3.82 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.95 5.48l3.34 2.61C7.18 7.72 9.39 5.96 12 5.96Z"})]})}const ta=()=>new Promise(t=>setTimeout(t,450));function Er(){const t=ct(),a=Ke(),{register:r,checkAuth:s}=Je(),i="231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com",l=new URLSearchParams(a.search).get("returnTo"),n=At(l,"/dashboard"),[o,c]=m.useState({firstName:"",lastName:"",email:"",phone:"",password:"",confirmPassword:""}),[g,u]=m.useState(null),[y,k]=m.useState(""),[E,w]=m.useState(!1),[p,b]=m.useState(!1),[x,I]=m.useState(!1),[A,f]=m.useState(!1),[d,F]=m.useState(0),[B,N]=m.useState(""),[h,P]=m.useState(""),[T,R]=m.useState(!1),[V,O]=m.useState(!1),[C,$]=m.useState(!1),[Y,H]=m.useState(!1),[M,D]=m.useState({email:!1,phone:!1,password:!1,confirmPassword:!1}),q=/^\S+@\S+\.\S+$/.test(o.email),oe=/^(\+?\d{1,3})?[\s-]?\d{10,12}$/.test(o.phone.replace(/\s+/g,"")),te={upper:/[A-Z]/.test(o.password),lower:/[a-z]/.test(o.password),number:/\d/.test(o.password),special:/[^A-Za-z0-9]/.test(o.password),length:o.password.length>=8},ne=Object.values(te).filter(Boolean).length,v=ne===5,j=o.confirmPassword.length>0&&o.password===o.confirmPassword,_=o.password.length>0,J=m.useMemo(()=>_?ne<=2?{label:"Weak",className:"weak",percent:28}:ne===3?{label:"Medium",className:"medium",percent:52}:ne===4?{label:"Strong",className:"strong",percent:78}:{label:"Excellent",className:"excellent",percent:100}:{label:"Start typing",className:"empty",percent:8},[_,ne]),re=[{key:"upper",text:"Uppercase letter",met:te.upper},{key:"lower",text:"Lowercase letter",met:te.lower},{key:"number",text:"Number",met:te.number},{key:"special",text:"Special character",met:te.special},{key:"length",text:"8+ characters",met:te.length}],ae=o.firstName.trim()&&o.lastName.trim()&&q&&oe&&v&&j&&p&&!T&&!V;m.useEffect(()=>{if(d<=0)return;const S=window.setInterval(()=>{F(L=>Math.max(0,L-1))},1e3);return()=>window.clearInterval(S)},[d]);const z=()=>{N(""),P("")},ie=S=>{const{name:L,value:Q}=S.target;z(),c(Z=>({...Z,[L]:Q})),L==="email"&&(k(""),w(!1),b(!1),F(0)),L in M&&Q.length>0&&D(Z=>({...Z,[L]:!0}))},me=S=>{const{name:L}=S.target;u(null),L in M&&D(Q=>({...Q,[L]:!0}))},Se=async()=>{if(z(),!q){D(S=>({...S,email:!0})),N("Please enter a valid email address before sending OTP.");return}I(!0);try{const S=await Ze.sendOtp(o.email);S?.emailDelivery==="failed"||typeof S?.message=="string"&&S.message.toLowerCase().includes("delivery failed")&&!S?.devOtp?(w(!1),N(S.emailError||"Email delivery failed: SMTP credentials (SMTP_USER and SMTP_PASS) are not configured on the backend server.")):(w(!0),b(!1),F(60),S?.devOtp?k(String(S.devOtp)):k(""),P(S.message||"OTP code has been sent to your email. Please check your inbox."))}catch(S){N(S.response?.data?.message||S.message||"Unable to send OTP.")}finally{I(!1)}},ue=async()=>{if(z(),!q||y.trim().length<4){N("Enter the OTP sent to your email.");return}f(!0);try{const S=await Ze.verifyOtp({email:o.email,otp:y});b(!0),P(S.message||"Email verified successfully.")}catch(S){b(!1),N(S.response?.data?.message||S.message||"OTP verification failed.")}finally{f(!1)}},se=async S=>{if(S.preventDefault(),z(),!q){D(L=>({...L,email:!0})),N("Please enter a valid email address.");return}if(!p){N("Please verify your email OTP before creating your account.");return}if(!oe){D(L=>({...L,phone:!0})),N("Please enter a valid mobile number.");return}if(!v){D(L=>({...L,password:!0})),N("Please satisfy all password requirements.");return}if(!j){D(L=>({...L,confirmPassword:!0})),N("Passwords do not match.");return}R(!0);try{await r({firstName:o.firstName,lastName:o.lastName,name:`${o.firstName} ${o.lastName}`.trim(),email:o.email,phone:o.phone,password:o.password}),P("Account created successfully. Preparing your festival workspace..."),await ta(),t(n)}catch(L){const Q=L.response?.status,Z=L.response?.data?.message||"Registration failed",de=Z.toLowerCase();Q===409||de.includes("already")||de.includes("exists")?N("Account already exists with this email or phone number"):N(Z)}finally{R(!1)}},G=async()=>{z(),O(!0);try{await Ia({clientId:i||"231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com",onProfile:async(L,Q)=>{const Z=await Ze.googleAuth(Q,L);Ne.setToken(Z.token),await s(),P(`Google sign-up verified as ${L.email}. Welcome to OZILLA FEST!`),await ta(),t(n)}})}catch(S){const L=S.response?.data?.message||S.message||"Google sign-up failed";!L.toLowerCase().includes("cancel")&&!L.toLowerCase().includes("closed")&&N(L)}finally{O(!1)}};return e.jsxs("form",{onSubmit:se,className:"kx-form",children:[B&&e.jsx("div",{className:"kx-alert kx-alert-error",role:"alert",children:B}),h&&e.jsx("div",{className:"kx-alert kx-alert-success",role:"alert",children:h}),e.jsxs("button",{type:"button",className:"kx-google",onClick:G,disabled:V||T,children:[e.jsx(Tr,{}),e.jsx("span",{children:V?"Connecting to Google...":"Sign up with Google"}),e.jsx("i",{"aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-divider",children:[e.jsx("span",{}),e.jsx("em",{children:"or register with email"}),e.jsx("span",{})]}),e.jsxs("div",{className:"kx-grid-row",children:[e.jsxs("label",{className:`kx-field ${g==="firstName"?"kx-focused":""}`,children:[e.jsx(Jt,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"firstName",value:o.firstName,placeholder:"First Name",autoComplete:"given-name",required:!0,onChange:ie,onFocus:()=>u("firstName"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("label",{className:`kx-field ${g==="lastName"?"kx-focused":""}`,children:[e.jsx(Jt,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"lastName",value:o.lastName,placeholder:"Last Name",autoComplete:"family-name",required:!0,onChange:ie,onFocus:()=>u("lastName"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]})]}),e.jsxs("label",{className:`kx-field ${g==="email"?"kx-focused":""} ${M.email&&!q?"kx-field-invalid":""}`,children:[e.jsx(Sr,{className:"kx-field-icon"}),e.jsx("input",{type:"email",name:"email",value:o.email,placeholder:"Email address",autoComplete:"email",required:!0,onChange:ie,onFocus:()=>u("email"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),M.email&&!q&&e.jsx("p",{className:"kx-field-error-msg",children:"Please enter a valid email address."}),e.jsxs("div",{className:`kx-otp-box ${p?"kx-otp-verified":""}`,children:[e.jsxs("div",{className:"kx-otp-meta",children:[e.jsx("span",{className:"kx-otp-kicker",children:"Email Verification"}),e.jsx("strong",{children:p?"✓ Email verified":E?"Enter 6-digit code":"Verify email before submit"}),e.jsx("span",{className:"kx-otp-subtext",children:p?"Security verified":d>0?`Resend available in ${d}s`:"Code will be sent to your email"})]}),e.jsxs("div",{className:"kx-otp-controls",children:[e.jsx("button",{type:"button",className:"kx-otp-btn",onClick:Se,disabled:x||!q||p||d>0,children:x?"Sending...":E?"Resend OTP":"Send OTP"}),e.jsx("input",{type:"text",value:y,onChange:S=>{z(),k(S.target.value.replace(/\D/g,"").slice(0,6)),b(!1)},className:"kx-otp-input",placeholder:"Enter 6-digit OTP",inputMode:"numeric",autoComplete:"one-time-code",disabled:!E||p}),e.jsx("button",{type:"button",className:"kx-otp-btn kx-otp-btn-accent",onClick:ue,disabled:!E||p||A,children:A?"Verifying...":p?"Verified":"Verify"})]})]}),e.jsxs("label",{className:`kx-field ${g==="phone"?"kx-focused":""} ${M.phone&&!oe?"kx-field-invalid":""}`,children:[e.jsx(Ar,{className:"kx-field-icon"}),e.jsx("input",{type:"tel",name:"phone",value:o.phone,placeholder:"Phone (+92 3XX XXXXXXX)",autoComplete:"tel",required:!0,onChange:ie,onFocus:()=>u("phone"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),M.phone&&!oe&&e.jsx("p",{className:"kx-field-error-msg",children:"Please enter a valid mobile number."}),e.jsxs("label",{className:`kx-field ${g==="password"?"kx-focused":""} ${M.password&&!v?"kx-field-invalid":""}`,children:[e.jsx(Qt,{className:"kx-field-icon"}),e.jsx("input",{type:C?"text":"password",name:"password",value:o.password,placeholder:"Create Password",autoComplete:"new-password",required:!0,onChange:ie,onFocus:()=>u("password"),onBlur:me}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>$(S=>!S),"aria-label":C?"Hide password":"Show password",children:e.jsx(ea,{hidden:C})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("div",{className:`kx-strength kx-strength-${J.className}`,children:[e.jsxs("div",{className:"kx-strength-header",children:[e.jsx("span",{children:"Password Strength"}),e.jsx("strong",{children:J.label})]}),e.jsx("div",{className:"kx-strength-bar-track",children:e.jsx("span",{style:{width:`${J.percent}%`}})})]}),e.jsx("ul",{className:"kx-pwd-rules",children:re.map(S=>{const L=S.met?"kx-rule-met":_?"kx-rule-unmet":"kx-rule-neutral";return e.jsxs("li",{className:`kx-pwd-rule ${L}`,children:[e.jsx("span",{className:"kx-rule-badge",children:S.met?"✓":"•"}),e.jsx("span",{children:S.text})]},S.key)})}),e.jsxs("label",{className:`kx-field ${g==="confirmPassword"?"kx-focused":""} ${M.confirmPassword&&!j?"kx-field-invalid":""}`,children:[e.jsx(Qt,{className:"kx-field-icon"}),e.jsx("input",{type:Y?"text":"password",name:"confirmPassword",value:o.confirmPassword,placeholder:"Confirm Password",autoComplete:"new-password",required:!0,onChange:ie,onFocus:()=>u("confirmPassword"),onBlur:me}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>H(S=>!S),"aria-label":Y?"Hide confirm password":"Show confirm password",children:e.jsx(ea,{hidden:Y})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),M.confirmPassword&&!j&&e.jsx("p",{className:"kx-field-error-msg",children:"Passwords do not match."}),e.jsxs("button",{className:"kx-sign-in",type:"submit",disabled:!ae,children:[e.jsx("span",{className:"kx-button-glow","aria-hidden":"true"}),e.jsx("span",{className:"kx-button-sheen","aria-hidden":"true"}),T?e.jsx("span",{className:"kx-spinner","aria-label":"Creating account..."}):e.jsxs("span",{className:"kx-button-copy",children:["Create Account",e.jsx(Pr,{})]})]}),e.jsxs("p",{className:"kx-signup",children:["Already have an account?"," ",e.jsx(X,{to:`/login?${new URLSearchParams({returnTo:n}).toString()}`,children:"Sign In"})]}),e.jsxs("div",{className:"kx-trust-grid","aria-label":"Security indicators",children:[e.jsx("span",{children:"🔒 Secure Sign Up"}),e.jsx("span",{children:"⚡ Instant Access"}),e.jsx("span",{children:"🛡️ Protected"}),e.jsx("span",{children:"✓ Google Verified"})]})]})}function Cr(){return e.jsxs("div",{className:"auth-form-container",children:[e.jsx(Er,{}),e.jsxs("div",{className:"auth-footer-links",children:[e.jsx(X,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"•"}),e.jsx(X,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"•"}),e.jsx(X,{to:"/#contact",children:"Need Help?"})]})]})}function Lr(){const[t]=Wa(),a=ct(),{checkAuth:r}=Je(),[s,i]=m.useState("Signing you in with Google...");return m.useEffect(()=>{(async()=>{const n=t.get("token"),o=t.get("error"),c=t.get("returnTo"),g=At(c,"/dashboard");if(o){i(o==="google_not_configured"?"Google sign-in is not configured on server yet. Please add GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in server/.env.":"Google sign-in failed. Please try again.");const u=new URLSearchParams({returnTo:g}).toString();setTimeout(()=>a(`/login?${u}`,{replace:!0}),1200);return}if(!n){i("Google sign-in token not found. Please try again.");const u=new URLSearchParams({returnTo:g}).toString();setTimeout(()=>a(`/login?${u}`,{replace:!0}),1200);return}Ne.setToken(n),await r(),a(g,{replace:!0})})()},[r,a,t]),e.jsx("div",{className:"auth-page",children:e.jsxs("div",{className:"auth-card",children:[e.jsx("h1",{className:"auth-title",children:"Google Sign-In"}),e.jsx("p",{className:"auth-subtitle",children:s})]})})}const Rr={hotels:[{name:"Pearl Continental Hotel (PC)",location:"Lahore, Punjab, Pakistan",rates:"Premium city-center business and leisure rates",offer:"Flexible booking options with conference and dining access.",website:"https://www.expedia.com/Lahore-Hotels-Pearl-Continental-Lahore.h6062.Hotel-Information?chkin=2026-07-23&chkout=2026-07-24&x_pwa=1&rfrr=HSR&pwa_ts=1783538185568&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=2068&destination=Lahore%2C+Punjab%2C+Pakistan&destType=MARKET&neighborhoodId=553248633981712959&selected=6062&latLong=31.554606%2C74.357155&sort=RECOMMENDED&top_dp=124&top_cur=USD&semcid=US.UB.BING.PT-c-EN.HOTEL&semdtl=a1429012176.b11315017303776210.g1kwd-82189323842618%3Aloc-144.e1c.m18d15bbf2af6c1d752fa9d1bc0e925b82.r1dbbc4399e805d7a471af9bb50c0eca6a53815556874c850795d8066b3e568804.c1.j1142691.k1152882.d182188878595064.h1e.i1.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&userIntent=&selectedRoomType=314006270&selectedRatePlan=380046345&categorySearch=any_option&searchId=60a6b42e-b43b-44af-a668-54a0fbd95022",image:W("/assets/hotels/Pearl-Continental-Lahore.jpg"),showImage:!0,description:"A flagship five-star property known for premium hospitality, executive facilities, and large event spaces.",facilities:["Luxury Rooms & Suites","Restaurants & Coffee Lounge","Swimming Pool","Fitness Center"],contact:"Reservations: +92 42 111 505 505",rating:"4.5/5"},{name:"Ramada by Wyndham Lahore",location:"Lahore, Punjab, Pakistan",rates:"Business-friendly international chain pricing",offer:"Comfort-focused stay packages with central access.",website:"https://www.guestreservations.com/ramada-by-wyndham-lahore-gulberg-ii/booking?utm_source=microsoft&utm_medium=cpc&utm_campaign=318380766&msclkid=2639f60cc7641752938d9c426507dbb5&ctTriggered=true",image:W("/assets/hotels/Ramada-by-Wyndham-Lahore-Gulberg-II.jpg"),showImage:!0,description:"An international-branded stay option designed for business travelers and families seeking modern comfort.",facilities:["Comfort Rooms","All-Day Dining","Meeting Facilities","Wi-Fi Access"],contact:"Reservations: +92 42 111 111 211",rating:"4.3/5"},{name:"Hotel Indigo Lahore",location:"Lahore, Punjab, Pakistan",rates:"Boutique premium rates for curated city stays",offer:"Lifestyle stay experience with modern interiors and city vibe.",website:"https://indigoheights.com/",image:W("/assets/hotels/Hotel-Indigo.jpg"),showImage:!0,description:"A contemporary boutique-style hotel brand experience offering design-led rooms and premium hospitality.",facilities:["Designer Rooms","Signature Dining","Fitness Facilities","Business Services"],contact:"Reservations: +92 42 111 111 111",rating:"4.4/5"},{name:"Hotel One Gulberg Lahore",location:"Lahore, Punjab, Pakistan",rates:"Upper-midscale corporate and family packages",offer:"Value-focused business stays in a prime Lahore district.",website:"https://www.guestreservations.com/hotel-one-gulberg-lahore/booking?utm_source=microsoft&utm_medium=cpc&utm_campaign=318380766&msclkid=3d22881e8b211d72a380e25028093b5b",image:W("/assets/hotels/Hotel-One-Gulberg-Lahore.jpg"),showImage:!0,description:"A trusted local hospitality brand known for practical comfort, business convenience, and central location.",facilities:["Business-Friendly Rooms","Breakfast Service","Meeting Room","24/7 Front Desk"],contact:"Reservations: +92 42 111 111 563",rating:"4.2/5"},{name:"Luxus Grand Hotel (LC)",location:"Lahore, Punjab, Pakistan",rates:"Executive and leisure stay rates",offer:"City-center premium rooms with event-friendly access.",website:"https://www.expedia.com/Lahore-Hotels-Luxus-Grand-Hotel.h16225098.Hotel-Information?chkin=2026-07-23&chkout=2026-07-24&x_pwa=1&rfrr=HSR&pwa_ts=1783538679588&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=2068&destination=Lahore%2C+Punjab%2C+Pakistan&destType=MARKET&selected=16225098&latLong=31.554606%2C74.357155&sort=RECOMMENDED&top_dp=50&top_cur=USD&semcid=US.UB.BING.PT-c-EN.HOTEL&semdtl=a1429012176.b11317216326895908.g1kwd-82326765629610%3Aloc-144.e1c.m1f413ae58b13f11ee7d78c41612f456b3.r17441980d01bf266109c2845e02c5e619d691d9360faf76d1fb0b3ff083f73b12.c1.j1142691.k1152882.d182326298507125.h1e.i1.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&userIntent=&selectedRoomType=201690559&selectedRatePlan=208425873&categorySearch=any_option&searchId=b938991e-d9ee-47cd-a5b9-bfbbe22962a7",image:W("/assets/hotels/Luxus-Grand-Hotel.jpg"),showImage:!0,description:"A modern luxury hotel in Lahore offering upscale rooms, contemporary dining, and premium guest services.",facilities:["Premium Rooms","Restaurant & Cafe","Concierge Support","Airport Transfer Assistance"],contact:"Reservations: +92 42 111 589 879",rating:"4.4/5"},{name:"Nishat Hotel Lahore",location:"Lahore, Punjab, Pakistan",rates:"Premium luxury rates with lifestyle amenities",offer:"High-end accommodation with shopping and dining proximity.",website:"https://www.booking.com/hotel/pk/the-nishat.en-gb.html?aid=2276380&label=msn-G%2AualcbtRsY8_D6yMU0tng-80333218529225%3Atikwd-80333372562144%3Aloc-144%3Aneo%3Amte%3Alp142691%3Adec%3Acid578349423%3Aagid1285329581450391%3Aclkid91bc1c0fd2ae13842aa77641760a897b&sid=d2e80396e6c920f70a72e21ba196f068&all_sr_blocks=112449101_204759422_0_2_0_670390&checkin=2026-07-14&checkout=2026-07-15&dest_id=-2767043&dest_type=city&dist=0&group_adults=2&group_children=0&hapos=1&highlighted_blocks=112449101_204759422_0_2_0_670390&hpos=1&matching_block_id=112449101_204759422_0_2_0_670390&no_rooms=1&req_adults=2&req_children=0&room1=A%2CA&sb_price_type=total&sr_order=popularity&sr_pri_blocks=112449101_204759422_0_2_0_670390_3300000&srepoch=1783539000&srpvid=7c17890e04e000e0&type=total&ucfs=1&",image:W("/assets/hotels/Nishat.jpg"),showImage:!0,description:"A luxury Lahore hospitality brand recognized for refined interiors, premium service standards, and prime locations.",facilities:["Luxury Suites","Fine Dining","Spa & Wellness","Event and Meeting Spaces"],contact:"Reservations: +92 42 111 647 428",rating:"4.6/5"}]};W("/assets/ozilla/singer-talwinder.png"),W("/assets/ozilla/singer-talwinder.png"),W("/assets/ozilla/Imran-Khan.jpg"),W("/assets/ozilla/Imran-Khan.jpg"),W("/assets/ozilla/Bohemia.jpg"),W("/assets/ozilla/Bohemia.jpg"),W("/assets/ozilla/hassan-raheem.jpg"),W("/assets/ozilla/hassan-raheem.jpg");const aa=[{name:"MYSTERY HEADLINER",isHeadliner:!0,isMystery:!0,genre:"Secret Headline Act",stage:"Main Prism Stage",bpm:"??? BPM",vibe:"Revealing Soon",src:W("/assets/ozilla/singer-talwinder.png"),image:W("/assets/ozilla/singer-talwinder.png"),offsetY:0},{name:"IMRAN KHAN",isHeadliner:!1,genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",src:W("/assets/ozilla/Imran-Khan.jpg"),image:W("/assets/ozilla/Imran-Khan.jpg"),offsetY:0},{name:"BOHEMIA",isHeadliner:!1,genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",src:W("/assets/ozilla/Bohemia.jpg"),image:W("/assets/ozilla/Bohemia.jpg"),offsetY:0},{name:"HASSAN RAHEEM",isHeadliner:!1,genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",src:W("/assets/ozilla/hassan-raheem.jpg"),image:W("/assets/ozilla/hassan-raheem.jpg"),offsetY:0}],ra=1.28,sa=.78;function Ye(t,a,r){return Math.min(r,Math.max(a,t))}function Nt(t){if(!t)return null;if(typeof t=="string")return t||null;const a=t.src||t.image;return typeof a=="string"&&a?a:null}function Ir(t){return Nt(t&&typeof t=="object"&&(t.image||t.src)||t)}function zr(t){if(t&&typeof t=="object"&&"offsetY"in t){const a=t.offsetY;return typeof a=="number"&&isFinite(a)?a:0}return 0}function Mr({items:t=aa,images:a,slideWidth:r=320,slideHeight:s=440,spacing:i=2.4,direction:l="right",smoothness:n=3,radius:o=24,dim:c=5,background:g="transparent",sensitivity:u=8,autoPlay:y=!1,autoPlayInterval:k=2800,autoPlaySpeed:E=1,style:w,onItemClick:p}){const b=m.useRef(null),x=m.useRef([]),I=m.useRef(0),A=m.useRef(0),[f,d]=m.useState(0),[F,B]=m.useState(!1),[N,h]=m.useState(0),P=t&&t.length>0?t:a&&a.length>0?a:aa,T=m.useMemo(()=>P.map((v,j)=>{const _=!!(v.isMystery||v.name?.toUpperCase().includes("MYSTERY")||v.name?.toUpperCase().includes("SECRET")||v.name?.toUpperCase().includes("TALWINDER")||v.name==="???");return{...v,src:_?Nt(v.src||v.image)?.includes(".png")?Nt(v.src||v.image):W("/assets/ozilla/singer-talwinder.png"):Ir(v),offsetY:zr(v),name:_?"MYSTERY HEADLINER":v.name||`Artist ${j+1}`,genre:_?"Secret Headline Act":v.genre||"Live Performer",stage:v.stage||"Ozilla Arena",bpm:_?"??? BPM":v.bpm||"128 BPM",vibe:_?"Revealing Soon":v.vibe||"Festival Energy",isHeadliner:!!v.isHeadliner,isMystery:_}}),[P]),R=f>0&&f<640?Math.min(r,250):f<1024?Math.min(r,290):r,V=f>0&&f<640?Math.round(R*1.36):s,O=R+Ye(i,0,10)*18,C=.24-Ye(n,0,10)/10*.1,$=Ye(c,0,10)/10*.75,Y=.8+Ye(u,0,10)/10*1.6,H=.9+Ye(u,0,10)/10*1.8,M=l==="left",D=E>0?Math.round(k/E):k,q=m.useRef({count:T.length,step:O,slideWidth:R,width:f,ease:C,maxScale:ra,minScale:sa,dim:$,loop:!1,flip:M});q.current={count:T.length,step:O,slideWidth:R,width:f,ease:C,maxScale:ra,minScale:sa,dim:$,loop:!1,flip:M};const oe=m.useRef({wheelMultiplier:Y,dragMultiplier:H,flip:M});oe.current={wheelMultiplier:Y,dragMultiplier:H,flip:M},m.useEffect(()=>{const v=b.current;if(!v)return;const j=new ResizeObserver(_=>{_[0]&&d(_[0].contentRect.width)});return j.observe(v),d(v.getBoundingClientRect().width),()=>j.disconnect()},[]),m.useEffect(()=>{x.current.length=T.length},[T.length]),m.useEffect(()=>{if(!y||F||T.length<=1)return;const v=setInterval(()=>{h(j=>{const _=(j+1)%T.length;return I.current=_*O,_})},D);return()=>clearInterval(v)},[y,F,T.length,O,D]),m.useEffect(()=>{let v=0,j=0,_=!0,J=null;const re=ae=>{if(v=requestAnimationFrame(re),!_){j=ae;return}const z=q.current,ie=j?Math.min((ae-j)/1e3,.1):1/60;if(j=ae,!z.count||z.step<=0||z.width<=0)return;const me=(z.count-1)*z.step;I.current=Ye(I.current,0,me);const Se=1-Math.pow(1-z.ease,ie*60);A.current+=(I.current-A.current)*Se;const ue=Math.round(A.current/z.step);ue>=0&&ue<z.count&&h(ue);const se=(z.width-z.slideWidth)/2,G=z.width/2;for(let S=0;S<z.count;S+=1){const L=x.current[S];if(!L)continue;const Z=S*z.step-A.current+se,de=Z+z.slideWidth/2-G;let je,ve;de>0?(je=Math.min(z.maxScale,1+de/z.width*.45),ve=(je-1)*z.slideWidth*.35):(je=Math.max(z.minScale,1+de/z.width*.5),ve=0);const he=z.flip?z.width-z.slideWidth-(Z+ve):Z+ve;if(L.style.transform=`translate3d(${he}px, -50%, 0) scale(${je})`,z.dim>0&&je<1){const Re=(1-je)/Math.max(.001,1-z.minScale);L.style.opacity=String(Math.max(.45,1-Re*z.dim*.6))}else L.style.opacity="1"}};return typeof IntersectionObserver<"u"&&b.current&&(J=new IntersectionObserver(ae=>{ae[0]&&(_=ae[0].isIntersecting)},{rootMargin:"100px"}),J.observe(b.current)),v=requestAnimationFrame(re),()=>{cancelAnimationFrame(v),J&&J.disconnect()}},[]),m.useEffect(()=>{const v=b.current;if(!v)return;const j=_=>{_.preventDefault();const J=Math.abs(_.deltaX)>Math.abs(_.deltaY)?_.deltaX:_.deltaY;I.current+=J*oe.current.wheelMultiplier};return v.addEventListener("wheel",j,{passive:!1}),()=>v.removeEventListener("wheel",j)},[]),m.useEffect(()=>{const v=b.current;if(!v)return;let j=null,_=0;const J=z=>{if(j===null){j=z.pointerId,_=z.clientX;try{v.setPointerCapture(z.pointerId)}catch{}}},re=z=>{if(j!==z.pointerId)return;const ie=z.clientX-_;_=z.clientX,I.current+=(oe.current.flip?ie:-ie)*oe.current.dragMultiplier},ae=z=>{if(j===z.pointerId){j=null;try{v.hasPointerCapture(z.pointerId)&&v.releasePointerCapture(z.pointerId)}catch{}}};return v.addEventListener("pointerdown",J),v.addEventListener("pointermove",re),v.addEventListener("pointerup",ae),v.addEventListener("pointercancel",ae),()=>{v.removeEventListener("pointerdown",J),v.removeEventListener("pointermove",re),v.removeEventListener("pointerup",ae),v.removeEventListener("pointercancel",ae)}},[]);const te=m.useCallback(v=>{const j=Ye(v,0,T.length-1);I.current=j*O,h(j)},[T.length,O]),ne=m.useCallback(v=>{const j=Ye(N+(v==="left"?-1:1),0,T.length-1);te(j)},[N,te,T.length]);return e.jsxs("div",{style:{position:"relative",width:"100%",display:"flex",flexDirection:"column",alignItems:"center",margin:"1.2rem 0"},onMouseEnter:()=>B(!0),onMouseLeave:()=>B(!1),children:[e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",flexWrap:"wrap",gap:"8px",marginBottom:"1rem",zIndex:10},children:T.map((v,j)=>{const _=j===N;return e.jsx("button",{type:"button",onClick:()=>te(j),style:{padding:"6px 14px",borderRadius:"999px",border:_?"1px solid #ff8a3d":"1px solid rgba(255, 255, 255, 0.12)",background:_?"linear-gradient(135deg, rgba(255, 138, 61, 0.32), rgba(255, 90, 31, 0.22))":"rgba(20, 10, 6, 0.55)",color:_?"#ffbd59":"rgba(255, 255, 255, 0.65)",fontSize:"0.78rem",fontWeight:_?"850":"650",letterSpacing:"0.04em",cursor:"pointer",transition:"all 200ms ease",backdropFilter:"blur(8px)",boxShadow:_?"0 0 16px rgba(255, 138, 61, 0.35)":"none"},children:v.name},v.name)})}),e.jsx("div",{ref:b,className:"smooth-scroll-slider-viewport",style:{position:"relative",width:"100%",height:`${V+50}px`,overflow:"hidden",background:g,cursor:"grab",touchAction:"pan-y",opacity:f>0?1:0,transition:"opacity 0.35s ease",userSelect:"none",...w},children:T.map((v,j)=>{const _=v.isHeadliner,J=j===N;return e.jsxs("div",{ref:re=>{x.current[j]=re},onClick:()=>{te(j),p&&p(v,j)},style:{position:"absolute",top:"50%",left:0,width:`${R}px`,height:`${V}px`,borderRadius:`${o}px`,overflow:"hidden",background:v.isMystery?"radial-gradient(ellipse at 50% 45%, rgba(255, 90, 31, 0.42) 0%, rgba(26, 8, 4, 0.95) 60%, #0c0605 100%)":"#130c0a",border:J?"1.5px solid rgba(255, 138, 61, 0.85)":_?"1px solid rgba(255, 138, 61, 0.45)":"1px solid rgba(255, 255, 255, 0.12)",boxShadow:J?"0 26px 65px rgba(0,0,0,0.9), 0 0 35px rgba(255, 90, 31, 0.4)":"0 18px 45px rgba(0,0,0,0.75)",willChange:"transform, filter",transform:"translate3d(0, -50%, 0)",cursor:"pointer",transition:"border-color 250ms ease, box-shadow 250ms ease"},children:[v.src?e.jsxs("div",{style:{position:"relative",width:"100%",height:"100%",overflow:"hidden"},children:[v.isMystery&&e.jsx("div",{style:{position:"absolute",inset:0,background:"radial-gradient(circle at 50% 38%, rgba(255, 110, 40, 0.35) 0%, transparent 68%)",zIndex:1,pointerEvents:"none"}}),e.jsx("img",{src:v.src,alt:v.name,draggable:!1,onError:re=>{re.currentTarget.src=W("/assets/prism-auth-visual.jpg")},style:{width:"100%",height:"100%",objectFit:v.isMystery?"contain":"cover",objectPosition:v.isMystery?"50% 65%":`50% calc(50% + ${v.offsetY}px)`,filter:v.isMystery?"brightness(0) drop-shadow(0 0 18px rgba(255, 90, 31, 0.95)) drop-shadow(0 0 38px rgba(255, 140, 50, 0.55))":"none",transform:v.isMystery?"scale(0.92) translateY(12px)":"none",display:"block",userSelect:"none"}})]}):null,e.jsxs("div",{style:{position:"absolute",top:"12px",left:"12px",right:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",zIndex:3},children:[v.isMystery?e.jsx("span",{style:{display:"inline-flex",alignItems:"center",gap:"4px",padding:"4px 10px",borderRadius:"999px",background:"linear-gradient(135deg, #ff5a1f, #c23300)",color:"#fff",fontSize:"0.68rem",fontWeight:"900",letterSpacing:"0.06em",textTransform:"uppercase",boxShadow:"0 4px 14px rgba(255, 90, 31, 0.55)"},children:"🔒 SECRET HEADLINER"}):_?e.jsx("span",{style:{display:"inline-flex",alignItems:"center",gap:"4px",padding:"4px 10px",borderRadius:"999px",background:"linear-gradient(135deg, #ff8a3d, #ff5a1f)",color:"#fff",fontSize:"0.68rem",fontWeight:"900",letterSpacing:"0.06em",textTransform:"uppercase",boxShadow:"0 4px 14px rgba(255, 90, 31, 0.45)"},children:"★ MAIN HEADLINER"}):e.jsx("span",{style:{padding:"3px 9px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.65)",backdropFilter:"blur(8px)",color:"#f6eee8",fontSize:"0.66rem",fontWeight:"700",border:"1px solid rgba(255,255,255,0.12)"},children:v.stage}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",gap:"2px",height:"14px",padding:"3px 6px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.55)",backdropFilter:"blur(6px)"},children:[e.jsx("span",{className:"sss-eq-bar sss-eq-1"}),e.jsx("span",{className:"sss-eq-bar sss-eq-2"}),e.jsx("span",{className:"sss-eq-bar sss-eq-3"})]})]}),e.jsxs("div",{style:{position:"absolute",inset:0,background:"linear-gradient(180deg, rgba(0,0,0,0.08) 0%, transparent 40%, rgba(10,5,3,0.72) 65%, rgba(6,3,2,0.96) 100%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:"16px 14px",zIndex:2},children:[e.jsx("span",{style:{display:"inline-block",width:"fit-content",padding:"2px 8px",borderRadius:"999px",background:"rgba(255, 138, 61, 0.18)",border:"1px solid rgba(255, 138, 61, 0.35)",color:"#ffbd59",fontSize:"0.68rem",fontWeight:"800",letterSpacing:"0.04em",textTransform:"uppercase",marginBottom:"6px"},children:v.genre}),e.jsx("h3",{style:{margin:0,color:"#ffffff",fontSize:"1.28rem",fontWeight:"900",letterSpacing:"-0.02em",lineHeight:1.15,textTransform:"uppercase",textShadow:"0 2px 10px rgba(0,0,0,0.7)"},children:v.name}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginTop:"8px",paddingTop:"6px",borderTop:"1px solid rgba(255,255,255,0.1)",color:"rgba(255, 255, 255, 0.72)",fontSize:"0.68rem",fontWeight:"700"},children:[e.jsxs("span",{children:["⚡ ",v.bpm]}),e.jsxs("span",{children:["♫ ",v.vibe]})]})]})]},v.name)})}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"1rem",marginTop:"0.8rem",zIndex:10},children:[e.jsx("button",{type:"button",onClick:()=>ne("left"),disabled:N===0,"aria-label":"Previous artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:N===0?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:N===0?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:N===0?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:N===0?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:v=>{N>0&&(v.currentTarget.style.transform="scale(1.1)",v.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:v=>{v.currentTarget.style.transform="scale(1)",v.currentTarget.style.borderColor=N===0?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"‹"}),e.jsx("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:T.map((v,j)=>e.jsx("span",{onClick:()=>te(j),style:{width:j===N?"20px":"6px",height:"6px",borderRadius:"999px",backgroundColor:j===N?"#ff8a3d":"rgba(255, 255, 255, 0.25)",cursor:"pointer",transition:"all 250ms ease"}},j))}),e.jsx("button",{type:"button",onClick:()=>ne("right"),disabled:N===T.length-1,"aria-label":"Next artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:N===T.length-1?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:N===T.length-1?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:N===T.length-1?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:N===T.length-1?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:v=>{N<T.length-1&&(v.currentTarget.style.transform="scale(1.1)",v.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:v=>{v.currentTarget.style.transform="scale(1)",v.currentTarget.style.borderColor=N===T.length-1?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"›"})]}),e.jsx("style",{children:`
        .sss-eq-bar {
          width: 2px;
          border-radius: 999px;
          background: #ff8a3d;
      ...
      `})]})}const et={color:"#ff8a3d",rounded:24,thickness:2.5,borderSize:45,glow:85,movement:"continuous",speed:16},Fr=2,$t=[{blur:8,opacity:.5,reach:.3},{blur:15,opacity:.3,reach:.6},{blur:40,opacity:.18,reach:1}],Or=Math.max(...$t.map(t=>t.blur)),ia=36;function zt(t,a){const r=Math.max(0,Math.min(1,a));if(typeof t!="string")return`rgba(0,0,0,${r})`;const s=t.trim(),i=s.match(/^#([0-9a-f]{3,8})$/i);if(i){let n=i[1];(n.length===3||n.length===4)&&(n=n.split("").map(c=>c+c).join(""));const o=parseInt(n.slice(0,6),16);return Number.isFinite(o)?`rgba(${o>>16&255},${o>>8&255},${o&255},${r})`:`rgba(0,0,0,${r})`}const l=s.match(/^rgba?\(([^)]+)\)/i);if(l){const n=l[1].split(",").map(o=>parseFloat(o));if(n.length>=3&&n.slice(0,3).every(Number.isFinite))return`rgba(${n[0]},${n[1]},${n[2]},${r})`}return`rgba(0,0,0,${r})`}function Dr(t,a,r){const s=(t%1+1)%1*2*(a+r);return s<a?[s,0]:s<a+r?[a,s-a]:s<a*2+r?[a-(s-a-r),r]:[0,r-(s-a*2-r)]}function na(t,a,r){const s=2*(a+r),i=[0,a/s,(a+r)/s,(a*2+r)/s];return Math.floor(t/4)+i[(t%4+4)%4]}function _r(t,a,r){const[s,i]=Dr(t,a,r);return Math.atan2(s-a/2,r/2-i)*180/Math.PI}const oa=24,Br=.015;function Mt(t,a,r,s,i){const l=r>0?r:100,n=s>0?s:100,o=Math.max(0,Math.min(100,a)),c=Math.max(Br,o/100*.5),g=o/100,u=[];let y=0,k=0,E=0;for(let p=0;p<=oa;p++){const b=p/oa,x=_r(t+(b-.5)*c,l,n);if(p===0)y=x;else{let f=x-k;for(;f>180;)f-=360;for(;f<-180;)f+=360;E+=f}k=x;const I=Math.abs(b-.5)*2,A=g>=1||I<=g?1:1-(I-g)/(1-g);u.push(`${zt(i,A*A*(3-2*A))} ${E.toFixed(2)}deg`)}const w=E.toFixed(2);return u.push(`${zt(i,0)} ${w}deg`),u.push(`${zt(i,0)} 360deg`),`conic-gradient(from ${y.toFixed(2)}deg at 50% 50%, ${u.join(", ")})`}const la=30,$r=4,ca=3,Hr=.35,Ur=[.72,.16,.18,1.05],Gr=[.65,0,.35,1];function za(t){const[a,r,s,i]=t;if(a===r&&s===i)return n=>n;const l=(n,o,c)=>{const g=1-c;return 3*g*g*c*n+3*g*c*c*o+c*c*c};return n=>{const o=Math.max(0,Math.min(1,n));let c=o;for(let g=0;g<8;g++){const u=l(a,s,c)-o,y=1-c,k=3*y*y*a+6*y*c*(s-a)+3*c*c*(1-s);if(Math.abs(k)<1e-6)break;c-=u/k,c=Math.max(0,Math.min(1,c))}return l(r,i,c)}}const Wr=za(Ur),Vr=za(Gr),da={WebkitMaskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",WebkitMaskClip:"content-box, border-box",WebkitMaskComposite:"xor",maskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",maskClip:"content-box, border-box",maskComposite:"exclude"};function tt({color:t=et.color,rounded:a=et.rounded,thickness:r=et.thickness,borderSize:s=et.borderSize,glow:i=et.glow,movement:l=et.movement,speed:n=et.speed,style:o,className:c=""}){const g=m.useRef(null),u=m.useRef(null),y=m.useRef({speed:n,movement:l,borderSize:s,color:t});y.current={speed:n,movement:l,borderSize:s,color:t};const k=m.useRef(null),E=m.useRef({w:0,h:0}),[w,p]=m.useState({w:0,h:0});m.useEffect(()=>{const N=k.current;if(!N||typeof ResizeObserver>"u")return;const h=new ResizeObserver(()=>{const P=N.getBoundingClientRect();P.width===E.current.w&&P.height===E.current.h||(E.current={w:P.width,h:P.height},p(E.current))});return h.observe(N),()=>h.disconnect()},[]),m.useEffect(()=>{const N=k.current;let h=!0,P=null;typeof IntersectionObserver<"u"&&N&&(P=new IntersectionObserver(Y=>{Y[0]&&(h=Y[0].isIntersecting)},{rootMargin:"100px"}),P.observe(N));let T=0,R=performance.now(),V=0,O=0,C=0;const $=Y=>{if(T=requestAnimationFrame($),!h||typeof document<"u"&&document.hidden){R=Y;return}const H=Math.min(.05,Math.max(0,(Y-R)/1e3));R=Y;const M=y.current,D=Math.max(0,Math.min(20,M.speed));if(D>0){const q=M.movement==="step",oe=q?ca+(Hr-ca)*(D-1)/19:(la+($r-la)*(D-1)/19)/4;for(C+=H/oe;C>=1;)C-=1,O+=1;const te=q?Wr(Math.min(1,C*2)):Vr(C),{w:ne,h:v}=E.current,j=ne>0?ne:100,_=v>0?v:100,J=na(O,j,_),re=na(O+1,j,_);V=J+(re-J)*te;const ae=g.current;ae&&ae.style.setProperty("--arc",Mt(V,M.borderSize,ne,v,M.color));const z=u.current;z&&z.style.setProperty("--arc",Mt(V+.5,M.borderSize,ne,v,M.color))}};return T=requestAnimationFrame($),()=>{cancelAnimationFrame(T),P&&P.disconnect()}},[]);const b=Math.max(1,Math.min(10,r)),x=Math.max(0,Math.min(100,a))/100*(Math.min(w.w||200,w.h||200)/2),I=Math.max(0,Math.min(100,i))/100,A=N=>b+I*ia*N,f=10+ia+Or*2,d=(N,h=0)=>e.jsx("div",{style:{position:"absolute",inset:h-N,boxSizing:"border-box",padding:N,borderRadius:x>0?x+N:0,background:"var(--arc)",...da}}),F=(N,h,P,T)=>e.jsx("div",{style:{position:"absolute",inset:-f,boxSizing:"border-box",padding:f,borderRadius:x>0?x+f:0,opacity:T,mixBlendMode:"plus-lighter",filter:P?`blur(${P.toFixed(1)}px)`:"none",WebkitFilter:P?`blur(${P.toFixed(1)}px)`:"none",...da},children:d(h,f)},N),B=(N,h)=>e.jsxs("div",{ref:h,style:{position:"absolute",inset:0,overflow:"visible",pointerEvents:"none","--arc":Mt(N,s,w.w,w.h,t)},children:[I>0&&(w.w>0&&w.w<600?[$t[0]].map((P,T)=>F(`glow-${T}`,A(P.reach),P.blur*.7,P.opacity*1.2)):$t.map((P,T)=>F(`glow-${T}`,A(P.reach),P.blur,P.opacity))),Array.from({length:Fr}).map((P,T)=>e.jsx("div",{style:{position:"absolute",inset:0,mixBlendMode:"plus-lighter"},children:d(b)},`edge-${T}`))]});return e.jsxs("div",{ref:k,className:`neon-border-overlay ${c}`,style:{position:"absolute",inset:0,width:"100%",height:"100%",flexShrink:0,borderRadius:x,pointerEvents:"none",zIndex:1,...o},children:[B(0,g),B(.5,u)]})}const Yr=1.5,qr=42,Xr=Math.PI*2,Zr=300,Kr=300,Jr=2,Qr=5e3,es=3.2,ts=.05,as=3,rs=1.35,ss=.08,is=.5,ns=.24,os=.35,ls=Xr*.75,cs=2,Ma=3,wt=720,ds=`
...
`;function pa(t){if(!t)return[1,1,1,1];let a=String(t).trim();const r=a.match(/^var\(\s*[^,)]+\s*,\s*(.+)\)$/i);r&&(a=r[1].trim());const s=a.match(/^rgba?\(([^)]+)\)$/i);if(s){const l=s[1].split(/[,\s/]+/).filter(Boolean).map(parseFloat);return[(l[0]||0)/255,(l[1]||0)/255,(l[2]||0)/255,l.length>3&&isFinite(l[3])?l[3]:1]}let i=a.replace("#","");return(i.length===3||i.length===4)&&(i=i.split("").map(l=>l+l).join("")),i.length<6?[1,1,1,1]:[parseInt(i.slice(0,2),16)/255,parseInt(i.slice(2,4),16)/255,parseInt(i.slice(4,6),16)/255,i.length>=8?parseInt(i.slice(6,8),16)/255:1]}function gs(t){return()=>{t|=0,t=t+1831565813|0;let a=Math.imul(t^t>>>15,1|t);return a=a+Math.imul(a^a>>>7,61|a)^a,((a^a>>>14)>>>0)/4294967296}}function ma(t,a,r){const s=t.createShader(a);return s?(t.shaderSource(s,r),t.compileShader(s),t.getShaderParameter(s,t.COMPILE_STATUS)||console.warn("VortexDustFall shader:",t.getShaderInfoLog(s)),s):null}function fa(t,a,r){const s=t.createProgram();if(!s)return null;const i=ma(t,t.VERTEX_SHADER,a),l=ma(t,t.FRAGMENT_SHADER,r);return!i||!l?null:(t.attachShader(s,i),t.attachShader(s,l),t.linkProgram(s),t.getProgramParameter(s,t.LINK_STATUS)||console.warn("VortexDustFall link:",t.getProgramInfoLog(s)),s)}const us={radius:195,thickness:16},hs={height:165,spin:38,spray:0},xs={scatter:280,blur:0},bs={amount:103,transition:{type:"tween",duration:.6,ease:"easeOut"}};function ys({background:t="transparent",baseColor:a="#FFA733",accentColor:r="#FFE082",density:s=145,dotSize:i=130,speed:l=48,distance:n=1450,tilt:o=7,ring:c={},fall:g={},field:u={},hover:y={},style:k={},className:E="",children:w}){const p={...us,...c},b={...hs,...g},x={...xs,...u},I={...bs,...y},A=m.useRef(null),f=m.useRef(null),d=m.useRef({x:0,y:0,active:0}),F=m.useRef({baseColor:a,accentColor:r,density:s,dotSize:i,speed:l,distance:n,tilt:o,ring:p,fall:b,field:x,hover:I});return F.current={baseColor:a,accentColor:r,density:s,dotSize:i,speed:l,distance:n,tilt:o,ring:p,fall:b,field:x,hover:I},m.useEffect(()=>{const B=A.current,N=f.current;if(!B||!N)return;const h=N.getContext("webgl",{alpha:!0,antialias:!1,premultipliedAlpha:!0,depth:!1});if(!h)return;const P=fa(h,ds,ps),T=fa(h,ms,fs);if(!P||!T)return;const R=(G,S)=>h.getUniformLocation(G,S),V={a:h.getAttribLocation(P,"aA"),b:h.getAttribLocation(P,"aB")},O={res:R(P,"uRes"),focal:R(P,"uFocal"),phase:R(P,"uPhase"),radius:R(P,"uRadius"),rise:R(P,"uRise"),fallD:R(P,"uFall"),spinTurns:R(P,"uSpinTurns"),scatter:R(P,"uScatter"),dotWorld:R(P,"uDotWorld"),blurK:R(P,"uBlurK"),camDist:R(P,"uCamDist"),tilt:R(P,"uTilt"),yPx:R(P,"uYPx"),alpha:R(P,"uAlpha"),color:R(P,"uColor")},C={ring:h.getAttribLocation(T,"aRing")},$={res:R(T,"uRes"),focal:R(T,"uFocal"),radius:R(T,"uRadius"),camDist:R(T,"uCamDist"),tilt:R(T,"uTilt"),yPx:R(T,"uYPx"),thick:R(T,"uThick"),seg:R(T,"uSeg"),color:R(T,"uColor"),alpha:R(T,"uAlpha")},Y=h.createBuffer(),H=h.createBuffer();let M=-1,D=0;const q=G=>{const S=N.clientWidth||B.clientWidth||(typeof window<"u"?window.innerWidth:1200),L=S<768,Q=S>=768&&S<1024,Z=L?1800:Q?8500:Math.round(G*Zr);D=Math.max(1e3,Z);const de=new Float32Array(D*4),je=new Float32Array(D*2),ve=gs(85840071);for(let he=0;he<D;he++)de[he*4]=ve(),de[he*4+1]=ve(),de[he*4+2]=ve(),de[he*4+3]=ve(),je[he*2]=ve(),je[he*2+1]=ve();h.bindBuffer(h.ARRAY_BUFFER,Y),h.bufferData(h.ARRAY_BUFFER,de,h.STATIC_DRAW),h.bindBuffer(h.ARRAY_BUFFER,H),h.bufferData(h.ARRAY_BUFFER,je,h.STATIC_DRAW),M=G},oe=h.createBuffer(),te=(wt+1)*2;{const G=new Float32Array(te*2);for(let S=0;S<=wt;S++){const L=S/wt;G[S*4]=L,G[S*4+1]=-1,G[S*4+2]=L,G[S*4+3]=1}h.bindBuffer(h.ARRAY_BUFFER,oe),h.bufferData(h.ARRAY_BUFFER,G,h.STATIC_DRAW)}h.disable(h.DEPTH_TEST),h.enable(h.BLEND),h.blendFunc(h.ONE,h.ONE);let ne=!0,v=null;typeof IntersectionObserver<"u"&&B&&(v=new IntersectionObserver(G=>{G[0]&&(ne=G[0].isIntersecting)},{rootMargin:"100px"}),v.observe(B));let j=1,_=0;const J=()=>{const G=typeof window<"u"&&window.innerWidth<768;j=Math.min(window.devicePixelRatio||1,G?.85:Yr);const S=N.clientWidth||B.clientWidth||1,L=N.clientHeight||B.clientHeight||1,Q=Math.max(1,Math.round(S*j)),Z=Math.max(1,Math.round(L*j));(N.width!==Q||N.height!==Z)&&(N.width=Q,N.height=Z),h.viewport(0,0,Q,Z),Math.abs(_-S)>50&&(_=S,q(F.current.density))};J();const re=new ResizeObserver(J);re.observe(N);let ae=0,z=performance.now(),ie=0,me=0,Se=0,ue=0;const se=G=>{if(ie=requestAnimationFrame(se),!ne||typeof document<"u"&&document.hidden){z=G;return}const S=Math.min((G-z)/1e3,.05);z=G;const L=F.current;if(L.density!==M&&q(L.density),D===0)return;const Q=Math.max(.05,L.hover.transition?.duration??.6),Z=1-Math.exp(-S/Q),de=d.current;me+=(de.x-me)*Z,Se+=(de.y-Se)*Z,ue+=(de.active-ue)*Z;const je=(L.hover.amount||100)/100,ve=1+ue*je*.6;ae=(ae+S*(L.speed/50*ve)/es)%1;const he=N.width,Re=N.height,_e=N.clientWidth||B.clientWidth||1200,ze=_e<768,dt=_e>=768&&_e<1024,Qe=Re/(2*Math.tan(qr/2*Math.PI/180)),pt=he/Math.max(Re,1),mt=pt<1?Math.max(.32,pt/1.4):dt?.85:1,Pe=Kr*(L.ring.radius/100)*mt,ft=Pe*(ze?1.1:L.fall.height/100),ht=ft*(L.fall.spray/400),xt=Re*(ze?.22:ns),Pt=L.fall.spin/100*1.5,Me=Pe*(L.field.scatter/100)*(ze?.08:.15),bt=Jr*(L.dotSize/100)*(ze?.65:1),He=Qr*(L.field.blur/100),Ue=ze?Math.min(L.ring.thickness*j,9*j):L.ring.thickness*j,U=L.tilt*Math.PI/180+Se*je*ue*(10*Math.PI/180),le=(ze?L.distance*1.05:L.distance)-ue*je*150,[xe,Te,we,Ie]=pa(L.baseColor),[Ge,st,Fe,it]=pa(L.accentColor);h.clearColor(0,0,0,0),h.clear(h.COLOR_BUFFER_BIT),h.useProgram(P),h.uniform2f(O.res,he,Re),h.uniform1f(O.focal,Qe),h.uniform1f(O.phase,ae),h.uniform1f(O.radius,Pe),h.uniform1f(O.rise,ht),h.uniform1f(O.fallD,ft),h.uniform1f(O.spinTurns,Pt),h.uniform1f(O.scatter,Me),h.uniform1f(O.dotWorld,bt*j),h.uniform1f(O.blurK,He*j),h.uniform1f(O.camDist,le),h.uniform1f(O.tilt,U),h.uniform1f(O.yPx,xt),h.uniform1f(O.alpha,Ie),h.uniform3f(O.color,xe,Te,we),h.bindBuffer(h.ARRAY_BUFFER,Y),h.enableVertexAttribArray(V.a),h.vertexAttribPointer(V.a,4,h.FLOAT,!1,0,0),h.bindBuffer(h.ARRAY_BUFFER,H),h.enableVertexAttribArray(V.b),h.vertexAttribPointer(V.b,2,h.FLOAT,!1,0,0),h.drawArrays(h.POINTS,0,D),h.useProgram(T),h.uniform2f($.res,he,Re),h.uniform1f($.focal,Qe),h.uniform1f($.radius,Pe),h.uniform1f($.camDist,le),h.uniform1f($.tilt,U),h.uniform1f($.yPx,xt),h.uniform1f($.thick,Ue),h.uniform1f($.seg,wt),h.uniform3f($.color,Ge,st,Fe),h.uniform1f($.alpha,it),h.bindBuffer(h.ARRAY_BUFFER,oe),h.enableVertexAttribArray(C.ring),h.vertexAttribPointer(C.ring,2,h.FLOAT,!1,0,0),h.drawArrays(h.TRIANGLE_STRIP,0,te)};return ie=requestAnimationFrame(se),()=>{cancelAnimationFrame(ie),re.disconnect(),v&&v.disconnect(),h.deleteBuffer(Y),h.deleteBuffer(H),h.deleteBuffer(oe),h.deleteProgram(P),h.deleteProgram(T)}},[]),e.jsxs("div",{ref:A,className:`vortex-dust-container ${E}`,onPointerMove:B=>{const N=B.currentTarget.getBoundingClientRect();N.width<=0||N.height<=0||(d.current={x:(B.clientX-N.left)/N.width*2-1,y:-((B.clientY-N.top)/N.height*2-1),active:1})},onPointerLeave:()=>{d.current={x:0,y:0,active:0}},style:{position:"absolute",inset:0,width:"100%",height:"100%",overflow:"hidden",pointerEvents:"none",background:t,...k},children:[e.jsx("canvas",{ref:f,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}}),w&&e.jsx("div",{style:{position:"relative",zIndex:2,pointerEvents:"auto",width:"100%",height:"100%"},children:w})]})}const vs=[{name:"MYSTERY HEADLINER",isHeadliner:!0,isMystery:!0,genre:"Secret Headline Act",stage:"Main Prism Stage",bpm:"??? BPM",vibe:"Revealing Soon",image:W("/assets/ozilla/singer-talwinder.png")},{name:"IMRAN KHAN",genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",image:W("/assets/ozilla/Imran-Khan.jpg")},{name:"BOHEMIA",genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",image:W("/assets/ozilla/Bohemia.jpg")},{name:"HASSAN RAHEEM",genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",image:W("/assets/ozilla/hassan-raheem.jpg")}],ws=[{id:"general",name:"General Pass",badge:"STANDARD ACCESS",price:"PKR 4,500",sub:"Full 1-day festival admission",isFeatured:!1,perks:["Access to All 4 Music Stages","Food & Beats Street Access","Festival Photo Booths & Activations","Instant Digital QR Pass"],ctaText:"Get General Pass",ctaLink:"/tickets"},{id:"vip",name:"VIP Experience",badge:"MOST POPULAR",price:"PKR 12,500",sub:"Elevated front-row & lounge access",isFeatured:!0,perks:["Priority Front Stage Viewing Deck","Private VIP Artist Lounge Access","Dedicated Fast-Track Entry Gate","Complimentary Food & Drink Voucher","20% Partner Hotel & Dining Discounts","Holographic VIP Commemorative Pass"],ctaText:"Book VIP Pass →",ctaLink:"/tickets"},{id:"platinum",name:"All-Access Platinum",badge:"EXCLUSIVE ALL-ACCESS",price:"PKR 25,000",sub:"Ultimate luxury hospitality package",isFeatured:!1,perks:["Backstage & Artist Lounge Access","Valet Reserved Parking Spot","Gourmet Catering & Open Mocktail Bar","Exclusive Afterparty Invitation","Dedicated Hospitality Concierge","Full Merchandise Gift Bundle"],ctaText:"Reserve Platinum Pass",ctaLink:"/tickets"}],ks=[{badge:"100kW SOUND SYSTEM",title:"4 Mega Sound Stages",desc:"Explosive stage arenas for Indie Pop, Punjabi Rap, Desi Hip-Hop, and non-stop EDM beats."},{badge:"HEADLINE CELEBRITIES",title:"Star-Studded Lineup",desc:"Live stadium sets by Mystery Headliner, Imran Khan, Bohemia, Hassan Raheem, and top artists."},{badge:"CULINARY & NIGHT BAZAAR",title:"Food & Beats Street",desc:"50+ curated gourmet food stalls, wood-fired artisan eats, and craft mocktail lounges."},{badge:"ALL-ACCESS HOSPITALITY",title:"VIP Lounge & Deck Access",desc:"Elevated front-stage viewing decks, private artist lounges, and fast-track VIP gates."}],js=[{name:"OZILLA FEST 2026: The Flagship",date:"November 1, 2026",location:"Lahore, Pakistan",status:"FEATURED FESTIVAL",description:"Flagship festival with 4 mega stages, 20+ star artists, and 10,000+ live crowd."},{name:"Celebrity Night Live Concert",date:"February 2027",location:"Lahore, Pakistan",status:"UPCOMING CONCERT",description:"High-octane stadium night with headline Punjabi artists and 360° laser shows."},{name:"Ozilla Basant Beats Season 2",date:"March 2027",location:"Lahore, Pakistan",status:"SEASONAL FESTIVAL",description:"Cultural music fusion festival with live pop sets, color activations, and street eats."}],Ns=[{name:"Ozilla Season 1: The Bass Awakening",status:"Sold Out · 6,500+ Fans",detail:"Debut open-air music festival in Lahore featuring indie fusion acts and 2 live mega stages."},{name:"Ozilla Season 2: Neon Nights",status:"Sold Out · 8,500+ Fans",detail:"High-energy night festival with headline celebrity acts and artisan night food street."}],Ss=[{name:"Ozilla Debut: The Sound Awakening",year:"2023",badge:"SOLD OUT DEBUT",description:"Historic launch in Lahore uniting 6,000+ fans for live indie music and night market culture.",highlights:["6,000+ Attendees","2 Live Stages","Indie & Desi Fusion"],venue:"Lahore Expo Center",date:"December 12, 2023"},{name:"Ozilla Season 2: Neon Nights",year:"2024",badge:"RECORD 8,500+ CROWD",description:"Season 2 expansion with 4 live stages, celebrity headliners, and 360° laser canopy.",highlights:["8,500+ Fans","4 Live Stages","Celebrity Headliners"],venue:"DHA Sports Complex, Lahore",date:"November 9, 2024"},{name:"Ozilla Basant Cultural Beats",year:"2025",badge:"SPRING FESTIVAL",description:"Seasonal spring music festival with live acoustic sets, DJ arenas, and artisan bazaar.",highlights:["Cultural Sets","Live DJ Stages","Food Hub"],venue:"Gulberg Cultural District, Lahore",date:"March 15, 2025"},{name:"OZILLA FEST 2026 (The Grand Edition)",year:"2026",badge:"FLAGSHIP 10,000+ EDITION",description:"Monumental flagship edition with 4 stages, 20+ star artists, and 100kW laser sound arrays.",highlights:["10,000+ Crowd","4 Mega Stages","Secret Headliner & Imran Khan"],venue:"Lahore, Punjab",date:"November 1, 2026"},{name:"OZILLA FEST 2027: Arena Tour",year:"2027",badge:"NATIONWIDE TOUR",description:"Nationwide arena tour expansion bringing the signature Ozilla concert experience across Pakistan.",highlights:["Arena Tour","Multi-City Stages","Star Acts"],venue:"Lahore, Karachi & Islamabad",date:"November 14, 2027"}],As=[{tier:"Title Sponsor",price:"PREMIUM",badge:"FLAGSHIP PARTNER",accent:"#ffbd59",tagline:"Maximum Brand Dominance",isFeatured:!0,ctaText:"Claim Title Partnership",perks:["Exclusive brand naming rights","Main stage backdrop placement","VIP lounge & deck co-branding","30-second main stage video slot","Dedicated social & press campaigns"]},{tier:"Gold Sponsor",price:"HIGH IMPACT",badge:"STAGE ACTIVATION",accent:"#ff8a3d",tagline:"High-Energy Ground Presence",isFeatured:!1,ctaText:"Become Gold Sponsor",perks:["Exclusive brand activation zone","Perimeter banner placements","Digital festival app features","Influencer co-branding & mentions","On-ground brand booth space"]},{tier:"Silver Sponsor",price:"GROWTH",badge:"BRAND PARTNER",accent:"#cbd5e1",tagline:"Targeted Festival Engagement",isFeatured:!1,ctaText:"Join Silver Tier",perks:["Official festival website branding","Social media shoutouts","Sampling booth at food street","Newsletter sponsor placement","10 complimentary festival passes"]},{tier:"Media Partner",price:"CUSTOM",badge:"BROADCAST & PRESS",accent:"#ec4899",tagline:"Official Media Rights",isFeatured:!1,ctaText:"Apply For Press Pass",perks:["Official media coverage rights","All-access artist press passes","Exclusive backstage interview access","Press release announcement feature","Dedicated creator lounge access"]}],Ps=[{badge:"100kW SOUND ARRAY",title:"Main Concert Arena",desc:"Stadium-grade concert sound arrays, 360° lasers, and cryogenic live jets.",accent:"#ff5a1f"},{badge:"50+ FOOD SPOTS",title:"Food & Beats Street",desc:"50+ night food stalls, wood-fired artisan eats, and gourmet smash burgers.",accent:"#ffbd59"},{badge:"24/7 RAPID CARE",title:"Medical & First Aid Hub",desc:"Fully equipped medical stations and certified paramedic response teams.",accent:"#ef4444"},{badge:"VALET & VIP GATES",title:"Managed VIP Parking",desc:"Fast-track valet lanes and direct express entry for VIP pass holders.",accent:"#f59e0b"},{badge:"CREATOR LIGHTING",title:"Holographic Photo Booths",desc:"Interactive neon backdrops and 360° video spinners for creator moments.",accent:"#ec4899"},{badge:"INCLUSIVE VENUE",title:"Full Venue Accessibility",desc:"Elevated viewing decks, step-free ramps, and on-ground guest assistance.",accent:"#3b82f6"},{badge:"PROFESSIONAL SQUAD",title:"Crowd Safety & Security",desc:"Trained festival security squad, CCTV monitoring, and RFID gate checks.",accent:"#10b981"},{badge:"GIGABIT HIGH-SPEED",title:"Ultra-Fast Festival Wi-Fi",desc:"High-density wireless zones across all stages and food streets.",accent:"#06b6d4"}],Ts=[{value:"10,000+",label:"Music Lovers",sub:"Packed Live Crowd"},{value:"20+",label:"Star Performers",sub:"Celebrity & Indie Acts"},{value:"4",label:"Mega Stages",sub:"Non-stop Beats"},{value:"50+",label:"Food & Stalls",sub:"Culinary & Brand Hub"}];function Es(t){const[a,r]=m.useState(()=>{const s=Math.max(new Date(t)-Date.now(),0);return{days:Math.floor(s/864e5),hours:Math.floor(s/36e5%24),minutes:Math.floor(s/6e4%60),seconds:Math.floor(s/1e3%60)}});return m.useEffect(()=>{const s=setInterval(()=>{const i=Math.max(new Date(t)-Date.now(),0);r({days:Math.floor(i/864e5),hours:Math.floor(i/36e5%24),minutes:Math.floor(i/6e4%60),seconds:Math.floor(i/1e3%60)})},1e3);return()=>clearInterval(s)},[t]),a}function Cs(){const t=Ke(),a=Es("2026-11-01T18:00:00+05:00");return m.useEffect(()=>{const r=t.hash?.replace("#","");r?setTimeout(()=>{const s=document.getElementById(r);s&&s.scrollIntoView({behavior:"smooth",block:"start"})},150):window.scrollTo({top:0,behavior:"smooth"})},[t.hash]),e.jsxs("main",{className:"sp-main",children:[e.jsxs("section",{id:"home",className:"sp-hero","aria-label":"Ozilla Fest",children:[e.jsx(ys,{baseColor:"#ff8a3d",accentColor:"#ffbd59",density:125,speed:46,tilt:7}),e.jsx("div",{className:"sp-hero-ambient-glow"}),e.jsxs("div",{className:"sp-hero-content",children:[e.jsxs(ce.div,{className:"sp-hero-badge",initial:{opacity:0,y:-20,scale:.9},animate:{opacity:1,y:0,scale:1},transition:{duration:.6},children:[e.jsx("span",{children:"✨"}),e.jsx("strong",{children:"OZILLA FEST 2026 · LAHORE"})]}),e.jsx(ce.h1,{className:"sp-hero-title",initial:{opacity:0,y:25},animate:{opacity:1,y:0},transition:{duration:.7,delay:.12},children:"OZILLA FEST"}),e.jsxs(ce.p,{className:"sp-hero-subtitle",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.7,delay:.25},children:[e.jsx("strong",{className:"sp-hero-sub-highlight",children:"Pakistan's Flagship Music & Cultural Phenomenon."}),e.jsx("span",{className:"sp-hero-sub-detail",children:"4 Electrified Mega Stages · Headline Celebrities · High-Octane Sound Under the Lahore Night Sky."})]}),e.jsxs(ce.div,{className:"sp-hero-meta-strip",initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{duration:.6,delay:.4},children:[e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsxs("span",{className:"sp-meta-header",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"DATE"})]}),e.jsx("strong",{children:"NOV 01, 2026"})]}),e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsxs("span",{className:"sp-meta-header",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"CITY"})]}),e.jsx("strong",{children:"LAHORE, PK"})]}),e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsxs("span",{className:"sp-meta-header",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"PRODUCTION"})]}),e.jsx("strong",{children:"4 MEGA STAGES"})]}),e.jsxs("div",{className:"sp-hero-meta-pill sp-meta-featured",children:[e.jsxs("span",{className:"sp-meta-header",children:[e.jsx("span",{className:"sp-meta-dot sp-dot-gold"}),e.jsx("span",{className:"sp-meta-label",children:"PASSES"})]}),e.jsx("strong",{children:"INSTANT QR PASS"})]})]}),e.jsxs(ce.div,{className:"sp-hero-actions",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6,delay:.55},children:[e.jsx(ce.a,{className:"sp-btn-ember",href:"#celebrities",whileHover:{scale:1.04},whileTap:{scale:.97},children:"Explore Lineup ⚡"}),e.jsx(ce.div,{whileHover:{scale:1.04},whileTap:{scale:.97},children:e.jsx(X,{className:"sp-btn-ghost",to:"/tickets",children:"Get VIP Passes 🎟️"})})]})]})]}),e.jsx("section",{className:"festival-stats-strip","aria-label":"Festival Highlights",children:e.jsx("div",{className:"sp-container",children:e.jsx("div",{className:"stats-inner-grid",children:Ts.map((r,s)=>e.jsxs(ce.div,{className:"stat-card",whileHover:{y:-5,scale:1.02},children:[e.jsx("strong",{className:"stat-val",children:r.value}),e.jsx("span",{className:"stat-label",children:r.label}),e.jsx("small",{className:"stat-sub",children:r.sub})]},r.label))})})}),e.jsx("section",{id:"celebrities",className:"sp-section sp-section-celebrities","aria-label":"Celebrities Lineup",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",children:[e.jsx("span",{className:"sp-eyebrow",children:"Live on the Ozilla Stage"}),e.jsx("h2",{className:"sp-section-title",children:"Celebrity Singers & Performers"}),e.jsx("p",{className:"sp-section-subtitle",children:"Four powerhouse headline performers, one premium Lahore festival atmosphere, and an amphitheatre built for unforgettable crowd moments."})]}),e.jsx("div",{className:"sp-celebrity-slider-wrap",style:{margin:"1rem 0 3.5rem 0"},children:e.jsx(Mr,{items:vs,slideWidth:320,slideHeight:440,spacing:2.6,smoothness:2.5,dim:6,sensitivity:8.5,autoPlay:!0,autoPlaySpeed:1.4})}),e.jsxs("div",{className:"sp-countdown-banner",children:[e.jsx("div",{className:"sp-countdown-header",children:e.jsxs("span",{className:"sp-countdown-eyebrow",children:[e.jsx("span",{className:"sp-countdown-pulse"}),"COUNTDOWN TO THE FIRST BEAT DROP"]})}),e.jsx("div",{className:"sp-countdown-grid",children:[["Days",a.days],["Hours",a.hours],["Minutes",a.minutes],["Seconds",a.seconds]].map(([r,s])=>e.jsxs(ce.div,{className:"sp-countdown-card",whileHover:{scale:1.05,y:-4},transition:{type:"spring",stiffness:350},children:[e.jsx("strong",{children:String(s).padStart(2,"0")}),e.jsx("span",{children:r}),e.jsx("div",{className:"sp-countdown-glow-line"})]},r))})]})]})}),e.jsx("section",{id:"vip-experience",className:"sp-section sp-section-pricing","aria-label":"Festival Passes",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",style:{textAlign:"center"},children:[e.jsx("span",{className:"sp-eyebrow",children:"CHOOSE YOUR ACCESS"}),e.jsx("h2",{className:"sp-section-title",children:"Festival Passes & VIP Tiers"}),e.jsx("p",{className:"sp-section-subtitle",style:{margin:"0 auto"},children:"Select your festival experience tier. Instant dynamic QR pass generated upon reservation with guaranteed fast-track admission."})]}),e.jsx("div",{className:"sp-pricing-grid",children:ws.map(r=>e.jsxs(ce.div,{className:`sp-pricing-card ${r.isFeatured?"sp-featured-pricing":""}`,whileHover:{y:-8},children:[r.isFeatured&&e.jsx("div",{className:"sp-pricing-popular-tag",children:"MOST POPULAR ACCESS"}),e.jsxs("div",{className:"sp-pricing-header",children:[e.jsx("span",{className:"sp-tier-badge",children:r.badge}),e.jsx("h3",{children:r.name}),e.jsx("div",{className:"sp-pricing-cost",children:e.jsx("strong",{children:r.price})}),e.jsx("p",{className:"sp-pricing-sub",children:r.sub})]}),e.jsx("div",{className:"sp-pricing-divider"}),e.jsx("ul",{className:"sp-pricing-features",children:r.perks.map(s=>e.jsxs("li",{children:[e.jsx("span",{className:"sp-perk-check",children:"✓"}),e.jsx("span",{children:s})]},s))}),e.jsx(X,{to:r.ctaLink,className:r.isFeatured?"sp-btn-ember w-full":"sp-btn-ghost w-full",style:{textAlign:"center",marginTop:"auto"},children:r.ctaText})]},r.id))})]})}),e.jsx("section",{id:"about",className:"sp-section sp-section-about","aria-label":"About Ozilla",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",children:[e.jsx("span",{className:"sp-eyebrow",children:"⚡ THE ULTIMATE LIVE EXPERIENCE"}),e.jsx("h2",{className:"sp-section-title",children:"The Ozilla Fest Atmosphere"}),e.jsx("p",{className:"sp-section-subtitle",children:"Pakistan's flagship open-air music & cultural festival. 4 electrified stages, 100kW concert sound, headline celebrity acts, gourmet food street, and unmatched crowd energy under the Lahore night sky."})]}),e.jsx("div",{className:"sp-pillars-grid",children:ks.map(r=>e.jsxs(ce.div,{className:"sp-pillar-card",whileHover:{y:-8,scale:1.02},children:[e.jsx("div",{className:"sp-pillar-glow-accent"}),e.jsx("div",{className:"sp-pillar-top",children:e.jsx("span",{className:"sp-pillar-badge",children:r.badge})}),e.jsx("h3",{className:"sp-pillar-title",children:r.title}),e.jsx("p",{className:"sp-pillar-desc",children:r.desc}),e.jsx("div",{className:"sp-pillar-glow-line"})]},r.title))}),e.jsxs("div",{className:"sp-festival-vibe-banner",style:{position:"relative",overflow:"hidden"},children:[e.jsx(tt,{color:"#ff7a29",rounded:32,thickness:2.8,borderSize:50,glow:85}),e.jsxs("div",{className:"sp-vibe-left",style:{position:"relative",zIndex:2},children:[e.jsxs("span",{className:"sp-vibe-eyebrow",children:[e.jsx("span",{className:"sp-countdown-pulse"}),"FESTIVAL HIGHLIGHTS"]}),e.jsx("h3",{children:"What Makes Ozilla Legendary"}),e.jsx("p",{children:"Non-stop beats from golden hour to midnight, surrounded by festival activations and pure music culture."}),e.jsxs("div",{className:"sp-vibe-actions",children:[e.jsx(ce.a,{href:"#celebrities",className:"sp-btn-ember",whileHover:{scale:1.04},whileTap:{scale:.97},children:"Explore Lineup →"}),e.jsx(ce.div,{whileHover:{scale:1.04},whileTap:{scale:.97},children:e.jsx(X,{to:"/tickets",className:"sp-btn-ghost",children:"Book Festival Passes"})})]})]}),e.jsx("div",{className:"sp-vibe-tags-grid",style:{position:"relative",zIndex:2},children:[{text:"4 Mega Music Stages",isMain:!0,icon:"⚡"},{text:"100kW Laser & Sound",isMain:!0,icon:"🔊"},{text:"20+ Star Performers",isMain:!0,icon:"👑"},{text:"Verified QR Instant Passes",isMain:!0,icon:"🎟️"},{text:"10,000+ Music Lovers",isMain:!1,icon:"👥"},{text:"50+ Food & Beats Stalls",isMain:!1,icon:"🍔"},{text:"VIP Artist Lounge & Deck",isMain:!1,icon:"✨"},{text:"Exclusive Partner Discounts",isMain:!1,icon:"🏷️"}].map(r=>e.jsxs(ce.div,{className:`sp-vibe-tag ${r.isMain?"sp-vibe-main":"sp-vibe-secondary"}`,whileHover:{scale:1.03,x:3},whileTap:{scale:.98},children:[e.jsx("span",{className:"sp-vibe-tag-icon",children:r.icon}),e.jsx("span",{className:"sp-vibe-tag-text",children:r.text}),r.isMain&&e.jsx("span",{className:"sp-vibe-tag-dot"})]},r.text))})]})]})}),e.jsx("section",{id:"events",className:"sp-section sp-section-events","aria-label":"Past Events",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",children:[e.jsx("span",{className:"sp-eyebrow",children:"Previous Editions"}),e.jsx("h2",{className:"sp-section-title",children:"Past Festival Milestones"}),e.jsx("p",{className:"sp-section-subtitle",children:"A legacy of sold-out stadium energy, breakthrough artist sets, and unforgettable Lahore nights."})]}),e.jsx("div",{className:"sp-events-grid",children:Ns.map(r=>e.jsxs(ce.div,{className:"sp-glass-card sp-past-event-card",style:{position:"relative",overflow:"hidden"},whileHover:{y:-6},children:[e.jsx(tt,{color:"#ff8a3d",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column",height:"100%"},children:[e.jsxs("div",{className:"sp-card-header",children:[e.jsx("h3",{children:r.name}),e.jsx("span",{className:"sp-pill-badge",children:r.status})]}),e.jsx("p",{className:"sp-card-desc",children:r.detail}),e.jsxs("div",{className:"sp-card-footer-eq",children:[e.jsx("span",{children:"LIVE ARCHIVE"}),e.jsxs("div",{className:"celeb-mini-eq",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})]})]},r.name))})]})}),e.jsx("section",{id:"future-events",className:"sp-section sp-section-future","aria-label":"Upcoming Events",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",children:[e.jsx("span",{className:"sp-eyebrow",children:"Upcoming Concert Tour"}),e.jsx("h2",{className:"sp-section-title",children:"Future Festival Editions"}),e.jsx("p",{className:"sp-section-subtitle",children:"Mark your calendar for upcoming major festival editions, celebrity concert nights, and arena dates."})]}),e.jsx("div",{className:"sp-future-grid",children:js.map(r=>e.jsxs(ce.div,{className:"sp-glass-card sp-future-card",style:{position:"relative",overflow:"hidden"},whileHover:{y:-6},children:[e.jsx(tt,{color:"#ff9e42",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column",height:"100%"},children:[e.jsx("span",{className:"sp-pill-badge",children:r.status}),e.jsx("h3",{style:{marginTop:"0.8rem"},children:r.name}),e.jsxs("p",{className:"sp-meta-text",children:["📍 ",r.date," · ",r.location]}),e.jsx("p",{className:"sp-card-desc",style:{flex:1},children:r.description}),e.jsx(X,{to:"/tickets",className:"sp-accent-link",children:"Get Tickets →"})]})]},r.name))})]})}),e.jsx("section",{id:"history",className:"sp-section sp-section-history","aria-label":"Festival History",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header sp-timeline-banner-header",style:{position:"relative",overflow:"hidden"},children:[e.jsx(tt,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"Festival Legacy"}),e.jsx("h2",{className:"sp-section-title",children:"Our Editions & Timeline"}),e.jsx("p",{className:"sp-section-subtitle",children:"From our underground debut to Pakistan's biggest stadium concert experience."})]})]}),e.jsx("div",{className:"sp-timeline",children:Ss.map(r=>e.jsxs("div",{className:"sp-timeline-item",children:[e.jsxs("div",{className:"sp-timeline-node-wrap",children:[e.jsx("div",{className:"sp-timeline-icon",children:e.jsx("span",{className:"sp-timeline-year-pill",children:r.year})}),e.jsx("div",{className:"sp-timeline-pulse-ring"})]}),e.jsxs("div",{className:"sp-glass-card sp-timeline-content",children:[e.jsxs("div",{className:"sp-timeline-top-row",children:[e.jsx("div",{className:"sp-meta-text",children:e.jsx("span",{className:"sp-year-highlight",children:r.date})}),e.jsx("span",{className:"sp-timeline-badge",children:r.badge})]}),e.jsx("h3",{className:"sp-timeline-heading",children:r.name}),e.jsx("p",{className:"sp-card-desc",children:r.description}),e.jsx("div",{className:"sp-tag-cloud",children:r.highlights.map(s=>e.jsx("span",{className:"sp-tag sp-timeline-tag",children:s},s))}),e.jsxs("div",{className:"sp-timeline-footer",children:[e.jsx("p",{className:"sp-venue-text",children:r.venue}),e.jsxs("div",{className:"celeb-mini-eq",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})]})]},r.name))})]})}),e.jsx("section",{id:"facilities",className:"sp-section sp-section-facilities","aria-label":"Facilities",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header sp-facilities-header-banner",style:{position:"relative",overflow:"hidden"},children:[e.jsx(tt,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"⚡ FESTIVAL VENUE & PRODUCTION"}),e.jsx("h2",{className:"sp-section-title",children:"World-Class Festival Facilities"}),e.jsx("p",{className:"sp-section-subtitle",children:"Built for a seamless 10,000+ attendee experience with concert-grade sound, medical support, VIP hospitality, and creator amenities."})]})]}),e.jsx("div",{className:"sp-facilities-grid",children:Ps.map(r=>e.jsxs(ce.div,{className:"sp-glass-card sp-facility-card",style:{position:"relative",overflow:"hidden"},whileHover:{y:-8,scale:1.02},children:[e.jsx(tt,{color:r.accent||"#ff8a3d",rounded:20,thickness:2.2,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,width:"100%"},children:[e.jsx("div",{className:"sp-facility-top",children:e.jsx("span",{className:"sp-facility-badge",style:{color:r.accent,borderColor:`${r.accent}44`,background:`${r.accent}14`},children:r.badge})}),e.jsx("h3",{className:"sp-facility-title",children:r.title}),e.jsx("p",{className:"sp-card-desc",children:r.desc})]}),e.jsx("div",{className:"sp-facility-glow-bar",style:{background:`linear-gradient(90deg, ${r.accent}, transparent)`}})]},r.title))})]})}),e.jsx("section",{id:"sponsorship",className:"sp-section sp-section-sponsorship","aria-label":"Sponsorships",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header sp-sponsorship-header-banner",style:{position:"relative",overflow:"hidden",textAlign:"center"},children:[e.jsx(tt,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"BRAND COLLABORATIONS"}),e.jsx("h2",{className:"sp-section-title",children:"Sponsorship & Brand Packages"}),e.jsx("p",{className:"sp-section-subtitle",style:{margin:"0 auto"},children:"Partner with Pakistan's biggest live music festival. Gain unparalleled on-ground brand presence, digital engagement, and VIP hospitality."})]})]}),e.jsx("div",{className:"sp-sponsorship-grid",children:As.map(r=>e.jsxs(ce.div,{className:`sp-glass-card sp-sponsor-card ${r.isFeatured?"sp-sponsor-featured":""}`,whileHover:{y:-10,scale:1.02},children:[r.isFeatured&&e.jsx("div",{className:"sp-sponsor-popular-tag",children:"MOST PRESTIGIOUS TIER"}),e.jsx("div",{className:"sp-sponsor-top",children:e.jsx("span",{className:"sp-sponsor-badge",style:{color:r.accent,borderColor:`${r.accent}44`,background:`${r.accent}14`},children:r.badge})}),e.jsxs("div",{className:"sp-sponsor-header",children:[e.jsx("h3",{children:r.tier}),e.jsx("div",{className:"sp-sponsor-price-tag",style:{color:r.accent},children:r.price}),e.jsx("p",{className:"sp-sponsor-tagline",children:r.tagline})]}),e.jsx("div",{className:"sp-sponsor-divider"}),e.jsx("ul",{className:"sp-sponsor-perks",children:r.perks.map(s=>e.jsxs("li",{children:[e.jsx("span",{className:"sp-check",style:{color:r.accent},children:"✓"}),e.jsx("span",{children:s})]},s))}),e.jsx(ce.div,{whileHover:{scale:1.04},whileTap:{scale:.96},style:{marginTop:"auto",paddingTop:"1.2rem"},children:e.jsx(X,{to:"/tickets",className:r.isFeatured?"sp-btn-ember w-full":"sp-btn-ghost w-full",style:{textAlign:"center"},children:r.ctaText})}),e.jsx("div",{className:"sp-sponsor-glow-bottom",style:{background:`linear-gradient(90deg, ${r.accent}, transparent)`}})]},r.tier))})]})}),e.jsx("style",{children:`
        .sp-main {
          --pink-accent:   #EC4899;
          --ember-accent:  #ff5a1f;
          --ember-glow:    #ff8a3d;
      ...
      `})]})}const Fa="ozilla_local_tickets";let Le=!1;const Oa={regular:1200,vip:1,premium:120},Ls=["pending","payment_submitted","approved","confirmed"];function St(t){const a=String(t||"regular").toLowerCase().trim();return a==="general"?"regular":Oa[a]?a:"regular"}function kt(){const t=Object.entries(Oa).reduce((s,[i,l])=>(s[i]={type:i,label:i==="regular"?"General":i==="vip"?"VIP":"Premium",capacity:l,sold:0,remaining:l,soldOut:!1},s),{});for(const s of pe()){if(!Ls.includes(s.status))continue;const i=St(s.ticketType);t[i].sold+=Number(s.quantity)||1}let a=0,r=0;for(const s of Object.values(t))s.sold=Math.min(s.sold,s.capacity),s.remaining=Math.max(0,s.capacity-s.sold),s.soldOut=s.remaining<=0,a+=s.capacity,r+=s.sold;return{capacity:a,sold:r,remaining:Math.max(0,a-r),soldOut:Object.values(t).every(s=>s.soldOut),byType:t,mode:"local-fallback"}}function Rs(t){return!t?.response&&(t?.code==="ERR_NETWORK"||t?.message?.includes("Network Error")||t?.message?.includes("ECONNREFUSED"))}function De(t){return Rs(t)?(Le=!0,!0):!1}function pe(){try{const t=localStorage.getItem(Fa),a=t?JSON.parse(t):[];return Array.isArray(a)?a.map(r=>r?.status==="payment_submitted"?{...r,status:"approved",generatedAt:r.generatedAt||r.updatedAt||new Date().toISOString(),verifiedAt:r.verifiedAt||null}:r):[]}catch{return[]}}function fe(t){localStorage.setItem(Fa,JSON.stringify(t))}function Is(t){const a=String(t||"");if(!a)return null;if(a.startsWith("local."))try{return JSON.parse(atob(a.slice(6)))}catch{return null}const r=a.split(".");if(r.length===3)try{return JSON.parse(atob(r[1]))}catch{return null}return null}function ge(){const t=Is(Ne.getToken());return{userId:String(t?.sub||t?.userId||"").trim(),email:String(t?.email||"").toLowerCase().trim()}}function be(t,a){if(!a?.email&&!a?.userId)return!1;const r=String(t?.ownerEmail||"").toLowerCase().trim(),s=String(t?.ownerId||"").trim(),i=String(t?.email||"").toLowerCase().trim();return r&&a.email?r===a.email:s&&a.userId?s===a.userId:a.email?i===a.email:!1}function at(t={}){const a=`local-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,r=(t?.name||`${t?.firstName||""} ${t?.lastName||""}`).trim()||"Demo User",s={id:"oz2026",name:"OZILLA FEST 2026",date:"2026-11-01",time:"08:00 PM",location:"Lahore"},i=new Date().toISOString(),l=ge(),n=String(t?.email||l?.email||"local@ozillafestival.com").toLowerCase().trim();return{id:a,ticketId:`OZILLA-${a.slice(-8).toUpperCase()}`,uniqueTicketId:`OZILLA-${a.slice(-8).toUpperCase()}`,ownerId:l?.userId||"",ownerEmail:n,fullName:r,name:r,email:n,phone:String(t?.phone||"+923000000000").trim(),idCardNumber:String(t?.idCardNumber||"").trim(),festivalDay:t?.festivalDay==="day2"?"day2":"day1",eventId:s.id,eventName:s.name,eventDate:s.date,eventTime:s.time,location:s.location,ticketType:St(t?.ticketType),quantity:Number(t?.quantity)||1,status:"pending",createdAt:i,updatedAt:i}}const Ae={async getAvailability(){if(Le)return kt();try{return(await ee.get("/tickets/availability")).data}catch(t){if(De(t))return kt();throw t}},async getMyTickets(){if(Le){const t=ge();return pe().filter(a=>be(a,t))}try{return(await ee.get("/tickets/my-tickets")).data}catch(t){if(De(t)){const a=ge();return pe().filter(r=>be(r,a))}throw t}},async requestTicket(t){if(Le){const a=kt(),r=St(t?.ticketType),s=Math.max(1,Math.min(10,Number(t?.quantity)||1)),i=a.byType[r];if(a.soldOut||!i||i.remaining<=0){const o=new Error("Tickets are sold out. The ticket portal is currently locked.");throw o.response={status:409,data:{message:o.message,soldOut:!0,availability:a}},o}if(s>i.remaining){const o=new Error(`Only ${i.remaining} ${i.label} ticket${i.remaining===1?"":"s"} remaining.`);throw o.response={status:409,data:{message:o.message,soldOut:!1,availability:a}},o}const l=pe(),n=at(t);return fe([n,...l]),{...n,ibanNumber:"2205931265594411 (TALAL NASEER)",mode:"local-fallback"}}try{return(await ee.post("/tickets/request",t)).data}catch(a){if(De(a)){const r=kt(),s=St(t?.ticketType),i=Math.max(1,Math.min(10,Number(t?.quantity)||1)),l=r.byType[s];if(r.soldOut||!l||l.remaining<=0){const c=new Error("Tickets are sold out. The ticket portal is currently locked.");throw c.response={status:409,data:{message:c.message,soldOut:!0,availability:r}},c}if(i>l.remaining){const c=new Error(`Only ${l.remaining} ${l.label} ticket${l.remaining===1?"":"s"} remaining.`);throw c.response={status:409,data:{message:c.message,soldOut:!1,availability:r}},c}const n=pe(),o=at(t);return fe([o,...n]),{...o,ibanNumber:"2205931265594411 (TALAL NASEER)",mode:"local-fallback"}}throw a}},async getTicketById(t){if(Le){const a=ge(),r=pe().find(s=>s.id===t&&be(s,a));if(!r){const s=new Error("Ticket not found");throw s.response={data:{message:"Ticket not found"}},s}return r}try{return(await ee.get(`/tickets/view/${t}`)).data}catch(a){if(De(a)){const r=ge(),s=pe().find(i=>i.id===t&&be(i,r));if(!s){const i=new Error("Ticket not found");throw i.response={data:{message:"Ticket not found"}},i}return s}throw a}},async payWithCard(t,a){if(Le){const r=pe(),s=ge(),i=r.findIndex(o=>o.id===t&&be(o,s));if(i===-1){const o=new Error("Ticket not found");throw o.response={data:{message:"Ticket not found"}},o}const l=new Date().toISOString(),n={...r[i],status:"approved",paymentMethod:"card",cardType:a?.cardType||"card",cardLast4:a?.cardLast4||"4242",cardholderName:a?.cardholderName||"",transactionId:`TXN-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:l,generatedAt:l,verifiedAt:null,updatedAt:l};return r[i]=n,fe(r),{message:"Payment processed and ticket generated successfully",ticket:n,mode:"local-fallback"}}try{return(await ee.post(`/tickets/${t}/pay-card`,a)).data}catch{const s=pe(),i=ge();let l=s.findIndex(c=>(c.id===t||c.ticketId===t)&&be(c,i));l===-1&&(l=s.findIndex(c=>c.id===t||c.ticketId===t));const n=new Date().toISOString();let o=null;return l!==-1?(o={...s[l],status:"approved",paymentMethod:"card",cardType:a?.cardType||"card",cardLast4:a?.cardLast4||"4411",cardholderName:a?.cardholderName||"TALAL NASEER",issuingBank:"Mastercard Commercial Bank",payoutAccount:"TALAL NASEER | Mastercard Commercial Bank (2205931265594411)",transactionId:`TXN-CRD-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:n,generatedAt:n,verifiedAt:null,updatedAt:n},s[l]=o,fe(s)):(o={...at({name:a?.cardholderName||"Card Customer",ticketType:"regular",quantity:1}),id:t,ticketId:String(t).startsWith("OZILLA-")?t:`OZILLA-${String(t).slice(-8).toUpperCase()}`,status:"approved",paymentMethod:"card",cardType:a?.cardType||"card",cardLast4:a?.cardLast4||"4411",cardholderName:a?.cardholderName||"TALAL NASEER",issuingBank:"Mastercard Commercial Bank",payoutAccount:"TALAL NASEER | Mastercard Commercial Bank (2205931265594411)",transactionId:`TXN-CRD-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:n,generatedAt:n,verifiedAt:null,updatedAt:n},fe([o,...s])),{message:"Card payment processed and ticket generated successfully",ticket:o,mode:"fallback"}}},async payWithJazzCash(t,a){if(Le){const r=pe(),s=ge();let i=r.findIndex(o=>(o.id===t||o.ticketId===t)&&be(o,s));i===-1&&(i=r.findIndex(o=>o.id===t||o.ticketId===t));const l=new Date().toISOString();let n=null;return i!==-1?(n={...r[i],status:"approved",paymentMethod:"jazzcash",senderPhone:a?.mobileNumber||"",accountTitle:a?.accountTitle||"",cardholderName:a?.accountTitle||"",issuingBank:"JazzCash Mobile Wallet",payoutAccount:"TALAL NASEER (JazzCash: 0300-1234567)",transactionId:`TXN-JC-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:l,generatedAt:l,verifiedAt:null,updatedAt:l},r[i]=n,fe(r)):(n={...at({name:a?.accountTitle||"JazzCash Customer",phone:a?.mobileNumber||"03000000000",ticketType:"regular",quantity:1}),id:t,ticketId:String(t).startsWith("OZILLA-")?t:`OZILLA-${String(t).slice(-8).toUpperCase()}`,status:"approved",paymentMethod:"jazzcash",senderPhone:a?.mobileNumber||"",accountTitle:a?.accountTitle||"",payoutAccount:"TALAL NASEER (JazzCash: 0300-1234567)",transactionId:`TXN-JC-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:l,generatedAt:l,verifiedAt:null,updatedAt:l},fe([n,...r])),{message:"JazzCash payment processed and ticket generated successfully",ticket:n,mode:"local-fallback"}}try{return(await ee.post(`/tickets/${t}/pay-jazzcash`,a)).data}catch{const s=pe(),i=ge();let l=s.findIndex(c=>(c.id===t||c.ticketId===t)&&be(c,i));l===-1&&(l=s.findIndex(c=>c.id===t||c.ticketId===t));const n=new Date().toISOString();let o=null;return l!==-1?(o={...s[l],status:"approved",paymentMethod:"jazzcash",senderPhone:a?.mobileNumber||"",accountTitle:a?.accountTitle||"",cardholderName:a?.accountTitle||"",issuingBank:"JazzCash Mobile Wallet",payoutAccount:"TALAL NASEER (JazzCash: 0300-1234567)",transactionId:`TXN-JC-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:n,generatedAt:n,verifiedAt:null,updatedAt:n},s[l]=o,fe(s)):(o={...at({name:a?.accountTitle||"JazzCash Customer",phone:a?.mobileNumber||"03000000000",ticketType:"regular",quantity:1}),id:t,ticketId:String(t).startsWith("OZILLA-")?t:`OZILLA-${String(t).slice(-8).toUpperCase()}`,status:"approved",paymentMethod:"jazzcash",senderPhone:a?.mobileNumber||"",accountTitle:a?.accountTitle||"",payoutAccount:"TALAL NASEER (JazzCash: 0300-1234567)",transactionId:`TXN-JC-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:n,generatedAt:n,verifiedAt:null,updatedAt:n},fe([o,...s])),{message:"JazzCash payment processed and ticket generated successfully",ticket:o,mode:"fallback"}}},async payWithEasypaisa(t,a){if(Le){const r=pe(),s=ge();let i=r.findIndex(o=>(o.id===t||o.ticketId===t)&&be(o,s));i===-1&&(i=r.findIndex(o=>o.id===t||o.ticketId===t));const l=new Date().toISOString();let n=null;return i!==-1?(n={...r[i],status:"approved",paymentMethod:"easypaisa",senderPhone:a?.mobileNumber||"",accountTitle:a?.accountTitle||"",cardholderName:a?.accountTitle||"",issuingBank:"Easypaisa Mobile Wallet",payoutAccount:"TALAL NASEER (Easypaisa: 0333-1234567)",transactionId:`TXN-EP-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:l,generatedAt:l,verifiedAt:null,updatedAt:l},r[i]=n,fe(r)):(n={...at({name:a?.accountTitle||"Easypaisa Customer",phone:a?.mobileNumber||"03330000000",ticketType:"regular",quantity:1}),id:t,ticketId:String(t).startsWith("OZILLA-")?t:`OZILLA-${String(t).slice(-8).toUpperCase()}`,status:"approved",paymentMethod:"easypaisa",senderPhone:a?.mobileNumber||"",accountTitle:a?.accountTitle||"",payoutAccount:"TALAL NASEER (Easypaisa: 0333-1234567)",transactionId:`TXN-EP-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:l,generatedAt:l,verifiedAt:null,updatedAt:l},fe([n,...r])),{message:"Easypaisa payment processed and ticket generated successfully",ticket:n,mode:"local-fallback"}}try{return(await ee.post(`/tickets/${t}/pay-easypaisa`,a)).data}catch{const s=pe(),i=ge();let l=s.findIndex(c=>(c.id===t||c.ticketId===t)&&be(c,i));l===-1&&(l=s.findIndex(c=>c.id===t||c.ticketId===t));const n=new Date().toISOString();let o=null;return l!==-1?(o={...s[l],status:"approved",paymentMethod:"easypaisa",senderPhone:a?.mobileNumber||"",accountTitle:a?.accountTitle||"",cardholderName:a?.accountTitle||"",issuingBank:"Easypaisa Mobile Wallet",payoutAccount:"TALAL NASEER (Easypaisa: 0333-1234567)",transactionId:`TXN-EP-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:n,generatedAt:n,verifiedAt:null,updatedAt:n},s[l]=o,fe(s)):(o={...at({name:a?.accountTitle||"Easypaisa Customer",phone:a?.mobileNumber||"03330000000",ticketType:"regular",quantity:1}),id:t,ticketId:String(t).startsWith("OZILLA-")?t:`OZILLA-${String(t).slice(-8).toUpperCase()}`,status:"approved",paymentMethod:"easypaisa",senderPhone:a?.mobileNumber||"",accountTitle:a?.accountTitle||"",payoutAccount:"TALAL NASEER (Easypaisa: 0333-1234567)",transactionId:`TXN-EP-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:n,generatedAt:n,verifiedAt:null,updatedAt:n},fe([o,...s])),{message:"Easypaisa payment processed and ticket generated successfully",ticket:o,mode:"fallback"}}},submitHiddenForm(t,a={}){const r=document.createElement("form");r.method="POST",r.action=t,Object.keys(a).forEach(s=>{const i=document.createElement("input");i.type="hidden",i.name=s,i.value=a[s],r.appendChild(i)}),document.body.appendChild(r),r.submit()},async initiateJazzCashCheckout(t,a){try{return(await ee.post(`/tickets/${t}/jazzcash-checkout`,{returnUrl:a})).data}catch(r){if(De(r))return{postUrl:"https://sandbox.jazzcash.com.pk/CustomerPortal/transactionmanagement/merchantform/",payload:{pp_Version:"1.1",pp_TxnType:"MWALLET",pp_Amount:"100",pp_TxnRefNo:`T${Date.now()}`}};throw r}},async initiateEasypaisaCheckout(t,a){try{return(await ee.post(`/tickets/${t}/easypaisa-checkout`,{postBackUrl:a})).data}catch(r){if(De(r))return{postUrl:"https://easypay.easypaisa.com.pk/easypay-service/rest/v4/initiate-ma-transaction",checkoutUrl:`${window.location.origin}/tickets/view/${t}?payment=success`,payload:{orderId:`EP-OZ-${t}`,transactionAmount:"1.0"}};throw r}},async initiatePayFastCheckout(t){if(Le){const a=pe(),r=ge(),s=a.find(i=>i.id===t&&be(i,r));return{message:"PayFast gateway session initiated",ticketId:t,checkout:{basket_id:`OZILLA-${t}-${Date.now().toString().slice(-6)}`,txnamt:String((s?.quantity||1)*1),is_sandbox:!0}}}try{return(await ee.post(`/tickets/${t}/payfast-checkout`)).data}catch(a){if(De(a)){const r=pe(),s=ge(),i=r.find(l=>l.id===t&&be(l,s));return{message:"PayFast gateway session initiated",ticketId:t,checkout:{basket_id:`OZILLA-${t}-${Date.now().toString().slice(-6)}`,txnamt:String((i?.quantity||1)*1),is_sandbox:!0}}}throw a}},async completePayFastGateway(t,a={}){if(Le){const r=pe(),s=ge(),i=r.findIndex(o=>o.id===t&&be(o,s));if(i===-1){const o=new Error("Ticket not found");throw o.response={data:{message:"Ticket not found"}},o}const l=new Date().toISOString(),n={...r[i],status:"approved",paymentMethod:"payfast_gateway",issuingBank:a?.bankName||"PayFast Multi-Channel Gateway",cardholderName:a?.customerName||r[i].fullName,transactionId:`TXN-PF-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:l,generatedAt:l,verifiedAt:null,updatedAt:l};return r[i]=n,fe(r),{message:"PayFast payment completed successfully",ticket:n,mode:"local-fallback"}}try{return(await ee.post("/tickets/payfast-ipn",{ticket_id:t,basket_id:a?.basket_id,transaction_id:`TXN-PF-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,bank_name:a?.bankName||"PayFast Gateway"})).data}catch(r){if(De(r)){const s=pe(),i=ge(),l=s.findIndex(c=>c.id===t&&be(c,i));if(l===-1){const c=new Error("Ticket not found");throw c.response={data:{message:"Ticket not found"}},c}const n=new Date().toISOString(),o={...s[l],status:"approved",paymentMethod:"payfast_gateway",issuingBank:a?.bankName||"PayFast Multi-Channel Gateway",cardholderName:a?.customerName||s[l].fullName,transactionId:`TXN-PF-${Date.now()}-${Math.random().toString(36).slice(2,7).toUpperCase()}`,paidAt:n,generatedAt:n,verifiedAt:null,updatedAt:n};return s[l]=o,fe(s),{message:"PayFast payment completed successfully",ticket:o,mode:"local-fallback"}}throw r}},async uploadPaymentProof(t,a){if(Le){const r=pe(),s=ge(),i=r.findIndex(n=>n.id===t&&be(n,s));if(i===-1){const n=new Error("Ticket not found");throw n.response={data:{message:"Ticket not found"}},n}const l={...r[i],status:"approved",generatedAt:new Date().toISOString(),verifiedAt:null,updatedAt:new Date().toISOString(),paymentProofPath:"local-fallback-proof"};return r[i]=l,fe(r),{message:"Payment proof uploaded and ticket generated successfully",ticket:l,mode:"local-fallback"}}try{return(await ee.post(`/tickets/${t}/payment-proof`,a,{headers:{"Content-Type":"multipart/form-data"}})).data}catch(r){if(De(r)){const s=pe(),i=ge(),l=s.findIndex(o=>o.id===t&&be(o,i));if(l===-1){const o=new Error("Ticket not found");throw o.response={data:{message:"Ticket not found"}},o}const n={...s[l],status:"approved",generatedAt:new Date().toISOString(),verifiedAt:null,updatedAt:new Date().toISOString(),paymentProofPath:"local-fallback-proof"};return s[l]=n,fe(s),{message:"Payment proof uploaded and ticket generated successfully",ticket:n,mode:"local-fallback"}}throw r}},async verifyTicket(t,a){return(await ee.post(`/tickets/${t}/verify`,{qrData:a})).data},async verifyTicketByQr(t){return(await ee.post("/tickets/verify-qr",{qrData:t})).data},async getPendingTicketsAdmin(){return(await ee.get("/tickets/admin/pending")).data},async decideTicketAdmin(t,a){return(await ee.post(`/tickets/admin/${t}/decision`,{decision:a})).data},async cancelTicket(t){if(Le){const a=pe(),r=ge(),s=a.findIndex(n=>n.id===t&&be(n,r));if(s===-1){const n=new Error("Ticket not found");throw n.response={data:{message:"Ticket not found"}},n}const i=a[s];if(!["pending","payment_submitted"].includes(i.status)){const n=new Error(`Ticket cannot be cancelled from status ${i.status}`);throw n.response={data:{message:`Ticket cannot be cancelled from status ${i.status}`}},n}const l={...i,status:"cancelled",updatedAt:new Date().toISOString()};return a[s]=l,fe(a),{message:"Ticket cancelled successfully",ticket:l,mode:"local-fallback"}}try{return(await ee.post(`/tickets/${t}/cancel`)).data}catch(a){if(De(a)){const r=pe(),s=ge(),i=r.findIndex(o=>o.id===t&&be(o,s));if(i===-1){const o=new Error("Ticket not found");throw o.response={data:{message:"Ticket not found"}},o}const l=r[i];if(!["pending","payment_submitted"].includes(l.status)){const o=new Error(`Ticket cannot be cancelled from status ${l.status}`);throw o.response={data:{message:`Ticket cannot be cancelled from status ${l.status}`}},o}const n={...l,status:"cancelled",updatedAt:new Date().toISOString()};return r[i]=n,fe(r),{message:"Ticket cancelled successfully",ticket:n,mode:"local-fallback"}}throw a}}};function Gt(){const[t,a]=m.useState([]),[r,s]=m.useState(!1),[i,l]=m.useState(null),n=m.useCallback(async()=>{s(!0);try{const p=await Ae.getMyTickets();a(p)}catch(p){l(p.message)}finally{s(!1)}},[]),o=m.useCallback(async p=>{s(!0);try{const b=await Ae.requestTicket(p);return await n(),b}catch(b){throw l(b.message),b}finally{s(!1)}},[n]),c=m.useCallback(async p=>{s(!0);try{return await Ae.getTicketById(p)}catch(b){throw l(b.message),b}finally{s(!1)}},[]),g=m.useCallback(async(p,b)=>{s(!0);try{const x=new FormData;x.append("paymentProof",b);const I=await Ae.uploadPaymentProof(p,x);return await n(),I}catch(x){throw l(x.message),x}finally{s(!1)}},[n]),u=m.useCallback(async(p,b)=>{s(!0);try{const x=await Ae.payWithCard(p,b);return await n(),x}catch(x){throw l(x.message),x}finally{s(!1)}},[n]),y=m.useCallback(async(p,b)=>{s(!0);try{const x=await Ae.payWithJazzCash(p,b);return await n(),x}catch(x){throw l(x.message),x}finally{s(!1)}},[n]),k=m.useCallback(async(p,b)=>{s(!0);try{const x=await Ae.payWithEasypaisa(p,b);return await n(),x}catch(x){throw l(x.message),x}finally{s(!1)}},[n]),E=m.useCallback(async p=>{s(!0);try{return await Ae.initiatePayFastCheckout(p)}catch(b){throw l(b.message),b}finally{s(!1)}},[]),w=m.useCallback(async(p,b)=>{s(!0);try{const x=await Ae.completePayFastGateway(p,b);return await n(),x}catch(x){throw l(x.message),x}finally{s(!1)}},[n]);return{tickets:t,loading:r,error:i,fetchMyTickets:n,requestTicket:o,getTicketById:c,payWithCard:u,payWithJazzCash:y,payWithEasypaisa:k,initiatePayFastCheckout:E,completePayFastGateway:w,uploadPaymentProof:g}}const Ft={regular:{label:"General",value:"regular",price:1,seats:"1,200+",benefits:["Festival entry","Food court access","Partner discount offers"]},vip:{label:"VIP",value:"vip",price:15e3,seats:"320",benefits:["Priority entry","Premium seating","Celebrity performance zone"]},premium:{label:"Premium",value:"premium",price:25e3,seats:"120",benefits:["VIP lounge","Premium seating","Festival merchandise"]}};function zs(t=""){const a=String(t).trim().split(/\s+/).filter(Boolean);return a.length===0?{firstName:"",lastName:""}:{firstName:a[0],lastName:a.slice(1).join(" ")}}function Ms({onSubmit:t,loading:a,profileDefaults:r,onBookingChange:s,availability:i,availabilityLoading:l}){const n=m.useMemo(()=>{const C=zs(r?.name);return{firstName:r?.firstName||C.firstName||"",lastName:r?.lastName||C.lastName||"",email:r?.email||"",phone:r?.phone||""}},[r]),[o,c]=m.useState(1),[g,u]=m.useState(""),[y,k]=m.useState({idCardNumber:"",festivalDay:"day1",ticketType:"regular",quantity:1,firstName:"",lastName:"",email:"",phone:""});m.useEffect(()=>{k(C=>({...C,firstName:n.firstName||C.firstName,lastName:n.lastName||C.lastName,email:n.email||C.email,phone:n.phone||C.phone}))},[n]);const E=C=>i?.byType?.[C],w=C=>!!E(C)?.soldOut,p=Ft[y.ticketType],b=E(y.ticketType),x=Number.isFinite(b?.remaining)?b.remaining:null,I=w(y.ticketType),A=Math.max(1,Math.min(10,x||10)),f=Number(y.quantity)||1,d=p.price*f,F=y.ticketType==="premium"?2500:0,B=Math.max(1,d-F),N=`${n.firstName} ${n.lastName}`.trim()||r?.email;m.useEffect(()=>{s?.({ticketType:p.label,day:y.festivalDay==="day1"?"Day 1":"Day 2",quantity:f,subtotal:d,serviceFee:0,discount:F,total:B,benefits:p.benefits})},[F,y.festivalDay,s,f,p,d,B]),m.useEffect(()=>{if(!i?.byType||!I)return;const C=Object.values(Ft).find($=>!w($.value));C&&k($=>({...$,ticketType:C.value,quantity:1}))},[i,I]),m.useEffect(()=>{f>A&&k(C=>({...C,quantity:A}))},[A,f]);const h=C=>{k($=>({...$,[C.target.name]:C.target.value})),C.target.name==="idCardNumber"&&u("")},P=()=>!!(y.firstName&&y.lastName&&y.email&&y.phone),T=()=>{const C=String(y.idCardNumber||"").trim(),$=/^(?:\d{13}|\d{5}-\d{7}-\d{1})$/.test(C);return u($?"":"Use 13 digits or format XXXXX-XXXXXXX-X."),$},R=()=>{o===1&&!P()||o===2&&(I||!T())||c(C=>Math.min(3,C+1))},V=C=>{if(C.preventDefault(),I||!P()||!T()){c(P()?2:1);return}t({...y,quantity:f,name:`${y.firstName} ${y.lastName}`.trim()})},O=()=>{c(1),u(""),k({idCardNumber:"",festivalDay:"day1",ticketType:"regular",quantity:1,firstName:n.firstName||"",lastName:n.lastName||"",email:n.email||"",phone:n.phone||""})};return e.jsxs("form",{onSubmit:V,className:"ticket-wizard-form",children:[e.jsx("div",{className:"ticket-form-stepper","aria-label":"Ticket form steps",children:["Personal Information","Ticket Information","Review & Confirm"].map((C,$)=>e.jsxs("button",{type:"button",className:o===$+1?"is-active":o>$+1?"is-complete":"",onClick:()=>c($+1),children:[e.jsx("span",{children:$+1}),C]},C))}),N&&e.jsxs("div",{className:"ticket-login-chip",children:[e.jsx("span",{children:"OK"}),"Logged in as ",N]}),o===1&&e.jsxs("section",{className:"ticket-form-panel",children:[e.jsxs("div",{className:"ticket-panel-heading",children:[e.jsx("p",{children:"Step 1"}),e.jsx("h3",{children:"Personal Information"})]}),e.jsxs("div",{className:"ticket-input-grid",children:[e.jsxs("label",{className:"ticket-input-wrap",children:[e.jsx("span",{children:"First Name"}),e.jsx("input",{type:"text",name:"firstName",value:y.firstName,onChange:h,required:!0})]}),e.jsxs("label",{className:"ticket-input-wrap",children:[e.jsx("span",{children:"Last Name"}),e.jsx("input",{type:"text",name:"lastName",value:y.lastName,onChange:h,required:!0})]}),e.jsxs("label",{className:"ticket-input-wrap",children:[e.jsx("span",{children:"Email Address"}),e.jsx("input",{type:"email",name:"email",value:y.email,onChange:h,required:!0})]}),e.jsxs("label",{className:"ticket-input-wrap",children:[e.jsx("span",{children:"Phone Number"}),e.jsx("input",{type:"tel",name:"phone",value:y.phone,onChange:h,required:!0})]})]})]}),o===2&&e.jsxs("section",{className:"ticket-form-panel",children:[e.jsxs("div",{className:"ticket-panel-heading",children:[e.jsx("p",{children:"Step 2"}),e.jsx("h3",{children:"Ticket Information"})]}),e.jsx("div",{className:"ticket-option-grid",role:"radiogroup","aria-label":"Ticket type",children:Object.values(Ft).map(C=>{const $=E(C.value),Y=!!$?.soldOut,H=l?"Checking availability...":$?Y?"Sold out":`${$.remaining.toLocaleString()} seats available`:`${C.seats} seats available`;return e.jsxs("button",{type:"button",disabled:Y,"aria-disabled":Y,className:`ticket-option-card ${y.ticketType===C.value?"is-selected":""} ${Y?"is-sold-out":""}`,onClick:()=>{Y||k(M=>({...M,ticketType:C.value,quantity:1}))},children:[e.jsx("span",{children:C.label}),e.jsxs("strong",{children:["PKR ",C.price.toLocaleString()]}),e.jsx("small",{children:H})]},C.value)})}),e.jsxs("div",{className:"ticket-input-grid",children:[e.jsxs("label",{className:"ticket-input-wrap",children:[e.jsx("span",{children:"Festival Day"}),e.jsxs("select",{name:"festivalDay",value:y.festivalDay,onChange:h,required:!0,children:[e.jsx("option",{value:"day1",children:"Day 1 - November 1, 2026"}),e.jsx("option",{value:"day2",children:"Day 2 - November 2, 2026"})]})]}),e.jsxs("label",{className:"ticket-input-wrap",children:[e.jsx("span",{children:"Quantity"}),e.jsx("input",{type:"number",name:"quantity",value:y.quantity,onChange:h,min:"1",max:A,disabled:I,required:!0})]}),e.jsxs("label",{className:"ticket-input-wrap ticket-input-wide",children:[e.jsx("span",{children:"ID Card Number (CNIC / National ID)"}),e.jsx("input",{type:"text",name:"idCardNumber",value:y.idCardNumber,onChange:h,placeholder:"35202-1234567-1",pattern:"(?:\\d{13}|\\d{5}-\\d{7}-\\d{1})",title:"Use 13 digits or format XXXXX-XXXXXXX-X",required:!0}),g&&e.jsx("em",{children:g})]})]})]}),o===3&&e.jsxs("section",{className:"ticket-form-panel",children:[e.jsxs("div",{className:"ticket-panel-heading",children:[e.jsx("p",{children:"Step 3"}),e.jsx("h3",{children:"Review & Confirm"})]}),e.jsxs("div",{className:"ticket-review-layout",children:[e.jsx("div",{className:"ticket-benefit-list",children:p.benefits.map(C=>e.jsx("span",{children:C},C))}),e.jsxs("aside",{className:"ticket-summary-card",children:[e.jsx("h4",{children:"Booking Summary"}),e.jsxs("div",{children:[e.jsx("span",{children:"Ticket Type"}),e.jsx("strong",{children:p.label})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Quantity"}),e.jsx("strong",{children:f})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Price"}),e.jsxs("strong",{children:["PKR ",d.toLocaleString()]})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Processing Fee"}),e.jsx("strong",{style:{color:"#10b981"},children:"Free (PKR 0)"})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Discount"}),e.jsxs("strong",{children:["PKR ",F.toLocaleString()]})]}),e.jsxs("div",{className:"ticket-total",children:[e.jsx("span",{children:"Total"}),e.jsxs("strong",{children:["PKR ",B.toLocaleString()]})]})]})]})]}),e.jsxs("div",{className:"ticket-form-actions",children:[e.jsx("button",{type:"button",onClick:o===1?O:()=>c(C=>C-1),className:"ticket-secondary-button",children:o===1?"Reset":"Back"}),o<3?e.jsx("button",{type:"button",onClick:R,className:"ticket-primary-button",children:"Continue"}):e.jsx("button",{type:"submit",disabled:a,className:"ticket-primary-button ticket-shimmer-button",children:a?"Verifying Details...":"Complete Your Booking"})]})]})}function Fs(t){const a=t.replace(/\D/g,"").slice(0,16),r=a.match(/.{1,4}/g);return r?r.join(" "):a}function Os(t){const a=t.replace(/\D/g,"").slice(0,4);return a.length>=3?`${a.slice(0,2)}/${a.slice(2)}`:a}function Ds(t){const a=t.replace(/\D/g,"");return/^4/.test(a)?"visa":/^(5[1-5]|2[2-7])/.test(a)?"mastercard":/^(62|81)/.test(a)?"unionpay":null}function _s(t){const a=t.replace(/\D/g,""),r=a.slice(0,4);return["5893","4012","5399","4519","4507"].includes(r)?"Meezan Bank":["4116","5241","4214","5488","4027"].includes(r)?"HBL":["4848","5189","4589","5294","4282"].includes(r)?"Bank Alfalah":["4351","5236","4271","5521","4046"].includes(r)?"MCB Bank":["4021","5123","4921","5424"].includes(r)?"Standard Chartered":["4203","5250","4894","5320"].includes(r)?"UBL":["4008","5456","4692","5378"].includes(r)?"Allied Bank":a.length>=6?"Verified Bank":""}function Bs({amount:t,onSubmit:a,loading:r,onBack:s}){const[i,l]=m.useState({cardNumber:"",cardholderName:"",expiryDate:"",cvv:"",saveCard:!0}),[n,o]=m.useState({}),[c,g]=m.useState(!1),[u,y]=m.useState(""),k=Ds(i.cardNumber);_s(i.cardNumber);const E=A=>{const f=Fs(A.target.value);l(d=>({...d,cardNumber:f})),n.cardNumber&&o(d=>({...d,cardNumber:""}))},w=A=>{const f=Os(A.target.value);l(d=>({...d,expiryDate:f})),n.expiryDate&&o(d=>({...d,expiryDate:""}))},p=A=>{const f=A.target.value.replace(/\D/g,"").slice(0,4);l(d=>({...d,cvv:f})),n.cvv&&o(d=>({...d,cvv:""}))},b=A=>{l(f=>({...f,cardholderName:A.target.value})),n.cardholderName&&o(f=>({...f,cardholderName:""}))},x=()=>{const A={},f=i.cardNumber.replace(/\s/g,"");if((!f||f.length<15)&&(A.cardNumber="Please enter a valid 16-digit card number"),i.cardholderName.trim()||(A.cardholderName="Please enter name as shown on card"),!i.expiryDate||i.expiryDate.length<5)A.expiryDate="Enter MM/YY";else{const[d,F]=i.expiryDate.split("/").map(Number);if(d<1||d>12)A.expiryDate="Invalid month (01-12)";else{const B=new Date,N=Number(String(B.getFullYear()).slice(-2)),h=B.getMonth()+1;(F<N||F===N&&d<h)&&(A.expiryDate="Card has expired")}}return(!i.cvv||i.cvv.length<3)&&(A.cvv="Enter 3 or 4 digits"),o(A),Object.keys(A).length===0},I=async A=>{if(A.preventDefault(),!!x()){y("Validating card credentials with bank..."),await new Promise(f=>setTimeout(f,450)),y("Authorizing payment deduction...");try{await a({cardNumber:i.cardNumber.replace(/\s/g,""),cardLast4:i.cardNumber.replace(/\s/g,"").slice(-4),cardholderName:i.cardholderName.trim(),expiryDate:i.expiryDate,cvv:i.cvv,saveCard:i.saveCard,cardType:k||"card"})}finally{y("")}}};return e.jsxs("div",{className:"card-payment-container",children:[e.jsxs("div",{className:"card-brands-row",children:[e.jsx("div",{className:`card-brand-logo mastercard ${k==="mastercard"?"is-active":""}`,title:"Mastercard",children:e.jsxs("svg",{viewBox:"0 0 38 24",width:"44",height:"28","aria-label":"Mastercard",children:[e.jsx("circle",{cx:"14",cy:"12",r:"10",fill:"#EB001B"}),e.jsx("circle",{cx:"24",cy:"12",r:"10",fill:"#F79E1B",fillOpacity:"0.88"})]})}),e.jsx("div",{className:`card-brand-logo visa ${k==="visa"?"is-active":""}`,title:"VISA",children:e.jsx("svg",{viewBox:"0 0 50 20",width:"54",height:"22","aria-label":"VISA",children:e.jsx("text",{x:"2",y:"16",fontFamily:"Arial, Helvetica, sans-serif",fontWeight:"900",fontStyle:"italic",fontSize:"18",fill:"#ffffff",letterSpacing:"1",children:"VISA"})})}),e.jsx("div",{className:`card-brand-logo unionpay ${k==="unionpay"?"is-active":""}`,title:"UnionPay",children:e.jsxs("div",{className:"unionpay-badge",children:[e.jsx("span",{className:"up-red"}),e.jsx("span",{className:"up-blue"}),e.jsx("span",{className:"up-green"}),e.jsx("span",{className:"up-text",children:"UnionPay"})]})})]}),e.jsxs("form",{onSubmit:I,className:"card-payment-form",children:[e.jsxs("div",{className:"card-field-group",children:[e.jsxs("label",{className:"card-field-label",children:[e.jsx("span",{className:"required-star",children:"*"})," Card number"]}),e.jsxs("div",{className:"card-input-wrapper",children:[e.jsx("input",{type:"text",inputMode:"numeric",autoComplete:"cc-number",placeholder:"4000 1234 5678 9010",value:i.cardNumber,onChange:E,className:`card-input ${n.cardNumber?"has-error":""}`,maxLength:19,disabled:r}),k&&e.jsx("span",{className:"card-detected-badge",children:k.toUpperCase()})]}),n.cardNumber&&e.jsx("span",{className:"card-field-error",children:n.cardNumber})]}),e.jsxs("div",{className:"card-field-group",children:[e.jsxs("label",{className:"card-field-label",children:[e.jsx("span",{className:"required-star",children:"*"})," Name on card"]}),e.jsx("input",{type:"text",autoComplete:"cc-name",placeholder:"e.g. HAMZA ALI",value:i.cardholderName,onChange:b,className:`card-input ${n.cardholderName?"has-error":""}`,disabled:r}),n.cardholderName&&e.jsx("span",{className:"card-field-error",children:n.cardholderName})]}),e.jsxs("div",{className:"card-row-two-col",children:[e.jsxs("div",{className:"card-field-group",children:[e.jsxs("label",{className:"card-field-label",children:[e.jsx("span",{className:"required-star",children:"*"})," Expiry date"]}),e.jsx("input",{type:"text",inputMode:"numeric",autoComplete:"cc-exp",placeholder:"MM/YY",value:i.expiryDate,onChange:w,className:`card-input ${n.expiryDate?"has-error":""}`,maxLength:5,disabled:r}),n.expiryDate&&e.jsx("span",{className:"card-field-error",children:n.expiryDate})]}),e.jsxs("div",{className:"card-field-group",children:[e.jsxs("label",{className:"card-field-label",children:[e.jsx("span",{className:"required-star",children:"*"})," CVV",e.jsx("button",{type:"button",className:"cvv-info-btn",onClick:()=>g(!c),onMouseEnter:()=>g(!0),onMouseLeave:()=>g(!1),"aria-label":"CVV information",children:"ⓘ"}),c&&e.jsx("div",{className:"cvv-tooltip",children:"3 or 4 digit security code located on the back of your card."})]}),e.jsx("input",{type:"password",inputMode:"numeric",autoComplete:"cc-csc",placeholder:"•••",value:i.cvv,onChange:p,className:`card-input ${n.cvv?"has-error":""}`,maxLength:4,disabled:r}),n.cvv&&e.jsx("span",{className:"card-field-error",children:n.cvv})]})]}),e.jsxs("div",{className:"save-card-wrapper",children:[e.jsxs("label",{className:"save-card-checkbox-label",children:[e.jsx("input",{type:"checkbox",checked:i.saveCard,onChange:A=>l(f=>({...f,saveCard:A.target.checked})),className:"save-card-checkbox",disabled:r}),e.jsx("span",{className:"save-card-title",children:"Save Card for Express Rebooking"})]}),e.jsx("p",{className:"save-card-subtext",children:"Card details are encrypted with bank-grade 256-bit tokenization for your security."})]}),u&&e.jsxs("div",{className:"card-processing-status",children:[e.jsx("span",{className:"card-spinner"}),e.jsx("span",{children:u})]}),e.jsxs("div",{className:"card-actions-row",children:[s&&e.jsx("button",{type:"button",onClick:s,disabled:r,className:"ticket-secondary-button",children:"Back"}),e.jsx("button",{type:"submit",disabled:r,className:"pay-now-btn",children:r?e.jsxs("span",{className:"btn-loading-content",children:[e.jsx("span",{className:"btn-spinner"})," Processing Payment..."]}):t?`Pay Now • PKR ${t.toLocaleString()}`:"Pay Now"})]}),e.jsxs("div",{className:"card-security-footer",children:[e.jsx("span",{children:"🔒 256-Bit SSL Encrypted & PCI-DSS Compliant"}),e.jsx("span",{children:"⚡ Instant Verified QR Pass Delivery"})]})]}),e.jsx("style",{children:`
      ...
      `})]})}function $s(t){const a=t.replace(/\D/g,"").slice(0,11);return a.length>4?`${a.slice(0,4)}-${a.slice(4)}`:a}function Hs({amount:t,onSubmit:a,loading:r,onBack:s}){const[i,l]=m.useState({mobileNumber:"",accountTitle:""}),[n,o]=m.useState({}),[c,g]=m.useState(""),u=w=>{const p=$s(w.target.value);l(b=>({...b,mobileNumber:p})),n.mobileNumber&&o(b=>({...b,mobileNumber:""}))},y=w=>{l(p=>({...p,accountTitle:w.target.value})),n.accountTitle&&o(p=>({...p,accountTitle:""}))},k=()=>{const w={},p=i.mobileNumber.replace(/\D/g,"");return(!p||p.length<11||!p.startsWith("03"))&&(w.mobileNumber="Please enter a valid 11-digit JazzCash number (e.g., 0300-1234567)"),i.accountTitle.trim()||(w.accountTitle="Please enter the title/name registered with this JazzCash account"),o(w),Object.keys(w).length===0},E=async w=>{if(w.preventDefault(),!!k()){g("Connecting to JazzCash Secure Gateway..."),await new Promise(p=>setTimeout(p,450)),g("Validating JazzCash wallet balance & credentials..."),await new Promise(p=>setTimeout(p,450)),g(`Authorizing deduction of PKR ${t.toLocaleString()}...`);try{await a({mobileNumber:i.mobileNumber.replace(/\D/g,""),accountTitle:i.accountTitle.trim()})}finally{g("")}}};return e.jsxs("div",{className:"jazzcash-payment-container",children:[e.jsxs("div",{className:"jazzcash-header-badge",children:[e.jsx("div",{className:"jc-logo-circle",children:"JC"}),e.jsxs("div",{children:[e.jsx("h4",{children:"JazzCash Direct Wallet"}),e.jsx("span",{children:"Automatic instant deduction from your mobile wallet"})]})]}),e.jsxs("form",{onSubmit:E,className:"jazzcash-payment-form",children:[e.jsxs("div",{className:"jc-field-group",children:[e.jsxs("label",{className:"jc-field-label",children:[e.jsx("span",{className:"required-star",children:"*"})," JazzCash Mobile Account Number"]}),e.jsx("input",{type:"tel",inputMode:"numeric",placeholder:"0300-1234567",value:i.mobileNumber,onChange:u,className:`jc-input ${n.mobileNumber?"has-error":""}`,maxLength:12,disabled:r}),n.mobileNumber&&e.jsx("span",{className:"jc-field-error",children:n.mobileNumber})]}),e.jsxs("div",{className:"jc-field-group",children:[e.jsxs("label",{className:"jc-field-label",children:[e.jsx("span",{className:"required-star",children:"*"})," Account Title / Registered Name"]}),e.jsx("input",{type:"text",placeholder:"e.g. HAMZA ALI",value:i.accountTitle,onChange:y,className:`jc-input ${n.accountTitle?"has-error":""}`,disabled:r}),n.accountTitle&&e.jsx("span",{className:"jc-field-error",children:n.accountTitle})]}),c&&e.jsxs("div",{className:"jc-processing-status",children:[e.jsx("span",{className:"jc-spinner"}),e.jsx("span",{children:c})]}),e.jsxs("div",{className:"jc-actions-row",children:[s&&e.jsx("button",{type:"button",onClick:s,disabled:r,className:"ticket-secondary-button",children:"Back"}),e.jsx("button",{type:"submit",disabled:r,className:"jc-pay-now-btn",children:r?e.jsxs("span",{className:"btn-loading-content",children:[e.jsx("span",{className:"btn-spinner"})," Processing JazzCash Payment..."]}):t?`Pay with JazzCash • PKR ${t.toLocaleString()}`:"Pay with JazzCash"})]}),e.jsxs("div",{className:"jc-security-footer",children:[e.jsx("span",{children:"🔒 256-Bit SSL Encrypted JazzCash API Integration"}),e.jsx("span",{children:"⚡ Instant Digital QR Ticket Generated"})]})]}),e.jsx("style",{children:`
      ...
      `})]})}function Vs({isOpen:t,onClose:a,ticket:r,amount:s,onComplete:i}){const[l,n]=m.useState("card"),[o,c]=m.useState(!1),[g,u]=m.useState(""),[y,k]=m.useState(!1),[E,w]=m.useState("849201"),[p,b]=m.useState({cardNumber:"5893 4100 8821 9402",expiry:"08/28",cvv:"921",holderName:r?.fullName||"Customer"}),[x,I]=m.useState(r?.phone||"03001234567");if(!t)return null;const A=async d=>{d.preventDefault(),c(!0),u("Connecting to SBP 1LINK switch..."),await new Promise(F=>setTimeout(F,600)),u("Sending 3D Secure OTP verification request to issuing bank..."),await new Promise(F=>setTimeout(F,600)),c(!1),k(!0)},f=async()=>{c(!0),u("Verifying OTP with issuing bank..."),await new Promise(d=>setTimeout(d,700)),u(`Deducting PKR ${Number(s||0).toLocaleString()} and settling to Organizer Bank Account...`),await new Promise(d=>setTimeout(d,800)),u("Payment Successful! Sending IPN webhook to OZILLA FEST..."),await new Promise(d=>setTimeout(d,600));try{await i({basket_id:`OZILLA-${r?.id||r?.ticketId}`,bankName:l==="card"?"Meezan Bank 1LINK":l==="jazzcash"?"JazzCash MWallet":"Easypaisa MAccount",customerName:r?.fullName||p.holderName})}finally{c(!1)}};return e.jsxs("div",{className:"pf-modal-overlay",children:[e.jsxs("div",{className:"pf-modal-container",children:[e.jsxs("div",{className:"pf-modal-header",children:[e.jsxs("div",{className:"pf-modal-brand",children:[e.jsx("span",{className:"pf-logo",children:"PayFast"}),e.jsx("span",{className:"pf-tagline",children:"Secure Multi-Channel IPG"})]}),e.jsx("button",{type:"button",className:"pf-close-btn",onClick:a,disabled:o,children:"✕"})]}),e.jsxs("div",{className:"pf-merchant-banner",children:[e.jsxs("div",{children:[e.jsx("small",{children:"Merchant"}),e.jsx("strong",{children:"Prism Events & Tours (OZILLA FEST 2026)"})]}),e.jsxs("div",{className:"pf-amount-pill",children:[e.jsx("small",{children:"Total Due"}),e.jsxs("strong",{children:["PKR ",Number(s||0).toLocaleString()]})]})]}),e.jsx("div",{className:"pf-modal-body",children:y?e.jsxs("div",{className:"pf-otp-screen",children:[e.jsx("div",{className:"pf-otp-icon",children:"🔐"}),e.jsx("h3",{children:"3D Secure Bank OTP Verification"}),e.jsxs("p",{children:["A one-time verification code has been sent to your bank-registered mobile number ending in ",e.jsx("strong",{children:"•••• 402"}),"."]}),e.jsx("div",{className:"pf-fg",style:{maxWidth:"240px",margin:"16px auto"},children:e.jsx("input",{type:"text",maxLength:6,value:E,onChange:d=>w(d.target.value),className:"pf-otp-input",style:{textAlign:"center",fontSize:"22px",letterSpacing:"4px",fontWeight:"bold"}})}),g&&e.jsx("div",{className:"pf-phase-msg",children:g}),e.jsx("button",{type:"button",className:"pf-modal-submit",onClick:f,disabled:o,children:o?g:"Confirm & Authorize Payment"})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"pf-modal-tabs",children:[e.jsx("button",{type:"button",className:`pf-tab ${l==="card"?"is-active":""}`,onClick:()=>n("card"),children:"💳 Debit / Credit Card"}),e.jsx("button",{type:"button",className:`pf-tab ${l==="jazzcash"?"is-active":""}`,onClick:()=>n("jazzcash"),children:"🟠 JazzCash"}),e.jsx("button",{type:"button",className:`pf-tab ${l==="easypaisa"?"is-active":""}`,onClick:()=>n("easypaisa"),children:"🟢 Easypaisa"})]}),l==="card"&&e.jsxs("form",{onSubmit:A,className:"pf-modal-form",children:[e.jsxs("div",{className:"pf-fg",children:[e.jsx("label",{children:"Card Number"}),e.jsx("input",{type:"text",value:p.cardNumber,onChange:d=>b({...p,cardNumber:d.target.value}),required:!0})]}),e.jsxs("div",{className:"pf-grid-2",children:[e.jsxs("div",{className:"pf-fg",children:[e.jsx("label",{children:"Expiry (MM/YY)"}),e.jsx("input",{type:"text",value:p.expiry,onChange:d=>b({...p,expiry:d.target.value}),required:!0})]}),e.jsxs("div",{className:"pf-fg",children:[e.jsx("label",{children:"CVV / CVC"}),e.jsx("input",{type:"password",maxLength:4,value:p.cvv,onChange:d=>b({...p,cvv:d.target.value}),required:!0})]})]}),e.jsxs("div",{className:"pf-fg",children:[e.jsx("label",{children:"Cardholder Name"}),e.jsx("input",{type:"text",value:p.holderName,onChange:d=>b({...p,holderName:d.target.value}),required:!0})]}),g&&e.jsx("div",{className:"pf-phase-msg",children:g}),e.jsx("button",{type:"submit",className:"pf-modal-submit",disabled:o,children:o?"Connecting...":`Pay PKR ${Number(s||0).toLocaleString()} via PayFast`})]}),(l==="jazzcash"||l==="easypaisa")&&e.jsxs("form",{onSubmit:A,className:"pf-modal-form",children:[e.jsxs("div",{className:"pf-fg",children:[e.jsx("label",{children:l==="jazzcash"?"JazzCash Mobile Number":"Easypaisa Mobile Number"}),e.jsx("input",{type:"text",value:x,onChange:d=>I(d.target.value),placeholder:"0300-1234567",required:!0})]}),e.jsxs("div",{className:"pf-fg",children:[e.jsx("label",{children:"Account Title"}),e.jsx("input",{type:"text",value:p.holderName,onChange:d=>b({...p,holderName:d.target.value}),required:!0})]}),g&&e.jsx("div",{className:"pf-phase-msg",children:g}),e.jsx("button",{type:"submit",className:"pf-modal-submit",disabled:o,children:o?"Connecting...":`Authenticate & Pay PKR ${Number(s||0).toLocaleString()}`})]})]})}),e.jsx("div",{className:"pf-modal-footer",children:e.jsx("span",{children:"🔒 256-Bit Encrypted Secure Connection · PCI-DSS Compliant"})})]}),e.jsx("style",{children:`
        .pf-modal-overlay {
          position: fixed;
      ...
      `})]})}function Wt({type:t,message:a,onClose:r}){const s={success:"bg-green-100 border-green-500 text-green-700",error:"bg-red-100 border-red-500 text-red-700",warning:"bg-yellow-100 border-yellow-500 text-yellow-700",info:"bg-blue-100 border-blue-500 text-blue-700"}[t]||"bg-gray-100 border-gray-500 text-gray-700";return e.jsxs("div",{className:`${s} border-l-4 p-4 rounded mb-4 flex justify-between items-center`,children:[e.jsx("p",{children:a}),r&&e.jsx("button",{onClick:r,className:"ml-4 font-bold hover:opacity-75",children:"×"})]})}const qs=["Personal Info","Ticket Details","Payment Checkout","QR Pass"],Xs={ticketType:"General",day:"Day 1",quantity:1,subtotal:1,serviceFee:0,discount:0,total:1,benefits:["Festival entry","Food court access","Partner discount offers"]};function Zs(){const t=ct(),{user:a}=Je(),{requestTicket:r,payWithCard:s,payWithJazzCash:i,payWithEasypaisa:l,initiatePayFastCheckout:n,completePayFastGateway:o,loading:c}=Gt(),[g,u]=m.useState(null),[y,k]=m.useState(!1),[E,w]=m.useState("payfast"),[p,b]=m.useState(null),[x,I]=m.useState(!1),[A,f]=m.useState(Xs),[d,F]=m.useState(null),[B,N]=m.useState(!0),h=y?3:2;`${a?.firstName||""} ${a?.lastName||""}`.trim()||a?.name||a?.email;const P=!!d?.soldOut;m.useEffect(()=>{let H=!0;return(async()=>{N(!0);try{const D=await Ae.getAvailability();if(!H)return;F(D),D?.soldOut&&u({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."})}catch{H&&F(null)}finally{H&&N(!1)}})(),()=>{H=!1}},[]);const T=()=>{if(P){u({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."});return}t(`/login?returnTo=${encodeURIComponent("/tickets")}`)},R=async H=>{if(P){u({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."});return}try{const M=await r(H);b(M),k(!0),u({type:"success",message:"Ticket reserved! Please complete payment below."});const D=await Ae.getAvailability().catch(()=>null);D&&F(D)}catch(M){const D=M?.response?.data?.message||M?.message||"Failed to request ticket. Please try again.";M?.response?.data?.availability&&F(M.response.data.availability),u({type:"error",message:D})}},V=async H=>{if(!p?.id){u({type:"error",message:"Ticket session expired. Please retry."});return}try{await s(p.id,H),u({type:"success",message:`Payment of PKR ${A.total.toLocaleString()} successful! Your QR pass is ready.`}),t(`/tickets/view/${p.id}`)}catch(M){const D=M?.response?.data?.message||M?.message||"Failed to process card payment.";u({type:"error",message:D})}},O=async H=>{if(!p?.id){u({type:"error",message:"Ticket session expired. Please retry."});return}try{await i(p.id,H),u({type:"success",message:"JazzCash payment successful! Your QR pass is ready."}),t(`/tickets/view/${p.id}`)}catch(M){const D=M?.response?.data?.message||M?.message||"Failed to process JazzCash payment.";u({type:"error",message:D})}},C=async H=>{if(!p?.id){u({type:"error",message:"Ticket session expired. Please retry."});return}try{await l(p.id,H),u({type:"success",message:"Easypaisa payment successful! Your QR pass is ready."}),t(`/tickets/view/${p.id}`)}catch(M){const D=M?.response?.data?.message||M?.message||"Failed to process Easypaisa payment.";u({type:"error",message:D})}},$=async()=>{if(!p?.id){u({type:"error",message:"Ticket session expired. Please retry."});return}try{await n(p.id),I(!0)}catch(H){u({type:"error",message:H?.response?.data?.message||H?.message||"Failed to initiate PayFast session."})}},Y=async H=>{if(p?.id)try{await o(p.id,H),I(!1),u({type:"success",message:`PayFast payment of PKR ${A.total.toLocaleString()} confirmed! Official QR pass generated.`}),t(`/tickets/view/${p.id}?payment=success`)}catch(M){u({type:"error",message:M?.response?.data?.message||M?.message||"Failed to verify PayFast transaction."})}};return e.jsxs("main",{className:"ticket-portal-clean",children:[e.jsxs("section",{className:"ticket-clean-hero",children:[e.jsx(Ut,{nodeColor:"#EC4899",lineColor:"236, 72, 153",secondaryColor:"255, 90, 31",maxDistance:140,speed:.5}),e.jsx("div",{className:"hero-glow-blob"}),e.jsxs("div",{className:"ticket-clean-hero-content",children:[e.jsx("span",{className:"hero-eyebrow",children:"OZILLA FEST 2026"}),e.jsx("h1",{className:"hero-title",children:"Book Your Festival Passes"}),e.jsx("p",{className:"hero-subtitle",children:"Instant digital QR pass with access to 4 live stages, headline artists, and VIP amenities in Lahore."}),e.jsxs("div",{className:"hero-tags",children:[e.jsx("span",{children:"📅 Nov 01, 2026"}),e.jsx("span",{children:"📍 Lahore"}),e.jsx("span",{children:"⚡ Instant QR Pass"})]})]})]}),e.jsxs("section",{className:"ticket-clean-shell",children:[g&&e.jsx(Wt,{type:g.type,message:g.message,onClose:()=>u(null)}),e.jsx("div",{className:"ticket-clean-stepper",children:qs.map((H,M)=>e.jsxs("div",{className:`step-item ${M+1<=h?"is-active":""}`,children:[e.jsx("span",{className:"step-num",children:M+1}),e.jsx("span",{className:"step-text",children:H})]},H))}),P?e.jsxs("div",{className:"ticket-sold-out-box",style:{background:"linear-gradient(135deg, rgba(239, 68, 68, 0.15) 0%, rgba(30, 10, 15, 0.95) 100%)",border:"2px solid #ef4444",borderRadius:"24px",padding:"48px 24px",textAlign:"center",boxShadow:"0 20px 50px rgba(239, 68, 68, 0.25)",margin:"20px 0 40px"},children:[e.jsx("div",{style:{display:"inline-flex",alignItems:"center",gap:"8px",background:"#ef4444",color:"#ffffff",padding:"6px 16px",borderRadius:"9999px",fontSize:"13px",fontWeight:"800",letterSpacing:"2px",textTransform:"uppercase",marginBottom:"16px"},children:"🔒 PORTAL LOCKED"}),e.jsx("h2",{style:{fontSize:"clamp(26px, 5vw, 40px)",fontWeight:"900",color:"#ffffff",margin:"0 0 12px"},children:"Tickets Are Officially Sold Out!"}),e.jsxs("p",{style:{color:"#d1d5db",maxWidth:"600px",margin:"0 auto 24px",fontSize:"16px",lineHeight:"1.6"},children:["All General, VIP, and Premium passes for ",e.jsx("strong",{children:"OZILLA FEST 2026"})," have been fully booked. The ticket booking system is locked to prevent overbooking."]}),e.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:"14px",flexWrap:"wrap"},children:[e.jsx("button",{type:"button",onClick:()=>t("/#sponsorship"),style:{background:"linear-gradient(135deg, #d4af37 0%, #aa8420 100%)",color:"#111827",padding:"12px 28px",borderRadius:"12px",fontWeight:"700",fontSize:"14px",border:"none",cursor:"pointer"},children:"Inquire Corporate / Sponsor Passes"}),e.jsx("button",{type:"button",onClick:()=>t("/schedule"),style:{background:"rgba(255,255,255,0.08)",color:"#ffffff",border:"1px solid rgba(255,255,255,0.2)",padding:"12px 24px",borderRadius:"12px",fontWeight:"600",fontSize:"14px",cursor:"pointer"},children:"View Festival Schedule"})]})]}):a?e.jsxs("div",{className:"ticket-main-grid",children:[e.jsxs("div",{className:"ticket-form-card",children:[e.jsxs("div",{className:"ticket-form-header",children:[e.jsx("h2",{children:y?"Payment Checkout":"Pass Reservation"}),e.jsx("span",{className:"ticket-badge-pill",children:"Official Portal"})]}),y?e.jsxs("div",{className:"ticket-payment-wrapper",children:[e.jsx(Ys,{activeMethod:E,onSelectMethod:w}),E==="payfast"&&e.jsx(Ws,{amount:A.total,onProceed:$,loading:c,onBack:()=>k(!1)}),E==="card"&&e.jsx(Bs,{amount:A.total,onSubmit:V,loading:c,onBack:()=>k(!1)}),E==="jazzcash"&&e.jsx(Hs,{amount:A.total,onSubmit:O,loading:c,onBack:()=>k(!1)}),E==="easypaisa"&&e.jsx(Gs,{amount:A.total,onSubmit:C,loading:c,onBack:()=>k(!1)})]}):e.jsx(Ms,{onSubmit:R,loading:c,profileDefaults:a,onBookingChange:f,availability:d,availabilityLoading:B})]}),e.jsx(Vs,{isOpen:x,onClose:()=>I(!1),ticket:p,amount:A.total,onComplete:Y}),e.jsx("aside",{className:"ticket-sidebar",children:e.jsxs("div",{className:"ticket-sidebar-summary",children:[e.jsx("h3",{children:"Order Summary"}),e.jsxs("div",{className:"summary-pass-type",children:[e.jsxs("strong",{children:[A.ticketType," Pass"]}),e.jsx("span",{children:A.day})]}),e.jsxs("div",{className:"summary-rows",children:[e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Quantity"}),e.jsx("strong",{children:A.quantity})]}),e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Price"}),e.jsxs("strong",{children:["PKR ",A.subtotal.toLocaleString()]})]}),e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Fee"}),e.jsx("strong",{style:{color:"#10b981"},children:"Free (PKR 0)"})]}),A.discount>0&&e.jsxs("div",{className:"summary-row summary-discount",children:[e.jsx("span",{children:"Discount"}),e.jsxs("strong",{children:["- PKR ",A.discount.toLocaleString()]})]})]}),e.jsxs("div",{className:"summary-total-row",children:[e.jsx("span",{children:"Grand Total"}),e.jsxs("strong",{children:["PKR ",A.total.toLocaleString()]})]}),e.jsx("div",{className:"summary-pass-badge",children:e.jsx("span",{children:"🎟️ Verified Digital QR Pass"})})]})})]}):e.jsxs("div",{className:"ticket-auth-prompt",children:[e.jsxs("div",{children:[e.jsx("h2",{children:"Sign in to Book Passes"}),e.jsx("p",{children:"Secure ticket purchasing requires an account for verified QR pass generation."})]}),e.jsx("button",{type:"button",onClick:T,className:"ticket-primary-button",children:"Sign In to Continue →"})]})]}),e.jsx("style",{children:`
        .ticket-portal-clean {
          position: relative;
          min-height: 100vh;
          padding: 0 0 3rem;
      ...
      `})]})}function ii(){const{ticketId:t}=Sa(),{getTicketById:a}=Gt(),[r,s]=m.useState(null),[i,l]=m.useState(!0),[n,o]=m.useState(!1),[c,g]=m.useState(null),u=r?.status==="approved",y=["pending","payment_submitted"].includes(r?.status);if(m.useEffect(()=>{(async()=>{try{const w=await a(t);s(w)}catch{s(null)}finally{l(!1)}})()},[t,a]),i)return e.jsx(Ra,{});if(!r)return e.jsx("div",{className:"bg-[#1b110b]/80 border border-white/10 rounded-2xl p-8 text-center max-w-2xl mx-auto my-12 backdrop-blur-xl",children:e.jsx("p",{className:"text-white/80 font-bold text-lg",children:"Ticket not found."})});const k=async()=>{o(!0),g(null);try{const E=await Ae.cancelTicket(r.id);s(E.ticket),g({type:"success",message:E.message||"Ticket cancelled successfully."})}catch(E){g({type:"error",message:E.response?.data?.message||"Failed to cancel ticket."})}finally{o(!1)}};return e.jsxs("div",{className:"max-w-5xl mx-auto px-4 py-8",children:[e.jsx("div",{className:"flex items-center justify-between gap-3 mb-6",children:e.jsxs("div",{children:[e.jsx("span",{className:"text-[#ffbd59] text-xs font-black uppercase tracking-widest block mb-1",children:"OFFICIAL DIGITAL PASS"}),e.jsx("h1",{className:"text-3xl sm:text-4xl font-black text-white font-['Outfit',sans-serif]",children:"Your Festival Pass"}),e.jsx("p",{className:"text-sm text-white/70 mt-1",children:"Official digital entry pass with scannable QR badge"})]})}),c&&e.jsx(Wt,{type:c.type,message:c.message,onClose:()=>g(null)}),e.jsxs("div",{className:"grid grid-cols-1 gap-8",children:[e.jsx(Da,{ticket:r,actionTo:"/tickets/my-tickets",actionLabel:"My Tickets Wallet"}),e.jsxs("div",{className:"bg-[#1b110b]/75 rounded-2xl border border-white/10 shadow-2xl p-6 sm:p-8 backdrop-blur-xl",children:[y&&e.jsx("button",{type:"button",className:"mb-4 bg-rose-600/20 border border-rose-500/40 text-rose-300 px-5 py-2.5 rounded-xl font-bold hover:bg-rose-600/30 transition-colors",onClick:k,disabled:n,children:n?"Cancelling...":"Cancel Ticket Request"}),u?e.jsxs("div",{className:"p-5 bg-emerald-500/10 border border-emerald-500/30 rounded-xl",children:[e.jsx("h2",{className:"text-lg font-bold text-emerald-300 mb-1",children:"Official Pass Ready"}),e.jsxs("p",{className:"text-emerald-200/80 text-sm",children:["Your ticket pass has been verified and the scannable QR badge is active. Click ",e.jsx("strong",{children:"Download Pass"})," above to save the pass image to your device."]})]}):e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-bold text-white mb-2 font-['Outfit',sans-serif]",children:"Verification In Progress"}),e.jsxs("div",{className:"bg-amber-500/10 border border-amber-500/30 rounded-xl p-5",children:[e.jsx("p",{className:"text-amber-300 font-semibold mb-1",children:"Pass verification pending admin approval."}),e.jsx("p",{className:"text-amber-200/80 text-sm",children:"Your scannable QR code and downloadable pass image will be unlocked once payment proof is verified by the admin team."})]})]})]})]})]})}function ni(){const{ticketId:t}=Sa(),[a,r]=m.useState(null),[s,i]=m.useState(""),[l,n]=m.useState(!0),[o,c]=m.useState(!1),[g,u]=m.useState(null),[y,k]=m.useState(""),E=b=>b==="approved"?"bg-green-100 text-green-800":b==="payment_submitted"?"bg-blue-100 text-blue-700":b==="rejected"||b==="cancelled"?"bg-red-100 text-red-700":"bg-yellow-100 text-yellow-800",w=b=>{try{const x=JSON.parse(b),A=["ticketId","fullName","email","phone","eventName","eventDate","eventTime"].filter(f=>!x[f]);return A.length>0?{ok:!1,message:`Missing fields: ${A.join(", ")}`}:{ok:!0,parsed:x}}catch{return{ok:!1,message:"QR payload is not valid JSON."}}};m.useEffect(()=>{(async()=>{try{const x=await Ae.getTicketById(t);r(x),i(JSON.stringify({ticketId:x.uniqueTicketId||x.ticketId||x.id,fullName:x.fullName||x.name,email:x.email,phone:x.phone,eventName:x.eventName,eventDate:x.eventDate,eventTime:x.eventTime},null,2))}catch{u({type:"error",message:"Ticket not found"})}finally{n(!1)}})()},[t]);const p=async()=>{u(null),k("");const b=w(s);if(!b.ok){k(b.message);return}c(!0);try{const x=await Ae.verifyTicketByQr(s);r(x.ticket||a),u({type:"success",message:x.message||`Ticket verified: ${x.status}`})}catch(x){const I=x.response?.data?.message||"Verification failed",A=x.response?.data?.mismatchedFields?.length?` Mismatched fields: ${x.response.data.mismatchedFields.join(", ")}.`:"";u({type:"error",message:`${I}${A}`})}finally{c(!1)}};return l?e.jsx("div",{className:"flex items-center justify-center min-h-screen",children:e.jsx("div",{className:"animate-spin rounded-full h-16 w-16 border-4 border-purple-600 border-t-transparent"})}):e.jsx("div",{className:"min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center p-6",children:e.jsxs("div",{className:"bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full",children:[e.jsx("h1",{className:"text-3xl font-bold text-gray-800 mb-6 text-center",children:"Ticket Verification"}),g&&e.jsx(Wt,{type:g.type,message:g.message,onClose:()=>u(null)}),a?e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"bg-gradient-to-r from-purple-100 to-blue-100 rounded-lg p-6",children:[e.jsx("h2",{className:"text-xl font-bold text-gray-800 mb-4",children:a.eventName}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{className:"text-gray-600",children:[e.jsx("span",{className:"font-semibold",children:"Date:"})," ",a.eventDate]}),e.jsxs("p",{className:"text-gray-600",children:[e.jsx("span",{className:"font-semibold",children:"Location:"})," ",a.location]}),e.jsxs("p",{className:"text-gray-600",children:[e.jsx("span",{className:"font-semibold",children:"Ticket Type:"})," ",a.ticketType]}),e.jsxs("p",{className:"text-gray-600",children:[e.jsx("span",{className:"font-semibold",children:"Status:"}),e.jsx("span",{className:`ml-2 px-3 py-1 rounded-full text-sm ${E(a.status)}`,children:a.status})]})]})]}),e.jsx("div",{className:"text-center",children:e.jsx("div",{className:"bg-white border-2 border-dashed border-gray-300 rounded-lg p-4 inline-block",children:e.jsx("div",{className:"w-48 h-48 bg-gray-100 flex items-center justify-center",children:e.jsx("span",{className:"text-gray-400",children:"Scan / Paste QR Data"})})})}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-gray-700 mb-2 font-semibold",children:"QR Payload"}),e.jsx("textarea",{className:"w-full px-4 py-2 border rounded-lg",rows:6,value:s,onChange:b=>i(b.target.value)}),y&&e.jsx("p",{className:"text-sm text-red-600 mt-2",children:y})]}),e.jsx("button",{onClick:p,disabled:o,className:"w-full bg-purple-600 text-white py-3 rounded-lg hover:bg-purple-700 disabled:opacity-50 font-semibold",children:o?"Verifying...":"Verify Ticket"})]}):e.jsx("div",{className:"text-center text-gray-600",children:e.jsx("p",{children:"Ticket not found or invalid."})})]})})}const ua={"Pearl Continental Hotel (PC)":W("/assets/hotels/Pearl-Continental-Lahore.jpg"),"Ramada by Wyndham Lahore":W("/assets/hotels/Ramada-by-Wyndham-Lahore-Gulberg-II.jpg"),"Hotel Indigo Lahore":W("/assets/hotels/Hotel-Indigo.jpg"),"Hotel One Gulberg Lahore":W("/assets/hotels/Hotel-One-Gulberg-Lahore.jpg"),"Luxus Grand Hotel (LC)":W("/assets/hotels/Luxus-Grand-Hotel.jpg"),"Nishat Hotel Lahore":W("/assets/hotels/Nishat.jpg")},ha=W("/assets/hotels/Nishat.jpg"),oi={"Pearl Continental Hotel (PC)":"Iconic five-star city hospitality","Ramada by Wyndham Lahore":"International comfort in Gulberg","Hotel Indigo Lahore":"Boutique lifestyle stay experience","Hotel One Gulberg Lahore":"Smart central festival access","Luxus Grand Hotel (LC)":"Executive luxury with city energy","Nishat Hotel Lahore":"Refined premium Lahore living"},xa=["Pool","Dining","Gym","WiFi","Parking","Service"],li=[["Festival Partner Hotels","Curated stays selected for Ozilla guests, brand partners, and VIP visitors."],["Premium Hospitality","Polished service, comfortable rooms, and refined Lahore hospitality."],["Exclusive Discounts","Partner booking options connected to the festival experience."],["Best Location","Convenient Lahore access for concerts, food experiences, and festival moments."]];function ci(t){return xa[t%xa.length]}function di(){const t=Rr.hotels.map((a,r)=>({...a,description:a.description||"Hotel partners showcase rooms, location, facilities and Ozilla special rates.",contact:a.contact||"Contact via Ozilla partner desk",facilities:a.facilities||["Rooms and Suites","On-site Facilities","Event Access Support","Partner Booking Assistance"],booking:a.offer,image:W(a.image)||ua[a.name]||W("/assets/prism-auth-visual.jpg"),fallbackImage:ua[a.name]||W("/assets/prism-auth-visual.jpg"),tagline:oi[a.name]||"Premium Ozilla partner hospitality",featured:r===0}));return m.useEffect(()=>{const a=document.querySelectorAll(".hotel-reveal"),r=new IntersectionObserver(s=>{s.forEach(i=>{i.target.classList.toggle("is-visible",i.isIntersecting)})},{threshold:.16,rootMargin:"0px 0px -8% 0px"});return a.forEach(s=>r.observe(s)),()=>r.disconnect()},[]),e.jsxs("main",{className:"hotel-booking-page",style:{"--hotel-hero-image":`url("${ha}")`},children:[e.jsxs("section",{className:"hotel-booking-hero hotel-reveal",children:[e.jsx("div",{className:"hotel-hero-glow hotel-hero-glow-a"}),e.jsx("div",{className:"hotel-hero-glow hotel-hero-glow-b"}),e.jsx("div",{className:"hotel-hero-sweep"}),e.jsxs("div",{className:"hotel-hero-content",children:[e.jsx("p",{className:"hotel-eyebrow",children:"OZILLA FEST 2026"}),e.jsx("h1",{children:"LUXURY HOTELS"}),e.jsx("p",{children:"Stay in the finest hotels and experience premium hospitality during OZILLA FEST 2026."}),e.jsxs("div",{className:"hotel-search-bar","aria-label":"Hotel page highlights",children:[e.jsx("span",{children:"Lahore, Pakistan"}),e.jsx("span",{children:"Festival Partner Hotels"}),e.jsx("span",{children:"Premium Stay Options"})]})]})]}),e.jsxs("section",{className:"hotel-booking-intro hotel-reveal",children:[e.jsxs("div",{children:[e.jsx("p",{className:"hotel-eyebrow",children:"Premium Stay Collection"}),e.jsx("h2",{children:"Browse OZILLA FEST Partner Hotels"})]}),e.jsx("p",{children:"A curated hotel listing experience for guests who want comfort, convenient access, trusted booking links, and premium Lahore hospitality."})]}),e.jsx("section",{className:"hotel-benefit-strip hotel-reveal",children:li.map(([a,r],s)=>e.jsxs("article",{className:"hotel-benefit-pill",children:[e.jsx("span",{children:String(s+1).padStart(2,"0")}),e.jsxs("div",{children:[e.jsx("h3",{children:a}),e.jsx("p",{children:r})]})]},a))}),e.jsx("section",{className:"hotel-listings","aria-label":"Luxury hotel listings",children:t.map((a,r)=>e.jsxs("article",{className:`hotel-listing-card hotel-reveal ${a.featured?"hotel-listing-featured":""}`,style:{transitionDelay:`${Math.min(r*70,280)}ms`},children:[a.featured?e.jsx("span",{className:"hotel-featured-ribbon",children:"Featured Partner Hotel"}):null,e.jsx("a",{href:a.website||"#",target:a.website?"_blank":void 0,rel:a.website?"noreferrer":void 0,className:"hotel-listing-image-link","aria-label":`Open ${a.name} details`,children:e.jsxs("div",{className:"hotel-listing-image-wrap",children:[a.showImage?e.jsx("img",{src:a.image,alt:a.name,className:"hotel-listing-image",loading:"lazy",referrerPolicy:"no-referrer",onError:s=>{s.currentTarget.onerror=null,s.currentTarget.src=a.fallbackImage}}):e.jsx("div",{className:"hotel-image-placeholder",children:"Premium Hotel Preview"}),e.jsxs("div",{className:"hotel-image-overlay",children:[e.jsx("span",{children:"*****"}),e.jsx("b",{children:"Luxury Stay"}),e.jsx("em",{children:"Premium Partner"})]})]})}),e.jsxs("div",{className:"hotel-listing-info",children:[e.jsxs("div",{className:"hotel-listing-top",children:[e.jsxs("div",{children:[e.jsxs("p",{className:"hotel-rating-line",children:["***** ",e.jsxs("span",{children:[a.rating||"4.8/5"," Exceptional"]})]}),a.website?e.jsx("a",{href:a.website,target:"_blank",rel:"noreferrer",className:"hotel-listing-title",children:a.name}):e.jsx("h2",{className:"hotel-listing-title",children:a.name}),e.jsx("p",{className:"hotel-tagline",children:a.tagline})]}),e.jsxs("div",{className:"hotel-score-box","aria-label":`${a.name} rating`,children:[e.jsx("strong",{children:a.rating?a.rating.replace("/5",""):"4.8"}),e.jsx("span",{children:"Exceptional"})]})]}),e.jsx("p",{className:"hotel-location",children:"Lahore, Pakistan"}),e.jsx("p",{className:"hotel-description",children:a.description}),e.jsx("div",{className:"hotel-amenity-row","aria-label":`${a.name} amenities`,children:a.facilities.slice(0,6).map((s,i)=>e.jsxs("span",{className:"hotel-amenity-chip",children:[e.jsx("b",{children:ci(i)}),s]},s))}),e.jsxs("div",{className:"hotel-listing-footer",children:[e.jsxs("div",{className:"hotel-detail-stack",children:[e.jsx("span",{children:"Festival Partner Badge"}),e.jsx("strong",{children:a.booking}),e.jsx("small",{children:a.contact})]}),a.website?e.jsx("a",{href:a.website,target:"_blank",rel:"noreferrer",className:"hotel-action-button",children:"View Details"}):null]})]})]},a.name))}),e.jsxs("section",{className:"hotel-booking-cta hotel-reveal",children:[e.jsx("p",{className:"hotel-eyebrow",children:"Premium Hospitality"}),e.jsx("h2",{children:"Your Perfect Stay Awaits"}),e.jsx("p",{children:"Stay in the finest hotels during OZILLA FEST 2026."}),e.jsx("a",{href:"#top",onClick:a=>{a.preventDefault(),window.scrollTo({top:0,behavior:"smooth"})},children:"Explore Partner Hotels"})]}),e.jsx("style",{children:`
        ...
        .hotel-booking-hero {
          ...
          color: #fff;
            ...
            var(--hotel-hero-image, url('${ha}')) center / cover;
...
`;function va(t,a,r){const s=t.createShader(a);return s?(t.shaderSource(s,r),t.compileShader(s),t.getShaderParameter(s,t.COMPILE_STATUS)?s:(console.error("ParticleDrift shader:",t.getShaderInfoLog(s)),t.deleteShader(s),null)):null}function wa(t,a,r){const s=va(t,t.VERTEX_SHADER,a),i=va(t,t.FRAGMENT_SHADER,r);if(!s||!i)return null;const l=t.createProgram();return l?(t.attachShader(l,s),t.attachShader(l,i),t.linkProgram(l),t.getProgramParameter(l,t.LINK_STATUS)?l:(console.error("ParticleDrift link:",t.getProgramInfoLog(l)),null)):null}function ka(t,a){if(!t)return a;const r=String(t).trim();if(r.charAt(0)==="#"){let i=r.slice(1);if((i.length===3||i.length===4)&&(i=i[0]+i[0]+i[1]+i[1]+i[2]+i[2]),i.length>=6){const l=parseInt(i.slice(0,2),16),n=parseInt(i.slice(2,4),16),o=parseInt(i.slice(4,6),16);if(!isNaN(l)&&!isNaN(n)&&!isNaN(o))return[l/255,n/255,o/255]}return a}const s=r.match(/[\d.]+/g);return s&&s.length>=3?[Math.min(255,parseFloat(s[0]))/255,Math.min(255,parseFloat(s[1]))/255,Math.min(255,parseFloat(s[2]))/255]:a}function Be(t,a){return typeof t=="number"&&isFinite(t)?t:a}function rt(t,a,r){return t<a?a:t>r?r:t}function Ii(t){let a=t>>>0;return function(){a+=1831565813;let r=a;return r=Math.imul(r^r>>>15,r|1),r^=r+Math.imul(r^r>>>7,r|61),((r^r>>>14)>>>0)/4294967296}}const Dt=[[0,-1],[1,-1],[1,1],[0,-1],[1,1],[0,1]];function zi({style:t,background:a="transparent",baseColor:r="#F84400",accentColor:s="#ECECEC",density:i=235,dotSize:l=14,speed:n=100,direction:o=0,hover:c=200,linkDistance:g=202,linkThickness:u=2.5,width:y,height:k,isFixed:E=!0}){const w=m.useRef(null),p=m.useRef(null),b=m.useRef({w:0,h:0});b.current={w:Be(y,0),h:Be(k,0)};const x=m.useRef({x:-1e4,y:-1e4}),I=m.useRef({});I.current={base:r,accent:s,density:Math.round(rt(Be(i,90),10,400)),dotSize:rt(Be(l,5),1,24),speed:rt(Be(n,50),0,100)/50,direction:rt(Be(o,0),0,360),hover:rt(Be(c,100),0,200)/100,linkDistance:rt(Be(g,120),0,400),linkThickness:rt(Be(u,1),.5,8)},m.useEffect(()=>{const f=p.current;if(!f)return;const d=f.getContext("webgl",{alpha:!0,antialias:!1,depth:!1,premultipliedAlpha:!0});if(!d){console.error("ParticleDrift: WebGL unavailable");return}const F=wa(d,Ei,Ci),B=wa(d,Li,Ri);if(!F||!B)return;const N=new Map,h=(se,G)=>{const S=(se===F?"L:":"D:")+G;return N.has(S)||N.set(S,d.getUniformLocation(se,G)),N.get(S)},P=new Float32Array(qe*6*2),T=new Float32Array(qe*6*2),R=new Float32Array(qe*6*2),V=new Float32Array(qe*6*3);for(let se=0;se<qe;se++)for(let G=0;G<6;G++){const S=(se*6+G)*2;R[S]=Dt[G][0],R[S+1]=Dt[G][1]}const O=d.createBuffer(),C=d.createBuffer(),$=d.createBuffer(),Y=d.createBuffer();d.bindBuffer(d.ARRAY_BUFFER,O),d.bufferData(d.ARRAY_BUFFER,P.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,C),d.bufferData(d.ARRAY_BUFFER,T.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,$),d.bufferData(d.ARRAY_BUFFER,R,d.STATIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,Y),d.bufferData(d.ARRAY_BUFFER,V.byteLength,d.DYNAMIC_DRAW);const H=Ii(20260824);let M=0,D=new Float32Array(0),q=new Float32Array(0),oe=new Float32Array(0),te=new Float32Array(0),ne=new Float32Array(0);const v=d.createBuffer(),j=d.createBuffer(),_=(se,G,S)=>{M=se,D=new Float32Array(se),q=new Float32Array(se),oe=new Float32Array(se),te=new Float32Array(se*2),ne=new Float32Array(se);for(let L=0;L<se;L++)D[L]=H()*G,q[L]=H()*S,oe[L]=(H()*.4+.1)*60;d.bindBuffer(d.ARRAY_BUFFER,v),d.bufferData(d.ARRAY_BUFFER,te.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,j),d.bufferData(d.ARRAY_BUFFER,ne.byteLength,d.DYNAMIC_DRAW)};let J=0,re=performance.now(),ae=-1,z=0,ie=0;const me=se=>{if(J=requestAnimationFrame(me),typeof document<"u"&&document.hidden){re=se;return}const G=Math.min(.05,(se-re)/1e3);re=se;const S=I.current,L=S.speed,Q=b.current.w||f.clientWidth||(typeof window<"u"?window.innerWidth:1200),Z=b.current.h||f.clientHeight||(typeof window<"u"?window.innerHeight:800),de=Q<768,je=Q>=768&&Q<1024,ve=Math.min(window.devicePixelRatio||1,de?.75:Ti),he=Math.max(1,Math.round(Q*ve)),Re=Math.max(1,Math.round(Z*ve));(f.width!==he||f.height!==Re)&&(f.width=he,f.height=Re),d.viewport(0,0,he,Re);let _e=S.density,ze=S.linkDistance,dt=S.dotSize;if(de?(_e=42,ze=95,dt=Math.min(S.dotSize,7)):je&&(_e=Math.max(80,Math.min(Math.round(S.density*.5),110)),ze=Math.min(S.linkDistance,145),dt=Math.min(S.dotSize,10)),_e!==ae&&(_(_e,Q,Z),ae=_e),Q!==z||Z!==ie){const U=Q/Math.max(z||Q,1),le=Z/Math.max(ie||Z,1);for(let xe=0;xe<M;xe++)D[xe]*=U,q[xe]*=le;z=Q,ie=Z}const Qe=x.current,pt=S.hover,mt=(de?100:180)*(pt>0?1:0),Pe=ze,ft=de?Math.min(S.linkThickness,1.6):S.linkThickness,ht=S.direction*Math.PI/180,xt=Math.sin(ht),Pt=Math.cos(ht);let Me=0;const bt=(U,le,xe,Te,we,Ie,Ge,st)=>{if(!(Me>=qe)){for(let Fe=0;Fe<6;Fe++){const it=(Me*6+Fe)*2,Tt=(Me*6+Fe)*3;P[it]=U,P[it+1]=le,T[it]=xe,T[it+1]=Te,V[Tt]=Dt[Fe][0]===0?we:Ie,V[Tt+1]=Ge,V[Tt+2]=st}Me++}};for(let U=0;U<M;U++){D[U]+=oe[U]*xt*G*L,q[U]+=oe[U]*Pt*G*L,D[U]<-Xe?(D[U]=Q+Xe,q[U]=H()*Z):D[U]>Q+Xe&&(D[U]=-Xe,q[U]=H()*Z),q[U]<-Xe?(q[U]=Z+Xe,D[U]=H()*Q):q[U]>Z+Xe&&(q[U]=-Xe,D[U]=H()*Q);const le=Qe.x-D[U],xe=Qe.y-q[U],Te=Math.sqrt(le*le+xe*xe),we=mt>0&&Te<mt?1:0;if(we===1){const Ie=.5*(1-Te/mt)*pt;bt(D[U],q[U],Qe.x,Qe.y,Ie,Ie,1,ft)}te[U*2]=D[U],te[U*2+1]=q[U],ne[U]=we}if(Pe>0){const U=Pe*Pe;for(let le=0;le<M&&Me<qe;le++){const xe=D[le],Te=q[le];for(let we=le+1;we<M&&Me<qe;we++){const Ie=xe-D[we];if(Ie>Pe||Ie<-Pe)continue;const Ge=Te-q[we];if(Ge>Pe||Ge<-Pe)continue;const st=Ie*Ie+Ge*Ge;if(st>=U)continue;const Fe=.15*(1-Math.sqrt(st)/Pe);bt(xe,Te,D[we],q[we],Fe,Fe,0,ft)}}}d.clearColor(0,0,0,0),d.clear(d.COLOR_BUFFER_BIT),d.disable(d.DEPTH_TEST),d.enable(d.BLEND),d.blendFunc(d.ONE,d.ONE_MINUS_SRC_ALPHA);const He=ka(S.base,[.973,.267,0]),Ue=ka(S.accent,[.925,.925,.925]);if(Me>0){d.useProgram(F);const U=Me*6;d.bindBuffer(d.ARRAY_BUFFER,O),d.bufferSubData(d.ARRAY_BUFFER,0,P.subarray(0,U*2));const le=d.getAttribLocation(F,"a_p0");d.enableVertexAttribArray(le),d.vertexAttribPointer(le,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,C),d.bufferSubData(d.ARRAY_BUFFER,0,T.subarray(0,U*2));const xe=d.getAttribLocation(F,"a_p1");d.enableVertexAttribArray(xe),d.vertexAttribPointer(xe,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,$);const Te=d.getAttribLocation(F,"a_corner");d.enableVertexAttribArray(Te),d.vertexAttribPointer(Te,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,Y),d.bufferSubData(d.ARRAY_BUFFER,0,V.subarray(0,U*3));const we=d.getAttribLocation(F,"a_shade");d.enableVertexAttribArray(we),d.vertexAttribPointer(we,3,d.FLOAT,!1,0,0),d.uniform2f(h(F,"uSize"),Q,Z),d.uniform3f(h(F,"uBase"),He[0],He[1],He[2]),d.uniform3f(h(F,"uAccent"),Ue[0],Ue[1],Ue[2]),d.drawArrays(d.TRIANGLES,0,U),d.disableVertexAttribArray(le),d.disableVertexAttribArray(xe),d.disableVertexAttribArray(Te),d.disableVertexAttribArray(we)}if(M>0){d.useProgram(B),d.bindBuffer(d.ARRAY_BUFFER,v),d.bufferSubData(d.ARRAY_BUFFER,0,te);const U=d.getAttribLocation(B,"a_pos");d.enableVertexAttribArray(U),d.vertexAttribPointer(U,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,j),d.bufferSubData(d.ARRAY_BUFFER,0,ne);const le=d.getAttribLocation(B,"a_lit");d.enableVertexAttribArray(le),d.vertexAttribPointer(le,1,d.FLOAT,!1,0,0),d.uniform2f(h(B,"uSize"),Q,Z),d.uniform1f(h(B,"uDpr"),ve),d.uniform1f(h(B,"uDot"),dt),d.uniform1f(h(B,"uRestAlpha"),.4),d.uniform3f(h(B,"uBase"),He[0],He[1],He[2]),d.uniform3f(h(B,"uAccent"),Ue[0],Ue[1],Ue[2]),d.drawArrays(d.POINTS,0,M),d.disableVertexAttribArray(U),d.disableVertexAttribArray(le)}},Se=se=>{const G=f.getBoundingClientRect();if(G.width<=0||G.height<=0)return;const S=b.current.w||f.clientWidth||window.innerWidth||1200,L=b.current.h||f.clientHeight||window.innerHeight||800;x.current.x=(se.clientX-G.left)/G.width*S,x.current.y=(se.clientY-G.top)/G.height*L},ue=()=>{x.current.x=-1e4,x.current.y=-1e4};return window.addEventListener("pointermove",Se,{passive:!0}),window.addEventListener("pointerleave",ue,{passive:!0}),J=requestAnimationFrame(me),()=>{cancelAnimationFrame(J),window.removeEventListener("pointermove",Se),window.removeEventListener("pointerleave",ue),d.deleteBuffer(O),d.deleteBuffer(C),d.deleteBuffer($),d.deleteBuffer(Y),d.deleteBuffer(v),d.deleteBuffer(j),d.deleteProgram(F),d.deleteProgram(B)}},[]);const A=E?{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:0,pointerEvents:"none",overflow:"hidden",background:a,isolation:"isolate",...t}:{position:"relative",overflow:"hidden",background:a,isolation:"isolate",width:typeof y=="number"&&y>0?y:"100%",height:typeof k=="number"&&k>0?k:"100%",...t};return e.jsx("div",{ref:w,style:A,"aria-hidden":"true",children:e.jsx("canvas",{ref:p,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}})})}function Mi(){const t="/ozillafest/".replace(/\/$/,"");return e.jsx(Ya,{basename:t||void 0,future:{v7_startTransition:!0,v7_relativeSplatPath:!0},children:e.jsxs(er,{children:[e.jsx(zi,{}),e.jsx(Pi,{})]})})}const ja=(t="")=>{const a=String(t).toLowerCase();return a.includes("importing a module script failed")||a.includes("failed to fetch dynamically imported module")||a.includes("loading chunk")||a.includes("failed to load module script")||a.includes("error loading dynamically imported module")||a.includes("mime type")||a.includes("dynamically imported")};class Fi extends m.Component{constructor(r){super(r);Yt(this,"handleReload",()=>{sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload()});this.state={error:null}}static getDerivedStateFromError(r){return{error:r}}componentDidCatch(r,s){if(console.error("Application render error:",r,s),ja(r?.message)){const i=Number(sessionStorage.getItem("chunk_reload_ts")||0);Date.now()-i>8e3&&(sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload())}}render(){if(this.state.error){const r=ja(this.state.error?.message);return e.jsxs("main",{style:{padding:"32px 20px",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',maxWidth:"540px",margin:"60px auto",textAlign:"center",backgroundColor:"#121118",color:"#f3f4f6",borderRadius:"16px",border:"1px solid rgba(255,255,255,0.1)",boxShadow:"0 20px 50px rgba(0,0,0,0.5)"},children:[e.jsx("h2",{style:{color:"#f97316",marginBottom:"12px",fontSize:"1.4rem"},children:r?"New Update Available":"Ozilla Festival could not render"}),e.jsx("p",{style:{color:"#9ca3af",marginBottom:"20px",fontSize:"0.95rem",lineHeight:"1.5"},children:r?"A fresh update has been deployed. Please tap refresh to load the latest version.":"Please refresh the page to reload the application."}),e.jsx("button",{type:"button",onClick:this.handleReload,style:{padding:"12px 28px",backgroundColor:"#ea580c",color:"#ffffff",border:"none",borderRadius:"999px",cursor:"pointer",fontWeight:"700",fontSize:"1rem",boxShadow:"0 4px 14px rgba(234, 88, 12, 0.4)",transition:"transform 0.15s ease"},children:"Refresh Website"})]})}return this.props.children}}if(typeof window<"u"){const t=a=>{const r=String(a?.message||a?.reason?.message||"").toLowerCase();if(r.includes("importing a module script failed")||r.includes("failed to fetch dynamically imported module")||r.includes("loading chunk")||r.includes("failed to load module script")){const s=Number(sessionStorage.getItem("chunk_reload_ts")||0);Date.now()-s>8e3&&(sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload())}};window.addEventListener("error",t),window.addEventListener("unhandledrejection",t)}const Oi="231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com";_t.createRoot(document.getElementById("root")).render(e.jsx(gt.StrictMode,{children:e.jsx(Fi,{children:e.jsx(Ja,{clientId:Oi,children:e.jsx(Mi,{})})})}));export{Wt as A,Gt as a,ee as b,Hi as c,Ks as f,Ae as t,Je as u};
