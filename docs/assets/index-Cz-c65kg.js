const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/UserDashboardPage-9g7C5py-.js","assets/vendor-motion-BW8tmsoW.js","assets/vendor-react-DycaHlXR.js","assets/PageHeader-Cr0bo0tp.js","assets/vendor-utils-BRCtA9qj.js","assets/AdminDashboardPage-DSL0XCCu.js","assets/AdminTicketReviewPage-DZ7F1Yio.js"])))=>i.map(i=>d[i]);
var Ma=Object.defineProperty;var Fa=(t,a,r)=>a in t?Ma(t,a,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[a]=r;var Gt=(t,a,r)=>Fa(t,typeof a!="symbol"?a+"":a,r);import{j as e,u as ka,m as J,a as Wt,b as Oa,A as Da}from"./vendor-motion-BW8tmsoW.js";import{a as Ba,r as m,R as gt,u as Ze,N as be,O as ht,L as Z,b as ct,c as _a,d as $a,e as ja,f as Ua,g as K,B as Ha}from"./vendor-react-DycaHlXR.js";import{a as Ga,Q as Wa}from"./vendor-utils-BRCtA9qj.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function r(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(i){if(i.ep)return;i.ep=!0;const l=r(i);fetch(i.href,l)}})();var Ot={},Vt=Ba;Ot.createRoot=Vt.createRoot,Ot.hydrateRoot=Vt.hydrateRoot;function Va(t={}){const{nonce:a,locale:r,onScriptLoadSuccess:s,onScriptLoadError:i}=t,[l,n]=m.useState(!1),o=m.useRef(s);o.current=s;const c=m.useRef(i);return c.current=i,m.useEffect(()=>{const u=document.createElement("script");return u.src="https://accounts.google.com/gsi/client",r&&(u.src+=`?hl=${r}`),u.async=!0,u.defer=!0,u.nonce=a,u.onload=()=>{var g;n(!0),(g=o.current)===null||g===void 0||g.call(o)},u.onerror=()=>{var g;n(!1),(g=c.current)===null||g===void 0||g.call(c)},document.body.appendChild(u),()=>{document.body.removeChild(u)}},[a]),l}const Ya=m.createContext(null);function qa({clientId:t,nonce:a,locale:r,onScriptLoadSuccess:s,onScriptLoadError:i,children:l}){const n=Va({nonce:a,onScriptLoadSuccess:s,onScriptLoadError:i,locale:r}),o=m.useMemo(()=>({locale:r,clientId:t,scriptLoadedSuccessfully:n}),[t,n]);return gt.createElement(Ya.Provider,{value:o},l)}const Tt="prism_token",Se={getToken(){return localStorage.getItem(Tt)},setToken(t){localStorage.setItem(Tt,t)},removeToken(){localStorage.removeItem(Tt)}},Xa="http://localhost:5000/api",ee=Ga.create({baseURL:Xa,headers:{"Content-Type":"application/json"}});ee.interceptors.request.use(t=>{const a=Se.getToken();return a&&(t.headers.Authorization=`Bearer ${a}`),t},t=>Promise.reject(t));ee.interceptors.response.use(t=>t,t=>(t.response?.status===401&&Se.removeToken(),Promise.reject(t)));const Ee={AUTH:{LOGIN:"/auth/login",REGISTER:"/auth/register",LOGOUT:"/auth/logout",SEND_OTP:"/auth/resend-otp",RESEND_OTP:"/auth/resend-otp",VERIFY_OTP:"/auth/verify-otp",FORGOT_PASSWORD:"/auth/forgot-password",RESET_PASSWORD:"/auth/reset-password",GOOGLE:"/auth/google",GOOGLE_CODE_LOGIN:"/auth/google/code-login",GOOGLE_TOKEN_LOGIN:"/auth/google/token-login",ME:"/auth/me",PROFILE:"/auth/profile"},TICKETS:{MY_TICKETS:"/tickets/my-tickets",REQUEST:"/tickets/request",BY_ID:"/tickets/:id",PAYMENT_PROOF:"/tickets/:id/payment-proof",VERIFY:"/tickets/:id/verify"},CONTENT:{EVENTS:"/content/events",EVENT_BY_ID:"/content/events/:id",SPONSORS:"/content/sponsors",FACILITIES:"/content/facilities",CONTACT:"/content/contact"}},Na="ozilla_local_users";let st=!1;function je(t){return String(t||"").toLowerCase().trim()}function $e(t){return String(t||"").trim()}function Be(){try{const t=localStorage.getItem(Na),a=t?JSON.parse(t):[];return Array.isArray(a)?a:[]}catch{return[]}}function We(t){localStorage.setItem(Na,JSON.stringify(t))}function Za(t){const a={sub:t.id,email:t.email,mode:"local-fallback"};return`local.${btoa(JSON.stringify(a))}`}function Et(t){const a=String(t||"");if(!a)return null;if(a.startsWith("local."))try{return JSON.parse(atob(a.slice(6)))}catch{return null}const r=a.split(".");if(r.length===3)try{return JSON.parse(atob(r[1]))}catch{return null}return null}function ut(t){return{id:t.id,firstName:t.firstName,lastName:t.lastName,name:t.name||`${t.firstName||""} ${t.lastName||""}`.trim(),email:t.email,phone:t.phone,role:t.role||"user"}}function ot(t={}){const a=String(t.firstName||"Local").trim()||"Local",r=String(t.lastName||"User").trim()||"User",s=je(t.email||"local@ozillafestival.com"),i=$e(t.phone||"+923000000000");return{id:t.id||`local-user-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,firstName:a,lastName:r,name:`${a} ${r}`.trim(),email:s,phone:i,password:String(t.password||""),role:"user"}}function Dt(t){return!t?.response&&(t?.code==="ERR_NETWORK"||t?.message?.includes("Network Error")||t?.message?.includes("ECONNREFUSED"))}function vt(t){return Dt(t)?(st=!0,!0):!1}function lt(t){const a=ut(t);return{token:Za(a),user:a,mode:"local-fallback"}}const Xe={async login(t){const a=String(t?.email||t?.phone||t?.identifier||"").trim(),r=je(a),s=$e(a),i=String(t?.password||"").trim();try{const l=await ee.post(Ee.AUTH.LOGIN,{email:a,password:i});if(l?.data?.token){const n=Be(),o=n.findIndex(u=>je(u.email)===r||$e(u.phone)===s),c={id:l.data.user?.id||`user-${Date.now()}`,firstName:l.data.user?.firstName||"",lastName:l.data.user?.lastName||"",name:l.data.user?.name||"",email:l.data.user?.email?je(l.data.user.email):r,phone:l.data.user?.phone?$e(l.data.user.phone):s,password:i,role:l.data.user?.role||"user"};return o>=0?(n[o]=c,We(n)):We([c,...n]),l.data}return l.data}catch(l){const n=Be(),o=n.find(u=>(je(u.email)===r||$e(u.phone)===s)&&u.password===i);if(o)return st=!0,lt(o);const c=n.find(u=>je(u.email)===r||$e(u.phone)===s);if(c&&c.password!==i){const u=new Error("Invalid credentials. Please check your password.");throw u.response={status:401,data:{message:"Invalid credentials. Please check your password."}},u}throw l}},async register(t){const a=je(t?.email),r=$e(t?.phone),s=String(t?.password||"").trim(),i=Be(),l=i.find(o=>je(o.email)===a),n=i.find(o=>$e(o.phone)===r);try{const o=await ee.post(Ee.AUTH.REGISTER,{...t,email:a,phone:r,password:s});if(o?.data?.token){const c=ot({id:o.data.user?.id,firstName:t.firstName,lastName:t.lastName,email:a,phone:r,password:s}),u=i.filter(g=>je(g.email)!==a&&$e(g.phone)!==r);We([c,...u])}return o.data}catch(o){if(o?.response?.status===409||o?.response?.data?.message)throw o;if(l){const u=new Error("Account already exists with this email. Please log in.");throw u.response={status:409,data:{message:"Account already exists with this email. Please log in."}},u}if(n){const u=new Error("Account already exists with this phone number. Please log in.");throw u.response={status:409,data:{message:"Account already exists with this phone number. Please log in."}},u}const c=ot({...t,email:a,phone:r,password:s});return We([c,...i]),st=!0,lt(c)}},async sendOtp(t){const a=je(t);try{return(await ee.post(Ee.AUTH.SEND_OTP,{email:a})).data}catch(r){if(r?.response?.status===404)try{return(await ee.post(Ee.AUTH.RESEND_OTP,{email:a})).data}catch(s){if(s?.response?.data?.message)throw s}if(r?.response?.data?.message)throw r;if(Dt(r)){const s=new Error("Cannot connect to backend server. Please ensure the backend server is running and reachable.");throw s.response={status:503,data:{message:"Cannot connect to backend server. Please ensure the backend server is running and reachable."}},s}throw r}},async resendOtp(t){return this.sendOtp(t)},async verifyOtp(t){const a=je(t?.email),r=String(t?.otp||"").trim();try{return(await ee.post(Ee.AUTH.VERIFY_OTP,{email:a,otp:r})).data}catch(s){if(s?.response?.data?.message)throw s;if(Dt(s)){const i=new Error("Cannot connect to backend server at http://localhost:5000. Please ensure the backend server is running.");throw i.response={status:503,data:{message:"Cannot connect to backend server at http://localhost:5000. Please ensure the backend server is running."}},i}throw s}},async getCurrentUser(){const t=Se.getToken();if(!t){const r=new Error("Unauthorized");throw r.response={status:401,data:{message:"Unauthorized"}},r}const a=Et(t);if(a?.mode==="local-fallback"||String(t||"").startsWith("local.")){const s=Be().find(i=>i.id===a?.sub||je(i.email)===je(a?.email));if(s)return ut(s)}try{return(await ee.get(Ee.AUTH.ME)).data}catch(r){const i=Be().find(l=>l.id===a?.sub||je(l.email)===je(a?.email));if(i)return ut(i);throw r}},async logout(){if(st)return{message:"Logged out successfully"};try{return(await ee.post(Ee.AUTH.LOGOUT)).data}catch(t){if(vt(t))return{message:"Logged out successfully"};throw t}},async forgotPassword(t){return(await ee.post(Ee.AUTH.FORGOT_PASSWORD,{email:t})).data},async resetPassword(t){return(await ee.post(Ee.AUTH.RESET_PASSWORD,t)).data},async googleAuth(t,a){if(st){const s=ot(a||{email:"ubair1100@gmail.com",firstName:"Ubair",lastName:"Naeem"}),i=Be();return i.some(l=>l.email===s.email)||We([s,...i]),lt(s)}try{return(await ee.post(Ee.AUTH.GOOGLE,{token:t,profile:a})).data}catch(r){if(vt(r)){const i=ot(a||{email:"ubair1100@gmail.com",firstName:"Ubair",lastName:"Naeem"});return lt(i)}throw r}},async googleCodeLogin(t,a="postmessage",r){if(st){const i=ot(r||{email:"ubair1100@gmail.com",firstName:"Ubair",lastName:"Naeem"}),l=Be();return l.some(n=>n.email===i.email)||We([i,...l]),lt(i)}try{return(await ee.post(Ee.AUTH.GOOGLE_CODE_LOGIN,{code:t,redirectUri:a,profile:r})).data}catch(s){if(vt(s)){const l=ot(r||{email:"ubair1100@gmail.com",firstName:"Ubair",lastName:"Naeem"});return lt(l)}throw s}},async googleTokenLogin(t,a){return this.googleAuth(t,a)},async updateProfile(t){if(st){const a=Se.getToken(),r=Et(a),s=Be(),i=s.findIndex(o=>o.id===r?.sub||o.email===r?.email);if(i===-1){const o=new Error("Unauthorized");throw o.response={status:401,data:{message:"Unauthorized"}},o}const l=s[i],n={...l,firstName:typeof t?.firstName=="string"?t.firstName.trim():l.firstName,lastName:typeof t?.lastName=="string"?t.lastName.trim():l.lastName,phone:typeof t?.phone=="string"?t.phone.trim():l.phone};return n.name=`${n.firstName||""} ${n.lastName||""}`.trim()||l.name,s[i]=n,We(s),{message:"Profile updated successfully",user:ut(n)}}try{return(await ee.put(Ee.AUTH.PROFILE,t)).data}catch(a){if(vt(a)){const r=Se.getToken(),s=Et(r),i=Be(),l=i.findIndex(c=>c.id===s?.sub||c.email===s?.email);if(l===-1){const c=new Error("Unauthorized");throw c.response={status:401,data:{message:"Unauthorized"}},c}const n=i[l],o={...n,firstName:typeof t?.firstName=="string"?t.firstName.trim():n.firstName,lastName:typeof t?.lastName=="string"?t.lastName.trim():n.lastName,phone:typeof t?.phone=="string"?t.phone.trim():n.phone};return o.name=`${o.firstName||""} ${o.lastName||""}`.trim()||n.name,i[l]=o,We(i),{message:"Profile updated successfully",user:ut(o)}}throw a}}},Sa=m.createContext(null);function Ka({children:t}){const[a,r]=m.useState(null),[s,i]=m.useState(!0);m.useEffect(()=>{l()},[]);const l=async()=>{try{if(Se.getToken()){const k=await Xe.getCurrentUser();r(k)}}catch{Se.removeToken()}finally{i(!1)}},n=async y=>{const k=await Xe.login(y);return Se.setToken(k.token),r(k.user),k},o=async y=>{const k=await Xe.register(y);return Se.setToken(k.token),r(k.user),k},c=()=>{Xe.logout().catch(()=>{}),Se.removeToken(),r(null)},u=a?.role==="admin"||["ubair1100@gmail.com","admin@ozillafestival.com","muhammadubair@gmail.com","admin@prism.com"].includes(String(a?.email||"").toLowerCase().trim()),g={user:a,isAdmin:u,loading:s,login:n,register:o,logout:c,checkAuth:l};return e.jsx(Sa.Provider,{value:g,children:t})}const Ja="modulepreload",Qa=function(t){return"/ozillafest/"+t},Yt={},Bt=function(a,r,s){let i=Promise.resolve();if(r&&r.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),o=n?.nonce||n?.getAttribute("nonce");i=Promise.allSettled(r.map(c=>{if(c=Qa(c),c in Yt)return;Yt[c]=!0;const u=c.endsWith(".css"),g=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${g}`))return;const y=document.createElement("link");if(y.rel=u?"stylesheet":Ja,u||(y.as="script"),y.crossOrigin="",y.href=c,o&&y.setAttribute("nonce",o),document.head.appendChild(y),u)return new Promise((k,A)=>{y.addEventListener("load",k),y.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${c}`)))})}))}function l(n){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=n,window.dispatchEvent(o),!o.defaultPrevented)throw n}return i.then(n=>{for(const o of n||[])o.status==="rejected"&&l(o.reason);return a().catch(l)})};function Ke(){const t=m.useContext(Sa);if(!t)throw new Error("useAuth must be used within an AuthProvider");return t}function er({children:t}){const{user:a,loading:r}=Ke(),s=Ze();if(r)return e.jsx("div",{className:"flex items-center justify-center min-h-screen",children:"Loading..."});if(!a){const i=`${s.pathname}${s.search}`,l=new URLSearchParams({returnTo:i}).toString();return e.jsx(be,{to:`/login?${l}`,replace:!0})}return t||e.jsx(ht,{})}function St(t,a="/dashboard"){if(!t||typeof t!="string")return a;let r=t.trim();if(r.startsWith("//")||/^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(r))return a;r.startsWith("/ozillafest")&&(r=r.slice(11)),r.startsWith("/")||(r=`/${r}`);const s=r.split("?")[0].replace(/\/$/,"");return!s||s==="/login"||s==="/register"?a:r}function tr({children:t}){const{user:a,loading:r}=Ke(),s=Ze();if(r)return e.jsx("div",{className:"flex items-center justify-center min-h-screen",children:"Loading..."});if(a){const l=new URLSearchParams(s.search).get("returnTo"),n=St(l,"/dashboard");return e.jsx(be,{to:n,replace:!0})}return t||e.jsx(ht,{})}function V(t){if(!t||typeof t!="string"||t.startsWith("http://")||t.startsWith("https://")||t.startsWith("data:")||t.startsWith("blob:"))return t;const a="/ozillafest/",r=a.endsWith("/")?a:`${a}/`,s=t.replace(/^\/+/,"");return s.startsWith("assets/")||s.startsWith("favicon")?`${r}${s}`:t.startsWith("/")?`${r}${s}`:t}function ar({className:t="",nodeColor:a="#EC4899",lineColor:r="236, 72, 153",secondaryColor:s="255, 90, 31",maxDistance:i=135,speed:l=.5}){const n=m.useRef(null);return m.useEffect(()=>{const o=n.current;if(!o)return;const c=o.getContext("2d",{alpha:!0});if(!c)return;let u=null,g=!0,y=!1,k=o.width=o.parentElement?.clientWidth||window.innerWidth,A=o.height=o.parentElement?.clientHeight||window.innerHeight;const p=k<768?18:34,b=340,x=450,M=i*i;let j={x:k/2,y:A/2,active:!1},f={rotX:0,rotY:0,targetRotX:0,targetRotY:0};const d=[];for(let $=0;$<p;$++)d.push({x:(Math.random()-.5)*k*1.1,y:(Math.random()-.5)*A*1.1,z:(Math.random()-.5)*x,vx:(Math.random()-.5)*l*.7,vy:(Math.random()-.5)*l*.7,vz:(Math.random()-.5)*l*.7,radius:Math.random()*1.8+1.2,colorType:Math.random()>.4?"primary":"secondary"});const B=()=>{o.parentElement&&(k=o.width=o.parentElement.clientWidth||window.innerWidth,A=o.height=o.parentElement.clientHeight||window.innerHeight)};window.addEventListener("resize",B,{passive:!0});const L=$=>{if(!g)return;const T=o.getBoundingClientRect();j.x=$.clientX-T.left,j.y=$.clientY-T.top,j.active=!0;const U=(j.x-k/2)/(k/2),X=(j.y-A/2)/(A/2);f.targetRotY=U*.14,f.targetRotX=-X*.14},P=()=>{j.active=!1,f.targetRotX=0,f.targetRotY=0};window.addEventListener("mousemove",L,{passive:!0}),window.addEventListener("mouseleave",P,{passive:!0});const h=()=>{if(!g||document.hidden){y=!1;return}c.clearRect(0,0,k,A),f.rotX+=(f.targetRotX-f.rotX)*.05,f.rotY+=(f.targetRotY-f.rotY)*.05;const $=Math.cos(f.rotY),T=Math.sin(f.rotY),U=Math.cos(f.rotX),X=Math.sin(f.rotX),H=k/2,F=A/2,O=k*.65,Y=A*.65,de=x*.55,N=[];for(let D=0;D<p;D++){const C=d[D];C.x+=C.vx,C.y+=C.vy,C.z+=C.vz,(C.x<-O||C.x>O)&&(C.vx*=-1),(C.y<-Y||C.y>Y)&&(C.vy*=-1),(C.z<-de||C.z>de)&&(C.vz*=-1);const _=C.x*$-C.z*T,ae=C.z*$+C.x*T,Q=C.y*U-ae*X,ce=ae*U+C.y*X,re=ce+x;if(re<=0)continue;const ne=b/(b+re*.65),me=H+_*ne,ye=F+Q*ne,fe=Math.max(.18,Math.min(.85,(ce+x)/(x*1.4)));N.push({x:me,y:ye,scale:ne,alpha:fe,radius:Math.max(1.2,C.radius*ne),colorType:C.colorType})}const z=N.length;for(let D=0;D<z;D++){const C=N[D];let _=0;for(let ae=D+1;ae<z&&_<3;ae++){const Q=N[ae],ce=C.x-Q.x,re=C.y-Q.y,ne=ce*ce+re*re;if(ne<M){_++;const me=Math.sqrt(ne),ye=(1-me/i)*.4*Math.min(C.alpha,Q.alpha),fe=C.colorType==="primary"?r:s;c.beginPath(),c.moveTo(C.x,C.y),c.lineTo(Q.x,Q.y),c.strokeStyle=`rgba(${fe}, ${ye})`,c.lineWidth=Math.max(.5,(1-me/i)*1.2),c.stroke()}}}for(let D=0;D<z;D++){const C=N[D],_=C.colorType==="primary"?`rgba(${r}, ${C.alpha})`:`rgba(${s}, ${C.alpha})`;c.beginPath(),c.arc(C.x,C.y,C.radius,0,Math.PI*2),c.fillStyle=_,c.fill()}u=requestAnimationFrame(h)},w=()=>{!y&&g&&!document.hidden&&(y=!0,u=requestAnimationFrame(h))},R=()=>{y=!1,u&&(cancelAnimationFrame(u),u=null)};let I=null;"IntersectionObserver"in window?(I=new IntersectionObserver(([$])=>{g=$.isIntersecting,g?w():R()},{threshold:.05}),I.observe(o)):w();const q=()=>{document.hidden?R():g&&w()};return document.addEventListener("visibilitychange",q),()=>{R(),window.removeEventListener("resize",B),window.removeEventListener("mousemove",L),window.removeEventListener("mouseleave",P),document.removeEventListener("visibilitychange",q),I&&I.disconnect()}},[a,r,s,i,l]),e.jsx("canvas",{ref:n,className:`plexus-net-canvas ${t}`,"aria-hidden":"true",style:{position:"absolute",inset:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:1,willChange:"transform"}})}const _t=gt.memo(ar);function Ct({children:t}){const a=Ze(),r=a.pathname==="/login",s=a.pathname==="/register",[i,l]=m.useState({x:0,y:0}),[n,o]=m.useState({x:50,y:42}),c=g=>{if(g.pointerType==="touch")return;const y=g.currentTarget.getBoundingClientRect(),k=(g.clientX-y.left)/y.width,A=(g.clientY-y.top)/y.height;l({x:(.5-A)*10,y:(k-.5)*10}),o({x:k*100,y:A*100})},u=()=>{l({x:0,y:0}),o({x:50,y:42})};return e.jsxs("main",{className:`kx-page auth-page ${r?"auth-page-login":""} ${s?"auth-page-register":""}`,children:[e.jsx(_t,{nodeColor:"#EC4899",lineColor:"236, 72, 153",secondaryColor:"255, 90, 31",maxDistance:130,speed:.4}),e.jsx("div",{className:"kx-grid","aria-hidden":"true"}),e.jsx("div",{className:"kx-noise","aria-hidden":"true"}),e.jsx("div",{className:"kx-halo kx-halo-top","aria-hidden":"true"}),e.jsx("div",{className:"kx-halo kx-halo-bottom","aria-hidden":"true"}),e.jsx("div",{className:"kx-orb kx-orb-left","aria-hidden":"true"}),e.jsx("div",{className:"kx-orb kx-orb-right","aria-hidden":"true"}),e.jsxs("section",{className:`kx-stage ${s?"kx-stage-wide":""}`,children:[e.jsx("div",{className:"kx-tilt",onPointerMove:c,onPointerLeave:u,onPointerCancel:u,style:{transform:`rotateX(${i.x}deg) rotateY(${i.y}deg)`},children:e.jsxs("div",{className:"kx-card-shell",children:[e.jsx("div",{className:"kx-shadow","aria-hidden":"true"}),e.jsxs("div",{className:"kx-runners","aria-hidden":"true",children:[e.jsx("span",{className:"kx-runner kx-runner-top"}),e.jsx("span",{className:"kx-runner kx-runner-right"}),e.jsx("span",{className:"kx-runner kx-runner-bottom"}),e.jsx("span",{className:"kx-runner kx-runner-left"})]}),e.jsxs("article",{className:"kx-card",children:[e.jsx("div",{className:"kx-pointer-glow","aria-hidden":"true",style:{left:`${n.x}%`,top:`${n.y}%`}}),e.jsx("div",{className:"kx-card-pattern","aria-hidden":"true"}),e.jsxs("header",{className:"kx-header",children:[e.jsx(Z,{to:"/",className:"kx-logo-link","aria-label":"OZILLA FEST Home",children:e.jsxs("div",{className:"kx-logo",children:[e.jsx("img",{src:V("/assets/ozilla/logo.png"),alt:"OZILLA FEST Logo",onError:g=>{g.currentTarget.src=V("/assets/logo.jpeg")}}),e.jsx("i",{"aria-hidden":"true"})]})}),e.jsx("span",{className:"kx-tag",children:"PAKISTAN'S PREMIER MUSIC FESTIVAL"}),e.jsx("h1",{className:"kx-title",children:r?"Welcome Back":"Join OZILLA FEST"}),e.jsx("p",{className:"kx-subtitle",children:r?"Sign in to access your passes, tickets & workspace":"Create your account for the ultimate festival experience"}),e.jsxs("div",{className:"kx-tabs",children:[e.jsx(Z,{to:`/login${a.search}`,className:`kx-tab-btn ${r?"active":""}`,children:"Sign In"}),e.jsx(Z,{to:`/register${a.search}`,className:`kx-tab-btn ${s?"active":""}`,children:"Create Account"})]})]}),e.jsx("div",{className:"kx-card-body",children:t||e.jsx(ht,{})})]})]})}),e.jsxs("div",{className:"auth-center-ribbon",children:[e.jsx("span",{children:"📅 Nov 01, 2026"}),e.jsx("span",{children:"📍 Lahore, Pakistan"}),e.jsx("span",{children:"⭐ 10,000+ Fans"})]})]})]})}function rr({children:t,className:a="",onClick:r,mouseX:s,spring:i,distance:l,magnification:n,baseItemSize:o,label:c}){const u=m.useRef(null),g=ka(0),y=Wt(s,x=>{if(x===1/0||!u.current)return l;const M=u.current.getBoundingClientRect(),j=M.left+M.width/2;return x-j}),k=Wt(y,[-l,0,l],[o,n,o]),A=Oa(k,i),v=x=>{(x.key==="Enter"||x.key===" ")&&(x.preventDefault(),r?.())},p=()=>{g.set(1)},b=()=>{g.set(0)};return e.jsx(J.div,{ref:u,style:{width:A,height:A},onHoverStart:p,onHoverEnd:b,onFocus:p,onBlur:b,onClick:r,className:`dock-item ${a}`,tabIndex:0,role:"button","aria-haspopup":"true","aria-label":c,onKeyDown:v,children:m.Children.map(t,x=>m.cloneElement(x,{isHovered:g}))})}function sr({children:t,className:a="",...r}){const{isHovered:s}=r,[i,l]=m.useState(!1);return m.useEffect(()=>{if(!s)return;const n=s.on("change",o=>{l(o===1)});return()=>n()},[s]),e.jsx(Da,{children:i&&e.jsx(J.div,{initial:{opacity:0,y:-4,scale:.85},animate:{opacity:1,y:0,scale:1},exit:{opacity:0,y:-4,scale:.85},transition:{duration:.15},className:`dock-label ${a}`,role:"tooltip",style:{x:"-50%"},children:t})})}function ir({children:t,className:a=""}){return e.jsx("div",{className:`dock-icon ${a}`,children:t})}function nr({items:t,className:a="",spring:r={mass:.1,stiffness:220,damping:18},magnification:s=52,distance:i=120,panelHeight:l=44,baseItemSize:n=36}){const o=ka(1/0),c=Ze(),u=ct();return e.jsx("div",{className:"dock-outer",children:e.jsx(J.div,{onMouseMove:g=>o.set(g.clientX),onMouseLeave:()=>o.set(1/0),className:`dock-panel ${a}`,style:{height:l},role:"toolbar","aria-label":"Application dock",children:t.map((g,y)=>{const k=c.pathname===g.to||g.to!=="/"&&c.pathname.startsWith(g.to)||g.to==="/"&&c.pathname==="/dashboard";return e.jsxs(rr,{onClick:()=>{g.onClick?.(),g.to&&u(g.to)},className:`${g.className||""} ${k?"active":""}`,mouseX:o,spring:r,distance:i,magnification:s,baseItemSize:n,label:g.label,children:[e.jsx(ir,{children:g.icon}),e.jsx(sr,{children:g.label})]},g.to||y)})})})}function we({path:t,size:a=24,viewBox:r="0 0 24 24",fill:s="none",stroke:i="currentColor",strokeWidth:l=1.8}){return e.jsx("svg",{width:a,height:a,viewBox:r,fill:s,stroke:i,strokeWidth:l,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:t})}const wt={home:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 10.5 12 3l9 7.5"}),e.jsx("path",{d:"M5 9.5V21h14V9.5"}),e.jsx("path",{d:"M9 21v-6h6v6"})]})}),calendar:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"3",y:"4",width:"18",height:"18",rx:"2"}),e.jsx("path",{d:"M16 2v4M8 2v4M3 10h18"})]})}),mic:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"9",y:"2",width:"6",height:"12",rx:"3"}),e.jsx("path",{d:"M5 10a7 7 0 0 0 14 0"}),e.jsx("path",{d:"M12 17v5"})]})}),clock:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("circle",{cx:"12",cy:"12",r:"9"}),e.jsx("path",{d:"M12 7v5l3 3"})]})}),history:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 12a9 9 0 1 0 3-6.7"}),e.jsx("path",{d:"M3 4v5h5"}),e.jsx("path",{d:"M12 8v4l3 2"})]})}),hotels:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M2 21V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v16"}),e.jsx("path",{d:"M2 21h20"}),e.jsx("path",{d:"M6 7h4M6 11h4M14 7h4M14 11h4M6 15h4M14 15h4M6 19h4M14 19h4"})]})}),restaurants:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M4 21v-8a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v8"}),e.jsx("path",{d:"M2 21h20"}),e.jsx("path",{d:"M8 9V3M12 9V3M16 9V3"}),e.jsx("path",{d:"M4 13h16"})]})}),discounts:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M20.6 13.4 12 22 2 12 3.5 4.5 11 3l9.6 10.4Z"}),e.jsx("circle",{cx:"8",cy:"8",r:"1.5"}),e.jsx("path",{d:"m15.5 5.5 4 4"})]})}),facilities:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 21V7l6-4 6 4v14"}),e.jsx("path",{d:"M15 21V9h6v12"}),e.jsx("path",{d:"M3 21h18"}),e.jsx("path",{d:"M7 10h3M7 14h3M7 18h3"})]})}),sponsorship:e.jsx(we,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M12 21s-7.5-4.6-10-9.2C.6 8.6 3 5 6.5 5c2 0 3.5 1 5.5 3 2-2 3.5-3 5.5-3C21 5 23.4 8.6 22 11.8 19.5 16.4 12 21 12 21Z"})})}),sparkle:e.jsx(we,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"m12 3-1.9 5.8a2 2 0 0 1-1.3 1.3L3 12l5.8 1.9a2 2 0 0 1 1.3 1.3L12 21l1.9-5.8a2 2 0 0 1 1.3-1.3L21 12l-5.8-1.9a2 2 0 0 1-1.3-1.3Z"})})}),ticket:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 9V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v3a3 3 0 0 0 0 6v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3a3 3 0 0 0 0-6Z"}),e.jsx("path",{d:"M13 5v2M13 11v2M13 17v2"})]})}),contact:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m3 7 9 6 9-6"})]})}),shield:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M12 22s8-3.6 8-10V5l-8-3-8 3v7c0 6.4 8 10 8 10Z"}),e.jsx("path",{d:"m9 11.5 2 2 4-4"})]})}),user:e.jsx(we,{path:e.jsxs(e.Fragment,{children:[e.jsx("circle",{cx:"12",cy:"8",r:"4"}),e.jsx("path",{d:"M4 21c0-4 4-6 8-6s8 2 8 6"})]})}),menu:e.jsx(we,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M3 6h18M3 12h18M3 18h18"})})}),close:e.jsx(we,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M5 5l14 14M19 5 5 19"})})})},or=[{label:"Home",to:"/#home",icon:"home"},{label:"Ticket Portal",to:"/tickets",icon:"ticket",cta:!0},{label:"Schedule",to:"/schedule",icon:"calendar"},{label:"Lineup",to:"/#celebrities",icon:"mic"},{label:"VIP Passes",to:"/#vip-experience",icon:"ticket"},{label:"Hotels",to:"/hotels",icon:"hotels"},{label:"Facilities",to:"/#facilities",icon:"facilities"},{label:"Sponsorship",to:"/#sponsorship",icon:"sponsorship"},{label:"Atmosphere",to:"/#about",icon:"sparkle"},{label:"My Tickets",to:"/tickets/my-tickets",icon:"ticket"}];function qt(t){return t?.firstName||t?.name||t?.email||"Account"}function Aa(){const{user:t,isAdmin:a,logout:r}=Ke(),s=ct(),i=Ze(),[l,n]=m.useState(!1),[o,c]=m.useState(!1),[u,g]=m.useState(!1),y=m.useRef(null),k=gt.useMemo(()=>{const p=[...or];return a&&p.push({label:"Admin",to:"/admin/dashboard",icon:"shield"}),p},[a]),A=gt.useMemo(()=>k.map(p=>({label:p.label,to:p.to,icon:wt[p.icon],className:p.cta?"dock-item-cta":""})),[k]);m.useEffect(()=>{const p=()=>{y.current||(y.current=window.requestAnimationFrame(()=>{n(window.scrollY>12),y.current=null}))};return p(),window.addEventListener("scroll",p,{passive:!0}),()=>{window.removeEventListener("scroll",p),y.current&&window.cancelAnimationFrame(y.current)}},[]),m.useEffect(()=>{c(!1),g(!1)},[i.pathname]);const v=()=>{r(),s("/")};return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:`dock-site-header ${l?"scrolled":""}`,children:e.jsxs("div",{className:"dock-site-header-inner",children:[e.jsxs(Z,{to:"/",className:"dock-site-brand","aria-label":"Ozilla Fest home",children:[e.jsx("span",{className:"dock-site-brand-logo",children:e.jsx("img",{src:V("/assets/ozilla/logo.png"),alt:"Ozilla Fest",onError:p=>{p.currentTarget.src=V("/assets/company-logo.jpeg")}})}),e.jsx("div",{className:"dock-site-brand-text",children:e.jsx("strong",{children:"OZILLA FEST"})})]}),e.jsx("div",{className:"dock-header-center",children:e.jsx(nr,{items:A,className:"dock-nav",magnification:58,distance:140,panelHeight:62,baseItemSize:44,spring:{mass:.1,stiffness:260,damping:19}})}),e.jsxs("div",{className:"dock-site-header-actions",children:[t?e.jsxs("div",{className:`dock-account ${u?"open":""}`,children:[e.jsxs("button",{type:"button",className:"dock-account-button",onClick:()=>g(p=>!p),"aria-expanded":u,"aria-label":"Account menu",children:[e.jsx("span",{className:"dock-account-avatar",children:String(qt(t)).slice(0,1).toUpperCase()}),e.jsx("strong",{children:qt(t)})]}),e.jsxs("div",{className:"dock-account-menu",children:[e.jsx(Z,{to:"/account",children:"Account"}),e.jsx(Z,{to:"/tickets/my-tickets",children:"My Tickets"}),a&&e.jsx(Z,{to:"/admin/dashboard",children:"Admin Dashboard"}),e.jsx("button",{type:"button",onClick:v,children:"Logout"})]})]}):e.jsxs(e.Fragment,{children:[e.jsx(Z,{to:"/login",className:"dock-site-login-btn",children:"Login"}),e.jsx(Z,{to:"/register",className:"dock-site-register-btn",children:"Sign Up"})]}),e.jsx("button",{type:"button",className:`dock-mobile-toggle ${o?"open":""}`,"aria-label":o?"Close menu":"Open menu","aria-expanded":o,onClick:()=>c(p=>!p),children:o?wt.close:wt.menu})]})]})}),e.jsx("div",{className:`dock-mobile-overlay ${o?"open":""}`,onClick:()=>c(!1),children:e.jsxs("div",{className:`dock-mobile-panel ${o?"open":""}`,onClick:p=>p.stopPropagation(),children:[e.jsxs("div",{className:"dock-mobile-header",children:[e.jsx("div",{children:e.jsx("h2",{children:"Menu"})}),e.jsx("button",{type:"button",className:"dock-mobile-close",onClick:()=>c(!1),"aria-label":"Close menu",children:"x"})]}),e.jsx("div",{className:"dock-mobile-links",children:k.map(p=>e.jsxs(_a,{to:p.to,className:p.cta?"dock-mobile-link-cta":"",onClick:()=>c(!1),children:[e.jsx("span",{className:"dock-mobile-link-icon",children:wt[p.icon]}),e.jsx("span",{children:p.label}),p.cta&&e.jsx("span",{className:"dock-mobile-badge",children:"PASSES"})]},p.to))}),e.jsx("div",{className:"dock-mobile-auth",children:t?e.jsx("button",{type:"button",onClick:()=>{v(),c(!1)},children:"Logout"}):e.jsxs(e.Fragment,{children:[e.jsx(Z,{to:"/login",onClick:()=>c(!1),children:"Login"}),e.jsx(Z,{to:"/register",onClick:()=>c(!1),children:"Sign Up"})]})})]})})]})}const lr=[{label:"Headline Artists",href:"/#celebrities"},{label:"VIP & Ticket Passes",href:"/tickets"},{label:"The Festival Vibe",href:"/#about"},{label:"World-Class Facilities",href:"/#facilities"},{label:"My Digital Passes",href:"/tickets/my-tickets"}],cr=[{label:"Instagram",href:"https://www.instagram.com/ozillafestival"}],dr=[{label:"Sponsorship Inquiries",href:"/#sponsorship"},{label:"QR Ticket Verification",href:"/verification/OZ-2026-PREVIEW"},{label:"Hotel & Travel Partners",href:"/hotels"},{label:"Privacy & Terms",href:"/privacy"}];function Pa(){return e.jsxs(e.Fragment,{children:[e.jsxs("footer",{className:"kex-footer",children:[e.jsx("div",{className:"kex-bg-glow","aria-hidden":"true"}),e.jsx("div",{className:"kex-bg-overlay","aria-hidden":"true"}),e.jsxs("div",{className:"kex-container",children:[e.jsxs("div",{className:"kex-nav-grid",children:[e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"MENU"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:lr.map(t=>e.jsx("li",{children:t.href.startsWith("/#")?e.jsx("a",{href:t.href,children:t.label}):e.jsx(Z,{to:t.href,children:t.label})},t.label))})]}),e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"SOCIALS"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:cr.map(t=>e.jsx("li",{children:e.jsx("a",{href:t.href,target:"_blank",rel:"noopener noreferrer",children:t.label})},t.label))})]}),e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"RESOURCES"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:dr.map(t=>e.jsx("li",{children:t.href.startsWith("/#")?e.jsx("a",{href:t.href,children:t.label}):e.jsx(Z,{to:t.href,children:t.label})},t.label))}),e.jsx("div",{className:"kex-action-wrap",children:e.jsx("a",{href:"mailto:ozillafestival@gmail.com",className:"kex-pill-btn",children:"Send a message"})})]})]}),e.jsx("div",{className:"kex-hero-word-wrap","aria-hidden":"true",children:e.jsx("span",{className:"kex-hero-word",children:"OZILLA FEST"})}),e.jsxs("div",{className:"kex-bottom-row",children:[e.jsxs("div",{className:"kex-bottom-links",children:[e.jsx(Z,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"·"}),e.jsx(Z,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"·"}),e.jsx(Z,{to:"/verification/OZ-2026-PREVIEW",children:"QR Verification"})]}),e.jsx("p",{className:"kex-bottom-copy",children:"© 2026 OZILLA FEST & Prism Entertainment. All rights reserved."})]})]})]}),e.jsx("style",{children:pr})]})}const pr=`
...
`;function Fe({children:t}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-transparent text-white overflow-x-hidden w-full relative z-[1]",children:[e.jsx(Aa,{}),e.jsx("div",{className:"flex-1 w-full overflow-x-hidden bg-transparent",children:t||e.jsx(ht,{})}),e.jsx(Pa,{})]})}function Lt({children:t}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-transparent text-white overflow-x-hidden w-full font-['Plus_Jakarta_Sans',sans-serif] dock-app-shell relative z-[1]",children:[e.jsx(Aa,{}),e.jsx("main",{className:"flex-1 px-4 sm:px-6 py-6 md:py-10 app-main app-content dock-app-content bg-transparent",children:e.jsx("div",{className:"w-full max-w-[1280px] mx-auto",children:t||e.jsx(ht,{})})}),e.jsx(Pa,{})]})}function Ta(){return e.jsx("div",{className:"flex items-center justify-center min-h-[200px]",children:e.jsx("div",{className:"animate-spin rounded-full h-16 w-16 border-4 border-purple-600 border-t-transparent"})})}function mr(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m4 7 8 6 8-6"})]})}function fr(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"4",y:"10",width:"16",height:"11",rx:"2"}),e.jsx("path",{d:"M8 10V7a4 4 0 0 1 8 0v3"})]})}function ur({hidden:t=!1,...a}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...a,children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"}),t&&e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}function gr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M5 12h14M13 6l6 6-6 6"})})}function hr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"m5 12 4 4L19 6"})})}function xr(t){return e.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",...t,children:[e.jsx("path",{fill:"#4285F4",d:"M21.6 12.23c0-.71-.06-1.4-.18-2.06H12v3.9h5.38a4.6 4.6 0 0 1-2 3.01v2.53h3.23c1.9-1.75 2.99-4.32 2.99-7.38Z"}),e.jsx("path",{fill:"#34A853",d:"M12 22c2.7 0 4.97-.9 6.62-2.39l-3.23-2.53c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.61-4.13H3.05v2.61A10 10 0 0 0 12 22Z"}),e.jsx("path",{fill:"#FBBC05",d:"M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.3.31-1.91V7.48H3.05A10 10 0 0 0 2 12c0 1.61.39 3.14 1.05 4.52l3.34-2.61Z"}),e.jsx("path",{fill:"#EA4335",d:"M12 5.96c1.47 0 2.79.51 3.82 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.95 5.48l3.34 2.61C7.18 7.72 9.39 5.96 12 5.96Z"})]})}function br(){const t=ct(),a=Ze(),{login:r,checkAuth:s}=Ke(),i="",l=new URLSearchParams(a.search).get("returnTo"),n=St(l,"/dashboard"),[o,c]=m.useState({email:"",password:""}),[u,g]=m.useState(null),[y,k]=m.useState(!1),[A,v]=m.useState(!0),[p,b]=m.useState(""),[x,M]=m.useState(""),[j,f]=m.useState(!1),[d,B]=m.useState(!1),L=w=>{M(""),c(R=>({...R,[w.target.name]:w.target.value}))},P=async w=>{if(w.preventDefault(),!(j||d)){b(""),M(""),f(!0);try{await r({email:String(o.email||"").trim().toLowerCase(),password:String(o.password||"")}),M("Login successful. Preparing your festival workspace..."),await new Promise(R=>setTimeout(R,450)),t(n)}catch(R){b(R.response?.data?.message||R.message||"Invalid email or password")}finally{f(!1)}}},h=async()=>{b(""),M(""),B(!0);try{if(!(i&&!i.includes("placeholder")&&!i.includes("your_google"))){const w=await Xe.googleAuth("local-dev-token",{email:"ubair1100@gmail.com",name:"Ubair Naeem",given_name:"Ubair",family_name:"Naeem"});Se.setToken(w.token),await s(),M("Google sign-in verified. Welcome back!"),await new Promise(R=>setTimeout(R,450)),t(n)}}catch(w){const R=w.response?.data?.message||w.message||"Google sign-in failed";R.toLowerCase().includes("cancel")||b(R)}finally{B(!1)}};return e.jsxs("form",{onSubmit:P,className:"kx-form",children:[p&&e.jsx("div",{className:"kx-alert kx-alert-error",role:"alert",children:p}),x&&e.jsx("div",{className:"kx-alert kx-alert-success",role:"alert",children:x}),e.jsxs("button",{type:"button",className:"kx-google",onClick:h,disabled:d||j,children:[e.jsx(xr,{}),e.jsx("span",{children:d?"Connecting to Google...":"Continue with Google"}),e.jsx("i",{"aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-divider",children:[e.jsx("span",{}),e.jsx("em",{children:"or sign in with email"}),e.jsx("span",{})]}),e.jsxs("label",{className:`kx-field ${u==="email"?"kx-focused":""}`,children:[e.jsx(mr,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"email",value:o.email,placeholder:"Email or Mobile Number",autoComplete:"username",required:!0,onChange:L,onFocus:()=>g("email"),onBlur:()=>g(null)}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("label",{className:`kx-field ${u==="password"?"kx-focused":""}`,children:[e.jsx(fr,{className:"kx-field-icon"}),e.jsx("input",{type:y?"text":"password",name:"password",value:o.password,placeholder:"Password",autoComplete:"current-password",required:!0,onChange:L,onFocus:()=>g("password"),onBlur:()=>g(null)}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>k(w=>!w),"aria-label":y?"Hide password":"Show password",children:e.jsx(ur,{hidden:y})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-meta",children:[e.jsxs("label",{className:"kx-remember",children:[e.jsx("input",{type:"checkbox",checked:A,onChange:w=>v(w.target.checked)}),e.jsx("span",{className:"kx-checkbox",children:A&&e.jsx(hr,{})}),e.jsx("span",{children:"Remember me"})]}),e.jsx("a",{href:"#forgot-password",className:"kx-forgot-link",children:"Forgot password?"})]}),e.jsxs("button",{className:"kx-sign-in",type:"submit",disabled:j||d,children:[e.jsx("span",{className:"kx-button-glow","aria-hidden":"true"}),e.jsx("span",{className:"kx-button-sheen","aria-hidden":"true"}),j?e.jsx("span",{className:"kx-spinner","aria-label":"Signing in..."}):e.jsxs("span",{className:"kx-button-copy",children:["Sign in",e.jsx(gr,{})]})]}),e.jsxs("p",{className:"kx-signup",children:["Don't have an account?"," ",e.jsx(Z,{to:`/register?${new URLSearchParams({returnTo:n}).toString()}`,children:"Create account"})]}),e.jsxs("div",{className:"kx-trust-grid","aria-label":"Security indicators",children:[e.jsx("span",{children:"🔒 Secure Login"}),e.jsx("span",{children:"⚡ Fast Access"}),e.jsx("span",{children:"🛡️ Protected"}),e.jsx("span",{children:"✓ Verified"})]})]})}function yr(){return e.jsxs("div",{className:"auth-form-container",children:[e.jsx(br,{}),e.jsxs("div",{className:"auth-footer-links",children:[e.jsx(Z,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"•"}),e.jsx(Z,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"•"}),e.jsx(Z,{to:"/#contact",children:"Need Help?"})]})]})}function Xt(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("path",{d:"M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"}),e.jsx("circle",{cx:"12",cy:"7",r:"4"})]})}function vr(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m4 7 8 6 8-6"})]})}function wr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"})})}function Zt(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"4",y:"10",width:"16",height:"11",rx:"2"}),e.jsx("path",{d:"M8 10V7a4 4 0 0 1 8 0v3"})]})}function Kt({hidden:t=!1,...a}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...a,children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"}),t&&e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}function kr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M5 12h14M13 6l6 6-6 6"})})}function jr(t){return e.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",...t,children:[e.jsx("path",{fill:"#4285F4",d:"M21.6 12.23c0-.71-.06-1.4-.18-2.06H12v3.9h5.38a4.6 4.6 0 0 1-2 3.01v2.53h3.23c1.9-1.75 2.99-4.32 2.99-7.38Z"}),e.jsx("path",{fill:"#34A853",d:"M12 22c2.7 0 4.97-.9 6.62-2.39l-3.23-2.53c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.61-4.13H3.05v2.61A10 10 0 0 0 12 22Z"}),e.jsx("path",{fill:"#FBBC05",d:"M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.3.31-1.91V7.48H3.05A10 10 0 0 0 2 12c0 1.61.39 3.14 1.05 4.52l3.34-2.61Z"}),e.jsx("path",{fill:"#EA4335",d:"M12 5.96c1.47 0 2.79.51 3.82 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.95 5.48l3.34 2.61C7.18 7.72 9.39 5.96 12 5.96Z"})]})}const Jt=()=>new Promise(t=>setTimeout(t,450));function Nr(){const t=ct(),a=Ze(),{register:r,checkAuth:s}=Ke(),i="",l=new URLSearchParams(a.search).get("returnTo"),n=St(l,"/dashboard"),[o,c]=m.useState({firstName:"",lastName:"",email:"",phone:"",password:"",confirmPassword:""}),[u,g]=m.useState(null),[y,k]=m.useState(""),[A,v]=m.useState(!1),[p,b]=m.useState(!1),[x,M]=m.useState(!1),[j,f]=m.useState(!1),[d,B]=m.useState(0),[L,P]=m.useState(""),[h,w]=m.useState(""),[R,I]=m.useState(!1),[q,$]=m.useState(!1),[T,U]=m.useState(!1),[X,H]=m.useState(!1),[F,O]=m.useState({email:!1,phone:!1,password:!1,confirmPassword:!1}),Y=/^\S+@\S+\.\S+$/.test(o.email),de=/^(\+?\d{1,3})?[\s-]?\d{10,12}$/.test(o.phone.replace(/\s+/g,"")),N={upper:/[A-Z]/.test(o.password),lower:/[a-z]/.test(o.password),number:/\d/.test(o.password),special:/[^A-Za-z0-9]/.test(o.password),length:o.password.length>=8},z=Object.values(N).filter(Boolean).length,D=z===5,C=o.confirmPassword.length>0&&o.password===o.confirmPassword,_=o.password.length>0,ae=m.useMemo(()=>_?z<=2?{label:"Weak",className:"weak",percent:28}:z===3?{label:"Medium",className:"medium",percent:52}:z===4?{label:"Strong",className:"strong",percent:78}:{label:"Excellent",className:"excellent",percent:100}:{label:"Start typing",className:"empty",percent:8},[_,z]),Q=[{key:"upper",text:"Uppercase letter",met:N.upper},{key:"lower",text:"Lowercase letter",met:N.lower},{key:"number",text:"Number",met:N.number},{key:"special",text:"Special character",met:N.special},{key:"length",text:"8+ characters",met:N.length}],ce=o.firstName.trim()&&o.lastName.trim()&&Y&&de&&D&&C&&p&&!R&&!q;m.useEffect(()=>{if(d<=0)return;const S=window.setInterval(()=>{B(E=>Math.max(0,E-1))},1e3);return()=>window.clearInterval(S)},[d]);const re=()=>{P(""),w("")},ne=S=>{const{name:E,value:oe}=S.target;re(),c(te=>({...te,[E]:oe})),E==="email"&&(k(""),v(!1),b(!1),B(0)),E in F&&oe.length>0&&O(te=>({...te,[E]:!0}))},me=S=>{const{name:E}=S.target;g(null),E in F&&O(oe=>({...oe,[E]:!0}))},ye=async()=>{if(re(),!Y){O(S=>({...S,email:!0})),P("Please enter a valid email address before sending OTP.");return}M(!0);try{const S=await Xe.sendOtp(o.email);S?.emailDelivery==="failed"||typeof S?.message=="string"&&S.message.toLowerCase().includes("delivery failed")?(v(!1),P(S.emailError||"Email delivery failed: SMTP credentials (SMTP_USER and SMTP_PASS) are not configured on the backend server.")):(v(!0),b(!1),B(60),k(""),w(S.message||"OTP code has been sent to your email. Please check your inbox."))}catch(S){P(S.response?.data?.message||S.message||"Unable to send OTP.")}finally{M(!1)}},fe=async()=>{if(re(),!Y||y.trim().length<4){P("Enter the OTP sent to your email.");return}f(!0);try{const S=await Xe.verifyOtp({email:o.email,otp:y});b(!0),w(S.message||"Email verified successfully.")}catch(S){b(!1),P(S.response?.data?.message||S.message||"OTP verification failed.")}finally{f(!1)}},se=async S=>{if(S.preventDefault(),re(),!Y){O(E=>({...E,email:!0})),P("Please enter a valid email address.");return}if(!p){P("Please verify your email OTP before creating your account.");return}if(!de){O(E=>({...E,phone:!0})),P("Please enter a valid mobile number.");return}if(!D){O(E=>({...E,password:!0})),P("Please satisfy all password requirements.");return}if(!C){O(E=>({...E,confirmPassword:!0})),P("Passwords do not match.");return}I(!0);try{await r({firstName:o.firstName,lastName:o.lastName,name:`${o.firstName} ${o.lastName}`.trim(),email:o.email,phone:o.phone,password:o.password}),w("Account created successfully. Preparing your festival workspace..."),await Jt(),t(n)}catch(E){const oe=E.response?.status,te=E.response?.data?.message||"Registration failed",ie=te.toLowerCase();oe===409||ie.includes("already")||ie.includes("exists")?P("Account already exists with this email or phone number"):P(te)}finally{I(!1)}},G=async()=>{re(),$(!0);try{if(!(i&&!i.includes("placeholder")&&!i.includes("your_google"))){const S=await Xe.googleAuth("local-dev-token",{email:"ubair1100@gmail.com",name:"Ubair Naeem",given_name:"Ubair",family_name:"Naeem"});Se.setToken(S.token),await s(),w("Google sign-up verified. Welcome to OZILLA FEST!"),await Jt(),t(n)}}catch(S){const E=S.response?.data?.message||S.message||"Google sign-up failed";E.toLowerCase().includes("cancel")||P(E)}finally{$(!1)}};return e.jsxs("form",{onSubmit:se,className:"kx-form",children:[L&&e.jsx("div",{className:"kx-alert kx-alert-error",role:"alert",children:L}),h&&e.jsx("div",{className:"kx-alert kx-alert-success",role:"alert",children:h}),e.jsxs("button",{type:"button",className:"kx-google",onClick:G,disabled:q||R,children:[e.jsx(jr,{}),e.jsx("span",{children:q?"Connecting to Google...":"Sign up with Google"}),e.jsx("i",{"aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-divider",children:[e.jsx("span",{}),e.jsx("em",{children:"or register with email"}),e.jsx("span",{})]}),e.jsxs("div",{className:"kx-grid-row",children:[e.jsxs("label",{className:`kx-field ${u==="firstName"?"kx-focused":""}`,children:[e.jsx(Xt,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"firstName",value:o.firstName,placeholder:"First Name",autoComplete:"given-name",required:!0,onChange:ne,onFocus:()=>g("firstName"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("label",{className:`kx-field ${u==="lastName"?"kx-focused":""}`,children:[e.jsx(Xt,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"lastName",value:o.lastName,placeholder:"Last Name",autoComplete:"family-name",required:!0,onChange:ne,onFocus:()=>g("lastName"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]})]}),e.jsxs("label",{className:`kx-field ${u==="email"?"kx-focused":""} ${F.email&&!Y?"kx-field-invalid":""}`,children:[e.jsx(vr,{className:"kx-field-icon"}),e.jsx("input",{type:"email",name:"email",value:o.email,placeholder:"Email address",autoComplete:"email",required:!0,onChange:ne,onFocus:()=>g("email"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),F.email&&!Y&&e.jsx("p",{className:"kx-field-error-msg",children:"Please enter a valid email address."}),e.jsxs("div",{className:`kx-otp-box ${p?"kx-otp-verified":""}`,children:[e.jsxs("div",{className:"kx-otp-meta",children:[e.jsx("span",{className:"kx-otp-kicker",children:"Email Verification"}),e.jsx("strong",{children:p?"✓ Email verified":A?"Enter 6-digit code":"Verify email before submit"}),e.jsx("span",{className:"kx-otp-subtext",children:p?"Security verified":d>0?`Resend available in ${d}s`:"Code will be sent to your email"})]}),e.jsxs("div",{className:"kx-otp-controls",children:[e.jsx("button",{type:"button",className:"kx-otp-btn",onClick:ye,disabled:x||!Y||p||d>0,children:x?"Sending...":A?"Resend OTP":"Send OTP"}),e.jsx("input",{type:"text",value:y,onChange:S=>{re(),k(S.target.value.replace(/\D/g,"").slice(0,6)),b(!1)},className:"kx-otp-input",placeholder:"Enter 6-digit OTP",inputMode:"numeric",autoComplete:"one-time-code",disabled:!A||p}),e.jsx("button",{type:"button",className:"kx-otp-btn kx-otp-btn-accent",onClick:fe,disabled:!A||p||j,children:j?"Verifying...":p?"Verified":"Verify"})]})]}),e.jsxs("label",{className:`kx-field ${u==="phone"?"kx-focused":""} ${F.phone&&!de?"kx-field-invalid":""}`,children:[e.jsx(wr,{className:"kx-field-icon"}),e.jsx("input",{type:"tel",name:"phone",value:o.phone,placeholder:"Phone (+92 3XX XXXXXXX)",autoComplete:"tel",required:!0,onChange:ne,onFocus:()=>g("phone"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),F.phone&&!de&&e.jsx("p",{className:"kx-field-error-msg",children:"Please enter a valid mobile number."}),e.jsxs("label",{className:`kx-field ${u==="password"?"kx-focused":""} ${F.password&&!D?"kx-field-invalid":""}`,children:[e.jsx(Zt,{className:"kx-field-icon"}),e.jsx("input",{type:T?"text":"password",name:"password",value:o.password,placeholder:"Create Password",autoComplete:"new-password",required:!0,onChange:ne,onFocus:()=>g("password"),onBlur:me}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>U(S=>!S),"aria-label":T?"Hide password":"Show password",children:e.jsx(Kt,{hidden:T})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("div",{className:`kx-strength kx-strength-${ae.className}`,children:[e.jsxs("div",{className:"kx-strength-header",children:[e.jsx("span",{children:"Password Strength"}),e.jsx("strong",{children:ae.label})]}),e.jsx("div",{className:"kx-strength-bar-track",children:e.jsx("span",{style:{width:`${ae.percent}%`}})})]}),e.jsx("ul",{className:"kx-pwd-rules",children:Q.map(S=>{const E=S.met?"kx-rule-met":_?"kx-rule-unmet":"kx-rule-neutral";return e.jsxs("li",{className:`kx-pwd-rule ${E}`,children:[e.jsx("span",{className:"kx-rule-badge",children:S.met?"✓":"•"}),e.jsx("span",{children:S.text})]},S.key)})}),e.jsxs("label",{className:`kx-field ${u==="confirmPassword"?"kx-focused":""} ${F.confirmPassword&&!C?"kx-field-invalid":""}`,children:[e.jsx(Zt,{className:"kx-field-icon"}),e.jsx("input",{type:X?"text":"password",name:"confirmPassword",value:o.confirmPassword,placeholder:"Confirm Password",autoComplete:"new-password",required:!0,onChange:ne,onFocus:()=>g("confirmPassword"),onBlur:me}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>H(S=>!S),"aria-label":X?"Hide confirm password":"Show confirm password",children:e.jsx(Kt,{hidden:X})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),F.confirmPassword&&!C&&e.jsx("p",{className:"kx-field-error-msg",children:"Passwords do not match."}),e.jsxs("button",{className:"kx-sign-in",type:"submit",disabled:!ce,children:[e.jsx("span",{className:"kx-button-glow","aria-hidden":"true"}),e.jsx("span",{className:"kx-button-sheen","aria-hidden":"true"}),R?e.jsx("span",{className:"kx-spinner","aria-label":"Creating account..."}):e.jsxs("span",{className:"kx-button-copy",children:["Create Account",e.jsx(kr,{})]})]}),e.jsxs("p",{className:"kx-signup",children:["Already have an account?"," ",e.jsx(Z,{to:`/login?${new URLSearchParams({returnTo:n}).toString()}`,children:"Sign In"})]}),e.jsxs("div",{className:"kx-trust-grid","aria-label":"Security indicators",children:[e.jsx("span",{children:"🔒 Secure Sign Up"}),e.jsx("span",{children:"⚡ Instant Access"}),e.jsx("span",{children:"🛡️ Protected"}),e.jsx("span",{children:"✓ Google Verified"})]})]})}function Sr(){return e.jsxs("div",{className:"auth-form-container",children:[e.jsx(Nr,{}),e.jsxs("div",{className:"auth-footer-links",children:[e.jsx(Z,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"•"}),e.jsx(Z,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"•"}),e.jsx(Z,{to:"/#contact",children:"Need Help?"})]})]})}function Ar(){const[t]=$a(),a=ct(),{checkAuth:r}=Ke(),[s,i]=m.useState("Signing you in with Google...");return m.useEffect(()=>{(async()=>{const n=t.get("token"),o=t.get("error"),c=t.get("returnTo"),u=St(c,"/dashboard");if(o){i(o==="google_not_configured"?"Google sign-in is not configured on server yet. Please add GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in server/.env.":"Google sign-in failed. Please try again.");const g=new URLSearchParams({returnTo:u}).toString();setTimeout(()=>a(`/login?${g}`,{replace:!0}),1200);return}if(!n){i("Google sign-in token not found. Please try again.");const g=new URLSearchParams({returnTo:u}).toString();setTimeout(()=>a(`/login?${g}`,{replace:!0}),1200);return}Se.setToken(n),await r(),a(u,{replace:!0})})()},[r,a,t]),e.jsx("div",{className:"auth-page",children:e.jsxs("div",{className:"auth-card",children:[e.jsx("h1",{className:"auth-title",children:"Google Sign-In"}),e.jsx("p",{className:"auth-subtitle",children:s})]})})}const Pr={hotels:[{name:"Pearl Continental Hotel (PC)",location:"Lahore, Punjab, Pakistan",rates:"Premium city-center business and leisure rates",offer:"Flexible booking options with conference and dining access.",website:"https://www.expedia.com/Lahore-Hotels-Pearl-Continental-Lahore.h6062.Hotel-Information?chkin=2026-07-23&chkout=2026-07-24&x_pwa=1&rfrr=HSR&pwa_ts=1783538185568&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=2068&destination=Lahore%2C+Punjab%2C+Pakistan&destType=MARKET&neighborhoodId=553248633981712959&selected=6062&latLong=31.554606%2C74.357155&sort=RECOMMENDED&top_dp=124&top_cur=USD&semcid=US.UB.BING.PT-c-EN.HOTEL&semdtl=a1429012176.b11315017303776210.g1kwd-82189323842618%3Aloc-144.e1c.m18d15bbf2af6c1d752fa9d1bc0e925b82.r1dbbc4399e805d7a471af9bb50c0eca6a53815556874c850795d8066b3e568804.c1.j1142691.k1152882.d182188878595064.h1e.i1.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&userIntent=&selectedRoomType=314006270&selectedRatePlan=380046345&categorySearch=any_option&searchId=60a6b42e-b43b-44af-a668-54a0fbd95022",image:V("/assets/hotels/Pearl-Continental-Lahore.jpg"),showImage:!0,description:"A flagship five-star property known for premium hospitality, executive facilities, and large event spaces.",facilities:["Luxury Rooms & Suites","Restaurants & Coffee Lounge","Swimming Pool","Fitness Center"],contact:"Reservations: +92 42 111 505 505",rating:"4.5/5"},{name:"Ramada by Wyndham Lahore",location:"Lahore, Punjab, Pakistan",rates:"Business-friendly international chain pricing",offer:"Comfort-focused stay packages with central access.",website:"https://www.guestreservations.com/ramada-by-wyndham-lahore-gulberg-ii/booking?utm_source=microsoft&utm_medium=cpc&utm_campaign=318380766&msclkid=2639f60cc7641752938d9c426507dbb5&ctTriggered=true",image:V("/assets/hotels/Ramada-by-Wyndham-Lahore-Gulberg-II.jpg"),showImage:!0,description:"An international-branded stay option designed for business travelers and families seeking modern comfort.",facilities:["Comfort Rooms","All-Day Dining","Meeting Facilities","Wi-Fi Access"],contact:"Reservations: +92 42 111 111 211",rating:"4.3/5"},{name:"Hotel Indigo Lahore",location:"Lahore, Punjab, Pakistan",rates:"Boutique premium rates for curated city stays",offer:"Lifestyle stay experience with modern interiors and city vibe.",website:"https://indigoheights.com/",image:V("/assets/hotels/Hotel-Indigo.jpg"),showImage:!0,description:"A contemporary boutique-style hotel brand experience offering design-led rooms and premium hospitality.",facilities:["Designer Rooms","Signature Dining","Fitness Facilities","Business Services"],contact:"Reservations: +92 42 111 111 111",rating:"4.4/5"},{name:"Hotel One Gulberg Lahore",location:"Lahore, Punjab, Pakistan",rates:"Upper-midscale corporate and family packages",offer:"Value-focused business stays in a prime Lahore district.",website:"https://www.guestreservations.com/hotel-one-gulberg-lahore/booking?utm_source=microsoft&utm_medium=cpc&utm_campaign=318380766&msclkid=3d22881e8b211d72a380e25028093b5b",image:V("/assets/hotels/Hotel-One-Gulberg-Lahore.jpg"),showImage:!0,description:"A trusted local hospitality brand known for practical comfort, business convenience, and central location.",facilities:["Business-Friendly Rooms","Breakfast Service","Meeting Room","24/7 Front Desk"],contact:"Reservations: +92 42 111 111 563",rating:"4.2/5"},{name:"Luxus Grand Hotel (LC)",location:"Lahore, Punjab, Pakistan",rates:"Executive and leisure stay rates",offer:"City-center premium rooms with event-friendly access.",website:"https://www.expedia.com/Lahore-Hotels-Luxus-Grand-Hotel.h16225098.Hotel-Information?chkin=2026-07-23&chkout=2026-07-24&x_pwa=1&rfrr=HSR&pwa_ts=1783538679588&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=2068&destination=Lahore%2C+Punjab%2C+Pakistan&destType=MARKET&selected=16225098&latLong=31.554606%2C74.357155&sort=RECOMMENDED&top_dp=50&top_cur=USD&semcid=US.UB.BING.PT-c-EN.HOTEL&semdtl=a1429012176.b11317216326895908.g1kwd-82326765629610%3Aloc-144.e1c.m1f413ae58b13f11ee7d78c41612f456b3.r17441980d01bf266109c2845e02c5e619d691d9360faf76d1fb0b3ff083f73b12.c1.j1142691.k1152882.d182326298507125.h1e.i1.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&userIntent=&selectedRoomType=201690559&selectedRatePlan=208425873&categorySearch=any_option&searchId=b938991e-d9ee-47cd-a5b9-bfbbe22962a7",image:V("/assets/hotels/Luxus-Grand-Hotel.jpg"),showImage:!0,description:"A modern luxury hotel in Lahore offering upscale rooms, contemporary dining, and premium guest services.",facilities:["Premium Rooms","Restaurant & Cafe","Concierge Support","Airport Transfer Assistance"],contact:"Reservations: +92 42 111 589 879",rating:"4.4/5"},{name:"Nishat Hotel Lahore",location:"Lahore, Punjab, Pakistan",rates:"Premium luxury rates with lifestyle amenities",offer:"High-end accommodation with shopping and dining proximity.",website:"https://www.booking.com/hotel/pk/the-nishat.en-gb.html?aid=2276380&label=msn-G%2AualcbtRsY8_D6yMU0tng-80333218529225%3Atikwd-80333372562144%3Aloc-144%3Aneo%3Amte%3Alp142691%3Adec%3Acid578349423%3Aagid1285329581450391%3Aclkid91bc1c0fd2ae13842aa77641760a897b&sid=d2e80396e6c920f70a72e21ba196f068&all_sr_blocks=112449101_204759422_0_2_0_670390&checkin=2026-07-14&checkout=2026-07-15&dest_id=-2767043&dest_type=city&dist=0&group_adults=2&group_children=0&hapos=1&highlighted_blocks=112449101_204759422_0_2_0_670390&hpos=1&matching_block_id=112449101_204759422_0_2_0_670390&no_rooms=1&req_adults=2&req_children=0&room1=A%2CA&sb_price_type=total&sr_order=popularity&sr_pri_blocks=112449101_204759422_0_2_0_670390_3300000&srepoch=1783539000&srpvid=7c17890e04e000e0&type=total&ucfs=1&",image:V("/assets/hotels/Nishat.jpg"),showImage:!0,description:"A luxury Lahore hospitality brand recognized for refined interiors, premium service standards, and prime locations.",facilities:["Luxury Suites","Fine Dining","Spa & Wellness","Event and Meeting Spaces"],contact:"Reservations: +92 42 111 647 428",rating:"4.6/5"}]};V("/assets/ozilla/talwinder.jpg"),V("/assets/ozilla/talwinder.jpg"),V("/assets/ozilla/Imran-Khan.jpg"),V("/assets/ozilla/Imran-Khan.jpg"),V("/assets/ozilla/Bohemia.jpg"),V("/assets/ozilla/Bohemia.jpg"),V("/assets/ozilla/hassan-raheem.jpg"),V("/assets/ozilla/hassan-raheem.jpg");const Qt=[{name:"TALWINDER",isHeadliner:!0,genre:"Indie Pop / Punjabi Fusion",stage:"Main Prism Stage",bpm:"128 BPM",vibe:"Euphoric Night",src:V("/assets/ozilla/talwinder.jpg"),image:V("/assets/ozilla/talwinder.jpg"),offsetY:0},{name:"IMRAN KHAN",isHeadliner:!1,genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",src:V("/assets/ozilla/Imran-Khan.jpg"),image:V("/assets/ozilla/Imran-Khan.jpg"),offsetY:0},{name:"BOHEMIA",isHeadliner:!1,genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",src:V("/assets/ozilla/Bohemia.jpg"),image:V("/assets/ozilla/Bohemia.jpg"),offsetY:0},{name:"HASSAN RAHEEM",isHeadliner:!1,genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",src:V("/assets/ozilla/hassan-raheem.jpg"),image:V("/assets/ozilla/hassan-raheem.jpg"),offsetY:0}],ea=1.28,ta=.78;function Ve(t,a,r){return Math.min(r,Math.max(a,t))}function aa(t){if(!t)return null;if(typeof t=="string")return t||null;const a=t.src||t.image;return typeof a=="string"&&a?a:null}function Tr(t){return aa(t&&typeof t=="object"&&(t.image||t.src)||t)}function Er(t){if(t&&typeof t=="object"&&"offsetY"in t){const a=t.offsetY;return typeof a=="number"&&isFinite(a)?a:0}return 0}function Cr({items:t=Qt,images:a,slideWidth:r=320,slideHeight:s=440,spacing:i=2.4,direction:l="right",smoothness:n=8.5,radius:o=24,dim:c=5,background:u="transparent",sensitivity:g=5,autoPlay:y=!1,autoPlayInterval:k=3500,style:A,onItemClick:v}){const p=m.useRef(null),b=m.useRef([]),x=m.useRef(0),M=m.useRef(0),[j,f]=m.useState(0),[d,B]=m.useState(!1),[L,P]=m.useState(0),h=t&&t.length>0?t:a&&a.length>0?a:Qt,w=m.useMemo(()=>h.map((N,z)=>({...N,src:Tr(N),offsetY:Er(N),name:N.name||`Artist ${z+1}`,genre:N.genre||"Live Performer",stage:N.stage||"Ozilla Arena",bpm:N.bpm||"128 BPM",vibe:N.vibe||"Festival Energy",isHeadliner:!!N.isHeadliner})),[h]),R=j>0&&j<640?Math.min(r,250):j<1024?Math.min(r,290):r,I=j>0&&j<640?Math.round(R*1.36):s,q=R+Ve(i,0,10)*18,$=.15-Ve(n,0,10)/10*.11,T=Ve(c,0,10)/10*.75,U=.4+Ve(g,0,10)/10*1.1,X=.6+Ve(g,0,10)/10*1.6,H=l==="left",F=m.useRef({count:w.length,step:q,slideWidth:R,width:j,ease:$,maxScale:ea,minScale:ta,dim:T,loop:!1,flip:H});F.current={count:w.length,step:q,slideWidth:R,width:j,ease:$,maxScale:ea,minScale:ta,dim:T,loop:!1,flip:H};const O=m.useRef({wheelMultiplier:U,dragMultiplier:X,flip:H});O.current={wheelMultiplier:U,dragMultiplier:X,flip:H},m.useEffect(()=>{const N=p.current;if(!N)return;const z=new ResizeObserver(D=>{D[0]&&f(D[0].contentRect.width)});return z.observe(N),f(N.getBoundingClientRect().width),()=>z.disconnect()},[]),m.useEffect(()=>{b.current.length=w.length},[w.length]),m.useEffect(()=>{if(!y||d||w.length<=1)return;const N=setInterval(()=>{P(z=>{const D=(z+1)%w.length;return x.current=D*q,D})},k);return()=>clearInterval(N)},[y,d,w.length,q,k]),m.useEffect(()=>{let N=0,z=0;const D=C=>{N=requestAnimationFrame(D);const _=F.current,ae=z?Math.min((C-z)/1e3,.1):1/60;if(z=C,!_.count||_.step<=0||_.width<=0)return;const Q=(_.count-1)*_.step;x.current=Ve(x.current,0,Q);const ce=1-Math.pow(1-_.ease,ae*60);M.current+=(x.current-M.current)*ce;const re=Math.round(M.current/_.step);re>=0&&re<_.count&&P(re);const ne=(_.width-_.slideWidth)/2,me=_.width/2;for(let ye=0;ye<_.count;ye+=1){const fe=b.current[ye];if(!fe)continue;const G=ye*_.step-M.current+ne,S=G+_.slideWidth/2-me;let E,oe;S>0?(E=Math.min(_.maxScale,1+S/_.width*.45),oe=(E-1)*_.slideWidth*.35):(E=Math.max(_.minScale,1+S/_.width*.5),oe=0);const te=_.flip?_.width-_.slideWidth-(G+oe):G+oe;if(fe.style.transform=`translate3d(${te}px, -50%, 0) scale(${E})`,_.dim>0&&E<1){const ie=(1-E)/Math.max(.001,1-_.minScale);fe.style.filter=`brightness(${Math.max(.35,1-ie*_.dim)})`}else fe.style.filter="none"}};return N=requestAnimationFrame(D),()=>cancelAnimationFrame(N)},[]),m.useEffect(()=>{const N=p.current;if(!N)return;const z=D=>{D.preventDefault();const C=Math.abs(D.deltaX)>Math.abs(D.deltaY)?D.deltaX:D.deltaY;x.current+=C*O.current.wheelMultiplier};return N.addEventListener("wheel",z,{passive:!1}),()=>N.removeEventListener("wheel",z)},[]),m.useEffect(()=>{const N=p.current;if(!N)return;let z=null,D=0;const C=Q=>{if(z===null){z=Q.pointerId,D=Q.clientX;try{N.setPointerCapture(Q.pointerId)}catch{}}},_=Q=>{if(z!==Q.pointerId)return;const ce=Q.clientX-D;D=Q.clientX,x.current+=(O.current.flip?ce:-ce)*O.current.dragMultiplier},ae=Q=>{if(z===Q.pointerId){z=null;try{N.hasPointerCapture(Q.pointerId)&&N.releasePointerCapture(Q.pointerId)}catch{}}};return N.addEventListener("pointerdown",C),N.addEventListener("pointermove",_),N.addEventListener("pointerup",ae),N.addEventListener("pointercancel",ae),()=>{N.removeEventListener("pointerdown",C),N.removeEventListener("pointermove",_),N.removeEventListener("pointerup",ae),N.removeEventListener("pointercancel",ae)}},[]);const Y=m.useCallback(N=>{const z=Ve(N,0,w.length-1);x.current=z*q,P(z)},[w.length,q]),de=m.useCallback(N=>{const z=Ve(L+(N==="left"?-1:1),0,w.length-1);Y(z)},[L,Y,w.length]);return e.jsxs("div",{style:{position:"relative",width:"100%",display:"flex",flexDirection:"column",alignItems:"center",margin:"1.2rem 0"},onMouseEnter:()=>B(!0),onMouseLeave:()=>B(!1),children:[e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",flexWrap:"wrap",gap:"8px",marginBottom:"1rem",zIndex:10},children:w.map((N,z)=>{const D=z===L;return e.jsx("button",{type:"button",onClick:()=>Y(z),style:{padding:"6px 14px",borderRadius:"999px",border:D?"1px solid #ff8a3d":"1px solid rgba(255, 255, 255, 0.12)",background:D?"linear-gradient(135deg, rgba(255, 138, 61, 0.32), rgba(255, 90, 31, 0.22))":"rgba(20, 10, 6, 0.55)",color:D?"#ffbd59":"rgba(255, 255, 255, 0.65)",fontSize:"0.78rem",fontWeight:D?"850":"650",letterSpacing:"0.04em",cursor:"pointer",transition:"all 200ms ease",backdropFilter:"blur(8px)",boxShadow:D?"0 0 16px rgba(255, 138, 61, 0.35)":"none"},children:N.name},N.name)})}),e.jsx("div",{ref:p,className:"smooth-scroll-slider-viewport",style:{position:"relative",width:"100%",height:`${I+50}px`,overflow:"hidden",background:u,cursor:"grab",touchAction:"pan-y",opacity:j>0?1:0,transition:"opacity 0.35s ease",userSelect:"none",...A},children:w.map((N,z)=>{const D=N.isHeadliner,C=z===L;return e.jsxs("div",{ref:_=>{b.current[z]=_},onClick:()=>{Y(z),v&&v(N,z)},style:{position:"absolute",top:"50%",left:0,width:`${R}px`,height:`${I}px`,borderRadius:`${o}px`,overflow:"hidden",background:"#130c0a",border:C?"1.5px solid rgba(255, 138, 61, 0.85)":D?"1px solid rgba(255, 138, 61, 0.45)":"1px solid rgba(255, 255, 255, 0.12)",boxShadow:C?"0 26px 65px rgba(0,0,0,0.9), 0 0 35px rgba(255, 90, 31, 0.4)":"0 18px 45px rgba(0,0,0,0.75)",willChange:"transform, filter",transform:"translate3d(0, -50%, 0)",cursor:"pointer",transition:"border-color 250ms ease, box-shadow 250ms ease"},children:[N.src?e.jsx("img",{src:N.src,alt:N.name,draggable:!1,onError:_=>{_.currentTarget.src=V("/assets/prism-auth-visual.jpg")},style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:`50% calc(50% + ${N.offsetY}px)`,display:"block",userSelect:"none"}}):null,e.jsxs("div",{style:{position:"absolute",top:"12px",left:"12px",right:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",zIndex:3},children:[D?e.jsx("span",{style:{display:"inline-flex",alignItems:"center",gap:"4px",padding:"4px 10px",borderRadius:"999px",background:"linear-gradient(135deg, #ff8a3d, #ff5a1f)",color:"#fff",fontSize:"0.68rem",fontWeight:"900",letterSpacing:"0.06em",textTransform:"uppercase",boxShadow:"0 4px 14px rgba(255, 90, 31, 0.45)"},children:"★ MAIN HEADLINER"}):e.jsx("span",{style:{padding:"3px 9px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.65)",backdropFilter:"blur(8px)",color:"#f6eee8",fontSize:"0.66rem",fontWeight:"700",border:"1px solid rgba(255,255,255,0.12)"},children:N.stage}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",gap:"2px",height:"14px",padding:"3px 6px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.55)",backdropFilter:"blur(6px)"},children:[e.jsx("span",{className:"sss-eq-bar sss-eq-1"}),e.jsx("span",{className:"sss-eq-bar sss-eq-2"}),e.jsx("span",{className:"sss-eq-bar sss-eq-3"})]})]}),e.jsxs("div",{style:{position:"absolute",inset:0,background:"linear-gradient(180deg, rgba(0,0,0,0.08) 0%, transparent 40%, rgba(10,5,3,0.72) 65%, rgba(6,3,2,0.96) 100%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:"16px 14px",zIndex:2},children:[e.jsx("span",{style:{display:"inline-block",width:"fit-content",padding:"2px 8px",borderRadius:"999px",background:"rgba(255, 138, 61, 0.18)",border:"1px solid rgba(255, 138, 61, 0.35)",color:"#ffbd59",fontSize:"0.68rem",fontWeight:"800",letterSpacing:"0.04em",textTransform:"uppercase",marginBottom:"6px"},children:N.genre}),e.jsx("h3",{style:{margin:0,color:"#ffffff",fontSize:"1.28rem",fontWeight:"900",letterSpacing:"-0.02em",lineHeight:1.15,textTransform:"uppercase",textShadow:"0 2px 10px rgba(0,0,0,0.7)"},children:N.name}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginTop:"8px",paddingTop:"6px",borderTop:"1px solid rgba(255,255,255,0.1)",color:"rgba(255, 255, 255, 0.72)",fontSize:"0.68rem",fontWeight:"700"},children:[e.jsxs("span",{children:["⚡ ",N.bpm]}),e.jsxs("span",{children:["♫ ",N.vibe]})]})]})]},N.name)})}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"1rem",marginTop:"0.8rem",zIndex:10},children:[e.jsx("button",{type:"button",onClick:()=>de("left"),disabled:L===0,"aria-label":"Previous artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:L===0?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:L===0?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:L===0?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:L===0?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:N=>{L>0&&(N.currentTarget.style.transform="scale(1.1)",N.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:N=>{N.currentTarget.style.transform="scale(1)",N.currentTarget.style.borderColor=L===0?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"‹"}),e.jsx("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:w.map((N,z)=>e.jsx("span",{onClick:()=>Y(z),style:{width:z===L?"20px":"6px",height:"6px",borderRadius:"999px",backgroundColor:z===L?"#ff8a3d":"rgba(255, 255, 255, 0.25)",cursor:"pointer",transition:"all 250ms ease"}},z))}),e.jsx("button",{type:"button",onClick:()=>de("right"),disabled:L===w.length-1,"aria-label":"Next artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:L===w.length-1?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:L===w.length-1?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:L===w.length-1?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:L===w.length-1?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:N=>{L<w.length-1&&(N.currentTarget.style.transform="scale(1.1)",N.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:N=>{N.currentTarget.style.transform="scale(1)",N.currentTarget.style.borderColor=L===w.length-1?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"›"})]}),e.jsx("style",{children:`
        .sss-eq-bar {
          width: 2px;
          border-radius: 999px;
          background: #ff8a3d;
      ...
      `})]})}const et={color:"#ff8a3d",rounded:24,thickness:2.5,borderSize:45,glow:85,movement:"continuous",speed:16},Lr=2,Ea=[{blur:8,opacity:.5,reach:.3},{blur:15,opacity:.3,reach:.6},{blur:40,opacity:.18,reach:1}],Rr=Math.max(...Ea.map(t=>t.blur)),ra=36;function Rt(t,a){const r=Math.max(0,Math.min(1,a));if(typeof t!="string")return`rgba(0,0,0,${r})`;const s=t.trim(),i=s.match(/^#([0-9a-f]{3,8})$/i);if(i){let n=i[1];(n.length===3||n.length===4)&&(n=n.split("").map(c=>c+c).join(""));const o=parseInt(n.slice(0,6),16);return Number.isFinite(o)?`rgba(${o>>16&255},${o>>8&255},${o&255},${r})`:`rgba(0,0,0,${r})`}const l=s.match(/^rgba?\(([^)]+)\)/i);if(l){const n=l[1].split(",").map(o=>parseFloat(o));if(n.length>=3&&n.slice(0,3).every(Number.isFinite))return`rgba(${n[0]},${n[1]},${n[2]},${r})`}return`rgba(0,0,0,${r})`}function Ir(t,a,r){const s=(t%1+1)%1*2*(a+r);return s<a?[s,0]:s<a+r?[a,s-a]:s<a*2+r?[a-(s-a-r),r]:[0,r-(s-a*2-r)]}function sa(t,a,r){const s=2*(a+r),i=[0,a/s,(a+r)/s,(a*2+r)/s];return Math.floor(t/4)+i[(t%4+4)%4]}function zr(t,a,r){const[s,i]=Ir(t,a,r);return Math.atan2(s-a/2,r/2-i)*180/Math.PI}const ia=24,Mr=.015;function It(t,a,r,s,i){const l=r>0?r:100,n=s>0?s:100,o=Math.max(0,Math.min(100,a)),c=Math.max(Mr,o/100*.5),u=o/100,g=[];let y=0,k=0,A=0;for(let p=0;p<=ia;p++){const b=p/ia,x=zr(t+(b-.5)*c,l,n);if(p===0)y=x;else{let f=x-k;for(;f>180;)f-=360;for(;f<-180;)f+=360;A+=f}k=x;const M=Math.abs(b-.5)*2,j=u>=1||M<=u?1:1-(M-u)/(1-u);g.push(`${Rt(i,j*j*(3-2*j))} ${A.toFixed(2)}deg`)}const v=A.toFixed(2);return g.push(`${Rt(i,0)} ${v}deg`),g.push(`${Rt(i,0)} 360deg`),`conic-gradient(from ${y.toFixed(2)}deg at 50% 50%, ${g.join(", ")})`}const na=30,Fr=4,oa=3,Or=.35,Dr=[.72,.16,.18,1.05],Br=[.65,0,.35,1];function Ca(t){const[a,r,s,i]=t;if(a===r&&s===i)return n=>n;const l=(n,o,c)=>{const u=1-c;return 3*u*u*c*n+3*u*c*c*o+c*c*c};return n=>{const o=Math.max(0,Math.min(1,n));let c=o;for(let u=0;u<8;u++){const g=l(a,s,c)-o,y=1-c,k=3*y*y*a+6*y*c*(s-a)+3*c*c*(1-s);if(Math.abs(k)<1e-6)break;c-=g/k,c=Math.max(0,Math.min(1,c))}return l(r,i,c)}}const _r=Ca(Dr),$r=Ca(Br),la={WebkitMaskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",WebkitMaskClip:"content-box, border-box",WebkitMaskComposite:"xor",maskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",maskClip:"content-box, border-box",maskComposite:"exclude"};function tt({color:t=et.color,rounded:a=et.rounded,thickness:r=et.thickness,borderSize:s=et.borderSize,glow:i=et.glow,movement:l=et.movement,speed:n=et.speed,style:o,className:c=""}){const u=m.useRef(null),g=m.useRef(null),y=m.useRef({speed:n,movement:l,borderSize:s,color:t});y.current={speed:n,movement:l,borderSize:s,color:t};const k=m.useRef(null),A=m.useRef({w:0,h:0}),[v,p]=m.useState({w:0,h:0});m.useEffect(()=>{const P=k.current;if(!P||typeof ResizeObserver>"u")return;const h=new ResizeObserver(()=>{const w=P.getBoundingClientRect();w.width===A.current.w&&w.height===A.current.h||(A.current={w:w.width,h:w.height},p(A.current))});return h.observe(P),()=>h.disconnect()},[]),m.useEffect(()=>{const P=k.current;let h=!0,w=null;typeof IntersectionObserver<"u"&&P&&(w=new IntersectionObserver(X=>{X[0]&&(h=X[0].isIntersecting)},{rootMargin:"100px"}),w.observe(P));let R=0,I=performance.now(),q=0,$=0,T=0;const U=X=>{if(R=requestAnimationFrame(U),!h||typeof document<"u"&&document.hidden){I=X;return}const H=Math.min(.05,Math.max(0,(X-I)/1e3));I=X;const F=y.current,O=Math.max(0,Math.min(20,F.speed));if(O>0){const Y=F.movement==="step",de=Y?oa+(Or-oa)*(O-1)/19:(na+(Fr-na)*(O-1)/19)/4;for(T+=H/de;T>=1;)T-=1,$+=1;const N=Y?_r(Math.min(1,T*2)):$r(T),{w:z,h:D}=A.current,C=z>0?z:100,_=D>0?D:100,ae=sa($,C,_),Q=sa($+1,C,_);q=ae+(Q-ae)*N;const ce=u.current;ce&&ce.style.setProperty("--arc",It(q,F.borderSize,z,D,F.color));const re=g.current;re&&re.style.setProperty("--arc",It(q+.5,F.borderSize,z,D,F.color))}};return R=requestAnimationFrame(U),()=>{cancelAnimationFrame(R),w&&w.disconnect()}},[]);const b=Math.max(1,Math.min(10,r)),x=Math.max(0,Math.min(100,a))/100*(Math.min(v.w||200,v.h||200)/2),M=Math.max(0,Math.min(100,i))/100,j=P=>b+M*ra*P,f=10+ra+Rr*2,d=(P,h=0)=>e.jsx("div",{style:{position:"absolute",inset:h-P,boxSizing:"border-box",padding:P,borderRadius:x>0?x+P:0,background:"var(--arc)",...la}}),B=(P,h,w,R)=>e.jsx("div",{style:{position:"absolute",inset:-f,boxSizing:"border-box",padding:f,borderRadius:x>0?x+f:0,opacity:R,mixBlendMode:"plus-lighter",filter:w?`blur(${w.toFixed(1)}px)`:"none",WebkitFilter:w?`blur(${w.toFixed(1)}px)`:"none",...la},children:d(h,f)},P),L=(P,h)=>e.jsxs("div",{ref:h,style:{position:"absolute",inset:0,overflow:"visible",pointerEvents:"none","--arc":It(P,s,v.w,v.h,t)},children:[M>0&&Ea.map((w,R)=>B(`glow-${R}`,j(w.reach),w.blur,w.opacity)),Array.from({length:Lr}).map((w,R)=>e.jsx("div",{style:{position:"absolute",inset:0,mixBlendMode:"plus-lighter"},children:d(b)},`edge-${R}`))]});return e.jsxs("div",{ref:k,className:`neon-border-overlay ${c}`,style:{position:"absolute",inset:0,width:"100%",height:"100%",flexShrink:0,borderRadius:x,pointerEvents:"none",zIndex:1,...o},children:[L(0,u),L(.5,g)]})}const Ur=1.5,Hr=42,Gr=Math.PI*2,Wr=300,Vr=300,Yr=2,qr=5e3,Xr=3.2,Zr=.05,Kr=3,Jr=1.35,Qr=.08,es=.5,ts=.24,as=.35,rs=Gr*.75,ss=2,La=3,kt=720,is=`
...
void main() {
    ...
    float ang = aA.x * ${rs.toFixed(6)} + aA.y * TAU * ${ss.toFixed(1)};
    float rN = mix(${as.toFixed(3)}, 1.0, sqrt(aA.z));
    float r  = uRadius * rN * (1.0 + ${Zr.toFixed(3)} * tau);

    float tp   = ${Qr.toFixed(3)};
    float bump = (tau / tp) * exp(1.0 - tau / tp);
    float rimW = smoothstep(${es.toFixed(3)}, 1.0, rN);
    float y    = uRise * bump * rimW - uFall * pow(tau, ${Jr.toFixed(2)});

    float L  = ${Kr.toFixed(1)};
...
void main() {
    ...
    float halfW  = uThick * 0.5 * ${La.toFixed(1)} * near;
...
`;function ca(t){if(!t)return[1,1,1,1];let a=String(t).trim();const r=a.match(/^var\(\s*[^,)]+\s*,\s*(.+)\)$/i);r&&(a=r[1].trim());const s=a.match(/^rgba?\(([^)]+)\)$/i);if(s){const l=s[1].split(/[,\s/]+/).filter(Boolean).map(parseFloat);return[(l[0]||0)/255,(l[1]||0)/255,(l[2]||0)/255,l.length>3&&isFinite(l[3])?l[3]:1]}let i=a.replace("#","");return(i.length===3||i.length===4)&&(i=i.split("").map(l=>l+l).join("")),i.length<6?[1,1,1,1]:[parseInt(i.slice(0,2),16)/255,parseInt(i.slice(2,4),16)/255,parseInt(i.slice(4,6),16)/255,i.length>=8?parseInt(i.slice(6,8),16)/255:1]}function cs(t){return()=>{t|=0,t=t+1831565813|0;let a=Math.imul(t^t>>>15,1|t);return a=a+Math.imul(a^a>>>7,61|a)^a,((a^a>>>14)>>>0)/4294967296}}function da(t,a,r){const s=t.createShader(a);return s?(t.shaderSource(s,r),t.compileShader(s),t.getShaderParameter(s,t.COMPILE_STATUS)||console.warn("VortexDustFall shader:",t.getShaderInfoLog(s)),s):null}function pa(t,a,r){const s=t.createProgram();if(!s)return null;const i=da(t,t.VERTEX_SHADER,a),l=da(t,t.FRAGMENT_SHADER,r);return!i||!l?null:(t.attachShader(s,i),t.attachShader(s,l),t.linkProgram(s),t.getProgramParameter(s,t.LINK_STATUS)||console.warn("VortexDustFall link:",t.getProgramInfoLog(s)),s)}const ds={radius:195,thickness:16},ps={height:165,spin:38,spray:0},ms={scatter:280,blur:0},fs={amount:103,transition:{type:"tween",duration:.6,ease:"easeOut"}};function us({background:t="transparent",baseColor:a="#FFA733",accentColor:r="#FFE082",density:s=145,dotSize:i=130,speed:l=48,distance:n=1450,tilt:o=7,ring:c={},fall:u={},field:g={},hover:y={},style:k={},className:A="",children:v}){const p={...ds,...c},b={...ps,...u},x={...ms,...g},M={...fs,...y},j=m.useRef(null),f=m.useRef(null),d=m.useRef({x:0,y:0,active:0}),B=m.useRef({baseColor:a,accentColor:r,density:s,dotSize:i,speed:l,distance:n,tilt:o,ring:p,fall:b,field:x,hover:M});return B.current={baseColor:a,accentColor:r,density:s,dotSize:i,speed:l,distance:n,tilt:o,ring:p,fall:b,field:x,hover:M},m.useEffect(()=>{const L=j.current,P=f.current;if(!L||!P)return;const h=P.getContext("webgl",{alpha:!0,antialias:!1,premultipliedAlpha:!0,depth:!1});if(!h)return;const w=pa(h,is,ns),R=pa(h,os,ls);if(!w||!R)return;const I=(G,S)=>h.getUniformLocation(G,S),q={a:h.getAttribLocation(w,"aA"),b:h.getAttribLocation(w,"aB")},$={res:I(w,"uRes"),focal:I(w,"uFocal"),phase:I(w,"uPhase"),radius:I(w,"uRadius"),rise:I(w,"uRise"),fallD:I(w,"uFall"),spinTurns:I(w,"uSpinTurns"),scatter:I(w,"uScatter"),dotWorld:I(w,"uDotWorld"),blurK:I(w,"uBlurK"),camDist:I(w,"uCamDist"),tilt:I(w,"uTilt"),yPx:I(w,"uYPx"),alpha:I(w,"uAlpha"),color:I(w,"uColor")},T={ring:h.getAttribLocation(R,"aRing")},U={res:I(R,"uRes"),focal:I(R,"uFocal"),radius:I(R,"uRadius"),camDist:I(R,"uCamDist"),tilt:I(R,"uTilt"),yPx:I(R,"uYPx"),thick:I(R,"uThick"),seg:I(R,"uSeg"),color:I(R,"uColor"),alpha:I(R,"uAlpha")},X=h.createBuffer(),H=h.createBuffer();let F=-1,O=0;const Y=G=>{const S=P.clientWidth||L.clientWidth||(typeof window<"u"?window.innerWidth:1200),E=S<768,oe=S>=768&&S<1024,te=E?1800:oe?8500:Math.round(G*Wr);O=Math.max(1e3,te);const ie=new Float32Array(O*4),Le=new Float32Array(O*2),Te=cs(85840071);for(let ke=0;ke<O;ke++)ie[ke*4]=Te(),ie[ke*4+1]=Te(),ie[ke*4+2]=Te(),ie[ke*4+3]=Te(),Le[ke*2]=Te(),Le[ke*2+1]=Te();h.bindBuffer(h.ARRAY_BUFFER,X),h.bufferData(h.ARRAY_BUFFER,ie,h.STATIC_DRAW),h.bindBuffer(h.ARRAY_BUFFER,H),h.bufferData(h.ARRAY_BUFFER,Le,h.STATIC_DRAW),F=G},de=h.createBuffer(),N=(kt+1)*2;{const G=new Float32Array(N*2);for(let S=0;S<=kt;S++){const E=S/kt;G[S*4]=E,G[S*4+1]=-1,G[S*4+2]=E,G[S*4+3]=1}h.bindBuffer(h.ARRAY_BUFFER,de),h.bufferData(h.ARRAY_BUFFER,G,h.STATIC_DRAW)}h.disable(h.DEPTH_TEST),h.enable(h.BLEND),h.blendFunc(h.ONE,h.ONE);let z=!0,D=null;typeof IntersectionObserver<"u"&&L&&(D=new IntersectionObserver(G=>{G[0]&&(z=G[0].isIntersecting)},{rootMargin:"120px"}),D.observe(L));let C=1,_=0;const ae=()=>{C=Math.min(window.devicePixelRatio||1,Ur);const G=P.clientWidth||L.clientWidth||1,S=P.clientHeight||L.clientHeight||1,E=Math.max(1,Math.round(G*C)),oe=Math.max(1,Math.round(S*C));(P.width!==E||P.height!==oe)&&(P.width=E,P.height=oe),h.viewport(0,0,E,oe),Math.abs(_-G)>50&&(_=G,Y(B.current.density))};ae();const Q=new ResizeObserver(ae);Q.observe(P);let ce=0,re=performance.now(),ne=0,me=0,ye=0,fe=0;const se=G=>{if(ne=requestAnimationFrame(se),!z||typeof document<"u"&&document.hidden){re=G;return}const S=Math.min((G-re)/1e3,.05);re=G;const E=B.current;if(E.density!==F&&Y(E.density),O===0)return;const oe=Math.max(.05,E.hover.transition?.duration??.6),te=1-Math.exp(-S/oe),ie=d.current;me+=(ie.x-me)*te,ye+=(ie.y-ye)*te,fe+=(ie.active-fe)*te;const Le=(E.hover.amount||100)/100,Te=1+fe*Le*.6;ce=(ce+S*(E.speed/50*Te)/Xr)%1;const ke=P.width,Je=P.height,De=P.clientWidth||L.clientWidth||1200,Ie=De<768,dt=De>=768&&De<1024,Qe=Je/(2*Math.tan(Hr/2*Math.PI/180)),pt=ke/Math.max(Je,1),mt=pt<1?Math.max(.32,pt/1.4):dt?.85:1,Ae=Vr*(E.ring.radius/100)*mt,ft=Ae*(Ie?1.1:E.fall.height/100),xt=ft*(E.fall.spray/400),bt=Je*(Ie?.22:ts),At=E.fall.spin/100*1.5,ze=Ae*(E.field.scatter/100)*(Ie?.08:.15),yt=Yr*(E.dotSize/100)*(Ie?.65:1),Ue=qr*(E.field.blur/100),He=Ie?Math.min(E.ring.thickness*C,9*C):E.ring.thickness*C,W=E.tilt*Math.PI/180+ye*Le*fe*(10*Math.PI/180),le=(Ie?E.distance*1.05:E.distance)-fe*Le*150,[he,Pe,ve,Re]=ca(E.baseColor),[Ge,it,Me,nt]=ca(E.accentColor);h.clearColor(0,0,0,0),h.clear(h.COLOR_BUFFER_BIT),h.useProgram(w),h.uniform2f($.res,ke,Je),h.uniform1f($.focal,Qe),h.uniform1f($.phase,ce),h.uniform1f($.radius,Ae),h.uniform1f($.rise,xt),h.uniform1f($.fallD,ft),h.uniform1f($.spinTurns,At),h.uniform1f($.scatter,ze),h.uniform1f($.dotWorld,yt*C),h.uniform1f($.blurK,Ue*C),h.uniform1f($.camDist,le),h.uniform1f($.tilt,W),h.uniform1f($.yPx,bt),h.uniform1f($.alpha,Re),h.uniform3f($.color,he,Pe,ve),h.bindBuffer(h.ARRAY_BUFFER,X),h.enableVertexAttribArray(q.a),h.vertexAttribPointer(q.a,4,h.FLOAT,!1,0,0),h.bindBuffer(h.ARRAY_BUFFER,H),h.enableVertexAttribArray(q.b),h.vertexAttribPointer(q.b,2,h.FLOAT,!1,0,0),h.drawArrays(h.POINTS,0,O),h.useProgram(R),h.uniform2f(U.res,ke,Je),h.uniform1f(U.focal,Qe),h.uniform1f(U.radius,Ae),h.uniform1f(U.camDist,le),h.uniform1f(U.tilt,W),h.uniform1f(U.yPx,bt),h.uniform1f(U.thick,He),h.uniform1f(U.seg,kt),h.uniform3f(U.color,Ge,it,Me),h.uniform1f(U.alpha,nt),h.bindBuffer(h.ARRAY_BUFFER,de),h.enableVertexAttribArray(T.ring),h.vertexAttribPointer(T.ring,2,h.FLOAT,!1,0,0),h.drawArrays(h.TRIANGLE_STRIP,0,N)};return ne=requestAnimationFrame(se),()=>{cancelAnimationFrame(ne),Q.disconnect(),D&&D.disconnect(),h.deleteBuffer(X),h.deleteBuffer(H),h.deleteBuffer(de),h.deleteProgram(w),h.deleteProgram(R)}},[]),e.jsxs("div",{ref:j,className:`vortex-dust-container ${A}`,onPointerMove:L=>{const P=L.currentTarget.getBoundingClientRect();P.width<=0||P.height<=0||(d.current={x:(L.clientX-P.left)/P.width*2-1,y:-((L.clientY-P.top)/P.height*2-1),active:1})},onPointerLeave:()=>{d.current={x:0,y:0,active:0}},style:{position:"absolute",inset:0,width:"100%",height:"100%",overflow:"hidden",pointerEvents:"none",background:t,...k},children:[e.jsx("canvas",{ref:f,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}}),v&&e.jsx("div",{style:{position:"relative",zIndex:2,pointerEvents:"auto",width:"100%",height:"100%"},children:v})]})}const gs=[{name:"TALWINDER",isHeadliner:!0,genre:"Indie Pop / Punjabi Fusion",stage:"Main Prism Stage",bpm:"128 BPM",vibe:"Euphoric Night",image:V("/assets/ozilla/talwinder.jpg")},{name:"IMRAN KHAN",genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",image:V("/assets/ozilla/Imran-Khan.jpg")},{name:"BOHEMIA",genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",image:V("/assets/ozilla/Bohemia.jpg")},{name:"HASSAN RAHEEM",genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",image:V("/assets/ozilla/hassan-raheem.jpg")}],hs=[{id:"general",name:"General Pass",badge:"STANDARD ACCESS",price:"PKR 4,500",sub:"Full 1-day festival admission",isFeatured:!1,perks:["Access to All 4 Music Stages","Food & Beats Street Access","Festival Photo Booths & Activations","Instant Digital QR Pass"],ctaText:"Get General Pass",ctaLink:"/tickets"},{id:"vip",name:"VIP Experience",badge:"MOST POPULAR",price:"PKR 12,500",sub:"Elevated front-row & lounge access",isFeatured:!0,perks:["Priority Front Stage Viewing Deck","Private VIP Artist Lounge Access","Dedicated Fast-Track Entry Gate","Complimentary Food & Drink Voucher","20% Partner Hotel & Dining Discounts","Holographic VIP Commemorative Pass"],ctaText:"Book VIP Pass →",ctaLink:"/tickets"},{id:"platinum",name:"All-Access Platinum",badge:"EXCLUSIVE ALL-ACCESS",price:"PKR 25,000",sub:"Ultimate luxury hospitality package",isFeatured:!1,perks:["Backstage & Artist Lounge Access","Valet Reserved Parking Spot","Gourmet Catering & Open Mocktail Bar","Exclusive Afterparty Invitation","Dedicated Hospitality Concierge","Full Merchandise Gift Bundle"],ctaText:"Reserve Platinum Pass",ctaLink:"/tickets"}],xs=[{badge:"100kW SOUND SYSTEM",title:"4 Mega Sound Stages",desc:"Explosive stage arenas for Indie Pop, Punjabi Rap, Desi Hip-Hop, and non-stop EDM beats."},{badge:"HEADLINE CELEBRITIES",title:"Star-Studded Lineup",desc:"Live stadium sets by Talwinder, Imran Khan, Bohemia, Hassan Raheem, and top artists."},{badge:"CULINARY & NIGHT BAZAAR",title:"Food & Beats Street",desc:"50+ curated gourmet food stalls, wood-fired artisan eats, and craft mocktail lounges."},{badge:"ALL-ACCESS HOSPITALITY",title:"VIP Lounge & Deck Access",desc:"Elevated front-stage viewing decks, private artist lounges, and fast-track VIP gates."}],bs=[{name:"OZILLA FEST 2026: The Flagship",date:"November 1, 2026",location:"Lahore, Pakistan",status:"FEATURED FESTIVAL",description:"Flagship festival with 4 mega stages, 20+ star artists, and 10,000+ live crowd."},{name:"Celebrity Night Live Concert",date:"February 2027",location:"Lahore, Pakistan",status:"UPCOMING CONCERT",description:"High-octane stadium night with headline Punjabi artists and 360° laser shows."},{name:"Ozilla Basant Beats Season 2",date:"March 2027",location:"Lahore, Pakistan",status:"SEASONAL FESTIVAL",description:"Cultural music fusion festival with live pop sets, color activations, and street eats."}],ys=[{name:"Ozilla Season 1: The Bass Awakening",status:"Sold Out · 6,500+ Fans",detail:"Debut open-air music festival in Lahore featuring indie fusion acts and 2 live mega stages."},{name:"Ozilla Season 2: Neon Nights",status:"Sold Out · 8,500+ Fans",detail:"High-energy night festival with headline celebrity acts and artisan night food street."}],vs=[{name:"Ozilla Debut: The Sound Awakening",year:"2023",badge:"SOLD OUT DEBUT",description:"Historic launch in Lahore uniting 6,000+ fans for live indie music and night market culture.",highlights:["6,000+ Attendees","2 Live Stages","Indie & Desi Fusion"],venue:"Lahore Expo Center",date:"December 12, 2023"},{name:"Ozilla Season 2: Neon Nights",year:"2024",badge:"RECORD 8,500+ CROWD",description:"Season 2 expansion with 4 live stages, celebrity headliners, and 360° laser canopy.",highlights:["8,500+ Fans","4 Live Stages","Celebrity Headliners"],venue:"DHA Sports Complex, Lahore",date:"November 9, 2024"},{name:"Ozilla Basant Cultural Beats",year:"2025",badge:"SPRING FESTIVAL",description:"Seasonal spring music festival with live acoustic sets, DJ arenas, and artisan bazaar.",highlights:["Cultural Sets","Live DJ Stages","Food Hub"],venue:"Gulberg Cultural District, Lahore",date:"March 15, 2025"},{name:"OZILLA FEST 2026 (The Grand Edition)",year:"2026",badge:"FLAGSHIP 10,000+ EDITION",description:"Monumental flagship edition with 4 stages, 20+ star artists, and 100kW laser sound arrays.",highlights:["10,000+ Crowd","4 Mega Stages","Talwinder & Imran Khan"],venue:"Lahore, Punjab",date:"November 1, 2026"},{name:"OZILLA FEST 2027: Arena Tour",year:"2027",badge:"NATIONWIDE TOUR",description:"Nationwide arena tour expansion bringing the signature Ozilla concert experience across Pakistan.",highlights:["Arena Tour","Multi-City Stages","Star Acts"],venue:"Lahore, Karachi & Islamabad",date:"November 14, 2027"}],ws=[{tier:"Title Sponsor",price:"PREMIUM",badge:"FLAGSHIP PARTNER",accent:"#ffbd59",tagline:"Maximum Brand Dominance",isFeatured:!0,ctaText:"Claim Title Partnership",perks:["Exclusive brand naming rights","Main stage backdrop placement","VIP lounge & deck co-branding","30-second main stage video slot","Dedicated social & press campaigns"]},{tier:"Gold Sponsor",price:"HIGH IMPACT",badge:"STAGE ACTIVATION",accent:"#ff8a3d",tagline:"High-Energy Ground Presence",isFeatured:!1,ctaText:"Become Gold Sponsor",perks:["Exclusive brand activation zone","Perimeter banner placements","Digital festival app features","Influencer co-branding & mentions","On-ground brand booth space"]},{tier:"Silver Sponsor",price:"GROWTH",badge:"BRAND PARTNER",accent:"#cbd5e1",tagline:"Targeted Festival Engagement",isFeatured:!1,ctaText:"Join Silver Tier",perks:["Official festival website branding","Social media shoutouts","Sampling booth at food street","Newsletter sponsor placement","10 complimentary festival passes"]},{tier:"Media Partner",price:"CUSTOM",badge:"BROADCAST & PRESS",accent:"#ec4899",tagline:"Official Media Rights",isFeatured:!1,ctaText:"Apply For Press Pass",perks:["Official media coverage rights","All-access artist press passes","Exclusive backstage interview access","Press release announcement feature","Dedicated creator lounge access"]}],ks=[{badge:"100kW SOUND ARRAY",title:"Main Concert Arena",desc:"Stadium-grade concert sound arrays, 360° lasers, and cryogenic live jets.",accent:"#ff5a1f"},{badge:"50+ FOOD SPOTS",title:"Food & Beats Street",desc:"50+ night food stalls, wood-fired artisan eats, and gourmet smash burgers.",accent:"#ffbd59"},{badge:"24/7 RAPID CARE",title:"Medical & First Aid Hub",desc:"Fully equipped medical stations and certified paramedic response teams.",accent:"#ef4444"},{badge:"VALET & VIP GATES",title:"Managed VIP Parking",desc:"Fast-track valet lanes and direct express entry for VIP pass holders.",accent:"#f59e0b"},{badge:"CREATOR LIGHTING",title:"Holographic Photo Booths",desc:"Interactive neon backdrops and 360° video spinners for creator moments.",accent:"#ec4899"},{badge:"INCLUSIVE VENUE",title:"Full Venue Accessibility",desc:"Elevated viewing decks, step-free ramps, and on-ground guest assistance.",accent:"#3b82f6"},{badge:"PROFESSIONAL SQUAD",title:"Crowd Safety & Security",desc:"Trained festival security squad, CCTV monitoring, and RFID gate checks.",accent:"#10b981"},{badge:"GIGABIT HIGH-SPEED",title:"Ultra-Fast Festival Wi-Fi",desc:"High-density wireless zones across all stages and food streets.",accent:"#06b6d4"}],js=[{value:"10,000+",label:"Music Lovers",sub:"Packed Live Crowd"},{value:"20+",label:"Star Performers",sub:"Celebrity & Indie Acts"},{value:"4",label:"Mega Stages",sub:"Non-stop Beats"},{value:"50+",label:"Food & Stalls",sub:"Culinary & Brand Hub"}];function Ns(t){const[a,r]=m.useState(()=>{const s=Math.max(new Date(t)-Date.now(),0);return{days:Math.floor(s/864e5),hours:Math.floor(s/36e5%24),minutes:Math.floor(s/6e4%60),seconds:Math.floor(s/1e3%60)}});return m.useEffect(()=>{const s=setInterval(()=>{const i=Math.max(new Date(t)-Date.now(),0);r({days:Math.floor(i/864e5),hours:Math.floor(i/36e5%24),minutes:Math.floor(i/6e4%60),seconds:Math.floor(i/1e3%60)})},1e3);return()=>clearInterval(s)},[t]),a}function Ss(){const t=Ze(),a=Ns("2026-11-01T18:00:00+05:00");return m.useEffect(()=>{const r=t.hash?.replace("#","");r?setTimeout(()=>{const s=document.getElementById(r);s&&s.scrollIntoView({behavior:"smooth",block:"start"})},150):window.scrollTo({top:0,behavior:"smooth"})},[t.hash]),e.jsxs("main",{className:"sp-main",children:[e.jsxs("section",{id:"home",className:"sp-hero","aria-label":"Ozilla Fest",children:[e.jsx(us,{baseColor:"#ff8a3d",accentColor:"#ffbd59",density:125,speed:46,tilt:7}),e.jsx("div",{className:"sp-hero-ambient-glow"}),e.jsxs("div",{className:"sp-hero-content",children:[e.jsxs(J.div,{className:"sp-hero-badge",initial:{opacity:0,y:-20,scale:.9},animate:{opacity:1,y:0,scale:1},transition:{duration:.6},children:[e.jsx("span",{children:"✨"}),e.jsx("strong",{children:"OZILLA FEST 2026 · LAHORE"})]}),e.jsx(J.h1,{className:"sp-hero-title",initial:{opacity:0,y:25},animate:{opacity:1,y:0},transition:{duration:.7,delay:.12},children:"OZILLA FEST"}),e.jsxs(J.p,{className:"sp-hero-subtitle",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.7,delay:.25},children:[e.jsx("strong",{className:"sp-hero-sub-highlight",children:"Pakistan's Flagship Music & Cultural Phenomenon."}),e.jsx("span",{className:"sp-hero-sub-detail",children:"4 Electrified Mega Stages · Headline Celebrities · High-Octane Sound Under the Lahore Night Sky."})]}),e.jsxs(J.div,{className:"sp-hero-meta-strip",initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{duration:.6,delay:.4},children:[e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"DATE"}),e.jsx("strong",{children:"NOV 01, 2026"})]}),e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"CITY"}),e.jsx("strong",{children:"LAHORE, PK"})]}),e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"PRODUCTION"}),e.jsx("strong",{children:"4 MEGA STAGES"})]}),e.jsxs("div",{className:"sp-hero-meta-pill sp-meta-featured",children:[e.jsx("span",{className:"sp-meta-dot sp-dot-gold"}),e.jsx("span",{className:"sp-meta-label",children:"PASSES"}),e.jsx("strong",{children:"INSTANT QR PASS"})]})]}),e.jsxs(J.div,{className:"sp-hero-actions",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6,delay:.55},children:[e.jsx(J.a,{className:"sp-btn-ember",href:"#celebrities",whileHover:{scale:1.04},whileTap:{scale:.97},children:"Explore Lineup ⚡"}),e.jsx(J.div,{whileHover:{scale:1.04},whileTap:{scale:.97},children:e.jsx(Z,{className:"sp-btn-ghost",to:"/tickets",children:"Get VIP Passes 🎟️"})})]})]})]}),e.jsx("section",{className:"festival-stats-strip","aria-label":"Festival Highlights",children:e.jsx("div",{className:"sp-container",children:e.jsx("div",{className:"stats-inner-grid",children:js.map((r,s)=>e.jsxs(J.div,{className:"stat-card",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.4,delay:s*.08},whileHover:{y:-5,scale:1.02},children:[e.jsx("strong",{className:"stat-val",children:r.value}),e.jsx("span",{className:"stat-label",children:r.label}),e.jsx("small",{className:"stat-sub",children:r.sub})]},r.label))})})}),e.jsx("section",{id:"celebrities",className:"sp-section sp-section-celebrities","aria-label":"Celebrities Lineup",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(J.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"Live on the Ozilla Stage"}),e.jsx("h2",{className:"sp-section-title",children:"Celebrity Singers & Performers"}),e.jsx("p",{className:"sp-section-subtitle",children:"Four powerhouse headline performers, one premium Lahore festival atmosphere, and an amphitheatre built for unforgettable crowd moments."})]}),e.jsx(J.div,{className:"sp-celebrity-slider-wrap",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-40px"},transition:{duration:.6},style:{margin:"1rem 0 3.5rem 0"},children:e.jsx(Cr,{items:gs,slideWidth:320,slideHeight:440,spacing:2.6,smoothness:8.5,dim:6,sensitivity:5,autoPlay:!0,autoPlaySpeed:1.2})}),e.jsxs(J.div,{className:"sp-countdown-banner",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.55},children:[e.jsx("div",{className:"sp-countdown-header",children:e.jsxs("span",{className:"sp-countdown-eyebrow",children:[e.jsx("span",{className:"sp-countdown-pulse"}),"COUNTDOWN TO THE FIRST BEAT DROP"]})}),e.jsx("div",{className:"sp-countdown-grid",children:[["Days",a.days],["Hours",a.hours],["Minutes",a.minutes],["Seconds",a.seconds]].map(([r,s])=>e.jsxs(J.div,{className:"sp-countdown-card",whileHover:{scale:1.05,y:-4},transition:{type:"spring",stiffness:350},children:[e.jsx("strong",{children:String(s).padStart(2,"0")}),e.jsx("span",{children:r}),e.jsx("div",{className:"sp-countdown-glow-line"})]},r))})]})]})}),e.jsx("section",{id:"vip-experience",className:"sp-section sp-section-pricing","aria-label":"Festival Passes",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(J.div,{className:"sp-section-header",style:{textAlign:"center"},initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"CHOOSE YOUR ACCESS"}),e.jsx("h2",{className:"sp-section-title",children:"Festival Passes & VIP Tiers"}),e.jsx("p",{className:"sp-section-subtitle",style:{margin:"0 auto"},children:"Select your festival experience tier. Instant dynamic QR pass generated upon reservation with guaranteed fast-track admission."})]}),e.jsx("div",{className:"sp-pricing-grid",children:hs.map((r,s)=>e.jsxs(J.div,{className:`sp-pricing-card ${r.isFeatured?"sp-featured-pricing":""}`,initial:{opacity:0,y:35},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:s*.12},whileHover:{y:-8},children:[r.isFeatured&&e.jsx("div",{className:"sp-pricing-popular-tag",children:"MOST POPULAR ACCESS"}),e.jsxs("div",{className:"sp-pricing-header",children:[e.jsx("span",{className:"sp-tier-badge",children:r.badge}),e.jsx("h3",{children:r.name}),e.jsx("div",{className:"sp-pricing-cost",children:e.jsx("strong",{children:r.price})}),e.jsx("p",{className:"sp-pricing-sub",children:r.sub})]}),e.jsx("div",{className:"sp-pricing-divider"}),e.jsx("ul",{className:"sp-pricing-features",children:r.perks.map(i=>e.jsxs("li",{children:[e.jsx("span",{className:"sp-perk-check",children:"✓"}),e.jsx("span",{children:i})]},i))}),e.jsx(Z,{to:r.ctaLink,className:r.isFeatured?"sp-btn-ember w-full":"sp-btn-ghost w-full",style:{textAlign:"center",marginTop:"auto"},children:r.ctaText})]},r.id))})]})}),e.jsx("section",{id:"about",className:"sp-section sp-section-about","aria-label":"About Ozilla",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(J.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"⚡ THE ULTIMATE LIVE EXPERIENCE"}),e.jsx("h2",{className:"sp-section-title",children:"The Ozilla Fest Atmosphere"}),e.jsx("p",{className:"sp-section-subtitle",children:"Pakistan's flagship open-air music & cultural festival. 4 electrified stages, 100kW concert sound, headline celebrity acts, gourmet food street, and unmatched crowd energy under the Lahore night sky."})]}),e.jsx("div",{className:"sp-pillars-grid",children:xs.map((r,s)=>e.jsxs(J.div,{className:"sp-pillar-card",initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:s*.1},whileHover:{y:-8,scale:1.02},children:[e.jsx("div",{className:"sp-pillar-glow-accent"}),e.jsx("div",{className:"sp-pillar-top",children:e.jsx("span",{className:"sp-pillar-badge",children:r.badge})}),e.jsx("h3",{className:"sp-pillar-title",children:r.title}),e.jsx("p",{className:"sp-pillar-desc",children:r.desc}),e.jsx("div",{className:"sp-pillar-glow-line"})]},r.title))}),e.jsxs(J.div,{className:"sp-festival-vibe-banner",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:35},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6},children:[e.jsx(tt,{color:"#ff7a29",rounded:32,thickness:2.8,borderSize:50,glow:85}),e.jsxs("div",{className:"sp-vibe-left",style:{position:"relative",zIndex:2},children:[e.jsxs("span",{className:"sp-vibe-eyebrow",children:[e.jsx("span",{className:"sp-countdown-pulse"}),"FESTIVAL HIGHLIGHTS"]}),e.jsx("h3",{children:"What Makes Ozilla Legendary"}),e.jsx("p",{children:"Non-stop beats from golden hour to midnight, surrounded by festival activations and pure music culture."}),e.jsxs("div",{className:"sp-vibe-actions",children:[e.jsx(J.a,{href:"#celebrities",className:"sp-btn-ember",whileHover:{scale:1.04},whileTap:{scale:.97},children:"Explore Lineup →"}),e.jsx(J.div,{whileHover:{scale:1.04},whileTap:{scale:.97},children:e.jsx(Z,{to:"/tickets",className:"sp-btn-ghost",children:"Book Festival Passes"})})]})]}),e.jsx("div",{className:"sp-vibe-tags-grid",style:{position:"relative",zIndex:2},children:[{text:"4 Mega Music Stages",isMain:!0,icon:"⚡"},{text:"100kW Laser & Sound",isMain:!0,icon:"🔊"},{text:"20+ Star Performers",isMain:!0,icon:"👑"},{text:"Verified QR Instant Passes",isMain:!0,icon:"🎟️"},{text:"10,000+ Music Lovers",isMain:!1,icon:"👥"},{text:"50+ Food & Beats Stalls",isMain:!1,icon:"🍔"},{text:"VIP Artist Lounge & Deck",isMain:!1,icon:"✨"},{text:"Exclusive Partner Discounts",isMain:!1,icon:"🏷️"}].map((r,s)=>e.jsxs(J.div,{className:`sp-vibe-tag ${r.isMain?"sp-vibe-main":"sp-vibe-secondary"}`,initial:{opacity:0,scale:.9},whileInView:{opacity:1,scale:1},viewport:{once:!0},transition:{duration:.35,delay:s*.05},whileHover:{scale:1.03,x:3},whileTap:{scale:.98},children:[e.jsx("span",{className:"sp-vibe-tag-icon",children:r.icon}),e.jsx("span",{className:"sp-vibe-tag-text",children:r.text}),r.isMain&&e.jsx("span",{className:"sp-vibe-tag-dot"})]},r.text))})]})]})}),e.jsx("section",{id:"events",className:"sp-section sp-section-events","aria-label":"Past Events",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(J.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"Previous Editions"}),e.jsx("h2",{className:"sp-section-title",children:"Past Festival Milestones"}),e.jsx("p",{className:"sp-section-subtitle",children:"A legacy of sold-out stadium energy, breakthrough artist sets, and unforgettable Lahore nights."})]}),e.jsx("div",{className:"sp-events-grid",children:ys.map((r,s)=>e.jsxs(J.div,{className:"sp-glass-card sp-past-event-card",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:s*.12},whileHover:{y:-6},children:[e.jsx(tt,{color:"#ff8a3d",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column",height:"100%"},children:[e.jsxs("div",{className:"sp-card-header",children:[e.jsx("h3",{children:r.name}),e.jsx("span",{className:"sp-pill-badge",children:r.status})]}),e.jsx("p",{className:"sp-card-desc",children:r.detail}),e.jsxs("div",{className:"sp-card-footer-eq",children:[e.jsx("span",{children:"LIVE ARCHIVE"}),e.jsxs("div",{className:"celeb-mini-eq",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})]})]},r.name))})]})}),e.jsx("section",{id:"future-events",className:"sp-section sp-section-future","aria-label":"Upcoming Events",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(J.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"Upcoming Concert Tour"}),e.jsx("h2",{className:"sp-section-title",children:"Future Festival Editions"}),e.jsx("p",{className:"sp-section-subtitle",children:"Mark your calendar for upcoming major festival editions, celebrity concert nights, and arena dates."})]}),e.jsx("div",{className:"sp-future-grid",children:bs.map((r,s)=>e.jsxs(J.div,{className:"sp-glass-card sp-future-card",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:s*.12},whileHover:{y:-6},children:[e.jsx(tt,{color:"#ff9e42",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column",height:"100%"},children:[e.jsx("span",{className:"sp-pill-badge",children:r.status}),e.jsx("h3",{style:{marginTop:"0.8rem"},children:r.name}),e.jsxs("p",{className:"sp-meta-text",children:["📍 ",r.date," · ",r.location]}),e.jsx("p",{className:"sp-card-desc",style:{flex:1},children:r.description}),e.jsx(Z,{to:"/tickets",className:"sp-accent-link",children:"Get Tickets →"})]})]},r.name))})]})}),e.jsx("section",{id:"history",className:"sp-section sp-section-history","aria-label":"Festival History",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header sp-timeline-banner-header",style:{position:"relative",overflow:"hidden"},children:[e.jsx(tt,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"Festival Legacy"}),e.jsx("h2",{className:"sp-section-title",children:"Our Editions & Timeline"}),e.jsx("p",{className:"sp-section-subtitle",children:"From our underground debut to Pakistan's biggest stadium concert experience."})]})]}),e.jsx("div",{className:"sp-timeline",children:vs.map((r,s)=>e.jsxs(J.div,{className:"sp-timeline-item",initial:{opacity:0,x:-28,y:20},whileInView:{opacity:1,x:0,y:0},viewport:{once:!0,margin:"-40px"},transition:{duration:.45,delay:s*.08},children:[e.jsxs("div",{className:"sp-timeline-node-wrap",children:[e.jsx("div",{className:"sp-timeline-icon",children:e.jsx("span",{className:"sp-timeline-year-pill",children:r.year})}),e.jsx("div",{className:"sp-timeline-pulse-ring"})]}),e.jsxs("div",{className:"sp-glass-card sp-timeline-content",children:[e.jsxs("div",{className:"sp-timeline-top-row",children:[e.jsx("div",{className:"sp-meta-text",children:e.jsx("span",{className:"sp-year-highlight",children:r.date})}),e.jsx("span",{className:"sp-timeline-badge",children:r.badge})]}),e.jsx("h3",{className:"sp-timeline-heading",children:r.name}),e.jsx("p",{className:"sp-card-desc",children:r.description}),e.jsx("div",{className:"sp-tag-cloud",children:r.highlights.map(i=>e.jsx("span",{className:"sp-tag sp-timeline-tag",children:i},i))}),e.jsxs("div",{className:"sp-timeline-footer",children:[e.jsx("p",{className:"sp-venue-text",children:r.venue}),e.jsxs("div",{className:"celeb-mini-eq",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})]})]},r.name))})]})}),e.jsx("section",{id:"facilities",className:"sp-section sp-section-facilities","aria-label":"Facilities",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(J.div,{className:"sp-section-header sp-facilities-header-banner",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx(tt,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"⚡ FESTIVAL VENUE & PRODUCTION"}),e.jsx("h2",{className:"sp-section-title",children:"World-Class Festival Facilities"}),e.jsx("p",{className:"sp-section-subtitle",children:"Built for a seamless 10,000+ attendee experience with concert-grade sound, medical support, VIP hospitality, and creator amenities."})]})]}),e.jsx("div",{className:"sp-facilities-grid",children:ks.map((r,s)=>e.jsxs(J.div,{className:"sp-glass-card sp-facility-card",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.45,delay:s*.07},whileHover:{y:-8,scale:1.02},children:[e.jsx(tt,{color:r.accent||"#ff8a3d",rounded:20,thickness:2.2,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,width:"100%"},children:[e.jsx("div",{className:"sp-facility-top",children:e.jsx("span",{className:"sp-facility-badge",style:{color:r.accent,borderColor:`${r.accent}44`,background:`${r.accent}14`},children:r.badge})}),e.jsx("h3",{className:"sp-facility-title",children:r.title}),e.jsx("p",{className:"sp-card-desc",children:r.desc})]}),e.jsx("div",{className:"sp-facility-glow-bar",style:{background:`linear-gradient(90deg, ${r.accent}, transparent)`}})]},r.title))})]})}),e.jsx("section",{id:"sponsorship",className:"sp-section sp-section-sponsorship","aria-label":"Sponsorships",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(J.div,{className:"sp-section-header sp-sponsorship-header-banner",style:{position:"relative",overflow:"hidden",textAlign:"center"},initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx(tt,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"BRAND COLLABORATIONS"}),e.jsx("h2",{className:"sp-section-title",children:"Sponsorship & Brand Packages"}),e.jsx("p",{className:"sp-section-subtitle",style:{margin:"0 auto"},children:"Partner with Pakistan's biggest live music festival. Gain unparalleled on-ground brand presence, digital engagement, and VIP hospitality."})]})]}),e.jsx("div",{className:"sp-sponsorship-grid",children:ws.map((r,s)=>e.jsxs(J.div,{className:`sp-glass-card sp-sponsor-card ${r.isFeatured?"sp-sponsor-featured":""}`,initial:{opacity:0,y:35},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.45,delay:s*.1},whileHover:{y:-10,scale:1.02},children:[r.isFeatured&&e.jsx("div",{className:"sp-sponsor-popular-tag",children:"MOST PRESTIGIOUS TIER"}),e.jsx("div",{className:"sp-sponsor-top",children:e.jsx("span",{className:"sp-sponsor-badge",style:{color:r.accent,borderColor:`${r.accent}44`,background:`${r.accent}14`},children:r.badge})}),e.jsxs("div",{className:"sp-sponsor-header",children:[e.jsx("h3",{children:r.tier}),e.jsx("div",{className:"sp-sponsor-price-tag",style:{color:r.accent},children:r.price}),e.jsx("p",{className:"sp-sponsor-tagline",children:r.tagline})]}),e.jsx("div",{className:"sp-sponsor-divider"}),e.jsx("ul",{className:"sp-sponsor-perks",children:r.perks.map(i=>e.jsxs("li",{children:[e.jsx("span",{className:"sp-check",style:{color:r.accent},children:"✓"}),e.jsx("span",{children:i})]},i))}),e.jsx(J.div,{whileHover:{scale:1.04},whileTap:{scale:.96},style:{marginTop:"auto",paddingTop:"1.2rem"},children:e.jsx(Z,{to:"/tickets",className:r.isFeatured?"sp-btn-ember w-full":"sp-btn-ghost w-full",style:{textAlign:"center"},children:r.ctaText})}),e.jsx("div",{className:"sp-sponsor-glow-bottom",style:{background:`linear-gradient(90deg, ${r.accent}, transparent)`}})]},r.tier))})]})}),e.jsx("style",{children:`
      ...
      `})]})}function Ut({type:t,message:a,onClose:r}){const s={success:"bg-green-100 border-green-500 text-green-700",error:"bg-red-100 border-red-500 text-red-700",warning:"bg-yellow-100 border-yellow-500 text-yellow-700",info:"bg-blue-100 border-blue-500 text-blue-700"}[t]||"bg-gray-100 border-gray-500 text-gray-700";return e.jsxs("div",{className:`${s} border-l-4 p-4 rounded mb-4 flex justify-between items-center`,children:[e.jsx("p",{children:a}),r&&e.jsx("button",{onClick:r,className:"ml-4 font-bold hover:opacity-75",children:"×"})]})}const Hs=["Personal Info","Ticket Details","Payment Checkout","QR Pass"],Gs={ticketType:"General",day:"Day 1",quantity:1,subtotal:1,serviceFee:0,discount:0,total:1,benefits:["Festival entry","Food court access","Partner discount offers"]};function Ws(){const t=ct(),{user:a}=Ke(),{requestTicket:r,payWithCard:s,payWithJazzCash:i,payWithEasypaisa:l,initiatePayFastCheckout:n,completePayFastGateway:o,loading:c}=$t(),[u,g]=m.useState(null),[y,k]=m.useState(!1),[A,v]=m.useState("payfast"),[p,b]=m.useState(null),[x,M]=m.useState(!1),[j,f]=m.useState(Gs),[d,B]=m.useState(null),[L,P]=m.useState(!0),h=y?3:2;`${a?.firstName||""} ${a?.lastName||""}`.trim()||a?.name||a?.email;const w=!!d?.soldOut;m.useEffect(()=>{let H=!0;return(async()=>{P(!0);try{const O=await Ne.getAvailability();if(!H)return;B(O),O?.soldOut&&g({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."})}catch{H&&B(null)}finally{H&&P(!1)}})(),()=>{H=!1}},[]);const R=()=>{if(w){g({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."});return}t(`/login?returnTo=${encodeURIComponent("/tickets")}`)},I=async H=>{if(w){g({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."});return}try{const F=await r(H);b(F),k(!0),g({type:"success",message:"Ticket reserved! Please complete payment below."});const O=await Ne.getAvailability().catch(()=>null);O&&B(O)}catch(F){const O=F?.response?.data?.message||F?.message||"Failed to request ticket. Please try again.";F?.response?.data?.availability&&B(F.response.data.availability),g({type:"error",message:O})}},q=async H=>{if(!p?.id){g({type:"error",message:"Ticket session expired. Please retry."});return}try{await s(p.id,H),g({type:"success",message:`Payment of PKR ${j.total.toLocaleString()} successful! Your QR pass is ready.`}),t(`/tickets/view/${p.id}`)}catch(F){const O=F?.response?.data?.message||F?.message||"Failed to process card payment.";g({type:"error",message:O})}},$=async H=>{if(!p?.id){g({type:"error",message:"Ticket session expired. Please retry."});return}try{await i(p.id,H),g({type:"success",message:"JazzCash payment successful! Your QR pass is ready."}),t(`/tickets/view/${p.id}`)}catch(F){const O=F?.response?.data?.message||F?.message||"Failed to process JazzCash payment.";g({type:"error",message:O})}},T=async H=>{if(!p?.id){g({type:"error",message:"Ticket session expired. Please retry."});return}try{await l(p.id,H),g({type:"success",message:"Easypaisa payment successful! Your QR pass is ready."}),t(`/tickets/view/${p.id}`)}catch(F){const O=F?.response?.data?.message||F?.message||"Failed to process Easypaisa payment.";g({type:"error",message:O})}},U=async()=>{if(!p?.id){g({type:"error",message:"Ticket session expired. Please retry."});return}try{await n(p.id),M(!0)}catch(H){g({type:"error",message:H?.response?.data?.message||H?.message||"Failed to initiate PayFast session."})}},X=async H=>{if(p?.id)try{await o(p.id,H),M(!1),g({type:"success",message:`PayFast payment of PKR ${j.total.toLocaleString()} confirmed! Official QR pass generated.`}),t(`/tickets/view/${p.id}?payment=success`)}catch(F){g({type:"error",message:F?.response?.data?.message||F?.message||"Failed to verify PayFast transaction."})}};return e.jsxs("main",{className:"ticket-portal-clean",children:[e.jsxs("section",{className:"ticket-clean-hero",children:[e.jsx(_t,{nodeColor:"#EC4899",lineColor:"236, 72, 153",secondaryColor:"255, 90, 31",maxDistance:140,speed:.5}),e.jsx("div",{className:"hero-glow-blob"}),e.jsxs("div",{className:"ticket-clean-hero-content",children:[e.jsx("span",{className:"hero-eyebrow",children:"OZILLA FEST 2026"}),e.jsx("h1",{className:"hero-title",children:"Book Your Festival Passes"}),e.jsx("p",{className:"hero-subtitle",children:"Instant digital QR pass with access to 4 live stages, headline artists, and VIP amenities in Lahore."}),e.jsxs("div",{className:"hero-tags",children:[e.jsx("span",{children:"📅 Nov 01, 2026"}),e.jsx("span",{children:"📍 Lahore"}),e.jsx("span",{children:"⚡ Instant QR Pass"})]})]})]}),e.jsxs("section",{className:"ticket-clean-shell",children:[u&&e.jsx(Ut,{type:u.type,message:u.message,onClose:()=>g(null)}),e.jsx("div",{className:"ticket-clean-stepper",children:Hs.map((H,F)=>e.jsxs("div",{className:`step-item ${F+1<=h?"is-active":""}`,children:[e.jsx("span",{className:"step-num",children:F+1}),e.jsx("span",{className:"step-text",children:H})]},H))}),w?e.jsxs("div",{className:"ticket-sold-out-box",style:{background:"linear-gradient(135deg, rgba(239, 68, 68, 0.15) 0%, rgba(30, 10, 15, 0.95) 100%)",border:"2px solid #ef4444",borderRadius:"24px",padding:"48px 24px",textAlign:"center",boxShadow:"0 20px 50px rgba(239, 68, 68, 0.25)",margin:"20px 0 40px"},children:[e.jsx("div",{style:{display:"inline-flex",alignItems:"center",gap:"8px",background:"#ef4444",color:"#ffffff",padding:"6px 16px",borderRadius:"9999px",fontSize:"13px",fontWeight:"800",letterSpacing:"2px",textTransform:"uppercase",marginBottom:"16px"},children:"🔒 PORTAL LOCKED"}),e.jsx("h2",{style:{fontSize:"clamp(26px, 5vw, 40px)",fontWeight:"900",color:"#ffffff",margin:"0 0 12px"},children:"Tickets Are Officially Sold Out!"}),e.jsxs("p",{style:{color:"#d1d5db",maxWidth:"600px",margin:"0 auto 24px",fontSize:"16px",lineHeight:"1.6"},children:["All General, VIP, and Premium passes for ",e.jsx("strong",{children:"OZILLA FEST 2026"})," have been fully booked. The ticket booking system is locked to prevent overbooking."]}),e.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:"14px",flexWrap:"wrap"},children:[e.jsx("button",{type:"button",onClick:()=>t("/#sponsorship"),style:{background:"linear-gradient(135deg, #d4af37 0%, #aa8420 100%)",color:"#111827",padding:"12px 28px",borderRadius:"12px",fontWeight:"700",fontSize:"14px",border:"none",cursor:"pointer"},children:"Inquire Corporate / Sponsor Passes"}),e.jsx("button",{type:"button",onClick:()=>t("/schedule"),style:{background:"rgba(255,255,255,0.08)",color:"#ffffff",border:"1px solid rgba(255,255,255,0.2)",padding:"12px 24px",borderRadius:"12px",fontWeight:"600",fontSize:"14px",cursor:"pointer"},children:"View Festival Schedule"})]})]}):a?e.jsxs("div",{className:"ticket-main-grid",children:[e.jsxs("div",{className:"ticket-form-card",children:[e.jsxs("div",{className:"ticket-form-header",children:[e.jsx("h2",{children:y?"Payment Checkout":"Pass Reservation"}),e.jsx("span",{className:"ticket-badge-pill",children:"Official Portal"})]}),y?e.jsxs("div",{className:"ticket-payment-wrapper",children:[e.jsx(Us,{activeMethod:A,onSelectMethod:v}),A==="payfast"&&e.jsx(_s,{amount:j.total,onProceed:U,loading:c,onBack:()=>k(!1)}),A==="card"&&e.jsx(Ms,{amount:j.total,onSubmit:q,loading:c,onBack:()=>k(!1)}),A==="jazzcash"&&e.jsx(Os,{amount:j.total,onSubmit:$,loading:c,onBack:()=>k(!1)}),A==="easypaisa"&&e.jsx(Bs,{amount:j.total,onSubmit:T,loading:c,onBack:()=>k(!1)})]}):e.jsx(Cs,{onSubmit:I,loading:c,profileDefaults:a,onBookingChange:f,availability:d,availabilityLoading:L})]}),e.jsx($s,{isOpen:x,onClose:()=>M(!1),ticket:p,amount:j.total,onComplete:X}),e.jsx("aside",{className:"ticket-sidebar",children:e.jsxs("div",{className:"ticket-sidebar-summary",children:[e.jsx("h3",{children:"Order Summary"}),e.jsxs("div",{className:"summary-pass-type",children:[e.jsxs("strong",{children:[j.ticketType," Pass"]}),e.jsx("span",{children:j.day})]}),e.jsxs("div",{className:"summary-rows",children:[e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Quantity"}),e.jsx("strong",{children:j.quantity})]}),e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Price"}),e.jsxs("strong",{children:["PKR ",j.subtotal.toLocaleString()]})]}),e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Fee"}),e.jsx("strong",{style:{color:"#10b981"},children:"Free (PKR 0)"})]}),j.discount>0&&e.jsxs("div",{className:"summary-row summary-discount",children:[e.jsx("span",{children:"Discount"}),e.jsxs("strong",{children:["- PKR ",j.discount.toLocaleString()]})]})]}),e.jsxs("div",{className:"summary-total-row",children:[e.jsx("span",{children:"Grand Total"}),e.jsxs("strong",{children:["PKR ",j.total.toLocaleString()]})]}),e.jsx("div",{className:"summary-pass-badge",children:e.jsx("span",{children:"🎟️ Verified Digital QR Pass"})})]})})]}):e.jsxs("div",{className:"ticket-auth-prompt",children:[e.jsxs("div",{children:[e.jsx("h2",{children:"Sign in to Book Passes"}),e.jsx("p",{children:"Secure ticket purchasing requires an account for verified QR pass generation."})]}),e.jsx("button",{type:"button",onClick:R,className:"ticket-primary-button",children:"Sign In to Continue →"})]})]}),e.jsx("style",{children:`
        .ticket-portal-clean {
          position: relative;
          min-height: 100vh;
          padding: 0 0 3rem;
      ...
      `})]})}function ei(){const{ticketId:t}=ja(),{getTicketById:a}=$t(),[r,s]=m.useState(null),[i,l]=m.useState(!0),[n,o]=m.useState(!1),[c,u]=m.useState(null),g=r?.status==="approved",y=["pending","payment_submitted"].includes(r?.status);if(m.useEffect(()=>{(async()=>{try{const v=await a(t);s(v)}catch{s(null)}finally{l(!1)}})()},[t,a]),i)return e.jsx(Ta,{});if(!r)return e.jsx("div",{className:"bg-[#1b110b]/80 border border-white/10 rounded-2xl p-8 text-center max-w-2xl mx-auto my-12 backdrop-blur-xl",children:e.jsx("p",{className:"text-white/80 font-bold text-lg",children:"Ticket not found."})});const k=async()=>{o(!0),u(null);try{const A=await Ne.cancelTicket(r.id);s(A.ticket),u({type:"success",message:A.message||"Ticket cancelled successfully."})}catch(A){u({type:"error",message:A.response?.data?.message||"Failed to cancel ticket."})}finally{o(!1)}};return e.jsxs("div",{className:"max-w-5xl mx-auto px-4 py-8",children:[e.jsx("div",{className:"flex items-center justify-between gap-3 mb-6",children:e.jsxs("div",{children:[e.jsx("span",{className:"text-[#ffbd59] text-xs font-black uppercase tracking-widest block mb-1",children:"OFFICIAL DIGITAL PASS"}),e.jsx("h1",{className:"text-3xl sm:text-4xl font-black text-white font-['Outfit',sans-serif]",children:"Your Festival Pass"}),e.jsx("p",{className:"text-sm text-white/70 mt-1",children:"Official digital entry pass with scannable QR badge"})]})}),c&&e.jsx(Ut,{type:c.type,message:c.message,onClose:()=>u(null)}),e.jsxs("div",{className:"grid grid-cols-1 gap-8",children:[e.jsx(za,{ticket:r,actionTo:"/tickets/my-tickets",actionLabel:"My Tickets Wallet"}),e.jsxs("div",{className:"bg-[#1b110b]/75 rounded-2xl border border-white/10 shadow-2xl p-6 sm:p-8 backdrop-blur-xl",children:[y&&e.jsx("button",{type:"button",className:"mb-4 bg-rose-600/20 border border-rose-500/40 text-rose-300 px-5 py-2.5 rounded-xl font-bold hover:bg-rose-600/30 transition-colors",onClick:k,disabled:n,children:n?"Cancelling...":"Cancel Ticket Request"}),g?e.jsxs("div",{className:"p-5 bg-emerald-500/10 border border-emerald-500/30 rounded-xl",children:[e.jsx("h2",{className:"text-lg font-bold text-emerald-300 mb-1",children:"Official Pass Ready"}),e.jsxs("p",{className:"text-emerald-200/80 text-sm",children:["Your ticket pass has been verified and the scannable QR badge is active. Click ",e.jsx("strong",{children:"Download Pass"})," above to save the pass image to your device."]})]}):e.jsxs("div",{children:[e.jsx("h2",{className:"text-xl font-bold text-white mb-2 font-['Outfit',sans-serif]",children:"Verification In Progress"}),e.jsxs("div",{className:"bg-amber-500/10 border border-amber-500/30 rounded-xl p-5",children:[e.jsx("p",{className:"text-amber-300 font-semibold mb-1",children:"Pass verification pending admin approval."}),e.jsx("p",{className:"text-amber-200/80 text-sm",children:"Your scannable QR code and downloadable pass image will be unlocked once payment proof is verified by the admin team."})]})]})]})]})]})}function ti(){const{ticketId:t}=ja(),[a,r]=m.useState(null),[s,i]=m.useState(""),[l,n]=m.useState(!0),[o,c]=m.useState(!1),[u,g]=m.useState(null),[y,k]=m.useState(""),A=b=>b==="approved"?"bg-green-100 text-green-800":b==="payment_submitted"?"bg-blue-100 text-blue-700":b==="rejected"||b==="cancelled"?"bg-red-100 text-red-700":"bg-yellow-100 text-yellow-800",v=b=>{try{const x=JSON.parse(b),j=["ticketId","fullName","email","phone","eventName","eventDate","eventTime"].filter(f=>!x[f]);return j.length>0?{ok:!1,message:`Missing fields: ${j.join(", ")}`}:{ok:!0,parsed:x}}catch{return{ok:!1,message:"QR payload is not valid JSON."}}};m.useEffect(()=>{(async()=>{try{const x=await Ne.getTicketById(t);r(x),i(JSON.stringify({ticketId:x.uniqueTicketId||x.ticketId||x.id,fullName:x.fullName||x.name,email:x.email,phone:x.phone,eventName:x.eventName,eventDate:x.eventDate,eventTime:x.eventTime},null,2))}catch{g({type:"error",message:"Ticket not found"})}finally{n(!1)}})()},[t]);const p=async()=>{g(null),k("");const b=v(s);if(!b.ok){k(b.message);return}c(!0);try{const x=await Ne.verifyTicketByQr(s);r(x.ticket||a),g({type:"success",message:x.message||`Ticket verified: ${x.status}`})}catch(x){const M=x.response?.data?.message||"Verification failed",j=x.response?.data?.mismatchedFields?.length?` Mismatched fields: ${x.response.data.mismatchedFields.join(", ")}.`:"";g({type:"error",message:`${M}${j}`})}finally{c(!1)}};return l?e.jsx("div",{className:"flex items-center justify-center min-h-screen",children:e.jsx("div",{className:"animate-spin rounded-full h-16 w-16 border-4 border-purple-600 border-t-transparent"})}):e.jsx("div",{className:"min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center p-6",children:e.jsxs("div",{className:"bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full",children:[e.jsx("h1",{className:"text-3xl font-bold text-gray-800 mb-6 text-center",children:"Ticket Verification"}),u&&e.jsx(Ut,{type:u.type,message:u.message,onClose:()=>g(null)}),a?e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"bg-gradient-to-r from-purple-100 to-blue-100 rounded-lg p-6",children:[e.jsx("h2",{className:"text-xl font-bold text-gray-800 mb-4",children:a.eventName}),e.jsxs("div",{className:"space-y-2",children:[e.jsxs("p",{className:"text-gray-600",children:[e.jsx("span",{className:"font-semibold",children:"Date:"})," ",a.eventDate]}),e.jsxs("p",{className:"text-gray-600",children:[e.jsx("span",{className:"font-semibold",children:"Location:"})," ",a.location]}),e.jsxs("p",{className:"text-gray-600",children:[e.jsx("span",{className:"font-semibold",children:"Ticket Type:"})," ",a.ticketType]}),e.jsxs("p",{className:"text-gray-600",children:[e.jsx("span",{className:"font-semibold",children:"Status:"}),e.jsx("span",{className:`ml-2 px-3 py-1 rounded-full text-sm ${A(a.status)}`,children:a.status})]})]})]}),e.jsx("div",{className:"text-center",children:e.jsx("div",{className:"bg-white border-2 border-dashed border-gray-300 rounded-lg p-4 inline-block",children:e.jsx("div",{className:"w-48 h-48 bg-gray-100 flex items-center justify-center",children:e.jsx("span",{className:"text-gray-400",children:"Scan / Paste QR Data"})})})}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-gray-700 mb-2 font-semibold",children:"QR Payload"}),e.jsx("textarea",{className:"w-full px-4 py-2 border rounded-lg",rows:6,value:s,onChange:b=>i(b.target.value)}),y&&e.jsx("p",{className:"text-sm text-red-600 mt-2",children:y})]}),e.jsx("button",{onClick:p,disabled:o,className:"w-full bg-purple-600 text-white py-3 rounded-lg hover:bg-purple-700 disabled:opacity-50 font-semibold",children:o?"Verifying...":"Verify Ticket"})]}):e.jsx("div",{className:"text-center text-gray-600",children:e.jsx("p",{children:"Ticket not found or invalid."})})]})})}const fa={"Pearl Continental Hotel (PC)":V("/assets/hotels/Pearl-Continental-Lahore.jpg"),"Ramada by Wyndham Lahore":V("/assets/hotels/Ramada-by-Wyndham-Lahore-Gulberg-II.jpg"),"Hotel Indigo Lahore":V("/assets/hotels/Hotel-Indigo.jpg"),"Hotel One Gulberg Lahore":V("/assets/hotels/Hotel-One-Gulberg-Lahore.jpg"),"Luxus Grand Hotel (LC)":V("/assets/hotels/Luxus-Grand-Hotel.jpg"),"Nishat Hotel Lahore":V("/assets/hotels/Nishat.jpg")},ua=V("/assets/hotels/Nishat.jpg"),ai={"Pearl Continental Hotel (PC)":"Iconic five-star city hospitality","Ramada by Wyndham Lahore":"International comfort in Gulberg","Hotel Indigo Lahore":"Boutique lifestyle stay experience","Hotel One Gulberg Lahore":"Smart central festival access","Luxus Grand Hotel (LC)":"Executive luxury with city energy","Nishat Hotel Lahore":"Refined premium Lahore living"},ga=["Pool","Dining","Gym","WiFi","Parking","Service"],ri=[["Festival Partner Hotels","Curated stays selected for Ozilla guests, brand partners, and VIP visitors."],["Premium Hospitality","Polished service, comfortable rooms, and refined Lahore hospitality."],["Exclusive Discounts","Partner booking options connected to the festival experience."],["Best Location","Convenient Lahore access for concerts, food experiences, and festival moments."]];function si(t){return ga[t%ga.length]}function ii(){const t=Pr.hotels.map((a,r)=>({...a,description:a.description||"Hotel partners showcase rooms, location, facilities and Ozilla special rates.",contact:a.contact||"Contact via Ozilla partner desk",facilities:a.facilities||["Rooms and Suites","On-site Facilities","Event Access Support","Partner Booking Assistance"],booking:a.offer,image:V(a.image)||fa[a.name]||V("/assets/prism-auth-visual.jpg"),fallbackImage:fa[a.name]||V("/assets/prism-auth-visual.jpg"),tagline:ai[a.name]||"Premium Ozilla partner hospitality",featured:r===0}));return m.useEffect(()=>{const a=document.querySelectorAll(".hotel-reveal"),r=new IntersectionObserver(s=>{s.forEach(i=>{i.target.classList.toggle("is-visible",i.isIntersecting)})},{threshold:.16,rootMargin:"0px 0px -8% 0px"});return a.forEach(s=>r.observe(s)),()=>r.disconnect()},[]),e.jsxs("main",{className:"hotel-booking-page",style:{"--hotel-hero-image":`url("${ua}")`},children:[e.jsxs("section",{className:"hotel-booking-hero hotel-reveal",children:[e.jsx("div",{className:"hotel-hero-glow hotel-hero-glow-a"}),e.jsx("div",{className:"hotel-hero-glow hotel-hero-glow-b"}),e.jsx("div",{className:"hotel-hero-sweep"}),e.jsxs("div",{className:"hotel-hero-content",children:[e.jsx("p",{className:"hotel-eyebrow",children:"OZILLA FEST 2026"}),e.jsx("h1",{children:"LUXURY HOTELS"}),e.jsx("p",{children:"Stay in the finest hotels and experience premium hospitality during OZILLA FEST 2026."}),e.jsxs("div",{className:"hotel-search-bar","aria-label":"Hotel page highlights",children:[e.jsx("span",{children:"Lahore, Pakistan"}),e.jsx("span",{children:"Festival Partner Hotels"}),e.jsx("span",{children:"Premium Stay Options"})]})]})]}),e.jsxs("section",{className:"hotel-booking-intro hotel-reveal",children:[e.jsxs("div",{children:[e.jsx("p",{className:"hotel-eyebrow",children:"Premium Stay Collection"}),e.jsx("h2",{children:"Browse OZILLA FEST Partner Hotels"})]}),e.jsx("p",{children:"A curated hotel listing experience for guests who want comfort, convenient access, trusted booking links, and premium Lahore hospitality."})]}),e.jsx("section",{className:"hotel-benefit-strip hotel-reveal",children:ri.map(([a,r],s)=>e.jsxs("article",{className:"hotel-benefit-pill",children:[e.jsx("span",{children:String(s+1).padStart(2,"0")}),e.jsxs("div",{children:[e.jsx("h3",{children:a}),e.jsx("p",{children:r})]})]},a))}),e.jsx("section",{className:"hotel-listings","aria-label":"Luxury hotel listings",children:t.map((a,r)=>e.jsxs("article",{className:`hotel-listing-card hotel-reveal ${a.featured?"hotel-listing-featured":""}`,style:{transitionDelay:`${Math.min(r*70,280)}ms`},children:[a.featured?e.jsx("span",{className:"hotel-featured-ribbon",children:"Featured Partner Hotel"}):null,e.jsx("a",{href:a.website||"#",target:a.website?"_blank":void 0,rel:a.website?"noreferrer":void 0,className:"hotel-listing-image-link","aria-label":`Open ${a.name} details`,children:e.jsxs("div",{className:"hotel-listing-image-wrap",children:[a.showImage?e.jsx("img",{src:a.image,alt:a.name,className:"hotel-listing-image",loading:"lazy",referrerPolicy:"no-referrer",onError:s=>{s.currentTarget.onerror=null,s.currentTarget.src=a.fallbackImage}}):e.jsx("div",{className:"hotel-image-placeholder",children:"Premium Hotel Preview"}),e.jsxs("div",{className:"hotel-image-overlay",children:[e.jsx("span",{children:"*****"}),e.jsx("b",{children:"Luxury Stay"}),e.jsx("em",{children:"Premium Partner"})]})]})}),e.jsxs("div",{className:"hotel-listing-info",children:[e.jsxs("div",{className:"hotel-listing-top",children:[e.jsxs("div",{children:[e.jsxs("p",{className:"hotel-rating-line",children:["***** ",e.jsxs("span",{children:[a.rating||"4.8/5"," Exceptional"]})]}),a.website?e.jsx("a",{href:a.website,target:"_blank",rel:"noreferrer",className:"hotel-listing-title",children:a.name}):e.jsx("h2",{className:"hotel-listing-title",children:a.name}),e.jsx("p",{className:"hotel-tagline",children:a.tagline})]}),e.jsxs("div",{className:"hotel-score-box","aria-label":`${a.name} rating`,children:[e.jsx("strong",{children:a.rating?a.rating.replace("/5",""):"4.8"}),e.jsx("span",{children:"Exceptional"})]})]}),e.jsx("p",{className:"hotel-location",children:"Lahore, Pakistan"}),e.jsx("p",{className:"hotel-description",children:a.description}),e.jsx("div",{className:"hotel-amenity-row","aria-label":`${a.name} amenities`,children:a.facilities.slice(0,6).map((s,i)=>e.jsxs("span",{className:"hotel-amenity-chip",children:[e.jsx("b",{children:si(i)}),s]},s))}),e.jsxs("div",{className:"hotel-listing-footer",children:[e.jsxs("div",{className:"hotel-detail-stack",children:[e.jsx("span",{children:"Festival Partner Badge"}),e.jsx("strong",{children:a.booking}),e.jsx("small",{children:a.contact})]}),a.website?e.jsx("a",{href:a.website,target:"_blank",rel:"noreferrer",className:"hotel-action-button",children:"View Details"}):null]})]})]},a.name))}),e.jsxs("section",{className:"hotel-booking-cta hotel-reveal",children:[e.jsx("p",{className:"hotel-eyebrow",children:"Premium Hospitality"}),e.jsx("h2",{children:"Your Perfect Stay Awaits"}),e.jsx("p",{children:"Stay in the finest hotels during OZILLA FEST 2026."}),e.jsx("a",{href:"#top",onClick:a=>{a.preventDefault(),window.scrollTo({top:0,behavior:"smooth"})},children:"Explore Partner Hotels"})]}),e.jsx("style",{children:`
        ...
        .hotel-booking-hero {
          ...
          color: #fff;
            ...
            var(--hotel-hero-image, url('${ua}')) center / cover;
...
`;function ba(t,a,r){const s=t.createShader(a);return s?(t.shaderSource(s,r),t.compileShader(s),t.getShaderParameter(s,t.COMPILE_STATUS)?s:(console.error("ParticleDrift shader:",t.getShaderInfoLog(s)),t.deleteShader(s),null)):null}function ya(t,a,r){const s=ba(t,t.VERTEX_SHADER,a),i=ba(t,t.FRAGMENT_SHADER,r);if(!s||!i)return null;const l=t.createProgram();return l?(t.attachShader(l,s),t.attachShader(l,i),t.linkProgram(l),t.getProgramParameter(l,t.LINK_STATUS)?l:(console.error("ParticleDrift link:",t.getProgramInfoLog(l)),null)):null}function va(t,a){if(!t)return a;const r=String(t).trim();if(r.charAt(0)==="#"){let i=r.slice(1);if((i.length===3||i.length===4)&&(i=i[0]+i[0]+i[1]+i[1]+i[2]+i[2]),i.length>=6){const l=parseInt(i.slice(0,2),16),n=parseInt(i.slice(2,4),16),o=parseInt(i.slice(4,6),16);if(!isNaN(l)&&!isNaN(n)&&!isNaN(o))return[l/255,n/255,o/255]}return a}const s=r.match(/[\d.]+/g);return s&&s.length>=3?[Math.min(255,parseFloat(s[0]))/255,Math.min(255,parseFloat(s[1]))/255,Math.min(255,parseFloat(s[2]))/255]:a}function _e(t,a){return typeof t=="number"&&isFinite(t)?t:a}function rt(t,a,r){return t<a?a:t>r?r:t}function Ti(t){let a=t>>>0;return function(){a+=1831565813;let r=a;return r=Math.imul(r^r>>>15,r|1),r^=r+Math.imul(r^r>>>7,r|61),((r^r>>>14)>>>0)/4294967296}}const Ft=[[0,-1],[1,-1],[1,1],[0,-1],[1,1],[0,1]];function Ei({style:t,background:a="transparent",baseColor:r="#F84400",accentColor:s="#ECECEC",density:i=235,dotSize:l=14,speed:n=100,direction:o=0,hover:c=200,linkDistance:u=202,linkThickness:g=2.5,width:y,height:k,isFixed:A=!0}){const v=m.useRef(null),p=m.useRef(null),b=m.useRef({w:0,h:0});b.current={w:_e(y,0),h:_e(k,0)};const x=m.useRef({x:-1e4,y:-1e4}),M=m.useRef({});M.current={base:r,accent:s,density:Math.round(rt(_e(i,90),10,400)),dotSize:rt(_e(l,5),1,24),speed:rt(_e(n,50),0,100)/50,direction:rt(_e(o,0),0,360),hover:rt(_e(c,100),0,200)/100,linkDistance:rt(_e(u,120),0,400),linkThickness:rt(_e(g,1),.5,8)},m.useEffect(()=>{const f=p.current;if(!f)return;const d=f.getContext("webgl",{alpha:!0,antialias:!1,depth:!1,premultipliedAlpha:!0});if(!d){console.error("ParticleDrift: WebGL unavailable");return}const B=ya(d,Ni,Si),L=ya(d,Ai,Pi);if(!B||!L)return;const P=new Map,h=(se,G)=>{const S=(se===B?"L:":"D:")+G;return P.has(S)||P.set(S,d.getUniformLocation(se,G)),P.get(S)},w=new Float32Array(Ye*6*2),R=new Float32Array(Ye*6*2),I=new Float32Array(Ye*6*2),q=new Float32Array(Ye*6*3);for(let se=0;se<Ye;se++)for(let G=0;G<6;G++){const S=(se*6+G)*2;I[S]=Ft[G][0],I[S+1]=Ft[G][1]}const $=d.createBuffer(),T=d.createBuffer(),U=d.createBuffer(),X=d.createBuffer();d.bindBuffer(d.ARRAY_BUFFER,$),d.bufferData(d.ARRAY_BUFFER,w.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,T),d.bufferData(d.ARRAY_BUFFER,R.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,U),d.bufferData(d.ARRAY_BUFFER,I,d.STATIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,X),d.bufferData(d.ARRAY_BUFFER,q.byteLength,d.DYNAMIC_DRAW);const H=Ti(20260824);let F=0,O=new Float32Array(0),Y=new Float32Array(0),de=new Float32Array(0),N=new Float32Array(0),z=new Float32Array(0);const D=d.createBuffer(),C=d.createBuffer(),_=(se,G,S)=>{F=se,O=new Float32Array(se),Y=new Float32Array(se),de=new Float32Array(se),N=new Float32Array(se*2),z=new Float32Array(se);for(let E=0;E<se;E++)O[E]=H()*G,Y[E]=H()*S,de[E]=(H()*.4+.1)*60;d.bindBuffer(d.ARRAY_BUFFER,D),d.bufferData(d.ARRAY_BUFFER,N.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,C),d.bufferData(d.ARRAY_BUFFER,z.byteLength,d.DYNAMIC_DRAW)};let ae=0,Q=performance.now(),ce=-1,re=0,ne=0;const me=se=>{if(ae=requestAnimationFrame(me),typeof document<"u"&&document.hidden){Q=se;return}const G=Math.min(.05,(se-Q)/1e3);Q=se;const S=M.current,E=S.speed,oe=Math.min(window.devicePixelRatio||1,ji),te=b.current.w||f.clientWidth||window.innerWidth||1200,ie=b.current.h||f.clientHeight||window.innerHeight||800,Le=Math.max(1,Math.round(te*oe)),Te=Math.max(1,Math.round(ie*oe));(f.width!==Le||f.height!==Te)&&(f.width=Le,f.height=Te),d.viewport(0,0,Le,Te);const ke=te<768,Je=te>=768&&te<1024;let De=S.density,Ie=S.linkDistance,dt=S.dotSize;if(ke?(De=Math.max(60,Math.min(Math.round(S.density*.38),90)),Ie=Math.min(S.linkDistance,135),dt=Math.min(S.dotSize,8.5)):Je&&(De=Math.max(90,Math.min(Math.round(S.density*.6),145)),Ie=Math.min(S.linkDistance,165),dt=Math.min(S.dotSize,11)),De!==ce&&(_(De,te,ie),ce=De),te!==re||ie!==ne){const W=te/Math.max(re||te,1),le=ie/Math.max(ne||ie,1);for(let he=0;he<F;he++)O[he]*=W,Y[he]*=le;re=te,ne=ie}const Qe=x.current,pt=S.hover,mt=(ke?100:180)*(pt>0?1:0),Ae=Ie,ft=ke?Math.min(S.linkThickness,1.6):S.linkThickness,xt=S.direction*Math.PI/180,bt=Math.sin(xt),At=Math.cos(xt);let ze=0;const yt=(W,le,he,Pe,ve,Re,Ge,it)=>{if(!(ze>=Ye)){for(let Me=0;Me<6;Me++){const nt=(ze*6+Me)*2,Pt=(ze*6+Me)*3;w[nt]=W,w[nt+1]=le,R[nt]=he,R[nt+1]=Pe,q[Pt]=Ft[Me][0]===0?ve:Re,q[Pt+1]=Ge,q[Pt+2]=it}ze++}};for(let W=0;W<F;W++){O[W]+=de[W]*bt*G*E,Y[W]+=de[W]*At*G*E,O[W]<-qe?(O[W]=te+qe,Y[W]=H()*ie):O[W]>te+qe&&(O[W]=-qe,Y[W]=H()*ie),Y[W]<-qe?(Y[W]=ie+qe,O[W]=H()*te):Y[W]>ie+qe&&(Y[W]=-qe,O[W]=H()*te);const le=Qe.x-O[W],he=Qe.y-Y[W],Pe=Math.sqrt(le*le+he*he),ve=mt>0&&Pe<mt?1:0;if(ve===1){const Re=.5*(1-Pe/mt)*pt;yt(O[W],Y[W],Qe.x,Qe.y,Re,Re,1,ft)}N[W*2]=O[W],N[W*2+1]=Y[W],z[W]=ve}if(Ae>0){const W=Ae*Ae;for(let le=0;le<F&&ze<Ye;le++){const he=O[le],Pe=Y[le];for(let ve=le+1;ve<F&&ze<Ye;ve++){const Re=he-O[ve];if(Re>Ae||Re<-Ae)continue;const Ge=Pe-Y[ve];if(Ge>Ae||Ge<-Ae)continue;const it=Re*Re+Ge*Ge;if(it>=W)continue;const Me=.15*(1-Math.sqrt(it)/Ae);yt(he,Pe,O[ve],Y[ve],Me,Me,0,ft)}}}d.clearColor(0,0,0,0),d.clear(d.COLOR_BUFFER_BIT),d.disable(d.DEPTH_TEST),d.enable(d.BLEND),d.blendFunc(d.ONE,d.ONE_MINUS_SRC_ALPHA);const Ue=va(S.base,[.973,.267,0]),He=va(S.accent,[.925,.925,.925]);if(ze>0){d.useProgram(B);const W=ze*6;d.bindBuffer(d.ARRAY_BUFFER,$),d.bufferSubData(d.ARRAY_BUFFER,0,w.subarray(0,W*2));const le=d.getAttribLocation(B,"a_p0");d.enableVertexAttribArray(le),d.vertexAttribPointer(le,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,T),d.bufferSubData(d.ARRAY_BUFFER,0,R.subarray(0,W*2));const he=d.getAttribLocation(B,"a_p1");d.enableVertexAttribArray(he),d.vertexAttribPointer(he,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,U);const Pe=d.getAttribLocation(B,"a_corner");d.enableVertexAttribArray(Pe),d.vertexAttribPointer(Pe,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,X),d.bufferSubData(d.ARRAY_BUFFER,0,q.subarray(0,W*3));const ve=d.getAttribLocation(B,"a_shade");d.enableVertexAttribArray(ve),d.vertexAttribPointer(ve,3,d.FLOAT,!1,0,0),d.uniform2f(h(B,"uSize"),te,ie),d.uniform3f(h(B,"uBase"),Ue[0],Ue[1],Ue[2]),d.uniform3f(h(B,"uAccent"),He[0],He[1],He[2]),d.drawArrays(d.TRIANGLES,0,W),d.disableVertexAttribArray(le),d.disableVertexAttribArray(he),d.disableVertexAttribArray(Pe),d.disableVertexAttribArray(ve)}if(F>0){d.useProgram(L),d.bindBuffer(d.ARRAY_BUFFER,D),d.bufferSubData(d.ARRAY_BUFFER,0,N);const W=d.getAttribLocation(L,"a_pos");d.enableVertexAttribArray(W),d.vertexAttribPointer(W,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,C),d.bufferSubData(d.ARRAY_BUFFER,0,z);const le=d.getAttribLocation(L,"a_lit");d.enableVertexAttribArray(le),d.vertexAttribPointer(le,1,d.FLOAT,!1,0,0),d.uniform2f(h(L,"uSize"),te,ie),d.uniform1f(h(L,"uDpr"),oe),d.uniform1f(h(L,"uDot"),dt),d.uniform1f(h(L,"uRestAlpha"),.4),d.uniform3f(h(L,"uBase"),Ue[0],Ue[1],Ue[2]),d.uniform3f(h(L,"uAccent"),He[0],He[1],He[2]),d.drawArrays(d.POINTS,0,F),d.disableVertexAttribArray(W),d.disableVertexAttribArray(le)}},ye=se=>{const G=f.getBoundingClientRect();if(G.width<=0||G.height<=0)return;const S=b.current.w||f.clientWidth||window.innerWidth||1200,E=b.current.h||f.clientHeight||window.innerHeight||800;x.current.x=(se.clientX-G.left)/G.width*S,x.current.y=(se.clientY-G.top)/G.height*E},fe=()=>{x.current.x=-1e4,x.current.y=-1e4};return window.addEventListener("pointermove",ye,{passive:!0}),window.addEventListener("pointerleave",fe,{passive:!0}),ae=requestAnimationFrame(me),()=>{cancelAnimationFrame(ae),window.removeEventListener("pointermove",ye),window.removeEventListener("pointerleave",fe),d.deleteBuffer($),d.deleteBuffer(T),d.deleteBuffer(U),d.deleteBuffer(X),d.deleteBuffer(D),d.deleteBuffer(C),d.deleteProgram(B),d.deleteProgram(L)}},[]);const j=A?{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:0,pointerEvents:"none",overflow:"hidden",background:a,isolation:"isolate",...t}:{position:"relative",overflow:"hidden",background:a,isolation:"isolate",width:typeof y=="number"&&y>0?y:"100%",height:typeof k=="number"&&k>0?k:"100%",...t};return e.jsx("div",{ref:v,style:j,"aria-hidden":"true",children:e.jsx("canvas",{ref:p,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}})})}function Ci(){const t="/ozillafest/".replace(/\/$/,"");return e.jsx(Ha,{basename:t||void 0,future:{v7_startTransition:!0,v7_relativeSplatPath:!0},children:e.jsxs(Ka,{children:[e.jsx(Ei,{}),e.jsx(ki,{})]})})}const wa=(t="")=>{const a=String(t).toLowerCase();return a.includes("importing a module script failed")||a.includes("failed to fetch dynamically imported module")||a.includes("loading chunk")||a.includes("failed to load module script")||a.includes("error loading dynamically imported module")||a.includes("mime type")||a.includes("dynamically imported")};class Li extends m.Component{constructor(r){super(r);Gt(this,"handleReload",()=>{sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload()});this.state={error:null}}static getDerivedStateFromError(r){return{error:r}}componentDidCatch(r,s){if(console.error("Application render error:",r,s),wa(r?.message)){const i=Number(sessionStorage.getItem("chunk_reload_ts")||0);Date.now()-i>8e3&&(sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload())}}render(){if(this.state.error){const r=wa(this.state.error?.message);return e.jsxs("main",{style:{padding:"32px 20px",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',maxWidth:"540px",margin:"60px auto",textAlign:"center",backgroundColor:"#121118",color:"#f3f4f6",borderRadius:"16px",border:"1px solid rgba(255,255,255,0.1)",boxShadow:"0 20px 50px rgba(0,0,0,0.5)"},children:[e.jsx("h2",{style:{color:"#f97316",marginBottom:"12px",fontSize:"1.4rem"},children:r?"New Update Available":"Ozilla Festival could not render"}),e.jsx("p",{style:{color:"#9ca3af",marginBottom:"20px",fontSize:"0.95rem",lineHeight:"1.5"},children:r?"A fresh update has been deployed. Please tap refresh to load the latest version.":"Please refresh the page to reload the application."}),e.jsx("button",{type:"button",onClick:this.handleReload,style:{padding:"12px 28px",backgroundColor:"#ea580c",color:"#ffffff",border:"none",borderRadius:"999px",cursor:"pointer",fontWeight:"700",fontSize:"1rem",boxShadow:"0 4px 14px rgba(234, 88, 12, 0.4)",transition:"transform 0.15s ease"},children:"Refresh Website"})]})}return this.props.children}}if(typeof window<"u"){const t=a=>{const r=String(a?.message||a?.reason?.message||"").toLowerCase();if(r.includes("importing a module script failed")||r.includes("failed to fetch dynamically imported module")||r.includes("loading chunk")||r.includes("failed to load module script")){const s=Number(sessionStorage.getItem("chunk_reload_ts")||0);Date.now()-s>8e3&&(sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload())}};window.addEventListener("error",t),window.addEventListener("unhandledrejection",t)}Ot.createRoot(document.getElementById("root")).render(e.jsx(gt.StrictMode,{children:e.jsx(Li,{children:e.jsx(qa,{clientId:"placeholder-client-id",children:e.jsx(Ci,{})})})}));export{Ut as A,$t as a,ee as b,Vs as f,Ne as t,Ke as u};
