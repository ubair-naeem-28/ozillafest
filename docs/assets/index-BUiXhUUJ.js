const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/UserDashboardPage-BBERp-Rv.js","assets/vendor-motion-Do9_0UrH.js","assets/vendor-react-nW6paGhL.js","assets/useTicket-DM-gPJjA.js","assets/ticketService-BCbfcxYW.js","assets/PageHeader-DSdXBTCQ.js","assets/formatDate.util-wEQv7dlP.js","assets/vendor-utils-nxL8y1-h.js","assets/TicketPortalPage-DlbRS4Ni.js","assets/AlertMessage-D_3e8DO-.js","assets/MyTicketsPage-BsobgFOg.js","assets/GeneratedTicketCard-CCfCQ_fS.js","assets/TicketViewPage-DcXBkfHH.js","assets/TicketVerificationPage-MkliexL6.js","assets/AdminDashboardPage-D4ME6g8L.js","assets/AdminTicketReviewPage-fobcFNAo.js","assets/HotelsPage-TGuxxWJg.js","assets/FestivalSchedulePage-2Cng7Uio.js","assets/LegalPage-Cp5apOjn.js","assets/NotFound-12U-ahfn.js"])))=>i.map(i=>d[i]);
var da=Object.defineProperty;var pa=(t,s,a)=>s in t?da(t,s,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[s]=a;var Rt=(t,s,a)=>pa(t,typeof s!="symbol"?s+"":s,a);import{j as e,u as aa,m as H,a as Tt,b as ma,A as ua}from"./vendor-motion-Do9_0UrH.js";import{a as fa,r as m,R as lt,u as $e,N as ue,O as ct,L as q,b as dt,c as ha,d as ga,e as xa,f as B,B as ba}from"./vendor-react-nW6paGhL.js";import{a as va}from"./vendor-utils-nxL8y1-h.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const d of l.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function a(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(i){if(i.ep)return;i.ep=!0;const l=a(i);fetch(i.href,l)}})();var Et={},It=fa;Et.createRoot=It.createRoot,Et.hydrateRoot=It.hydrateRoot;function ya(t={}){const{nonce:s,locale:a,onScriptLoadSuccess:r,onScriptLoadError:i}=t,[l,d]=m.useState(!1),o=m.useRef(r);o.current=r;const p=m.useRef(i);return p.current=i,m.useEffect(()=>{const h=document.createElement("script");return h.src="https://accounts.google.com/gsi/client",a&&(h.src+=`?hl=${a}`),h.async=!0,h.defer=!0,h.nonce=s,h.onload=()=>{var x;d(!0),(x=o.current)===null||x===void 0||x.call(o)},h.onerror=()=>{var x;d(!1),(x=p.current)===null||x===void 0||x.call(p)},document.body.appendChild(h),()=>{document.body.removeChild(h)}},[s]),l}const wa=m.createContext(null);function ja({clientId:t,nonce:s,locale:a,onScriptLoadSuccess:r,onScriptLoadError:i,children:l}){const d=ya({nonce:s,onScriptLoadSuccess:r,onScriptLoadError:i,locale:a}),o=m.useMemo(()=>({locale:a,clientId:t,scriptLoadedSuccessfully:d}),[t,d]);return lt.createElement(wa.Provider,{value:o},l)}const yt="prism_token",je={getToken(){return localStorage.getItem(yt)},setToken(t){localStorage.setItem(yt,t)},removeToken(){localStorage.removeItem(yt)}},ka="http://localhost:5000/api",ve=va.create({baseURL:ka,headers:{"Content-Type":"application/json"}});ve.interceptors.request.use(t=>{const s=je.getToken();return s&&(t.headers.Authorization=`Bearer ${s}`),t},t=>Promise.reject(t));ve.interceptors.response.use(t=>t,t=>(t.response?.status===401&&je.removeToken(),Promise.reject(t)));const Ne={AUTH:{LOGIN:"/auth/login",REGISTER:"/auth/register",LOGOUT:"/auth/logout",SEND_OTP:"/auth/resend-otp",RESEND_OTP:"/auth/resend-otp",VERIFY_OTP:"/auth/verify-otp",FORGOT_PASSWORD:"/auth/forgot-password",RESET_PASSWORD:"/auth/reset-password",GOOGLE:"/auth/google",GOOGLE_CODE_LOGIN:"/auth/google/code-login",GOOGLE_TOKEN_LOGIN:"/auth/google/token-login",ME:"/auth/me",PROFILE:"/auth/profile"},TICKETS:{MY_TICKETS:"/tickets/my-tickets",REQUEST:"/tickets/request",BY_ID:"/tickets/:id",PAYMENT_PROOF:"/tickets/:id/payment-proof",VERIFY:"/tickets/:id/verify"},CONTENT:{EVENTS:"/content/events",EVENT_BY_ID:"/content/events/:id",SPONSORS:"/content/sponsors",FACILITIES:"/content/facilities",CONTACT:"/content/contact"}},sa="ozilla_local_users";let Ze=!1;function be(t){return String(t||"").toLowerCase().trim()}function _e(t){return String(t||"").trim()}function Fe(){try{const t=localStorage.getItem(sa),s=t?JSON.parse(t):[];return Array.isArray(s)?s:[]}catch{return[]}}function Be(t){localStorage.setItem(sa,JSON.stringify(t))}function Na(t){const s={sub:t.id,email:t.email,mode:"local-fallback"};return`local.${btoa(JSON.stringify(s))}`}function wt(t){const s=String(t||"");if(!s)return null;if(s.startsWith("local."))try{return JSON.parse(atob(s.slice(6)))}catch{return null}const a=s.split(".");if(a.length===3)try{return JSON.parse(atob(a[1]))}catch{return null}return null}function ot(t){return{id:t.id,firstName:t.firstName,lastName:t.lastName,name:t.name||`${t.firstName||""} ${t.lastName||""}`.trim(),email:t.email,phone:t.phone,role:t.role||"user"}}function et(t={}){const s=String(t.firstName||"Local").trim()||"Local",a=String(t.lastName||"User").trim()||"User",r=be(t.email||"local@ozillafestival.com"),i=_e(t.phone||"+923000000000");return{id:t.id||`local-user-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,firstName:s,lastName:a,name:`${s} ${a}`.trim(),email:r,phone:i,password:String(t.password||""),role:"user"}}function Pt(t){return!t?.response&&(t?.code==="ERR_NETWORK"||t?.message?.includes("Network Error")||t?.message?.includes("ECONNREFUSED"))}function ft(t){return Pt(t)?(Ze=!0,!0):!1}function tt(t){const s=ot(t);return{token:Na(s),user:s,mode:"local-fallback"}}const Ge={async login(t){const s=String(t?.email||t?.phone||t?.identifier||"").trim(),a=be(s),r=_e(s),i=String(t?.password||"").trim();try{const l=await ve.post(Ne.AUTH.LOGIN,{email:s,password:i});if(l?.data?.token){const d=Fe(),o=d.findIndex(h=>be(h.email)===a||_e(h.phone)===r),p={id:l.data.user?.id||`user-${Date.now()}`,firstName:l.data.user?.firstName||"",lastName:l.data.user?.lastName||"",name:l.data.user?.name||"",email:l.data.user?.email?be(l.data.user.email):a,phone:l.data.user?.phone?_e(l.data.user.phone):r,password:i,role:l.data.user?.role||"user"};return o>=0?(d[o]=p,Be(d)):Be([p,...d]),l.data}return l.data}catch(l){const d=Fe(),o=d.find(h=>(be(h.email)===a||_e(h.phone)===r)&&h.password===i);if(o)return Ze=!0,tt(o);const p=d.find(h=>be(h.email)===a||_e(h.phone)===r);if(p&&p.password!==i){const h=new Error("Invalid credentials. Please check your password.");throw h.response={status:401,data:{message:"Invalid credentials. Please check your password."}},h}throw l}},async register(t){const s=be(t?.email),a=_e(t?.phone),r=String(t?.password||"").trim(),i=Fe(),l=i.find(o=>be(o.email)===s),d=i.find(o=>_e(o.phone)===a);try{const o=await ve.post(Ne.AUTH.REGISTER,{...t,email:s,phone:a,password:r});if(o?.data?.token){const p=et({id:o.data.user?.id,firstName:t.firstName,lastName:t.lastName,email:s,phone:a,password:r}),h=i.filter(x=>be(x.email)!==s&&_e(x.phone)!==a);Be([p,...h])}return o.data}catch(o){if(o?.response?.status===409||o?.response?.data?.message)throw o;if(l){const h=new Error("Account already exists with this email. Please log in.");throw h.response={status:409,data:{message:"Account already exists with this email. Please log in."}},h}if(d){const h=new Error("Account already exists with this phone number. Please log in.");throw h.response={status:409,data:{message:"Account already exists with this phone number. Please log in."}},h}const p=et({...t,email:s,phone:a,password:r});return Be([p,...i]),Ze=!0,tt(p)}},async sendOtp(t){const s=be(t);try{return(await ve.post(Ne.AUTH.SEND_OTP,{email:s})).data}catch(a){if(a?.response?.status===404)try{return(await ve.post(Ne.AUTH.RESEND_OTP,{email:s})).data}catch(r){if(r?.response?.data?.message)throw r}if(a?.response?.data?.message)throw a;if(Pt(a)){const r=new Error("Cannot connect to backend server. Please ensure the backend server is running and reachable.");throw r.response={status:503,data:{message:"Cannot connect to backend server. Please ensure the backend server is running and reachable."}},r}throw a}},async resendOtp(t){return this.sendOtp(t)},async verifyOtp(t){const s=be(t?.email),a=String(t?.otp||"").trim();try{return(await ve.post(Ne.AUTH.VERIFY_OTP,{email:s,otp:a})).data}catch(r){if(r?.response?.data?.message)throw r;if(Pt(r)){const i=new Error("Cannot connect to backend server at http://localhost:5000. Please ensure the backend server is running.");throw i.response={status:503,data:{message:"Cannot connect to backend server at http://localhost:5000. Please ensure the backend server is running."}},i}throw r}},async getCurrentUser(){const t=je.getToken();if(!t){const a=new Error("Unauthorized");throw a.response={status:401,data:{message:"Unauthorized"}},a}const s=wt(t);if(s?.mode==="local-fallback"||String(t||"").startsWith("local.")){const r=Fe().find(i=>i.id===s?.sub||be(i.email)===be(s?.email));if(r)return ot(r)}try{return(await ve.get(Ne.AUTH.ME)).data}catch(a){const i=Fe().find(l=>l.id===s?.sub||be(l.email)===be(s?.email));if(i)return ot(i);throw a}},async logout(){if(Ze)return{message:"Logged out successfully"};try{return(await ve.post(Ne.AUTH.LOGOUT)).data}catch(t){if(ft(t))return{message:"Logged out successfully"};throw t}},async forgotPassword(t){return(await ve.post(Ne.AUTH.FORGOT_PASSWORD,{email:t})).data},async resetPassword(t){return(await ve.post(Ne.AUTH.RESET_PASSWORD,t)).data},async googleAuth(t,s){if(Ze){const r=et(s||{email:"ubair1100@gmail.com",firstName:"Ubair",lastName:"Naeem"}),i=Fe();return i.some(l=>l.email===r.email)||Be([r,...i]),tt(r)}try{return(await ve.post(Ne.AUTH.GOOGLE,{token:t,profile:s})).data}catch(a){if(ft(a)){const i=et(s||{email:"ubair1100@gmail.com",firstName:"Ubair",lastName:"Naeem"});return tt(i)}throw a}},async googleCodeLogin(t,s="postmessage",a){if(Ze){const i=et(a||{email:"ubair1100@gmail.com",firstName:"Ubair",lastName:"Naeem"}),l=Fe();return l.some(d=>d.email===i.email)||Be([i,...l]),tt(i)}try{return(await ve.post(Ne.AUTH.GOOGLE_CODE_LOGIN,{code:t,redirectUri:s,profile:a})).data}catch(r){if(ft(r)){const l=et(a||{email:"ubair1100@gmail.com",firstName:"Ubair",lastName:"Naeem"});return tt(l)}throw r}},async googleTokenLogin(t,s){return this.googleAuth(t,s)},async updateProfile(t){if(Ze){const s=je.getToken(),a=wt(s),r=Fe(),i=r.findIndex(o=>o.id===a?.sub||o.email===a?.email);if(i===-1){const o=new Error("Unauthorized");throw o.response={status:401,data:{message:"Unauthorized"}},o}const l=r[i],d={...l,firstName:typeof t?.firstName=="string"?t.firstName.trim():l.firstName,lastName:typeof t?.lastName=="string"?t.lastName.trim():l.lastName,phone:typeof t?.phone=="string"?t.phone.trim():l.phone};return d.name=`${d.firstName||""} ${d.lastName||""}`.trim()||l.name,r[i]=d,Be(r),{message:"Profile updated successfully",user:ot(d)}}try{return(await ve.put(Ne.AUTH.PROFILE,t)).data}catch(s){if(ft(s)){const a=je.getToken(),r=wt(a),i=Fe(),l=i.findIndex(p=>p.id===r?.sub||p.email===r?.email);if(l===-1){const p=new Error("Unauthorized");throw p.response={status:401,data:{message:"Unauthorized"}},p}const d=i[l],o={...d,firstName:typeof t?.firstName=="string"?t.firstName.trim():d.firstName,lastName:typeof t?.lastName=="string"?t.lastName.trim():d.lastName,phone:typeof t?.phone=="string"?t.phone.trim():d.phone};return o.name=`${o.firstName||""} ${o.lastName||""}`.trim()||d.name,i[l]=o,Be(i),{message:"Profile updated successfully",user:ot(o)}}throw s}}},ra=m.createContext(null);function Sa({children:t}){const[s,a]=m.useState(null),[r,i]=m.useState(!0);m.useEffect(()=>{l()},[]);const l=async()=>{try{if(je.getToken()){const N=await Ge.getCurrentUser();a(N)}}catch{je.removeToken()}finally{i(!1)}},d=async j=>{const N=await Ge.login(j);return je.setToken(N.token),a(N.user),N},o=async j=>{const N=await Ge.register(j);return je.setToken(N.token),a(N.user),N},p=()=>{Ge.logout().catch(()=>{}),je.removeToken(),a(null)},h=s?.role==="admin"||["ubair1100@gmail.com","admin@ozillafestival.com","muhammadubair@gmail.com","admin@prism.com"].includes(String(s?.email||"").toLowerCase().trim()),x={user:s,isAdmin:h,loading:r,login:d,register:o,logout:p,checkAuth:l};return e.jsx(ra.Provider,{value:x,children:t})}const Aa="modulepreload",Ea=function(t){return"/ozillafest/"+t},Lt={},Ee=function(s,a,r){let i=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),o=d?.nonce||d?.getAttribute("nonce");i=Promise.allSettled(a.map(p=>{if(p=Ea(p),p in Lt)return;Lt[p]=!0;const h=p.endsWith(".css"),x=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${x}`))return;const j=document.createElement("link");if(j.rel=h?"stylesheet":Aa,h||(j.as="script"),j.crossOrigin="",j.href=p,o&&j.setAttribute("nonce",o),document.head.appendChild(j),h)return new Promise((N,C)=>{j.addEventListener("load",N),j.addEventListener("error",()=>C(new Error(`Unable to preload CSS for ${p}`)))})}))}function l(d){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=d,window.dispatchEvent(o),!o.defaultPrevented)throw d}return i.then(d=>{for(const o of d||[])o.status==="rejected"&&l(o.reason);return s().catch(l)})};function at(){const t=m.useContext(ra);if(!t)throw new Error("useAuth must be used within an AuthProvider");return t}function Pa({children:t}){const{user:s,loading:a}=at(),r=$e();if(a)return e.jsx("div",{className:"flex items-center justify-center min-h-screen",children:"Loading..."});if(!s){const i=`${r.pathname}${r.search}`,l=new URLSearchParams({returnTo:i}).toString();return e.jsx(ue,{to:`/login?${l}`,replace:!0})}return t||e.jsx(ct,{})}function xt(t,s="/dashboard"){if(!t||typeof t!="string")return s;let a=t.trim();if(a.startsWith("//")||/^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(a))return s;a.startsWith("/ozillafest")&&(a=a.slice(11)),a.startsWith("/")||(a=`/${a}`);const r=a.split("?")[0].replace(/\/$/,"");return!r||r==="/login"||r==="/register"?s:a}function Ra({children:t}){const{user:s,loading:a}=at(),r=$e();if(a)return e.jsx("div",{className:"flex items-center justify-center min-h-screen",children:"Loading..."});if(s){const l=new URLSearchParams(r.search).get("returnTo"),d=xt(l,"/dashboard");return e.jsx(ue,{to:d,replace:!0})}return t||e.jsx(ct,{})}function G(t){if(!t||typeof t!="string"||t.startsWith("http://")||t.startsWith("https://")||t.startsWith("data:")||t.startsWith("blob:"))return t;const s="/ozillafest/",a=s.endsWith("/")?s:`${s}/`,r=t.replace(/^\/+/,"");return r.startsWith("assets/")||r.startsWith("favicon")?`${a}${r}`:t.startsWith("/")?`${a}${r}`:t}function Ta({className:t="",nodeColor:s="#EC4899",lineColor:a="236, 72, 153",secondaryColor:r="255, 90, 31",maxDistance:i=135,speed:l=.5}){const d=m.useRef(null);return m.useEffect(()=>{const o=d.current;if(!o)return;const p=o.getContext("2d",{alpha:!0});if(!p)return;let h=null,x=!0,j=!1,N=o.width=o.parentElement?.clientWidth||window.innerWidth,C=o.height=o.parentElement?.clientHeight||window.innerHeight;const w=N<768?18:34,D=340,I=450,$=i*i;let O={x:N/2,y:C/2,active:!1},R={rotX:0,rotY:0,targetRotX:0,targetRotY:0};const n=[];for(let _=0;_<w;_++)n.push({x:(Math.random()-.5)*N*1.1,y:(Math.random()-.5)*C*1.1,z:(Math.random()-.5)*I,vx:(Math.random()-.5)*l*.7,vy:(Math.random()-.5)*l*.7,vz:(Math.random()-.5)*l*.7,radius:Math.random()*1.8+1.2,colorType:Math.random()>.4?"primary":"secondary"});const W=()=>{o.parentElement&&(N=o.width=o.parentElement.clientWidth||window.innerWidth,C=o.height=o.parentElement.clientHeight||window.innerHeight)};window.addEventListener("resize",W,{passive:!0});const A=_=>{if(!x)return;const se=o.getBoundingClientRect();O.x=_.clientX-se.left,O.y=_.clientY-se.top,O.active=!0;const K=(O.x-N/2)/(N/2),ae=(O.y-C/2)/(C/2);R.targetRotY=K*.14,R.targetRotX=-ae*.14},y=()=>{O.active=!1,R.targetRotX=0,R.targetRotY=0};window.addEventListener("mousemove",A,{passive:!0}),window.addEventListener("mouseleave",y,{passive:!0});const c=()=>{if(!x||document.hidden){j=!1;return}p.clearRect(0,0,N,C),R.rotX+=(R.targetRotX-R.rotX)*.05,R.rotY+=(R.targetRotY-R.rotY)*.05;const _=Math.cos(R.rotY),se=Math.sin(R.rotY),K=Math.cos(R.rotX),ae=Math.sin(R.rotX),oe=N/2,U=C/2,F=N*.65,z=C*.65,ce=I*.55,u=[];for(let S=0;S<w;S++){const v=n[S];v.x+=v.vx,v.y+=v.vy,v.z+=v.vz,(v.x<-F||v.x>F)&&(v.vx*=-1),(v.y<-z||v.y>z)&&(v.vy*=-1),(v.z<-ce||v.z>ce)&&(v.vz*=-1);const P=v.x*_-v.z*se,Z=v.z*_+v.x*se,V=v.y*K-Z*ae,le=Z*K+v.y*ae,J=le+I;if(J<=0)continue;const re=D/(D+J*.65),de=oe+P*re,fe=U+V*re,pe=Math.max(.18,Math.min(.85,(le+I)/(I*1.4)));u.push({x:de,y:fe,scale:re,alpha:pe,radius:Math.max(1.2,v.radius*re),colorType:v.colorType})}const k=u.length;for(let S=0;S<k;S++){const v=u[S];let P=0;for(let Z=S+1;Z<k&&P<3;Z++){const V=u[Z],le=v.x-V.x,J=v.y-V.y,re=le*le+J*J;if(re<$){P++;const de=Math.sqrt(re),fe=(1-de/i)*.4*Math.min(v.alpha,V.alpha),pe=v.colorType==="primary"?a:r;p.beginPath(),p.moveTo(v.x,v.y),p.lineTo(V.x,V.y),p.strokeStyle=`rgba(${pe}, ${fe})`,p.lineWidth=Math.max(.5,(1-de/i)*1.2),p.stroke()}}}for(let S=0;S<k;S++){const v=u[S],P=v.colorType==="primary"?`rgba(${a}, ${v.alpha})`:`rgba(${r}, ${v.alpha})`;p.beginPath(),p.arc(v.x,v.y,v.radius,0,Math.PI*2),p.fillStyle=P,p.fill()}h=requestAnimationFrame(c)},f=()=>{!j&&x&&!document.hidden&&(j=!0,h=requestAnimationFrame(c))},E=()=>{j=!1,h&&(cancelAnimationFrame(h),h=null)};let M=null;"IntersectionObserver"in window?(M=new IntersectionObserver(([_])=>{x=_.isIntersecting,x?f():E()},{threshold:.05}),M.observe(o)):f();const X=()=>{document.hidden?E():x&&f()};return document.addEventListener("visibilitychange",X),()=>{E(),window.removeEventListener("resize",W),window.removeEventListener("mousemove",A),window.removeEventListener("mouseleave",y),document.removeEventListener("visibilitychange",X),M&&M.disconnect()}},[s,a,r,i,l]),e.jsx("canvas",{ref:d,className:`plexus-net-canvas ${t}`,"aria-hidden":"true",style:{position:"absolute",inset:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:1,willChange:"transform"}})}const Ia=lt.memo(Ta);function jt({children:t}){const s=$e(),a=s.pathname==="/login",r=s.pathname==="/register",[i,l]=m.useState({x:0,y:0}),[d,o]=m.useState({x:50,y:42}),p=x=>{if(x.pointerType==="touch")return;const j=x.currentTarget.getBoundingClientRect(),N=(x.clientX-j.left)/j.width,C=(x.clientY-j.top)/j.height;l({x:(.5-C)*10,y:(N-.5)*10}),o({x:N*100,y:C*100})},h=()=>{l({x:0,y:0}),o({x:50,y:42})};return e.jsxs("main",{className:`kx-page auth-page ${a?"auth-page-login":""} ${r?"auth-page-register":""}`,children:[e.jsx(Ia,{nodeColor:"#EC4899",lineColor:"236, 72, 153",secondaryColor:"255, 90, 31",maxDistance:130,speed:.4}),e.jsx("div",{className:"kx-grid","aria-hidden":"true"}),e.jsx("div",{className:"kx-noise","aria-hidden":"true"}),e.jsx("div",{className:"kx-halo kx-halo-top","aria-hidden":"true"}),e.jsx("div",{className:"kx-halo kx-halo-bottom","aria-hidden":"true"}),e.jsx("div",{className:"kx-orb kx-orb-left","aria-hidden":"true"}),e.jsx("div",{className:"kx-orb kx-orb-right","aria-hidden":"true"}),e.jsxs("section",{className:`kx-stage ${r?"kx-stage-wide":""}`,children:[e.jsx("div",{className:"kx-tilt",onPointerMove:p,onPointerLeave:h,onPointerCancel:h,style:{transform:`rotateX(${i.x}deg) rotateY(${i.y}deg)`},children:e.jsxs("div",{className:"kx-card-shell",children:[e.jsx("div",{className:"kx-shadow","aria-hidden":"true"}),e.jsxs("div",{className:"kx-runners","aria-hidden":"true",children:[e.jsx("span",{className:"kx-runner kx-runner-top"}),e.jsx("span",{className:"kx-runner kx-runner-right"}),e.jsx("span",{className:"kx-runner kx-runner-bottom"}),e.jsx("span",{className:"kx-runner kx-runner-left"})]}),e.jsxs("article",{className:"kx-card",children:[e.jsx("div",{className:"kx-pointer-glow","aria-hidden":"true",style:{left:`${d.x}%`,top:`${d.y}%`}}),e.jsx("div",{className:"kx-card-pattern","aria-hidden":"true"}),e.jsxs("header",{className:"kx-header",children:[e.jsx(q,{to:"/",className:"kx-logo-link","aria-label":"OZILLA FEST Home",children:e.jsxs("div",{className:"kx-logo",children:[e.jsx("img",{src:G("/assets/ozilla/logo.png"),alt:"OZILLA FEST Logo",onError:x=>{x.currentTarget.src=G("/assets/logo.jpeg")}}),e.jsx("i",{"aria-hidden":"true"})]})}),e.jsx("span",{className:"kx-tag",children:"PAKISTAN'S PREMIER MUSIC FESTIVAL"}),e.jsx("h1",{className:"kx-title",children:a?"Welcome Back":"Join OZILLA FEST"}),e.jsx("p",{className:"kx-subtitle",children:a?"Sign in to access your passes, tickets & workspace":"Create your account for the ultimate festival experience"}),e.jsxs("div",{className:"kx-tabs",children:[e.jsx(q,{to:`/login${s.search}`,className:`kx-tab-btn ${a?"active":""}`,children:"Sign In"}),e.jsx(q,{to:`/register${s.search}`,className:`kx-tab-btn ${r?"active":""}`,children:"Create Account"})]})]}),e.jsx("div",{className:"kx-card-body",children:t||e.jsx(ct,{})})]})]})}),e.jsxs("div",{className:"auth-center-ribbon",children:[e.jsx("span",{children:"📅 Nov 01, 2026"}),e.jsx("span",{children:"📍 Lahore, Pakistan"}),e.jsx("span",{children:"⭐ 10,000+ Fans"})]})]})]})}function La({children:t,className:s="",onClick:a,mouseX:r,spring:i,distance:l,magnification:d,baseItemSize:o,label:p}){const h=m.useRef(null),x=aa(0),j=Tt(r,I=>{if(I===1/0||!h.current)return l;const $=h.current.getBoundingClientRect(),O=$.left+$.width/2;return I-O}),N=Tt(j,[-l,0,l],[o,d,o]),C=ma(N,i),te=I=>{(I.key==="Enter"||I.key===" ")&&(I.preventDefault(),a?.())},w=()=>{x.set(1)},D=()=>{x.set(0)};return e.jsx(H.div,{ref:h,style:{width:C,height:C},onHoverStart:w,onHoverEnd:D,onFocus:w,onBlur:D,onClick:a,className:`dock-item ${s}`,tabIndex:0,role:"button","aria-haspopup":"true","aria-label":p,onKeyDown:te,children:m.Children.map(t,I=>m.cloneElement(I,{isHovered:x}))})}function Ma({children:t,className:s="",...a}){const{isHovered:r}=a,[i,l]=m.useState(!1);return m.useEffect(()=>{if(!r)return;const d=r.on("change",o=>{l(o===1)});return()=>d()},[r]),e.jsx(ua,{children:i&&e.jsx(H.div,{initial:{opacity:0,y:-4,scale:.85},animate:{opacity:1,y:0,scale:1},exit:{opacity:0,y:-4,scale:.85},transition:{duration:.15},className:`dock-label ${s}`,role:"tooltip",style:{x:"-50%"},children:t})})}function Fa({children:t,className:s=""}){return e.jsx("div",{className:`dock-icon ${s}`,children:t})}function Ca({items:t,className:s="",spring:a={mass:.1,stiffness:220,damping:18},magnification:r=52,distance:i=120,panelHeight:l=44,baseItemSize:d=36}){const o=aa(1/0),p=$e(),h=dt();return e.jsx("div",{className:"dock-outer",children:e.jsx(H.div,{onMouseMove:x=>o.set(x.clientX),onMouseLeave:()=>o.set(1/0),className:`dock-panel ${s}`,style:{height:l},role:"toolbar","aria-label":"Application dock",children:t.map((x,j)=>{const N=p.pathname===x.to||x.to!=="/"&&p.pathname.startsWith(x.to)||x.to==="/"&&p.pathname==="/dashboard";return e.jsxs(La,{onClick:()=>{x.onClick?.(),x.to&&h(x.to)},className:`${x.className||""} ${N?"active":""}`,mouseX:o,spring:a,distance:i,magnification:r,baseItemSize:d,label:x.label,children:[e.jsx(Fa,{children:x.icon}),e.jsx(Ma,{children:x.label})]},x.to||j)})})})}function ge({path:t,size:s=24,viewBox:a="0 0 24 24",fill:r="none",stroke:i="currentColor",strokeWidth:l=1.8}){return e.jsx("svg",{width:s,height:s,viewBox:a,fill:r,stroke:i,strokeWidth:l,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:t})}const ht={home:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 10.5 12 3l9 7.5"}),e.jsx("path",{d:"M5 9.5V21h14V9.5"}),e.jsx("path",{d:"M9 21v-6h6v6"})]})}),calendar:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"3",y:"4",width:"18",height:"18",rx:"2"}),e.jsx("path",{d:"M16 2v4M8 2v4M3 10h18"})]})}),mic:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"9",y:"2",width:"6",height:"12",rx:"3"}),e.jsx("path",{d:"M5 10a7 7 0 0 0 14 0"}),e.jsx("path",{d:"M12 17v5"})]})}),clock:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("circle",{cx:"12",cy:"12",r:"9"}),e.jsx("path",{d:"M12 7v5l3 3"})]})}),history:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 12a9 9 0 1 0 3-6.7"}),e.jsx("path",{d:"M3 4v5h5"}),e.jsx("path",{d:"M12 8v4l3 2"})]})}),hotels:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M2 21V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v16"}),e.jsx("path",{d:"M2 21h20"}),e.jsx("path",{d:"M6 7h4M6 11h4M14 7h4M14 11h4M6 15h4M14 15h4M6 19h4M14 19h4"})]})}),restaurants:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M4 21v-8a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v8"}),e.jsx("path",{d:"M2 21h20"}),e.jsx("path",{d:"M8 9V3M12 9V3M16 9V3"}),e.jsx("path",{d:"M4 13h16"})]})}),discounts:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M20.6 13.4 12 22 2 12 3.5 4.5 11 3l9.6 10.4Z"}),e.jsx("circle",{cx:"8",cy:"8",r:"1.5"}),e.jsx("path",{d:"m15.5 5.5 4 4"})]})}),facilities:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 21V7l6-4 6 4v14"}),e.jsx("path",{d:"M15 21V9h6v12"}),e.jsx("path",{d:"M3 21h18"}),e.jsx("path",{d:"M7 10h3M7 14h3M7 18h3"})]})}),sponsorship:e.jsx(ge,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M12 21s-7.5-4.6-10-9.2C.6 8.6 3 5 6.5 5c2 0 3.5 1 5.5 3 2-2 3.5-3 5.5-3C21 5 23.4 8.6 22 11.8 19.5 16.4 12 21 12 21Z"})})}),sparkle:e.jsx(ge,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"m12 3-1.9 5.8a2 2 0 0 1-1.3 1.3L3 12l5.8 1.9a2 2 0 0 1 1.3 1.3L12 21l1.9-5.8a2 2 0 0 1 1.3-1.3L21 12l-5.8-1.9a2 2 0 0 1-1.3-1.3Z"})})}),ticket:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 9V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v3a3 3 0 0 0 0 6v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3a3 3 0 0 0 0-6Z"}),e.jsx("path",{d:"M13 5v2M13 11v2M13 17v2"})]})}),contact:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m3 7 9 6 9-6"})]})}),shield:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M12 22s8-3.6 8-10V5l-8-3-8 3v7c0 6.4 8 10 8 10Z"}),e.jsx("path",{d:"m9 11.5 2 2 4-4"})]})}),user:e.jsx(ge,{path:e.jsxs(e.Fragment,{children:[e.jsx("circle",{cx:"12",cy:"8",r:"4"}),e.jsx("path",{d:"M4 21c0-4 4-6 8-6s8 2 8 6"})]})}),menu:e.jsx(ge,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M3 6h18M3 12h18M3 18h18"})})}),close:e.jsx(ge,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M5 5l14 14M19 5 5 19"})})})},_a=[{label:"Home",to:"/#home",icon:"home"},{label:"Ticket Portal",to:"/tickets",icon:"ticket",cta:!0},{label:"Schedule",to:"/schedule",icon:"calendar"},{label:"Lineup",to:"/#celebrities",icon:"mic"},{label:"VIP Passes",to:"/#vip-experience",icon:"ticket"},{label:"Hotels",to:"/hotels",icon:"hotels"},{label:"Facilities",to:"/#facilities",icon:"facilities"},{label:"Sponsorship",to:"/#sponsorship",icon:"sponsorship"},{label:"Atmosphere",to:"/#about",icon:"sparkle"},{label:"My Tickets",to:"/tickets/my-tickets",icon:"ticket"}];function Mt(t){return t?.firstName||t?.name||t?.email||"Account"}function ia(){const{user:t,isAdmin:s,logout:a}=at(),r=dt(),i=$e(),[l,d]=m.useState(!1),[o,p]=m.useState(!1),[h,x]=m.useState(!1),j=m.useRef(null),N=lt.useMemo(()=>{const w=[..._a];return s&&w.push({label:"Admin",to:"/admin/dashboard",icon:"shield"}),w},[s]),C=lt.useMemo(()=>N.map(w=>({label:w.label,to:w.to,icon:ht[w.icon],className:w.cta?"dock-item-cta":""})),[N]);m.useEffect(()=>{const w=()=>{j.current||(j.current=window.requestAnimationFrame(()=>{d(window.scrollY>12),j.current=null}))};return w(),window.addEventListener("scroll",w,{passive:!0}),()=>{window.removeEventListener("scroll",w),j.current&&window.cancelAnimationFrame(j.current)}},[]),m.useEffect(()=>{p(!1),x(!1)},[i.pathname]);const te=()=>{a(),r("/")};return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:`dock-site-header ${l?"scrolled":""}`,children:e.jsxs("div",{className:"dock-site-header-inner",children:[e.jsxs(q,{to:"/",className:"dock-site-brand","aria-label":"Ozilla Fest home",children:[e.jsx("span",{className:"dock-site-brand-logo",children:e.jsx("img",{src:G("/assets/ozilla/logo.png"),alt:"Ozilla Fest",onError:w=>{w.currentTarget.src=G("/assets/company-logo.jpeg")}})}),e.jsx("div",{className:"dock-site-brand-text",children:e.jsx("strong",{children:"OZILLA FEST"})})]}),e.jsx("div",{className:"dock-header-center",children:e.jsx(Ca,{items:C,className:"dock-nav",magnification:58,distance:140,panelHeight:62,baseItemSize:44,spring:{mass:.1,stiffness:260,damping:19}})}),e.jsxs("div",{className:"dock-site-header-actions",children:[t?e.jsxs("div",{className:`dock-account ${h?"open":""}`,children:[e.jsxs("button",{type:"button",className:"dock-account-button",onClick:()=>x(w=>!w),"aria-expanded":h,"aria-label":"Account menu",children:[e.jsx("span",{className:"dock-account-avatar",children:String(Mt(t)).slice(0,1).toUpperCase()}),e.jsx("strong",{children:Mt(t)})]}),e.jsxs("div",{className:"dock-account-menu",children:[e.jsx(q,{to:"/account",children:"Account"}),e.jsx(q,{to:"/tickets/my-tickets",children:"My Tickets"}),s&&e.jsx(q,{to:"/admin/dashboard",children:"Admin Dashboard"}),e.jsx("button",{type:"button",onClick:te,children:"Logout"})]})]}):e.jsxs(e.Fragment,{children:[e.jsx(q,{to:"/login",className:"dock-site-login-btn",children:"Login"}),e.jsx(q,{to:"/register",className:"dock-site-register-btn",children:"Sign Up"})]}),e.jsx("button",{type:"button",className:`dock-mobile-toggle ${o?"open":""}`,"aria-label":o?"Close menu":"Open menu","aria-expanded":o,onClick:()=>p(w=>!w),children:o?ht.close:ht.menu})]})]})}),e.jsx("div",{className:`dock-mobile-overlay ${o?"open":""}`,onClick:()=>p(!1),children:e.jsxs("div",{className:`dock-mobile-panel ${o?"open":""}`,onClick:w=>w.stopPropagation(),children:[e.jsxs("div",{className:"dock-mobile-header",children:[e.jsx("div",{children:e.jsx("h2",{children:"Menu"})}),e.jsx("button",{type:"button",className:"dock-mobile-close",onClick:()=>p(!1),"aria-label":"Close menu",children:"x"})]}),e.jsx("div",{className:"dock-mobile-links",children:N.map(w=>e.jsxs(ha,{to:w.to,className:w.cta?"dock-mobile-link-cta":"",onClick:()=>p(!1),children:[e.jsx("span",{className:"dock-mobile-link-icon",children:ht[w.icon]}),e.jsx("span",{children:w.label}),w.cta&&e.jsx("span",{className:"dock-mobile-badge",children:"PASSES"})]},w.to))}),e.jsx("div",{className:"dock-mobile-auth",children:t?e.jsx("button",{type:"button",onClick:()=>{te(),p(!1)},children:"Logout"}):e.jsxs(e.Fragment,{children:[e.jsx(q,{to:"/login",onClick:()=>p(!1),children:"Login"}),e.jsx(q,{to:"/register",onClick:()=>p(!1),children:"Sign Up"})]})})]})})]})}const za=[{label:"Headline Artists",href:"/#celebrities"},{label:"VIP & Ticket Passes",href:"/tickets"},{label:"The Festival Vibe",href:"/#about"},{label:"World-Class Facilities",href:"/#facilities"},{label:"My Digital Passes",href:"/tickets/my-tickets"}],Oa=[{label:"Instagram",href:"https://www.instagram.com/ozillafestival"}],Da=[{label:"Sponsorship Inquiries",href:"/#sponsorship"},{label:"QR Ticket Verification",href:"/verification/OZ-2026-PREVIEW"},{label:"Hotel & Travel Partners",href:"/hotels"},{label:"Privacy & Terms",href:"/privacy"}];function na(){return e.jsxs(e.Fragment,{children:[e.jsxs("footer",{className:"kex-footer",children:[e.jsx("div",{className:"kex-bg-glow","aria-hidden":"true"}),e.jsx("div",{className:"kex-bg-overlay","aria-hidden":"true"}),e.jsxs("div",{className:"kex-container",children:[e.jsxs("div",{className:"kex-nav-grid",children:[e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"MENU"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:za.map(t=>e.jsx("li",{children:t.href.startsWith("/#")?e.jsx("a",{href:t.href,children:t.label}):e.jsx(q,{to:t.href,children:t.label})},t.label))})]}),e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"SOCIALS"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:Oa.map(t=>e.jsx("li",{children:e.jsx("a",{href:t.href,target:"_blank",rel:"noopener noreferrer",children:t.label})},t.label))})]}),e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"RESOURCES"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:Da.map(t=>e.jsx("li",{children:t.href.startsWith("/#")?e.jsx("a",{href:t.href,children:t.label}):e.jsx(q,{to:t.href,children:t.label})},t.label))}),e.jsx("div",{className:"kex-action-wrap",children:e.jsx("a",{href:"mailto:ozillafestival@gmail.com",className:"kex-pill-btn",children:"Send a message"})})]})]}),e.jsx("div",{className:"kex-hero-word-wrap","aria-hidden":"true",children:e.jsx("span",{className:"kex-hero-word",children:"OZILLA FEST"})}),e.jsxs("div",{className:"kex-bottom-row",children:[e.jsxs("div",{className:"kex-bottom-links",children:[e.jsx(q,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"·"}),e.jsx(q,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"·"}),e.jsx(q,{to:"/verification/OZ-2026-PREVIEW",children:"QR Verification"})]}),e.jsx("p",{className:"kex-bottom-copy",children:"© 2026 OZILLA FEST & Prism Entertainment. All rights reserved."})]})]})]}),e.jsx("style",{children:Ba})]})}const Ba=`
...
`;function Le({children:t}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-transparent text-white overflow-x-hidden w-full relative z-[1]",children:[e.jsx(ia,{}),e.jsx("div",{className:"flex-1 w-full overflow-x-hidden bg-transparent",children:t||e.jsx(ct,{})}),e.jsx(na,{})]})}function kt({children:t}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-transparent text-white overflow-x-hidden w-full font-['Plus_Jakarta_Sans',sans-serif] dock-app-shell relative z-[1]",children:[e.jsx(ia,{}),e.jsx("main",{className:"flex-1 px-4 sm:px-6 py-6 md:py-10 app-main app-content dock-app-content bg-transparent",children:e.jsx("div",{className:"w-full max-w-[1280px] mx-auto",children:t||e.jsx(ct,{})})}),e.jsx(na,{})]})}function Ha(){return e.jsx("div",{className:"flex items-center justify-center min-h-[200px]",children:e.jsx("div",{className:"animate-spin rounded-full h-16 w-16 border-4 border-purple-600 border-t-transparent"})})}function Ua(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m4 7 8 6 8-6"})]})}function Va(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"4",y:"10",width:"16",height:"11",rx:"2"}),e.jsx("path",{d:"M8 10V7a4 4 0 0 1 8 0v3"})]})}function Ga({hidden:t=!1,...s}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...s,children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"}),t&&e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}function $a(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M5 12h14M13 6l6 6-6 6"})})}function Wa(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"m5 12 4 4L19 6"})})}function Ya(t){return e.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",...t,children:[e.jsx("path",{fill:"#4285F4",d:"M21.6 12.23c0-.71-.06-1.4-.18-2.06H12v3.9h5.38a4.6 4.6 0 0 1-2 3.01v2.53h3.23c1.9-1.75 2.99-4.32 2.99-7.38Z"}),e.jsx("path",{fill:"#34A853",d:"M12 22c2.7 0 4.97-.9 6.62-2.39l-3.23-2.53c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.61-4.13H3.05v2.61A10 10 0 0 0 12 22Z"}),e.jsx("path",{fill:"#FBBC05",d:"M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.3.31-1.91V7.48H3.05A10 10 0 0 0 2 12c0 1.61.39 3.14 1.05 4.52l3.34-2.61Z"}),e.jsx("path",{fill:"#EA4335",d:"M12 5.96c1.47 0 2.79.51 3.82 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.95 5.48l3.34 2.61C7.18 7.72 9.39 5.96 12 5.96Z"})]})}function qa(){const t=dt(),s=$e(),{login:a,checkAuth:r}=at(),i="",l=new URLSearchParams(s.search).get("returnTo"),d=xt(l,"/dashboard"),[o,p]=m.useState({email:"",password:""}),[h,x]=m.useState(null),[j,N]=m.useState(!1),[C,te]=m.useState(!0),[w,D]=m.useState(""),[I,$]=m.useState(""),[O,R]=m.useState(!1),[n,W]=m.useState(!1),A=f=>{$(""),p(E=>({...E,[f.target.name]:f.target.value}))},y=async f=>{if(f.preventDefault(),!(O||n)){D(""),$(""),R(!0);try{await a({email:String(o.email||"").trim().toLowerCase(),password:String(o.password||"")}),$("Login successful. Preparing your festival workspace..."),await new Promise(E=>setTimeout(E,450)),t(d)}catch(E){D(E.response?.data?.message||E.message||"Invalid email or password")}finally{R(!1)}}},c=async()=>{D(""),$(""),W(!0);try{if(!(i&&!i.includes("placeholder")&&!i.includes("your_google"))){const f=await Ge.googleAuth("local-dev-token",{email:"ubair1100@gmail.com",name:"Ubair Naeem",given_name:"Ubair",family_name:"Naeem"});je.setToken(f.token),await r(),$("Google sign-in verified. Welcome back!"),await new Promise(E=>setTimeout(E,450)),t(d)}}catch(f){const E=f.response?.data?.message||f.message||"Google sign-in failed";E.toLowerCase().includes("cancel")||D(E)}finally{W(!1)}};return e.jsxs("form",{onSubmit:y,className:"kx-form",children:[w&&e.jsx("div",{className:"kx-alert kx-alert-error",role:"alert",children:w}),I&&e.jsx("div",{className:"kx-alert kx-alert-success",role:"alert",children:I}),e.jsxs("button",{type:"button",className:"kx-google",onClick:c,disabled:n||O,children:[e.jsx(Ya,{}),e.jsx("span",{children:n?"Connecting to Google...":"Continue with Google"}),e.jsx("i",{"aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-divider",children:[e.jsx("span",{}),e.jsx("em",{children:"or sign in with email"}),e.jsx("span",{})]}),e.jsxs("label",{className:`kx-field ${h==="email"?"kx-focused":""}`,children:[e.jsx(Ua,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"email",value:o.email,placeholder:"Email or Mobile Number",autoComplete:"username",required:!0,onChange:A,onFocus:()=>x("email"),onBlur:()=>x(null)}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("label",{className:`kx-field ${h==="password"?"kx-focused":""}`,children:[e.jsx(Va,{className:"kx-field-icon"}),e.jsx("input",{type:j?"text":"password",name:"password",value:o.password,placeholder:"Password",autoComplete:"current-password",required:!0,onChange:A,onFocus:()=>x("password"),onBlur:()=>x(null)}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>N(f=>!f),"aria-label":j?"Hide password":"Show password",children:e.jsx(Ga,{hidden:j})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-meta",children:[e.jsxs("label",{className:"kx-remember",children:[e.jsx("input",{type:"checkbox",checked:C,onChange:f=>te(f.target.checked)}),e.jsx("span",{className:"kx-checkbox",children:C&&e.jsx(Wa,{})}),e.jsx("span",{children:"Remember me"})]}),e.jsx("a",{href:"#forgot-password",className:"kx-forgot-link",children:"Forgot password?"})]}),e.jsxs("button",{className:"kx-sign-in",type:"submit",disabled:O||n,children:[e.jsx("span",{className:"kx-button-glow","aria-hidden":"true"}),e.jsx("span",{className:"kx-button-sheen","aria-hidden":"true"}),O?e.jsx("span",{className:"kx-spinner","aria-label":"Signing in..."}):e.jsxs("span",{className:"kx-button-copy",children:["Sign in",e.jsx($a,{})]})]}),e.jsxs("p",{className:"kx-signup",children:["Don't have an account?"," ",e.jsx(q,{to:`/register?${new URLSearchParams({returnTo:d}).toString()}`,children:"Create account"})]}),e.jsxs("div",{className:"kx-trust-grid","aria-label":"Security indicators",children:[e.jsx("span",{children:"🔒 Secure Login"}),e.jsx("span",{children:"⚡ Fast Access"}),e.jsx("span",{children:"🛡️ Protected"}),e.jsx("span",{children:"✓ Verified"})]})]})}function Xa(){return e.jsxs("div",{className:"auth-form-container",children:[e.jsx(qa,{}),e.jsxs("div",{className:"auth-footer-links",children:[e.jsx(q,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"•"}),e.jsx(q,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"•"}),e.jsx(q,{to:"/#contact",children:"Need Help?"})]})]})}function Ft(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("path",{d:"M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"}),e.jsx("circle",{cx:"12",cy:"7",r:"4"})]})}function Ka(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m4 7 8 6 8-6"})]})}function Za(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"})})}function Ct(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"4",y:"10",width:"16",height:"11",rx:"2"}),e.jsx("path",{d:"M8 10V7a4 4 0 0 1 8 0v3"})]})}function _t({hidden:t=!1,...s}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...s,children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"}),t&&e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}function Ja(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M5 12h14M13 6l6 6-6 6"})})}function Qa(t){return e.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",...t,children:[e.jsx("path",{fill:"#4285F4",d:"M21.6 12.23c0-.71-.06-1.4-.18-2.06H12v3.9h5.38a4.6 4.6 0 0 1-2 3.01v2.53h3.23c1.9-1.75 2.99-4.32 2.99-7.38Z"}),e.jsx("path",{fill:"#34A853",d:"M12 22c2.7 0 4.97-.9 6.62-2.39l-3.23-2.53c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.61-4.13H3.05v2.61A10 10 0 0 0 12 22Z"}),e.jsx("path",{fill:"#FBBC05",d:"M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.3.31-1.91V7.48H3.05A10 10 0 0 0 2 12c0 1.61.39 3.14 1.05 4.52l3.34-2.61Z"}),e.jsx("path",{fill:"#EA4335",d:"M12 5.96c1.47 0 2.79.51 3.82 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.95 5.48l3.34 2.61C7.18 7.72 9.39 5.96 12 5.96Z"})]})}const zt=()=>new Promise(t=>setTimeout(t,450));function es(){const t=dt(),s=$e(),{register:a,checkAuth:r}=at(),i="",l=new URLSearchParams(s.search).get("returnTo"),d=xt(l,"/dashboard"),[o,p]=m.useState({firstName:"",lastName:"",email:"",phone:"",password:"",confirmPassword:""}),[h,x]=m.useState(null),[j,N]=m.useState(""),[C,te]=m.useState(!1),[w,D]=m.useState(!1),[I,$]=m.useState(!1),[O,R]=m.useState(!1),[n,W]=m.useState(0),[A,y]=m.useState(""),[c,f]=m.useState(""),[E,M]=m.useState(!1),[X,_]=m.useState(!1),[se,K]=m.useState(!1),[ae,oe]=m.useState(!1),[U,F]=m.useState({email:!1,phone:!1,password:!1,confirmPassword:!1}),z=/^\S+@\S+\.\S+$/.test(o.email),ce=/^(\+?\d{1,3})?[\s-]?\d{10,12}$/.test(o.phone.replace(/\s+/g,"")),u={upper:/[A-Z]/.test(o.password),lower:/[a-z]/.test(o.password),number:/\d/.test(o.password),special:/[^A-Za-z0-9]/.test(o.password),length:o.password.length>=8},k=Object.values(u).filter(Boolean).length,S=k===5,v=o.confirmPassword.length>0&&o.password===o.confirmPassword,P=o.password.length>0,Z=m.useMemo(()=>P?k<=2?{label:"Weak",className:"weak",percent:28}:k===3?{label:"Medium",className:"medium",percent:52}:k===4?{label:"Strong",className:"strong",percent:78}:{label:"Excellent",className:"excellent",percent:100}:{label:"Start typing",className:"empty",percent:8},[P,k]),V=[{key:"upper",text:"Uppercase letter",met:u.upper},{key:"lower",text:"Lowercase letter",met:u.lower},{key:"number",text:"Number",met:u.number},{key:"special",text:"Special character",met:u.special},{key:"length",text:"8+ characters",met:u.length}],le=o.firstName.trim()&&o.lastName.trim()&&z&&ce&&S&&v&&w&&!E&&!X;m.useEffect(()=>{if(n<=0)return;const g=window.setInterval(()=>{W(b=>Math.max(0,b-1))},1e3);return()=>window.clearInterval(g)},[n]);const J=()=>{y(""),f("")},re=g=>{const{name:b,value:ie}=g.target;J(),p(Y=>({...Y,[b]:ie})),b==="email"&&(N(""),te(!1),D(!1),W(0)),b in U&&ie.length>0&&F(Y=>({...Y,[b]:!0}))},de=g=>{const{name:b}=g.target;x(null),b in U&&F(ie=>({...ie,[b]:!0}))},fe=async()=>{if(J(),!z){F(g=>({...g,email:!0})),y("Please enter a valid email address before sending OTP.");return}$(!0);try{const g=await Ge.sendOtp(o.email);g?.emailDelivery==="failed"||typeof g?.message=="string"&&g.message.toLowerCase().includes("delivery failed")?(te(!1),y(g.emailError||"Email delivery failed: SMTP credentials (SMTP_USER and SMTP_PASS) are not configured on the backend server.")):(te(!0),D(!1),W(60),N(""),f(g.message||"OTP code has been sent to your email. Please check your inbox."))}catch(g){y(g.response?.data?.message||g.message||"Unable to send OTP.")}finally{$(!1)}},pe=async()=>{if(J(),!z||j.trim().length<4){y("Enter the OTP sent to your email.");return}R(!0);try{const g=await Ge.verifyOtp({email:o.email,otp:j});D(!0),f(g.message||"Email verified successfully.")}catch(g){D(!1),y(g.response?.data?.message||g.message||"OTP verification failed.")}finally{R(!1)}},Q=async g=>{if(g.preventDefault(),J(),!z){F(b=>({...b,email:!0})),y("Please enter a valid email address.");return}if(!w){y("Please verify your email OTP before creating your account.");return}if(!ce){F(b=>({...b,phone:!0})),y("Please enter a valid mobile number.");return}if(!S){F(b=>({...b,password:!0})),y("Please satisfy all password requirements.");return}if(!v){F(b=>({...b,confirmPassword:!0})),y("Passwords do not match.");return}M(!0);try{await a({firstName:o.firstName,lastName:o.lastName,name:`${o.firstName} ${o.lastName}`.trim(),email:o.email,phone:o.phone,password:o.password}),f("Account created successfully. Preparing your festival workspace..."),await zt(),t(d)}catch(b){const ie=b.response?.status,Y=b.response?.data?.message||"Registration failed",ee=Y.toLowerCase();ie===409||ee.includes("already")||ee.includes("exists")?y("Account already exists with this email or phone number"):y(Y)}finally{M(!1)}},T=async()=>{J(),_(!0);try{if(!(i&&!i.includes("placeholder")&&!i.includes("your_google"))){const g=await Ge.googleAuth("local-dev-token",{email:"ubair1100@gmail.com",name:"Ubair Naeem",given_name:"Ubair",family_name:"Naeem"});je.setToken(g.token),await r(),f("Google sign-up verified. Welcome to OZILLA FEST!"),await zt(),t(d)}}catch(g){const b=g.response?.data?.message||g.message||"Google sign-up failed";b.toLowerCase().includes("cancel")||y(b)}finally{_(!1)}};return e.jsxs("form",{onSubmit:Q,className:"kx-form",children:[A&&e.jsx("div",{className:"kx-alert kx-alert-error",role:"alert",children:A}),c&&e.jsx("div",{className:"kx-alert kx-alert-success",role:"alert",children:c}),e.jsxs("button",{type:"button",className:"kx-google",onClick:T,disabled:X||E,children:[e.jsx(Qa,{}),e.jsx("span",{children:X?"Connecting to Google...":"Sign up with Google"}),e.jsx("i",{"aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-divider",children:[e.jsx("span",{}),e.jsx("em",{children:"or register with email"}),e.jsx("span",{})]}),e.jsxs("div",{className:"kx-grid-row",children:[e.jsxs("label",{className:`kx-field ${h==="firstName"?"kx-focused":""}`,children:[e.jsx(Ft,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"firstName",value:o.firstName,placeholder:"First Name",autoComplete:"given-name",required:!0,onChange:re,onFocus:()=>x("firstName"),onBlur:de}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("label",{className:`kx-field ${h==="lastName"?"kx-focused":""}`,children:[e.jsx(Ft,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"lastName",value:o.lastName,placeholder:"Last Name",autoComplete:"family-name",required:!0,onChange:re,onFocus:()=>x("lastName"),onBlur:de}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]})]}),e.jsxs("label",{className:`kx-field ${h==="email"?"kx-focused":""} ${U.email&&!z?"kx-field-invalid":""}`,children:[e.jsx(Ka,{className:"kx-field-icon"}),e.jsx("input",{type:"email",name:"email",value:o.email,placeholder:"Email address",autoComplete:"email",required:!0,onChange:re,onFocus:()=>x("email"),onBlur:de}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),U.email&&!z&&e.jsx("p",{className:"kx-field-error-msg",children:"Please enter a valid email address."}),e.jsxs("div",{className:`kx-otp-box ${w?"kx-otp-verified":""}`,children:[e.jsxs("div",{className:"kx-otp-meta",children:[e.jsx("span",{className:"kx-otp-kicker",children:"Email Verification"}),e.jsx("strong",{children:w?"✓ Email verified":C?"Enter 6-digit code":"Verify email before submit"}),e.jsx("span",{className:"kx-otp-subtext",children:w?"Security verified":n>0?`Resend available in ${n}s`:"Code will be sent to your email"})]}),e.jsxs("div",{className:"kx-otp-controls",children:[e.jsx("button",{type:"button",className:"kx-otp-btn",onClick:fe,disabled:I||!z||w||n>0,children:I?"Sending...":C?"Resend OTP":"Send OTP"}),e.jsx("input",{type:"text",value:j,onChange:g=>{J(),N(g.target.value.replace(/\D/g,"").slice(0,6)),D(!1)},className:"kx-otp-input",placeholder:"Enter 6-digit OTP",inputMode:"numeric",autoComplete:"one-time-code",disabled:!C||w}),e.jsx("button",{type:"button",className:"kx-otp-btn kx-otp-btn-accent",onClick:pe,disabled:!C||w||O,children:O?"Verifying...":w?"Verified":"Verify"})]})]}),e.jsxs("label",{className:`kx-field ${h==="phone"?"kx-focused":""} ${U.phone&&!ce?"kx-field-invalid":""}`,children:[e.jsx(Za,{className:"kx-field-icon"}),e.jsx("input",{type:"tel",name:"phone",value:o.phone,placeholder:"Phone (+92 3XX XXXXXXX)",autoComplete:"tel",required:!0,onChange:re,onFocus:()=>x("phone"),onBlur:de}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),U.phone&&!ce&&e.jsx("p",{className:"kx-field-error-msg",children:"Please enter a valid mobile number."}),e.jsxs("label",{className:`kx-field ${h==="password"?"kx-focused":""} ${U.password&&!S?"kx-field-invalid":""}`,children:[e.jsx(Ct,{className:"kx-field-icon"}),e.jsx("input",{type:se?"text":"password",name:"password",value:o.password,placeholder:"Create Password",autoComplete:"new-password",required:!0,onChange:re,onFocus:()=>x("password"),onBlur:de}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>K(g=>!g),"aria-label":se?"Hide password":"Show password",children:e.jsx(_t,{hidden:se})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("div",{className:`kx-strength kx-strength-${Z.className}`,children:[e.jsxs("div",{className:"kx-strength-header",children:[e.jsx("span",{children:"Password Strength"}),e.jsx("strong",{children:Z.label})]}),e.jsx("div",{className:"kx-strength-bar-track",children:e.jsx("span",{style:{width:`${Z.percent}%`}})})]}),e.jsx("ul",{className:"kx-pwd-rules",children:V.map(g=>{const b=g.met?"kx-rule-met":P?"kx-rule-unmet":"kx-rule-neutral";return e.jsxs("li",{className:`kx-pwd-rule ${b}`,children:[e.jsx("span",{className:"kx-rule-badge",children:g.met?"✓":"•"}),e.jsx("span",{children:g.text})]},g.key)})}),e.jsxs("label",{className:`kx-field ${h==="confirmPassword"?"kx-focused":""} ${U.confirmPassword&&!v?"kx-field-invalid":""}`,children:[e.jsx(Ct,{className:"kx-field-icon"}),e.jsx("input",{type:ae?"text":"password",name:"confirmPassword",value:o.confirmPassword,placeholder:"Confirm Password",autoComplete:"new-password",required:!0,onChange:re,onFocus:()=>x("confirmPassword"),onBlur:de}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>oe(g=>!g),"aria-label":ae?"Hide confirm password":"Show confirm password",children:e.jsx(_t,{hidden:ae})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),U.confirmPassword&&!v&&e.jsx("p",{className:"kx-field-error-msg",children:"Passwords do not match."}),e.jsxs("button",{className:"kx-sign-in",type:"submit",disabled:!le,children:[e.jsx("span",{className:"kx-button-glow","aria-hidden":"true"}),e.jsx("span",{className:"kx-button-sheen","aria-hidden":"true"}),E?e.jsx("span",{className:"kx-spinner","aria-label":"Creating account..."}):e.jsxs("span",{className:"kx-button-copy",children:["Create Account",e.jsx(Ja,{})]})]}),e.jsxs("p",{className:"kx-signup",children:["Already have an account?"," ",e.jsx(q,{to:`/login?${new URLSearchParams({returnTo:d}).toString()}`,children:"Sign In"})]}),e.jsxs("div",{className:"kx-trust-grid","aria-label":"Security indicators",children:[e.jsx("span",{children:"🔒 Secure Sign Up"}),e.jsx("span",{children:"⚡ Instant Access"}),e.jsx("span",{children:"🛡️ Protected"}),e.jsx("span",{children:"✓ Google Verified"})]})]})}function ts(){return e.jsxs("div",{className:"auth-form-container",children:[e.jsx(es,{}),e.jsxs("div",{className:"auth-footer-links",children:[e.jsx(q,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"•"}),e.jsx(q,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"•"}),e.jsx(q,{to:"/#contact",children:"Need Help?"})]})]})}function as(){const[t]=ga(),s=dt(),{checkAuth:a}=at(),[r,i]=m.useState("Signing you in with Google...");return m.useEffect(()=>{(async()=>{const d=t.get("token"),o=t.get("error"),p=t.get("returnTo"),h=xt(p,"/dashboard");if(o){i(o==="google_not_configured"?"Google sign-in is not configured on server yet. Please add GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in server/.env.":"Google sign-in failed. Please try again.");const x=new URLSearchParams({returnTo:h}).toString();setTimeout(()=>s(`/login?${x}`,{replace:!0}),1200);return}if(!d){i("Google sign-in token not found. Please try again.");const x=new URLSearchParams({returnTo:h}).toString();setTimeout(()=>s(`/login?${x}`,{replace:!0}),1200);return}je.setToken(d),await a(),s(h,{replace:!0})})()},[a,s,t]),e.jsx("div",{className:"auth-page",children:e.jsxs("div",{className:"auth-card",children:[e.jsx("h1",{className:"auth-title",children:"Google Sign-In"}),e.jsx("p",{className:"auth-subtitle",children:r})]})})}const Nr={hotels:[{name:"Pearl Continental Hotel (PC)",location:"Lahore, Punjab, Pakistan",rates:"Premium city-center business and leisure rates",offer:"Flexible booking options with conference and dining access.",website:"https://www.expedia.com/Lahore-Hotels-Pearl-Continental-Lahore.h6062.Hotel-Information?chkin=2026-07-23&chkout=2026-07-24&x_pwa=1&rfrr=HSR&pwa_ts=1783538185568&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=2068&destination=Lahore%2C+Punjab%2C+Pakistan&destType=MARKET&neighborhoodId=553248633981712959&selected=6062&latLong=31.554606%2C74.357155&sort=RECOMMENDED&top_dp=124&top_cur=USD&semcid=US.UB.BING.PT-c-EN.HOTEL&semdtl=a1429012176.b11315017303776210.g1kwd-82189323842618%3Aloc-144.e1c.m18d15bbf2af6c1d752fa9d1bc0e925b82.r1dbbc4399e805d7a471af9bb50c0eca6a53815556874c850795d8066b3e568804.c1.j1142691.k1152882.d182188878595064.h1e.i1.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&userIntent=&selectedRoomType=314006270&selectedRatePlan=380046345&categorySearch=any_option&searchId=60a6b42e-b43b-44af-a668-54a0fbd95022",image:G("/assets/hotels/Pearl-Continental-Lahore.jpg"),showImage:!0,description:"A flagship five-star property known for premium hospitality, executive facilities, and large event spaces.",facilities:["Luxury Rooms & Suites","Restaurants & Coffee Lounge","Swimming Pool","Fitness Center"],contact:"Reservations: +92 42 111 505 505",rating:"4.5/5"},{name:"Ramada by Wyndham Lahore",location:"Lahore, Punjab, Pakistan",rates:"Business-friendly international chain pricing",offer:"Comfort-focused stay packages with central access.",website:"https://www.guestreservations.com/ramada-by-wyndham-lahore-gulberg-ii/booking?utm_source=microsoft&utm_medium=cpc&utm_campaign=318380766&msclkid=2639f60cc7641752938d9c426507dbb5&ctTriggered=true",image:G("/assets/hotels/Ramada-by-Wyndham-Lahore-Gulberg-II.jpg"),showImage:!0,description:"An international-branded stay option designed for business travelers and families seeking modern comfort.",facilities:["Comfort Rooms","All-Day Dining","Meeting Facilities","Wi-Fi Access"],contact:"Reservations: +92 42 111 111 211",rating:"4.3/5"},{name:"Hotel Indigo Lahore",location:"Lahore, Punjab, Pakistan",rates:"Boutique premium rates for curated city stays",offer:"Lifestyle stay experience with modern interiors and city vibe.",website:"https://indigoheights.com/",image:G("/assets/hotels/Hotel-Indigo.jpg"),showImage:!0,description:"A contemporary boutique-style hotel brand experience offering design-led rooms and premium hospitality.",facilities:["Designer Rooms","Signature Dining","Fitness Facilities","Business Services"],contact:"Reservations: +92 42 111 111 111",rating:"4.4/5"},{name:"Hotel One Gulberg Lahore",location:"Lahore, Punjab, Pakistan",rates:"Upper-midscale corporate and family packages",offer:"Value-focused business stays in a prime Lahore district.",website:"https://www.guestreservations.com/hotel-one-gulberg-lahore/booking?utm_source=microsoft&utm_medium=cpc&utm_campaign=318380766&msclkid=3d22881e8b211d72a380e25028093b5b",image:G("/assets/hotels/Hotel-One-Gulberg-Lahore.jpg"),showImage:!0,description:"A trusted local hospitality brand known for practical comfort, business convenience, and central location.",facilities:["Business-Friendly Rooms","Breakfast Service","Meeting Room","24/7 Front Desk"],contact:"Reservations: +92 42 111 111 563",rating:"4.2/5"},{name:"Luxus Grand Hotel (LC)",location:"Lahore, Punjab, Pakistan",rates:"Executive and leisure stay rates",offer:"City-center premium rooms with event-friendly access.",website:"https://www.expedia.com/Lahore-Hotels-Luxus-Grand-Hotel.h16225098.Hotel-Information?chkin=2026-07-23&chkout=2026-07-24&x_pwa=1&rfrr=HSR&pwa_ts=1783538679588&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=2068&destination=Lahore%2C+Punjab%2C+Pakistan&destType=MARKET&selected=16225098&latLong=31.554606%2C74.357155&sort=RECOMMENDED&top_dp=50&top_cur=USD&semcid=US.UB.BING.PT-c-EN.HOTEL&semdtl=a1429012176.b11317216326895908.g1kwd-82326765629610%3Aloc-144.e1c.m1f413ae58b13f11ee7d78c41612f456b3.r17441980d01bf266109c2845e02c5e619d691d9360faf76d1fb0b3ff083f73b12.c1.j1142691.k1152882.d182326298507125.h1e.i1.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&userIntent=&selectedRoomType=201690559&selectedRatePlan=208425873&categorySearch=any_option&searchId=b938991e-d9ee-47cd-a5b9-bfbbe22962a7",image:G("/assets/hotels/Luxus-Grand-Hotel.jpg"),showImage:!0,description:"A modern luxury hotel in Lahore offering upscale rooms, contemporary dining, and premium guest services.",facilities:["Premium Rooms","Restaurant & Cafe","Concierge Support","Airport Transfer Assistance"],contact:"Reservations: +92 42 111 589 879",rating:"4.4/5"},{name:"Nishat Hotel Lahore",location:"Lahore, Punjab, Pakistan",rates:"Premium luxury rates with lifestyle amenities",offer:"High-end accommodation with shopping and dining proximity.",website:"https://www.booking.com/hotel/pk/the-nishat.en-gb.html?aid=2276380&label=msn-G%2AualcbtRsY8_D6yMU0tng-80333218529225%3Atikwd-80333372562144%3Aloc-144%3Aneo%3Amte%3Alp142691%3Adec%3Acid578349423%3Aagid1285329581450391%3Aclkid91bc1c0fd2ae13842aa77641760a897b&sid=d2e80396e6c920f70a72e21ba196f068&all_sr_blocks=112449101_204759422_0_2_0_670390&checkin=2026-07-14&checkout=2026-07-15&dest_id=-2767043&dest_type=city&dist=0&group_adults=2&group_children=0&hapos=1&highlighted_blocks=112449101_204759422_0_2_0_670390&hpos=1&matching_block_id=112449101_204759422_0_2_0_670390&no_rooms=1&req_adults=2&req_children=0&room1=A%2CA&sb_price_type=total&sr_order=popularity&sr_pri_blocks=112449101_204759422_0_2_0_670390_3300000&srepoch=1783539000&srpvid=7c17890e04e000e0&type=total&ucfs=1&",image:G("/assets/hotels/Nishat.jpg"),showImage:!0,description:"A luxury Lahore hospitality brand recognized for refined interiors, premium service standards, and prime locations.",facilities:["Luxury Suites","Fine Dining","Spa & Wellness","Event and Meeting Spaces"],contact:"Reservations: +92 42 111 647 428",rating:"4.6/5"}]};G("/assets/ozilla/talwinder.jpg"),G("/assets/ozilla/talwinder.jpg"),G("/assets/ozilla/Imran-Khan.jpg"),G("/assets/ozilla/Imran-Khan.jpg"),G("/assets/ozilla/Bohemia.jpg"),G("/assets/ozilla/Bohemia.jpg"),G("/assets/ozilla/hassan-raheem.jpg"),G("/assets/ozilla/hassan-raheem.jpg");const Ot=[{name:"TALWINDER",isHeadliner:!0,genre:"Indie Pop / Punjabi Fusion",stage:"Main Prism Stage",bpm:"128 BPM",vibe:"Euphoric Night",src:G("/assets/ozilla/talwinder.jpg"),image:G("/assets/ozilla/talwinder.jpg"),offsetY:0},{name:"IMRAN KHAN",isHeadliner:!1,genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",src:G("/assets/ozilla/Imran-Khan.jpg"),image:G("/assets/ozilla/Imran-Khan.jpg"),offsetY:0},{name:"BOHEMIA",isHeadliner:!1,genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",src:G("/assets/ozilla/Bohemia.jpg"),image:G("/assets/ozilla/Bohemia.jpg"),offsetY:0},{name:"HASSAN RAHEEM",isHeadliner:!1,genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",src:G("/assets/ozilla/hassan-raheem.jpg"),image:G("/assets/ozilla/hassan-raheem.jpg"),offsetY:0}],Dt=1.28,Bt=.78;function He(t,s,a){return Math.min(a,Math.max(s,t))}function Ht(t){if(!t)return null;if(typeof t=="string")return t||null;const s=t.src||t.image;return typeof s=="string"&&s?s:null}function ss(t){return Ht(t&&typeof t=="object"&&(t.image||t.src)||t)}function rs(t){if(t&&typeof t=="object"&&"offsetY"in t){const s=t.offsetY;return typeof s=="number"&&isFinite(s)?s:0}return 0}function is({items:t=Ot,images:s,slideWidth:a=320,slideHeight:r=440,spacing:i=2.4,direction:l="right",smoothness:d=8.5,radius:o=24,dim:p=5,background:h="transparent",sensitivity:x=5,autoPlay:j=!1,autoPlayInterval:N=3500,style:C,onItemClick:te}){const w=m.useRef(null),D=m.useRef([]),I=m.useRef(0),$=m.useRef(0),[O,R]=m.useState(0),[n,W]=m.useState(!1),[A,y]=m.useState(0),c=t&&t.length>0?t:s&&s.length>0?s:Ot,f=m.useMemo(()=>c.map((u,k)=>({...u,src:ss(u),offsetY:rs(u),name:u.name||`Artist ${k+1}`,genre:u.genre||"Live Performer",stage:u.stage||"Ozilla Arena",bpm:u.bpm||"128 BPM",vibe:u.vibe||"Festival Energy",isHeadliner:!!u.isHeadliner})),[c]),E=O>0&&O<640?Math.min(a,250):O<1024?Math.min(a,290):a,M=O>0&&O<640?Math.round(E*1.36):r,X=E+He(i,0,10)*18,_=.15-He(d,0,10)/10*.11,se=He(p,0,10)/10*.75,K=.4+He(x,0,10)/10*1.1,ae=.6+He(x,0,10)/10*1.6,oe=l==="left",U=m.useRef({count:f.length,step:X,slideWidth:E,width:O,ease:_,maxScale:Dt,minScale:Bt,dim:se,loop:!1,flip:oe});U.current={count:f.length,step:X,slideWidth:E,width:O,ease:_,maxScale:Dt,minScale:Bt,dim:se,loop:!1,flip:oe};const F=m.useRef({wheelMultiplier:K,dragMultiplier:ae,flip:oe});F.current={wheelMultiplier:K,dragMultiplier:ae,flip:oe},m.useEffect(()=>{const u=w.current;if(!u)return;const k=new ResizeObserver(S=>{S[0]&&R(S[0].contentRect.width)});return k.observe(u),R(u.getBoundingClientRect().width),()=>k.disconnect()},[]),m.useEffect(()=>{D.current.length=f.length},[f.length]),m.useEffect(()=>{if(!j||n||f.length<=1)return;const u=setInterval(()=>{y(k=>{const S=(k+1)%f.length;return I.current=S*X,S})},N);return()=>clearInterval(u)},[j,n,f.length,X,N]),m.useEffect(()=>{let u=0,k=0;const S=v=>{u=requestAnimationFrame(S);const P=U.current,Z=k?Math.min((v-k)/1e3,.1):1/60;if(k=v,!P.count||P.step<=0||P.width<=0)return;const V=(P.count-1)*P.step;I.current=He(I.current,0,V);const le=1-Math.pow(1-P.ease,Z*60);$.current+=(I.current-$.current)*le;const J=Math.round($.current/P.step);J>=0&&J<P.count&&y(J);const re=(P.width-P.slideWidth)/2,de=P.width/2;for(let fe=0;fe<P.count;fe+=1){const pe=D.current[fe];if(!pe)continue;const T=fe*P.step-$.current+re,g=T+P.slideWidth/2-de;let b,ie;g>0?(b=Math.min(P.maxScale,1+g/P.width*.45),ie=(b-1)*P.slideWidth*.35):(b=Math.max(P.minScale,1+g/P.width*.5),ie=0);const Y=P.flip?P.width-P.slideWidth-(T+ie):T+ie;if(pe.style.transform=`translate3d(${Y}px, -50%, 0) scale(${b})`,P.dim>0&&b<1){const ee=(1-b)/Math.max(.001,1-P.minScale);pe.style.filter=`brightness(${Math.max(.35,1-ee*P.dim)})`}else pe.style.filter="none"}};return u=requestAnimationFrame(S),()=>cancelAnimationFrame(u)},[]),m.useEffect(()=>{const u=w.current;if(!u)return;const k=S=>{S.preventDefault();const v=Math.abs(S.deltaX)>Math.abs(S.deltaY)?S.deltaX:S.deltaY;I.current+=v*F.current.wheelMultiplier};return u.addEventListener("wheel",k,{passive:!1}),()=>u.removeEventListener("wheel",k)},[]),m.useEffect(()=>{const u=w.current;if(!u)return;let k=null,S=0;const v=V=>{if(k===null){k=V.pointerId,S=V.clientX;try{u.setPointerCapture(V.pointerId)}catch{}}},P=V=>{if(k!==V.pointerId)return;const le=V.clientX-S;S=V.clientX,I.current+=(F.current.flip?le:-le)*F.current.dragMultiplier},Z=V=>{if(k===V.pointerId){k=null;try{u.hasPointerCapture(V.pointerId)&&u.releasePointerCapture(V.pointerId)}catch{}}};return u.addEventListener("pointerdown",v),u.addEventListener("pointermove",P),u.addEventListener("pointerup",Z),u.addEventListener("pointercancel",Z),()=>{u.removeEventListener("pointerdown",v),u.removeEventListener("pointermove",P),u.removeEventListener("pointerup",Z),u.removeEventListener("pointercancel",Z)}},[]);const z=m.useCallback(u=>{const k=He(u,0,f.length-1);I.current=k*X,y(k)},[f.length,X]),ce=m.useCallback(u=>{const k=He(A+(u==="left"?-1:1),0,f.length-1);z(k)},[A,z,f.length]);return e.jsxs("div",{style:{position:"relative",width:"100%",display:"flex",flexDirection:"column",alignItems:"center",margin:"1.2rem 0"},onMouseEnter:()=>W(!0),onMouseLeave:()=>W(!1),children:[e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",flexWrap:"wrap",gap:"8px",marginBottom:"1rem",zIndex:10},children:f.map((u,k)=>{const S=k===A;return e.jsx("button",{type:"button",onClick:()=>z(k),style:{padding:"6px 14px",borderRadius:"999px",border:S?"1px solid #ff8a3d":"1px solid rgba(255, 255, 255, 0.12)",background:S?"linear-gradient(135deg, rgba(255, 138, 61, 0.32), rgba(255, 90, 31, 0.22))":"rgba(20, 10, 6, 0.55)",color:S?"#ffbd59":"rgba(255, 255, 255, 0.65)",fontSize:"0.78rem",fontWeight:S?"850":"650",letterSpacing:"0.04em",cursor:"pointer",transition:"all 200ms ease",backdropFilter:"blur(8px)",boxShadow:S?"0 0 16px rgba(255, 138, 61, 0.35)":"none"},children:u.name},u.name)})}),e.jsx("div",{ref:w,className:"smooth-scroll-slider-viewport",style:{position:"relative",width:"100%",height:`${M+50}px`,overflow:"hidden",background:h,cursor:"grab",touchAction:"pan-y",opacity:O>0?1:0,transition:"opacity 0.35s ease",userSelect:"none",...C},children:f.map((u,k)=>{const S=u.isHeadliner,v=k===A;return e.jsxs("div",{ref:P=>{D.current[k]=P},onClick:()=>{z(k),te&&te(u,k)},style:{position:"absolute",top:"50%",left:0,width:`${E}px`,height:`${M}px`,borderRadius:`${o}px`,overflow:"hidden",background:"#130c0a",border:v?"1.5px solid rgba(255, 138, 61, 0.85)":S?"1px solid rgba(255, 138, 61, 0.45)":"1px solid rgba(255, 255, 255, 0.12)",boxShadow:v?"0 26px 65px rgba(0,0,0,0.9), 0 0 35px rgba(255, 90, 31, 0.4)":"0 18px 45px rgba(0,0,0,0.75)",willChange:"transform, filter",transform:"translate3d(0, -50%, 0)",cursor:"pointer",transition:"border-color 250ms ease, box-shadow 250ms ease"},children:[u.src?e.jsx("img",{src:u.src,alt:u.name,draggable:!1,onError:P=>{P.currentTarget.src=G("/assets/prism-auth-visual.jpg")},style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:`50% calc(50% + ${u.offsetY}px)`,display:"block",userSelect:"none"}}):null,e.jsxs("div",{style:{position:"absolute",top:"12px",left:"12px",right:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",zIndex:3},children:[S?e.jsx("span",{style:{display:"inline-flex",alignItems:"center",gap:"4px",padding:"4px 10px",borderRadius:"999px",background:"linear-gradient(135deg, #ff8a3d, #ff5a1f)",color:"#fff",fontSize:"0.68rem",fontWeight:"900",letterSpacing:"0.06em",textTransform:"uppercase",boxShadow:"0 4px 14px rgba(255, 90, 31, 0.45)"},children:"★ MAIN HEADLINER"}):e.jsx("span",{style:{padding:"3px 9px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.65)",backdropFilter:"blur(8px)",color:"#f6eee8",fontSize:"0.66rem",fontWeight:"700",border:"1px solid rgba(255,255,255,0.12)"},children:u.stage}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",gap:"2px",height:"14px",padding:"3px 6px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.55)",backdropFilter:"blur(6px)"},children:[e.jsx("span",{className:"sss-eq-bar sss-eq-1"}),e.jsx("span",{className:"sss-eq-bar sss-eq-2"}),e.jsx("span",{className:"sss-eq-bar sss-eq-3"})]})]}),e.jsxs("div",{style:{position:"absolute",inset:0,background:"linear-gradient(180deg, rgba(0,0,0,0.08) 0%, transparent 40%, rgba(10,5,3,0.72) 65%, rgba(6,3,2,0.96) 100%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:"16px 14px",zIndex:2},children:[e.jsx("span",{style:{display:"inline-block",width:"fit-content",padding:"2px 8px",borderRadius:"999px",background:"rgba(255, 138, 61, 0.18)",border:"1px solid rgba(255, 138, 61, 0.35)",color:"#ffbd59",fontSize:"0.68rem",fontWeight:"800",letterSpacing:"0.04em",textTransform:"uppercase",marginBottom:"6px"},children:u.genre}),e.jsx("h3",{style:{margin:0,color:"#ffffff",fontSize:"1.28rem",fontWeight:"900",letterSpacing:"-0.02em",lineHeight:1.15,textTransform:"uppercase",textShadow:"0 2px 10px rgba(0,0,0,0.7)"},children:u.name}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginTop:"8px",paddingTop:"6px",borderTop:"1px solid rgba(255,255,255,0.1)",color:"rgba(255, 255, 255, 0.72)",fontSize:"0.68rem",fontWeight:"700"},children:[e.jsxs("span",{children:["⚡ ",u.bpm]}),e.jsxs("span",{children:["♫ ",u.vibe]})]})]})]},u.name)})}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"1rem",marginTop:"0.8rem",zIndex:10},children:[e.jsx("button",{type:"button",onClick:()=>ce("left"),disabled:A===0,"aria-label":"Previous artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:A===0?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:A===0?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:A===0?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:A===0?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:u=>{A>0&&(u.currentTarget.style.transform="scale(1.1)",u.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:u=>{u.currentTarget.style.transform="scale(1)",u.currentTarget.style.borderColor=A===0?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"‹"}),e.jsx("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:f.map((u,k)=>e.jsx("span",{onClick:()=>z(k),style:{width:k===A?"20px":"6px",height:"6px",borderRadius:"999px",backgroundColor:k===A?"#ff8a3d":"rgba(255, 255, 255, 0.25)",cursor:"pointer",transition:"all 250ms ease"}},k))}),e.jsx("button",{type:"button",onClick:()=>ce("right"),disabled:A===f.length-1,"aria-label":"Next artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:A===f.length-1?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:A===f.length-1?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:A===f.length-1?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:A===f.length-1?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:u=>{A<f.length-1&&(u.currentTarget.style.transform="scale(1.1)",u.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:u=>{u.currentTarget.style.transform="scale(1)",u.currentTarget.style.borderColor=A===f.length-1?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"›"})]}),e.jsx("style",{children:`
      ...
      `})]})}const qe={color:"#ff8a3d",rounded:24,thickness:2.5,borderSize:45,glow:85,movement:"continuous",speed:16},ns=2,oa=[{blur:8,opacity:.5,reach:.3},{blur:15,opacity:.3,reach:.6},{blur:40,opacity:.18,reach:1}],os=Math.max(...oa.map(t=>t.blur)),Ut=36;function Nt(t,s){const a=Math.max(0,Math.min(1,s));if(typeof t!="string")return`rgba(0,0,0,${a})`;const r=t.trim(),i=r.match(/^#([0-9a-f]{3,8})$/i);if(i){let d=i[1];(d.length===3||d.length===4)&&(d=d.split("").map(p=>p+p).join(""));const o=parseInt(d.slice(0,6),16);return Number.isFinite(o)?`rgba(${o>>16&255},${o>>8&255},${o&255},${a})`:`rgba(0,0,0,${a})`}const l=r.match(/^rgba?\(([^)]+)\)/i);if(l){const d=l[1].split(",").map(o=>parseFloat(o));if(d.length>=3&&d.slice(0,3).every(Number.isFinite))return`rgba(${d[0]},${d[1]},${d[2]},${a})`}return`rgba(0,0,0,${a})`}function ls(t,s,a){const r=(t%1+1)%1*2*(s+a);return r<s?[r,0]:r<s+a?[s,r-s]:r<s*2+a?[s-(r-s-a),a]:[0,a-(r-s*2-a)]}function Vt(t,s,a){const r=2*(s+a),i=[0,s/r,(s+a)/r,(s*2+a)/r];return Math.floor(t/4)+i[(t%4+4)%4]}function cs(t,s,a){const[r,i]=ls(t,s,a);return Math.atan2(r-s/2,a/2-i)*180/Math.PI}const Gt=24,ds=.015;function St(t,s,a,r,i){const l=a>0?a:100,d=r>0?r:100,o=Math.max(0,Math.min(100,s)),p=Math.max(ds,o/100*.5),h=o/100,x=[];let j=0,N=0,C=0;for(let w=0;w<=Gt;w++){const D=w/Gt,I=cs(t+(D-.5)*p,l,d);if(w===0)j=I;else{let R=I-N;for(;R>180;)R-=360;for(;R<-180;)R+=360;C+=R}N=I;const $=Math.abs(D-.5)*2,O=h>=1||$<=h?1:1-($-h)/(1-h);x.push(`${Nt(i,O*O*(3-2*O))} ${C.toFixed(2)}deg`)}const te=C.toFixed(2);return x.push(`${Nt(i,0)} ${te}deg`),x.push(`${Nt(i,0)} 360deg`),`conic-gradient(from ${j.toFixed(2)}deg at 50% 50%, ${x.join(", ")})`}const $t=30,ps=4,Wt=3,ms=.35,us=[.72,.16,.18,1.05],fs=[.65,0,.35,1];function la(t){const[s,a,r,i]=t;if(s===a&&r===i)return d=>d;const l=(d,o,p)=>{const h=1-p;return 3*h*h*p*d+3*h*p*p*o+p*p*p};return d=>{const o=Math.max(0,Math.min(1,d));let p=o;for(let h=0;h<8;h++){const x=l(s,r,p)-o,j=1-p,N=3*j*j*s+6*j*p*(r-s)+3*p*p*(1-r);if(Math.abs(N)<1e-6)break;p-=x/N,p=Math.max(0,Math.min(1,p))}return l(a,i,p)}}const hs=la(us),gs=la(fs),Yt={WebkitMaskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",WebkitMaskClip:"content-box, border-box",WebkitMaskComposite:"xor",maskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",maskClip:"content-box, border-box",maskComposite:"exclude"};function Xe({color:t=qe.color,rounded:s=qe.rounded,thickness:a=qe.thickness,borderSize:r=qe.borderSize,glow:i=qe.glow,movement:l=qe.movement,speed:d=qe.speed,style:o,className:p=""}){const h=m.useRef(null),x=m.useRef(null),j=m.useRef({speed:d,movement:l,borderSize:r,color:t});j.current={speed:d,movement:l,borderSize:r,color:t};const N=m.useRef(null),C=m.useRef({w:0,h:0}),[te,w]=m.useState({w:0,h:0});m.useEffect(()=>{const y=N.current;if(!y||typeof ResizeObserver>"u")return;const c=new ResizeObserver(()=>{const f=y.getBoundingClientRect();f.width===C.current.w&&f.height===C.current.h||(C.current={w:f.width,h:f.height},w(C.current))});return c.observe(y),()=>c.disconnect()},[]),m.useEffect(()=>{const y=N.current;let c=!0,f=null;typeof IntersectionObserver<"u"&&y&&(f=new IntersectionObserver(ae=>{ae[0]&&(c=ae[0].isIntersecting)},{rootMargin:"100px"}),f.observe(y));let E=0,M=performance.now(),X=0,_=0,se=0;const K=ae=>{if(E=requestAnimationFrame(K),!c||typeof document<"u"&&document.hidden){M=ae;return}const oe=Math.min(.05,Math.max(0,(ae-M)/1e3));M=ae;const U=j.current,F=Math.max(0,Math.min(20,U.speed));if(F>0){const z=U.movement==="step",ce=z?Wt+(ms-Wt)*(F-1)/19:($t+(ps-$t)*(F-1)/19)/4;for(se+=oe/ce;se>=1;)se-=1,_+=1;const u=z?hs(Math.min(1,se*2)):gs(se),{w:k,h:S}=C.current,v=k>0?k:100,P=S>0?S:100,Z=Vt(_,v,P),V=Vt(_+1,v,P);X=Z+(V-Z)*u;const le=h.current;le&&le.style.setProperty("--arc",St(X,U.borderSize,k,S,U.color));const J=x.current;J&&J.style.setProperty("--arc",St(X+.5,U.borderSize,k,S,U.color))}};return E=requestAnimationFrame(K),()=>{cancelAnimationFrame(E),f&&f.disconnect()}},[]);const D=Math.max(1,Math.min(10,a)),I=Math.max(0,Math.min(100,s))/100*(Math.min(te.w||200,te.h||200)/2),$=Math.max(0,Math.min(100,i))/100,O=y=>D+$*Ut*y,R=10+Ut+os*2,n=(y,c=0)=>e.jsx("div",{style:{position:"absolute",inset:c-y,boxSizing:"border-box",padding:y,borderRadius:I>0?I+y:0,background:"var(--arc)",...Yt}}),W=(y,c,f,E)=>e.jsx("div",{style:{position:"absolute",inset:-R,boxSizing:"border-box",padding:R,borderRadius:I>0?I+R:0,opacity:E,mixBlendMode:"plus-lighter",filter:f?`blur(${f.toFixed(1)}px)`:"none",WebkitFilter:f?`blur(${f.toFixed(1)}px)`:"none",...Yt},children:n(c,R)},y),A=(y,c)=>e.jsxs("div",{ref:c,style:{position:"absolute",inset:0,overflow:"visible",pointerEvents:"none","--arc":St(y,r,te.w,te.h,t)},children:[$>0&&oa.map((f,E)=>W(`glow-${E}`,O(f.reach),f.blur,f.opacity)),Array.from({length:ns}).map((f,E)=>e.jsx("div",{style:{position:"absolute",inset:0,mixBlendMode:"plus-lighter"},children:n(D)},`edge-${E}`))]});return e.jsxs("div",{ref:N,className:`neon-border-overlay ${p}`,style:{position:"absolute",inset:0,width:"100%",height:"100%",flexShrink:0,borderRadius:I,pointerEvents:"none",zIndex:1,...o},children:[A(0,h),A(.5,x)]})}const xs=1.5,bs=42,vs=Math.PI*2,ys=300,ws=300,js=2,ks=5e3,Ns=3.2,Ss=.05,As=3,Es=1.35,Ps=.08,Rs=.5,Ts=.24,Is=.35,Ls=vs*.75,Ms=2,ca=3,gt=720,Fs=`
...
void main() {
    ...
    float ang = aA.x * ${Ls.toFixed(6)} + aA.y * TAU * ${Ms.toFixed(1)};
    float rN = mix(${Is.toFixed(3)}, 1.0, sqrt(aA.z));
    float r  = uRadius * rN * (1.0 + ${Ss.toFixed(3)} * tau);

    float tp   = ${Ps.toFixed(3)};
    float bump = (tau / tp) * exp(1.0 - tau / tp);
    float rimW = smoothstep(${Rs.toFixed(3)}, 1.0, rN);
    float y    = uRise * bump * rimW - uFall * pow(tau, ${Es.toFixed(2)});
...
`;function qt(t){if(!t)return[1,1,1,1];let s=String(t).trim();const a=s.match(/^var\(\s*[^,)]+\s*,\s*(.+)\)$/i);a&&(s=a[1].trim());const r=s.match(/^rgba?\(([^)]+)\)$/i);if(r){const l=r[1].split(/[,\s/]+/).filter(Boolean).map(parseFloat);return[(l[0]||0)/255,(l[1]||0)/255,(l[2]||0)/255,l.length>3&&isFinite(l[3])?l[3]:1]}let i=s.replace("#","");return(i.length===3||i.length===4)&&(i=i.split("").map(l=>l+l).join("")),i.length<6?[1,1,1,1]:[parseInt(i.slice(0,2),16)/255,parseInt(i.slice(2,4),16)/255,parseInt(i.slice(4,6),16)/255,i.length>=8?parseInt(i.slice(6,8),16)/255:1]}function Os(t){return()=>{t|=0,t=t+1831565813|0;let s=Math.imul(t^t>>>15,1|t);return s=s+Math.imul(s^s>>>7,61|s)^s,((s^s>>>14)>>>0)/4294967296}}function Xt(t,s,a){const r=t.createShader(s);return r?(t.shaderSource(r,a),t.compileShader(r),t.getShaderParameter(r,t.COMPILE_STATUS)||console.warn("VortexDustFall shader:",t.getShaderInfoLog(r)),r):null}function Kt(t,s,a){const r=t.createProgram();if(!r)return null;const i=Xt(t,t.VERTEX_SHADER,s),l=Xt(t,t.FRAGMENT_SHADER,a);return!i||!l?null:(t.attachShader(r,i),t.attachShader(r,l),t.linkProgram(r),t.getProgramParameter(r,t.LINK_STATUS)||console.warn("VortexDustFall link:",t.getProgramInfoLog(r)),r)}const Ds={radius:195,thickness:16},Bs={height:165,spin:38,spray:0},Hs={scatter:280,blur:0},Us={amount:103,transition:{type:"tween",duration:.6,ease:"easeOut"}};function Vs({background:t="transparent",baseColor:s="#FFA733",accentColor:a="#FFE082",density:r=145,dotSize:i=130,speed:l=48,distance:d=1450,tilt:o=7,ring:p={},fall:h={},field:x={},hover:j={},style:N={},className:C="",children:te}){const w={...Ds,...p},D={...Bs,...h},I={...Hs,...x},$={...Us,...j},O=m.useRef(null),R=m.useRef(null),n=m.useRef({x:0,y:0,active:0}),W=m.useRef({baseColor:s,accentColor:a,density:r,dotSize:i,speed:l,distance:d,tilt:o,ring:w,fall:D,field:I,hover:$});return W.current={baseColor:s,accentColor:a,density:r,dotSize:i,speed:l,distance:d,tilt:o,ring:w,fall:D,field:I,hover:$},m.useEffect(()=>{const A=O.current,y=R.current;if(!A||!y)return;const c=y.getContext("webgl",{alpha:!0,antialias:!1,premultipliedAlpha:!0,depth:!1});if(!c)return;const f=Kt(c,Fs,Cs),E=Kt(c,_s,zs);if(!f||!E)return;const M=(T,g)=>c.getUniformLocation(T,g),X={a:c.getAttribLocation(f,"aA"),b:c.getAttribLocation(f,"aB")},_={res:M(f,"uRes"),focal:M(f,"uFocal"),phase:M(f,"uPhase"),radius:M(f,"uRadius"),rise:M(f,"uRise"),fallD:M(f,"uFall"),spinTurns:M(f,"uSpinTurns"),scatter:M(f,"uScatter"),dotWorld:M(f,"uDotWorld"),blurK:M(f,"uBlurK"),camDist:M(f,"uCamDist"),tilt:M(f,"uTilt"),yPx:M(f,"uYPx"),alpha:M(f,"uAlpha"),color:M(f,"uColor")},se={ring:c.getAttribLocation(E,"aRing")},K={res:M(E,"uRes"),focal:M(E,"uFocal"),radius:M(E,"uRadius"),camDist:M(E,"uCamDist"),tilt:M(E,"uTilt"),yPx:M(E,"uYPx"),thick:M(E,"uThick"),seg:M(E,"uSeg"),color:M(E,"uColor"),alpha:M(E,"uAlpha")},ae=c.createBuffer(),oe=c.createBuffer();let U=-1,F=0;const z=T=>{const g=y.clientWidth||A.clientWidth||(typeof window<"u"?window.innerWidth:1200),b=g<768,ie=g>=768&&g<1024,Y=b?1800:ie?8500:Math.round(T*ys);F=Math.max(1e3,Y);const ee=new Float32Array(F*4),Se=new Float32Array(F*2),ke=Os(85840071);for(let xe=0;xe<F;xe++)ee[xe*4]=ke(),ee[xe*4+1]=ke(),ee[xe*4+2]=ke(),ee[xe*4+3]=ke(),Se[xe*2]=ke(),Se[xe*2+1]=ke();c.bindBuffer(c.ARRAY_BUFFER,ae),c.bufferData(c.ARRAY_BUFFER,ee,c.STATIC_DRAW),c.bindBuffer(c.ARRAY_BUFFER,oe),c.bufferData(c.ARRAY_BUFFER,Se,c.STATIC_DRAW),U=T},ce=c.createBuffer(),u=(gt+1)*2;{const T=new Float32Array(u*2);for(let g=0;g<=gt;g++){const b=g/gt;T[g*4]=b,T[g*4+1]=-1,T[g*4+2]=b,T[g*4+3]=1}c.bindBuffer(c.ARRAY_BUFFER,ce),c.bufferData(c.ARRAY_BUFFER,T,c.STATIC_DRAW)}c.disable(c.DEPTH_TEST),c.enable(c.BLEND),c.blendFunc(c.ONE,c.ONE);let k=!0,S=null;typeof IntersectionObserver<"u"&&A&&(S=new IntersectionObserver(T=>{T[0]&&(k=T[0].isIntersecting)},{rootMargin:"120px"}),S.observe(A));let v=1,P=0;const Z=()=>{v=Math.min(window.devicePixelRatio||1,xs);const T=y.clientWidth||A.clientWidth||1,g=y.clientHeight||A.clientHeight||1,b=Math.max(1,Math.round(T*v)),ie=Math.max(1,Math.round(g*v));(y.width!==b||y.height!==ie)&&(y.width=b,y.height=ie),c.viewport(0,0,b,ie),Math.abs(P-T)>50&&(P=T,z(W.current.density))};Z();const V=new ResizeObserver(Z);V.observe(y);let le=0,J=performance.now(),re=0,de=0,fe=0,pe=0;const Q=T=>{if(re=requestAnimationFrame(Q),!k||typeof document<"u"&&document.hidden){J=T;return}const g=Math.min((T-J)/1e3,.05);J=T;const b=W.current;if(b.density!==U&&z(b.density),F===0)return;const ie=Math.max(.05,b.hover.transition?.duration??.6),Y=1-Math.exp(-g/ie),ee=n.current;de+=(ee.x-de)*Y,fe+=(ee.y-fe)*Y,pe+=(ee.active-pe)*Y;const Se=(b.hover.amount||100)/100,ke=1+pe*Se*.6;le=(le+g*(b.speed/50*ke)/Ns)%1;const xe=y.width,We=y.height,Me=y.clientWidth||A.clientWidth||1200,Re=Me<768,st=Me>=768&&Me<1024,Ye=We/(2*Math.tan(bs/2*Math.PI/180)),rt=xe/Math.max(We,1),it=rt<1?Math.max(.32,rt/1.4):st?.85:1,ye=ws*(b.ring.radius/100)*it,nt=ye*(Re?1.1:b.fall.height/100),pt=nt*(b.fall.spray/400),mt=We*(Re?.22:Ts),bt=b.fall.spin/100*1.5,Te=ye*(b.field.scatter/100)*(Re?.08:.15),ut=js*(b.dotSize/100)*(Re?.65:1),ze=ks*(b.field.blur/100),Oe=Re?Math.min(b.ring.thickness*v,9*v):b.ring.thickness*v,L=b.tilt*Math.PI/180+fe*Se*pe*(10*Math.PI/180),ne=(Re?b.distance*1.05:b.distance)-pe*Se*150,[me,we,he,Ae]=qt(b.baseColor),[De,Je,Ie,Qe]=qt(b.accentColor);c.clearColor(0,0,0,0),c.clear(c.COLOR_BUFFER_BIT),c.useProgram(f),c.uniform2f(_.res,xe,We),c.uniform1f(_.focal,Ye),c.uniform1f(_.phase,le),c.uniform1f(_.radius,ye),c.uniform1f(_.rise,pt),c.uniform1f(_.fallD,nt),c.uniform1f(_.spinTurns,bt),c.uniform1f(_.scatter,Te),c.uniform1f(_.dotWorld,ut*v),c.uniform1f(_.blurK,ze*v),c.uniform1f(_.camDist,ne),c.uniform1f(_.tilt,L),c.uniform1f(_.yPx,mt),c.uniform1f(_.alpha,Ae),c.uniform3f(_.color,me,we,he),c.bindBuffer(c.ARRAY_BUFFER,ae),c.enableVertexAttribArray(X.a),c.vertexAttribPointer(X.a,4,c.FLOAT,!1,0,0),c.bindBuffer(c.ARRAY_BUFFER,oe),c.enableVertexAttribArray(X.b),c.vertexAttribPointer(X.b,2,c.FLOAT,!1,0,0),c.drawArrays(c.POINTS,0,F),c.useProgram(E),c.uniform2f(K.res,xe,We),c.uniform1f(K.focal,Ye),c.uniform1f(K.radius,ye),c.uniform1f(K.camDist,ne),c.uniform1f(K.tilt,L),c.uniform1f(K.yPx,mt),c.uniform1f(K.thick,Oe),c.uniform1f(K.seg,gt),c.uniform3f(K.color,De,Je,Ie),c.uniform1f(K.alpha,Qe),c.bindBuffer(c.ARRAY_BUFFER,ce),c.enableVertexAttribArray(se.ring),c.vertexAttribPointer(se.ring,2,c.FLOAT,!1,0,0),c.drawArrays(c.TRIANGLE_STRIP,0,u)};return re=requestAnimationFrame(Q),()=>{cancelAnimationFrame(re),V.disconnect(),S&&S.disconnect(),c.deleteBuffer(ae),c.deleteBuffer(oe),c.deleteBuffer(ce),c.deleteProgram(f),c.deleteProgram(E)}},[]),e.jsxs("div",{ref:O,className:`vortex-dust-container ${C}`,onPointerMove:A=>{const y=A.currentTarget.getBoundingClientRect();y.width<=0||y.height<=0||(n.current={x:(A.clientX-y.left)/y.width*2-1,y:-((A.clientY-y.top)/y.height*2-1),active:1})},onPointerLeave:()=>{n.current={x:0,y:0,active:0}},style:{position:"absolute",inset:0,width:"100%",height:"100%",overflow:"hidden",pointerEvents:"none",background:t,...N},children:[e.jsx("canvas",{ref:R,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}}),te&&e.jsx("div",{style:{position:"relative",zIndex:2,pointerEvents:"auto",width:"100%",height:"100%"},children:te})]})}const Gs=[{name:"TALWINDER",isHeadliner:!0,genre:"Indie Pop / Punjabi Fusion",stage:"Main Prism Stage",bpm:"128 BPM",vibe:"Euphoric Night",image:G("/assets/ozilla/talwinder.jpg")},{name:"IMRAN KHAN",genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",image:G("/assets/ozilla/Imran-Khan.jpg")},{name:"BOHEMIA",genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",image:G("/assets/ozilla/Bohemia.jpg")},{name:"HASSAN RAHEEM",genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",image:G("/assets/ozilla/hassan-raheem.jpg")}],$s=[{id:"general",name:"General Pass",badge:"STANDARD ACCESS",price:"PKR 4,500",sub:"Full 1-day festival admission",isFeatured:!1,perks:["Access to All 4 Music Stages","Food & Beats Street Access","Festival Photo Booths & Activations","Instant Digital QR Pass"],ctaText:"Get General Pass",ctaLink:"/tickets"},{id:"vip",name:"VIP Experience",badge:"MOST POPULAR",price:"PKR 12,500",sub:"Elevated front-row & lounge access",isFeatured:!0,perks:["Priority Front Stage Viewing Deck","Private VIP Artist Lounge Access","Dedicated Fast-Track Entry Gate","Complimentary Food & Drink Voucher","20% Partner Hotel & Dining Discounts","Holographic VIP Commemorative Pass"],ctaText:"Book VIP Pass →",ctaLink:"/tickets"},{id:"platinum",name:"All-Access Platinum",badge:"EXCLUSIVE ALL-ACCESS",price:"PKR 25,000",sub:"Ultimate luxury hospitality package",isFeatured:!1,perks:["Backstage & Artist Lounge Access","Valet Reserved Parking Spot","Gourmet Catering & Open Mocktail Bar","Exclusive Afterparty Invitation","Dedicated Hospitality Concierge","Full Merchandise Gift Bundle"],ctaText:"Reserve Platinum Pass",ctaLink:"/tickets"}],Ws=[{badge:"100kW SOUND SYSTEM",title:"4 Mega Sound Stages",desc:"Explosive stage arenas for Indie Pop, Punjabi Rap, Desi Hip-Hop, and non-stop EDM beats."},{badge:"HEADLINE CELEBRITIES",title:"Star-Studded Lineup",desc:"Live stadium sets by Talwinder, Imran Khan, Bohemia, Hassan Raheem, and top artists."},{badge:"CULINARY & NIGHT BAZAAR",title:"Food & Beats Street",desc:"50+ curated gourmet food stalls, wood-fired artisan eats, and craft mocktail lounges."},{badge:"ALL-ACCESS HOSPITALITY",title:"VIP Lounge & Deck Access",desc:"Elevated front-stage viewing decks, private artist lounges, and fast-track VIP gates."}],Ys=[{name:"OZILLA FEST 2026: The Flagship",date:"November 1, 2026",location:"Lahore, Pakistan",status:"FEATURED FESTIVAL",description:"Flagship festival with 4 mega stages, 20+ star artists, and 10,000+ live crowd."},{name:"Celebrity Night Live Concert",date:"February 2027",location:"Lahore, Pakistan",status:"UPCOMING CONCERT",description:"High-octane stadium night with headline Punjabi artists and 360° laser shows."},{name:"Ozilla Basant Beats Season 2",date:"March 2027",location:"Lahore, Pakistan",status:"SEASONAL FESTIVAL",description:"Cultural music fusion festival with live pop sets, color activations, and street eats."}],qs=[{name:"Ozilla Season 1: The Bass Awakening",status:"Sold Out · 6,500+ Fans",detail:"Debut open-air music festival in Lahore featuring indie fusion acts and 2 live mega stages."},{name:"Ozilla Season 2: Neon Nights",status:"Sold Out · 8,500+ Fans",detail:"High-energy night festival with headline celebrity acts and artisan night food street."}],Xs=[{name:"Ozilla Debut: The Sound Awakening",year:"2023",badge:"SOLD OUT DEBUT",description:"Historic launch in Lahore uniting 6,000+ fans for live indie music and night market culture.",highlights:["6,000+ Attendees","2 Live Stages","Indie & Desi Fusion"],venue:"Lahore Expo Center",date:"December 12, 2023"},{name:"Ozilla Season 2: Neon Nights",year:"2024",badge:"RECORD 8,500+ CROWD",description:"Season 2 expansion with 4 live stages, celebrity headliners, and 360° laser canopy.",highlights:["8,500+ Fans","4 Live Stages","Celebrity Headliners"],venue:"DHA Sports Complex, Lahore",date:"November 9, 2024"},{name:"Ozilla Basant Cultural Beats",year:"2025",badge:"SPRING FESTIVAL",description:"Seasonal spring music festival with live acoustic sets, DJ arenas, and artisan bazaar.",highlights:["Cultural Sets","Live DJ Stages","Food Hub"],venue:"Gulberg Cultural District, Lahore",date:"March 15, 2025"},{name:"OZILLA FEST 2026 (The Grand Edition)",year:"2026",badge:"FLAGSHIP 10,000+ EDITION",description:"Monumental flagship edition with 4 stages, 20+ star artists, and 100kW laser sound arrays.",highlights:["10,000+ Crowd","4 Mega Stages","Talwinder & Imran Khan"],venue:"Lahore, Punjab",date:"November 1, 2026"},{name:"OZILLA FEST 2027: Arena Tour",year:"2027",badge:"NATIONWIDE TOUR",description:"Nationwide arena tour expansion bringing the signature Ozilla concert experience across Pakistan.",highlights:["Arena Tour","Multi-City Stages","Star Acts"],venue:"Lahore, Karachi & Islamabad",date:"November 14, 2027"}],Ks=[{tier:"Title Sponsor",price:"PREMIUM",badge:"FLAGSHIP PARTNER",accent:"#ffbd59",tagline:"Maximum Brand Dominance",isFeatured:!0,ctaText:"Claim Title Partnership",perks:["Exclusive brand naming rights","Main stage backdrop placement","VIP lounge & deck co-branding","30-second main stage video slot","Dedicated social & press campaigns"]},{tier:"Gold Sponsor",price:"HIGH IMPACT",badge:"STAGE ACTIVATION",accent:"#ff8a3d",tagline:"High-Energy Ground Presence",isFeatured:!1,ctaText:"Become Gold Sponsor",perks:["Exclusive brand activation zone","Perimeter banner placements","Digital festival app features","Influencer co-branding & mentions","On-ground brand booth space"]},{tier:"Silver Sponsor",price:"GROWTH",badge:"BRAND PARTNER",accent:"#cbd5e1",tagline:"Targeted Festival Engagement",isFeatured:!1,ctaText:"Join Silver Tier",perks:["Official festival website branding","Social media shoutouts","Sampling booth at food street","Newsletter sponsor placement","10 complimentary festival passes"]},{tier:"Media Partner",price:"CUSTOM",badge:"BROADCAST & PRESS",accent:"#ec4899",tagline:"Official Media Rights",isFeatured:!1,ctaText:"Apply For Press Pass",perks:["Official media coverage rights","All-access artist press passes","Exclusive backstage interview access","Press release announcement feature","Dedicated creator lounge access"]}],Zs=[{badge:"100kW SOUND ARRAY",title:"Main Concert Arena",desc:"Stadium-grade concert sound arrays, 360° lasers, and cryogenic live jets.",accent:"#ff5a1f"},{badge:"50+ FOOD SPOTS",title:"Food & Beats Street",desc:"50+ night food stalls, wood-fired artisan eats, and gourmet smash burgers.",accent:"#ffbd59"},{badge:"24/7 RAPID CARE",title:"Medical & First Aid Hub",desc:"Fully equipped medical stations and certified paramedic response teams.",accent:"#ef4444"},{badge:"VALET & VIP GATES",title:"Managed VIP Parking",desc:"Fast-track valet lanes and direct express entry for VIP pass holders.",accent:"#f59e0b"},{badge:"CREATOR LIGHTING",title:"Holographic Photo Booths",desc:"Interactive neon backdrops and 360° video spinners for creator moments.",accent:"#ec4899"},{badge:"INCLUSIVE VENUE",title:"Full Venue Accessibility",desc:"Elevated viewing decks, step-free ramps, and on-ground guest assistance.",accent:"#3b82f6"},{badge:"PROFESSIONAL SQUAD",title:"Crowd Safety & Security",desc:"Trained festival security squad, CCTV monitoring, and RFID gate checks.",accent:"#10b981"},{badge:"GIGABIT HIGH-SPEED",title:"Ultra-Fast Festival Wi-Fi",desc:"High-density wireless zones across all stages and food streets.",accent:"#06b6d4"}],Js=[{value:"10,000+",label:"Music Lovers",sub:"Packed Live Crowd"},{value:"20+",label:"Star Performers",sub:"Celebrity & Indie Acts"},{value:"4",label:"Mega Stages",sub:"Non-stop Beats"},{value:"50+",label:"Food & Stalls",sub:"Culinary & Brand Hub"}];function Qs(t){const[s,a]=m.useState(()=>{const r=Math.max(new Date(t)-Date.now(),0);return{days:Math.floor(r/864e5),hours:Math.floor(r/36e5%24),minutes:Math.floor(r/6e4%60),seconds:Math.floor(r/1e3%60)}});return m.useEffect(()=>{const r=setInterval(()=>{const i=Math.max(new Date(t)-Date.now(),0);a({days:Math.floor(i/864e5),hours:Math.floor(i/36e5%24),minutes:Math.floor(i/6e4%60),seconds:Math.floor(i/1e3%60)})},1e3);return()=>clearInterval(r)},[t]),s}function er(){const t=$e(),s=Qs("2026-11-01T18:00:00+05:00");return m.useEffect(()=>{const a=t.hash?.replace("#","");a?setTimeout(()=>{const r=document.getElementById(a);r&&r.scrollIntoView({behavior:"smooth",block:"start"})},150):window.scrollTo({top:0,behavior:"smooth"})},[t.hash]),e.jsxs("main",{className:"sp-main",children:[e.jsxs("section",{id:"home",className:"sp-hero","aria-label":"Ozilla Fest",children:[e.jsx(Vs,{baseColor:"#ff8a3d",accentColor:"#ffbd59",density:125,speed:46,tilt:7}),e.jsx("div",{className:"sp-hero-ambient-glow"}),e.jsxs("div",{className:"sp-hero-content",children:[e.jsxs(H.div,{className:"sp-hero-badge",initial:{opacity:0,y:-20,scale:.9},animate:{opacity:1,y:0,scale:1},transition:{duration:.6},children:[e.jsx("span",{children:"✨"}),e.jsx("strong",{children:"OZILLA FEST 2026 · LAHORE"})]}),e.jsx(H.h1,{className:"sp-hero-title",initial:{opacity:0,y:25},animate:{opacity:1,y:0},transition:{duration:.7,delay:.12},children:"OZILLA FEST"}),e.jsxs(H.p,{className:"sp-hero-subtitle",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.7,delay:.25},children:[e.jsx("strong",{className:"sp-hero-sub-highlight",children:"Pakistan's Flagship Music & Cultural Phenomenon."}),e.jsx("span",{className:"sp-hero-sub-detail",children:"4 Electrified Mega Stages · Headline Celebrities · High-Octane Sound Under the Lahore Night Sky."})]}),e.jsxs(H.div,{className:"sp-hero-meta-strip",initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{duration:.6,delay:.4},children:[e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"DATE"}),e.jsx("strong",{children:"NOV 01, 2026"})]}),e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"CITY"}),e.jsx("strong",{children:"LAHORE, PK"})]}),e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"PRODUCTION"}),e.jsx("strong",{children:"4 MEGA STAGES"})]}),e.jsxs("div",{className:"sp-hero-meta-pill sp-meta-featured",children:[e.jsx("span",{className:"sp-meta-dot sp-dot-gold"}),e.jsx("span",{className:"sp-meta-label",children:"PASSES"}),e.jsx("strong",{children:"INSTANT QR PASS"})]})]}),e.jsxs(H.div,{className:"sp-hero-actions",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6,delay:.55},children:[e.jsx(H.a,{className:"sp-btn-ember",href:"#celebrities",whileHover:{scale:1.04},whileTap:{scale:.97},children:"Explore Lineup ⚡"}),e.jsx(H.div,{whileHover:{scale:1.04},whileTap:{scale:.97},children:e.jsx(q,{className:"sp-btn-ghost",to:"/tickets",children:"Get VIP Passes 🎟️"})})]})]})]}),e.jsx("section",{className:"festival-stats-strip","aria-label":"Festival Highlights",children:e.jsx("div",{className:"sp-container",children:e.jsx("div",{className:"stats-inner-grid",children:Js.map((a,r)=>e.jsxs(H.div,{className:"stat-card",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.4,delay:r*.08},whileHover:{y:-5,scale:1.02},children:[e.jsx("strong",{className:"stat-val",children:a.value}),e.jsx("span",{className:"stat-label",children:a.label}),e.jsx("small",{className:"stat-sub",children:a.sub})]},a.label))})})}),e.jsx("section",{id:"celebrities",className:"sp-section sp-section-celebrities","aria-label":"Celebrities Lineup",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"Live on the Ozilla Stage"}),e.jsx("h2",{className:"sp-section-title",children:"Celebrity Singers & Performers"}),e.jsx("p",{className:"sp-section-subtitle",children:"Four powerhouse headline performers, one premium Lahore festival atmosphere, and an amphitheatre built for unforgettable crowd moments."})]}),e.jsx(H.div,{className:"sp-celebrity-slider-wrap",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-40px"},transition:{duration:.6},style:{margin:"1rem 0 3.5rem 0"},children:e.jsx(is,{items:Gs,slideWidth:320,slideHeight:440,spacing:2.6,smoothness:8.5,dim:6,sensitivity:5,autoPlay:!0,autoPlaySpeed:1.2})}),e.jsxs(H.div,{className:"sp-countdown-banner",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.55},children:[e.jsx("div",{className:"sp-countdown-header",children:e.jsxs("span",{className:"sp-countdown-eyebrow",children:[e.jsx("span",{className:"sp-countdown-pulse"}),"COUNTDOWN TO THE FIRST BEAT DROP"]})}),e.jsx("div",{className:"sp-countdown-grid",children:[["Days",s.days],["Hours",s.hours],["Minutes",s.minutes],["Seconds",s.seconds]].map(([a,r])=>e.jsxs(H.div,{className:"sp-countdown-card",whileHover:{scale:1.05,y:-4},transition:{type:"spring",stiffness:350},children:[e.jsx("strong",{children:String(r).padStart(2,"0")}),e.jsx("span",{children:a}),e.jsx("div",{className:"sp-countdown-glow-line"})]},a))})]})]})}),e.jsx("section",{id:"vip-experience",className:"sp-section sp-section-pricing","aria-label":"Festival Passes",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header",style:{textAlign:"center"},initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"CHOOSE YOUR ACCESS"}),e.jsx("h2",{className:"sp-section-title",children:"Festival Passes & VIP Tiers"}),e.jsx("p",{className:"sp-section-subtitle",style:{margin:"0 auto"},children:"Select your festival experience tier. Instant dynamic QR pass generated upon reservation with guaranteed fast-track admission."})]}),e.jsx("div",{className:"sp-pricing-grid",children:$s.map((a,r)=>e.jsxs(H.div,{className:`sp-pricing-card ${a.isFeatured?"sp-featured-pricing":""}`,initial:{opacity:0,y:35},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:r*.12},whileHover:{y:-8},children:[a.isFeatured&&e.jsx("div",{className:"sp-pricing-popular-tag",children:"MOST POPULAR ACCESS"}),e.jsxs("div",{className:"sp-pricing-header",children:[e.jsx("span",{className:"sp-tier-badge",children:a.badge}),e.jsx("h3",{children:a.name}),e.jsx("div",{className:"sp-pricing-cost",children:e.jsx("strong",{children:a.price})}),e.jsx("p",{className:"sp-pricing-sub",children:a.sub})]}),e.jsx("div",{className:"sp-pricing-divider"}),e.jsx("ul",{className:"sp-pricing-features",children:a.perks.map(i=>e.jsxs("li",{children:[e.jsx("span",{className:"sp-perk-check",children:"✓"}),e.jsx("span",{children:i})]},i))}),e.jsx(q,{to:a.ctaLink,className:a.isFeatured?"sp-btn-ember w-full":"sp-btn-ghost w-full",style:{textAlign:"center",marginTop:"auto"},children:a.ctaText})]},a.id))})]})}),e.jsx("section",{id:"about",className:"sp-section sp-section-about","aria-label":"About Ozilla",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"⚡ THE ULTIMATE LIVE EXPERIENCE"}),e.jsx("h2",{className:"sp-section-title",children:"The Ozilla Fest Atmosphere"}),e.jsx("p",{className:"sp-section-subtitle",children:"Pakistan's flagship open-air music & cultural festival. 4 electrified stages, 100kW concert sound, headline celebrity acts, gourmet food street, and unmatched crowd energy under the Lahore night sky."})]}),e.jsx("div",{className:"sp-pillars-grid",children:Ws.map((a,r)=>e.jsxs(H.div,{className:"sp-pillar-card",initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:r*.1},whileHover:{y:-8,scale:1.02},children:[e.jsx("div",{className:"sp-pillar-glow-accent"}),e.jsx("div",{className:"sp-pillar-top",children:e.jsx("span",{className:"sp-pillar-badge",children:a.badge})}),e.jsx("h3",{className:"sp-pillar-title",children:a.title}),e.jsx("p",{className:"sp-pillar-desc",children:a.desc}),e.jsx("div",{className:"sp-pillar-glow-line"})]},a.title))}),e.jsxs(H.div,{className:"sp-festival-vibe-banner",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:35},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6},children:[e.jsx(Xe,{color:"#ff7a29",rounded:32,thickness:2.8,borderSize:50,glow:85}),e.jsxs("div",{className:"sp-vibe-left",style:{position:"relative",zIndex:2},children:[e.jsxs("span",{className:"sp-vibe-eyebrow",children:[e.jsx("span",{className:"sp-countdown-pulse"}),"FESTIVAL HIGHLIGHTS"]}),e.jsx("h3",{children:"What Makes Ozilla Legendary"}),e.jsx("p",{children:"Non-stop beats from golden hour to midnight, surrounded by festival activations and pure music culture."}),e.jsxs("div",{className:"sp-vibe-actions",children:[e.jsx(H.a,{href:"#celebrities",className:"sp-btn-ember",whileHover:{scale:1.04},whileTap:{scale:.97},children:"Explore Lineup →"}),e.jsx(H.div,{whileHover:{scale:1.04},whileTap:{scale:.97},children:e.jsx(q,{to:"/tickets",className:"sp-btn-ghost",children:"Book Festival Passes"})})]})]}),e.jsx("div",{className:"sp-vibe-tags-grid",style:{position:"relative",zIndex:2},children:[{text:"4 Mega Music Stages",isMain:!0,icon:"⚡"},{text:"100kW Laser & Sound",isMain:!0,icon:"🔊"},{text:"20+ Star Performers",isMain:!0,icon:"👑"},{text:"Verified QR Instant Passes",isMain:!0,icon:"🎟️"},{text:"10,000+ Music Lovers",isMain:!1,icon:"👥"},{text:"50+ Food & Beats Stalls",isMain:!1,icon:"🍔"},{text:"VIP Artist Lounge & Deck",isMain:!1,icon:"✨"},{text:"Exclusive Partner Discounts",isMain:!1,icon:"🏷️"}].map((a,r)=>e.jsxs(H.div,{className:`sp-vibe-tag ${a.isMain?"sp-vibe-main":"sp-vibe-secondary"}`,initial:{opacity:0,scale:.9},whileInView:{opacity:1,scale:1},viewport:{once:!0},transition:{duration:.35,delay:r*.05},whileHover:{scale:1.03,x:3},whileTap:{scale:.98},children:[e.jsx("span",{className:"sp-vibe-tag-icon",children:a.icon}),e.jsx("span",{className:"sp-vibe-tag-text",children:a.text}),a.isMain&&e.jsx("span",{className:"sp-vibe-tag-dot"})]},a.text))})]})]})}),e.jsx("section",{id:"events",className:"sp-section sp-section-events","aria-label":"Past Events",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"Previous Editions"}),e.jsx("h2",{className:"sp-section-title",children:"Past Festival Milestones"}),e.jsx("p",{className:"sp-section-subtitle",children:"A legacy of sold-out stadium energy, breakthrough artist sets, and unforgettable Lahore nights."})]}),e.jsx("div",{className:"sp-events-grid",children:qs.map((a,r)=>e.jsxs(H.div,{className:"sp-glass-card sp-past-event-card",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:r*.12},whileHover:{y:-6},children:[e.jsx(Xe,{color:"#ff8a3d",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column",height:"100%"},children:[e.jsxs("div",{className:"sp-card-header",children:[e.jsx("h3",{children:a.name}),e.jsx("span",{className:"sp-pill-badge",children:a.status})]}),e.jsx("p",{className:"sp-card-desc",children:a.detail}),e.jsxs("div",{className:"sp-card-footer-eq",children:[e.jsx("span",{children:"LIVE ARCHIVE"}),e.jsxs("div",{className:"celeb-mini-eq",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})]})]},a.name))})]})}),e.jsx("section",{id:"future-events",className:"sp-section sp-section-future","aria-label":"Upcoming Events",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"Upcoming Concert Tour"}),e.jsx("h2",{className:"sp-section-title",children:"Future Festival Editions"}),e.jsx("p",{className:"sp-section-subtitle",children:"Mark your calendar for upcoming major festival editions, celebrity concert nights, and arena dates."})]}),e.jsx("div",{className:"sp-future-grid",children:Ys.map((a,r)=>e.jsxs(H.div,{className:"sp-glass-card sp-future-card",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:r*.12},whileHover:{y:-6},children:[e.jsx(Xe,{color:"#ff9e42",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column",height:"100%"},children:[e.jsx("span",{className:"sp-pill-badge",children:a.status}),e.jsx("h3",{style:{marginTop:"0.8rem"},children:a.name}),e.jsxs("p",{className:"sp-meta-text",children:["📍 ",a.date," · ",a.location]}),e.jsx("p",{className:"sp-card-desc",style:{flex:1},children:a.description}),e.jsx(q,{to:"/tickets",className:"sp-accent-link",children:"Get Tickets →"})]})]},a.name))})]})}),e.jsx("section",{id:"history",className:"sp-section sp-section-history","aria-label":"Festival History",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header sp-timeline-banner-header",style:{position:"relative",overflow:"hidden"},children:[e.jsx(Xe,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"Festival Legacy"}),e.jsx("h2",{className:"sp-section-title",children:"Our Editions & Timeline"}),e.jsx("p",{className:"sp-section-subtitle",children:"From our underground debut to Pakistan's biggest stadium concert experience."})]})]}),e.jsx("div",{className:"sp-timeline",children:Xs.map((a,r)=>e.jsxs(H.div,{className:"sp-timeline-item",initial:{opacity:0,x:-28,y:20},whileInView:{opacity:1,x:0,y:0},viewport:{once:!0,margin:"-40px"},transition:{duration:.45,delay:r*.08},children:[e.jsxs("div",{className:"sp-timeline-node-wrap",children:[e.jsx("div",{className:"sp-timeline-icon",children:e.jsx("span",{className:"sp-timeline-year-pill",children:a.year})}),e.jsx("div",{className:"sp-timeline-pulse-ring"})]}),e.jsxs("div",{className:"sp-glass-card sp-timeline-content",children:[e.jsxs("div",{className:"sp-timeline-top-row",children:[e.jsx("div",{className:"sp-meta-text",children:e.jsx("span",{className:"sp-year-highlight",children:a.date})}),e.jsx("span",{className:"sp-timeline-badge",children:a.badge})]}),e.jsx("h3",{className:"sp-timeline-heading",children:a.name}),e.jsx("p",{className:"sp-card-desc",children:a.description}),e.jsx("div",{className:"sp-tag-cloud",children:a.highlights.map(i=>e.jsx("span",{className:"sp-tag sp-timeline-tag",children:i},i))}),e.jsxs("div",{className:"sp-timeline-footer",children:[e.jsx("p",{className:"sp-venue-text",children:a.venue}),e.jsxs("div",{className:"celeb-mini-eq",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})]})]},a.name))})]})}),e.jsx("section",{id:"facilities",className:"sp-section sp-section-facilities","aria-label":"Facilities",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header sp-facilities-header-banner",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx(Xe,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"⚡ FESTIVAL VENUE & PRODUCTION"}),e.jsx("h2",{className:"sp-section-title",children:"World-Class Festival Facilities"}),e.jsx("p",{className:"sp-section-subtitle",children:"Built for a seamless 10,000+ attendee experience with concert-grade sound, medical support, VIP hospitality, and creator amenities."})]})]}),e.jsx("div",{className:"sp-facilities-grid",children:Zs.map((a,r)=>e.jsxs(H.div,{className:"sp-glass-card sp-facility-card",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.45,delay:r*.07},whileHover:{y:-8,scale:1.02},children:[e.jsx(Xe,{color:a.accent||"#ff8a3d",rounded:20,thickness:2.2,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,width:"100%"},children:[e.jsx("div",{className:"sp-facility-top",children:e.jsx("span",{className:"sp-facility-badge",style:{color:a.accent,borderColor:`${a.accent}44`,background:`${a.accent}14`},children:a.badge})}),e.jsx("h3",{className:"sp-facility-title",children:a.title}),e.jsx("p",{className:"sp-card-desc",children:a.desc})]}),e.jsx("div",{className:"sp-facility-glow-bar",style:{background:`linear-gradient(90deg, ${a.accent}, transparent)`}})]},a.title))})]})}),e.jsx("section",{id:"sponsorship",className:"sp-section sp-section-sponsorship","aria-label":"Sponsorships",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header sp-sponsorship-header-banner",style:{position:"relative",overflow:"hidden",textAlign:"center"},initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx(Xe,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"BRAND COLLABORATIONS"}),e.jsx("h2",{className:"sp-section-title",children:"Sponsorship & Brand Packages"}),e.jsx("p",{className:"sp-section-subtitle",style:{margin:"0 auto"},children:"Partner with Pakistan's biggest live music festival. Gain unparalleled on-ground brand presence, digital engagement, and VIP hospitality."})]})]}),e.jsx("div",{className:"sp-sponsorship-grid",children:Ks.map((a,r)=>e.jsxs(H.div,{className:`sp-glass-card sp-sponsor-card ${a.isFeatured?"sp-sponsor-featured":""}`,initial:{opacity:0,y:35},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.45,delay:r*.1},whileHover:{y:-10,scale:1.02},children:[a.isFeatured&&e.jsx("div",{className:"sp-sponsor-popular-tag",children:"MOST PRESTIGIOUS TIER"}),e.jsx("div",{className:"sp-sponsor-top",children:e.jsx("span",{className:"sp-sponsor-badge",style:{color:a.accent,borderColor:`${a.accent}44`,background:`${a.accent}14`},children:a.badge})}),e.jsxs("div",{className:"sp-sponsor-header",children:[e.jsx("h3",{children:a.tier}),e.jsx("div",{className:"sp-sponsor-price-tag",style:{color:a.accent},children:a.price}),e.jsx("p",{className:"sp-sponsor-tagline",children:a.tagline})]}),e.jsx("div",{className:"sp-sponsor-divider"}),e.jsx("ul",{className:"sp-sponsor-perks",children:a.perks.map(i=>e.jsxs("li",{children:[e.jsx("span",{className:"sp-check",style:{color:a.accent},children:"✓"}),e.jsx("span",{children:i})]},i))}),e.jsx(H.div,{whileHover:{scale:1.04},whileTap:{scale:.96},style:{marginTop:"auto",paddingTop:"1.2rem"},children:e.jsx(q,{to:"/tickets",className:a.isFeatured?"sp-btn-ember w-full":"sp-btn-ghost w-full",style:{textAlign:"center"},children:a.ctaText})}),e.jsx("div",{className:"sp-sponsor-glow-bottom",style:{background:`linear-gradient(90deg, ${a.accent}, transparent)`}})]},a.tier))})]})}),e.jsx("style",{children:`
        .sp-main {
          --pink-accent:   #EC4899;
          --ember-accent:  #ff5a1f;
          --ember-glow:    #ff8a3d;
      ...
      `})]})}function Pe(t){return m.lazy(async()=>{try{return await t()}catch(s){if(/Failed to fetch dynamically imported module/i.test(s?.message)||/Loading chunk/i.test(s?.message)||/Failed to load module script/i.test(s?.message)){const r=Number(sessionStorage.getItem("chunk_reload_ts")||0);if(Date.now()-r>1e4)return sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload(),new Promise(()=>{})}throw s}})}const tr=Pe(()=>Ee(()=>import("./UserDashboardPage-BBERp-Rv.js"),__vite__mapDeps([0,1,2,3,4,5,6,7]))),ar=Pe(()=>Ee(()=>import("./TicketPortalPage-DlbRS4Ni.js"),__vite__mapDeps([8,1,2,3,4,9,7]))),sr=Pe(()=>Ee(()=>import("./MyTicketsPage-BsobgFOg.js"),__vite__mapDeps([10,1,2,3,4,11,6,7]))),rr=Pe(()=>Ee(()=>import("./TicketViewPage-DcXBkfHH.js"),__vite__mapDeps([12,1,2,3,4,11,6,7,9]))),ir=Pe(()=>Ee(()=>import("./TicketVerificationPage-MkliexL6.js"),__vite__mapDeps([13,1,2,4,9,7]))),nr=Pe(()=>Ee(()=>import("./AdminDashboardPage-D4ME6g8L.js"),__vite__mapDeps([14,1,2,5,9,7]))),or=Pe(()=>Ee(()=>import("./AdminTicketReviewPage-fobcFNAo.js"),__vite__mapDeps([15,1,2,4,9,5,7]))),lr=Pe(()=>Ee(()=>import("./HotelsPage-TGuxxWJg.js"),__vite__mapDeps([16,1,2,7]))),Zt=Pe(()=>Ee(()=>import("./FestivalSchedulePage-2Cng7Uio.js"),__vite__mapDeps([17,1,2]))),Jt=Pe(()=>Ee(()=>import("./LegalPage-Cp5apOjn.js"),__vite__mapDeps([18,1,2]))),cr=Pe(()=>Ee(()=>import("./NotFound-12U-ahfn.js"),__vite__mapDeps([19,1,2])));function dr(){return e.jsx(m.Suspense,{fallback:e.jsx(Ha,{}),children:e.jsxs(xa,{children:[e.jsxs(B,{element:e.jsx(Ra,{}),children:[e.jsx(B,{path:"/login",element:e.jsx(jt,{children:e.jsx(Xa,{})})}),e.jsx(B,{path:"/register",element:e.jsx(jt,{children:e.jsx(ts,{})})}),e.jsx(B,{path:"/auth/google/callback",element:e.jsx(jt,{children:e.jsx(as,{})})})]}),e.jsx(B,{path:"/",element:e.jsx(Le,{children:e.jsx(er,{})})}),e.jsx(B,{path:"/dashboard",element:e.jsx(ue,{to:"/",replace:!0})}),e.jsx(B,{path:"/about",element:e.jsx(ue,{to:"/#about",replace:!0})}),e.jsx(B,{path:"/collaboration",element:e.jsx(ue,{to:"/#sponsorship",replace:!0})}),e.jsx(B,{path:"/prismfest",element:e.jsx(ue,{to:"/#home",replace:!0})}),e.jsx(B,{path:"/prismfest/celebrities",element:e.jsx(ue,{to:"/#celebrities",replace:!0})}),e.jsx(B,{path:"/prismfest/events",element:e.jsx(ue,{to:"/#events",replace:!0})}),e.jsx(B,{path:"/prismfest/future",element:e.jsx(ue,{to:"/#future-events",replace:!0})}),e.jsx(B,{path:"/history",element:e.jsx(ue,{to:"/#history",replace:!0})}),e.jsx(B,{path:"/events",element:e.jsx(ue,{to:"/#events",replace:!0})}),e.jsx(B,{path:"/sponsorship",element:e.jsx(ue,{to:"/#sponsorship",replace:!0})}),e.jsx(B,{path:"/contact",element:e.jsx(ue,{to:"/#contact",replace:!0})}),e.jsx(B,{path:"/facilities",element:e.jsx(ue,{to:"/#facilities",replace:!0})}),e.jsx(B,{path:"/hotels",element:e.jsx(Le,{children:e.jsx(lr,{})})}),e.jsx(B,{path:"/schedule",element:e.jsx(Le,{children:e.jsx(Zt,{})})}),e.jsx(B,{path:"/lineup",element:e.jsx(Le,{children:e.jsx(Zt,{})})}),e.jsx(B,{path:"/restaurants",element:e.jsx(ue,{to:"/#restaurants",replace:!0})}),e.jsx(B,{path:"/discounts",element:e.jsx(ue,{to:"/#discounts",replace:!0})}),e.jsx(B,{path:"/partner",element:e.jsx(ue,{to:"/#about",replace:!0})}),e.jsx(B,{path:"/privacy",element:e.jsx(Le,{children:e.jsx(Jt,{type:"privacy"})})}),e.jsx(B,{path:"/terms",element:e.jsx(Le,{children:e.jsx(Jt,{type:"terms"})})}),e.jsx(B,{path:"/verification/:ticketId",element:e.jsx(Le,{children:e.jsx(ir,{})})}),e.jsx(B,{path:"/tickets",element:e.jsx(kt,{children:e.jsx(ar,{})})}),e.jsxs(B,{element:e.jsx(Pa,{}),children:[e.jsx(B,{path:"/account",element:e.jsx(Le,{children:e.jsx(tr,{})})}),e.jsx(B,{path:"/admin",element:e.jsx(ue,{to:"/admin/dashboard",replace:!0})}),e.jsx(B,{path:"/admin/dashboard",element:e.jsx(Le,{children:e.jsx(nr,{})})}),e.jsx(B,{path:"/tickets/my-tickets",element:e.jsx(kt,{children:e.jsx(sr,{})})}),e.jsx(B,{path:"/tickets/view/:ticketId",element:e.jsx(kt,{children:e.jsx(rr,{})})}),e.jsx(B,{path:"/admin/tickets",element:e.jsx(Le,{children:e.jsx(or,{})})})]}),e.jsx(B,{path:"*",element:e.jsx(cr,{})})]})})}const pr=2,Ue=8e3,Ve=20,mr=`
precision highp float;
...
`;function Qt(t,s,a){const r=t.createShader(s);return r?(t.shaderSource(r,a),t.compileShader(r),t.getShaderParameter(r,t.COMPILE_STATUS)?r:(console.error("ParticleDrift shader:",t.getShaderInfoLog(r)),t.deleteShader(r),null)):null}function ea(t,s,a){const r=Qt(t,t.VERTEX_SHADER,s),i=Qt(t,t.FRAGMENT_SHADER,a);if(!r||!i)return null;const l=t.createProgram();return l?(t.attachShader(l,r),t.attachShader(l,i),t.linkProgram(l),t.getProgramParameter(l,t.LINK_STATUS)?l:(console.error("ParticleDrift link:",t.getProgramInfoLog(l)),null)):null}function ta(t,s){if(!t)return s;const a=String(t).trim();if(a.charAt(0)==="#"){let i=a.slice(1);if((i.length===3||i.length===4)&&(i=i[0]+i[0]+i[1]+i[1]+i[2]+i[2]),i.length>=6){const l=parseInt(i.slice(0,2),16),d=parseInt(i.slice(2,4),16),o=parseInt(i.slice(4,6),16);if(!isNaN(l)&&!isNaN(d)&&!isNaN(o))return[l/255,d/255,o/255]}return s}const r=a.match(/[\d.]+/g);return r&&r.length>=3?[Math.min(255,parseFloat(r[0]))/255,Math.min(255,parseFloat(r[1]))/255,Math.min(255,parseFloat(r[2]))/255]:s}function Ce(t,s){return typeof t=="number"&&isFinite(t)?t:s}function Ke(t,s,a){return t<s?s:t>a?a:t}function gr(t){let s=t>>>0;return function(){s+=1831565813;let a=s;return a=Math.imul(a^a>>>15,a|1),a^=a+Math.imul(a^a>>>7,a|61),((a^a>>>14)>>>0)/4294967296}}const At=[[0,-1],[1,-1],[1,1],[0,-1],[1,1],[0,1]];function xr({style:t,background:s="transparent",baseColor:a="#F84400",accentColor:r="#ECECEC",density:i=235,dotSize:l=14,speed:d=100,direction:o=0,hover:p=200,linkDistance:h=202,linkThickness:x=2.5,width:j,height:N,isFixed:C=!0}){const te=m.useRef(null),w=m.useRef(null),D=m.useRef({w:0,h:0});D.current={w:Ce(j,0),h:Ce(N,0)};const I=m.useRef({x:-1e4,y:-1e4}),$=m.useRef({});$.current={base:a,accent:r,density:Math.round(Ke(Ce(i,90),10,400)),dotSize:Ke(Ce(l,5),1,24),speed:Ke(Ce(d,50),0,100)/50,direction:Ke(Ce(o,0),0,360),hover:Ke(Ce(p,100),0,200)/100,linkDistance:Ke(Ce(h,120),0,400),linkThickness:Ke(Ce(x,1),.5,8)},m.useEffect(()=>{const R=w.current;if(!R)return;const n=R.getContext("webgl",{alpha:!0,antialias:!1,depth:!1,premultipliedAlpha:!0});if(!n){console.error("ParticleDrift: WebGL unavailable");return}const W=ea(n,mr,ur),A=ea(n,fr,hr);if(!W||!A)return;const y=new Map,c=(Q,T)=>{const g=(Q===W?"L:":"D:")+T;return y.has(g)||y.set(g,n.getUniformLocation(Q,T)),y.get(g)},f=new Float32Array(Ue*6*2),E=new Float32Array(Ue*6*2),M=new Float32Array(Ue*6*2),X=new Float32Array(Ue*6*3);for(let Q=0;Q<Ue;Q++)for(let T=0;T<6;T++){const g=(Q*6+T)*2;M[g]=At[T][0],M[g+1]=At[T][1]}const _=n.createBuffer(),se=n.createBuffer(),K=n.createBuffer(),ae=n.createBuffer();n.bindBuffer(n.ARRAY_BUFFER,_),n.bufferData(n.ARRAY_BUFFER,f.byteLength,n.DYNAMIC_DRAW),n.bindBuffer(n.ARRAY_BUFFER,se),n.bufferData(n.ARRAY_BUFFER,E.byteLength,n.DYNAMIC_DRAW),n.bindBuffer(n.ARRAY_BUFFER,K),n.bufferData(n.ARRAY_BUFFER,M,n.STATIC_DRAW),n.bindBuffer(n.ARRAY_BUFFER,ae),n.bufferData(n.ARRAY_BUFFER,X.byteLength,n.DYNAMIC_DRAW);const oe=gr(20260824);let U=0,F=new Float32Array(0),z=new Float32Array(0),ce=new Float32Array(0),u=new Float32Array(0),k=new Float32Array(0);const S=n.createBuffer(),v=n.createBuffer(),P=(Q,T,g)=>{U=Q,F=new Float32Array(Q),z=new Float32Array(Q),ce=new Float32Array(Q),u=new Float32Array(Q*2),k=new Float32Array(Q);for(let b=0;b<Q;b++)F[b]=oe()*T,z[b]=oe()*g,ce[b]=(oe()*.4+.1)*60;n.bindBuffer(n.ARRAY_BUFFER,S),n.bufferData(n.ARRAY_BUFFER,u.byteLength,n.DYNAMIC_DRAW),n.bindBuffer(n.ARRAY_BUFFER,v),n.bufferData(n.ARRAY_BUFFER,k.byteLength,n.DYNAMIC_DRAW)};let Z=0,V=performance.now(),le=-1,J=0,re=0;const de=Q=>{if(Z=requestAnimationFrame(de),typeof document<"u"&&document.hidden){V=Q;return}const T=Math.min(.05,(Q-V)/1e3);V=Q;const g=$.current,b=g.speed,ie=Math.min(window.devicePixelRatio||1,pr),Y=D.current.w||R.clientWidth||window.innerWidth||1200,ee=D.current.h||R.clientHeight||window.innerHeight||800,Se=Math.max(1,Math.round(Y*ie)),ke=Math.max(1,Math.round(ee*ie));(R.width!==Se||R.height!==ke)&&(R.width=Se,R.height=ke),n.viewport(0,0,Se,ke);const xe=Y<768,We=Y>=768&&Y<1024;let Me=g.density,Re=g.linkDistance,st=g.dotSize;if(xe?(Me=Math.max(60,Math.min(Math.round(g.density*.38),90)),Re=Math.min(g.linkDistance,135),st=Math.min(g.dotSize,8.5)):We&&(Me=Math.max(90,Math.min(Math.round(g.density*.6),145)),Re=Math.min(g.linkDistance,165),st=Math.min(g.dotSize,11)),Me!==le&&(P(Me,Y,ee),le=Me),Y!==J||ee!==re){const L=Y/Math.max(J||Y,1),ne=ee/Math.max(re||ee,1);for(let me=0;me<U;me++)F[me]*=L,z[me]*=ne;J=Y,re=ee}const Ye=I.current,rt=g.hover,it=(xe?100:180)*(rt>0?1:0),ye=Re,nt=xe?Math.min(g.linkThickness,1.6):g.linkThickness,pt=g.direction*Math.PI/180,mt=Math.sin(pt),bt=Math.cos(pt);let Te=0;const ut=(L,ne,me,we,he,Ae,De,Je)=>{if(!(Te>=Ue)){for(let Ie=0;Ie<6;Ie++){const Qe=(Te*6+Ie)*2,vt=(Te*6+Ie)*3;f[Qe]=L,f[Qe+1]=ne,E[Qe]=me,E[Qe+1]=we,X[vt]=At[Ie][0]===0?he:Ae,X[vt+1]=De,X[vt+2]=Je}Te++}};for(let L=0;L<U;L++){F[L]+=ce[L]*mt*T*b,z[L]+=ce[L]*bt*T*b,F[L]<-Ve?(F[L]=Y+Ve,z[L]=oe()*ee):F[L]>Y+Ve&&(F[L]=-Ve,z[L]=oe()*ee),z[L]<-Ve?(z[L]=ee+Ve,F[L]=oe()*Y):z[L]>ee+Ve&&(z[L]=-Ve,F[L]=oe()*Y);const ne=Ye.x-F[L],me=Ye.y-z[L],we=Math.sqrt(ne*ne+me*me),he=it>0&&we<it?1:0;if(he===1){const Ae=.5*(1-we/it)*rt;ut(F[L],z[L],Ye.x,Ye.y,Ae,Ae,1,nt)}u[L*2]=F[L],u[L*2+1]=z[L],k[L]=he}if(ye>0){const L=ye*ye;for(let ne=0;ne<U&&Te<Ue;ne++){const me=F[ne],we=z[ne];for(let he=ne+1;he<U&&Te<Ue;he++){const Ae=me-F[he];if(Ae>ye||Ae<-ye)continue;const De=we-z[he];if(De>ye||De<-ye)continue;const Je=Ae*Ae+De*De;if(Je>=L)continue;const Ie=.15*(1-Math.sqrt(Je)/ye);ut(me,we,F[he],z[he],Ie,Ie,0,nt)}}}n.clearColor(0,0,0,0),n.clear(n.COLOR_BUFFER_BIT),n.disable(n.DEPTH_TEST),n.enable(n.BLEND),n.blendFunc(n.ONE,n.ONE_MINUS_SRC_ALPHA);const ze=ta(g.base,[.973,.267,0]),Oe=ta(g.accent,[.925,.925,.925]);if(Te>0){n.useProgram(W);const L=Te*6;n.bindBuffer(n.ARRAY_BUFFER,_),n.bufferSubData(n.ARRAY_BUFFER,0,f.subarray(0,L*2));const ne=n.getAttribLocation(W,"a_p0");n.enableVertexAttribArray(ne),n.vertexAttribPointer(ne,2,n.FLOAT,!1,0,0),n.bindBuffer(n.ARRAY_BUFFER,se),n.bufferSubData(n.ARRAY_BUFFER,0,E.subarray(0,L*2));const me=n.getAttribLocation(W,"a_p1");n.enableVertexAttribArray(me),n.vertexAttribPointer(me,2,n.FLOAT,!1,0,0),n.bindBuffer(n.ARRAY_BUFFER,K);const we=n.getAttribLocation(W,"a_corner");n.enableVertexAttribArray(we),n.vertexAttribPointer(we,2,n.FLOAT,!1,0,0),n.bindBuffer(n.ARRAY_BUFFER,ae),n.bufferSubData(n.ARRAY_BUFFER,0,X.subarray(0,L*3));const he=n.getAttribLocation(W,"a_shade");n.enableVertexAttribArray(he),n.vertexAttribPointer(he,3,n.FLOAT,!1,0,0),n.uniform2f(c(W,"uSize"),Y,ee),n.uniform3f(c(W,"uBase"),ze[0],ze[1],ze[2]),n.uniform3f(c(W,"uAccent"),Oe[0],Oe[1],Oe[2]),n.drawArrays(n.TRIANGLES,0,L),n.disableVertexAttribArray(ne),n.disableVertexAttribArray(me),n.disableVertexAttribArray(we),n.disableVertexAttribArray(he)}if(U>0){n.useProgram(A),n.bindBuffer(n.ARRAY_BUFFER,S),n.bufferSubData(n.ARRAY_BUFFER,0,u);const L=n.getAttribLocation(A,"a_pos");n.enableVertexAttribArray(L),n.vertexAttribPointer(L,2,n.FLOAT,!1,0,0),n.bindBuffer(n.ARRAY_BUFFER,v),n.bufferSubData(n.ARRAY_BUFFER,0,k);const ne=n.getAttribLocation(A,"a_lit");n.enableVertexAttribArray(ne),n.vertexAttribPointer(ne,1,n.FLOAT,!1,0,0),n.uniform2f(c(A,"uSize"),Y,ee),n.uniform1f(c(A,"uDpr"),ie),n.uniform1f(c(A,"uDot"),st),n.uniform1f(c(A,"uRestAlpha"),.4),n.uniform3f(c(A,"uBase"),ze[0],ze[1],ze[2]),n.uniform3f(c(A,"uAccent"),Oe[0],Oe[1],Oe[2]),n.drawArrays(n.POINTS,0,U),n.disableVertexAttribArray(L),n.disableVertexAttribArray(ne)}},fe=Q=>{const T=R.getBoundingClientRect();if(T.width<=0||T.height<=0)return;const g=D.current.w||R.clientWidth||window.innerWidth||1200,b=D.current.h||R.clientHeight||window.innerHeight||800;I.current.x=(Q.clientX-T.left)/T.width*g,I.current.y=(Q.clientY-T.top)/T.height*b},pe=()=>{I.current.x=-1e4,I.current.y=-1e4};return window.addEventListener("pointermove",fe,{passive:!0}),window.addEventListener("pointerleave",pe,{passive:!0}),Z=requestAnimationFrame(de),()=>{cancelAnimationFrame(Z),window.removeEventListener("pointermove",fe),window.removeEventListener("pointerleave",pe),n.deleteBuffer(_),n.deleteBuffer(se),n.deleteBuffer(K),n.deleteBuffer(ae),n.deleteBuffer(S),n.deleteBuffer(v),n.deleteProgram(W),n.deleteProgram(A)}},[]);const O=C?{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:0,pointerEvents:"none",overflow:"hidden",background:s,isolation:"isolate",...t}:{position:"relative",overflow:"hidden",background:s,isolation:"isolate",width:typeof j=="number"&&j>0?j:"100%",height:typeof N=="number"&&N>0?N:"100%",...t};return e.jsx("div",{ref:te,style:O,"aria-hidden":"true",children:e.jsx("canvas",{ref:w,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}})})}function br(){const t="/ozillafest/".replace(/\/$/,"");return e.jsx(ba,{basename:t||void 0,future:{v7_startTransition:!0,v7_relativeSplatPath:!0},children:e.jsxs(Sa,{children:[e.jsx(xr,{}),e.jsx(dr,{})]})})}class vr extends m.Component{constructor(a){super(a);Rt(this,"handleReload",()=>{sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload()});this.state={error:null}}static getDerivedStateFromError(a){return{error:a}}componentDidCatch(a,r){if(console.error("Application render failed:",a,r),/Failed to fetch dynamically imported module/i.test(a?.message)||/Loading chunk/i.test(a?.message)||/Failed to load module script/i.test(a?.message)){const l=Number(sessionStorage.getItem("chunk_reload_ts")||0);Date.now()-l>1e4&&(sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload())}}render(){if(this.state.error){const a=/Failed to fetch dynamically imported module/i.test(this.state.error?.message)||/Loading chunk/i.test(this.state.error?.message);return e.jsxs("main",{style:{padding:"32px",fontFamily:"Arial, sans-serif",maxWidth:"600px",margin:"40px auto",textAlign:"center"},children:[e.jsx("h1",{style:{color:"#7c2d12",marginBottom:"12px"},children:a?"New Update Available":"OZILLA FEST could not render"}),e.jsx("p",{style:{color:"#444",marginBottom:"16px"},children:a?"A new version of the website was published. Please refresh to load the latest version.":"Check the browser console for the full error details."}),e.jsx("button",{type:"button",onClick:this.handleReload,style:{padding:"10px 20px",backgroundColor:"#ea580c",color:"#fff",border:"none",borderRadius:"6px",cursor:"pointer",fontWeight:"bold",marginBottom:"16px"},children:"Refresh Page"}),!a&&e.jsx("pre",{style:{whiteSpace:"pre-wrap",background:"#fff7ed",border:"1px solid #fed7aa",padding:"16px",borderRadius:"6px",color:"#7c2d12",textAlign:"left"},children:this.state.error.message})]})}return this.props.children}}Et.createRoot(document.getElementById("root")).render(e.jsx(lt.StrictMode,{children:e.jsx(vr,{children:e.jsx(ja,{clientId:"placeholder-client-id",children:e.jsx(br,{})})})}));export{Ha as L,Ia as P,ve as a,G as b,Nr as o,je as t,at as u};
