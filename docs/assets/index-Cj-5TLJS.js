...
`;function Oe({children:t}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-transparent text-white overflow-x-hidden w-full relative z-[1]",children:[e.jsx(Ca,{}),e.jsx("div",{className:"flex-1 w-full overflow-x-hidden bg-transparent",children:t||e.jsx(ut,{})}),e.jsx(La,{})]})}function It({children:t}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-transparent text-white overflow-x-hidden w-full font-['Plus_Jakarta_Sans',sans-serif] dock-app-shell relative z-[1]",children:[e.jsx(Ca,{}),e.jsx("main",{className:"flex-1 px-4 sm:px-6 py-6 md:py-10 app-main app-content dock-app-content bg-transparent",children:e.jsx("div",{className:"w-full max-w-[1280px] mx-auto",children:t||e.jsx(ut,{})})}),e.jsx(La,{})]})}function Ia(){return e.jsx("div",{className:"flex items-center justify-center min-h-[200px]",children:e.jsx("div",{className:"animate-spin rounded-full h-16 w-16 border-4 border-purple-600 border-t-transparent"})})}let vt;function ur(){return window.google?.accounts?.id||window.google?.accounts?.oauth2?Promise.resolve(window.google):vt||(vt=new Promise((t,a)=>{const r=document.querySelector('script[data-google-identity="true"]');if(r){r.addEventListener("load",()=>t(window.google),{once:!0}),r.addEventListener("error",()=>a(new Error("Failed to load Google Identity script")),{once:!0});return}const s=document.createElement("script");s.src="https://accounts.google.com/gsi/client",s.async=!0,s.defer=!0,s.dataset.googleIdentity="true",s.onload=()=>t(window.google),s.onerror=()=>a(new Error("Failed to load Google Identity script")),document.head.appendChild(s)}),vt)}async function hr(t){const a=await fetch("https://www.googleapis.com/oauth2/v3/userinfo",{headers:{Authorization:`Bearer ${t}`}});if(!a.ok)throw new Error("Failed to fetch Google profile");return a.json()}async function Ra({clientId:t,onProfile:a,onError:r}){if(t.includes("placeholder")||t.includes("your_google"))throw new Error("Google Client ID is not configured. Please add GOOGLE_CLIENT_ID in Render or VITE_GOOGLE_CLIENT_ID in client/.env");if(await ur(),!window.google?.accounts?.oauth2?.initTokenClient)throw new Error("Google Identity Services library is unavailable");return new Promise((s,i)=>{window.google.accounts.oauth2.initTokenClient({client_id:t,scope:"openid email profile",prompt:"select_account",callback:async n=>{try{if(n?.error)throw n.error==="popup_closed_by_user"?new Error("Google sign-in was cancelled"):new Error(n.error_description||n.error||"Google login failed");if(!n?.access_token)throw new Error("Google sign-in was cancelled");const o=await hr(n.access_token);if(!o?.email)throw new Error("Could not retrieve email from selected Google account");a&&await a(o,n.access_token),s(o)}catch(o){r&&r(o),i(o)}},error_callback:n=>{const o=new Error(n?.message||"Google account chooser popup failed");r&&r(o),i(o)}}).requestAccessToken({prompt:"select_account"})})}function xr(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m4 7 8 6 8-6"})]})}function br(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"4",y:"10",width:"16",height:"11",rx:"2"}),e.jsx("path",{d:"M8 10V7a4 4 0 0 1 8 0v3"})]})}function yr({hidden:t=!1,...a}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...a,children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"}),t&&e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}function vr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M5 12h14M13 6l6 6-6 6"})})}function wr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"m5 12 4 4L19 6"})})}function kr(t){return e.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",...t,children:[e.jsx("path",{fill:"#4285F4",d:"M21.6 12.23c0-.71-.06-1.4-.18-2.06H12v3.9h5.38a4.6 4.6 0 0 1-2 3.01v2.53h3.23c1.9-1.75 2.99-4.32 2.99-7.38Z"}),e.jsx("path",{fill:"#34A853",d:"M12 22c2.7 0 4.97-.9 6.62-2.39l-3.23-2.53c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.61-4.13H3.05v2.61A10 10 0 0 0 12 22Z"}),e.jsx("path",{fill:"#FBBC05",d:"M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.3.31-1.91V7.48H3.05A10 10 0 0 0 2 12c0 1.61.39 3.14 1.05 4.52l3.34-2.61Z"}),e.jsx("path",{fill:"#EA4335",d:"M12 5.96c1.47 0 2.79.51 3.82 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.95 5.48l3.34 2.61C7.18 7.72 9.39 5.96 12 5.96Z"})]})}function jr(){const t=ct(),a=Ke(),{login:r,checkAuth:s}=Je(),i="231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com",l=new URLSearchParams(a.search).get("returnTo"),n=St(l,"/dashboard"),[o,c]=m.useState({email:"",password:""}),[g,u]=m.useState(null),[y,k]=m.useState(!1),[E,v]=m.useState(!0),[p,b]=m.useState(""),[x,R]=m.useState(""),[A,f]=m.useState(!1),[d,F]=m.useState(!1),_=P=>{R(""),c(T=>({...T,[P.target.name]:P.target.value}))},N=async P=>{if(P.preventDefault(),!(A||d)){b(""),R(""),f(!0);try{await r({email:String(o.email||"").trim().toLowerCase(),password:String(o.password||"")}),R("Login successful. Preparing your festival workspace..."),await new Promise(T=>setTimeout(T,450)),t(n)}catch(T){b(T.response?.data?.message||T.message||"Invalid email or password")}finally{f(!1)}}},h=async()=>{b(""),R(""),F(!0);try{await Ra({clientId:i||"231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com",onProfile:async(T,I)=>{const V=await Ze.googleAuth(I,T);Ne.setToken(V.token),await s(),R(`Google sign-in successful as ${T.email}. Redirecting...`),await new Promise(O=>setTimeout(O,450)),t(n)}})}catch(P){const T=P.response?.data?.message||P.message||"Google sign-in failed";!T.toLowerCase().includes("cancel")&&!T.toLowerCase().includes("closed")&&b(T)}finally{F(!1)}};return e.jsxs("form",{onSubmit:N,className:"kx-form",children:[p&&e.jsx("div",{className:"kx-alert kx-alert-error",role:"alert",children:p}),x&&e.jsx("div",{className:"kx-alert kx-alert-success",role:"alert",children:x}),e.jsxs("button",{type:"button",className:"kx-google",onClick:h,disabled:d||A,children:[e.jsx(kr,{}),e.jsx("span",{children:d?"Connecting to Google...":"Continue with Google"}),e.jsx("i",{"aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-divider",children:[e.jsx("span",{}),e.jsx("em",{children:"or sign in with email"}),e.jsx("span",{})]}),e.jsxs("label",{className:`kx-field ${g==="email"?"kx-focused":""}`,children:[e.jsx(xr,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"email",value:o.email,placeholder:"Email or Mobile Number",autoComplete:"username",required:!0,onChange:_,onFocus:()=>u("email"),onBlur:()=>u(null)}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("label",{className:`kx-field ${g==="password"?"kx-focused":""}`,children:[e.jsx(br,{className:"kx-field-icon"}),e.jsx("input",{type:y?"text":"password",name:"password",value:o.password,placeholder:"Password",autoComplete:"current-password",required:!0,onChange:_,onFocus:()=>u("password"),onBlur:()=>u(null)}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>k(P=>!P),"aria-label":y?"Hide password":"Show password",children:e.jsx(yr,{hidden:y})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-meta",children:[e.jsxs("label",{className:"kx-remember",children:[e.jsx("input",{type:"checkbox",checked:E,onChange:P=>v(P.target.checked)}),e.jsx("span",{className:"kx-checkbox",children:E&&e.jsx(wr,{})}),e.jsx("span",{children:"Remember me"})]}),e.jsx("a",{href:"#forgot-password",className:"kx-forgot-link",children:"Forgot password?"})]}),e.jsxs("button",{className:"kx-sign-in",type:"submit",disabled:A||d,children:[e.jsx("span",{className:"kx-button-glow","aria-hidden":"true"}),e.jsx("span",{className:"kx-button-sheen","aria-hidden":"true"}),A?e.jsx("span",{className:"kx-spinner","aria-label":"Signing in..."}):e.jsxs("span",{className:"kx-button-copy",children:["Sign in",e.jsx(vr,{})]})]}),e.jsxs("p",{className:"kx-signup",children:["Don't have an account?"," ",e.jsx(X,{to:`/register?${new URLSearchParams({returnTo:n}).toString()}`,children:"Create account"})]}),e.jsxs("div",{className:"kx-trust-grid","aria-label":"Security indicators",children:[e.jsx("span",{children:"🔒 Secure Login"}),e.jsx("span",{children:"⚡ Fast Access"}),e.jsx("span",{children:"🛡️ Protected"}),e.jsx("span",{children:"✓ Verified"})]})]})}function Nr(){return e.jsxs("div",{className:"auth-form-container",children:[e.jsx(jr,{}),e.jsxs("div",{className:"auth-footer-links",children:[e.jsx(X,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"•"}),e.jsx(X,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"•"}),e.jsx(X,{to:"/#contact",children:"Need Help?"})]})]})}function Kt(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("path",{d:"M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"}),e.jsx("circle",{cx:"12",cy:"7",r:"4"})]})}function Sr(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m4 7 8 6 8-6"})]})}function Ar(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"})})}function Jt(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"4",y:"10",width:"16",height:"11",rx:"2"}),e.jsx("path",{d:"M8 10V7a4 4 0 0 1 8 0v3"})]})}function Qt({hidden:t=!1,...a}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...a,children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"}),t&&e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}function Pr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M5 12h14M13 6l6 6-6 6"})})}function Tr(t){return e.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",...t,children:[e.jsx("path",{fill:"#4285F4",d:"M21.6 12.23c0-.71-.06-1.4-.18-2.06H12v3.9h5.38a4.6 4.6 0 0 1-2 3.01v2.53h3.23c1.9-1.75 2.99-4.32 2.99-7.38Z"}),e.jsx("path",{fill:"#34A853",d:"M12 22c2.7 0 4.97-.9 6.62-2.39l-3.23-2.53c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.61-4.13H3.05v2.61A10 10 0 0 0 12 22Z"}),e.jsx("path",{fill:"#FBBC05",d:"M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.3.31-1.91V7.48H3.05A10 10 0 0 0 2 12c0 1.61.39 3.14 1.05 4.52l3.34-2.61Z"}),e.jsx("path",{fill:"#EA4335",d:"M12 5.96c1.47 0 2.79.51 3.82 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.95 5.48l3.34 2.61C7.18 7.72 9.39 5.96 12 5.96Z"})]})}const ea=()=>new Promise(t=>setTimeout(t,450));function Er(){const t=ct(),a=Ke(),{register:r,checkAuth:s}=Je(),i="231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com",l=new URLSearchParams(a.search).get("returnTo"),n=St(l,"/dashboard"),[o,c]=m.useState({firstName:"",lastName:"",email:"",phone:"",password:"",confirmPassword:""}),[g,u]=m.useState(null),[y,k]=m.useState(""),[E,v]=m.useState(!1),[p,b]=m.useState(!1),[x,R]=m.useState(!1),[A,f]=m.useState(!1),[d,F]=m.useState(0),[_,N]=m.useState(""),[h,P]=m.useState(""),[T,I]=m.useState(!1),[V,O]=m.useState(!1),[C,B]=m.useState(!1),[q,$]=m.useState(!1),[M,D]=m.useState({email:!1,phone:!1,password:!1,confirmPassword:!1}),Y=/^\S+@\S+\.\S+$/.test(o.email),oe=/^(\+?\d{1,3})?[\s-]?\d{10,12}$/.test(o.phone.replace(/\s+/g,"")),te={upper:/[A-Z]/.test(o.password),lower:/[a-z]/.test(o.password),number:/\d/.test(o.password),special:/[^A-Za-z0-9]/.test(o.password),length:o.password.length>=8},ne=Object.values(te).filter(Boolean).length,w=ne===5,j=o.confirmPassword.length>0&&o.password===o.confirmPassword,H=o.password.length>0,J=m.useMemo(()=>H?ne<=2?{label:"Weak",className:"weak",percent:28}:ne===3?{label:"Medium",className:"medium",percent:52}:ne===4?{label:"Strong",className:"strong",percent:78}:{label:"Excellent",className:"excellent",percent:100}:{label:"Start typing",className:"empty",percent:8},[H,ne]),re=[{key:"upper",text:"Uppercase letter",met:te.upper},{key:"lower",text:"Lowercase letter",met:te.lower},{key:"number",text:"Number",met:te.number},{key:"special",text:"Special character",met:te.special},{key:"length",text:"8+ characters",met:te.length}],ae=o.firstName.trim()&&o.lastName.trim()&&Y&&oe&&w&&j&&p&&!T&&!V;m.useEffect(()=>{if(d<=0)return;const S=window.setInterval(()=>{F(L=>Math.max(0,L-1))},1e3);return()=>window.clearInterval(S)},[d]);const z=()=>{N(""),P("")},ie=S=>{const{name:L,value:Q}=S.target;z(),c(Z=>({...Z,[L]:Q})),L==="email"&&(k(""),v(!1),b(!1),F(0)),L in M&&Q.length>0&&D(Z=>({...Z,[L]:!0}))},me=S=>{const{name:L}=S.target;u(null),L in M&&D(Q=>({...Q,[L]:!0}))},Se=async()=>{if(z(),!Y){D(S=>({...S,email:!0})),N("Please enter a valid email address before sending OTP.");return}R(!0);try{const S=await Ze.sendOtp(o.email);S?.emailDelivery==="failed"||typeof S?.message=="string"&&S.message.toLowerCase().includes("delivery failed")&&!S?.devOtp?(v(!1),N(S.emailError||"Email delivery failed: SMTP credentials (SMTP_USER and SMTP_PASS) are not configured on the backend server.")):(v(!0),b(!1),F(60),S?.devOtp?k(String(S.devOtp)):k(""),P(S.message||"OTP code has been sent to your email. Please check your inbox."))}catch(S){N(S.response?.data?.message||S.message||"Unable to send OTP.")}finally{R(!1)}},ue=async()=>{if(z(),!Y||y.trim().length<4){N("Enter the OTP sent to your email.");return}f(!0);try{const S=await Ze.verifyOtp({email:o.email,otp:y});b(!0),P(S.message||"Email verified successfully.")}catch(S){b(!1),N(S.response?.data?.message||S.message||"OTP verification failed.")}finally{f(!1)}},se=async S=>{if(S.preventDefault(),z(),!Y){D(L=>({...L,email:!0})),N("Please enter a valid email address.");return}if(!p){N("Please verify your email OTP before creating your account.");return}if(!oe){D(L=>({...L,phone:!0})),N("Please enter a valid mobile number.");return}if(!w){D(L=>({...L,password:!0})),N("Please satisfy all password requirements.");return}if(!j){D(L=>({...L,confirmPassword:!0})),N("Passwords do not match.");return}I(!0);try{await r({firstName:o.firstName,lastName:o.lastName,name:`${o.firstName} ${o.lastName}`.trim(),email:o.email,phone:o.phone,password:o.password}),P("Account created successfully. Preparing your festival workspace..."),await ea(),t(n)}catch(L){const Q=L.response?.status,Z=L.response?.data?.message||"Registration failed",de=Z.toLowerCase();Q===409||de.includes("already")||de.includes("exists")?N("Account already exists with this email or phone number"):N(Z)}finally{I(!1)}},G=async()=>{z(),O(!0);try{await Ra({clientId:i||"231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com",onProfile:async(L,Q)=>{const Z=await Ze.googleAuth(Q,L);Ne.setToken(Z.token),await s(),P(`Google sign-up verified as ${L.email}. Welcome to OZILLA FEST!`),await ea(),t(n)}})}catch(S){const L=S.response?.data?.message||S.message||"Google sign-up failed";!L.toLowerCase().includes("cancel")&&!L.toLowerCase().includes("closed")&&N(L)}finally{O(!1)}};return e.jsxs("form",{onSubmit:se,className:"kx-form",children:[_&&e.jsx("div",{className:"kx-alert kx-alert-error",role:"alert",children:_}),h&&e.jsx("div",{className:"kx-alert kx-alert-success",role:"alert",children:h}),e.jsxs("button",{type:"button",className:"kx-google",onClick:G,disabled:V||T,children:[e.jsx(Tr,{}),e.jsx("span",{children:V?"Connecting to Google...":"Sign up with Google"}),e.jsx("i",{"aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-divider",children:[e.jsx("span",{}),e.jsx("em",{children:"or register with email"}),e.jsx("span",{})]}),e.jsxs("div",{className:"kx-grid-row",children:[e.jsxs("label",{className:`kx-field ${g==="firstName"?"kx-focused":""}`,children:[e.jsx(Kt,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"firstName",value:o.firstName,placeholder:"First Name",autoComplete:"given-name",required:!0,onChange:ie,onFocus:()=>u("firstName"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("label",{className:`kx-field ${g==="lastName"?"kx-focused":""}`,children:[e.jsx(Kt,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"lastName",value:o.lastName,placeholder:"Last Name",autoComplete:"family-name",required:!0,onChange:ie,onFocus:()=>u("lastName"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]})]}),e.jsxs("label",{className:`kx-field ${g==="email"?"kx-focused":""} ${M.email&&!Y?"kx-field-invalid":""}`,children:[e.jsx(Sr,{className:"kx-field-icon"}),e.jsx("input",{type:"email",name:"email",value:o.email,placeholder:"Email address",autoComplete:"email",required:!0,onChange:ie,onFocus:()=>u("email"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),M.email&&!Y&&e.jsx("p",{className:"kx-field-error-msg",children:"Please enter a valid email address."}),e.jsxs("div",{className:`kx-otp-box ${p?"kx-otp-verified":""}`,children:[e.jsxs("div",{className:"kx-otp-meta",children:[e.jsx("span",{className:"kx-otp-kicker",children:"Email Verification"}),e.jsx("strong",{children:p?"✓ Email verified":E?"Enter 6-digit code":"Verify email before submit"}),e.jsx("span",{className:"kx-otp-subtext",children:p?"Security verified":d>0?`Resend available in ${d}s`:"Code will be sent to your email"})]}),e.jsxs("div",{className:"kx-otp-controls",children:[e.jsx("button",{type:"button",className:"kx-otp-btn",onClick:Se,disabled:x||!Y||p||d>0,children:x?"Sending...":E?"Resend OTP":"Send OTP"}),e.jsx("input",{type:"text",value:y,onChange:S=>{z(),k(S.target.value.replace(/\D/g,"").slice(0,6)),b(!1)},className:"kx-otp-input",placeholder:"Enter 6-digit OTP",inputMode:"numeric",autoComplete:"one-time-code",disabled:!E||p}),e.jsx("button",{type:"button",className:"kx-otp-btn kx-otp-btn-accent",onClick:ue,disabled:!E||p||A,children:A?"Verifying...":p?"Verified":"Verify"})]})]}),e.jsxs("label",{className:`kx-field ${g==="phone"?"kx-focused":""} ${M.phone&&!oe?"kx-field-invalid":""}`,children:[e.jsx(Ar,{className:"kx-field-icon"}),e.jsx("input",{type:"tel",name:"phone",value:o.phone,placeholder:"Phone (+92 3XX XXXXXXX)",autoComplete:"tel",required:!0,onChange:ie,onFocus:()=>u("phone"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),M.phone&&!oe&&e.jsx("p",{className:"kx-field-error-msg",children:"Please enter a valid mobile number."}),e.jsxs("label",{className:`kx-field ${g==="password"?"kx-focused":""} ${M.password&&!w?"kx-field-invalid":""}`,children:[e.jsx(Jt,{className:"kx-field-icon"}),e.jsx("input",{type:C?"text":"password",name:"password",value:o.password,placeholder:"Create Password",autoComplete:"new-password",required:!0,onChange:ie,onFocus:()=>u("password"),onBlur:me}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>B(S=>!S),"aria-label":C?"Hide password":"Show password",children:e.jsx(Qt,{hidden:C})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("div",{className:`kx-strength kx-strength-${J.className}`,children:[e.jsxs("div",{className:"kx-strength-header",children:[e.jsx("span",{children:"Password Strength"}),e.jsx("strong",{children:J.label})]}),e.jsx("div",{className:"kx-strength-bar-track",children:e.jsx("span",{style:{width:`${J.percent}%`}})})]}),e.jsx("ul",{className:"kx-pwd-rules",children:re.map(S=>{const L=S.met?"kx-rule-met":H?"kx-rule-unmet":"kx-rule-neutral";return e.jsxs("li",{className:`kx-pwd-rule ${L}`,children:[e.jsx("span",{className:"kx-rule-badge",children:S.met?"✓":"•"}),e.jsx("span",{children:S.text})]},S.key)})}),e.jsxs("label",{className:`kx-field ${g==="confirmPassword"?"kx-focused":""} ${M.confirmPassword&&!j?"kx-field-invalid":""}`,children:[e.jsx(Jt,{className:"kx-field-icon"}),e.jsx("input",{type:q?"text":"password",name:"confirmPassword",value:o.confirmPassword,placeholder:"Confirm Password",autoComplete:"new-password",required:!0,onChange:ie,onFocus:()=>u("confirmPassword"),onBlur:me}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>$(S=>!S),"aria-label":q?"Hide confirm password":"Show confirm password",children:e.jsx(Qt,{hidden:q})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),M.confirmPassword&&!j&&e.jsx("p",{className:"kx-field-error-msg",children:"Passwords do not match."}),e.jsxs("button",{className:"kx-sign-in",type:"submit",disabled:!ae,children:[e.jsx("span",{className:"kx-button-glow","aria-hidden":"true"}),e.jsx("span",{className:"kx-button-sheen","aria-hidden":"true"}),T?e.jsx("span",{className:"kx-spinner","aria-label":"Creating account..."}):e.jsxs("span",{className:"kx-button-copy",children:["Create Account",e.jsx(Pr,{})]})]}),e.jsxs("p",{className:"kx-signup",children:["Already have an account?"," ",e.jsx(X,{to:`/login?${new URLSearchParams({returnTo:n}).toString()}`,children:"Sign In"})]}),e.jsxs("div",{className:"kx-trust-grid","aria-label":"Security indicators",children:[e.jsx("span",{children:"🔒 Secure Sign Up"}),e.jsx("span",{children:"⚡ Instant Access"}),e.jsx("span",{children:"🛡️ Protected"}),e.jsx("span",{children:"✓ Google Verified"})]})]})}function Cr(){return e.jsxs("div",{className:"auth-form-container",children:[e.jsx(Er,{}),e.jsxs("div",{className:"auth-footer-links",children:[e.jsx(X,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"•"}),e.jsx(X,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"•"}),e.jsx(X,{to:"/#contact",children:"Need Help?"})]})]})}function Lr(){const[t]=Wa(),a=ct(),{checkAuth:r}=Je(),[s,i]=m.useState("Signing you in with Google...");return m.useEffect(()=>{(async()=>{const n=t.get("token"),o=t.get("error"),c=t.get("returnTo"),g=St(c,"/dashboard");if(o){i(o==="google_not_configured"?"Google sign-in is not configured on server yet. Please add GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in server/.env.":"Google sign-in failed. Please try again.");const u=new URLSearchParams({returnTo:g}).toString();setTimeout(()=>a(`/login?${u}`,{replace:!0}),1200);return}if(!n){i("Google sign-in token not found. Please try again.");const u=new URLSearchParams({returnTo:g}).toString();setTimeout(()=>a(`/login?${u}`,{replace:!0}),1200);return}Ne.setToken(n),await r(),a(g,{replace:!0})})()},[r,a,t]),e.jsx("div",{className:"auth-page",children:e.jsxs("div",{className:"auth-card",children:[e.jsx("h1",{className:"auth-title",children:"Google Sign-In"}),e.jsx("p",{className:"auth-subtitle",children:s})]})})}const Ir={hotels:[{name:"Pearl Continental Hotel (PC)",location:"Lahore, Punjab, Pakistan",rates:"Premium city-center business and leisure rates",offer:"Flexible booking options with conference and dining access.",website:"https://www.expedia.com/Lahore-Hotels-Pearl-Continental-Lahore.h6062.Hotel-Information?chkin=2026-07-23&chkout=2026-07-24&x_pwa=1&rfrr=HSR&pwa_ts=1783538185568&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=2068&destination=Lahore%2C+Punjab%2C+Pakistan&destType=MARKET&neighborhoodId=553248633981712959&selected=6062&latLong=31.554606%2C74.357155&sort=RECOMMENDED&top_dp=124&top_cur=USD&semcid=US.UB.BING.PT-c-EN.HOTEL&semdtl=a1429012176.b11315017303776210.g1kwd-82189323842618%3Aloc-144.e1c.m18d15bbf2af6c1d752fa9d1bc0e925b82.r1dbbc4399e805d7a471af9bb50c0eca6a53815556874c850795d8066b3e568804.c1.j1142691.k1152882.d182188878595064.h1e.i1.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&userIntent=&selectedRoomType=314006270&selectedRatePlan=380046345&categorySearch=any_option&searchId=60a6b42e-b43b-44af-a668-54a0fbd95022",image:W("/assets/hotels/Pearl-Continental-Lahore.jpg"),showImage:!0,description:"A flagship five-star property known for premium hospitality, executive facilities, and large event spaces.",facilities:["Luxury Rooms & Suites","Restaurants & Coffee Lounge","Swimming Pool","Fitness Center"],contact:"Reservations: +92 42 111 505 505",rating:"4.5/5"},{name:"Ramada by Wyndham Lahore",location:"Lahore, Punjab, Pakistan",rates:"Business-friendly international chain pricing",offer:"Comfort-focused stay packages with central access.",website:"https://www.guestreservations.com/ramada-by-wyndham-lahore-gulberg-ii/booking?utm_source=microsoft&utm_medium=cpc&utm_campaign=318380766&msclkid=2639f60cc7641752938d9c426507dbb5&ctTriggered=true",image:W("/assets/hotels/Ramada-by-Wyndham-Lahore-Gulberg-II.jpg"),showImage:!0,description:"An international-branded stay option designed for business travelers and families seeking modern comfort.",facilities:["Comfort Rooms","All-Day Dining","Meeting Facilities","Wi-Fi Access"],contact:"Reservations: +92 42 111 111 211",rating:"4.3/5"},{name:"Hotel Indigo Lahore",location:"Lahore, Punjab, Pakistan",rates:"Boutique premium rates for curated city stays",offer:"Lifestyle stay experience with modern interiors and city vibe.",website:"https://indigoheights.com/",image:W("/assets/hotels/Hotel-Indigo.jpg"),showImage:!0,description:"A contemporary boutique-style hotel brand experience offering design-led rooms and premium hospitality.",facilities:["Designer Rooms","Signature Dining","Fitness Facilities","Business Services"],contact:"Reservations: +92 42 111 111 111",rating:"4.4/5"},{name:"Hotel One Gulberg Lahore",location:"Lahore, Punjab, Pakistan",rates:"Upper-midscale corporate and family packages",offer:"Value-focused business stays in a prime Lahore district.",website:"https://www.guestreservations.com/hotel-one-gulberg-lahore/booking?utm_source=microsoft&utm_medium=cpc&utm_campaign=318380766&msclkid=3d22881e8b211d72a380e25028093b5b",image:W("/assets/hotels/Hotel-One-Gulberg-Lahore.jpg"),showImage:!0,description:"A trusted local hospitality brand known for practical comfort, business convenience, and central location.",facilities:["Business-Friendly Rooms","Breakfast Service","Meeting Room","24/7 Front Desk"],contact:"Reservations: +92 42 111 111 563",rating:"4.2/5"},{name:"Luxus Grand Hotel (LC)",location:"Lahore, Punjab, Pakistan",rates:"Executive and leisure stay rates",offer:"City-center premium rooms with event-friendly access.",website:"https://www.expedia.com/Lahore-Hotels-Luxus-Grand-Hotel.h16225098.Hotel-Information?chkin=2026-07-23&chkout=2026-07-24&x_pwa=1&rfrr=HSR&pwa_ts=1783538679588&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=2068&destination=Lahore%2C+Punjab%2C+Pakistan&destType=MARKET&selected=16225098&latLong=31.554606%2C74.357155&sort=RECOMMENDED&top_dp=50&top_cur=USD&semcid=US.UB.BING.PT-c-EN.HOTEL&semdtl=a1429012176.b11317216326895908.g1kwd-82326765629610%3Aloc-144.e1c.m1f413ae58b13f11ee7d78c41612f456b3.r17441980d01bf266109c2845e02c5e619d691d9360faf76d1fb0b3ff083f73b12.c1.j1142691.k1152882.d182326298507125.h1e.i1.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&userIntent=&selectedRoomType=201690559&selectedRatePlan=208425873&categorySearch=any_option&searchId=b938991e-d9ee-47cd-a5b9-bfbbe22962a7",image:W("/assets/hotels/Luxus-Grand-Hotel.jpg"),showImage:!0,description:"A modern luxury hotel in Lahore offering upscale rooms, contemporary dining, and premium guest services.",facilities:["Premium Rooms","Restaurant & Cafe","Concierge Support","Airport Transfer Assistance"],contact:"Reservations: +92 42 111 589 879",rating:"4.4/5"},{name:"Nishat Hotel Lahore",location:"Lahore, Punjab, Pakistan",rates:"Premium luxury rates with lifestyle amenities",offer:"High-end accommodation with shopping and dining proximity.",website:"https://www.booking.com/hotel/pk/the-nishat.en-gb.html?aid=2276380&label=msn-G%2AualcbtRsY8_D6yMU0tng-80333218529225%3Atikwd-80333372562144%3Aloc-144%3Aneo%3Amte%3Alp142691%3Adec%3Acid578349423%3Aagid1285329581450391%3Aclkid91bc1c0fd2ae13842aa77641760a897b&sid=d2e80396e6c920f70a72e21ba196f068&all_sr_blocks=112449101_204759422_0_2_0_670390&checkin=2026-07-14&checkout=2026-07-15&dest_id=-2767043&dest_type=city&dist=0&group_adults=2&group_children=0&hapos=1&highlighted_blocks=112449101_204759422_0_2_0_670390&hpos=1&matching_block_id=112449101_204759422_0_2_0_670390&no_rooms=1&req_adults=2&req_children=0&room1=A%2CA&sb_price_type=total&sr_order=popularity&sr_pri_blocks=112449101_204759422_0_2_0_670390_3300000&srepoch=1783539000&srpvid=7c17890e04e000e0&type=total&ucfs=1&",image:W("/assets/hotels/Nishat.jpg"),showImage:!0,description:"A luxury Lahore hospitality brand recognized for refined interiors, premium service standards, and prime locations.",facilities:["Luxury Suites","Fine Dining","Spa & Wellness","Event and Meeting Spaces"],contact:"Reservations: +92 42 111 647 428",rating:"4.6/5"}]};W("/assets/ozilla/talwinder.jpg"),W("/assets/ozilla/talwinder.jpg"),W("/assets/ozilla/Imran-Khan.jpg"),W("/assets/ozilla/Imran-Khan.jpg"),W("/assets/ozilla/Bohemia.jpg"),W("/assets/ozilla/Bohemia.jpg"),W("/assets/ozilla/hassan-raheem.jpg"),W("/assets/ozilla/hassan-raheem.jpg");const ta=[{name:"TALWINDER",isHeadliner:!0,genre:"Indie Pop / Punjabi Fusion",stage:"Main Prism Stage",bpm:"128 BPM",vibe:"Euphoric Night",src:W("/assets/ozilla/talwinder.jpg"),image:W("/assets/ozilla/talwinder.jpg"),offsetY:0},{name:"IMRAN KHAN",isHeadliner:!1,genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",src:W("/assets/ozilla/Imran-Khan.jpg"),image:W("/assets/ozilla/Imran-Khan.jpg"),offsetY:0},{name:"BOHEMIA",isHeadliner:!1,genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",src:W("/assets/ozilla/Bohemia.jpg"),image:W("/assets/ozilla/Bohemia.jpg"),offsetY:0},{name:"HASSAN RAHEEM",isHeadliner:!1,genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",src:W("/assets/ozilla/hassan-raheem.jpg"),image:W("/assets/ozilla/hassan-raheem.jpg"),offsetY:0}],aa=1.28,ra=.78;function qe(t,a,r){return Math.min(r,Math.max(a,t))}function sa(t){if(!t)return null;if(typeof t=="string")return t||null;const a=t.src||t.image;return typeof a=="string"&&a?a:null}function Rr(t){return sa(t&&typeof t=="object"&&(t.image||t.src)||t)}function zr(t){if(t&&typeof t=="object"&&"offsetY"in t){const a=t.offsetY;return typeof a=="number"&&isFinite(a)?a:0}return 0}function Mr({items:t=ta,images:a,slideWidth:r=320,slideHeight:s=440,spacing:i=2.4,direction:l="right",smoothness:n=3,radius:o=24,dim:c=5,background:g="transparent",sensitivity:u=8,autoPlay:y=!1,autoPlayInterval:k=2800,autoPlaySpeed:E=1,style:v,onItemClick:p}){const b=m.useRef(null),x=m.useRef([]),R=m.useRef(0),A=m.useRef(0),[f,d]=m.useState(0),[F,_]=m.useState(!1),[N,h]=m.useState(0),P=t&&t.length>0?t:a&&a.length>0?a:ta,T=m.useMemo(()=>P.map((w,j)=>({...w,src:Rr(w),offsetY:zr(w),name:w.name||`Artist ${j+1}`,genre:w.genre||"Live Performer",stage:w.stage||"Ozilla Arena",bpm:w.bpm||"128 BPM",vibe:w.vibe||"Festival Energy",isHeadliner:!!w.isHeadliner})),[P]),I=f>0&&f<640?Math.min(r,250):f<1024?Math.min(r,290):r,V=f>0&&f<640?Math.round(I*1.36):s,O=I+qe(i,0,10)*18,C=.24-qe(n,0,10)/10*.1,B=qe(c,0,10)/10*.75,q=.8+qe(u,0,10)/10*1.6,$=.9+qe(u,0,10)/10*1.8,M=l==="left",D=E>0?Math.round(k/E):k,Y=m.useRef({count:T.length,step:O,slideWidth:I,width:f,ease:C,maxScale:aa,minScale:ra,dim:B,loop:!1,flip:M});Y.current={count:T.length,step:O,slideWidth:I,width:f,ease:C,maxScale:aa,minScale:ra,dim:B,loop:!1,flip:M};const oe=m.useRef({wheelMultiplier:q,dragMultiplier:$,flip:M});oe.current={wheelMultiplier:q,dragMultiplier:$,flip:M},m.useEffect(()=>{const w=b.current;if(!w)return;const j=new ResizeObserver(H=>{H[0]&&d(H[0].contentRect.width)});return j.observe(w),d(w.getBoundingClientRect().width),()=>j.disconnect()},[]),m.useEffect(()=>{x.current.length=T.length},[T.length]),m.useEffect(()=>{if(!y||F||T.length<=1)return;const w=setInterval(()=>{h(j=>{const H=(j+1)%T.length;return R.current=H*O,H})},D);return()=>clearInterval(w)},[y,F,T.length,O,D]),m.useEffect(()=>{let w=0,j=0,H=!0,J=null;const re=ae=>{if(w=requestAnimationFrame(re),!H){j=ae;return}const z=Y.current,ie=j?Math.min((ae-j)/1e3,.1):1/60;if(j=ae,!z.count||z.step<=0||z.width<=0)return;const me=(z.count-1)*z.step;R.current=qe(R.current,0,me);const Se=1-Math.pow(1-z.ease,ie*60);A.current+=(R.current-A.current)*Se;const ue=Math.round(A.current/z.step);ue>=0&&ue<z.count&&h(ue);const se=(z.width-z.slideWidth)/2,G=z.width/2;for(let S=0;S<z.count;S+=1){const L=x.current[S];if(!L)continue;const Z=S*z.step-A.current+se,de=Z+z.slideWidth/2-G;let je,ve;de>0?(je=Math.min(z.maxScale,1+de/z.width*.45),ve=(je-1)*z.slideWidth*.35):(je=Math.max(z.minScale,1+de/z.width*.5),ve=0);const he=z.flip?z.width-z.slideWidth-(Z+ve):Z+ve;if(L.style.transform=`translate3d(${he}px, -50%, 0) scale(${je})`,z.dim>0&&je<1){const Ie=(1-je)/Math.max(.001,1-z.minScale);L.style.opacity=String(Math.max(.45,1-Ie*z.dim*.6))}else L.style.opacity="1"}};return typeof IntersectionObserver<"u"&&b.current&&(J=new IntersectionObserver(ae=>{ae[0]&&(H=ae[0].isIntersecting)},{rootMargin:"100px"}),J.observe(b.current)),w=requestAnimationFrame(re),()=>{cancelAnimationFrame(w),J&&J.disconnect()}},[]),m.useEffect(()=>{const w=b.current;if(!w)return;const j=H=>{H.preventDefault();const J=Math.abs(H.deltaX)>Math.abs(H.deltaY)?H.deltaX:H.deltaY;R.current+=J*oe.current.wheelMultiplier};return w.addEventListener("wheel",j,{passive:!1}),()=>w.removeEventListener("wheel",j)},[]),m.useEffect(()=>{const w=b.current;if(!w)return;let j=null,H=0;const J=z=>{if(j===null){j=z.pointerId,H=z.clientX;try{w.setPointerCapture(z.pointerId)}catch{}}},re=z=>{if(j!==z.pointerId)return;const ie=z.clientX-H;H=z.clientX,R.current+=(oe.current.flip?ie:-ie)*oe.current.dragMultiplier},ae=z=>{if(j===z.pointerId){j=null;try{w.hasPointerCapture(z.pointerId)&&w.releasePointerCapture(z.pointerId)}catch{}}};return w.addEventListener("pointerdown",J),w.addEventListener("pointermove",re),w.addEventListener("pointerup",ae),w.addEventListener("pointercancel",ae),()=>{w.removeEventListener("pointerdown",J),w.removeEventListener("pointermove",re),w.removeEventListener("pointerup",ae),w.removeEventListener("pointercancel",ae)}},[]);const te=m.useCallback(w=>{const j=qe(w,0,T.length-1);R.current=j*O,h(j)},[T.length,O]),ne=m.useCallback(w=>{const j=qe(N+(w==="left"?-1:1),0,T.length-1);te(j)},[N,te,T.length]);return e.jsxs("div",{style:{position:"relative",width:"100%",display:"flex",flexDirection:"column",alignItems:"center",margin:"1.2rem 0"},onMouseEnter:()=>_(!0),onMouseLeave:()=>_(!1),children:[e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",flexWrap:"wrap",gap:"8px",marginBottom:"1rem",zIndex:10},children:T.map((w,j)=>{const H=j===N;return e.jsx("button",{type:"button",onClick:()=>te(j),style:{padding:"6px 14px",borderRadius:"999px",border:H?"1px solid #ff8a3d":"1px solid rgba(255, 255, 255, 0.12)",background:H?"linear-gradient(135deg, rgba(255, 138, 61, 0.32), rgba(255, 90, 31, 0.22))":"rgba(20, 10, 6, 0.55)",color:H?"#ffbd59":"rgba(255, 255, 255, 0.65)",fontSize:"0.78rem",fontWeight:H?"850":"650",letterSpacing:"0.04em",cursor:"pointer",transition:"all 200ms ease",backdropFilter:"blur(8px)",boxShadow:H?"0 0 16px rgba(255, 138, 61, 0.35)":"none"},children:w.name},w.name)})}),e.jsx("div",{ref:b,className:"smooth-scroll-slider-viewport",style:{position:"relative",width:"100%",height:`${V+50}px`,overflow:"hidden",background:g,cursor:"grab",touchAction:"pan-y",opacity:f>0?1:0,transition:"opacity 0.35s ease",userSelect:"none",...v},children:T.map((w,j)=>{const H=w.isHeadliner,J=j===N;return e.jsxs("div",{ref:re=>{x.current[j]=re},onClick:()=>{te(j),p&&p(w,j)},style:{position:"absolute",top:"50%",left:0,width:`${I}px`,height:`${V}px`,borderRadius:`${o}px`,overflow:"hidden",background:"#130c0a",border:J?"1.5px solid rgba(255, 138, 61, 0.85)":H?"1px solid rgba(255, 138, 61, 0.45)":"1px solid rgba(255, 255, 255, 0.12)",boxShadow:J?"0 26px 65px rgba(0,0,0,0.9), 0 0 35px rgba(255, 90, 31, 0.4)":"0 18px 45px rgba(0,0,0,0.75)",willChange:"transform, filter",transform:"translate3d(0, -50%, 0)",cursor:"pointer",transition:"border-color 250ms ease, box-shadow 250ms ease"},children:[w.src?e.jsx("img",{src:w.src,alt:w.name,draggable:!1,onError:re=>{re.currentTarget.src=W("/assets/prism-auth-visual.jpg")},style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:`50% calc(50% + ${w.offsetY}px)`,display:"block",userSelect:"none"}}):null,e.jsxs("div",{style:{position:"absolute",top:"12px",left:"12px",right:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",zIndex:3},children:[H?e.jsx("span",{style:{display:"inline-flex",alignItems:"center",gap:"4px",padding:"4px 10px",borderRadius:"999px",background:"linear-gradient(135deg, #ff8a3d, #ff5a1f)",color:"#fff",fontSize:"0.68rem",fontWeight:"900",letterSpacing:"0.06em",textTransform:"uppercase",boxShadow:"0 4px 14px rgba(255, 90, 31, 0.45)"},children:"★ MAIN HEADLINER"}):e.jsx("span",{style:{padding:"3px 9px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.65)",backdropFilter:"blur(8px)",color:"#f6eee8",fontSize:"0.66rem",fontWeight:"700",border:"1px solid rgba(255,255,255,0.12)"},children:w.stage}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",gap:"2px",height:"14px",padding:"3px 6px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.55)",backdropFilter:"blur(6px)"},children:[e.jsx("span",{className:"sss-eq-bar sss-eq-1"}),e.jsx("span",{className:"sss-eq-bar sss-eq-2"}),e.jsx("span",{className:"sss-eq-bar sss-eq-3"})]})]}),e.jsxs("div",{style:{position:"absolute",inset:0,background:"linear-gradient(180deg, rgba(0,0,0,0.08) 0%, transparent 40%, rgba(10,5,3,0.72) 65%, rgba(6,3,2,0.96) 100%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:"16px 14px",zIndex:2},children:[e.jsx("span",{style:{display:"inline-block",width:"fit-content",padding:"2px 8px",borderRadius:"999px",background:"rgba(255, 138, 61, 0.18)",border:"1px solid rgba(255, 138, 61, 0.35)",color:"#ffbd59",fontSize:"0.68rem",fontWeight:"800",letterSpacing:"0.04em",textTransform:"uppercase",marginBottom:"6px"},children:w.genre}),e.jsx("h3",{style:{margin:0,color:"#ffffff",fontSize:"1.28rem",fontWeight:"900",letterSpacing:"-0.02em",lineHeight:1.15,textTransform:"uppercase",textShadow:"0 2px 10px rgba(0,0,0,0.7)"},children:w.name}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginTop:"8px",paddingTop:"6px",borderTop:"1px solid rgba(255,255,255,0.1)",color:"rgba(255, 255, 255, 0.72)",fontSize:"0.68rem",fontWeight:"700"},children:[e.jsxs("span",{children:["⚡ ",w.bpm]}),e.jsxs("span",{children:["♫ ",w.vibe]})]})]})]},w.name)})}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"1rem",marginTop:"0.8rem",zIndex:10},children:[e.jsx("button",{type:"button",onClick:()=>ne("left"),disabled:N===0,"aria-label":"Previous artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:N===0?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:N===0?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:N===0?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:N===0?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:w=>{N>0&&(w.currentTarget.style.transform="scale(1.1)",w.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:w=>{w.currentTarget.style.transform="scale(1)",w.currentTarget.style.borderColor=N===0?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"‹"}),e.jsx("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:T.map((w,j)=>e.jsx("span",{onClick:()=>te(j),style:{width:j===N?"20px":"6px",height:"6px",borderRadius:"999px",backgroundColor:j===N?"#ff8a3d":"rgba(255, 255, 255, 0.25)",cursor:"pointer",transition:"all 250ms ease"}},j))}),e.jsx("button",{type:"button",onClick:()=>ne("right"),disabled:N===T.length-1,"aria-label":"Next artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:N===T.length-1?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:N===T.length-1?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:N===T.length-1?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:N===T.length-1?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:w=>{N<T.length-1&&(w.currentTarget.style.transform="scale(1.1)",w.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:w=>{w.currentTarget.style.transform="scale(1)",w.currentTarget.style.borderColor=N===T.length-1?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"›"})]}),e.jsx("style",{children:`
      ...
      `})]})}const et={color:"#ff8a3d",rounded:24,thickness:2.5,borderSize:45,glow:85,movement:"continuous",speed:16},Fr=2,Bt=[{blur:8,opacity:.5,reach:.3},{blur:15,opacity:.3,reach:.6},{blur:40,opacity:.18,reach:1}],Or=Math.max(...Bt.map(t=>t.blur)),ia=36;function Rt(t,a){const r=Math.max(0,Math.min(1,a));if(typeof t!="string")return`rgba(0,0,0,${r})`;const s=t.trim(),i=s.match(/^#([0-9a-f]{3,8})$/i);if(i){let n=i[1];(n.length===3||n.length===4)&&(n=n.split("").map(c=>c+c).join(""));const o=parseInt(n.slice(0,6),16);return Number.isFinite(o)?`rgba(${o>>16&255},${o>>8&255},${o&255},${r})`:`rgba(0,0,0,${r})`}const l=s.match(/^rgba?\(([^)]+)\)/i);if(l){const n=l[1].split(",").map(o=>parseFloat(o));if(n.length>=3&&n.slice(0,3).every(Number.isFinite))return`rgba(${n[0]},${n[1]},${n[2]},${r})`}return`rgba(0,0,0,${r})`}function Dr(t,a,r){const s=(t%1+1)%1*2*(a+r);return s<a?[s,0]:s<a+r?[a,s-a]:s<a*2+r?[a-(s-a-r),r]:[0,r-(s-a*2-r)]}function na(t,a,r){const s=2*(a+r),i=[0,a/s,(a+r)/s,(a*2+r)/s];return Math.floor(t/4)+i[(t%4+4)%4]}function _r(t,a,r){const[s,i]=Dr(t,a,r);return Math.atan2(s-a/2,r/2-i)*180/Math.PI}const oa=24,Br=.015;function zt(t,a,r,s,i){const l=r>0?r:100,n=s>0?s:100,o=Math.max(0,Math.min(100,a)),c=Math.max(Br,o/100*.5),g=o/100,u=[];let y=0,k=0,E=0;for(let p=0;p<=oa;p++){const b=p/oa,x=_r(t+(b-.5)*c,l,n);if(p===0)y=x;else{let f=x-k;for(;f>180;)f-=360;for(;f<-180;)f+=360;E+=f}k=x;const R=Math.abs(b-.5)*2,A=g>=1||R<=g?1:1-(R-g)/(1-g);u.push(`${Rt(i,A*A*(3-2*A))} ${E.toFixed(2)}deg`)}const v=E.toFixed(2);return u.push(`${Rt(i,0)} ${v}deg`),u.push(`${Rt(i,0)} 360deg`),`conic-gradient(from ${y.toFixed(2)}deg at 50% 50%, ${u.join(", ")})`}const la=30,$r=4,ca=3,Hr=.35,Ur=[.72,.16,.18,1.05],Gr=[.65,0,.35,1];function za(t){const[a,r,s,i]=t;if(a===r&&s===i)return n=>n;const l=(n,o,c)=>{const g=1-c;return 3*g*g*c*n+3*g*c*c*o+c*c*c};return n=>{const o=Math.max(0,Math.min(1,n));let c=o;for(let g=0;g<8;g++){const u=l(a,s,c)-o,y=1-c,k=3*y*y*a+6*y*c*(s-a)+3*c*c*(1-s);if(Math.abs(k)<1e-6)break;c-=u/k,c=Math.max(0,Math.min(1,c))}return l(r,i,c)}}const Wr=za(Ur),Vr=za(Gr),da={WebkitMaskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",WebkitMaskClip:"content-box, border-box",WebkitMaskComposite:"xor",maskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",maskClip:"content-box, border-box",maskComposite:"exclude"};function tt({color:t=et.color,rounded:a=et.rounded,thickness:r=et.thickness,borderSize:s=et.borderSize,glow:i=et.glow,movement:l=et.movement,speed:n=et.speed,style:o,className:c=""}){const g=m.useRef(null),u=m.useRef(null),y=m.useRef({speed:n,movement:l,borderSize:s,color:t});y.current={speed:n,movement:l,borderSize:s,color:t};const k=m.useRef(null),E=m.useRef({w:0,h:0}),[v,p]=m.useState({w:0,h:0});m.useEffect(()=>{const N=k.current;if(!N||typeof ResizeObserver>"u")return;const h=new ResizeObserver(()=>{const P=N.getBoundingClientRect();P.width===E.current.w&&P.height===E.current.h||(E.current={w:P.width,h:P.height},p(E.current))});return h.observe(N),()=>h.disconnect()},[]),m.useEffect(()=>{const N=k.current;let h=!0,P=null;typeof IntersectionObserver<"u"&&N&&(P=new IntersectionObserver(q=>{q[0]&&(h=q[0].isIntersecting)},{rootMargin:"100px"}),P.observe(N));let T=0,I=performance.now(),V=0,O=0,C=0;const B=q=>{if(T=requestAnimationFrame(B),!h||typeof document<"u"&&document.hidden){I=q;return}const $=Math.min(.05,Math.max(0,(q-I)/1e3));I=q;const M=y.current,D=Math.max(0,Math.min(20,M.speed));if(D>0){const Y=M.movement==="step",oe=Y?ca+(Hr-ca)*(D-1)/19:(la+($r-la)*(D-1)/19)/4;for(C+=$/oe;C>=1;)C-=1,O+=1;const te=Y?Wr(Math.min(1,C*2)):Vr(C),{w:ne,h:w}=E.current,j=ne>0?ne:100,H=w>0?w:100,J=na(O,j,H),re=na(O+1,j,H);V=J+(re-J)*te;const ae=g.current;ae&&ae.style.setProperty("--arc",zt(V,M.borderSize,ne,w,M.color));const z=u.current;z&&z.style.setProperty("--arc",zt(V+.5,M.borderSize,ne,w,M.color))}};return T=requestAnimationFrame(B),()=>{cancelAnimationFrame(T),P&&P.disconnect()}},[]);const b=Math.max(1,Math.min(10,r)),x=Math.max(0,Math.min(100,a))/100*(Math.min(v.w||200,v.h||200)/2),R=Math.max(0,Math.min(100,i))/100,A=N=>b+R*ia*N,f=10+ia+Or*2,d=(N,h=0)=>e.jsx("div",{style:{position:"absolute",inset:h-N,boxSizing:"border-box",padding:N,borderRadius:x>0?x+N:0,background:"var(--arc)",...da}}),F=(N,h,P,T)=>e.jsx("div",{style:{position:"absolute",inset:-f,boxSizing:"border-box",padding:f,borderRadius:x>0?x+f:0,opacity:T,mixBlendMode:"plus-lighter",filter:P?`blur(${P.toFixed(1)}px)`:"none",WebkitFilter:P?`blur(${P.toFixed(1)}px)`:"none",...da},children:d(h,f)},N),_=(N,h)=>e.jsxs("div",{ref:h,style:{position:"absolute",inset:0,overflow:"visible",pointerEvents:"none","--arc":zt(N,s,v.w,v.h,t)},children:[R>0&&(v.w>0&&v.w<600?[Bt[0]].map((P,T)=>F(`glow-${T}`,A(P.reach),P.blur*.7,P.opacity*1.2)):Bt.map((P,T)=>F(`glow-${T}`,A(P.reach),P.blur,P.opacity))),Array.from({length:Fr}).map((P,T)=>e.jsx("div",{style:{position:"absolute",inset:0,mixBlendMode:"plus-lighter"},children:d(b)},`edge-${T}`))]});return e.jsxs("div",{ref:k,className:`neon-border-overlay ${c}`,style:{position:"absolute",inset:0,width:"100%",height:"100%",flexShrink:0,borderRadius:x,pointerEvents:"none",zIndex:1,...o},children:[_(0,g),_(.5,u)]})}const qr=1.5,Yr=42,Xr=Math.PI*2,Zr=300,Kr=300,Jr=2,Qr=5e3,es=3.2,ts=.05,as=3,rs=1.35,ss=.08,is=.5,ns=.24,os=.35,ls=Xr*.75,cs=2,Ma=3,wt=720,ds=`
...
`;function pa(t){if(!t)return[1,1,1,1];let a=String(t).trim();const r=a.match(/^var\(\s*[^,)]+\s*,\s*(.+)\)$/i);r&&(a=r[1].trim());const s=a.match(/^rgba?\(([^)]+)\)$/i);if(s){const l=s[1].split(/[,\s/]+/).filter(Boolean).map(parseFloat);return[(l[0]||0)/255,(l[1]||0)/255,(l[2]||0)/255,l.length>3&&isFinite(l[3])?l[3]:1]}let i=a.replace("#","");return(i.length===3||i.length===4)&&(i=i.split("").map(l=>l+l).join("")),i.length<6?[1,1,1,1]:[parseInt(i.slice(0,2),16)/255,parseInt(i.slice(2,4),16)/255,parseInt(i.slice(4,6),16)/255,i.length>=8?parseInt(i.slice(6,8),16)/255:1]}function gs(t){return()=>{t|=0,t=t+1831565813|0;let a=Math.imul(t^t>>>15,1|t);return a=a+Math.imul(a^a>>>7,61|a)^a,((a^a>>>14)>>>0)/4294967296}}function ma(t,a,r){const s=t.createShader(a);return s?(t.shaderSource(s,r),t.compileShader(s),t.getShaderParameter(s,t.COMPILE_STATUS)||console.warn("VortexDustFall shader:",t.getShaderInfoLog(s)),s):null}function fa(t,a,r){const s=t.createProgram();if(!s)return null;const i=ma(t,t.VERTEX_SHADER,a),l=ma(t,t.FRAGMENT_SHADER,r);return!i||!l?null:(t.attachShader(s,i),t.attachShader(s,l),t.linkProgram(s),t.getProgramParameter(s,t.LINK_STATUS)||console.warn("VortexDustFall link:",t.getProgramInfoLog(s)),s)}const us={radius:195,thickness:16},hs={height:165,spin:38,spray:0},xs={scatter:280,blur:0},bs={amount:103,transition:{type:"tween",duration:.6,ease:"easeOut"}};function ys({background:t="transparent",baseColor:a="#FFA733",accentColor:r="#FFE082",density:s=145,dotSize:i=130,speed:l=48,distance:n=1450,tilt:o=7,ring:c={},fall:g={},field:u={},hover:y={},style:k={},className:E="",children:v}){const p={...us,...c},b={...hs,...g},x={...xs,...u},R={...bs,...y},A=m.useRef(null),f=m.useRef(null),d=m.useRef({x:0,y:0,active:0}),F=m.useRef({baseColor:a,accentColor:r,density:s,dotSize:i,speed:l,distance:n,tilt:o,ring:p,fall:b,field:x,hover:R});return F.current={baseColor:a,accentColor:r,density:s,dotSize:i,speed:l,distance:n,tilt:o,ring:p,fall:b,field:x,hover:R},m.useEffect(()=>{const _=A.current,N=f.current;if(!_||!N)return;const h=N.getContext("webgl",{alpha:!0,antialias:!1,premultipliedAlpha:!0,depth:!1});if(!h)return;const P=fa(h,ds,ps),T=fa(h,ms,fs);if(!P||!T)return;const I=(G,S)=>h.getUniformLocation(G,S),V={a:h.getAttribLocation(P,"aA"),b:h.getAttribLocation(P,"aB")},O={res:I(P,"uRes"),focal:I(P,"uFocal"),phase:I(P,"uPhase"),radius:I(P,"uRadius"),rise:I(P,"uRise"),fallD:I(P,"uFall"),spinTurns:I(P,"uSpinTurns"),scatter:I(P,"uScatter"),dotWorld:I(P,"uDotWorld"),blurK:I(P,"uBlurK"),camDist:I(P,"uCamDist"),tilt:I(P,"uTilt"),yPx:I(P,"uYPx"),alpha:I(P,"uAlpha"),color:I(P,"uColor")},C={ring:h.getAttribLocation(T,"aRing")},B={res:I(T,"uRes"),focal:I(T,"uFocal"),radius:I(T,"uRadius"),camDist:I(T,"uCamDist"),tilt:I(T,"uTilt"),yPx:I(T,"uYPx"),thick:I(T,"uThick"),seg:I(T,"uSeg"),color:I(T,"uColor"),alpha:I(T,"uAlpha")},q=h.createBuffer(),$=h.createBuffer();let M=-1,D=0;const Y=G=>{const S=N.clientWidth||_.clientWidth||(typeof window<"u"?window.innerWidth:1200),L=S<768,Q=S>=768&&S<1024,Z=L?1800:Q?8500:Math.round(G*Zr);D=Math.max(1e3,Z);const de=new Float32Array(D*4),je=new Float32Array(D*2),ve=gs(85840071);for(let he=0;he<D;he++)de[he*4]=ve(),de[he*4+1]=ve(),de[he*4+2]=ve(),de[he*4+3]=ve(),je[he*2]=ve(),je[he*2+1]=ve();h.bindBuffer(h.ARRAY_BUFFER,q),h.bufferData(h.ARRAY_BUFFER,de,h.STATIC_DRAW),h.bindBuffer(h.ARRAY_BUFFER,$),h.bufferData(h.ARRAY_BUFFER,je,h.STATIC_DRAW),M=G},oe=h.createBuffer(),te=(wt+1)*2;{const G=new Float32Array(te*2);for(let S=0;S<=wt;S++){const L=S/wt;G[S*4]=L,G[S*4+1]=-1,G[S*4+2]=L,G[S*4+3]=1}h.bindBuffer(h.ARRAY_BUFFER,oe),h.bufferData(h.ARRAY_BUFFER,G,h.STATIC_DRAW)}h.disable(h.DEPTH_TEST),h.enable(h.BLEND),h.blendFunc(h.ONE,h.ONE);let ne=!0,w=null;typeof IntersectionObserver<"u"&&_&&(w=new IntersectionObserver(G=>{G[0]&&(ne=G[0].isIntersecting)},{rootMargin:"100px"}),w.observe(_));let j=1,H=0;const J=()=>{const G=typeof window<"u"&&window.innerWidth<768;j=Math.min(window.devicePixelRatio||1,G?.85:qr);const S=N.clientWidth||_.clientWidth||1,L=N.clientHeight||_.clientHeight||1,Q=Math.max(1,Math.round(S*j)),Z=Math.max(1,Math.round(L*j));(N.width!==Q||N.height!==Z)&&(N.width=Q,N.height=Z),h.viewport(0,0,Q,Z),Math.abs(H-S)>50&&(H=S,Y(F.current.density))};J();const re=new ResizeObserver(J);re.observe(N);let ae=0,z=performance.now(),ie=0,me=0,Se=0,ue=0;const se=G=>{if(ie=requestAnimationFrame(se),!ne||typeof document<"u"&&document.hidden){z=G;return}const S=Math.min((G-z)/1e3,.05);z=G;const L=F.current;if(L.density!==M&&Y(L.density),D===0)return;const Q=Math.max(.05,L.hover.transition?.duration??.6),Z=1-Math.exp(-S/Q),de=d.current;me+=(de.x-me)*Z,Se+=(de.y-Se)*Z,ue+=(de.active-ue)*Z;const je=(L.hover.amount||100)/100,ve=1+ue*je*.6;ae=(ae+S*(L.speed/50*ve)/es)%1;const he=N.width,Ie=N.height,_e=N.clientWidth||_.clientWidth||1200,ze=_e<768,dt=_e>=768&&_e<1024,Qe=Ie/(2*Math.tan(Yr/2*Math.PI/180)),pt=he/Math.max(Ie,1),mt=pt<1?Math.max(.32,pt/1.4):dt?.85:1,Pe=Kr*(L.ring.radius/100)*mt,ft=Pe*(ze?1.1:L.fall.height/100),ht=ft*(L.fall.spray/400),xt=Ie*(ze?.22:ns),At=L.fall.spin/100*1.5,Me=Pe*(L.field.scatter/100)*(ze?.08:.15),bt=Jr*(L.dotSize/100)*(ze?.65:1),He=Qr*(L.field.blur/100),Ue=ze?Math.min(L.ring.thickness*j,9*j):L.ring.thickness*j,U=L.tilt*Math.PI/180+Se*je*ue*(10*Math.PI/180),le=(ze?L.distance*1.05:L.distance)-ue*je*150,[xe,Te,we,Re]=pa(L.baseColor),[Ge,st,Fe,it]=pa(L.accentColor);h.clearColor(0,0,0,0),h.clear(h.COLOR_BUFFER_BIT),h.useProgram(P),h.uniform2f(O.res,he,Ie),h.uniform1f(O.focal,Qe),h.uniform1f(O.phase,ae),h.uniform1f(O.radius,Pe),h.uniform1f(O.rise,ht),h.uniform1f(O.fallD,ft),h.uniform1f(O.spinTurns,At),h.uniform1f(O.scatter,Me),h.uniform1f(O.dotWorld,bt*j),h.uniform1f(O.blurK,He*j),h.uniform1f(O.camDist,le),h.uniform1f(O.tilt,U),h.uniform1f(O.yPx,xt),h.uniform1f(O.alpha,Re),h.uniform3f(O.color,xe,Te,we),h.bindBuffer(h.ARRAY_BUFFER,q),h.enableVertexAttribArray(V.a),h.vertexAttribPointer(V.a,4,h.FLOAT,!1,0,0),h.bindBuffer(h.ARRAY_BUFFER,$),h.enableVertexAttribArray(V.b),h.vertexAttribPointer(V.b,2,h.FLOAT,!1,0,0),h.drawArrays(h.POINTS,0,D),h.useProgram(T),h.uniform2f(B.res,he,Ie),h.uniform1f(B.focal,Qe),h.uniform1f(B.radius,Pe),h.uniform1f(B.camDist,le),h.uniform1f(B.tilt,U),h.uniform1f(B.yPx,xt),h.uniform1f(B.thick,Ue),h.uniform1f(B.seg,wt),h.uniform3f(B.color,Ge,st,Fe),h.uniform1f(B.alpha,it),h.bindBuffer(h.ARRAY_BUFFER,oe),h.enableVertexAttribArray(C.ring),h.vertexAttribPointer(C.ring,2,h.FLOAT,!1,0,0),h.drawArrays(h.TRIANGLE_STRIP,0,te)};return ie=requestAnimationFrame(se),()=>{cancelAnimationFrame(ie),re.disconnect(),w&&w.disconnect(),h.deleteBuffer(q),h.deleteBuffer($),h.deleteBuffer(oe),h.deleteProgram(P),h.deleteProgram(T)}},[]),e.jsxs("div",{ref:A,className:`vortex-dust-container ${E}`,onPointerMove:_=>{const N=_.currentTarget.getBoundingClientRect();N.width<=0||N.height<=0||(d.current={x:(_.clientX-N.left)/N.width*2-1,y:-((_.clientY-N.top)/N.height*2-1),active:1})},onPointerLeave:()=>{d.current={x:0,y:0,active:0}},style:{position:"absolute",inset:0,width:"100%",height:"100%",overflow:"hidden",pointerEvents:"none",background:t,...k},children:[e.jsx("canvas",{ref:f,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}}),v&&e.jsx("div",{style:{position:"relative",zIndex:2,pointerEvents:"auto",width:"100%",height:"100%"},children:v})]})}const vs=[{name:"TALWINDER",isHeadliner:!0,genre:"Indie Pop / Punjabi Fusion",stage:"Main Prism Stage",bpm:"128 BPM",vibe:"Euphoric Night",image:W("/assets/ozilla/talwinder.jpg")},{name:"IMRAN KHAN",genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",image:W("/assets/ozilla/Imran-Khan.jpg")},{name:"BOHEMIA",genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",image:W("/assets/ozilla/Bohemia.jpg")},{name:"HASSAN RAHEEM",genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",image:W("/assets/ozilla/hassan-raheem.jpg")}],ws=[{id:"general",name:"General Pass",badge:"STANDARD ACCESS",price:"PKR 4,500",sub:"Full 1-day festival admission",isFeatured:!1,perks:["Access to All 4 Music Stages","Food & Beats Street Access","Festival Photo Booths & Activations","Instant Digital QR Pass"],ctaText:"Get General Pass",ctaLink:"/tickets"},{id:"vip",name:"VIP Experience",badge:"MOST POPULAR",price:"PKR 12,500",sub:"Elevated front-row & lounge access",isFeatured:!0,perks:["Priority Front Stage Viewing Deck","Private VIP Artist Lounge Access","Dedicated Fast-Track Entry Gate","Complimentary Food & Drink Voucher","20% Partner Hotel & Dining Discounts","Holographic VIP Commemorative Pass"],ctaText:"Book VIP Pass →",ctaLink:"/tickets"},{id:"platinum",name:"All-Access Platinum",badge:"EXCLUSIVE ALL-ACCESS",price:"PKR 25,000",sub:"Ultimate luxury hospitality package",isFeatured:!1,perks:["Backstage & Artist Lounge Access","Valet Reserved Parking Spot","Gourmet Catering & Open Mocktail Bar","Exclusive Afterparty Invitation","Dedicated Hospitality Concierge","Full Merchandise Gift Bundle"],ctaText:"Reserve Platinum Pass",ctaLink:"/tickets"}],ks=[{badge:"100kW SOUND SYSTEM",title:"4 Mega Sound Stages",desc:"Explosive stage arenas for Indie Pop, Punjabi Rap, Desi Hip-Hop, and non-stop EDM beats."},{badge:"HEADLINE CELEBRITIES",title:"Star-Studded Lineup",desc:"Live stadium sets by Talwinder, Imran Khan, Bohemia, Hassan Raheem, and top artists."},{badge:"CULINARY & NIGHT BAZAAR",title:"Food & Beats Street",desc:"50+ curated gourmet food stalls, wood-fired artisan eats, and craft mocktail lounges."},{badge:"ALL-ACCESS HOSPITALITY",title:"VIP Lounge & Deck Access",desc:"Elevated front-stage viewing decks, private artist lounges, and fast-track VIP gates."}],js=[{name:"OZILLA FEST 2026: The Flagship",date:"November 1, 2026",location:"Lahore, Pakistan",status:"FEATURED FESTIVAL",description:"Flagship festival with 4 mega stages, 20+ star artists, and 10,000+ live crowd."},{name:"Celebrity Night Live Concert",date:"February 2027",location:"Lahore, Pakistan",status:"UPCOMING CONCERT",description:"High-octane stadium night with headline Punjabi artists and 360° laser shows."},{name:"Ozilla Basant Beats Season 2",date:"March 2027",location:"Lahore, Pakistan",status:"SEASONAL FESTIVAL",description:"Cultural music fusion festival with live pop sets, color activations, and street eats."}],Ns=[{name:"Ozilla Season 1: The Bass Awakening",status:"Sold Out · 6,500+ Fans",detail:"Debut open-air music festival in Lahore featuring indie fusion acts and 2 live mega stages."},{name:"Ozilla Season 2: Neon Nights",status:"Sold Out · 8,500+ Fans",detail:"High-energy night festival with headline celebrity acts and artisan night food street."}],Ss=[{name:"Ozilla Debut: The Sound Awakening",year:"2023",badge:"SOLD OUT DEBUT",description:"Historic launch in Lahore uniting 6,000+ fans for live indie music and night market culture.",highlights:["6,000+ Attendees","2 Live Stages","Indie & Desi Fusion"],venue:"Lahore Expo Center",date:"December 12, 2023"},{name:"Ozilla Season 2: Neon Nights",year:"2024",badge:"RECORD 8,500+ CROWD",description:"Season 2 expansion with 4 live stages, celebrity headliners, and 360° laser canopy.",highlights:["8,500+ Fans","4 Live Stages","Celebrity Headliners"],venue:"DHA Sports Complex, Lahore",date:"November 9, 2024"},{name:"Ozilla Basant Cultural Beats",year:"2025",badge:"SPRING FESTIVAL",description:"Seasonal spring music festival with live acoustic sets, DJ arenas, and artisan bazaar.",highlights:["Cultural Sets","Live DJ Stages","Food Hub"],venue:"Gulberg Cultural District, Lahore",date:"March 15, 2025"},{name:"OZILLA FEST 2026 (The Grand Edition)",year:"2026",badge:"FLAGSHIP 10,000+ EDITION",description:"Monumental flagship edition with 4 stages, 20+ star artists, and 100kW laser sound arrays.",highlights:["10,000+ Crowd","4 Mega Stages","Talwinder & Imran Khan"],venue:"Lahore, Punjab",date:"November 1, 2026"},{name:"OZILLA FEST 2027: Arena Tour",year:"2027",badge:"NATIONWIDE TOUR",description:"Nationwide arena tour expansion bringing the signature Ozilla concert experience across Pakistan.",highlights:["Arena Tour","Multi-City Stages","Star Acts"],venue:"Lahore, Karachi & Islamabad",date:"November 14, 2027"}],As=[{tier:"Title Sponsor",price:"PREMIUM",badge:"FLAGSHIP PARTNER",accent:"#ffbd59",tagline:"Maximum Brand Dominance",isFeatured:!0,ctaText:"Claim Title Partnership",perks:["Exclusive brand naming rights","Main stage backdrop placement","VIP lounge & deck co-branding","30-second main stage video slot","Dedicated social & press campaigns"]},{tier:"Gold Sponsor",price:"HIGH IMPACT",badge:"STAGE ACTIVATION",accent:"#ff8a3d",tagline:"High-Energy Ground Presence",isFeatured:!1,ctaText:"Become Gold Sponsor",perks:["Exclusive brand activation zone","Perimeter banner placements","Digital festival app features","Influencer co-branding & mentions","On-ground brand booth space"]},{tier:"Silver Sponsor",price:"GROWTH",badge:"BRAND PARTNER",accent:"#cbd5e1",tagline:"Targeted Festival Engagement",isFeatured:!1,ctaText:"Join Silver Tier",perks:["Official festival website branding","Social media shoutouts","Sampling booth at food street","Newsletter sponsor placement","10 complimentary festival passes"]},{tier:"Media Partner",price:"CUSTOM",badge:"BROADCAST & PRESS",accent:"#ec4899",tagline:"Official Media Rights",isFeatured:!1,ctaText:"Apply For Press Pass",perks:["Official media coverage rights","All-access artist press passes","Exclusive backstage interview access","Press release announcement feature","Dedicated creator lounge access"]}],Ps=[{badge:"100kW SOUND ARRAY",title:"Main Concert Arena",desc:"Stadium-grade concert sound arrays, 360° lasers, and cryogenic live jets.",accent:"#ff5a1f"},{badge:"50+ FOOD SPOTS",title:"Food & Beats Street",desc:"50+ night food stalls, wood-fired artisan eats, and gourmet smash burgers.",accent:"#ffbd59"},{badge:"24/7 RAPID CARE",title:"Medical & First Aid Hub",desc:"Fully equipped medical stations and certified paramedic response teams.",accent:"#ef4444"},{badge:"VALET & VIP GATES",title:"Managed VIP Parking",desc:"Fast-track valet lanes and direct express entry for VIP pass holders.",accent:"#f59e0b"},{badge:"CREATOR LIGHTING",title:"Holographic Photo Booths",desc:"Interactive neon backdrops and 360° video spinners for creator moments.",accent:"#ec4899"},{badge:"INCLUSIVE VENUE",title:"Full Venue Accessibility",desc:"Elevated viewing decks, step-free ramps, and on-ground guest assistance.",accent:"#3b82f6"},{badge:"PROFESSIONAL SQUAD",title:"Crowd Safety & Security",desc:"Trained festival security squad, CCTV monitoring, and RFID gate checks.",accent:"#10b981"},{badge:"GIGABIT HIGH-SPEED",title:"Ultra-Fast Festival Wi-Fi",desc:"High-density wireless zones across all stages and food streets.",accent:"#06b6d4"}],Ts=[{value:"10,000+",label:"Music Lovers",sub:"Packed Live Crowd"},{value:"20+",label:"Star Performers",sub:"Celebrity & Indie Acts"},{value:"4",label:"Mega Stages",sub:"Non-stop Beats"},{value:"50+",label:"Food & Stalls",sub:"Culinary & Brand Hub"}];function Es(t){const[a,r]=m.useState(()=>{const s=Math.max(new Date(t)-Date.now(),0);return{days:Math.floor(s/864e5),hours:Math.floor(s/36e5%24),minutes:Math.floor(s/6e4%60),seconds:Math.floor(s/1e3%60)}});return m.useEffect(()=>{const s=setInterval(()=>{const i=Math.max(new Date(t)-Date.now(),0);r({days:Math.floor(i/864e5),hours:Math.floor(i/36e5%24),minutes:Math.floor(i/6e4%60),seconds:Math.floor(i/1e3%60)})},1e3);return()=>clearInterval(s)},[t]),a}function Cs(){const t=Ke(),a=Es("2026-11-01T18:00:00+05:00");return m.useEffect(()=>{const r=t.hash?.replace("#","");r?setTimeout(()=>{const s=document.getElementById(r);s&&s.scrollIntoView({behavior:"smooth",block:"start"})},150):window.scrollTo({top:0,behavior:"smooth"})},[t.hash]),e.jsxs("main",{className:"sp-main",children:[e.jsxs("section",{id:"home",className:"sp-hero","aria-label":"Ozilla Fest",children:[e.jsx(ys,{baseColor:"#ff8a3d",accentColor:"#ffbd59",density:125,speed:46,tilt:7}),e.jsx("div",{className:"sp-hero-ambient-glow"}),e.jsxs("div",{className:"sp-hero-content",children:[e.jsxs(ce.div,{className:"sp-hero-badge",initial:{opacity:0,y:-20,scale:.9},animate:{opacity:1,y:0,scale:1},transition:{duration:.6},children:[e.jsx("span",{children:"✨"}),e.jsx("strong",{children:"OZILLA FEST 2026 · LAHORE"})]}),e.jsx(ce.h1,{className:"sp-hero-title",initial:{opacity:0,y:25},animate:{opacity:1,y:0},transition:{duration:.7,delay:.12},children:"OZILLA FEST"}),e.jsxs(ce.p,{className:"sp-hero-subtitle",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.7,delay:.25},children:[e.jsx("strong",{className:"sp-hero-sub-highlight",children:"Pakistan's Flagship Music & Cultural Phenomenon."}),e.jsx("span",{className:"sp-hero-sub-detail",children:"4 Electrified Mega Stages · Headline Celebrities · High-Octane Sound Under the Lahore Night Sky."})]}),e.jsxs(ce.div,{className:"sp-hero-meta-strip",initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{duration:.6,delay:.4},children:[e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsxs("span",{className:"sp-meta-header",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"DATE"})]}),e.jsx("strong",{children:"NOV 01, 2026"})]}),e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsxs("span",{className:"sp-meta-header",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"CITY"})]}),e.jsx("strong",{children:"LAHORE, PK"})]}),e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsxs("span",{className:"sp-meta-header",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"PRODUCTION"})]}),e.jsx("strong",{children:"4 MEGA STAGES"})]}),e.jsxs("div",{className:"sp-hero-meta-pill sp-meta-featured",children:[e.jsxs("span",{className:"sp-meta-header",children:[e.jsx("span",{className:"sp-meta-dot sp-dot-gold"}),e.jsx("span",{className:"sp-meta-label",children:"PASSES"})]}),e.jsx("strong",{children:"INSTANT QR PASS"})]})]}),e.jsxs(ce.div,{className:"sp-hero-actions",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6,delay:.55},children:[e.jsx(ce.a,{className:"sp-btn-ember",href:"#celebrities",whileHover:{scale:1.04},whileTap:{scale:.97},children:"Explore Lineup ⚡"}),e.jsx(ce.div,{whileHover:{scale:1.04},whileTap:{scale:.97},children:e.jsx(X,{className:"sp-btn-ghost",to:"/tickets",children:"Get VIP Passes 🎟️"})})]})]})]}),e.jsx("section",{className:"festival-stats-strip","aria-label":"Festival Highlights",children:e.jsx("div",{className:"sp-container",children:e.jsx("div",{className:"stats-inner-grid",children:Ts.map((r,s)=>e.jsxs(ce.div,{className:"stat-card",whileHover:{y:-5,scale:1.02},children:[e.jsx("strong",{className:"stat-val",children:r.value}),e.jsx("span",{className:"stat-label",children:r.label}),e.jsx("small",{className:"stat-sub",children:r.sub})]},r.label))})})}),e.jsx("section",{id:"celebrities",className:"sp-section sp-section-celebrities","aria-label":"Celebrities Lineup",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",children:[e.jsx("span",{className:"sp-eyebrow",children:"Live on the Ozilla Stage"}),e.jsx("h2",{className:"sp-section-title",children:"Celebrity Singers & Performers"}),e.jsx("p",{className:"sp-section-subtitle",children:"Four powerhouse headline performers, one premium Lahore festival atmosphere, and an amphitheatre built for unforgettable crowd moments."})]}),e.jsx("div",{className:"sp-celebrity-slider-wrap",style:{margin:"1rem 0 3.5rem 0"},children:e.jsx(Mr,{items:vs,slideWidth:320,slideHeight:440,spacing:2.6,smoothness:2.5,dim:6,sensitivity:8.5,autoPlay:!0,autoPlaySpeed:1.4})}),e.jsxs("div",{className:"sp-countdown-banner",children:[e.jsx("div",{className:"sp-countdown-header",children:e.jsxs("span",{className:"sp-countdown-eyebrow",children:[e.jsx("span",{className:"sp-countdown-pulse"}),"COUNTDOWN TO THE FIRST BEAT DROP"]})}),e.jsx("div",{className:"sp-countdown-grid",children:[["Days",a.days],["Hours",a.hours],["Minutes",a.minutes],["Seconds",a.seconds]].map(([r,s])=>e.jsxs(ce.div,{className:"sp-countdown-card",whileHover:{scale:1.05,y:-4},transition:{type:"spring",stiffness:350},children:[e.jsx("strong",{children:String(s).padStart(2,"0")}),e.jsx("span",{children:r}),e.jsx("div",{className:"sp-countdown-glow-line"})]},r))})]})]})}),e.jsx("section",{id:"vip-experience",className:"sp-section sp-section-pricing","aria-label":"Festival Passes",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",style:{textAlign:"center"},children:[e.jsx("span",{className:"sp-eyebrow",children:"CHOOSE YOUR ACCESS"}),e.jsx("h2",{className:"sp-section-title",children:"Festival Passes & VIP Tiers"}),e.jsx("p",{className:"sp-section-subtitle",style:{margin:"0 auto"},children:"Select your festival experience tier. Instant dynamic QR pass generated upon reservation with guaranteed fast-track admission."})]}),e.jsx("div",{className:"sp-pricing-grid",children:ws.map(r=>e.jsxs(ce.div,{className:`sp-pricing-card ${r.isFeatured?"sp-featured-pricing":""}`,whileHover:{y:-8},children:[r.isFeatured&&e.jsx("div",{className:"sp-pricing-popular-tag",children:"MOST POPULAR ACCESS"}),e.jsxs("div",{className:"sp-pricing-header",children:[e.jsx("span",{className:"sp-tier-badge",children:r.badge}),e.jsx("h3",{children:r.name}),e.jsx("div",{className:"sp-pricing-cost",children:e.jsx("strong",{children:r.price})}),e.jsx("p",{className:"sp-pricing-sub",children:r.sub})]}),e.jsx("div",{className:"sp-pricing-divider"}),e.jsx("ul",{className:"sp-pricing-features",children:r.perks.map(s=>e.jsxs("li",{children:[e.jsx("span",{className:"sp-perk-check",children:"✓"}),e.jsx("span",{children:s})]},s))}),e.jsx(X,{to:r.ctaLink,className:r.isFeatured?"sp-btn-ember w-full":"sp-btn-ghost w-full",style:{textAlign:"center",marginTop:"auto"},children:r.ctaText})]},r.id))})]})}),e.jsx("section",{id:"about",className:"sp-section sp-section-about","aria-label":"About Ozilla",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",children:[e.jsx("span",{className:"sp-eyebrow",children:"⚡ THE ULTIMATE LIVE EXPERIENCE"}),e.jsx("h2",{className:"sp-section-title",children:"The Ozilla Fest Atmosphere"}),e.jsx("p",{className:"sp-section-subtitle",children:"Pakistan's flagship open-air music & cultural festival. 4 electrified stages, 100kW concert sound, headline celebrity acts, gourmet food street, and unmatched crowd energy under the Lahore night sky."})]}),e.jsx("div",{className:"sp-pillars-grid",children:ks.map(r=>e.jsxs(ce.div,{className:"sp-pillar-card",whileHover:{y:-8,scale:1.02},children:[e.jsx("div",{className:"sp-pillar-glow-accent"}),e.jsx("div",{className:"sp-pillar-top",children:e.jsx("span",{className:"sp-pillar-badge",children:r.badge})}),e.jsx("h3",{className:"sp-pillar-title",children:r.title}),e.jsx("p",{className:"sp-pillar-desc",children:r.desc}),e.jsx("div",{className:"sp-pillar-glow-line"})]},r.title))}),e.jsxs("div",{className:"sp-festival-vibe-banner",style:{position:"relative",overflow:"hidden"},children:[e.jsx(tt,{color:"#ff7a29",rounded:32,thickness:2.8,borderSize:50,glow:85}),e.jsxs("div",{className:"sp-vibe-left",style:{position:"relative",zIndex:2},children:[e.jsxs("span",{className:"sp-vibe-eyebrow",children:[e.jsx("span",{className:"sp-countdown-pulse"}),"FESTIVAL HIGHLIGHTS"]}),e.jsx("h3",{children:"What Makes Ozilla Legendary"}),e.jsx("p",{children:"Non-stop beats from golden hour to midnight, surrounded by festival activations and pure music culture."}),e.jsxs("div",{className:"sp-vibe-actions",children:[e.jsx(ce.a,{href:"#celebrities",className:"sp-btn-ember",whileHover:{scale:1.04},whileTap:{scale:.97},children:"Explore Lineup →"}),e.jsx(ce.div,{whileHover:{scale:1.04},whileTap:{scale:.97},children:e.jsx(X,{to:"/tickets",className:"sp-btn-ghost",children:"Book Festival Passes"})})]})]}),e.jsx("div",{className:"sp-vibe-tags-grid",style:{position:"relative",zIndex:2},children:[{text:"4 Mega Music Stages",isMain:!0,icon:"⚡"},{text:"100kW Laser & Sound",isMain:!0,icon:"🔊"},{text:"20+ Star Performers",isMain:!0,icon:"👑"},{text:"Verified QR Instant Passes",isMain:!0,icon:"🎟️"},{text:"10,000+ Music Lovers",isMain:!1,icon:"👥"},{text:"50+ Food & Beats Stalls",isMain:!1,icon:"🍔"},{text:"VIP Artist Lounge & Deck",isMain:!1,icon:"✨"},{text:"Exclusive Partner Discounts",isMain:!1,icon:"🏷️"}].map(r=>e.jsxs(ce.div,{className:`sp-vibe-tag ${r.isMain?"sp-vibe-main":"sp-vibe-secondary"}`,whileHover:{scale:1.03,x:3},whileTap:{scale:.98},children:[e.jsx("span",{className:"sp-vibe-tag-icon",children:r.icon}),e.jsx("span",{className:"sp-vibe-tag-text",children:r.text}),r.isMain&&e.jsx("span",{className:"sp-vibe-tag-dot"})]},r.text))})]})]})}),e.jsx("section",{id:"events",className:"sp-section sp-section-events","aria-label":"Past Events",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",children:[e.jsx("span",{className:"sp-eyebrow",children:"Previous Editions"}),e.jsx("h2",{className:"sp-section-title",children:"Past Festival Milestones"}),e.jsx("p",{className:"sp-section-subtitle",children:"A legacy of sold-out stadium energy, breakthrough artist sets, and unforgettable Lahore nights."})]}),e.jsx("div",{className:"sp-events-grid",children:Ns.map(r=>e.jsxs(ce.div,{className:"sp-glass-card sp-past-event-card",style:{position:"relative",overflow:"hidden"},whileHover:{y:-6},children:[e.jsx(tt,{color:"#ff8a3d",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column",height:"100%"},children:[e.jsxs("div",{className:"sp-card-header",children:[e.jsx("h3",{children:r.name}),e.jsx("span",{className:"sp-pill-badge",children:r.status})]}),e.jsx("p",{className:"sp-card-desc",children:r.detail}),e.jsxs("div",{className:"sp-card-footer-eq",children:[e.jsx("span",{children:"LIVE ARCHIVE"}),e.jsxs("div",{className:"celeb-mini-eq",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})]})]},r.name))})]})}),e.jsx("section",{id:"future-events",className:"sp-section sp-section-future","aria-label":"Upcoming Events",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header",children:[e.jsx("span",{className:"sp-eyebrow",children:"Upcoming Concert Tour"}),e.jsx("h2",{className:"sp-section-title",children:"Future Festival Editions"}),e.jsx("p",{className:"sp-section-subtitle",children:"Mark your calendar for upcoming major festival editions, celebrity concert nights, and arena dates."})]}),e.jsx("div",{className:"sp-future-grid",children:js.map(r=>e.jsxs(ce.div,{className:"sp-glass-card sp-future-card",style:{position:"relative",overflow:"hidden"},whileHover:{y:-6},children:[e.jsx(tt,{color:"#ff9e42",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column",height:"100%"},children:[e.jsx("span",{className:"sp-pill-badge",children:r.status}),e.jsx("h3",{style:{marginTop:"0.8rem"},children:r.name}),e.jsxs("p",{className:"sp-meta-text",children:["📍 ",r.date," · ",r.location]}),e.jsx("p",{className:"sp-card-desc",style:{flex:1},children:r.description}),e.jsx(X,{to:"/tickets",className:"sp-accent-link",children:"Get Tickets →"})]})]},r.name))})]})}),e.jsx("section",{id:"history",className:"sp-section sp-section-history","aria-label":"Festival History",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header sp-timeline-banner-header",style:{position:"relative",overflow:"hidden"},children:[e.jsx(tt,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"Festival Legacy"}),e.jsx("h2",{className:"sp-section-title",children:"Our Editions & Timeline"}),e.jsx("p",{className:"sp-section-subtitle",children:"From our underground debut to Pakistan's biggest stadium concert experience."})]})]}),e.jsx("div",{className:"sp-timeline",children:Ss.map(r=>e.jsxs("div",{className:"sp-timeline-item",children:[e.jsxs("div",{className:"sp-timeline-node-wrap",children:[e.jsx("div",{className:"sp-timeline-icon",children:e.jsx("span",{className:"sp-timeline-year-pill",children:r.year})}),e.jsx("div",{className:"sp-timeline-pulse-ring"})]}),e.jsxs("div",{className:"sp-glass-card sp-timeline-content",children:[e.jsxs("div",{className:"sp-timeline-top-row",children:[e.jsx("div",{className:"sp-meta-text",children:e.jsx("span",{className:"sp-year-highlight",children:r.date})}),e.jsx("span",{className:"sp-timeline-badge",children:r.badge})]}),e.jsx("h3",{className:"sp-timeline-heading",children:r.name}),e.jsx("p",{className:"sp-card-desc",children:r.description}),e.jsx("div",{className:"sp-tag-cloud",children:r.highlights.map(s=>e.jsx("span",{className:"sp-tag sp-timeline-tag",children:s},s))}),e.jsxs("div",{className:"sp-timeline-footer",children:[e.jsx("p",{className:"sp-venue-text",children:r.venue}),e.jsxs("div",{className:"celeb-mini-eq",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})]})]},r.name))})]})}),e.jsx("section",{id:"facilities",className:"sp-section sp-section-facilities","aria-label":"Facilities",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header sp-facilities-header-banner",style:{position:"relative",overflow:"hidden"},children:[e.jsx(tt,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"⚡ FESTIVAL VENUE & PRODUCTION"}),e.jsx("h2",{className:"sp-section-title",children:"World-Class Festival Facilities"}),e.jsx("p",{className:"sp-section-subtitle",children:"Built for a seamless 10,000+ attendee experience with concert-grade sound, medical support, VIP hospitality, and creator amenities."})]})]}),e.jsx("div",{className:"sp-facilities-grid",children:Ps.map(r=>e.jsxs(ce.div,{className:"sp-glass-card sp-facility-card",style:{position:"relative",overflow:"hidden"},whileHover:{y:-8,scale:1.02},children:[e.jsx(tt,{color:r.accent||"#ff8a3d",rounded:20,thickness:2.2,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,width:"100%"},children:[e.jsx("div",{className:"sp-facility-top",children:e.jsx("span",{className:"sp-facility-badge",style:{color:r.accent,borderColor:`${r.accent}44`,background:`${r.accent}14`},children:r.badge})}),e.jsx("h3",{className:"sp-facility-title",children:r.title}),e.jsx("p",{className:"sp-card-desc",children:r.desc})]}),e.jsx("div",{className:"sp-facility-glow-bar",style:{background:`linear-gradient(90deg, ${r.accent}, transparent)`}})]},r.title))})]})}),e.jsx("section",{id:"sponsorship",className:"sp-section sp-section-sponsorship","aria-label":"Sponsorships",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header sp-sponsorship-header-banner",style:{position:"relative",overflow:"hidden",textAlign:"center"},children:[e.jsx(tt,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"BRAND COLLABORATIONS"}),e.jsx("h2",{className:"sp-section-title",children:"Sponsorship & Brand Packages"}),e.jsx("p",{className:"sp-section-subtitle",style:{margin:"0 auto"},children:"Partner with Pakistan's biggest live music festival. Gain unparalleled on-ground brand presence, digital engagement, and VIP hospitality."})]})]}),e.jsx("div",{className:"sp-sponsorship-grid",children:As.map(r=>e.jsxs(ce.div,{className:`sp-glass-card sp-sponsor-card ${r.isFeatured?"sp-sponsor-featured":""}`,whileHover:{y:-10,scale:1.02},children:[r.isFeatured&&e.jsx("div",{className:"sp-sponsor-popular-tag",children:"MOST PRESTIGIOUS TIER"}),e.jsx("div",{className:"sp-sponsor-top",children:e.jsx("span",{className:"sp-sponsor-badge",style:{color:r.accent,borderColor:`${r.accent}44`,background:`${r.accent}14`},children:r.badge})}),e.jsxs("div",{className:"sp-sponsor-header",children:[e.jsx("h3",{children:r.tier}),e.jsx("div",{className:"sp-sponsor-price-tag",style:{color:r.accent},children:r.price}),e.jsx("p",{className:"sp-sponsor-tagline",children:r.tagline})]}),e.jsx("div",{className:"sp-sponsor-divider"}),e.jsx("ul",{className:"sp-sponsor-perks",children:r.perks.map(s=>e.jsxs("li",{children:[e.jsx("span",{className:"sp-check",style:{color:r.accent},children:"✓"}),e.jsx("span",{children:s})]},s))}),e.jsx(ce.div,{whileHover:{scale:1.04},whileTap:{scale:.96},style:{marginTop:"auto",paddingTop:"1.2rem"},children:e.jsx(X,{to:"/tickets",className:r.isFeatured?"sp-btn-ember w-full":"sp-btn-ghost w-full",style:{textAlign:"center"},children:r.ctaText})}),e.jsx("div",{className:"sp-sponsor-glow-bottom",style:{background:`linear-gradient(90deg, ${r.accent}, transparent)`}})]},r.tier))})]})}),e.jsx("style",{children:`
      ...
      `})]})}function Gt({type:t,message:a,onClose:r}){const s={success:"bg-green-100 border-green-500 text-green-700",error:"bg-red-100 border-red-500 text-red-700",warning:"bg-yellow-100 border-yellow-500 text-yellow-700",info:"bg-blue-100 border-blue-500 text-blue-700"}[t]||"bg-gray-100 border-gray-500 text-gray-700";return e.jsxs("div",{className:`${s} border-l-4 p-4 rounded mb-4 flex justify-between items-center`,children:[e.jsx("p",{children:a}),r&&e.jsx("button",{onClick:r,className:"ml-4 font-bold hover:opacity-75",children:"×"})]})}const Ys=["Personal Info","Ticket Details","Payment Checkout","QR Pass"],Xs={ticketType:"General",day:"Day 1",quantity:1,subtotal:1,serviceFee:0,discount:0,total:1,benefits:["Festival entry","Food court access","Partner discount offers"]};function Zs(){const t=ct(),{user:a}=Je(),{requestTicket:r,payWithCard:s,payWithJazzCash:i,payWithEasypaisa:l,initiatePayFastCheckout:n,completePayFastGateway:o,loading:c}=Ut(),[g,u]=m.useState(null),[y,k]=m.useState(!1),[E,v]=m.useState("payfast"),[p,b]=m.useState(null),[x,R]=m.useState(!1),[A,f]=m.useState(Xs),[d,F]=m.useState(null),[_,N]=m.useState(!0),h=y?3:2;`${a?.firstName||""} ${a?.lastName||""}`.trim()||a?.name||a?.email;const P=!!d?.soldOut;m.useEffect(()=>{let $=!0;return(async()=>{N(!0);try{const D=await Ae.getAvailability();if(!$)return;F(D),D?.soldOut&&u({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."})}catch{$&&F(null)}finally{$&&N(!1)}})(),()=>{$=!1}},[]);const T=()=>{if(P){u({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."});return}t(`/login?returnTo=${encodeURIComponent("/tickets")}`)},I=async $=>{if(P){u({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."});return}try{const M=await r($);b(M),k(!0),u({type:"success",message:"Ticket reserved! Please complete payment below."});const D=await Ae.getAvailability().catch(()=>null);D&&F(D)}catch(M){const D=M?.response?.data?.message||M?.message||"Failed to request ticket. Please try again.";M?.response?.data?.availability&&F(M.response.data.availability),u({type:"error",message:D})}},V=async $=>{if(!p?.id){u({type:"error",message:"Ticket session expired. Please retry."});return}try{await s(p.id,$),u({type:"success",message:`Payment of PKR ${A.total.toLocaleString()} successful! Your QR pass is ready.`}),t(`/tickets/view/${p.id}`)}catch(M){const D=M?.response?.data?.message||M?.message||"Failed to process card payment.";u({type:"error",message:D})}},O=async $=>{if(!p?.id){u({type:"error",message:"Ticket session expired. Please retry."});return}try{await i(p.id,$),u({type:"success",message:"JazzCash payment successful! Your QR pass is ready."}),t(`/tickets/view/${p.id}`)}catch(M){const D=M?.response?.data?.message||M?.message||"Failed to process JazzCash payment.";u({type:"error",message:D})}},C=async $=>{if(!p?.id){u({type:"error",message:"Ticket session expired. Please retry."});return}try{await l(p.id,$),u({type:"success",message:"Easypaisa payment successful! Your QR pass is ready."}),t(`/tickets/view/${p.id}`)}catch(M){const D=M?.response?.data?.message||M?.message||"Failed to process Easypaisa payment.";u({type:"error",message:D})}},B=async()=>{if(!p?.id){u({type:"error",message:"Ticket session expired. Please retry."});return}try{await n(p.id),R(!0)}catch($){u({type:"error",message:$?.response?.data?.message||$?.message||"Failed to initiate PayFast session."})}},q=async $=>{if(p?.id)try{await o(p.id,$),R(!1),u({type:"success",message:`PayFast payment of PKR ${A.total.toLocaleString()} confirmed! Official QR pass generated.`}),t(`/tickets/view/${p.id}?payment=success`)}catch(M){u({type:"error",message:M?.response?.data?.message||M?.message||"Failed to verify PayFast transaction."})}};return e.jsxs("main",{className:"ticket-portal-clean",children:[e.jsxs("section",{className:"ticket-clean-hero",children:[e.jsx(Ht,{nodeColor:"#EC4899",lineColor:"236, 72, 153",secondaryColor:"255, 90, 31",maxDistance:140,speed:.5}),e.jsx("div",{className:"hero-glow-blob"}),e.jsxs("div",{className:"ticket-clean-hero-content",children:[e.jsx("span",{className:"hero-eyebrow",children:"OZILLA FEST 2026"}),e.jsx("h1",{className:"hero-title",children:"Book Your Festival Passes"}),e.jsx("p",{className:"hero-subtitle",children:"Instant digital QR pass with access to 4 live stages, headline artists, and VIP amenities in Lahore."}),e.jsxs("div",{className:"hero-tags",children:[e.jsx("span",{children:"📅 Nov 01, 2026"}),e.jsx("span",{children:"📍 Lahore"}),e.jsx("span",{children:"⚡ Instant QR Pass"})]})]})]}),e.jsxs("section",{className:"ticket-clean-shell",children:[g&&e.jsx(Gt,{type:g.type,message:g.message,onClose:()=>u(null)}),e.jsx("div",{className:"ticket-clean-stepper",children:Ys.map(($,M)=>e.jsxs("div",{className:`step-item ${M+1<=h?"is-active":""}`,children:[e.jsx("span",{className:"step-num",children:M+1}),e.jsx("span",{className:"step-text",children:$})]},$))}),P?e.jsxs("div",{className:"ticket-sold-out-box",style:{background:"linear-gradient(135deg, rgba(239, 68, 68, 0.15) 0%, rgba(30, 10, 15, 0.95) 100%)",border:"2px solid #ef4444",borderRadius:"24px",padding:"48px 24px",textAlign:"center",boxShadow:"0 20px 50px rgba(239, 68, 68, 0.25)",margin:"20px 0 40px"},children:[e.jsx("div",{style:{display:"inline-flex",alignItems:"center",gap:"8px",background:"#ef4444",color:"#ffffff",padding:"6px 16px",borderRadius:"9999px",fontSize:"13px",fontWeight:"800",letterSpacing:"2px",textTransform:"uppercase",marginBottom:"16px"},children:"🔒 PORTAL LOCKED"}),e.jsx("h2",{style:{fontSize:"clamp(26px, 5vw, 40px)",fontWeight:"900",color:"#ffffff",margin:"0 0 12px"},children:"Tickets Are Officially Sold Out!"}),e.jsxs("p",{style:{color:"#d1d5db",maxWidth:"600px",margin:"0 auto 24px",fontSize:"16px",lineHeight:"1.6"},children:["All General, VIP, and Premium passes for ",e.jsx("strong",{children:"OZILLA FEST 2026"})," have been fully booked. The ticket booking system is locked to prevent overbooking."]}),e.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:"14px",flexWrap:"wrap"},children:[e.jsx("button",{type:"button",onClick:()=>t("/#sponsorship"),style:{background:"linear-gradient(135deg, #d4af37 0%, #aa8420 100%)",color:"#111827",padding:"12px 28px",borderRadius:"12px",fontWeight:"700",fontSize:"14px",border:"none",cursor:"pointer"},children:"Inquire Corporate / Sponsor Passes"}),e.jsx("button",{type:"button",onClick:()=>t("/schedule"),style:{background:"rgba(255,255,255,0.08)",color:"#ffffff",border:"1px solid rgba(255,255,255,0.2)",padding:"12px 24px",borderRadius:"12px",fontWeight:"600",fontSize:"14px",cursor:"pointer"},children:"View Festival Schedule"})]})]}):a?e.jsxs("div",{className:"ticket-main-grid",children:[e.jsxs("div",{className:"ticket-form-card",children:[e.jsxs("div",{className:"ticket-form-header",children:[e.jsx("h2",{children:y?"Payment Checkout":"Pass Reservation"}),e.jsx("span",{className:"ticket-badge-pill",children:"Official Portal"})]}),y?e.jsxs("div",{className:"ticket-payment-wrapper",children:[e.jsx(qs,{activeMethod:E,onSelectMethod:v}),E==="payfast"&&e.jsx(Ws,{amount:A.total,onProceed:B,loading:c,onBack:()=>k(!1)}),E==="card"&&e.jsx(Bs,{amount:A.total,onSubmit:V,loading:c,onBack:()=>k(!1)}),E==="jazzcash"&&e.jsx(Hs,{amount:A.total,onSubmit:O,loading:c,onBack:()=>k(!1)}),E==="easypaisa"&&e.jsx(Gs,{amount:A.total,onSubmit:C,loading:c,onBack:()=>k(!1)})]}):e.jsx(Ms,{onSubmit:I,loading:c,profileDefaults:a,onBookingChange:f,availability:d,availabilityLoading:_})]}),e.jsx(Vs,{isOpen:x,onClose:()=>R(!1),ticket:p,amount:A.total,onComplete:q}),e.jsx("aside",{className:"ticket-sidebar",children:e.jsxs("div",{className:"ticket-sidebar-summary",children:[e.jsx("h3",{children:"Order Summary"}),e.jsxs("div",{className:"summary-pass-type",children:[e.jsxs("strong",{children:[A.ticketType," Pass"]}),e.jsx("span",{children:A.day})]}),e.jsxs("div",{className:"summary-rows",children:[e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Quantity"}),e.jsx("strong",{children:A.quantity})]}),e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Price"}),e.jsxs("strong",{children:["PKR ",A.subtotal.toLocaleString()]})]}),e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Fee"}),e.jsx("strong",{style:{color:"#10b981"},children:"Free (PKR 0)"})]}),A.discount>0&&e.jsxs("div",{className:"summary-row summary-discount",children:[e.jsx("span",{children:"Discount"}),e.jsxs("strong",{children:["- PKR ",A.discount.toLocaleString()]})]})]}),e.jsxs("div",{className:"summary-total-row",children:[e.jsx("span",{children:"Grand Total"}),e.jsxs("strong",{children:["PKR ",A.total.toLocaleString()]})]}),e.jsx("div",{className:"summary-pass-badge",children:e.jsx("span",{children:"🎟️ Verified Digital QR Pass"})})]})})]}):e.jsxs("div",{className:"ticket-auth-prompt",children:[e.jsxs("div",{children:[e.jsx("h2",{children:"Sign in to Book Passes"}),e.jsx("p",{children:"Secure ticket purchasing requires an account for verified QR pass generation."})]}),e.jsx("button",{type:"button",onClick:T,className:"ticket-primary-button",children:"Sign In to Continue →"})]})]}),e.jsx("style",{children:`
        .ticket-portal-clean {
          position: relative;
          min-height: 100vh;
          padding: 0 0 3rem;
...
`;function va(t,a,r){const s=t.createShader(a);return s?(t.shaderSource(s,r),t.compileShader(s),t.getShaderParameter(s,t.COMPILE_STATUS)?s:(console.error("ParticleDrift shader:",t.getShaderInfoLog(s)),t.deleteShader(s),null)):null}function wa(t,a,r){const s=va(t,t.VERTEX_SHADER,a),i=va(t,t.FRAGMENT_SHADER,r);if(!s||!i)return null;const l=t.createProgram();return l?(t.attachShader(l,s),t.attachShader(l,i),t.linkProgram(l),t.getProgramParameter(l,t.LINK_STATUS)?l:(console.error("ParticleDrift link:",t.getProgramInfoLog(l)),null)):null}function ka(t,a){if(!t)return a;const r=String(t).trim();if(r.charAt(0)==="#"){let i=r.slice(1);if((i.length===3||i.length===4)&&(i=i[0]+i[0]+i[1]+i[1]+i[2]+i[2]),i.length>=6){const l=parseInt(i.slice(0,2),16),n=parseInt(i.slice(2,4),16),o=parseInt(i.slice(4,6),16);if(!isNaN(l)&&!isNaN(n)&&!isNaN(o))return[l/255,n/255,o/255]}return a}const s=r.match(/[\d.]+/g);return s&&s.length>=3?[Math.min(255,parseFloat(s[0]))/255,Math.min(255,parseFloat(s[1]))/255,Math.min(255,parseFloat(s[2]))/255]:a}function Be(t,a){return typeof t=="number"&&isFinite(t)?t:a}function rt(t,a,r){return t<a?a:t>r?r:t}function Ri(t){let a=t>>>0;return function(){a+=1831565813;let r=a;return r=Math.imul(r^r>>>15,r|1),r^=r+Math.imul(r^r>>>7,r|61),((r^r>>>14)>>>0)/4294967296}}const Ot=[[0,-1],[1,-1],[1,1],[0,-1],[1,1],[0,1]];function zi({style:t,background:a="transparent",baseColor:r="#F84400",accentColor:s="#ECECEC",density:i=235,dotSize:l=14,speed:n=100,direction:o=0,hover:c=200,linkDistance:g=202,linkThickness:u=2.5,width:y,height:k,isFixed:E=!0}){const v=m.useRef(null),p=m.useRef(null),b=m.useRef({w:0,h:0});b.current={w:Be(y,0),h:Be(k,0)};const x=m.useRef({x:-1e4,y:-1e4}),R=m.useRef({});R.current={base:r,accent:s,density:Math.round(rt(Be(i,90),10,400)),dotSize:rt(Be(l,5),1,24),speed:rt(Be(n,50),0,100)/50,direction:rt(Be(o,0),0,360),hover:rt(Be(c,100),0,200)/100,linkDistance:rt(Be(g,120),0,400),linkThickness:rt(Be(u,1),.5,8)},m.useEffect(()=>{const f=p.current;if(!f)return;const d=f.getContext("webgl",{alpha:!0,antialias:!1,depth:!1,premultipliedAlpha:!0});if(!d){console.error("ParticleDrift: WebGL unavailable");return}const F=wa(d,Ei,Ci),_=wa(d,Li,Ii);if(!F||!_)return;const N=new Map,h=(se,G)=>{const S=(se===F?"L:":"D:")+G;return N.has(S)||N.set(S,d.getUniformLocation(se,G)),N.get(S)},P=new Float32Array(Ye*6*2),T=new Float32Array(Ye*6*2),I=new Float32Array(Ye*6*2),V=new Float32Array(Ye*6*3);for(let se=0;se<Ye;se++)for(let G=0;G<6;G++){const S=(se*6+G)*2;I[S]=Ot[G][0],I[S+1]=Ot[G][1]}const O=d.createBuffer(),C=d.createBuffer(),B=d.createBuffer(),q=d.createBuffer();d.bindBuffer(d.ARRAY_BUFFER,O),d.bufferData(d.ARRAY_BUFFER,P.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,C),d.bufferData(d.ARRAY_BUFFER,T.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,B),d.bufferData(d.ARRAY_BUFFER,I,d.STATIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,q),d.bufferData(d.ARRAY_BUFFER,V.byteLength,d.DYNAMIC_DRAW);const $=Ri(20260824);let M=0,D=new Float32Array(0),Y=new Float32Array(0),oe=new Float32Array(0),te=new Float32Array(0),ne=new Float32Array(0);const w=d.createBuffer(),j=d.createBuffer(),H=(se,G,S)=>{M=se,D=new Float32Array(se),Y=new Float32Array(se),oe=new Float32Array(se),te=new Float32Array(se*2),ne=new Float32Array(se);for(let L=0;L<se;L++)D[L]=$()*G,Y[L]=$()*S,oe[L]=($()*.4+.1)*60;d.bindBuffer(d.ARRAY_BUFFER,w),d.bufferData(d.ARRAY_BUFFER,te.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,j),d.bufferData(d.ARRAY_BUFFER,ne.byteLength,d.DYNAMIC_DRAW)};let J=0,re=performance.now(),ae=-1,z=0,ie=0;const me=se=>{if(J=requestAnimationFrame(me),typeof document<"u"&&document.hidden){re=se;return}const G=Math.min(.05,(se-re)/1e3);re=se;const S=R.current,L=S.speed,Q=b.current.w||f.clientWidth||(typeof window<"u"?window.innerWidth:1200),Z=b.current.h||f.clientHeight||(typeof window<"u"?window.innerHeight:800),de=Q<768,je=Q>=768&&Q<1024,ve=Math.min(window.devicePixelRatio||1,de?.75:Ti),he=Math.max(1,Math.round(Q*ve)),Ie=Math.max(1,Math.round(Z*ve));(f.width!==he||f.height!==Ie)&&(f.width=he,f.height=Ie),d.viewport(0,0,he,Ie);let _e=S.density,ze=S.linkDistance,dt=S.dotSize;if(de?(_e=42,ze=95,dt=Math.min(S.dotSize,7)):je&&(_e=Math.max(80,Math.min(Math.round(S.density*.5),110)),ze=Math.min(S.linkDistance,145),dt=Math.min(S.dotSize,10)),_e!==ae&&(H(_e,Q,Z),ae=_e),Q!==z||Z!==ie){const U=Q/Math.max(z||Q,1),le=Z/Math.max(ie||Z,1);for(let xe=0;xe<M;xe++)D[xe]*=U,Y[xe]*=le;z=Q,ie=Z}const Qe=x.current,pt=S.hover,mt=(de?100:180)*(pt>0?1:0),Pe=ze,ft=de?Math.min(S.linkThickness,1.6):S.linkThickness,ht=S.direction*Math.PI/180,xt=Math.sin(ht),At=Math.cos(ht);let Me=0;const bt=(U,le,xe,Te,we,Re,Ge,st)=>{if(!(Me>=Ye)){for(let Fe=0;Fe<6;Fe++){const it=(Me*6+Fe)*2,Pt=(Me*6+Fe)*3;P[it]=U,P[it+1]=le,T[it]=xe,T[it+1]=Te,V[Pt]=Ot[Fe][0]===0?we:Re,V[Pt+1]=Ge,V[Pt+2]=st}Me++}};for(let U=0;U<M;U++){D[U]+=oe[U]*xt*G*L,Y[U]+=oe[U]*At*G*L,D[U]<-Xe?(D[U]=Q+Xe,Y[U]=$()*Z):D[U]>Q+Xe&&(D[U]=-Xe,Y[U]=$()*Z),Y[U]<-Xe?(Y[U]=Z+Xe,D[U]=$()*Q):Y[U]>Z+Xe&&(Y[U]=-Xe,D[U]=$()*Q);const le=Qe.x-D[U],xe=Qe.y-Y[U],Te=Math.sqrt(le*le+xe*xe),we=mt>0&&Te<mt?1:0;if(we===1){const Re=.5*(1-Te/mt)*pt;bt(D[U],Y[U],Qe.x,Qe.y,Re,Re,1,ft)}te[U*2]=D[U],te[U*2+1]=Y[U],ne[U]=we}if(Pe>0){const U=Pe*Pe;for(let le=0;le<M&&Me<Ye;le++){const xe=D[le],Te=Y[le];for(let we=le+1;we<M&&Me<Ye;we++){const Re=xe-D[we];if(Re>Pe||Re<-Pe)continue;const Ge=Te-Y[we];if(Ge>Pe||Ge<-Pe)continue;const st=Re*Re+Ge*Ge;if(st>=U)continue;const Fe=.15*(1-Math.sqrt(st)/Pe);bt(xe,Te,D[we],Y[we],Fe,Fe,0,ft)}}}d.clearColor(0,0,0,0),d.clear(d.COLOR_BUFFER_BIT),d.disable(d.DEPTH_TEST),d.enable(d.BLEND),d.blendFunc(d.ONE,d.ONE_MINUS_SRC_ALPHA);const He=ka(S.base,[.973,.267,0]),Ue=ka(S.accent,[.925,.925,.925]);if(Me>0){d.useProgram(F);const U=Me*6;d.bindBuffer(d.ARRAY_BUFFER,O),d.bufferSubData(d.ARRAY_BUFFER,0,P.subarray(0,U*2));const le=d.getAttribLocation(F,"a_p0");d.enableVertexAttribArray(le),d.vertexAttribPointer(le,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,C),d.bufferSubData(d.ARRAY_BUFFER,0,T.subarray(0,U*2));const xe=d.getAttribLocation(F,"a_p1");d.enableVertexAttribArray(xe),d.vertexAttribPointer(xe,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,B);const Te=d.getAttribLocation(F,"a_corner");d.enableVertexAttribArray(Te),d.vertexAttribPointer(Te,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,q),d.bufferSubData(d.ARRAY_BUFFER,0,V.subarray(0,U*3));const we=d.getAttribLocation(F,"a_shade");d.enableVertexAttribArray(we),d.vertexAttribPointer(we,3,d.FLOAT,!1,0,0),d.uniform2f(h(F,"uSize"),Q,Z),d.uniform3f(h(F,"uBase"),He[0],He[1],He[2]),d.uniform3f(h(F,"uAccent"),Ue[0],Ue[1],Ue[2]),d.drawArrays(d.TRIANGLES,0,U),d.disableVertexAttribArray(le),d.disableVertexAttribArray(xe),d.disableVertexAttribArray(Te),d.disableVertexAttribArray(we)}if(M>0){d.useProgram(_),d.bindBuffer(d.ARRAY_BUFFER,w),d.bufferSubData(d.ARRAY_BUFFER,0,te);const U=d.getAttribLocation(_,"a_pos");d.enableVertexAttribArray(U),d.vertexAttribPointer(U,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,j),d.bufferSubData(d.ARRAY_BUFFER,0,ne);const le=d.getAttribLocation(_,"a_lit");d.enableVertexAttribArray(le),d.vertexAttribPointer(le,1,d.FLOAT,!1,0,0),d.uniform2f(h(_,"uSize"),Q,Z),d.uniform1f(h(_,"uDpr"),ve),d.uniform1f(h(_,"uDot"),dt),d.uniform1f(h(_,"uRestAlpha"),.4),d.uniform3f(h(_,"uBase"),He[0],He[1],He[2]),d.uniform3f(h(_,"uAccent"),Ue[0],Ue[1],Ue[2]),d.drawArrays(d.POINTS,0,M),d.disableVertexAttribArray(U),d.disableVertexAttribArray(le)}},Se=se=>{const G=f.getBoundingClientRect();if(G.width<=0||G.height<=0)return;const S=b.current.w||f.clientWidth||window.innerWidth||1200,L=b.current.h||f.clientHeight||window.innerHeight||800;x.current.x=(se.clientX-G.left)/G.width*S,x.current.y=(se.clientY-G.top)/G.height*L},ue=()=>{x.current.x=-1e4,x.current.y=-1e4};return window.addEventListener("pointermove",Se,{passive:!0}),window.addEventListener("pointerleave",ue,{passive:!0}),J=requestAnimationFrame(me),()=>{cancelAnimationFrame(J),window.removeEventListener("pointermove",Se),window.removeEventListener("pointerleave",ue),d.deleteBuffer(O),d.deleteBuffer(C),d.deleteBuffer(B),d.deleteBuffer(q),d.deleteBuffer(w),d.deleteBuffer(j),d.deleteProgram(F),d.deleteProgram(_)}},[]);const A=E?{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:0,pointerEvents:"none",overflow:"hidden",background:a,isolation:"isolate",...t}:{position:"relative",overflow:"hidden",background:a,isolation:"isolate",width:typeof y=="number"&&y>0?y:"100%",height:typeof k=="number"&&k>0?k:"100%",...t};return e.jsx("div",{ref:v,style:A,"aria-hidden":"true",children:e.jsx("canvas",{ref:p,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}})})}function Mi(){const t="/ozillafest/".replace(/\/$/,"");return e.jsx(qa,{basename:t||void 0,future:{v7_startTransition:!0,v7_relativeSplatPath:!0},children:e.jsxs(er,{children:[e.jsx(zi,{}),e.jsx(Pi,{})]})})}const ja=(t="")=>{const a=String(t).toLowerCase();return a.includes("importing a module script failed")||a.includes("failed to fetch dynamically imported module")||a.includes("loading chunk")||a.includes("failed to load module script")||a.includes("error loading dynamically imported module")||a.includes("mime type")||a.includes("dynamically imported")};class Fi extends m.Component{constructor(r){super(r);Vt(this,"handleReload",()=>{sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload()});this.state={error:null}}static getDerivedStateFromError(r){return{error:r}}componentDidCatch(r,s){if(console.error("Application render error:",r,s),ja(r?.message)){const i=Number(sessionStorage.getItem("chunk_reload_ts")||0);Date.now()-i>8e3&&(sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload())}}render(){if(this.state.error){const r=ja(this.state.error?.message);return e.jsxs("main",{style:{padding:"32px 20px",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',maxWidth:"540px",margin:"60px auto",textAlign:"center",backgroundColor:"#121118",color:"#f3f4f6",borderRadius:"16px",border:"1px solid rgba(255,255,255,0.1)",boxShadow:"0 20px 50px rgba(0,0,0,0.5)"},children:[e.jsx("h2",{style:{color:"#f97316",marginBottom:"12px",fontSize:"1.4rem"},children:r?"New Update Available":"Ozilla Festival could not render"}),e.jsx("p",{style:{color:"#9ca3af",marginBottom:"20px",fontSize:"0.95rem",lineHeight:"1.5"},children:r?"A fresh update has been deployed. Please tap refresh to load the latest version.":"Please refresh the page to reload the application."}),e.jsx("button",{type:"button",onClick:this.handleReload,style:{padding:"12px 28px",backgroundColor:"#ea580c",color:"#ffffff",border:"none",borderRadius:"999px",cursor:"pointer",fontWeight:"700",fontSize:"1rem",boxShadow:"0 4px 14px rgba(234, 88, 12, 0.4)",transition:"transform 0.15s ease"},children:"Refresh Website"})]})}return this.props.children}}if(typeof window<"u"){const t=a=>{const r=String(a?.message||a?.reason?.message||"").toLowerCase();if(r.includes("importing a module script failed")||r.includes("failed to fetch dynamically imported module")||r.includes("loading chunk")||r.includes("failed to load module script")){const s=Number(sessionStorage.getItem("chunk_reload_ts")||0);Date.now()-s>8e3&&(sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload())}};window.addEventListener("error",t),window.addEventListener("unhandledrejection",t)}const Oi="231763775562-gc86oo86thvcfrnlt9u4i3m4emdaga7e.apps.googleusercontent.com";Dt.createRoot(document.getElementById("root")).render(e.jsx(gt.StrictMode,{children:e.jsx(Fi,{children:e.jsx(Ja,{clientId:Oi,children:e.jsx(Mi,{})})})}));export{Gt as A,Ut as a,ee as b,Hi as c,Ks as f,Ae as t,Je as u};
