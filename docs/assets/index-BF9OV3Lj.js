const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/UserDashboardPage-DUejs395.js","assets/vendor-motion-BW8tmsoW.js","assets/vendor-react-DycaHlXR.js","assets/PageHeader-Cr0bo0tp.js","assets/vendor-utils-BRCtA9qj.js","assets/AdminDashboardPage-B4JowUwu.js","assets/AdminTicketReviewPage-l7NHD82P.js"])))=>i.map(i=>d[i]);
var Da=Object.defineProperty;var _a=(t,a,r)=>a in t?Da(t,a,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[a]=r;var Vt=(t,a,r)=>_a(t,typeof a!="symbol"?a+"":a,r);import{j as e,u as ja,m as J,a as Wt,b as Ba,A as $a}from"./vendor-motion-BW8tmsoW.js";import{a as Ha,r as m,R as gt,u as Ze,N as be,O as ht,L as Z,b as ct,c as Ua,d as Ga,e as Na,f as Va,g as K,B as Wa}from"./vendor-react-DycaHlXR.js";import{a as qa,Q as Ya}from"./vendor-utils-BRCtA9qj.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function r(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(i){if(i.ep)return;i.ep=!0;const l=r(i);fetch(i.href,l)}})();var Dt={},qt=Ha;Dt.createRoot=qt.createRoot,Dt.hydrateRoot=qt.hydrateRoot;function Xa(t={}){const{nonce:a,locale:r,onScriptLoadSuccess:s,onScriptLoadError:i}=t,[l,n]=m.useState(!1),o=m.useRef(s);o.current=s;const c=m.useRef(i);return c.current=i,m.useEffect(()=>{const u=document.createElement("script");return u.src="https://accounts.google.com/gsi/client",r&&(u.src+=`?hl=${r}`),u.async=!0,u.defer=!0,u.nonce=a,u.onload=()=>{var g;n(!0),(g=o.current)===null||g===void 0||g.call(o)},u.onerror=()=>{var g;n(!1),(g=c.current)===null||g===void 0||g.call(c)},document.body.appendChild(u),()=>{document.body.removeChild(u)}},[a]),l}const Za=m.createContext(null);function Ka({clientId:t,nonce:a,locale:r,onScriptLoadSuccess:s,onScriptLoadError:i,children:l}){const n=Xa({nonce:a,onScriptLoadSuccess:s,onScriptLoadError:i,locale:r}),o=m.useMemo(()=>({locale:r,clientId:t,scriptLoadedSuccessfully:n}),[t,n]);return gt.createElement(Za.Provider,{value:o},l)}const Tt="prism_token",Ne={getToken(){return localStorage.getItem(Tt)},setToken(t){localStorage.setItem(Tt,t)},removeToken(){localStorage.removeItem(Tt)}},Sa="http://localhost:5000/api",Bi=Sa.replace(/\/api\/?$/,""),te=qa.create({baseURL:Sa,headers:{"Content-Type":"application/json"}});te.interceptors.request.use(t=>{const a=Ne.getToken();return a&&(t.headers.Authorization=`Bearer ${a}`),t},t=>Promise.reject(t));te.interceptors.response.use(t=>t,t=>(t.response?.status===401&&Ne.removeToken(),Promise.reject(t)));const Te={AUTH:{LOGIN:"/auth/login",REGISTER:"/auth/register",LOGOUT:"/auth/logout",SEND_OTP:"/auth/resend-otp",RESEND_OTP:"/auth/resend-otp",VERIFY_OTP:"/auth/verify-otp",FORGOT_PASSWORD:"/auth/forgot-password",RESET_PASSWORD:"/auth/reset-password",GOOGLE:"/auth/google",GOOGLE_CODE_LOGIN:"/auth/google/code-login",GOOGLE_TOKEN_LOGIN:"/auth/google/token-login",GOOGLE_CONFIG:"/auth/google/config",ME:"/auth/me",PROFILE:"/auth/profile"},TICKETS:{MY_TICKETS:"/tickets/my-tickets",REQUEST:"/tickets/request",BY_ID:"/tickets/:id",PAYMENT_PROOF:"/tickets/:id/payment-proof",VERIFY:"/tickets/:id/verify"},CONTENT:{EVENTS:"/content/events",EVENT_BY_ID:"/content/events/:id",SPONSORS:"/content/sponsors",FACILITIES:"/content/facilities",CONTACT:"/content/contact"}},Aa="ozilla_local_users";let st=!1;function je(t){return String(t||"").toLowerCase().trim()}function He(t){return String(t||"").trim()}function Be(){try{const t=localStorage.getItem(Aa),a=t?JSON.parse(t):[];return Array.isArray(a)?a:[]}catch{return[]}}function We(t){localStorage.setItem(Aa,JSON.stringify(t))}function Ja(t){const a={sub:t.id,email:t.email,mode:"local-fallback"};return`local.${btoa(JSON.stringify(a))}`}function Et(t){const a=String(t||"");if(!a)return null;if(a.startsWith("local."))try{return JSON.parse(atob(a.slice(6)))}catch{return null}const r=a.split(".");if(r.length===3)try{return JSON.parse(atob(r[1]))}catch{return null}return null}function ut(t){return{id:t.id,firstName:t.firstName,lastName:t.lastName,name:t.name||`${t.firstName||""} ${t.lastName||""}`.trim(),email:t.email,phone:t.phone,role:t.role||"user"}}function ot(t={}){const a=String(t.firstName||"Local").trim()||"Local",r=String(t.lastName||"User").trim()||"User",s=je(t.email||"local@ozillafestival.com"),i=He(t.phone||"+923000000000");return{id:t.id||`local-user-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,firstName:a,lastName:r,name:`${a} ${r}`.trim(),email:s,phone:i,password:String(t.password||""),role:"user"}}function _t(t){return!t?.response&&(t?.code==="ERR_NETWORK"||t?.message?.includes("Network Error")||t?.message?.includes("ECONNREFUSED"))}function Ct(t){return _t(t)?(st=!0,!0):!1}function lt(t){const a=ut(t);return{token:Ja(a),user:a,mode:"local-fallback"}}const De={async login(t){const a=String(t?.email||t?.phone||t?.identifier||"").trim(),r=je(a),s=He(a),i=String(t?.password||"").trim();try{const l=await te.post(Te.AUTH.LOGIN,{email:a,password:i});if(l?.data?.token){const n=Be(),o=n.findIndex(u=>je(u.email)===r||He(u.phone)===s),c={id:l.data.user?.id||`user-${Date.now()}`,firstName:l.data.user?.firstName||"",lastName:l.data.user?.lastName||"",name:l.data.user?.name||"",email:l.data.user?.email?je(l.data.user.email):r,phone:l.data.user?.phone?He(l.data.user.phone):s,password:i,role:l.data.user?.role||"user"};return o>=0?(n[o]=c,We(n)):We([c,...n]),l.data}return l.data}catch(l){const n=Be(),o=n.find(u=>(je(u.email)===r||He(u.phone)===s)&&u.password===i);if(o)return st=!0,lt(o);const c=n.find(u=>je(u.email)===r||He(u.phone)===s);if(c&&c.password!==i){const u=new Error("Invalid credentials. Please check your password.");throw u.response={status:401,data:{message:"Invalid credentials. Please check your password."}},u}throw l}},async register(t){const a=je(t?.email),r=He(t?.phone),s=String(t?.password||"").trim(),i=Be(),l=i.find(o=>je(o.email)===a),n=i.find(o=>He(o.phone)===r);try{const o=await te.post(Te.AUTH.REGISTER,{...t,email:a,phone:r,password:s});if(o?.data?.token){const c=ot({id:o.data.user?.id,firstName:t.firstName,lastName:t.lastName,email:a,phone:r,password:s}),u=i.filter(g=>je(g.email)!==a&&He(g.phone)!==r);We([c,...u])}return o.data}catch(o){if(o?.response?.status===409||o?.response?.data?.message)throw o;if(l){const u=new Error("Account already exists with this email. Please log in.");throw u.response={status:409,data:{message:"Account already exists with this email. Please log in."}},u}if(n){const u=new Error("Account already exists with this phone number. Please log in.");throw u.response={status:409,data:{message:"Account already exists with this phone number. Please log in."}},u}const c=ot({...t,email:a,phone:r,password:s});return We([c,...i]),st=!0,lt(c)}},async sendOtp(t){const a=je(t);try{return(await te.post(Te.AUTH.SEND_OTP,{email:a})).data}catch(r){if(r?.response?.status===404)try{return(await te.post(Te.AUTH.RESEND_OTP,{email:a})).data}catch(s){if(s?.response?.data?.message)throw s}if(r?.response?.data?.message)throw r;if(_t(r)){const s=new Error("Cannot connect to backend server. Please ensure the backend server is running and reachable.");throw s.response={status:503,data:{message:"Cannot connect to backend server. Please ensure the backend server is running and reachable."}},s}throw r}},async resendOtp(t){return this.sendOtp(t)},async verifyOtp(t){const a=je(t?.email),r=String(t?.otp||"").trim();try{return(await te.post(Te.AUTH.VERIFY_OTP,{email:a,otp:r})).data}catch(s){if(s?.response?.data?.message)throw s;if(_t(s)){const i=new Error("Cannot connect to backend server at http://localhost:5000. Please ensure the backend server is running.");throw i.response={status:503,data:{message:"Cannot connect to backend server at http://localhost:5000. Please ensure the backend server is running."}},i}throw s}},async getCurrentUser(){const t=Ne.getToken();if(!t){const r=new Error("Unauthorized");throw r.response={status:401,data:{message:"Unauthorized"}},r}const a=Et(t);if(a?.mode==="local-fallback"||String(t||"").startsWith("local.")){const s=Be().find(i=>i.id===a?.sub||je(i.email)===je(a?.email));if(s)return ut(s)}try{return(await te.get(Te.AUTH.ME)).data}catch(r){const i=Be().find(l=>l.id===a?.sub||je(l.email)===je(a?.email));if(i)return ut(i);throw r}},async logout(){if(Ne.removeToken(),st)return{message:"Logged out successfully"};try{return(await te.post(Te.AUTH.LOGOUT)).data}catch{return{message:"Logged out successfully"}}},async forgotPassword(t){return(await te.post(Te.AUTH.FORGOT_PASSWORD,{email:t})).data},async resetPassword(t){return(await te.post(Te.AUTH.RESET_PASSWORD,t)).data},async getGoogleConfig(){try{return(await te.get(Te.AUTH.GOOGLE_CONFIG)).data?.clientId||null}catch{return null}},async googleAuth(t,a){if(st){if(!a?.email)throw new Error("Google account email is required");const r=ot(a),s=Be();return s.some(i=>i.email===r.email)||We([r,...s]),lt(r)}try{return(await te.post(Te.AUTH.GOOGLE,{token:t,profile:a})).data}catch(r){if(Ct(r)&&a?.email){const s=ot(a);return lt(s)}throw r}},async googleCodeLogin(t,a="postmessage",r){if(st){if(!r?.email)throw new Error("Google account email is required");const s=ot(r),i=Be();return i.some(l=>l.email===s.email)||We([s,...i]),lt(s)}try{return(await te.post(Te.AUTH.GOOGLE_CODE_LOGIN,{code:t,redirectUri:a,profile:r})).data}catch(s){if(Ct(s)&&r?.email){const i=ot(r);return lt(i)}throw s}},async googleTokenLogin(t,a){return this.googleAuth(t,a)},async updateProfile(t){if(st){const a=Ne.getToken(),r=Et(a),s=Be(),i=s.findIndex(o=>o.id===r?.sub||o.email===r?.email);if(i===-1){const o=new Error("Unauthorized");throw o.response={status:401,data:{message:"Unauthorized"}},o}const l=s[i],n={...l,firstName:typeof t?.firstName=="string"?t.firstName.trim():l.firstName,lastName:typeof t?.lastName=="string"?t.lastName.trim():l.lastName,phone:typeof t?.phone=="string"?t.phone.trim():l.phone};return n.name=`${n.firstName||""} ${n.lastName||""}`.trim()||l.name,s[i]=n,We(s),{message:"Profile updated successfully",user:ut(n)}}try{return(await te.put(Te.AUTH.PROFILE,t)).data}catch(a){if(Ct(a)){const r=Ne.getToken(),s=Et(r),i=Be(),l=i.findIndex(c=>c.id===s?.sub||c.email===s?.email);if(l===-1){const c=new Error("Unauthorized");throw c.response={status:401,data:{message:"Unauthorized"}},c}const n=i[l],o={...n,firstName:typeof t?.firstName=="string"?t.firstName.trim():n.firstName,lastName:typeof t?.lastName=="string"?t.lastName.trim():n.lastName,phone:typeof t?.phone=="string"?t.phone.trim():n.phone};return o.name=`${o.firstName||""} ${o.lastName||""}`.trim()||n.name,i[l]=o,We(i),{message:"Profile updated successfully",user:ut(o)}}throw a}}},Pa=m.createContext(null);function Qa({children:t}){const[a,r]=m.useState(null),[s,i]=m.useState(!0);m.useEffect(()=>{l()},[]);const l=async()=>{try{if(Ne.getToken()){const k=await De.getCurrentUser();r(k)}}catch{Ne.removeToken()}finally{i(!1)}},n=async y=>{const k=await De.login(y);return Ne.setToken(k.token),r(k.user),k},o=async y=>{const k=await De.register(y);return Ne.setToken(k.token),r(k.user),k},c=()=>{De.logout().catch(()=>{}),Ne.removeToken(),r(null)},u=a?.role==="admin"||["ubair1100@gmail.com","admin@ozillafestival.com","muhammadubair@gmail.com","admin@prism.com"].includes(String(a?.email||"").toLowerCase().trim()),g={user:a,isAdmin:u,loading:s,login:n,register:o,logout:c,checkAuth:l};return e.jsx(Pa.Provider,{value:g,children:t})}const er="modulepreload",tr=function(t){return"/ozillafest/"+t},Yt={},Bt=function(a,r,s){let i=Promise.resolve();if(r&&r.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),o=n?.nonce||n?.getAttribute("nonce");i=Promise.allSettled(r.map(c=>{if(c=tr(c),c in Yt)return;Yt[c]=!0;const u=c.endsWith(".css"),g=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${g}`))return;const y=document.createElement("link");if(y.rel=u?"stylesheet":er,u||(y.as="script"),y.crossOrigin="",y.href=c,o&&y.setAttribute("nonce",o),document.head.appendChild(y),u)return new Promise((k,A)=>{y.addEventListener("load",k),y.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${c}`)))})}))}function l(n){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=n,window.dispatchEvent(o),!o.defaultPrevented)throw n}return i.then(n=>{for(const o of n||[])o.status==="rejected"&&l(o.reason);return a().catch(l)})};function Ke(){const t=m.useContext(Pa);if(!t)throw new Error("useAuth must be used within an AuthProvider");return t}function ar({children:t}){const{user:a,loading:r}=Ke(),s=Ze();if(r)return e.jsx("div",{className:"flex items-center justify-center min-h-screen",children:"Loading..."});if(!a){const i=`${s.pathname}${s.search}`,l=new URLSearchParams({returnTo:i}).toString();return e.jsx(be,{to:`/login?${l}`,replace:!0})}return t||e.jsx(ht,{})}function St(t,a="/dashboard"){if(!t||typeof t!="string")return a;let r=t.trim();if(r.startsWith("//")||/^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(r))return a;r.startsWith("/ozillafest")&&(r=r.slice(11)),r.startsWith("/")||(r=`/${r}`);const s=r.split("?")[0].replace(/\/$/,"");return!s||s==="/login"||s==="/register"?a:r}function rr({children:t}){const{user:a,loading:r}=Ke(),s=Ze();if(r)return e.jsx("div",{className:"flex items-center justify-center min-h-screen",children:"Loading..."});if(a){const l=new URLSearchParams(s.search).get("returnTo"),n=St(l,"/dashboard");return e.jsx(be,{to:n,replace:!0})}return t||e.jsx(ht,{})}function W(t){if(!t||typeof t!="string"||t.startsWith("http://")||t.startsWith("https://")||t.startsWith("data:")||t.startsWith("blob:"))return t;const a="/ozillafest/",r=a.endsWith("/")?a:`${a}/`,s=t.replace(/^\/+/,"");return s.startsWith("assets/")||s.startsWith("favicon")?`${r}${s}`:t.startsWith("/")?`${r}${s}`:t}function sr({className:t="",nodeColor:a="#EC4899",lineColor:r="236, 72, 153",secondaryColor:s="255, 90, 31",maxDistance:i=135,speed:l=.5}){const n=m.useRef(null);return m.useEffect(()=>{const o=n.current;if(!o)return;const c=o.getContext("2d",{alpha:!0});if(!c)return;let u=null,g=!0,y=!1,k=o.width=o.parentElement?.clientWidth||window.innerWidth,A=o.height=o.parentElement?.clientHeight||window.innerHeight;const p=k<768?18:34,b=340,x=450,M=i*i;let N={x:k/2,y:A/2,active:!1},f={rotX:0,rotY:0,targetRotX:0,targetRotY:0};const d=[];for(let B=0;B<p;B++)d.push({x:(Math.random()-.5)*k*1.1,y:(Math.random()-.5)*A*1.1,z:(Math.random()-.5)*x,vx:(Math.random()-.5)*l*.7,vy:(Math.random()-.5)*l*.7,vz:(Math.random()-.5)*l*.7,radius:Math.random()*1.8+1.2,colorType:Math.random()>.4?"primary":"secondary"});const _=()=>{o.parentElement&&(k=o.width=o.parentElement.clientWidth||window.innerWidth,A=o.height=o.parentElement.clientHeight||window.innerHeight)};window.addEventListener("resize",_,{passive:!0});const L=B=>{if(!g)return;const T=o.getBoundingClientRect();N.x=B.clientX-T.left,N.y=B.clientY-T.top,N.active=!0;const H=(N.x-k/2)/(k/2),X=(N.y-A/2)/(A/2);f.targetRotY=H*.14,f.targetRotX=-X*.14},P=()=>{N.active=!1,f.targetRotX=0,f.targetRotY=0};window.addEventListener("mousemove",L,{passive:!0}),window.addEventListener("mouseleave",P,{passive:!0});const h=()=>{if(!g||document.hidden){y=!1;return}c.clearRect(0,0,k,A),f.rotX+=(f.targetRotX-f.rotX)*.05,f.rotY+=(f.targetRotY-f.rotY)*.05;const B=Math.cos(f.rotY),T=Math.sin(f.rotY),H=Math.cos(f.rotX),X=Math.sin(f.rotX),U=k/2,F=A/2,O=k*.65,Y=A*.65,de=x*.55,S=[];for(let D=0;D<p;D++){const C=d[D];C.x+=C.vx,C.y+=C.vy,C.z+=C.vz,(C.x<-O||C.x>O)&&(C.vx*=-1),(C.y<-Y||C.y>Y)&&(C.vy*=-1),(C.z<-de||C.z>de)&&(C.vz*=-1);const $=C.x*B-C.z*T,ae=C.z*B+C.x*T,Q=C.y*H-ae*X,ce=ae*H+C.y*X,re=ce+x;if(re<=0)continue;const oe=b/(b+re*.65),me=U+$*oe,ye=F+Q*oe,fe=Math.max(.18,Math.min(.85,(ce+x)/(x*1.4)));S.push({x:me,y:ye,scale:oe,alpha:fe,radius:Math.max(1.2,C.radius*oe),colorType:C.colorType})}const z=S.length;for(let D=0;D<z;D++){const C=S[D];let $=0;for(let ae=D+1;ae<z&&$<3;ae++){const Q=S[ae],ce=C.x-Q.x,re=C.y-Q.y,oe=ce*ce+re*re;if(oe<M){$++;const me=Math.sqrt(oe),ye=(1-me/i)*.4*Math.min(C.alpha,Q.alpha),fe=C.colorType==="primary"?r:s;c.beginPath(),c.moveTo(C.x,C.y),c.lineTo(Q.x,Q.y),c.strokeStyle=`rgba(${fe}, ${ye})`,c.lineWidth=Math.max(.5,(1-me/i)*1.2),c.stroke()}}}for(let D=0;D<z;D++){const C=S[D],$=C.colorType==="primary"?`rgba(${r}, ${C.alpha})`:`rgba(${s}, ${C.alpha})`;c.beginPath(),c.arc(C.x,C.y,C.radius,0,Math.PI*2),c.fillStyle=$,c.fill()}u=requestAnimationFrame(h)},v=()=>{!y&&g&&!document.hidden&&(y=!0,u=requestAnimationFrame(h))},I=()=>{y=!1,u&&(cancelAnimationFrame(u),u=null)};let R=null;"IntersectionObserver"in window?(R=new IntersectionObserver(([B])=>{g=B.isIntersecting,g?v():I()},{threshold:.05}),R.observe(o)):v();const q=()=>{document.hidden?I():g&&v()};return document.addEventListener("visibilitychange",q),()=>{I(),window.removeEventListener("resize",_),window.removeEventListener("mousemove",L),window.removeEventListener("mouseleave",P),document.removeEventListener("visibilitychange",q),R&&R.disconnect()}},[a,r,s,i,l]),e.jsx("canvas",{ref:n,className:`plexus-net-canvas ${t}`,"aria-hidden":"true",style:{position:"absolute",inset:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:1,willChange:"transform"}})}const $t=gt.memo(sr);function Lt({children:t}){const a=Ze(),r=a.pathname==="/login",s=a.pathname==="/register",[i,l]=m.useState({x:0,y:0}),[n,o]=m.useState({x:50,y:42}),c=g=>{if(g.pointerType==="touch")return;const y=g.currentTarget.getBoundingClientRect(),k=(g.clientX-y.left)/y.width,A=(g.clientY-y.top)/y.height;l({x:(.5-A)*10,y:(k-.5)*10}),o({x:k*100,y:A*100})},u=()=>{l({x:0,y:0}),o({x:50,y:42})};return e.jsxs("main",{className:`kx-page auth-page ${r?"auth-page-login":""} ${s?"auth-page-register":""}`,children:[e.jsx($t,{nodeColor:"#EC4899",lineColor:"236, 72, 153",secondaryColor:"255, 90, 31",maxDistance:130,speed:.4}),e.jsx("div",{className:"kx-grid","aria-hidden":"true"}),e.jsx("div",{className:"kx-noise","aria-hidden":"true"}),e.jsx("div",{className:"kx-halo kx-halo-top","aria-hidden":"true"}),e.jsx("div",{className:"kx-halo kx-halo-bottom","aria-hidden":"true"}),e.jsx("div",{className:"kx-orb kx-orb-left","aria-hidden":"true"}),e.jsx("div",{className:"kx-orb kx-orb-right","aria-hidden":"true"}),e.jsxs("section",{className:`kx-stage ${s?"kx-stage-wide":""}`,children:[e.jsx("div",{className:"kx-tilt",onPointerMove:c,onPointerLeave:u,onPointerCancel:u,style:{transform:`rotateX(${i.x}deg) rotateY(${i.y}deg)`},children:e.jsxs("div",{className:"kx-card-shell",children:[e.jsx("div",{className:"kx-shadow","aria-hidden":"true"}),e.jsxs("div",{className:"kx-runners","aria-hidden":"true",children:[e.jsx("span",{className:"kx-runner kx-runner-top"}),e.jsx("span",{className:"kx-runner kx-runner-right"}),e.jsx("span",{className:"kx-runner kx-runner-bottom"}),e.jsx("span",{className:"kx-runner kx-runner-left"})]}),e.jsxs("article",{className:"kx-card",children:[e.jsx("div",{className:"kx-pointer-glow","aria-hidden":"true",style:{left:`${n.x}%`,top:`${n.y}%`}}),e.jsx("div",{className:"kx-card-pattern","aria-hidden":"true"}),e.jsxs("header",{className:"kx-header",children:[e.jsx(Z,{to:"/",className:"kx-logo-link","aria-label":"OZILLA FEST Home",children:e.jsxs("div",{className:"kx-logo",children:[e.jsx("img",{src:W("/assets/ozilla/logo.png"),alt:"OZILLA FEST Logo",onError:g=>{g.currentTarget.src=W("/assets/logo.jpeg")}}),e.jsx("i",{"aria-hidden":"true"})]})}),e.jsx("span",{className:"kx-tag",children:"PAKISTAN'S PREMIER MUSIC FESTIVAL"}),e.jsx("h1",{className:"kx-title",children:r?"Welcome Back":"Join OZILLA FEST"}),e.jsx("p",{className:"kx-subtitle",children:r?"Sign in to access your passes, tickets & workspace":"Create your account for the ultimate festival experience"}),e.jsxs("div",{className:"kx-tabs",children:[e.jsx(Z,{to:`/login${a.search}`,className:`kx-tab-btn ${r?"active":""}`,children:"Sign In"}),e.jsx(Z,{to:`/register${a.search}`,className:`kx-tab-btn ${s?"active":""}`,children:"Create Account"})]})]}),e.jsx("div",{className:"kx-card-body",children:t||e.jsx(ht,{})})]})]})}),e.jsxs("div",{className:"auth-center-ribbon",children:[e.jsx("span",{children:"📅 Nov 01, 2026"}),e.jsx("span",{children:"📍 Lahore, Pakistan"}),e.jsx("span",{children:"⭐ 10,000+ Fans"})]})]})]})}function ir({children:t,className:a="",onClick:r,mouseX:s,spring:i,distance:l,magnification:n,baseItemSize:o,label:c}){const u=m.useRef(null),g=ja(0),y=Wt(s,x=>{if(x===1/0||!u.current)return l;const M=u.current.getBoundingClientRect(),N=M.left+M.width/2;return x-N}),k=Wt(y,[-l,0,l],[o,n,o]),A=Ba(k,i),w=x=>{(x.key==="Enter"||x.key===" ")&&(x.preventDefault(),r?.())},p=()=>{g.set(1)},b=()=>{g.set(0)};return e.jsx(J.div,{ref:u,style:{width:A,height:A},onHoverStart:p,onHoverEnd:b,onFocus:p,onBlur:b,onClick:r,className:`dock-item ${a}`,tabIndex:0,role:"button","aria-haspopup":"true","aria-label":c,onKeyDown:w,children:m.Children.map(t,x=>m.cloneElement(x,{isHovered:g}))})}function nr({children:t,className:a="",...r}){const{isHovered:s}=r,[i,l]=m.useState(!1);return m.useEffect(()=>{if(!s)return;const n=s.on("change",o=>{l(o===1)});return()=>n()},[s]),e.jsx($a,{children:i&&e.jsx(J.div,{initial:{opacity:0,y:-4,scale:.85},animate:{opacity:1,y:0,scale:1},exit:{opacity:0,y:-4,scale:.85},transition:{duration:.15},className:`dock-label ${a}`,role:"tooltip",style:{x:"-50%"},children:t})})}function or({children:t,className:a=""}){return e.jsx("div",{className:`dock-icon ${a}`,children:t})}function lr({items:t,className:a="",spring:r={mass:.1,stiffness:220,damping:18},magnification:s=52,distance:i=120,panelHeight:l=44,baseItemSize:n=36}){const o=ja(1/0),c=Ze(),u=ct();return e.jsx("div",{className:"dock-outer",children:e.jsx(J.div,{onMouseMove:g=>o.set(g.clientX),onMouseLeave:()=>o.set(1/0),className:`dock-panel ${a}`,style:{height:l},role:"toolbar","aria-label":"Application dock",children:t.map((g,y)=>{const k=c.pathname===g.to||g.to!=="/"&&c.pathname.startsWith(g.to)||g.to==="/"&&c.pathname==="/dashboard";return e.jsxs(ir,{onClick:()=>{g.onClick?.(),g.to&&u(g.to)},className:`${g.className||""} ${k?"active":""}`,mouseX:o,spring:r,distance:i,magnification:s,baseItemSize:n,label:g.label,children:[e.jsx(or,{children:g.icon}),e.jsx(nr,{children:g.label})]},g.to||y)})})})}function ve({path:t,size:a=24,viewBox:r="0 0 24 24",fill:s="none",stroke:i="currentColor",strokeWidth:l=1.8}){return e.jsx("svg",{width:a,height:a,viewBox:r,fill:s,stroke:i,strokeWidth:l,strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",children:t})}const wt={home:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 10.5 12 3l9 7.5"}),e.jsx("path",{d:"M5 9.5V21h14V9.5"}),e.jsx("path",{d:"M9 21v-6h6v6"})]})}),calendar:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"3",y:"4",width:"18",height:"18",rx:"2"}),e.jsx("path",{d:"M16 2v4M8 2v4M3 10h18"})]})}),mic:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"9",y:"2",width:"6",height:"12",rx:"3"}),e.jsx("path",{d:"M5 10a7 7 0 0 0 14 0"}),e.jsx("path",{d:"M12 17v5"})]})}),clock:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("circle",{cx:"12",cy:"12",r:"9"}),e.jsx("path",{d:"M12 7v5l3 3"})]})}),history:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 12a9 9 0 1 0 3-6.7"}),e.jsx("path",{d:"M3 4v5h5"}),e.jsx("path",{d:"M12 8v4l3 2"})]})}),hotels:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M2 21V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v16"}),e.jsx("path",{d:"M2 21h20"}),e.jsx("path",{d:"M6 7h4M6 11h4M14 7h4M14 11h4M6 15h4M14 15h4M6 19h4M14 19h4"})]})}),restaurants:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M4 21v-8a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v8"}),e.jsx("path",{d:"M2 21h20"}),e.jsx("path",{d:"M8 9V3M12 9V3M16 9V3"}),e.jsx("path",{d:"M4 13h16"})]})}),discounts:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M20.6 13.4 12 22 2 12 3.5 4.5 11 3l9.6 10.4Z"}),e.jsx("circle",{cx:"8",cy:"8",r:"1.5"}),e.jsx("path",{d:"m15.5 5.5 4 4"})]})}),facilities:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 21V7l6-4 6 4v14"}),e.jsx("path",{d:"M15 21V9h6v12"}),e.jsx("path",{d:"M3 21h18"}),e.jsx("path",{d:"M7 10h3M7 14h3M7 18h3"})]})}),sponsorship:e.jsx(ve,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M12 21s-7.5-4.6-10-9.2C.6 8.6 3 5 6.5 5c2 0 3.5 1 5.5 3 2-2 3.5-3 5.5-3C21 5 23.4 8.6 22 11.8 19.5 16.4 12 21 12 21Z"})})}),sparkle:e.jsx(ve,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"m12 3-1.9 5.8a2 2 0 0 1-1.3 1.3L3 12l5.8 1.9a2 2 0 0 1 1.3 1.3L12 21l1.9-5.8a2 2 0 0 1 1.3-1.3L21 12l-5.8-1.9a2 2 0 0 1-1.3-1.3Z"})})}),ticket:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M3 9V6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v3a3 3 0 0 0 0 6v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3a3 3 0 0 0 0-6Z"}),e.jsx("path",{d:"M13 5v2M13 11v2M13 17v2"})]})}),contact:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m3 7 9 6 9-6"})]})}),shield:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("path",{d:"M12 22s8-3.6 8-10V5l-8-3-8 3v7c0 6.4 8 10 8 10Z"}),e.jsx("path",{d:"m9 11.5 2 2 4-4"})]})}),user:e.jsx(ve,{path:e.jsxs(e.Fragment,{children:[e.jsx("circle",{cx:"12",cy:"8",r:"4"}),e.jsx("path",{d:"M4 21c0-4 4-6 8-6s8 2 8 6"})]})}),menu:e.jsx(ve,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M3 6h18M3 12h18M3 18h18"})})}),close:e.jsx(ve,{path:e.jsx(e.Fragment,{children:e.jsx("path",{d:"M5 5l14 14M19 5 5 19"})})})},cr=[{label:"Home",to:"/#home",icon:"home"},{label:"Ticket Portal",to:"/tickets",icon:"ticket",cta:!0},{label:"Schedule",to:"/schedule",icon:"calendar"},{label:"Lineup",to:"/#celebrities",icon:"mic"},{label:"VIP Passes",to:"/#vip-experience",icon:"ticket"},{label:"Hotels",to:"/hotels",icon:"hotels"},{label:"Facilities",to:"/#facilities",icon:"facilities"},{label:"Sponsorship",to:"/#sponsorship",icon:"sponsorship"},{label:"Atmosphere",to:"/#about",icon:"sparkle"},{label:"My Tickets",to:"/tickets/my-tickets",icon:"ticket"}];function Xt(t){return t?.firstName||t?.name||t?.email||"Account"}function Ta(){const{user:t,isAdmin:a,logout:r}=Ke(),s=ct(),i=Ze(),[l,n]=m.useState(!1),[o,c]=m.useState(!1),[u,g]=m.useState(!1),y=m.useRef(null),k=gt.useMemo(()=>{const p=[...cr];return a&&p.push({label:"Admin",to:"/admin/dashboard",icon:"shield"}),p},[a]),A=gt.useMemo(()=>k.map(p=>({label:p.label,to:p.to,icon:wt[p.icon],className:p.cta?"dock-item-cta":""})),[k]);m.useEffect(()=>{const p=()=>{y.current||(y.current=window.requestAnimationFrame(()=>{n(window.scrollY>12),y.current=null}))};return p(),window.addEventListener("scroll",p,{passive:!0}),()=>{window.removeEventListener("scroll",p),y.current&&window.cancelAnimationFrame(y.current)}},[]),m.useEffect(()=>{c(!1),g(!1)},[i.pathname]);const w=()=>{r(),s("/")};return e.jsxs(e.Fragment,{children:[e.jsx("header",{className:`dock-site-header ${l?"scrolled":""}`,children:e.jsxs("div",{className:"dock-site-header-inner",children:[e.jsxs(Z,{to:"/",className:"dock-site-brand","aria-label":"Ozilla Fest home",children:[e.jsx("span",{className:"dock-site-brand-logo",children:e.jsx("img",{src:W("/assets/ozilla/logo.png"),alt:"Ozilla Fest",onError:p=>{p.currentTarget.src=W("/assets/company-logo.jpeg")}})}),e.jsx("div",{className:"dock-site-brand-text",children:e.jsx("strong",{children:"OZILLA FEST"})})]}),e.jsx("div",{className:"dock-header-center",children:e.jsx(lr,{items:A,className:"dock-nav",magnification:58,distance:140,panelHeight:62,baseItemSize:44,spring:{mass:.1,stiffness:260,damping:19}})}),e.jsxs("div",{className:"dock-site-header-actions",children:[t?e.jsxs("div",{className:`dock-account ${u?"open":""}`,children:[e.jsxs("button",{type:"button",className:"dock-account-button",onClick:()=>g(p=>!p),"aria-expanded":u,"aria-label":"Account menu",children:[e.jsx("span",{className:"dock-account-avatar",children:String(Xt(t)).slice(0,1).toUpperCase()}),e.jsx("strong",{children:Xt(t)})]}),e.jsxs("div",{className:"dock-account-menu",children:[e.jsx(Z,{to:"/account",children:"Account"}),e.jsx(Z,{to:"/tickets/my-tickets",children:"My Tickets"}),a&&e.jsx(Z,{to:"/admin/dashboard",children:"Admin Dashboard"}),e.jsx("button",{type:"button",onClick:w,children:"Logout"})]})]}):e.jsxs(e.Fragment,{children:[e.jsx(Z,{to:"/login",className:"dock-site-login-btn",children:"Login"}),e.jsx(Z,{to:"/register",className:"dock-site-register-btn",children:"Sign Up"})]}),e.jsx("button",{type:"button",className:`dock-mobile-toggle ${o?"open":""}`,"aria-label":o?"Close menu":"Open menu","aria-expanded":o,onClick:()=>c(p=>!p),children:o?wt.close:wt.menu})]})]})}),e.jsx("div",{className:`dock-mobile-overlay ${o?"open":""}`,onClick:()=>c(!1),children:e.jsxs("div",{className:`dock-mobile-panel ${o?"open":""}`,onClick:p=>p.stopPropagation(),children:[e.jsxs("div",{className:"dock-mobile-header",children:[e.jsx("div",{children:e.jsx("h2",{children:"Menu"})}),e.jsx("button",{type:"button",className:"dock-mobile-close",onClick:()=>c(!1),"aria-label":"Close menu",children:"x"})]}),e.jsx("div",{className:"dock-mobile-links",children:k.map(p=>e.jsxs(Ua,{to:p.to,className:p.cta?"dock-mobile-link-cta":"",onClick:()=>c(!1),children:[e.jsx("span",{className:"dock-mobile-link-icon",children:wt[p.icon]}),e.jsx("span",{children:p.label}),p.cta&&e.jsx("span",{className:"dock-mobile-badge",children:"PASSES"})]},p.to))}),e.jsx("div",{className:"dock-mobile-auth",children:t?e.jsx("button",{type:"button",onClick:()=>{w(),c(!1)},children:"Logout"}):e.jsxs(e.Fragment,{children:[e.jsx(Z,{to:"/login",onClick:()=>c(!1),children:"Login"}),e.jsx(Z,{to:"/register",onClick:()=>c(!1),children:"Sign Up"})]})})]})})]})}const dr=[{label:"Headline Artists",href:"/#celebrities"},{label:"VIP & Ticket Passes",href:"/tickets"},{label:"The Festival Vibe",href:"/#about"},{label:"World-Class Facilities",href:"/#facilities"},{label:"My Digital Passes",href:"/tickets/my-tickets"}],pr=[{label:"Instagram",href:"https://www.instagram.com/ozillafestival"}],mr=[{label:"Sponsorship Inquiries",href:"/#sponsorship"},{label:"QR Ticket Verification",href:"/verification/OZ-2026-PREVIEW"},{label:"Hotel & Travel Partners",href:"/hotels"},{label:"Privacy & Terms",href:"/privacy"}];function Ea(){return e.jsxs(e.Fragment,{children:[e.jsxs("footer",{className:"kex-footer",children:[e.jsx("div",{className:"kex-bg-glow","aria-hidden":"true"}),e.jsx("div",{className:"kex-bg-overlay","aria-hidden":"true"}),e.jsxs("div",{className:"kex-container",children:[e.jsxs("div",{className:"kex-nav-grid",children:[e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"MENU"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:dr.map(t=>e.jsx("li",{children:t.href.startsWith("/#")?e.jsx("a",{href:t.href,children:t.label}):e.jsx(Z,{to:t.href,children:t.label})},t.label))})]}),e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"SOCIALS"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:pr.map(t=>e.jsx("li",{children:e.jsx("a",{href:t.href,target:"_blank",rel:"noopener noreferrer",children:t.label})},t.label))})]}),e.jsxs("div",{className:"kex-col",children:[e.jsx("h3",{className:"kex-col-title",children:"RESOURCES"}),e.jsx("div",{className:"kex-col-line"}),e.jsx("ul",{className:"kex-col-list",children:mr.map(t=>e.jsx("li",{children:t.href.startsWith("/#")?e.jsx("a",{href:t.href,children:t.label}):e.jsx(Z,{to:t.href,children:t.label})},t.label))}),e.jsx("div",{className:"kex-action-wrap",children:e.jsx("a",{href:"mailto:ozillafestival@gmail.com",className:"kex-pill-btn",children:"Send a message"})})]})]}),e.jsx("div",{className:"kex-hero-word-wrap","aria-hidden":"true",children:e.jsx("span",{className:"kex-hero-word",children:"OZILLA FEST"})}),e.jsxs("div",{className:"kex-bottom-row",children:[e.jsxs("div",{className:"kex-bottom-links",children:[e.jsx(Z,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"·"}),e.jsx(Z,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"·"}),e.jsx(Z,{to:"/verification/OZ-2026-PREVIEW",children:"QR Verification"})]}),e.jsx("p",{className:"kex-bottom-copy",children:"© 2026 OZILLA FEST & Prism Entertainment. All rights reserved."})]})]})]}),e.jsx("style",{children:fr})]})}const fr=`
...
`;function Fe({children:t}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-transparent text-white overflow-x-hidden w-full relative z-[1]",children:[e.jsx(Ta,{}),e.jsx("div",{className:"flex-1 w-full overflow-x-hidden bg-transparent",children:t||e.jsx(ht,{})}),e.jsx(Ea,{})]})}function It({children:t}){return e.jsxs("div",{className:"min-h-screen flex flex-col bg-transparent text-white overflow-x-hidden w-full font-['Plus_Jakarta_Sans',sans-serif] dock-app-shell relative z-[1]",children:[e.jsx(Ta,{}),e.jsx("main",{className:"flex-1 px-4 sm:px-6 py-6 md:py-10 app-main app-content dock-app-content bg-transparent",children:e.jsx("div",{className:"w-full max-w-[1280px] mx-auto",children:t||e.jsx(ht,{})})}),e.jsx(Ea,{})]})}function Ca(){return e.jsx("div",{className:"flex items-center justify-center min-h-[200px]",children:e.jsx("div",{className:"animate-spin rounded-full h-16 w-16 border-4 border-purple-600 border-t-transparent"})})}let vt;function ur(){return window.google?.accounts?.id||window.google?.accounts?.oauth2?Promise.resolve(window.google):vt||(vt=new Promise((t,a)=>{const r=document.querySelector('script[data-google-identity="true"]');if(r){r.addEventListener("load",()=>t(window.google),{once:!0}),r.addEventListener("error",()=>a(new Error("Failed to load Google Identity script")),{once:!0});return}const s=document.createElement("script");s.src="https://accounts.google.com/gsi/client",s.async=!0,s.defer=!0,s.dataset.googleIdentity="true",s.onload=()=>t(window.google),s.onerror=()=>a(new Error("Failed to load Google Identity script")),document.head.appendChild(s)}),vt)}async function gr(t){const a=await fetch("https://www.googleapis.com/oauth2/v3/userinfo",{headers:{Authorization:`Bearer ${t}`}});if(!a.ok)throw new Error("Failed to fetch Google profile");return a.json()}async function La({clientId:t,onProfile:a,onError:r}){if(!t||t.includes("placeholder")||t.includes("your_google"))throw new Error("Google Client ID is not configured. Please add GOOGLE_CLIENT_ID in Render or VITE_GOOGLE_CLIENT_ID in client/.env");if(await ur(),!window.google?.accounts?.oauth2?.initTokenClient)throw new Error("Google Identity Services library is unavailable");return new Promise((s,i)=>{window.google.accounts.oauth2.initTokenClient({client_id:t,scope:"openid email profile",prompt:"select_account",callback:async n=>{try{if(n?.error)throw n.error==="popup_closed_by_user"?new Error("Google sign-in was cancelled"):new Error(n.error_description||n.error||"Google login failed");if(!n?.access_token)throw new Error("Google sign-in was cancelled");const o=await gr(n.access_token);if(!o?.email)throw new Error("Could not retrieve email from selected Google account");a&&await a(o,n.access_token),s(o)}catch(o){r&&r(o),i(o)}},error_callback:n=>{const o=new Error(n?.message||"Google account chooser popup failed");r&&r(o),i(o)}}).requestAccessToken({prompt:"select_account"})})}function hr(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m4 7 8 6 8-6"})]})}function xr(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"4",y:"10",width:"16",height:"11",rx:"2"}),e.jsx("path",{d:"M8 10V7a4 4 0 0 1 8 0v3"})]})}function br({hidden:t=!1,...a}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...a,children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"}),t&&e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}function yr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M5 12h14M13 6l6 6-6 6"})})}function wr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"m5 12 4 4L19 6"})})}function vr(t){return e.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",...t,children:[e.jsx("path",{fill:"#4285F4",d:"M21.6 12.23c0-.71-.06-1.4-.18-2.06H12v3.9h5.38a4.6 4.6 0 0 1-2 3.01v2.53h3.23c1.9-1.75 2.99-4.32 2.99-7.38Z"}),e.jsx("path",{fill:"#34A853",d:"M12 22c2.7 0 4.97-.9 6.62-2.39l-3.23-2.53c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.61-4.13H3.05v2.61A10 10 0 0 0 12 22Z"}),e.jsx("path",{fill:"#FBBC05",d:"M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.3.31-1.91V7.48H3.05A10 10 0 0 0 2 12c0 1.61.39 3.14 1.05 4.52l3.34-2.61Z"}),e.jsx("path",{fill:"#EA4335",d:"M12 5.96c1.47 0 2.79.51 3.82 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.95 5.48l3.34 2.61C7.18 7.72 9.39 5.96 12 5.96Z"})]})}function kr(){const t=ct(),a=Ze(),{login:r,checkAuth:s}=Ke(),i="",l=new URLSearchParams(a.search).get("returnTo"),n=St(l,"/dashboard"),[o,c]=m.useState({email:"",password:""}),[u,g]=m.useState(null),[y,k]=m.useState(!1),[A,w]=m.useState(!0),[p,b]=m.useState(""),[x,M]=m.useState(""),[N,f]=m.useState(!1),[d,_]=m.useState(!1),L=v=>{M(""),c(I=>({...I,[v.target.name]:v.target.value}))},P=async v=>{if(v.preventDefault(),!(N||d)){b(""),M(""),f(!0);try{await r({email:String(o.email||"").trim().toLowerCase(),password:String(o.password||"")}),M("Login successful. Preparing your festival workspace..."),await new Promise(I=>setTimeout(I,450)),t(n)}catch(I){b(I.response?.data?.message||I.message||"Invalid email or password")}finally{f(!1)}}},h=async()=>{b(""),M(""),_(!0);try{let v=i;if((!v||v.includes("placeholder")||v.includes("your_google"))&&(v=await De.getGoogleConfig()),!v||v.includes("placeholder")||v.includes("your_google"))throw new Error("Google OAuth is not configured on the server. Please add GOOGLE_CLIENT_ID to Render or client/.env");await La({clientId:v,onProfile:async(I,R)=>{const q=await De.googleAuth(R,I);Ne.setToken(q.token),await s(),M(`Google sign-in successful as ${I.email}. Redirecting...`),await new Promise(B=>setTimeout(B,450)),t(n)}})}catch(v){const I=v.response?.data?.message||v.message||"Google sign-in failed";!I.toLowerCase().includes("cancel")&&!I.toLowerCase().includes("closed")&&b(I)}finally{_(!1)}};return e.jsxs("form",{onSubmit:P,className:"kx-form",children:[p&&e.jsx("div",{className:"kx-alert kx-alert-error",role:"alert",children:p}),x&&e.jsx("div",{className:"kx-alert kx-alert-success",role:"alert",children:x}),e.jsxs("button",{type:"button",className:"kx-google",onClick:h,disabled:d||N,children:[e.jsx(vr,{}),e.jsx("span",{children:d?"Connecting to Google...":"Continue with Google"}),e.jsx("i",{"aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-divider",children:[e.jsx("span",{}),e.jsx("em",{children:"or sign in with email"}),e.jsx("span",{})]}),e.jsxs("label",{className:`kx-field ${u==="email"?"kx-focused":""}`,children:[e.jsx(hr,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"email",value:o.email,placeholder:"Email or Mobile Number",autoComplete:"username",required:!0,onChange:L,onFocus:()=>g("email"),onBlur:()=>g(null)}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("label",{className:`kx-field ${u==="password"?"kx-focused":""}`,children:[e.jsx(xr,{className:"kx-field-icon"}),e.jsx("input",{type:y?"text":"password",name:"password",value:o.password,placeholder:"Password",autoComplete:"current-password",required:!0,onChange:L,onFocus:()=>g("password"),onBlur:()=>g(null)}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>k(v=>!v),"aria-label":y?"Hide password":"Show password",children:e.jsx(br,{hidden:y})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-meta",children:[e.jsxs("label",{className:"kx-remember",children:[e.jsx("input",{type:"checkbox",checked:A,onChange:v=>w(v.target.checked)}),e.jsx("span",{className:"kx-checkbox",children:A&&e.jsx(wr,{})}),e.jsx("span",{children:"Remember me"})]}),e.jsx("a",{href:"#forgot-password",className:"kx-forgot-link",children:"Forgot password?"})]}),e.jsxs("button",{className:"kx-sign-in",type:"submit",disabled:N||d,children:[e.jsx("span",{className:"kx-button-glow","aria-hidden":"true"}),e.jsx("span",{className:"kx-button-sheen","aria-hidden":"true"}),N?e.jsx("span",{className:"kx-spinner","aria-label":"Signing in..."}):e.jsxs("span",{className:"kx-button-copy",children:["Sign in",e.jsx(yr,{})]})]}),e.jsxs("p",{className:"kx-signup",children:["Don't have an account?"," ",e.jsx(Z,{to:`/register?${new URLSearchParams({returnTo:n}).toString()}`,children:"Create account"})]}),e.jsxs("div",{className:"kx-trust-grid","aria-label":"Security indicators",children:[e.jsx("span",{children:"🔒 Secure Login"}),e.jsx("span",{children:"⚡ Fast Access"}),e.jsx("span",{children:"🛡️ Protected"}),e.jsx("span",{children:"✓ Verified"})]})]})}function jr(){return e.jsxs("div",{className:"auth-form-container",children:[e.jsx(kr,{}),e.jsxs("div",{className:"auth-footer-links",children:[e.jsx(Z,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"•"}),e.jsx(Z,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"•"}),e.jsx(Z,{to:"/#contact",children:"Need Help?"})]})]})}function Zt(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("path",{d:"M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"}),e.jsx("circle",{cx:"12",cy:"7",r:"4"})]})}function Nr(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"3",y:"5",width:"18",height:"14",rx:"2"}),e.jsx("path",{d:"m4 7 8 6 8-6"})]})}function Sr(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"})})}function Kt(t){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:[e.jsx("rect",{x:"4",y:"10",width:"16",height:"11",rx:"2"}),e.jsx("path",{d:"M8 10V7a4 4 0 0 1 8 0v3"})]})}function Jt({hidden:t=!1,...a}){return e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":"true",...a,children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"}),t&&e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]})}function Ar(t){return e.jsx("svg",{viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",...t,children:e.jsx("path",{d:"M5 12h14M13 6l6 6-6 6"})})}function Pr(t){return e.jsxs("svg",{viewBox:"0 0 24 24","aria-hidden":"true",...t,children:[e.jsx("path",{fill:"#4285F4",d:"M21.6 12.23c0-.71-.06-1.4-.18-2.06H12v3.9h5.38a4.6 4.6 0 0 1-2 3.01v2.53h3.23c1.9-1.75 2.99-4.32 2.99-7.38Z"}),e.jsx("path",{fill:"#34A853",d:"M12 22c2.7 0 4.97-.9 6.62-2.39l-3.23-2.53c-.9.6-2.04.96-3.39.96-2.61 0-4.82-1.76-5.61-4.13H3.05v2.61A10 10 0 0 0 12 22Z"}),e.jsx("path",{fill:"#FBBC05",d:"M6.39 13.91A6.02 6.02 0 0 1 6.08 12c0-.66.11-1.3.31-1.91V7.48H3.05A10 10 0 0 0 2 12c0 1.61.39 3.14 1.05 4.52l3.34-2.61Z"}),e.jsx("path",{fill:"#EA4335",d:"M12 5.96c1.47 0 2.79.51 3.82 1.5l2.87-2.87A9.63 9.63 0 0 0 12 2a10 10 0 0 0-8.95 5.48l3.34 2.61C7.18 7.72 9.39 5.96 12 5.96Z"})]})}const Qt=()=>new Promise(t=>setTimeout(t,450));function Tr(){const t=ct(),a=Ze(),{register:r,checkAuth:s}=Ke(),i="",l=new URLSearchParams(a.search).get("returnTo"),n=St(l,"/dashboard"),[o,c]=m.useState({firstName:"",lastName:"",email:"",phone:"",password:"",confirmPassword:""}),[u,g]=m.useState(null),[y,k]=m.useState(""),[A,w]=m.useState(!1),[p,b]=m.useState(!1),[x,M]=m.useState(!1),[N,f]=m.useState(!1),[d,_]=m.useState(0),[L,P]=m.useState(""),[h,v]=m.useState(""),[I,R]=m.useState(!1),[q,B]=m.useState(!1),[T,H]=m.useState(!1),[X,U]=m.useState(!1),[F,O]=m.useState({email:!1,phone:!1,password:!1,confirmPassword:!1}),Y=/^\S+@\S+\.\S+$/.test(o.email),de=/^(\+?\d{1,3})?[\s-]?\d{10,12}$/.test(o.phone.replace(/\s+/g,"")),S={upper:/[A-Z]/.test(o.password),lower:/[a-z]/.test(o.password),number:/\d/.test(o.password),special:/[^A-Za-z0-9]/.test(o.password),length:o.password.length>=8},z=Object.values(S).filter(Boolean).length,D=z===5,C=o.confirmPassword.length>0&&o.password===o.confirmPassword,$=o.password.length>0,ae=m.useMemo(()=>$?z<=2?{label:"Weak",className:"weak",percent:28}:z===3?{label:"Medium",className:"medium",percent:52}:z===4?{label:"Strong",className:"strong",percent:78}:{label:"Excellent",className:"excellent",percent:100}:{label:"Start typing",className:"empty",percent:8},[$,z]),Q=[{key:"upper",text:"Uppercase letter",met:S.upper},{key:"lower",text:"Lowercase letter",met:S.lower},{key:"number",text:"Number",met:S.number},{key:"special",text:"Special character",met:S.special},{key:"length",text:"8+ characters",met:S.length}],ce=o.firstName.trim()&&o.lastName.trim()&&Y&&de&&D&&C&&p&&!I&&!q;m.useEffect(()=>{if(d<=0)return;const j=window.setInterval(()=>{_(E=>Math.max(0,E-1))},1e3);return()=>window.clearInterval(j)},[d]);const re=()=>{P(""),v("")},oe=j=>{const{name:E,value:ne}=j.target;re(),c(ee=>({...ee,[E]:ne})),E==="email"&&(k(""),w(!1),b(!1),_(0)),E in F&&ne.length>0&&O(ee=>({...ee,[E]:!0}))},me=j=>{const{name:E}=j.target;g(null),E in F&&O(ne=>({...ne,[E]:!0}))},ye=async()=>{if(re(),!Y){O(j=>({...j,email:!0})),P("Please enter a valid email address before sending OTP.");return}M(!0);try{const j=await De.sendOtp(o.email);j?.emailDelivery==="failed"||typeof j?.message=="string"&&j.message.toLowerCase().includes("delivery failed")?(w(!1),P(j.emailError||"Email delivery failed: SMTP credentials (SMTP_USER and SMTP_PASS) are not configured on the backend server.")):(w(!0),b(!1),_(60),k(""),v(j.message||"OTP code has been sent to your email. Please check your inbox."))}catch(j){P(j.response?.data?.message||j.message||"Unable to send OTP.")}finally{M(!1)}},fe=async()=>{if(re(),!Y||y.trim().length<4){P("Enter the OTP sent to your email.");return}f(!0);try{const j=await De.verifyOtp({email:o.email,otp:y});b(!0),v(j.message||"Email verified successfully.")}catch(j){b(!1),P(j.response?.data?.message||j.message||"OTP verification failed.")}finally{f(!1)}},se=async j=>{if(j.preventDefault(),re(),!Y){O(E=>({...E,email:!0})),P("Please enter a valid email address.");return}if(!p){P("Please verify your email OTP before creating your account.");return}if(!de){O(E=>({...E,phone:!0})),P("Please enter a valid mobile number.");return}if(!D){O(E=>({...E,password:!0})),P("Please satisfy all password requirements.");return}if(!C){O(E=>({...E,confirmPassword:!0})),P("Passwords do not match.");return}R(!0);try{await r({firstName:o.firstName,lastName:o.lastName,name:`${o.firstName} ${o.lastName}`.trim(),email:o.email,phone:o.phone,password:o.password}),v("Account created successfully. Preparing your festival workspace..."),await Qt(),t(n)}catch(E){const ne=E.response?.status,ee=E.response?.data?.message||"Registration failed",ie=ee.toLowerCase();ne===409||ie.includes("already")||ie.includes("exists")?P("Account already exists with this email or phone number"):P(ee)}finally{R(!1)}},G=async()=>{re(),B(!0);try{let j=i;if((!j||j.includes("placeholder")||j.includes("your_google"))&&(j=await De.getGoogleConfig()),!j||j.includes("placeholder")||j.includes("your_google"))throw new Error("Google OAuth is not configured on the server. Please add GOOGLE_CLIENT_ID to Render or client/.env");await La({clientId:j,onProfile:async(E,ne)=>{const ee=await De.googleAuth(ne,E);Ne.setToken(ee.token),await s(),v(`Google sign-up verified as ${E.email}. Welcome to OZILLA FEST!`),await Qt(),t(n)}})}catch(j){const E=j.response?.data?.message||j.message||"Google sign-up failed";!E.toLowerCase().includes("cancel")&&!E.toLowerCase().includes("closed")&&P(E)}finally{B(!1)}};return e.jsxs("form",{onSubmit:se,className:"kx-form",children:[L&&e.jsx("div",{className:"kx-alert kx-alert-error",role:"alert",children:L}),h&&e.jsx("div",{className:"kx-alert kx-alert-success",role:"alert",children:h}),e.jsxs("button",{type:"button",className:"kx-google",onClick:G,disabled:q||I,children:[e.jsx(Pr,{}),e.jsx("span",{children:q?"Connecting to Google...":"Sign up with Google"}),e.jsx("i",{"aria-hidden":"true"})]}),e.jsxs("div",{className:"kx-divider",children:[e.jsx("span",{}),e.jsx("em",{children:"or register with email"}),e.jsx("span",{})]}),e.jsxs("div",{className:"kx-grid-row",children:[e.jsxs("label",{className:`kx-field ${u==="firstName"?"kx-focused":""}`,children:[e.jsx(Zt,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"firstName",value:o.firstName,placeholder:"First Name",autoComplete:"given-name",required:!0,onChange:oe,onFocus:()=>g("firstName"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("label",{className:`kx-field ${u==="lastName"?"kx-focused":""}`,children:[e.jsx(Zt,{className:"kx-field-icon"}),e.jsx("input",{type:"text",name:"lastName",value:o.lastName,placeholder:"Last Name",autoComplete:"family-name",required:!0,onChange:oe,onFocus:()=>g("lastName"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]})]}),e.jsxs("label",{className:`kx-field ${u==="email"?"kx-focused":""} ${F.email&&!Y?"kx-field-invalid":""}`,children:[e.jsx(Nr,{className:"kx-field-icon"}),e.jsx("input",{type:"email",name:"email",value:o.email,placeholder:"Email address",autoComplete:"email",required:!0,onChange:oe,onFocus:()=>g("email"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),F.email&&!Y&&e.jsx("p",{className:"kx-field-error-msg",children:"Please enter a valid email address."}),e.jsxs("div",{className:`kx-otp-box ${p?"kx-otp-verified":""}`,children:[e.jsxs("div",{className:"kx-otp-meta",children:[e.jsx("span",{className:"kx-otp-kicker",children:"Email Verification"}),e.jsx("strong",{children:p?"✓ Email verified":A?"Enter 6-digit code":"Verify email before submit"}),e.jsx("span",{className:"kx-otp-subtext",children:p?"Security verified":d>0?`Resend available in ${d}s`:"Code will be sent to your email"})]}),e.jsxs("div",{className:"kx-otp-controls",children:[e.jsx("button",{type:"button",className:"kx-otp-btn",onClick:ye,disabled:x||!Y||p||d>0,children:x?"Sending...":A?"Resend OTP":"Send OTP"}),e.jsx("input",{type:"text",value:y,onChange:j=>{re(),k(j.target.value.replace(/\D/g,"").slice(0,6)),b(!1)},className:"kx-otp-input",placeholder:"Enter 6-digit OTP",inputMode:"numeric",autoComplete:"one-time-code",disabled:!A||p}),e.jsx("button",{type:"button",className:"kx-otp-btn kx-otp-btn-accent",onClick:fe,disabled:!A||p||N,children:N?"Verifying...":p?"Verified":"Verify"})]})]}),e.jsxs("label",{className:`kx-field ${u==="phone"?"kx-focused":""} ${F.phone&&!de?"kx-field-invalid":""}`,children:[e.jsx(Sr,{className:"kx-field-icon"}),e.jsx("input",{type:"tel",name:"phone",value:o.phone,placeholder:"Phone (+92 3XX XXXXXXX)",autoComplete:"tel",required:!0,onChange:oe,onFocus:()=>g("phone"),onBlur:me}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),F.phone&&!de&&e.jsx("p",{className:"kx-field-error-msg",children:"Please enter a valid mobile number."}),e.jsxs("label",{className:`kx-field ${u==="password"?"kx-focused":""} ${F.password&&!D?"kx-field-invalid":""}`,children:[e.jsx(Kt,{className:"kx-field-icon"}),e.jsx("input",{type:T?"text":"password",name:"password",value:o.password,placeholder:"Create Password",autoComplete:"new-password",required:!0,onChange:oe,onFocus:()=>g("password"),onBlur:me}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>H(j=>!j),"aria-label":T?"Hide password":"Show password",children:e.jsx(Jt,{hidden:T})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),e.jsxs("div",{className:`kx-strength kx-strength-${ae.className}`,children:[e.jsxs("div",{className:"kx-strength-header",children:[e.jsx("span",{children:"Password Strength"}),e.jsx("strong",{children:ae.label})]}),e.jsx("div",{className:"kx-strength-bar-track",children:e.jsx("span",{style:{width:`${ae.percent}%`}})})]}),e.jsx("ul",{className:"kx-pwd-rules",children:Q.map(j=>{const E=j.met?"kx-rule-met":$?"kx-rule-unmet":"kx-rule-neutral";return e.jsxs("li",{className:`kx-pwd-rule ${E}`,children:[e.jsx("span",{className:"kx-rule-badge",children:j.met?"✓":"•"}),e.jsx("span",{children:j.text})]},j.key)})}),e.jsxs("label",{className:`kx-field ${u==="confirmPassword"?"kx-focused":""} ${F.confirmPassword&&!C?"kx-field-invalid":""}`,children:[e.jsx(Kt,{className:"kx-field-icon"}),e.jsx("input",{type:X?"text":"password",name:"confirmPassword",value:o.confirmPassword,placeholder:"Confirm Password",autoComplete:"new-password",required:!0,onChange:oe,onFocus:()=>g("confirmPassword"),onBlur:me}),e.jsx("button",{className:"kx-password-toggle",type:"button",onClick:()=>U(j=>!j),"aria-label":X?"Hide confirm password":"Show confirm password",children:e.jsx(Jt,{hidden:X})}),e.jsx("span",{className:"kx-field-light","aria-hidden":"true"})]}),F.confirmPassword&&!C&&e.jsx("p",{className:"kx-field-error-msg",children:"Passwords do not match."}),e.jsxs("button",{className:"kx-sign-in",type:"submit",disabled:!ce,children:[e.jsx("span",{className:"kx-button-glow","aria-hidden":"true"}),e.jsx("span",{className:"kx-button-sheen","aria-hidden":"true"}),I?e.jsx("span",{className:"kx-spinner","aria-label":"Creating account..."}):e.jsxs("span",{className:"kx-button-copy",children:["Create Account",e.jsx(Ar,{})]})]}),e.jsxs("p",{className:"kx-signup",children:["Already have an account?"," ",e.jsx(Z,{to:`/login?${new URLSearchParams({returnTo:n}).toString()}`,children:"Sign In"})]}),e.jsxs("div",{className:"kx-trust-grid","aria-label":"Security indicators",children:[e.jsx("span",{children:"🔒 Secure Sign Up"}),e.jsx("span",{children:"⚡ Instant Access"}),e.jsx("span",{children:"🛡️ Protected"}),e.jsx("span",{children:"✓ Google Verified"})]})]})}function Er(){return e.jsxs("div",{className:"auth-form-container",children:[e.jsx(Tr,{}),e.jsxs("div",{className:"auth-footer-links",children:[e.jsx(Z,{to:"/privacy",children:"Privacy Policy"}),e.jsx("span",{children:"•"}),e.jsx(Z,{to:"/terms",children:"Terms of Service"}),e.jsx("span",{children:"•"}),e.jsx(Z,{to:"/#contact",children:"Need Help?"})]})]})}function Cr(){const[t]=Ga(),a=ct(),{checkAuth:r}=Ke(),[s,i]=m.useState("Signing you in with Google...");return m.useEffect(()=>{(async()=>{const n=t.get("token"),o=t.get("error"),c=t.get("returnTo"),u=St(c,"/dashboard");if(o){i(o==="google_not_configured"?"Google sign-in is not configured on server yet. Please add GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET in server/.env.":"Google sign-in failed. Please try again.");const g=new URLSearchParams({returnTo:u}).toString();setTimeout(()=>a(`/login?${g}`,{replace:!0}),1200);return}if(!n){i("Google sign-in token not found. Please try again.");const g=new URLSearchParams({returnTo:u}).toString();setTimeout(()=>a(`/login?${g}`,{replace:!0}),1200);return}Ne.setToken(n),await r(),a(u,{replace:!0})})()},[r,a,t]),e.jsx("div",{className:"auth-page",children:e.jsxs("div",{className:"auth-card",children:[e.jsx("h1",{className:"auth-title",children:"Google Sign-In"}),e.jsx("p",{className:"auth-subtitle",children:s})]})})}const Lr={hotels:[{name:"Pearl Continental Hotel (PC)",location:"Lahore, Punjab, Pakistan",rates:"Premium city-center business and leisure rates",offer:"Flexible booking options with conference and dining access.",website:"https://www.expedia.com/Lahore-Hotels-Pearl-Continental-Lahore.h6062.Hotel-Information?chkin=2026-07-23&chkout=2026-07-24&x_pwa=1&rfrr=HSR&pwa_ts=1783538185568&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=2068&destination=Lahore%2C+Punjab%2C+Pakistan&destType=MARKET&neighborhoodId=553248633981712959&selected=6062&latLong=31.554606%2C74.357155&sort=RECOMMENDED&top_dp=124&top_cur=USD&semcid=US.UB.BING.PT-c-EN.HOTEL&semdtl=a1429012176.b11315017303776210.g1kwd-82189323842618%3Aloc-144.e1c.m18d15bbf2af6c1d752fa9d1bc0e925b82.r1dbbc4399e805d7a471af9bb50c0eca6a53815556874c850795d8066b3e568804.c1.j1142691.k1152882.d182188878595064.h1e.i1.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&userIntent=&selectedRoomType=314006270&selectedRatePlan=380046345&categorySearch=any_option&searchId=60a6b42e-b43b-44af-a668-54a0fbd95022",image:W("/assets/hotels/Pearl-Continental-Lahore.jpg"),showImage:!0,description:"A flagship five-star property known for premium hospitality, executive facilities, and large event spaces.",facilities:["Luxury Rooms & Suites","Restaurants & Coffee Lounge","Swimming Pool","Fitness Center"],contact:"Reservations: +92 42 111 505 505",rating:"4.5/5"},{name:"Ramada by Wyndham Lahore",location:"Lahore, Punjab, Pakistan",rates:"Business-friendly international chain pricing",offer:"Comfort-focused stay packages with central access.",website:"https://www.guestreservations.com/ramada-by-wyndham-lahore-gulberg-ii/booking?utm_source=microsoft&utm_medium=cpc&utm_campaign=318380766&msclkid=2639f60cc7641752938d9c426507dbb5&ctTriggered=true",image:W("/assets/hotels/Ramada-by-Wyndham-Lahore-Gulberg-II.jpg"),showImage:!0,description:"An international-branded stay option designed for business travelers and families seeking modern comfort.",facilities:["Comfort Rooms","All-Day Dining","Meeting Facilities","Wi-Fi Access"],contact:"Reservations: +92 42 111 111 211",rating:"4.3/5"},{name:"Hotel Indigo Lahore",location:"Lahore, Punjab, Pakistan",rates:"Boutique premium rates for curated city stays",offer:"Lifestyle stay experience with modern interiors and city vibe.",website:"https://indigoheights.com/",image:W("/assets/hotels/Hotel-Indigo.jpg"),showImage:!0,description:"A contemporary boutique-style hotel brand experience offering design-led rooms and premium hospitality.",facilities:["Designer Rooms","Signature Dining","Fitness Facilities","Business Services"],contact:"Reservations: +92 42 111 111 111",rating:"4.4/5"},{name:"Hotel One Gulberg Lahore",location:"Lahore, Punjab, Pakistan",rates:"Upper-midscale corporate and family packages",offer:"Value-focused business stays in a prime Lahore district.",website:"https://www.guestreservations.com/hotel-one-gulberg-lahore/booking?utm_source=microsoft&utm_medium=cpc&utm_campaign=318380766&msclkid=3d22881e8b211d72a380e25028093b5b",image:W("/assets/hotels/Hotel-One-Gulberg-Lahore.jpg"),showImage:!0,description:"A trusted local hospitality brand known for practical comfort, business convenience, and central location.",facilities:["Business-Friendly Rooms","Breakfast Service","Meeting Room","24/7 Front Desk"],contact:"Reservations: +92 42 111 111 563",rating:"4.2/5"},{name:"Luxus Grand Hotel (LC)",location:"Lahore, Punjab, Pakistan",rates:"Executive and leisure stay rates",offer:"City-center premium rooms with event-friendly access.",website:"https://www.expedia.com/Lahore-Hotels-Luxus-Grand-Hotel.h16225098.Hotel-Information?chkin=2026-07-23&chkout=2026-07-24&x_pwa=1&rfrr=HSR&pwa_ts=1783538679588&referrerUrl=aHR0cHM6Ly93d3cuZXhwZWRpYS5jb20vSG90ZWwtU2VhcmNo&useRewards=false&rm1=a2&regionId=2068&destination=Lahore%2C+Punjab%2C+Pakistan&destType=MARKET&selected=16225098&latLong=31.554606%2C74.357155&sort=RECOMMENDED&top_dp=50&top_cur=USD&semcid=US.UB.BING.PT-c-EN.HOTEL&semdtl=a1429012176.b11317216326895908.g1kwd-82326765629610%3Aloc-144.e1c.m1f413ae58b13f11ee7d78c41612f456b3.r17441980d01bf266109c2845e02c5e619d691d9360faf76d1fb0b3ff083f73b12.c1.j1142691.k1152882.d182326298507125.h1e.i1.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&userIntent=&selectedRoomType=201690559&selectedRatePlan=208425873&categorySearch=any_option&searchId=b938991e-d9ee-47cd-a5b9-bfbbe22962a7",image:W("/assets/hotels/Luxus-Grand-Hotel.jpg"),showImage:!0,description:"A modern luxury hotel in Lahore offering upscale rooms, contemporary dining, and premium guest services.",facilities:["Premium Rooms","Restaurant & Cafe","Concierge Support","Airport Transfer Assistance"],contact:"Reservations: +92 42 111 589 879",rating:"4.4/5"},{name:"Nishat Hotel Lahore",location:"Lahore, Punjab, Pakistan",rates:"Premium luxury rates with lifestyle amenities",offer:"High-end accommodation with shopping and dining proximity.",website:"https://www.booking.com/hotel/pk/the-nishat.en-gb.html?aid=2276380&label=msn-G%2AualcbtRsY8_D6yMU0tng-80333218529225%3Atikwd-80333372562144%3Aloc-144%3Aneo%3Amte%3Alp142691%3Adec%3Acid578349423%3Aagid1285329581450391%3Aclkid91bc1c0fd2ae13842aa77641760a897b&sid=d2e80396e6c920f70a72e21ba196f068&all_sr_blocks=112449101_204759422_0_2_0_670390&checkin=2026-07-14&checkout=2026-07-15&dest_id=-2767043&dest_type=city&dist=0&group_adults=2&group_children=0&hapos=1&highlighted_blocks=112449101_204759422_0_2_0_670390&hpos=1&matching_block_id=112449101_204759422_0_2_0_670390&no_rooms=1&req_adults=2&req_children=0&room1=A%2CA&sb_price_type=total&sr_order=popularity&sr_pri_blocks=112449101_204759422_0_2_0_670390_3300000&srepoch=1783539000&srpvid=7c17890e04e000e0&type=total&ucfs=1&",image:W("/assets/hotels/Nishat.jpg"),showImage:!0,description:"A luxury Lahore hospitality brand recognized for refined interiors, premium service standards, and prime locations.",facilities:["Luxury Suites","Fine Dining","Spa & Wellness","Event and Meeting Spaces"],contact:"Reservations: +92 42 111 647 428",rating:"4.6/5"}]};W("/assets/ozilla/talwinder.jpg"),W("/assets/ozilla/talwinder.jpg"),W("/assets/ozilla/Imran-Khan.jpg"),W("/assets/ozilla/Imran-Khan.jpg"),W("/assets/ozilla/Bohemia.jpg"),W("/assets/ozilla/Bohemia.jpg"),W("/assets/ozilla/hassan-raheem.jpg"),W("/assets/ozilla/hassan-raheem.jpg");const ea=[{name:"TALWINDER",isHeadliner:!0,genre:"Indie Pop / Punjabi Fusion",stage:"Main Prism Stage",bpm:"128 BPM",vibe:"Euphoric Night",src:W("/assets/ozilla/talwinder.jpg"),image:W("/assets/ozilla/talwinder.jpg"),offsetY:0},{name:"IMRAN KHAN",isHeadliner:!1,genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",src:W("/assets/ozilla/Imran-Khan.jpg"),image:W("/assets/ozilla/Imran-Khan.jpg"),offsetY:0},{name:"BOHEMIA",isHeadliner:!1,genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",src:W("/assets/ozilla/Bohemia.jpg"),image:W("/assets/ozilla/Bohemia.jpg"),offsetY:0},{name:"HASSAN RAHEEM",isHeadliner:!1,genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",src:W("/assets/ozilla/hassan-raheem.jpg"),image:W("/assets/ozilla/hassan-raheem.jpg"),offsetY:0}],ta=1.28,aa=.78;function qe(t,a,r){return Math.min(r,Math.max(a,t))}function ra(t){if(!t)return null;if(typeof t=="string")return t||null;const a=t.src||t.image;return typeof a=="string"&&a?a:null}function Ir(t){return ra(t&&typeof t=="object"&&(t.image||t.src)||t)}function Rr(t){if(t&&typeof t=="object"&&"offsetY"in t){const a=t.offsetY;return typeof a=="number"&&isFinite(a)?a:0}return 0}function zr({items:t=ea,images:a,slideWidth:r=320,slideHeight:s=440,spacing:i=2.4,direction:l="right",smoothness:n=8.5,radius:o=24,dim:c=5,background:u="transparent",sensitivity:g=5,autoPlay:y=!1,autoPlayInterval:k=3500,style:A,onItemClick:w}){const p=m.useRef(null),b=m.useRef([]),x=m.useRef(0),M=m.useRef(0),[N,f]=m.useState(0),[d,_]=m.useState(!1),[L,P]=m.useState(0),h=t&&t.length>0?t:a&&a.length>0?a:ea,v=m.useMemo(()=>h.map((S,z)=>({...S,src:Ir(S),offsetY:Rr(S),name:S.name||`Artist ${z+1}`,genre:S.genre||"Live Performer",stage:S.stage||"Ozilla Arena",bpm:S.bpm||"128 BPM",vibe:S.vibe||"Festival Energy",isHeadliner:!!S.isHeadliner})),[h]),I=N>0&&N<640?Math.min(r,250):N<1024?Math.min(r,290):r,R=N>0&&N<640?Math.round(I*1.36):s,q=I+qe(i,0,10)*18,B=.15-qe(n,0,10)/10*.11,T=qe(c,0,10)/10*.75,H=.4+qe(g,0,10)/10*1.1,X=.6+qe(g,0,10)/10*1.6,U=l==="left",F=m.useRef({count:v.length,step:q,slideWidth:I,width:N,ease:B,maxScale:ta,minScale:aa,dim:T,loop:!1,flip:U});F.current={count:v.length,step:q,slideWidth:I,width:N,ease:B,maxScale:ta,minScale:aa,dim:T,loop:!1,flip:U};const O=m.useRef({wheelMultiplier:H,dragMultiplier:X,flip:U});O.current={wheelMultiplier:H,dragMultiplier:X,flip:U},m.useEffect(()=>{const S=p.current;if(!S)return;const z=new ResizeObserver(D=>{D[0]&&f(D[0].contentRect.width)});return z.observe(S),f(S.getBoundingClientRect().width),()=>z.disconnect()},[]),m.useEffect(()=>{b.current.length=v.length},[v.length]),m.useEffect(()=>{if(!y||d||v.length<=1)return;const S=setInterval(()=>{P(z=>{const D=(z+1)%v.length;return x.current=D*q,D})},k);return()=>clearInterval(S)},[y,d,v.length,q,k]),m.useEffect(()=>{let S=0,z=0;const D=C=>{S=requestAnimationFrame(D);const $=F.current,ae=z?Math.min((C-z)/1e3,.1):1/60;if(z=C,!$.count||$.step<=0||$.width<=0)return;const Q=($.count-1)*$.step;x.current=qe(x.current,0,Q);const ce=1-Math.pow(1-$.ease,ae*60);M.current+=(x.current-M.current)*ce;const re=Math.round(M.current/$.step);re>=0&&re<$.count&&P(re);const oe=($.width-$.slideWidth)/2,me=$.width/2;for(let ye=0;ye<$.count;ye+=1){const fe=b.current[ye];if(!fe)continue;const G=ye*$.step-M.current+oe,j=G+$.slideWidth/2-me;let E,ne;j>0?(E=Math.min($.maxScale,1+j/$.width*.45),ne=(E-1)*$.slideWidth*.35):(E=Math.max($.minScale,1+j/$.width*.5),ne=0);const ee=$.flip?$.width-$.slideWidth-(G+ne):G+ne;if(fe.style.transform=`translate3d(${ee}px, -50%, 0) scale(${E})`,$.dim>0&&E<1){const ie=(1-E)/Math.max(.001,1-$.minScale);fe.style.filter=`brightness(${Math.max(.35,1-ie*$.dim)})`}else fe.style.filter="none"}};return S=requestAnimationFrame(D),()=>cancelAnimationFrame(S)},[]),m.useEffect(()=>{const S=p.current;if(!S)return;const z=D=>{D.preventDefault();const C=Math.abs(D.deltaX)>Math.abs(D.deltaY)?D.deltaX:D.deltaY;x.current+=C*O.current.wheelMultiplier};return S.addEventListener("wheel",z,{passive:!1}),()=>S.removeEventListener("wheel",z)},[]),m.useEffect(()=>{const S=p.current;if(!S)return;let z=null,D=0;const C=Q=>{if(z===null){z=Q.pointerId,D=Q.clientX;try{S.setPointerCapture(Q.pointerId)}catch{}}},$=Q=>{if(z!==Q.pointerId)return;const ce=Q.clientX-D;D=Q.clientX,x.current+=(O.current.flip?ce:-ce)*O.current.dragMultiplier},ae=Q=>{if(z===Q.pointerId){z=null;try{S.hasPointerCapture(Q.pointerId)&&S.releasePointerCapture(Q.pointerId)}catch{}}};return S.addEventListener("pointerdown",C),S.addEventListener("pointermove",$),S.addEventListener("pointerup",ae),S.addEventListener("pointercancel",ae),()=>{S.removeEventListener("pointerdown",C),S.removeEventListener("pointermove",$),S.removeEventListener("pointerup",ae),S.removeEventListener("pointercancel",ae)}},[]);const Y=m.useCallback(S=>{const z=qe(S,0,v.length-1);x.current=z*q,P(z)},[v.length,q]),de=m.useCallback(S=>{const z=qe(L+(S==="left"?-1:1),0,v.length-1);Y(z)},[L,Y,v.length]);return e.jsxs("div",{style:{position:"relative",width:"100%",display:"flex",flexDirection:"column",alignItems:"center",margin:"1.2rem 0"},onMouseEnter:()=>_(!0),onMouseLeave:()=>_(!1),children:[e.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",flexWrap:"wrap",gap:"8px",marginBottom:"1rem",zIndex:10},children:v.map((S,z)=>{const D=z===L;return e.jsx("button",{type:"button",onClick:()=>Y(z),style:{padding:"6px 14px",borderRadius:"999px",border:D?"1px solid #ff8a3d":"1px solid rgba(255, 255, 255, 0.12)",background:D?"linear-gradient(135deg, rgba(255, 138, 61, 0.32), rgba(255, 90, 31, 0.22))":"rgba(20, 10, 6, 0.55)",color:D?"#ffbd59":"rgba(255, 255, 255, 0.65)",fontSize:"0.78rem",fontWeight:D?"850":"650",letterSpacing:"0.04em",cursor:"pointer",transition:"all 200ms ease",backdropFilter:"blur(8px)",boxShadow:D?"0 0 16px rgba(255, 138, 61, 0.35)":"none"},children:S.name},S.name)})}),e.jsx("div",{ref:p,className:"smooth-scroll-slider-viewport",style:{position:"relative",width:"100%",height:`${R+50}px`,overflow:"hidden",background:u,cursor:"grab",touchAction:"pan-y",opacity:N>0?1:0,transition:"opacity 0.35s ease",userSelect:"none",...A},children:v.map((S,z)=>{const D=S.isHeadliner,C=z===L;return e.jsxs("div",{ref:$=>{b.current[z]=$},onClick:()=>{Y(z),w&&w(S,z)},style:{position:"absolute",top:"50%",left:0,width:`${I}px`,height:`${R}px`,borderRadius:`${o}px`,overflow:"hidden",background:"#130c0a",border:C?"1.5px solid rgba(255, 138, 61, 0.85)":D?"1px solid rgba(255, 138, 61, 0.45)":"1px solid rgba(255, 255, 255, 0.12)",boxShadow:C?"0 26px 65px rgba(0,0,0,0.9), 0 0 35px rgba(255, 90, 31, 0.4)":"0 18px 45px rgba(0,0,0,0.75)",willChange:"transform, filter",transform:"translate3d(0, -50%, 0)",cursor:"pointer",transition:"border-color 250ms ease, box-shadow 250ms ease"},children:[S.src?e.jsx("img",{src:S.src,alt:S.name,draggable:!1,onError:$=>{$.currentTarget.src=W("/assets/prism-auth-visual.jpg")},style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:`50% calc(50% + ${S.offsetY}px)`,display:"block",userSelect:"none"}}):null,e.jsxs("div",{style:{position:"absolute",top:"12px",left:"12px",right:"12px",display:"flex",alignItems:"center",justifyContent:"space-between",zIndex:3},children:[D?e.jsx("span",{style:{display:"inline-flex",alignItems:"center",gap:"4px",padding:"4px 10px",borderRadius:"999px",background:"linear-gradient(135deg, #ff8a3d, #ff5a1f)",color:"#fff",fontSize:"0.68rem",fontWeight:"900",letterSpacing:"0.06em",textTransform:"uppercase",boxShadow:"0 4px 14px rgba(255, 90, 31, 0.45)"},children:"★ MAIN HEADLINER"}):e.jsx("span",{style:{padding:"3px 9px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.65)",backdropFilter:"blur(8px)",color:"#f6eee8",fontSize:"0.66rem",fontWeight:"700",border:"1px solid rgba(255,255,255,0.12)"},children:S.stage}),e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",gap:"2px",height:"14px",padding:"3px 6px",borderRadius:"999px",background:"rgba(0, 0, 0, 0.55)",backdropFilter:"blur(6px)"},children:[e.jsx("span",{className:"sss-eq-bar sss-eq-1"}),e.jsx("span",{className:"sss-eq-bar sss-eq-2"}),e.jsx("span",{className:"sss-eq-bar sss-eq-3"})]})]}),e.jsxs("div",{style:{position:"absolute",inset:0,background:"linear-gradient(180deg, rgba(0,0,0,0.08) 0%, transparent 40%, rgba(10,5,3,0.72) 65%, rgba(6,3,2,0.96) 100%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:"16px 14px",zIndex:2},children:[e.jsx("span",{style:{display:"inline-block",width:"fit-content",padding:"2px 8px",borderRadius:"999px",background:"rgba(255, 138, 61, 0.18)",border:"1px solid rgba(255, 138, 61, 0.35)",color:"#ffbd59",fontSize:"0.68rem",fontWeight:"800",letterSpacing:"0.04em",textTransform:"uppercase",marginBottom:"6px"},children:S.genre}),e.jsx("h3",{style:{margin:0,color:"#ffffff",fontSize:"1.28rem",fontWeight:"900",letterSpacing:"-0.02em",lineHeight:1.15,textTransform:"uppercase",textShadow:"0 2px 10px rgba(0,0,0,0.7)"},children:S.name}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginTop:"8px",paddingTop:"6px",borderTop:"1px solid rgba(255,255,255,0.1)",color:"rgba(255, 255, 255, 0.72)",fontSize:"0.68rem",fontWeight:"700"},children:[e.jsxs("span",{children:["⚡ ",S.bpm]}),e.jsxs("span",{children:["♫ ",S.vibe]})]})]})]},S.name)})}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:"1rem",marginTop:"0.8rem",zIndex:10},children:[e.jsx("button",{type:"button",onClick:()=>de("left"),disabled:L===0,"aria-label":"Previous artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:L===0?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:L===0?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:L===0?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:L===0?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:S=>{L>0&&(S.currentTarget.style.transform="scale(1.1)",S.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:S=>{S.currentTarget.style.transform="scale(1)",S.currentTarget.style.borderColor=L===0?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"‹"}),e.jsx("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:v.map((S,z)=>e.jsx("span",{onClick:()=>Y(z),style:{width:z===L?"20px":"6px",height:"6px",borderRadius:"999px",backgroundColor:z===L?"#ff8a3d":"rgba(255, 255, 255, 0.25)",cursor:"pointer",transition:"all 250ms ease"}},z))}),e.jsx("button",{type:"button",onClick:()=>de("right"),disabled:L===v.length-1,"aria-label":"Next artist",style:{width:"40px",height:"40px",borderRadius:"50%",border:L===v.length-1?"1px solid rgba(255, 255, 255, 0.1)":"1px solid rgba(255, 138, 61, 0.35)",background:L===v.length-1?"rgba(10, 5, 3, 0.4)":"rgba(20, 10, 6, 0.75)",backdropFilter:"blur(10px)",color:L===v.length-1?"rgba(255, 255, 255, 0.25)":"#ffbd59",cursor:L===v.length-1?"default":"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.5)",transition:"all 200ms ease"},onMouseEnter:S=>{L<v.length-1&&(S.currentTarget.style.transform="scale(1.1)",S.currentTarget.style.borderColor="#ff8a3d")},onMouseLeave:S=>{S.currentTarget.style.transform="scale(1)",S.currentTarget.style.borderColor=L===v.length-1?"rgba(255, 255, 255, 0.1)":"rgba(255, 138, 61, 0.35)"},children:"›"})]}),e.jsx("style",{children:`
        .sss-eq-bar {
          width: 2px;
          border-radius: 999px;
          background: #ff8a3d;
      ...
      `})]})}const et={color:"#ff8a3d",rounded:24,thickness:2.5,borderSize:45,glow:85,movement:"continuous",speed:16},Mr=2,Ia=[{blur:8,opacity:.5,reach:.3},{blur:15,opacity:.3,reach:.6},{blur:40,opacity:.18,reach:1}],Fr=Math.max(...Ia.map(t=>t.blur)),sa=36;function Rt(t,a){const r=Math.max(0,Math.min(1,a));if(typeof t!="string")return`rgba(0,0,0,${r})`;const s=t.trim(),i=s.match(/^#([0-9a-f]{3,8})$/i);if(i){let n=i[1];(n.length===3||n.length===4)&&(n=n.split("").map(c=>c+c).join(""));const o=parseInt(n.slice(0,6),16);return Number.isFinite(o)?`rgba(${o>>16&255},${o>>8&255},${o&255},${r})`:`rgba(0,0,0,${r})`}const l=s.match(/^rgba?\(([^)]+)\)/i);if(l){const n=l[1].split(",").map(o=>parseFloat(o));if(n.length>=3&&n.slice(0,3).every(Number.isFinite))return`rgba(${n[0]},${n[1]},${n[2]},${r})`}return`rgba(0,0,0,${r})`}function Or(t,a,r){const s=(t%1+1)%1*2*(a+r);return s<a?[s,0]:s<a+r?[a,s-a]:s<a*2+r?[a-(s-a-r),r]:[0,r-(s-a*2-r)]}function ia(t,a,r){const s=2*(a+r),i=[0,a/s,(a+r)/s,(a*2+r)/s];return Math.floor(t/4)+i[(t%4+4)%4]}function Dr(t,a,r){const[s,i]=Or(t,a,r);return Math.atan2(s-a/2,r/2-i)*180/Math.PI}const na=24,_r=.015;function zt(t,a,r,s,i){const l=r>0?r:100,n=s>0?s:100,o=Math.max(0,Math.min(100,a)),c=Math.max(_r,o/100*.5),u=o/100,g=[];let y=0,k=0,A=0;for(let p=0;p<=na;p++){const b=p/na,x=Dr(t+(b-.5)*c,l,n);if(p===0)y=x;else{let f=x-k;for(;f>180;)f-=360;for(;f<-180;)f+=360;A+=f}k=x;const M=Math.abs(b-.5)*2,N=u>=1||M<=u?1:1-(M-u)/(1-u);g.push(`${Rt(i,N*N*(3-2*N))} ${A.toFixed(2)}deg`)}const w=A.toFixed(2);return g.push(`${Rt(i,0)} ${w}deg`),g.push(`${Rt(i,0)} 360deg`),`conic-gradient(from ${y.toFixed(2)}deg at 50% 50%, ${g.join(", ")})`}const oa=30,Br=4,la=3,$r=.35,Hr=[.72,.16,.18,1.05],Ur=[.65,0,.35,1];function Ra(t){const[a,r,s,i]=t;if(a===r&&s===i)return n=>n;const l=(n,o,c)=>{const u=1-c;return 3*u*u*c*n+3*u*c*c*o+c*c*c};return n=>{const o=Math.max(0,Math.min(1,n));let c=o;for(let u=0;u<8;u++){const g=l(a,s,c)-o,y=1-c,k=3*y*y*a+6*y*c*(s-a)+3*c*c*(1-s);if(Math.abs(k)<1e-6)break;c-=g/k,c=Math.max(0,Math.min(1,c))}return l(r,i,c)}}const Gr=Ra(Hr),Vr=Ra(Ur),ca={WebkitMaskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",WebkitMaskClip:"content-box, border-box",WebkitMaskComposite:"xor",maskImage:"linear-gradient(#fff 0 0), linear-gradient(#fff 0 0)",maskClip:"content-box, border-box",maskComposite:"exclude"};function tt({color:t=et.color,rounded:a=et.rounded,thickness:r=et.thickness,borderSize:s=et.borderSize,glow:i=et.glow,movement:l=et.movement,speed:n=et.speed,style:o,className:c=""}){const u=m.useRef(null),g=m.useRef(null),y=m.useRef({speed:n,movement:l,borderSize:s,color:t});y.current={speed:n,movement:l,borderSize:s,color:t};const k=m.useRef(null),A=m.useRef({w:0,h:0}),[w,p]=m.useState({w:0,h:0});m.useEffect(()=>{const P=k.current;if(!P||typeof ResizeObserver>"u")return;const h=new ResizeObserver(()=>{const v=P.getBoundingClientRect();v.width===A.current.w&&v.height===A.current.h||(A.current={w:v.width,h:v.height},p(A.current))});return h.observe(P),()=>h.disconnect()},[]),m.useEffect(()=>{const P=k.current;let h=!0,v=null;typeof IntersectionObserver<"u"&&P&&(v=new IntersectionObserver(X=>{X[0]&&(h=X[0].isIntersecting)},{rootMargin:"100px"}),v.observe(P));let I=0,R=performance.now(),q=0,B=0,T=0;const H=X=>{if(I=requestAnimationFrame(H),!h||typeof document<"u"&&document.hidden){R=X;return}const U=Math.min(.05,Math.max(0,(X-R)/1e3));R=X;const F=y.current,O=Math.max(0,Math.min(20,F.speed));if(O>0){const Y=F.movement==="step",de=Y?la+($r-la)*(O-1)/19:(oa+(Br-oa)*(O-1)/19)/4;for(T+=U/de;T>=1;)T-=1,B+=1;const S=Y?Gr(Math.min(1,T*2)):Vr(T),{w:z,h:D}=A.current,C=z>0?z:100,$=D>0?D:100,ae=ia(B,C,$),Q=ia(B+1,C,$);q=ae+(Q-ae)*S;const ce=u.current;ce&&ce.style.setProperty("--arc",zt(q,F.borderSize,z,D,F.color));const re=g.current;re&&re.style.setProperty("--arc",zt(q+.5,F.borderSize,z,D,F.color))}};return I=requestAnimationFrame(H),()=>{cancelAnimationFrame(I),v&&v.disconnect()}},[]);const b=Math.max(1,Math.min(10,r)),x=Math.max(0,Math.min(100,a))/100*(Math.min(w.w||200,w.h||200)/2),M=Math.max(0,Math.min(100,i))/100,N=P=>b+M*sa*P,f=10+sa+Fr*2,d=(P,h=0)=>e.jsx("div",{style:{position:"absolute",inset:h-P,boxSizing:"border-box",padding:P,borderRadius:x>0?x+P:0,background:"var(--arc)",...ca}}),_=(P,h,v,I)=>e.jsx("div",{style:{position:"absolute",inset:-f,boxSizing:"border-box",padding:f,borderRadius:x>0?x+f:0,opacity:I,mixBlendMode:"plus-lighter",filter:v?`blur(${v.toFixed(1)}px)`:"none",WebkitFilter:v?`blur(${v.toFixed(1)}px)`:"none",...ca},children:d(h,f)},P),L=(P,h)=>e.jsxs("div",{ref:h,style:{position:"absolute",inset:0,overflow:"visible",pointerEvents:"none","--arc":zt(P,s,w.w,w.h,t)},children:[M>0&&Ia.map((v,I)=>_(`glow-${I}`,N(v.reach),v.blur,v.opacity)),Array.from({length:Mr}).map((v,I)=>e.jsx("div",{style:{position:"absolute",inset:0,mixBlendMode:"plus-lighter"},children:d(b)},`edge-${I}`))]});return e.jsxs("div",{ref:k,className:`neon-border-overlay ${c}`,style:{position:"absolute",inset:0,width:"100%",height:"100%",flexShrink:0,borderRadius:x,pointerEvents:"none",zIndex:1,...o},children:[L(0,u),L(.5,g)]})}const Wr=1.5,qr=42,Yr=Math.PI*2,Xr=300,Zr=300,Kr=2,Jr=5e3,Qr=3.2,es=.05,ts=3,as=1.35,rs=.08,ss=.5,is=.24,ns=.35,os=Yr*.75,ls=2,za=3,kt=720,cs=`
...
void main() {
    ...
    float ang = aA.x * ${os.toFixed(6)} + aA.y * TAU * ${ls.toFixed(1)};
    float rN = mix(${ns.toFixed(3)}, 1.0, sqrt(aA.z));
    float r  = uRadius * rN * (1.0 + ${es.toFixed(3)} * tau);

    float tp   = ${rs.toFixed(3)};
    float bump = (tau / tp) * exp(1.0 - tau / tp);
    float rimW = smoothstep(${ss.toFixed(3)}, 1.0, rN);
    float y    = uRise * bump * rimW - uFall * pow(tau, ${as.toFixed(2)});

    float L  = ${ts.toFixed(1)};
...
void main() {
    ...
    float halfW  = uThick * 0.5 * ${za.toFixed(1)} * near;
...
`;function ya(t,a,r){const s=t.createShader(a);return s?(t.shaderSource(s,r),t.compileShader(s),t.getShaderParameter(s,t.COMPILE_STATUS)?s:(console.error("ParticleDrift shader:",t.getShaderInfoLog(s)),t.deleteShader(s),null)):null}function wa(t,a,r){const s=ya(t,t.VERTEX_SHADER,a),i=ya(t,t.FRAGMENT_SHADER,r);if(!s||!i)return null;const l=t.createProgram();return l?(t.attachShader(l,s),t.attachShader(l,i),t.linkProgram(l),t.getProgramParameter(l,t.LINK_STATUS)?l:(console.error("ParticleDrift link:",t.getProgramInfoLog(l)),null)):null}function va(t,a){if(!t)return a;const r=String(t).trim();if(r.charAt(0)==="#"){let i=r.slice(1);if((i.length===3||i.length===4)&&(i=i[0]+i[0]+i[1]+i[1]+i[2]+i[2]),i.length>=6){const l=parseInt(i.slice(0,2),16),n=parseInt(i.slice(2,4),16),o=parseInt(i.slice(4,6),16);if(!isNaN(l)&&!isNaN(n)&&!isNaN(o))return[l/255,n/255,o/255]}return a}const s=r.match(/[\d.]+/g);return s&&s.length>=3?[Math.min(255,parseFloat(s[0]))/255,Math.min(255,parseFloat(s[1]))/255,Math.min(255,parseFloat(s[2]))/255]:a}function $e(t,a){return typeof t=="number"&&isFinite(t)?t:a}function rt(t,a,r){return t<a?a:t>r?r:t}function Ii(t){let a=t>>>0;return function(){a+=1831565813;let r=a;return r=Math.imul(r^r>>>15,r|1),r^=r+Math.imul(r^r>>>7,r|61),((r^r>>>14)>>>0)/4294967296}}const Ot=[[0,-1],[1,-1],[1,1],[0,-1],[1,1],[0,1]];function Ri({style:t,background:a="transparent",baseColor:r="#F84400",accentColor:s="#ECECEC",density:i=235,dotSize:l=14,speed:n=100,direction:o=0,hover:c=200,linkDistance:u=202,linkThickness:g=2.5,width:y,height:k,isFixed:A=!0}){const w=m.useRef(null),p=m.useRef(null),b=m.useRef({w:0,h:0});b.current={w:$e(y,0),h:$e(k,0)};const x=m.useRef({x:-1e4,y:-1e4}),M=m.useRef({});M.current={base:r,accent:s,density:Math.round(rt($e(i,90),10,400)),dotSize:rt($e(l,5),1,24),speed:rt($e(n,50),0,100)/50,direction:rt($e(o,0),0,360),hover:rt($e(c,100),0,200)/100,linkDistance:rt($e(u,120),0,400),linkThickness:rt($e(g,1),.5,8)},m.useEffect(()=>{const f=p.current;if(!f)return;const d=f.getContext("webgl",{alpha:!0,antialias:!1,depth:!1,premultipliedAlpha:!0});if(!d){console.error("ParticleDrift: WebGL unavailable");return}const _=wa(d,Ti,Ei),L=wa(d,Ci,Li);if(!_||!L)return;const P=new Map,h=(se,G)=>{const j=(se===_?"L:":"D:")+G;return P.has(j)||P.set(j,d.getUniformLocation(se,G)),P.get(j)},v=new Float32Array(Ye*6*2),I=new Float32Array(Ye*6*2),R=new Float32Array(Ye*6*2),q=new Float32Array(Ye*6*3);for(let se=0;se<Ye;se++)for(let G=0;G<6;G++){const j=(se*6+G)*2;R[j]=Ot[G][0],R[j+1]=Ot[G][1]}const B=d.createBuffer(),T=d.createBuffer(),H=d.createBuffer(),X=d.createBuffer();d.bindBuffer(d.ARRAY_BUFFER,B),d.bufferData(d.ARRAY_BUFFER,v.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,T),d.bufferData(d.ARRAY_BUFFER,I.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,H),d.bufferData(d.ARRAY_BUFFER,R,d.STATIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,X),d.bufferData(d.ARRAY_BUFFER,q.byteLength,d.DYNAMIC_DRAW);const U=Ii(20260824);let F=0,O=new Float32Array(0),Y=new Float32Array(0),de=new Float32Array(0),S=new Float32Array(0),z=new Float32Array(0);const D=d.createBuffer(),C=d.createBuffer(),$=(se,G,j)=>{F=se,O=new Float32Array(se),Y=new Float32Array(se),de=new Float32Array(se),S=new Float32Array(se*2),z=new Float32Array(se);for(let E=0;E<se;E++)O[E]=U()*G,Y[E]=U()*j,de[E]=(U()*.4+.1)*60;d.bindBuffer(d.ARRAY_BUFFER,D),d.bufferData(d.ARRAY_BUFFER,S.byteLength,d.DYNAMIC_DRAW),d.bindBuffer(d.ARRAY_BUFFER,C),d.bufferData(d.ARRAY_BUFFER,z.byteLength,d.DYNAMIC_DRAW)};let ae=0,Q=performance.now(),ce=-1,re=0,oe=0;const me=se=>{if(ae=requestAnimationFrame(me),typeof document<"u"&&document.hidden){Q=se;return}const G=Math.min(.05,(se-Q)/1e3);Q=se;const j=M.current,E=j.speed,ne=Math.min(window.devicePixelRatio||1,Pi),ee=b.current.w||f.clientWidth||window.innerWidth||1200,ie=b.current.h||f.clientHeight||window.innerHeight||800,Le=Math.max(1,Math.round(ee*ne)),Ee=Math.max(1,Math.round(ie*ne));(f.width!==Le||f.height!==Ee)&&(f.width=Le,f.height=Ee),d.viewport(0,0,Le,Ee);const ke=ee<768,Je=ee>=768&&ee<1024;let _e=j.density,Re=j.linkDistance,dt=j.dotSize;if(ke?(_e=Math.max(60,Math.min(Math.round(j.density*.38),90)),Re=Math.min(j.linkDistance,135),dt=Math.min(j.dotSize,8.5)):Je&&(_e=Math.max(90,Math.min(Math.round(j.density*.6),145)),Re=Math.min(j.linkDistance,165),dt=Math.min(j.dotSize,11)),_e!==ce&&($(_e,ee,ie),ce=_e),ee!==re||ie!==oe){const V=ee/Math.max(re||ee,1),le=ie/Math.max(oe||ie,1);for(let he=0;he<F;he++)O[he]*=V,Y[he]*=le;re=ee,oe=ie}const Qe=x.current,pt=j.hover,mt=(ke?100:180)*(pt>0?1:0),Ae=Re,ft=ke?Math.min(j.linkThickness,1.6):j.linkThickness,xt=j.direction*Math.PI/180,bt=Math.sin(xt),At=Math.cos(xt);let ze=0;const yt=(V,le,he,Pe,we,Ie,Ve,it)=>{if(!(ze>=Ye)){for(let Me=0;Me<6;Me++){const nt=(ze*6+Me)*2,Pt=(ze*6+Me)*3;v[nt]=V,v[nt+1]=le,I[nt]=he,I[nt+1]=Pe,q[Pt]=Ot[Me][0]===0?we:Ie,q[Pt+1]=Ve,q[Pt+2]=it}ze++}};for(let V=0;V<F;V++){O[V]+=de[V]*bt*G*E,Y[V]+=de[V]*At*G*E,O[V]<-Xe?(O[V]=ee+Xe,Y[V]=U()*ie):O[V]>ee+Xe&&(O[V]=-Xe,Y[V]=U()*ie),Y[V]<-Xe?(Y[V]=ie+Xe,O[V]=U()*ee):Y[V]>ie+Xe&&(Y[V]=-Xe,O[V]=U()*ee);const le=Qe.x-O[V],he=Qe.y-Y[V],Pe=Math.sqrt(le*le+he*he),we=mt>0&&Pe<mt?1:0;if(we===1){const Ie=.5*(1-Pe/mt)*pt;yt(O[V],Y[V],Qe.x,Qe.y,Ie,Ie,1,ft)}S[V*2]=O[V],S[V*2+1]=Y[V],z[V]=we}if(Ae>0){const V=Ae*Ae;for(let le=0;le<F&&ze<Ye;le++){const he=O[le],Pe=Y[le];for(let we=le+1;we<F&&ze<Ye;we++){const Ie=he-O[we];if(Ie>Ae||Ie<-Ae)continue;const Ve=Pe-Y[we];if(Ve>Ae||Ve<-Ae)continue;const it=Ie*Ie+Ve*Ve;if(it>=V)continue;const Me=.15*(1-Math.sqrt(it)/Ae);yt(he,Pe,O[we],Y[we],Me,Me,0,ft)}}}d.clearColor(0,0,0,0),d.clear(d.COLOR_BUFFER_BIT),d.disable(d.DEPTH_TEST),d.enable(d.BLEND),d.blendFunc(d.ONE,d.ONE_MINUS_SRC_ALPHA);const Ue=va(j.base,[.973,.267,0]),Ge=va(j.accent,[.925,.925,.925]);if(ze>0){d.useProgram(_);const V=ze*6;d.bindBuffer(d.ARRAY_BUFFER,B),d.bufferSubData(d.ARRAY_BUFFER,0,v.subarray(0,V*2));const le=d.getAttribLocation(_,"a_p0");d.enableVertexAttribArray(le),d.vertexAttribPointer(le,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,T),d.bufferSubData(d.ARRAY_BUFFER,0,I.subarray(0,V*2));const he=d.getAttribLocation(_,"a_p1");d.enableVertexAttribArray(he),d.vertexAttribPointer(he,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,H);const Pe=d.getAttribLocation(_,"a_corner");d.enableVertexAttribArray(Pe),d.vertexAttribPointer(Pe,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,X),d.bufferSubData(d.ARRAY_BUFFER,0,q.subarray(0,V*3));const we=d.getAttribLocation(_,"a_shade");d.enableVertexAttribArray(we),d.vertexAttribPointer(we,3,d.FLOAT,!1,0,0),d.uniform2f(h(_,"uSize"),ee,ie),d.uniform3f(h(_,"uBase"),Ue[0],Ue[1],Ue[2]),d.uniform3f(h(_,"uAccent"),Ge[0],Ge[1],Ge[2]),d.drawArrays(d.TRIANGLES,0,V),d.disableVertexAttribArray(le),d.disableVertexAttribArray(he),d.disableVertexAttribArray(Pe),d.disableVertexAttribArray(we)}if(F>0){d.useProgram(L),d.bindBuffer(d.ARRAY_BUFFER,D),d.bufferSubData(d.ARRAY_BUFFER,0,S);const V=d.getAttribLocation(L,"a_pos");d.enableVertexAttribArray(V),d.vertexAttribPointer(V,2,d.FLOAT,!1,0,0),d.bindBuffer(d.ARRAY_BUFFER,C),d.bufferSubData(d.ARRAY_BUFFER,0,z);const le=d.getAttribLocation(L,"a_lit");d.enableVertexAttribArray(le),d.vertexAttribPointer(le,1,d.FLOAT,!1,0,0),d.uniform2f(h(L,"uSize"),ee,ie),d.uniform1f(h(L,"uDpr"),ne),d.uniform1f(h(L,"uDot"),dt),d.uniform1f(h(L,"uRestAlpha"),.4),d.uniform3f(h(L,"uBase"),Ue[0],Ue[1],Ue[2]),d.uniform3f(h(L,"uAccent"),Ge[0],Ge[1],Ge[2]),d.drawArrays(d.POINTS,0,F),d.disableVertexAttribArray(V),d.disableVertexAttribArray(le)}},ye=se=>{const G=f.getBoundingClientRect();if(G.width<=0||G.height<=0)return;const j=b.current.w||f.clientWidth||window.innerWidth||1200,E=b.current.h||f.clientHeight||window.innerHeight||800;x.current.x=(se.clientX-G.left)/G.width*j,x.current.y=(se.clientY-G.top)/G.height*E},fe=()=>{x.current.x=-1e4,x.current.y=-1e4};return window.addEventListener("pointermove",ye,{passive:!0}),window.addEventListener("pointerleave",fe,{passive:!0}),ae=requestAnimationFrame(me),()=>{cancelAnimationFrame(ae),window.removeEventListener("pointermove",ye),window.removeEventListener("pointerleave",fe),d.deleteBuffer(B),d.deleteBuffer(T),d.deleteBuffer(H),d.deleteBuffer(X),d.deleteBuffer(D),d.deleteBuffer(C),d.deleteProgram(_),d.deleteProgram(L)}},[]);const N=A?{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:0,pointerEvents:"none",overflow:"hidden",background:a,isolation:"isolate",...t}:{position:"relative",overflow:"hidden",background:a,isolation:"isolate",width:typeof y=="number"&&y>0?y:"100%",height:typeof k=="number"&&k>0?k:"100%",...t};return e.jsx("div",{ref:w,style:N,"aria-hidden":"true",children:e.jsx("canvas",{ref:p,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}})})}function zi(){const t="/ozillafest/".replace(/\/$/,"");return e.jsx(Wa,{basename:t||void 0,future:{v7_startTransition:!0,v7_relativeSplatPath:!0},children:e.jsxs(Qa,{children:[e.jsx(Ri,{}),e.jsx(Ai,{})]})})}const ka=(t="")=>{const a=String(t).toLowerCase();return a.includes("importing a module script failed")||a.includes("failed to fetch dynamically imported module")||a.includes("loading chunk")||a.includes("failed to load module script")||a.includes("error loading dynamically imported module")||a.includes("mime type")||a.includes("dynamically imported")};class Mi extends m.Component{constructor(r){super(r);Vt(this,"handleReload",()=>{sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload()});this.state={error:null}}static getDerivedStateFromError(r){return{error:r}}componentDidCatch(r,s){if(console.error("Application render error:",r,s),ka(r?.message)){const i=Number(sessionStorage.getItem("chunk_reload_ts")||0);Date.now()-i>8e3&&(sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload())}}render(){if(this.state.error){const r=ka(this.state.error?.message);return e.jsxs("main",{style:{padding:"32px 20px",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',maxWidth:"540px",margin:"60px auto",textAlign:"center",backgroundColor:"#121118",color:"#f3f4f6",borderRadius:"16px",border:"1px solid rgba(255,255,255,0.1)",boxShadow:"0 20px 50px rgba(0,0,0,0.5)"},children:[e.jsx("h2",{style:{color:"#f97316",marginBottom:"12px",fontSize:"1.4rem"},children:r?"New Update Available":"Ozilla Festival could not render"}),e.jsx("p",{style:{color:"#9ca3af",marginBottom:"20px",fontSize:"0.95rem",lineHeight:"1.5"},children:r?"A fresh update has been deployed. Please tap refresh to load the latest version.":"Please refresh the page to reload the application."}),e.jsx("button",{type:"button",onClick:this.handleReload,style:{padding:"12px 28px",backgroundColor:"#ea580c",color:"#ffffff",border:"none",borderRadius:"999px",cursor:"pointer",fontWeight:"700",fontSize:"1rem",boxShadow:"0 4px 14px rgba(234, 88, 12, 0.4)",transition:"transform 0.15s ease"},children:"Refresh Website"})]})}return this.props.children}}if(typeof window<"u"){const t=a=>{const r=String(a?.message||a?.reason?.message||"").toLowerCase();if(r.includes("importing a module script failed")||r.includes("failed to fetch dynamically imported module")||r.includes("loading chunk")||r.includes("failed to load module script")){const s=Number(sessionStorage.getItem("chunk_reload_ts")||0);Date.now()-s>8e3&&(sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload())}};window.addEventListener("error",t),window.addEventListener("unhandledrejection",t)}Dt.createRoot(document.getElementById("root")).render(e.jsx(gt.StrictMode,{children:e.jsx(Mi,{children:e.jsx(Ka,{clientId:"placeholder-client-id",children:e.jsx(zi,{})})})}));export{Ut as A,Ht as a,te as b,Bi as c,Zs as f,Se as t,Ke as u};
