...
`;function qt(t){if(!t)return[1,1,1,1];let s=String(t).trim();const a=s.match(/^var\(\s*[^,)]+\s*,\s*(.+)\)$/i);a&&(s=a[1].trim());const r=s.match(/^rgba?\(([^)]+)\)$/i);if(r){const l=r[1].split(/[,\s/]+/).filter(Boolean).map(parseFloat);return[(l[0]||0)/255,(l[1]||0)/255,(l[2]||0)/255,l.length>3&&isFinite(l[3])?l[3]:1]}let i=s.replace("#","");return(i.length===3||i.length===4)&&(i=i.split("").map(l=>l+l).join("")),i.length<6?[1,1,1,1]:[parseInt(i.slice(0,2),16)/255,parseInt(i.slice(2,4),16)/255,parseInt(i.slice(4,6),16)/255,i.length>=8?parseInt(i.slice(6,8),16)/255:1]}function Ds(t){return()=>{t|=0,t=t+1831565813|0;let s=Math.imul(t^t>>>15,1|t);return s=s+Math.imul(s^s>>>7,61|s)^s,((s^s>>>14)>>>0)/4294967296}}function Xt(t,s,a){const r=t.createShader(s);return r?(t.shaderSource(r,a),t.compileShader(r),t.getShaderParameter(r,t.COMPILE_STATUS)||console.warn("VortexDustFall shader:",t.getShaderInfoLog(r)),r):null}function Kt(t,s,a){const r=t.createProgram();if(!r)return null;const i=Xt(t,t.VERTEX_SHADER,s),l=Xt(t,t.FRAGMENT_SHADER,a);return!i||!l?null:(t.attachShader(r,i),t.attachShader(r,l),t.linkProgram(r),t.getProgramParameter(r,t.LINK_STATUS)||console.warn("VortexDustFall link:",t.getProgramInfoLog(r)),r)}const Bs={radius:195,thickness:16},Hs={height:165,spin:38,spray:0},Us={scatter:280,blur:0},Vs={amount:103,transition:{type:"tween",duration:.6,ease:"easeOut"}};function Gs({background:t="transparent",baseColor:s="#FFA733",accentColor:a="#FFE082",density:r=145,dotSize:i=130,speed:l=48,distance:d=1450,tilt:o=7,ring:p={},fall:f={},field:x={},hover:j={},style:N={},className:C="",children:ae}){const w={...Bs,...p},D={...Hs,...f},T={...Us,...x},$={...Vs,...j},O=m.useRef(null),R=m.useRef(null),n=m.useRef({x:0,y:0,active:0}),W=m.useRef({baseColor:s,accentColor:a,density:r,dotSize:i,speed:l,distance:d,tilt:o,ring:w,fall:D,field:T,hover:$});return W.current={baseColor:s,accentColor:a,density:r,dotSize:i,speed:l,distance:d,tilt:o,ring:w,fall:D,field:T,hover:$},m.useEffect(()=>{const A=O.current,y=R.current;if(!A||!y)return;const c=y.getContext("webgl",{alpha:!0,antialias:!1,premultipliedAlpha:!0,depth:!1});if(!c)return;const h=Kt(c,Cs,_s),E=Kt(c,zs,Os);if(!h||!E)return;const M=(I,g)=>c.getUniformLocation(I,g),X={a:c.getAttribLocation(h,"aA"),b:c.getAttribLocation(h,"aB")},_={res:M(h,"uRes"),focal:M(h,"uFocal"),phase:M(h,"uPhase"),radius:M(h,"uRadius"),rise:M(h,"uRise"),fallD:M(h,"uFall"),spinTurns:M(h,"uSpinTurns"),scatter:M(h,"uScatter"),dotWorld:M(h,"uDotWorld"),blurK:M(h,"uBlurK"),camDist:M(h,"uCamDist"),tilt:M(h,"uTilt"),yPx:M(h,"uYPx"),alpha:M(h,"uAlpha"),color:M(h,"uColor")},se={ring:c.getAttribLocation(E,"aRing")},K={res:M(E,"uRes"),focal:M(E,"uFocal"),radius:M(E,"uRadius"),camDist:M(E,"uCamDist"),tilt:M(E,"uTilt"),yPx:M(E,"uYPx"),thick:M(E,"uThick"),seg:M(E,"uSeg"),color:M(E,"uColor"),alpha:M(E,"uAlpha")},te=c.createBuffer(),oe=c.createBuffer();let U=-1,F=0;const z=I=>{const g=y.clientWidth||A.clientWidth||(typeof window<"u"?window.innerWidth:1200),b=g<768,ie=g>=768&&g<1024,Y=b?1800:ie?8500:Math.round(I*ws);F=Math.max(1e3,Y);const ee=new Float32Array(F*4),Se=new Float32Array(F*2),ke=Ds(85840071);for(let xe=0;xe<F;xe++)ee[xe*4]=ke(),ee[xe*4+1]=ke(),ee[xe*4+2]=ke(),ee[xe*4+3]=ke(),Se[xe*2]=ke(),Se[xe*2+1]=ke();c.bindBuffer(c.ARRAY_BUFFER,te),c.bufferData(c.ARRAY_BUFFER,ee,c.STATIC_DRAW),c.bindBuffer(c.ARRAY_BUFFER,oe),c.bufferData(c.ARRAY_BUFFER,Se,c.STATIC_DRAW),U=I},ce=c.createBuffer(),u=(gt+1)*2;{const I=new Float32Array(u*2);for(let g=0;g<=gt;g++){const b=g/gt;I[g*4]=b,I[g*4+1]=-1,I[g*4+2]=b,I[g*4+3]=1}c.bindBuffer(c.ARRAY_BUFFER,ce),c.bufferData(c.ARRAY_BUFFER,I,c.STATIC_DRAW)}c.disable(c.DEPTH_TEST),c.enable(c.BLEND),c.blendFunc(c.ONE,c.ONE);let k=!0,S=null;typeof IntersectionObserver<"u"&&A&&(S=new IntersectionObserver(I=>{I[0]&&(k=I[0].isIntersecting)},{rootMargin:"120px"}),S.observe(A));let v=1,P=0;const Z=()=>{v=Math.min(window.devicePixelRatio||1,bs);const I=y.clientWidth||A.clientWidth||1,g=y.clientHeight||A.clientHeight||1,b=Math.max(1,Math.round(I*v)),ie=Math.max(1,Math.round(g*v));(y.width!==b||y.height!==ie)&&(y.width=b,y.height=ie),c.viewport(0,0,b,ie),Math.abs(P-I)>50&&(P=I,z(W.current.density))};Z();const V=new ResizeObserver(Z);V.observe(y);let le=0,J=performance.now(),re=0,de=0,he=0,pe=0;const Q=I=>{if(re=requestAnimationFrame(Q),!k||typeof document<"u"&&document.hidden){J=I;return}const g=Math.min((I-J)/1e3,.05);J=I;const b=W.current;if(b.density!==U&&z(b.density),F===0)return;const ie=Math.max(.05,b.hover.transition?.duration??.6),Y=1-Math.exp(-g/ie),ee=n.current;de+=(ee.x-de)*Y,he+=(ee.y-he)*Y,pe+=(ee.active-pe)*Y;const Se=(b.hover.amount||100)/100,ke=1+pe*Se*.6;le=(le+g*(b.speed/50*ke)/Ss)%1;const xe=y.width,Ye=y.height,Me=y.clientWidth||A.clientWidth||1200,Re=Me<768,st=Me>=768&&Me<1024,qe=Ye/(2*Math.tan(vs/2*Math.PI/180)),rt=xe/Math.max(Ye,1),it=rt<1?Math.max(.32,rt/1.4):st?.85:1,ye=js*(b.ring.radius/100)*it,nt=ye*(Re?1.1:b.fall.height/100),pt=nt*(b.fall.spray/400),mt=Ye*(Re?.22:Ts),bt=b.fall.spin/100*1.5,Ie=ye*(b.field.scatter/100)*(Re?.08:.15),ut=ks*(b.dotSize/100)*(Re?.65:1),ze=Ns*(b.field.blur/100),Oe=Re?Math.min(b.ring.thickness*v,9*v):b.ring.thickness*v,L=b.tilt*Math.PI/180+he*Se*pe*(10*Math.PI/180),ne=(Re?b.distance*1.05:b.distance)-pe*Se*150,[me,we,fe,Ae]=qt(b.baseColor),[De,Je,Te,Qe]=qt(b.accentColor);c.clearColor(0,0,0,0),c.clear(c.COLOR_BUFFER_BIT),c.useProgram(h),c.uniform2f(_.res,xe,Ye),c.uniform1f(_.focal,qe),c.uniform1f(_.phase,le),c.uniform1f(_.radius,ye),c.uniform1f(_.rise,pt),c.uniform1f(_.fallD,nt),c.uniform1f(_.spinTurns,bt),c.uniform1f(_.scatter,Ie),c.uniform1f(_.dotWorld,ut*v),c.uniform1f(_.blurK,ze*v),c.uniform1f(_.camDist,ne),c.uniform1f(_.tilt,L),c.uniform1f(_.yPx,mt),c.uniform1f(_.alpha,Ae),c.uniform3f(_.color,me,we,fe),c.bindBuffer(c.ARRAY_BUFFER,te),c.enableVertexAttribArray(X.a),c.vertexAttribPointer(X.a,4,c.FLOAT,!1,0,0),c.bindBuffer(c.ARRAY_BUFFER,oe),c.enableVertexAttribArray(X.b),c.vertexAttribPointer(X.b,2,c.FLOAT,!1,0,0),c.drawArrays(c.POINTS,0,F),c.useProgram(E),c.uniform2f(K.res,xe,Ye),c.uniform1f(K.focal,qe),c.uniform1f(K.radius,ye),c.uniform1f(K.camDist,ne),c.uniform1f(K.tilt,L),c.uniform1f(K.yPx,mt),c.uniform1f(K.thick,Oe),c.uniform1f(K.seg,gt),c.uniform3f(K.color,De,Je,Te),c.uniform1f(K.alpha,Qe),c.bindBuffer(c.ARRAY_BUFFER,ce),c.enableVertexAttribArray(se.ring),c.vertexAttribPointer(se.ring,2,c.FLOAT,!1,0,0),c.drawArrays(c.TRIANGLE_STRIP,0,u)};return re=requestAnimationFrame(Q),()=>{cancelAnimationFrame(re),V.disconnect(),S&&S.disconnect(),c.deleteBuffer(te),c.deleteBuffer(oe),c.deleteBuffer(ce),c.deleteProgram(h),c.deleteProgram(E)}},[]),e.jsxs("div",{ref:O,className:`vortex-dust-container ${C}`,onPointerMove:A=>{const y=A.currentTarget.getBoundingClientRect();y.width<=0||y.height<=0||(n.current={x:(A.clientX-y.left)/y.width*2-1,y:-((A.clientY-y.top)/y.height*2-1),active:1})},onPointerLeave:()=>{n.current={x:0,y:0,active:0}},style:{position:"absolute",inset:0,width:"100%",height:"100%",overflow:"hidden",pointerEvents:"none",background:t,...N},children:[e.jsx("canvas",{ref:R,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}}),ae&&e.jsx("div",{style:{position:"relative",zIndex:2,pointerEvents:"auto",width:"100%",height:"100%"},children:ae})]})}const $s=[{name:"TALWINDER",isHeadliner:!0,genre:"Indie Pop / Punjabi Fusion",stage:"Main Prism Stage",bpm:"128 BPM",vibe:"Euphoric Night",image:G("/assets/ozilla/talwinder.jpg")},{name:"IMRAN KHAN",genre:"Punjabi Pop / Urban",stage:"Neon Bass Arena",bpm:"132 BPM",vibe:"High Energy",image:G("/assets/ozilla/Imran-Khan.jpg")},{name:"BOHEMIA",genre:"Punjabi Rap / Desi Hip Hop",stage:"Underground Stage",bpm:"95 BPM",vibe:"Heavy Bass",image:G("/assets/ozilla/Bohemia.jpg")},{name:"HASSAN RAHEEM",genre:"Pop / Indie R&B",stage:"Sunset Stage",bpm:"115 BPM",vibe:"Golden Hour Chill",image:G("/assets/ozilla/hassan-raheem.jpg")}],Ws=[{id:"general",name:"General Pass",badge:"STANDARD ACCESS",price:"PKR 4,500",sub:"Full 1-day festival admission",isFeatured:!1,perks:["Access to All 4 Music Stages","Food & Beats Street Access","Festival Photo Booths & Activations","Instant Digital QR Pass"],ctaText:"Get General Pass",ctaLink:"/tickets"},{id:"vip",name:"VIP Experience",badge:"MOST POPULAR",price:"PKR 12,500",sub:"Elevated front-row & lounge access",isFeatured:!0,perks:["Priority Front Stage Viewing Deck","Private VIP Artist Lounge Access","Dedicated Fast-Track Entry Gate","Complimentary Food & Drink Voucher","20% Partner Hotel & Dining Discounts","Holographic VIP Commemorative Pass"],ctaText:"Book VIP Pass →",ctaLink:"/tickets"},{id:"platinum",name:"All-Access Platinum",badge:"EXCLUSIVE ALL-ACCESS",price:"PKR 25,000",sub:"Ultimate luxury hospitality package",isFeatured:!1,perks:["Backstage & Artist Lounge Access","Valet Reserved Parking Spot","Gourmet Catering & Open Mocktail Bar","Exclusive Afterparty Invitation","Dedicated Hospitality Concierge","Full Merchandise Gift Bundle"],ctaText:"Reserve Platinum Pass",ctaLink:"/tickets"}],Ys=[{badge:"100kW SOUND SYSTEM",title:"4 Mega Sound Stages",desc:"Explosive stage arenas for Indie Pop, Punjabi Rap, Desi Hip-Hop, and non-stop EDM beats."},{badge:"HEADLINE CELEBRITIES",title:"Star-Studded Lineup",desc:"Live stadium sets by Talwinder, Imran Khan, Bohemia, Hassan Raheem, and top artists."},{badge:"CULINARY & NIGHT BAZAAR",title:"Food & Beats Street",desc:"50+ curated gourmet food stalls, wood-fired artisan eats, and craft mocktail lounges."},{badge:"ALL-ACCESS HOSPITALITY",title:"VIP Lounge & Deck Access",desc:"Elevated front-stage viewing decks, private artist lounges, and fast-track VIP gates."}],qs=[{name:"OZILLA FEST 2026: The Flagship",date:"November 1, 2026",location:"Lahore, Pakistan",status:"FEATURED FESTIVAL",description:"Flagship festival with 4 mega stages, 20+ star artists, and 10,000+ live crowd."},{name:"Celebrity Night Live Concert",date:"February 2027",location:"Lahore, Pakistan",status:"UPCOMING CONCERT",description:"High-octane stadium night with headline Punjabi artists and 360° laser shows."},{name:"Ozilla Basant Beats Season 2",date:"March 2027",location:"Lahore, Pakistan",status:"SEASONAL FESTIVAL",description:"Cultural music fusion festival with live pop sets, color activations, and street eats."}],Xs=[{name:"Ozilla Season 1: The Bass Awakening",status:"Sold Out · 6,500+ Fans",detail:"Debut open-air music festival in Lahore featuring indie fusion acts and 2 live mega stages."},{name:"Ozilla Season 2: Neon Nights",status:"Sold Out · 8,500+ Fans",detail:"High-energy night festival with headline celebrity acts and artisan night food street."}],Ks=[{name:"Ozilla Debut: The Sound Awakening",year:"2023",badge:"SOLD OUT DEBUT",description:"Historic launch in Lahore uniting 6,000+ fans for live indie music and night market culture.",highlights:["6,000+ Attendees","2 Live Stages","Indie & Desi Fusion"],venue:"Lahore Expo Center",date:"December 12, 2023"},{name:"Ozilla Season 2: Neon Nights",year:"2024",badge:"RECORD 8,500+ CROWD",description:"Season 2 expansion with 4 live stages, celebrity headliners, and 360° laser canopy.",highlights:["8,500+ Fans","4 Live Stages","Celebrity Headliners"],venue:"DHA Sports Complex, Lahore",date:"November 9, 2024"},{name:"Ozilla Basant Cultural Beats",year:"2025",badge:"SPRING FESTIVAL",description:"Seasonal spring music festival with live acoustic sets, DJ arenas, and artisan bazaar.",highlights:["Cultural Sets","Live DJ Stages","Food Hub"],venue:"Gulberg Cultural District, Lahore",date:"March 15, 2025"},{name:"OZILLA FEST 2026 (The Grand Edition)",year:"2026",badge:"FLAGSHIP 10,000+ EDITION",description:"Monumental flagship edition with 4 stages, 20+ star artists, and 100kW laser sound arrays.",highlights:["10,000+ Crowd","4 Mega Stages","Talwinder & Imran Khan"],venue:"Lahore, Punjab",date:"November 1, 2026"},{name:"OZILLA FEST 2027: Arena Tour",year:"2027",badge:"NATIONWIDE TOUR",description:"Nationwide arena tour expansion bringing the signature Ozilla concert experience across Pakistan.",highlights:["Arena Tour","Multi-City Stages","Star Acts"],venue:"Lahore, Karachi & Islamabad",date:"November 14, 2027"}],Zs=[{tier:"Title Sponsor",price:"PREMIUM",badge:"FLAGSHIP PARTNER",accent:"#ffbd59",tagline:"Maximum Brand Dominance",isFeatured:!0,ctaText:"Claim Title Partnership",perks:["Exclusive brand naming rights","Main stage backdrop placement","VIP lounge & deck co-branding","30-second main stage video slot","Dedicated social & press campaigns"]},{tier:"Gold Sponsor",price:"HIGH IMPACT",badge:"STAGE ACTIVATION",accent:"#ff8a3d",tagline:"High-Energy Ground Presence",isFeatured:!1,ctaText:"Become Gold Sponsor",perks:["Exclusive brand activation zone","Perimeter banner placements","Digital festival app features","Influencer co-branding & mentions","On-ground brand booth space"]},{tier:"Silver Sponsor",price:"GROWTH",badge:"BRAND PARTNER",accent:"#cbd5e1",tagline:"Targeted Festival Engagement",isFeatured:!1,ctaText:"Join Silver Tier",perks:["Official festival website branding","Social media shoutouts","Sampling booth at food street","Newsletter sponsor placement","10 complimentary festival passes"]},{tier:"Media Partner",price:"CUSTOM",badge:"BROADCAST & PRESS",accent:"#ec4899",tagline:"Official Media Rights",isFeatured:!1,ctaText:"Apply For Press Pass",perks:["Official media coverage rights","All-access artist press passes","Exclusive backstage interview access","Press release announcement feature","Dedicated creator lounge access"]}],Js=[{badge:"100kW SOUND ARRAY",title:"Main Concert Arena",desc:"Stadium-grade concert sound arrays, 360° lasers, and cryogenic live jets.",accent:"#ff5a1f"},{badge:"50+ FOOD SPOTS",title:"Food & Beats Street",desc:"50+ night food stalls, wood-fired artisan eats, and gourmet smash burgers.",accent:"#ffbd59"},{badge:"24/7 RAPID CARE",title:"Medical & First Aid Hub",desc:"Fully equipped medical stations and certified paramedic response teams.",accent:"#ef4444"},{badge:"VALET & VIP GATES",title:"Managed VIP Parking",desc:"Fast-track valet lanes and direct express entry for VIP pass holders.",accent:"#f59e0b"},{badge:"CREATOR LIGHTING",title:"Holographic Photo Booths",desc:"Interactive neon backdrops and 360° video spinners for creator moments.",accent:"#ec4899"},{badge:"INCLUSIVE VENUE",title:"Full Venue Accessibility",desc:"Elevated viewing decks, step-free ramps, and on-ground guest assistance.",accent:"#3b82f6"},{badge:"PROFESSIONAL SQUAD",title:"Crowd Safety & Security",desc:"Trained festival security squad, CCTV monitoring, and RFID gate checks.",accent:"#10b981"},{badge:"GIGABIT HIGH-SPEED",title:"Ultra-Fast Festival Wi-Fi",desc:"High-density wireless zones across all stages and food streets.",accent:"#06b6d4"}],Qs=[{value:"10,000+",label:"Music Lovers",sub:"Packed Live Crowd"},{value:"20+",label:"Star Performers",sub:"Celebrity & Indie Acts"},{value:"4",label:"Mega Stages",sub:"Non-stop Beats"},{value:"50+",label:"Food & Stalls",sub:"Culinary & Brand Hub"}];function er(t){const[s,a]=m.useState(()=>{const r=Math.max(new Date(t)-Date.now(),0);return{days:Math.floor(r/864e5),hours:Math.floor(r/36e5%24),minutes:Math.floor(r/6e4%60),seconds:Math.floor(r/1e3%60)}});return m.useEffect(()=>{const r=setInterval(()=>{const i=Math.max(new Date(t)-Date.now(),0);a({days:Math.floor(i/864e5),hours:Math.floor(i/36e5%24),minutes:Math.floor(i/6e4%60),seconds:Math.floor(i/1e3%60)})},1e3);return()=>clearInterval(r)},[t]),s}function tr(){const t=We(),s=er("2026-11-01T18:00:00+05:00");return m.useEffect(()=>{const a=t.hash?.replace("#","");a?setTimeout(()=>{const r=document.getElementById(a);r&&r.scrollIntoView({behavior:"smooth",block:"start"})},150):window.scrollTo({top:0,behavior:"smooth"})},[t.hash]),e.jsxs("main",{className:"sp-main",children:[e.jsxs("section",{id:"home",className:"sp-hero","aria-label":"Ozilla Fest",children:[e.jsx(Gs,{baseColor:"#ff8a3d",accentColor:"#ffbd59",density:125,speed:46,tilt:7}),e.jsx("div",{className:"sp-hero-ambient-glow"}),e.jsxs("div",{className:"sp-hero-content",children:[e.jsxs(H.div,{className:"sp-hero-badge",initial:{opacity:0,y:-20,scale:.9},animate:{opacity:1,y:0,scale:1},transition:{duration:.6},children:[e.jsx("span",{children:"✨"}),e.jsx("strong",{children:"OZILLA FEST 2026 · LAHORE"})]}),e.jsx(H.h1,{className:"sp-hero-title",initial:{opacity:0,y:25},animate:{opacity:1,y:0},transition:{duration:.7,delay:.12},children:"OZILLA FEST"}),e.jsxs(H.p,{className:"sp-hero-subtitle",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.7,delay:.25},children:[e.jsx("strong",{className:"sp-hero-sub-highlight",children:"Pakistan's Flagship Music & Cultural Phenomenon."}),e.jsx("span",{className:"sp-hero-sub-detail",children:"4 Electrified Mega Stages · Headline Celebrities · High-Octane Sound Under the Lahore Night Sky."})]}),e.jsxs(H.div,{className:"sp-hero-meta-strip",initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{duration:.6,delay:.4},children:[e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"DATE"}),e.jsx("strong",{children:"NOV 01, 2026"})]}),e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"CITY"}),e.jsx("strong",{children:"LAHORE, PK"})]}),e.jsxs("div",{className:"sp-hero-meta-pill",children:[e.jsx("span",{className:"sp-meta-dot"}),e.jsx("span",{className:"sp-meta-label",children:"PRODUCTION"}),e.jsx("strong",{children:"4 MEGA STAGES"})]}),e.jsxs("div",{className:"sp-hero-meta-pill sp-meta-featured",children:[e.jsx("span",{className:"sp-meta-dot sp-dot-gold"}),e.jsx("span",{className:"sp-meta-label",children:"PASSES"}),e.jsx("strong",{children:"INSTANT QR PASS"})]})]}),e.jsxs(H.div,{className:"sp-hero-actions",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.6,delay:.55},children:[e.jsx(H.a,{className:"sp-btn-ember",href:"#celebrities",whileHover:{scale:1.04},whileTap:{scale:.97},children:"Explore Lineup ⚡"}),e.jsx(H.div,{whileHover:{scale:1.04},whileTap:{scale:.97},children:e.jsx(q,{className:"sp-btn-ghost",to:"/tickets",children:"Get VIP Passes 🎟️"})})]})]})]}),e.jsx("section",{className:"festival-stats-strip","aria-label":"Festival Highlights",children:e.jsx("div",{className:"sp-container",children:e.jsx("div",{className:"stats-inner-grid",children:Qs.map((a,r)=>e.jsxs(H.div,{className:"stat-card",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.4,delay:r*.08},whileHover:{y:-5,scale:1.02},children:[e.jsx("strong",{className:"stat-val",children:a.value}),e.jsx("span",{className:"stat-label",children:a.label}),e.jsx("small",{className:"stat-sub",children:a.sub})]},a.label))})})}),e.jsx("section",{id:"celebrities",className:"sp-section sp-section-celebrities","aria-label":"Celebrities Lineup",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"Live on the Ozilla Stage"}),e.jsx("h2",{className:"sp-section-title",children:"Celebrity Singers & Performers"}),e.jsx("p",{className:"sp-section-subtitle",children:"Four powerhouse headline performers, one premium Lahore festival atmosphere, and an amphitheatre built for unforgettable crowd moments."})]}),e.jsx(H.div,{className:"sp-celebrity-slider-wrap",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-40px"},transition:{duration:.6},style:{margin:"1rem 0 3.5rem 0"},children:e.jsx(ns,{items:$s,slideWidth:320,slideHeight:440,spacing:2.6,smoothness:8.5,dim:6,sensitivity:5,autoPlay:!0,autoPlaySpeed:1.2})}),e.jsxs(H.div,{className:"sp-countdown-banner",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.55},children:[e.jsx("div",{className:"sp-countdown-header",children:e.jsxs("span",{className:"sp-countdown-eyebrow",children:[e.jsx("span",{className:"sp-countdown-pulse"}),"COUNTDOWN TO THE FIRST BEAT DROP"]})}),e.jsx("div",{className:"sp-countdown-grid",children:[["Days",s.days],["Hours",s.hours],["Minutes",s.minutes],["Seconds",s.seconds]].map(([a,r])=>e.jsxs(H.div,{className:"sp-countdown-card",whileHover:{scale:1.05,y:-4},transition:{type:"spring",stiffness:350},children:[e.jsx("strong",{children:String(r).padStart(2,"0")}),e.jsx("span",{children:a}),e.jsx("div",{className:"sp-countdown-glow-line"})]},a))})]})]})}),e.jsx("section",{id:"vip-experience",className:"sp-section sp-section-pricing","aria-label":"Festival Passes",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header",style:{textAlign:"center"},initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"CHOOSE YOUR ACCESS"}),e.jsx("h2",{className:"sp-section-title",children:"Festival Passes & VIP Tiers"}),e.jsx("p",{className:"sp-section-subtitle",style:{margin:"0 auto"},children:"Select your festival experience tier. Instant dynamic QR pass generated upon reservation with guaranteed fast-track admission."})]}),e.jsx("div",{className:"sp-pricing-grid",children:Ws.map((a,r)=>e.jsxs(H.div,{className:`sp-pricing-card ${a.isFeatured?"sp-featured-pricing":""}`,initial:{opacity:0,y:35},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:r*.12},whileHover:{y:-8},children:[a.isFeatured&&e.jsx("div",{className:"sp-pricing-popular-tag",children:"MOST POPULAR ACCESS"}),e.jsxs("div",{className:"sp-pricing-header",children:[e.jsx("span",{className:"sp-tier-badge",children:a.badge}),e.jsx("h3",{children:a.name}),e.jsx("div",{className:"sp-pricing-cost",children:e.jsx("strong",{children:a.price})}),e.jsx("p",{className:"sp-pricing-sub",children:a.sub})]}),e.jsx("div",{className:"sp-pricing-divider"}),e.jsx("ul",{className:"sp-pricing-features",children:a.perks.map(i=>e.jsxs("li",{children:[e.jsx("span",{className:"sp-perk-check",children:"✓"}),e.jsx("span",{children:i})]},i))}),e.jsx(q,{to:a.ctaLink,className:a.isFeatured?"sp-btn-ember w-full":"sp-btn-ghost w-full",style:{textAlign:"center",marginTop:"auto"},children:a.ctaText})]},a.id))})]})}),e.jsx("section",{id:"about",className:"sp-section sp-section-about","aria-label":"About Ozilla",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"⚡ THE ULTIMATE LIVE EXPERIENCE"}),e.jsx("h2",{className:"sp-section-title",children:"The Ozilla Fest Atmosphere"}),e.jsx("p",{className:"sp-section-subtitle",children:"Pakistan's flagship open-air music & cultural festival. 4 electrified stages, 100kW concert sound, headline celebrity acts, gourmet food street, and unmatched crowd energy under the Lahore night sky."})]}),e.jsx("div",{className:"sp-pillars-grid",children:Ys.map((a,r)=>e.jsxs(H.div,{className:"sp-pillar-card",initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:r*.1},whileHover:{y:-8,scale:1.02},children:[e.jsx("div",{className:"sp-pillar-glow-accent"}),e.jsx("div",{className:"sp-pillar-top",children:e.jsx("span",{className:"sp-pillar-badge",children:a.badge})}),e.jsx("h3",{className:"sp-pillar-title",children:a.title}),e.jsx("p",{className:"sp-pillar-desc",children:a.desc}),e.jsx("div",{className:"sp-pillar-glow-line"})]},a.title))}),e.jsxs(H.div,{className:"sp-festival-vibe-banner",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:35},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6},children:[e.jsx(Ue,{color:"#ff7a29",rounded:32,thickness:2.8,borderSize:50,glow:85}),e.jsxs("div",{className:"sp-vibe-left",style:{position:"relative",zIndex:2},children:[e.jsxs("span",{className:"sp-vibe-eyebrow",children:[e.jsx("span",{className:"sp-countdown-pulse"}),"FESTIVAL HIGHLIGHTS"]}),e.jsx("h3",{children:"What Makes Ozilla Legendary"}),e.jsx("p",{children:"Non-stop beats from golden hour to midnight, surrounded by festival activations and pure music culture."}),e.jsxs("div",{className:"sp-vibe-actions",children:[e.jsx(H.a,{href:"#celebrities",className:"sp-btn-ember",whileHover:{scale:1.04},whileTap:{scale:.97},children:"Explore Lineup →"}),e.jsx(H.div,{whileHover:{scale:1.04},whileTap:{scale:.97},children:e.jsx(q,{to:"/tickets",className:"sp-btn-ghost",children:"Book Festival Passes"})})]})]}),e.jsx("div",{className:"sp-vibe-tags-grid",style:{position:"relative",zIndex:2},children:[{text:"4 Mega Music Stages",isMain:!0,icon:"⚡"},{text:"100kW Laser & Sound",isMain:!0,icon:"🔊"},{text:"20+ Star Performers",isMain:!0,icon:"👑"},{text:"Verified QR Instant Passes",isMain:!0,icon:"🎟️"},{text:"10,000+ Music Lovers",isMain:!1,icon:"👥"},{text:"50+ Food & Beats Stalls",isMain:!1,icon:"🍔"},{text:"VIP Artist Lounge & Deck",isMain:!1,icon:"✨"},{text:"Exclusive Partner Discounts",isMain:!1,icon:"🏷️"}].map((a,r)=>e.jsxs(H.div,{className:`sp-vibe-tag ${a.isMain?"sp-vibe-main":"sp-vibe-secondary"}`,initial:{opacity:0,scale:.9},whileInView:{opacity:1,scale:1},viewport:{once:!0},transition:{duration:.35,delay:r*.05},whileHover:{scale:1.03,x:3},whileTap:{scale:.98},children:[e.jsx("span",{className:"sp-vibe-tag-icon",children:a.icon}),e.jsx("span",{className:"sp-vibe-tag-text",children:a.text}),a.isMain&&e.jsx("span",{className:"sp-vibe-tag-dot"})]},a.text))})]})]})}),e.jsx("section",{id:"events",className:"sp-section sp-section-events","aria-label":"Past Events",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"Previous Editions"}),e.jsx("h2",{className:"sp-section-title",children:"Past Festival Milestones"}),e.jsx("p",{className:"sp-section-subtitle",children:"A legacy of sold-out stadium energy, breakthrough artist sets, and unforgettable Lahore nights."})]}),e.jsx("div",{className:"sp-events-grid",children:Xs.map((a,r)=>e.jsxs(H.div,{className:"sp-glass-card sp-past-event-card",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:r*.12},whileHover:{y:-6},children:[e.jsx(Ue,{color:"#ff8a3d",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column",height:"100%"},children:[e.jsxs("div",{className:"sp-card-header",children:[e.jsx("h3",{children:a.name}),e.jsx("span",{className:"sp-pill-badge",children:a.status})]}),e.jsx("p",{className:"sp-card-desc",children:a.detail}),e.jsxs("div",{className:"sp-card-footer-eq",children:[e.jsx("span",{children:"LIVE ARCHIVE"}),e.jsxs("div",{className:"celeb-mini-eq",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})]})]},a.name))})]})}),e.jsx("section",{id:"future-events",className:"sp-section sp-section-future","aria-label":"Upcoming Events",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"Upcoming Concert Tour"}),e.jsx("h2",{className:"sp-section-title",children:"Future Festival Editions"}),e.jsx("p",{className:"sp-section-subtitle",children:"Mark your calendar for upcoming major festival editions, celebrity concert nights, and arena dates."})]}),e.jsx("div",{className:"sp-future-grid",children:qs.map((a,r)=>e.jsxs(H.div,{className:"sp-glass-card sp-future-card",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:r*.12},whileHover:{y:-6},children:[e.jsx(Ue,{color:"#ff9e42",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,display:"flex",flexDirection:"column",height:"100%"},children:[e.jsx("span",{className:"sp-pill-badge",children:a.status}),e.jsx("h3",{style:{marginTop:"0.8rem"},children:a.name}),e.jsxs("p",{className:"sp-meta-text",children:["📍 ",a.date," · ",a.location]}),e.jsx("p",{className:"sp-card-desc",style:{flex:1},children:a.description}),e.jsx(q,{to:"/tickets",className:"sp-accent-link",children:"Get Tickets →"})]})]},a.name))})]})}),e.jsx("section",{id:"history",className:"sp-section sp-section-history","aria-label":"Festival History",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs("div",{className:"sp-section-header sp-timeline-banner-header",style:{position:"relative",overflow:"hidden"},children:[e.jsx(Ue,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"Festival Legacy"}),e.jsx("h2",{className:"sp-section-title",children:"Our Editions & Timeline"}),e.jsx("p",{className:"sp-section-subtitle",children:"From our underground debut to Pakistan's biggest stadium concert experience."})]})]}),e.jsx("div",{className:"sp-timeline",children:Ks.map((a,r)=>e.jsxs(H.div,{className:"sp-timeline-item",initial:{opacity:0,x:-28,y:20},whileInView:{opacity:1,x:0,y:0},viewport:{once:!0,margin:"-40px"},transition:{duration:.45,delay:r*.08},children:[e.jsxs("div",{className:"sp-timeline-node-wrap",children:[e.jsx("div",{className:"sp-timeline-icon",children:e.jsx("span",{className:"sp-timeline-year-pill",children:a.year})}),e.jsx("div",{className:"sp-timeline-pulse-ring"})]}),e.jsxs("div",{className:"sp-glass-card sp-timeline-content",children:[e.jsxs("div",{className:"sp-timeline-top-row",children:[e.jsx("div",{className:"sp-meta-text",children:e.jsx("span",{className:"sp-year-highlight",children:a.date})}),e.jsx("span",{className:"sp-timeline-badge",children:a.badge})]}),e.jsx("h3",{className:"sp-timeline-heading",children:a.name}),e.jsx("p",{className:"sp-card-desc",children:a.description}),e.jsx("div",{className:"sp-tag-cloud",children:a.highlights.map(i=>e.jsx("span",{className:"sp-tag sp-timeline-tag",children:i},i))}),e.jsxs("div",{className:"sp-timeline-footer",children:[e.jsx("p",{className:"sp-venue-text",children:a.venue}),e.jsxs("div",{className:"celeb-mini-eq",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})]})]},a.name))})]})}),e.jsx("section",{id:"restaurants",className:"sp-section sp-section-dining","aria-label":"Dining Hub",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header",initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx("span",{className:"sp-eyebrow",children:"Food & Drinks"}),e.jsx("h2",{className:"sp-section-title",children:"Festival Dining Hub"})]}),e.jsx("div",{className:"sp-restaurants-grid",children:ss.restaurants.map((a,r)=>e.jsxs(H.div,{className:"sp-glass-card sp-restaurant-card",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.45,delay:r*.1},whileHover:{y:-5,scale:1.01},children:[e.jsx(Ue,{color:"#ff8a3d",rounded:22,thickness:2.5,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsxs("div",{className:"sp-card-header",children:[e.jsx("h3",{children:a.name}),e.jsx("span",{className:"sp-discount-pill",children:a.discount})]}),e.jsxs("p",{className:"sp-meta-text",children:[a.cuisine," · ",a.location]}),e.jsx("p",{className:"sp-card-desc",children:a.offer}),e.jsxs("div",{className:"sp-code-box",children:[e.jsx("span",{children:"Promo Code:"}),e.jsx("code",{children:a.code})]})]})]},a.name))})]})}),e.jsx("section",{id:"facilities",className:"sp-section sp-section-facilities","aria-label":"Facilities",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header sp-facilities-header-banner",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx(Ue,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"⚡ FESTIVAL VENUE & PRODUCTION"}),e.jsx("h2",{className:"sp-section-title",children:"World-Class Festival Facilities"}),e.jsx("p",{className:"sp-section-subtitle",children:"Built for a seamless 10,000+ attendee experience with concert-grade sound, medical support, VIP hospitality, and creator amenities."})]})]}),e.jsx("div",{className:"sp-facilities-grid",children:Js.map((a,r)=>e.jsxs(H.div,{className:"sp-glass-card sp-facility-card",style:{position:"relative",overflow:"hidden"},initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.45,delay:r*.07},whileHover:{y:-8,scale:1.02},children:[e.jsx(Ue,{color:a.accent||"#ff8a3d",rounded:20,thickness:2.2,borderSize:40,glow:80}),e.jsxs("div",{style:{position:"relative",zIndex:2,width:"100%"},children:[e.jsx("div",{className:"sp-facility-top",children:e.jsx("span",{className:"sp-facility-badge",style:{color:a.accent,borderColor:`${a.accent}44`,background:`${a.accent}14`},children:a.badge})}),e.jsx("h3",{className:"sp-facility-title",children:a.title}),e.jsx("p",{className:"sp-card-desc",children:a.desc})]}),e.jsx("div",{className:"sp-facility-glow-bar",style:{background:`linear-gradient(90deg, ${a.accent}, transparent)`}})]},a.title))})]})}),e.jsx("section",{id:"sponsorship",className:"sp-section sp-section-sponsorship","aria-label":"Sponsorships",children:e.jsxs("div",{className:"sp-container",children:[e.jsxs(H.div,{className:"sp-section-header sp-sponsorship-header-banner",style:{position:"relative",overflow:"hidden",textAlign:"center"},initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5},children:[e.jsx(Ue,{color:"#ff8a3d",rounded:24,thickness:2.8,borderSize:45,glow:85}),e.jsxs("div",{style:{position:"relative",zIndex:2},children:[e.jsx("span",{className:"sp-eyebrow",children:"BRAND COLLABORATIONS"}),e.jsx("h2",{className:"sp-section-title",children:"Sponsorship & Brand Packages"}),e.jsx("p",{className:"sp-section-subtitle",style:{margin:"0 auto"},children:"Partner with Pakistan's biggest live music festival. Gain unparalleled on-ground brand presence, digital engagement, and VIP hospitality."})]})]}),e.jsx("div",{className:"sp-sponsorship-grid",children:Zs.map((a,r)=>e.jsxs(H.div,{className:`sp-glass-card sp-sponsor-card ${a.isFeatured?"sp-sponsor-featured":""}`,initial:{opacity:0,y:35},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.45,delay:r*.1},whileHover:{y:-10,scale:1.02},children:[a.isFeatured&&e.jsx("div",{className:"sp-sponsor-popular-tag",children:"MOST PRESTIGIOUS TIER"}),e.jsx("div",{className:"sp-sponsor-top",children:e.jsx("span",{className:"sp-sponsor-badge",style:{color:a.accent,borderColor:`${a.accent}44`,background:`${a.accent}14`},children:a.badge})}),e.jsxs("div",{className:"sp-sponsor-header",children:[e.jsx("h3",{children:a.tier}),e.jsx("div",{className:"sp-sponsor-price-tag",style:{color:a.accent},children:a.price}),e.jsx("p",{className:"sp-sponsor-tagline",children:a.tagline})]}),e.jsx("div",{className:"sp-sponsor-divider"}),e.jsx("ul",{className:"sp-sponsor-perks",children:a.perks.map(i=>e.jsxs("li",{children:[e.jsx("span",{className:"sp-check",style:{color:a.accent},children:"✓"}),e.jsx("span",{children:i})]},i))}),e.jsx(H.div,{whileHover:{scale:1.04},whileTap:{scale:.96},style:{marginTop:"auto",paddingTop:"1.2rem"},children:e.jsx(q,{to:"/tickets",className:a.isFeatured?"sp-btn-ember w-full":"sp-btn-ghost w-full",style:{textAlign:"center"},children:a.ctaText})}),e.jsx("div",{className:"sp-sponsor-glow-bottom",style:{background:`linear-gradient(90deg, ${a.accent}, transparent)`}})]},a.tier))})]})}),e.jsx("style",{children:`
      ...
      `})]})}function Pe(t){return m.lazy(async()=>{try{return await t()}catch(s){if(/Failed to fetch dynamically imported module/i.test(s?.message)||/Loading chunk/i.test(s?.message)||/Failed to load module script/i.test(s?.message)){const r=Number(sessionStorage.getItem("chunk_reload_ts")||0);if(Date.now()-r>1e4)return sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload(),new Promise(()=>{})}throw s}})}const ar=Pe(()=>Ee(()=>import("./UserDashboardPage-DPyvl25C.js"),__vite__mapDeps([0,1,2,3,4,5,6,7]))),sr=Pe(()=>Ee(()=>import("./TicketPortalPage-BuQXku6y.js"),__vite__mapDeps([8,1,2,3,4,9,7]))),rr=Pe(()=>Ee(()=>import("./MyTicketsPage-Bc-H7mOw.js"),__vite__mapDeps([10,1,2,3,4,11,6,7]))),ir=Pe(()=>Ee(()=>import("./TicketViewPage-C4c1dOI5.js"),__vite__mapDeps([12,1,2,3,4,11,6,7,9]))),nr=Pe(()=>Ee(()=>import("./TicketVerificationPage-BFkKqtbB.js"),__vite__mapDeps([13,1,2,4,9,7]))),or=Pe(()=>Ee(()=>import("./AdminDashboardPage-D74vabw7.js"),__vite__mapDeps([14,1,2,5,9,7]))),lr=Pe(()=>Ee(()=>import("./AdminTicketReviewPage-BzsiTvZw.js"),__vite__mapDeps([15,1,2,4,9,5,7]))),cr=Pe(()=>Ee(()=>import("./HotelsPage-DVz-x2dA.js"),__vite__mapDeps([16,1,2,7]))),Zt=Pe(()=>Ee(()=>import("./FestivalSchedulePage-2Cng7Uio.js"),__vite__mapDeps([17,1,2]))),Jt=Pe(()=>Ee(()=>import("./LegalPage-Cp5apOjn.js"),__vite__mapDeps([18,1,2]))),dr=Pe(()=>Ee(()=>import("./NotFound-12U-ahfn.js"),__vite__mapDeps([19,1,2])));function pr(){return e.jsx(m.Suspense,{fallback:e.jsx(Ha,{}),children:e.jsxs(xa,{children:[e.jsxs(B,{element:e.jsx(Ra,{}),children:[e.jsx(B,{path:"/login",element:e.jsx(jt,{children:e.jsx(Xa,{})})}),e.jsx(B,{path:"/register",element:e.jsx(jt,{children:e.jsx(ts,{})})}),e.jsx(B,{path:"/auth/google/callback",element:e.jsx(jt,{children:e.jsx(as,{})})})]}),e.jsx(B,{path:"/",element:e.jsx(Le,{children:e.jsx(tr,{})})}),e.jsx(B,{path:"/dashboard",element:e.jsx(ue,{to:"/",replace:!0})}),e.jsx(B,{path:"/about",element:e.jsx(ue,{to:"/#about",replace:!0})}),e.jsx(B,{path:"/collaboration",element:e.jsx(ue,{to:"/#sponsorship",replace:!0})}),e.jsx(B,{path:"/prismfest",element:e.jsx(ue,{to:"/#home",replace:!0})}),e.jsx(B,{path:"/prismfest/celebrities",element:e.jsx(ue,{to:"/#celebrities",replace:!0})}),e.jsx(B,{path:"/prismfest/events",element:e.jsx(ue,{to:"/#events",replace:!0})}),e.jsx(B,{path:"/prismfest/future",element:e.jsx(ue,{to:"/#future-events",replace:!0})}),e.jsx(B,{path:"/history",element:e.jsx(ue,{to:"/#history",replace:!0})}),e.jsx(B,{path:"/events",element:e.jsx(ue,{to:"/#events",replace:!0})}),e.jsx(B,{path:"/sponsorship",element:e.jsx(ue,{to:"/#sponsorship",replace:!0})}),e.jsx(B,{path:"/contact",element:e.jsx(ue,{to:"/#contact",replace:!0})}),e.jsx(B,{path:"/facilities",element:e.jsx(ue,{to:"/#facilities",replace:!0})}),e.jsx(B,{path:"/hotels",element:e.jsx(Le,{children:e.jsx(cr,{})})}),e.jsx(B,{path:"/schedule",element:e.jsx(Le,{children:e.jsx(Zt,{})})}),e.jsx(B,{path:"/lineup",element:e.jsx(Le,{children:e.jsx(Zt,{})})}),e.jsx(B,{path:"/restaurants",element:e.jsx(ue,{to:"/#restaurants",replace:!0})}),e.jsx(B,{path:"/discounts",element:e.jsx(ue,{to:"/#discounts",replace:!0})}),e.jsx(B,{path:"/partner",element:e.jsx(ue,{to:"/#about",replace:!0})}),e.jsx(B,{path:"/privacy",element:e.jsx(Le,{children:e.jsx(Jt,{type:"privacy"})})}),e.jsx(B,{path:"/terms",element:e.jsx(Le,{children:e.jsx(Jt,{type:"terms"})})}),e.jsx(B,{path:"/verification/:ticketId",element:e.jsx(Le,{children:e.jsx(nr,{})})}),e.jsx(B,{path:"/tickets",element:e.jsx(kt,{children:e.jsx(sr,{})})}),e.jsxs(B,{element:e.jsx(Pa,{}),children:[e.jsx(B,{path:"/account",element:e.jsx(Le,{children:e.jsx(ar,{})})}),e.jsx(B,{path:"/admin",element:e.jsx(ue,{to:"/admin/dashboard",replace:!0})}),e.jsx(B,{path:"/admin/dashboard",element:e.jsx(Le,{children:e.jsx(or,{})})}),e.jsx(B,{path:"/tickets/my-tickets",element:e.jsx(kt,{children:e.jsx(rr,{})})}),e.jsx(B,{path:"/tickets/view/:ticketId",element:e.jsx(kt,{children:e.jsx(ir,{})})}),e.jsx(B,{path:"/admin/tickets",element:e.jsx(Le,{children:e.jsx(lr,{})})})]}),e.jsx(B,{path:"*",element:e.jsx(dr,{})})]})})}const mr=2,Ve=8e3,Ge=20,ur=`
precision highp float;
...
`;function Qt(t,s,a){const r=t.createShader(s);return r?(t.shaderSource(r,a),t.compileShader(r),t.getShaderParameter(r,t.COMPILE_STATUS)?r:(console.error("ParticleDrift shader:",t.getShaderInfoLog(r)),t.deleteShader(r),null)):null}function ea(t,s,a){const r=Qt(t,t.VERTEX_SHADER,s),i=Qt(t,t.FRAGMENT_SHADER,a);if(!r||!i)return null;const l=t.createProgram();return l?(t.attachShader(l,r),t.attachShader(l,i),t.linkProgram(l),t.getProgramParameter(l,t.LINK_STATUS)?l:(console.error("ParticleDrift link:",t.getProgramInfoLog(l)),null)):null}function ta(t,s){if(!t)return s;const a=String(t).trim();if(a.charAt(0)==="#"){let i=a.slice(1);if((i.length===3||i.length===4)&&(i=i[0]+i[0]+i[1]+i[1]+i[2]+i[2]),i.length>=6){const l=parseInt(i.slice(0,2),16),d=parseInt(i.slice(2,4),16),o=parseInt(i.slice(4,6),16);if(!isNaN(l)&&!isNaN(d)&&!isNaN(o))return[l/255,d/255,o/255]}return s}const r=a.match(/[\d.]+/g);return r&&r.length>=3?[Math.min(255,parseFloat(r[0]))/255,Math.min(255,parseFloat(r[1]))/255,Math.min(255,parseFloat(r[2]))/255]:s}function Ce(t,s){return typeof t=="number"&&isFinite(t)?t:s}function Ke(t,s,a){return t<s?s:t>a?a:t}function xr(t){let s=t>>>0;return function(){s+=1831565813;let a=s;return a=Math.imul(a^a>>>15,a|1),a^=a+Math.imul(a^a>>>7,a|61),((a^a>>>14)>>>0)/4294967296}}const At=[[0,-1],[1,-1],[1,1],[0,-1],[1,1],[0,1]];function br({style:t,background:s="transparent",baseColor:a="#F84400",accentColor:r="#ECECEC",density:i=235,dotSize:l=14,speed:d=100,direction:o=0,hover:p=200,linkDistance:f=202,linkThickness:x=2.5,width:j,height:N,isFixed:C=!0}){const ae=m.useRef(null),w=m.useRef(null),D=m.useRef({w:0,h:0});D.current={w:Ce(j,0),h:Ce(N,0)};const T=m.useRef({x:-1e4,y:-1e4}),$=m.useRef({});$.current={base:a,accent:r,density:Math.round(Ke(Ce(i,90),10,400)),dotSize:Ke(Ce(l,5),1,24),speed:Ke(Ce(d,50),0,100)/50,direction:Ke(Ce(o,0),0,360),hover:Ke(Ce(p,100),0,200)/100,linkDistance:Ke(Ce(f,120),0,400),linkThickness:Ke(Ce(x,1),.5,8)},m.useEffect(()=>{const R=w.current;if(!R)return;const n=R.getContext("webgl",{alpha:!0,antialias:!1,depth:!1,premultipliedAlpha:!0});if(!n){console.error("ParticleDrift: WebGL unavailable");return}const W=ea(n,ur,hr),A=ea(n,fr,gr);if(!W||!A)return;const y=new Map,c=(Q,I)=>{const g=(Q===W?"L:":"D:")+I;return y.has(g)||y.set(g,n.getUniformLocation(Q,I)),y.get(g)},h=new Float32Array(Ve*6*2),E=new Float32Array(Ve*6*2),M=new Float32Array(Ve*6*2),X=new Float32Array(Ve*6*3);for(let Q=0;Q<Ve;Q++)for(let I=0;I<6;I++){const g=(Q*6+I)*2;M[g]=At[I][0],M[g+1]=At[I][1]}const _=n.createBuffer(),se=n.createBuffer(),K=n.createBuffer(),te=n.createBuffer();n.bindBuffer(n.ARRAY_BUFFER,_),n.bufferData(n.ARRAY_BUFFER,h.byteLength,n.DYNAMIC_DRAW),n.bindBuffer(n.ARRAY_BUFFER,se),n.bufferData(n.ARRAY_BUFFER,E.byteLength,n.DYNAMIC_DRAW),n.bindBuffer(n.ARRAY_BUFFER,K),n.bufferData(n.ARRAY_BUFFER,M,n.STATIC_DRAW),n.bindBuffer(n.ARRAY_BUFFER,te),n.bufferData(n.ARRAY_BUFFER,X.byteLength,n.DYNAMIC_DRAW);const oe=xr(20260824);let U=0,F=new Float32Array(0),z=new Float32Array(0),ce=new Float32Array(0),u=new Float32Array(0),k=new Float32Array(0);const S=n.createBuffer(),v=n.createBuffer(),P=(Q,I,g)=>{U=Q,F=new Float32Array(Q),z=new Float32Array(Q),ce=new Float32Array(Q),u=new Float32Array(Q*2),k=new Float32Array(Q);for(let b=0;b<Q;b++)F[b]=oe()*I,z[b]=oe()*g,ce[b]=(oe()*.4+.1)*60;n.bindBuffer(n.ARRAY_BUFFER,S),n.bufferData(n.ARRAY_BUFFER,u.byteLength,n.DYNAMIC_DRAW),n.bindBuffer(n.ARRAY_BUFFER,v),n.bufferData(n.ARRAY_BUFFER,k.byteLength,n.DYNAMIC_DRAW)};let Z=0,V=performance.now(),le=-1,J=0,re=0;const de=Q=>{if(Z=requestAnimationFrame(de),typeof document<"u"&&document.hidden){V=Q;return}const I=Math.min(.05,(Q-V)/1e3);V=Q;const g=$.current,b=g.speed,ie=Math.min(window.devicePixelRatio||1,mr),Y=D.current.w||R.clientWidth||window.innerWidth||1200,ee=D.current.h||R.clientHeight||window.innerHeight||800,Se=Math.max(1,Math.round(Y*ie)),ke=Math.max(1,Math.round(ee*ie));(R.width!==Se||R.height!==ke)&&(R.width=Se,R.height=ke),n.viewport(0,0,Se,ke);const xe=Y<768,Ye=Y>=768&&Y<1024;let Me=g.density,Re=g.linkDistance,st=g.dotSize;if(xe?(Me=Math.max(60,Math.min(Math.round(g.density*.38),90)),Re=Math.min(g.linkDistance,135),st=Math.min(g.dotSize,8.5)):Ye&&(Me=Math.max(90,Math.min(Math.round(g.density*.6),145)),Re=Math.min(g.linkDistance,165),st=Math.min(g.dotSize,11)),Me!==le&&(P(Me,Y,ee),le=Me),Y!==J||ee!==re){const L=Y/Math.max(J||Y,1),ne=ee/Math.max(re||ee,1);for(let me=0;me<U;me++)F[me]*=L,z[me]*=ne;J=Y,re=ee}const qe=T.current,rt=g.hover,it=(xe?100:180)*(rt>0?1:0),ye=Re,nt=xe?Math.min(g.linkThickness,1.6):g.linkThickness,pt=g.direction*Math.PI/180,mt=Math.sin(pt),bt=Math.cos(pt);let Ie=0;const ut=(L,ne,me,we,fe,Ae,De,Je)=>{if(!(Ie>=Ve)){for(let Te=0;Te<6;Te++){const Qe=(Ie*6+Te)*2,vt=(Ie*6+Te)*3;h[Qe]=L,h[Qe+1]=ne,E[Qe]=me,E[Qe+1]=we,X[vt]=At[Te][0]===0?fe:Ae,X[vt+1]=De,X[vt+2]=Je}Ie++}};for(let L=0;L<U;L++){F[L]+=ce[L]*mt*I*b,z[L]+=ce[L]*bt*I*b,F[L]<-Ge?(F[L]=Y+Ge,z[L]=oe()*ee):F[L]>Y+Ge&&(F[L]=-Ge,z[L]=oe()*ee),z[L]<-Ge?(z[L]=ee+Ge,F[L]=oe()*Y):z[L]>ee+Ge&&(z[L]=-Ge,F[L]=oe()*Y);const ne=qe.x-F[L],me=qe.y-z[L],we=Math.sqrt(ne*ne+me*me),fe=it>0&&we<it?1:0;if(fe===1){const Ae=.5*(1-we/it)*rt;ut(F[L],z[L],qe.x,qe.y,Ae,Ae,1,nt)}u[L*2]=F[L],u[L*2+1]=z[L],k[L]=fe}if(ye>0){const L=ye*ye;for(let ne=0;ne<U&&Ie<Ve;ne++){const me=F[ne],we=z[ne];for(let fe=ne+1;fe<U&&Ie<Ve;fe++){const Ae=me-F[fe];if(Ae>ye||Ae<-ye)continue;const De=we-z[fe];if(De>ye||De<-ye)continue;const Je=Ae*Ae+De*De;if(Je>=L)continue;const Te=.15*(1-Math.sqrt(Je)/ye);ut(me,we,F[fe],z[fe],Te,Te,0,nt)}}}n.clearColor(0,0,0,0),n.clear(n.COLOR_BUFFER_BIT),n.disable(n.DEPTH_TEST),n.enable(n.BLEND),n.blendFunc(n.ONE,n.ONE_MINUS_SRC_ALPHA);const ze=ta(g.base,[.973,.267,0]),Oe=ta(g.accent,[.925,.925,.925]);if(Ie>0){n.useProgram(W);const L=Ie*6;n.bindBuffer(n.ARRAY_BUFFER,_),n.bufferSubData(n.ARRAY_BUFFER,0,h.subarray(0,L*2));const ne=n.getAttribLocation(W,"a_p0");n.enableVertexAttribArray(ne),n.vertexAttribPointer(ne,2,n.FLOAT,!1,0,0),n.bindBuffer(n.ARRAY_BUFFER,se),n.bufferSubData(n.ARRAY_BUFFER,0,E.subarray(0,L*2));const me=n.getAttribLocation(W,"a_p1");n.enableVertexAttribArray(me),n.vertexAttribPointer(me,2,n.FLOAT,!1,0,0),n.bindBuffer(n.ARRAY_BUFFER,K);const we=n.getAttribLocation(W,"a_corner");n.enableVertexAttribArray(we),n.vertexAttribPointer(we,2,n.FLOAT,!1,0,0),n.bindBuffer(n.ARRAY_BUFFER,te),n.bufferSubData(n.ARRAY_BUFFER,0,X.subarray(0,L*3));const fe=n.getAttribLocation(W,"a_shade");n.enableVertexAttribArray(fe),n.vertexAttribPointer(fe,3,n.FLOAT,!1,0,0),n.uniform2f(c(W,"uSize"),Y,ee),n.uniform3f(c(W,"uBase"),ze[0],ze[1],ze[2]),n.uniform3f(c(W,"uAccent"),Oe[0],Oe[1],Oe[2]),n.drawArrays(n.TRIANGLES,0,L),n.disableVertexAttribArray(ne),n.disableVertexAttribArray(me),n.disableVertexAttribArray(we),n.disableVertexAttribArray(fe)}if(U>0){n.useProgram(A),n.bindBuffer(n.ARRAY_BUFFER,S),n.bufferSubData(n.ARRAY_BUFFER,0,u);const L=n.getAttribLocation(A,"a_pos");n.enableVertexAttribArray(L),n.vertexAttribPointer(L,2,n.FLOAT,!1,0,0),n.bindBuffer(n.ARRAY_BUFFER,v),n.bufferSubData(n.ARRAY_BUFFER,0,k);const ne=n.getAttribLocation(A,"a_lit");n.enableVertexAttribArray(ne),n.vertexAttribPointer(ne,1,n.FLOAT,!1,0,0),n.uniform2f(c(A,"uSize"),Y,ee),n.uniform1f(c(A,"uDpr"),ie),n.uniform1f(c(A,"uDot"),st),n.uniform1f(c(A,"uRestAlpha"),.4),n.uniform3f(c(A,"uBase"),ze[0],ze[1],ze[2]),n.uniform3f(c(A,"uAccent"),Oe[0],Oe[1],Oe[2]),n.drawArrays(n.POINTS,0,U),n.disableVertexAttribArray(L),n.disableVertexAttribArray(ne)}},he=Q=>{const I=R.getBoundingClientRect();if(I.width<=0||I.height<=0)return;const g=D.current.w||R.clientWidth||window.innerWidth||1200,b=D.current.h||R.clientHeight||window.innerHeight||800;T.current.x=(Q.clientX-I.left)/I.width*g,T.current.y=(Q.clientY-I.top)/I.height*b},pe=()=>{T.current.x=-1e4,T.current.y=-1e4};return window.addEventListener("pointermove",he,{passive:!0}),window.addEventListener("pointerleave",pe,{passive:!0}),Z=requestAnimationFrame(de),()=>{cancelAnimationFrame(Z),window.removeEventListener("pointermove",he),window.removeEventListener("pointerleave",pe),n.deleteBuffer(_),n.deleteBuffer(se),n.deleteBuffer(K),n.deleteBuffer(te),n.deleteBuffer(S),n.deleteBuffer(v),n.deleteProgram(W),n.deleteProgram(A)}},[]);const O=C?{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",zIndex:0,pointerEvents:"none",overflow:"hidden",background:s,isolation:"isolate",...t}:{position:"relative",overflow:"hidden",background:s,isolation:"isolate",width:typeof j=="number"&&j>0?j:"100%",height:typeof N=="number"&&N>0?N:"100%",...t};return e.jsx("div",{ref:ae,style:O,"aria-hidden":"true",children:e.jsx("canvas",{ref:w,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block"}})})}function vr(){const t="/ozillafest/".replace(/\/$/,"");return e.jsx(ba,{basename:t||void 0,future:{v7_startTransition:!0,v7_relativeSplatPath:!0},children:e.jsxs(Sa,{children:[e.jsx(br,{}),e.jsx(pr,{})]})})}class yr extends m.Component{constructor(a){super(a);Rt(this,"handleReload",()=>{sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload()});this.state={error:null}}static getDerivedStateFromError(a){return{error:a}}componentDidCatch(a,r){if(console.error("Application render failed:",a,r),/Failed to fetch dynamically imported module/i.test(a?.message)||/Loading chunk/i.test(a?.message)||/Failed to load module script/i.test(a?.message)){const l=Number(sessionStorage.getItem("chunk_reload_ts")||0);Date.now()-l>1e4&&(sessionStorage.setItem("chunk_reload_ts",String(Date.now())),window.location.reload())}}render(){if(this.state.error){const a=/Failed to fetch dynamically imported module/i.test(this.state.error?.message)||/Loading chunk/i.test(this.state.error?.message);return e.jsxs("main",{style:{padding:"32px",fontFamily:"Arial, sans-serif",maxWidth:"600px",margin:"40px auto",textAlign:"center"},children:[e.jsx("h1",{style:{color:"#7c2d12",marginBottom:"12px"},children:a?"New Update Available":"OZILLA FEST could not render"}),e.jsx("p",{style:{color:"#444",marginBottom:"16px"},children:a?"A new version of the website was published. Please refresh to load the latest version.":"Check the browser console for the full error details."}),e.jsx("button",{type:"button",onClick:this.handleReload,style:{padding:"10px 20px",backgroundColor:"#ea580c",color:"#fff",border:"none",borderRadius:"6px",cursor:"pointer",fontWeight:"bold",marginBottom:"16px"},children:"Refresh Page"}),!a&&e.jsx("pre",{style:{whiteSpace:"pre-wrap",background:"#fff7ed",border:"1px solid #fed7aa",padding:"16px",borderRadius:"6px",color:"#7c2d12",textAlign:"left"},children:this.state.error.message})]})}return this.props.children}}Et.createRoot(document.getElementById("root")).render(e.jsx(lt.StrictMode,{children:e.jsx(yr,{children:e.jsx(ja,{clientId:"placeholder-client-id",children:e.jsx(vr,{})})})}));export{Ha as L,Ta as P,ve as a,G as b,ss as o,je as t,at as u};
