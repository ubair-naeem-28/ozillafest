import{j as e}from"./vendor-motion-Do9_0UrH.js";import{r as m,b as q}from"./vendor-react-nW6paGhL.js";import{u as K}from"./useTicket-D4fCNidh.js";import{u as V,P as X}from"./index-CaJt-pv2.js";import{A as W}from"./AlertMessage-D_3e8DO-.js";import{t as B}from"./ticketService-CEHsvWnO.js";import"./vendor-utils-nxL8y1-h.js";const $={regular:{label:"General",value:"regular",price:1,seats:"1,200+",benefits:["Festival entry","Food court access","Partner discount offers"]},vip:{label:"VIP",value:"vip",price:15e3,seats:"320",benefits:["Priority entry","Premium seating","Celebrity performance zone"]},premium:{label:"Premium",value:"premium",price:25e3,seats:"120",benefits:["VIP lounge","Premium seating","Festival merchandise"]}};function J(c=""){const s=String(c).trim().split(/\s+/).filter(Boolean);return s.length===0?{firstName:"",lastName:""}:{firstName:s[0],lastName:s.slice(1).join(" ")}}function Y({onSubmit:c,loading:s,profileDefaults:r,onBookingChange:b,availability:i,availabilityLoading:g}){const t=m.useMemo(()=>{const o=J(r?.name);return{firstName:r?.firstName||o.firstName||"",lastName:r?.lastName||o.lastName||"",email:r?.email||"",phone:r?.phone||""}},[r]),[f,y]=m.useState(1),[x,p]=m.useState(""),[d,j]=m.useState({idCardNumber:"",festivalDay:"day1",ticketType:"regular",quantity:1,firstName:"",lastName:"",email:"",phone:""});m.useEffect(()=>{j(o=>({...o,firstName:t.firstName||o.firstName,lastName:t.lastName||o.lastName,email:t.email||o.email,phone:t.phone||o.phone}))},[t]);const z=o=>i?.byType?.[o],u=o=>!!z(o)?.soldOut,a=$[d.ticketType],k=z(d.ticketType),E=Number.isFinite(k?.remaining)?k.remaining:null,S=u(d.ticketType),l=Math.max(1,Math.min(10,E||10)),h=Number(d.quantity)||1,n=a.price*h,P=d.ticketType==="premium"?2500:0,A=Math.max(1,n-P),D=`${t.firstName} ${t.lastName}`.trim()||r?.email;m.useEffect(()=>{b?.({ticketType:a.label,day:d.festivalDay==="day1"?"Day 1":"Day 2",quantity:h,subtotal:n,serviceFee:0,discount:P,total:A,benefits:a.benefits})},[P,d.festivalDay,b,h,a,n,A]),m.useEffect(()=>{if(!i?.byType||!S)return;const o=Object.values($).find(w=>!u(w.value));o&&j(w=>({...w,ticketType:o.value,quantity:1}))},[i,S]),m.useEffect(()=>{h>l&&j(o=>({...o,quantity:l}))},[l,h]);const T=o=>{j(w=>({...w,[o.target.name]:o.target.value})),o.target.name==="idCardNumber"&&p("")},R=()=>!!(d.firstName&&d.lastName&&d.email&&d.phone),L=()=>{const o=String(d.idCardNumber||"").trim(),w=/^(?:\d{13}|\d{5}-\d{7}-\d{1})$/.test(o);return p(w?"":"Use 13 digits or format XXXXX-XXXXXXX-X."),w},I=()=>{f===1&&!R()||f===2&&(S||!L())||y(o=>Math.min(3,o+1))},M=o=>{if(o.preventDefault(),S||!R()||!L()){y(R()?2:1);return}c({...d,quantity:h,name:`${d.firstName} ${d.lastName}`.trim()})},O=()=>{y(1),p(""),j({idCardNumber:"",festivalDay:"day1",ticketType:"regular",quantity:1,firstName:t.firstName||"",lastName:t.lastName||"",email:t.email||"",phone:t.phone||""})};return e.jsxs("form",{onSubmit:M,className:"ticket-wizard-form",children:[e.jsx("div",{className:"ticket-form-stepper","aria-label":"Ticket form steps",children:["Personal Information","Ticket Information","Review & Confirm"].map((o,w)=>e.jsxs("button",{type:"button",className:f===w+1?"is-active":f>w+1?"is-complete":"",onClick:()=>y(w+1),children:[e.jsx("span",{children:w+1}),o]},o))}),D&&e.jsxs("div",{className:"ticket-login-chip",children:[e.jsx("span",{children:"OK"}),"Logged in as ",D]}),f===1&&e.jsxs("section",{className:"ticket-form-panel",children:[e.jsxs("div",{className:"ticket-panel-heading",children:[e.jsx("p",{children:"Step 1"}),e.jsx("h3",{children:"Personal Information"})]}),e.jsxs("div",{className:"ticket-input-grid",children:[e.jsxs("label",{className:"ticket-input-wrap",children:[e.jsx("span",{children:"First Name"}),e.jsx("input",{type:"text",name:"firstName",value:d.firstName,onChange:T,required:!0})]}),e.jsxs("label",{className:"ticket-input-wrap",children:[e.jsx("span",{children:"Last Name"}),e.jsx("input",{type:"text",name:"lastName",value:d.lastName,onChange:T,required:!0})]}),e.jsxs("label",{className:"ticket-input-wrap",children:[e.jsx("span",{children:"Email Address"}),e.jsx("input",{type:"email",name:"email",value:d.email,onChange:T,required:!0})]}),e.jsxs("label",{className:"ticket-input-wrap",children:[e.jsx("span",{children:"Phone Number"}),e.jsx("input",{type:"tel",name:"phone",value:d.phone,onChange:T,required:!0})]})]})]}),f===2&&e.jsxs("section",{className:"ticket-form-panel",children:[e.jsxs("div",{className:"ticket-panel-heading",children:[e.jsx("p",{children:"Step 2"}),e.jsx("h3",{children:"Ticket Information"})]}),e.jsx("div",{className:"ticket-option-grid",role:"radiogroup","aria-label":"Ticket type",children:Object.values($).map(o=>{const w=z(o.value),F=!!w?.soldOut,v=g?"Checking availability...":w?F?"Sold out":`${w.remaining.toLocaleString()} seats available`:`${o.seats} seats available`;return e.jsxs("button",{type:"button",disabled:F,"aria-disabled":F,className:`ticket-option-card ${d.ticketType===o.value?"is-selected":""} ${F?"is-sold-out":""}`,onClick:()=>{F||j(N=>({...N,ticketType:o.value,quantity:1}))},children:[e.jsx("span",{children:o.label}),e.jsxs("strong",{children:["PKR ",o.price.toLocaleString()]}),e.jsx("small",{children:v})]},o.value)})}),e.jsxs("div",{className:"ticket-input-grid",children:[e.jsxs("label",{className:"ticket-input-wrap",children:[e.jsx("span",{children:"Festival Day"}),e.jsxs("select",{name:"festivalDay",value:d.festivalDay,onChange:T,required:!0,children:[e.jsx("option",{value:"day1",children:"Day 1 - November 1, 2026"}),e.jsx("option",{value:"day2",children:"Day 2 - November 2, 2026"})]})]}),e.jsxs("label",{className:"ticket-input-wrap",children:[e.jsx("span",{children:"Quantity"}),e.jsx("input",{type:"number",name:"quantity",value:d.quantity,onChange:T,min:"1",max:l,disabled:S,required:!0})]}),e.jsxs("label",{className:"ticket-input-wrap ticket-input-wide",children:[e.jsx("span",{children:"ID Card Number (CNIC / National ID)"}),e.jsx("input",{type:"text",name:"idCardNumber",value:d.idCardNumber,onChange:T,placeholder:"35202-1234567-1",pattern:"(?:\\d{13}|\\d{5}-\\d{7}-\\d{1})",title:"Use 13 digits or format XXXXX-XXXXXXX-X",required:!0}),x&&e.jsx("em",{children:x})]})]})]}),f===3&&e.jsxs("section",{className:"ticket-form-panel",children:[e.jsxs("div",{className:"ticket-panel-heading",children:[e.jsx("p",{children:"Step 3"}),e.jsx("h3",{children:"Review & Confirm"})]}),e.jsxs("div",{className:"ticket-review-layout",children:[e.jsx("div",{className:"ticket-benefit-list",children:a.benefits.map(o=>e.jsx("span",{children:o},o))}),e.jsxs("aside",{className:"ticket-summary-card",children:[e.jsx("h4",{children:"Booking Summary"}),e.jsxs("div",{children:[e.jsx("span",{children:"Ticket Type"}),e.jsx("strong",{children:a.label})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Quantity"}),e.jsx("strong",{children:h})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Price"}),e.jsxs("strong",{children:["PKR ",n.toLocaleString()]})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Processing Fee"}),e.jsx("strong",{style:{color:"#10b981"},children:"Free (PKR 0)"})]}),e.jsxs("div",{children:[e.jsx("span",{children:"Discount"}),e.jsxs("strong",{children:["PKR ",P.toLocaleString()]})]}),e.jsxs("div",{className:"ticket-total",children:[e.jsx("span",{children:"Total"}),e.jsxs("strong",{children:["PKR ",A.toLocaleString()]})]})]})]})]}),e.jsxs("div",{className:"ticket-form-actions",children:[e.jsx("button",{type:"button",onClick:f===1?O:()=>y(o=>o-1),className:"ticket-secondary-button",children:f===1?"Reset":"Back"}),f<3?e.jsx("button",{type:"button",onClick:I,className:"ticket-primary-button",children:"Continue"}):e.jsx("button",{type:"submit",disabled:s,className:"ticket-primary-button ticket-shimmer-button",children:s?"Verifying Details...":"Complete Your Booking"})]})]})}function G(c){const s=c.replace(/\D/g,"").slice(0,16),r=s.match(/.{1,4}/g);return r?r.join(" "):s}function Q(c){const s=c.replace(/\D/g,"").slice(0,4);return s.length>=3?`${s.slice(0,2)}/${s.slice(2)}`:s}function U(c){const s=c.replace(/\D/g,"");return/^4/.test(s)?"visa":/^(5[1-5]|2[2-7])/.test(s)?"mastercard":/^(62|81)/.test(s)?"unionpay":null}function H(c){const s=c.replace(/\D/g,""),r=s.slice(0,4);return["5893","4012","5399","4519","4507"].includes(r)?"Meezan Bank":["4116","5241","4214","5488","4027"].includes(r)?"HBL":["4848","5189","4589","5294","4282"].includes(r)?"Bank Alfalah":["4351","5236","4271","5521","4046"].includes(r)?"MCB Bank":["4021","5123","4921","5424"].includes(r)?"Standard Chartered":["4203","5250","4894","5320"].includes(r)?"UBL":["4008","5456","4692","5378"].includes(r)?"Allied Bank":s.length>=6?"Verified Bank":""}function Z({amount:c,onSubmit:s,loading:r,onBack:b}){const[i,g]=m.useState({cardNumber:"",cardholderName:"",expiryDate:"",cvv:"",saveCard:!0}),[t,f]=m.useState({}),[y,x]=m.useState(!1),[p,d]=m.useState(""),j=U(i.cardNumber);H(i.cardNumber);const z=l=>{const h=G(l.target.value);g(n=>({...n,cardNumber:h})),t.cardNumber&&f(n=>({...n,cardNumber:""}))},u=l=>{const h=Q(l.target.value);g(n=>({...n,expiryDate:h})),t.expiryDate&&f(n=>({...n,expiryDate:""}))},a=l=>{const h=l.target.value.replace(/\D/g,"").slice(0,4);g(n=>({...n,cvv:h})),t.cvv&&f(n=>({...n,cvv:""}))},k=l=>{g(h=>({...h,cardholderName:l.target.value})),t.cardholderName&&f(h=>({...h,cardholderName:""}))},E=()=>{const l={},h=i.cardNumber.replace(/\s/g,"");if((!h||h.length<15)&&(l.cardNumber="Please enter a valid 16-digit card number"),i.cardholderName.trim()||(l.cardholderName="Please enter name as shown on card"),!i.expiryDate||i.expiryDate.length<5)l.expiryDate="Enter MM/YY";else{const[n,P]=i.expiryDate.split("/").map(Number);if(n<1||n>12)l.expiryDate="Invalid month (01-12)";else{const A=new Date,D=Number(String(A.getFullYear()).slice(-2)),T=A.getMonth()+1;(P<D||P===D&&n<T)&&(l.expiryDate="Card has expired")}}return(!i.cvv||i.cvv.length<3)&&(l.cvv="Enter 3 or 4 digits"),f(l),Object.keys(l).length===0},S=async l=>{if(l.preventDefault(),!!E()){d("Validating card credentials with bank..."),await new Promise(h=>setTimeout(h,450)),d("Authorizing payment deduction...");try{await s({cardNumber:i.cardNumber.replace(/\s/g,""),cardLast4:i.cardNumber.replace(/\s/g,"").slice(-4),cardholderName:i.cardholderName.trim(),expiryDate:i.expiryDate,cvv:i.cvv,saveCard:i.saveCard,cardType:j||"card"})}finally{d("")}}};return e.jsxs("div",{className:"card-payment-container",children:[e.jsxs("div",{className:"card-brands-row",children:[e.jsx("div",{className:`card-brand-logo mastercard ${j==="mastercard"?"is-active":""}`,title:"Mastercard",children:e.jsxs("svg",{viewBox:"0 0 38 24",width:"44",height:"28","aria-label":"Mastercard",children:[e.jsx("circle",{cx:"14",cy:"12",r:"10",fill:"#EB001B"}),e.jsx("circle",{cx:"24",cy:"12",r:"10",fill:"#F79E1B",fillOpacity:"0.88"})]})}),e.jsx("div",{className:`card-brand-logo visa ${j==="visa"?"is-active":""}`,title:"VISA",children:e.jsx("svg",{viewBox:"0 0 50 20",width:"54",height:"22","aria-label":"VISA",children:e.jsx("text",{x:"2",y:"16",fontFamily:"Arial, Helvetica, sans-serif",fontWeight:"900",fontStyle:"italic",fontSize:"18",fill:"#ffffff",letterSpacing:"1",children:"VISA"})})}),e.jsx("div",{className:`card-brand-logo unionpay ${j==="unionpay"?"is-active":""}`,title:"UnionPay",children:e.jsxs("div",{className:"unionpay-badge",children:[e.jsx("span",{className:"up-red"}),e.jsx("span",{className:"up-blue"}),e.jsx("span",{className:"up-green"}),e.jsx("span",{className:"up-text",children:"UnionPay"})]})})]}),e.jsxs("form",{onSubmit:S,className:"card-payment-form",children:[e.jsxs("div",{className:"card-field-group",children:[e.jsxs("label",{className:"card-field-label",children:[e.jsx("span",{className:"required-star",children:"*"})," Card number"]}),e.jsxs("div",{className:"card-input-wrapper",children:[e.jsx("input",{type:"text",inputMode:"numeric",autoComplete:"cc-number",placeholder:"4000 1234 5678 9010",value:i.cardNumber,onChange:z,className:`card-input ${t.cardNumber?"has-error":""}`,maxLength:19,disabled:r}),j&&e.jsx("span",{className:"card-detected-badge",children:j.toUpperCase()})]}),t.cardNumber&&e.jsx("span",{className:"card-field-error",children:t.cardNumber})]}),e.jsxs("div",{className:"card-field-group",children:[e.jsxs("label",{className:"card-field-label",children:[e.jsx("span",{className:"required-star",children:"*"})," Name on card"]}),e.jsx("input",{type:"text",autoComplete:"cc-name",placeholder:"e.g. HAMZA ALI",value:i.cardholderName,onChange:k,className:`card-input ${t.cardholderName?"has-error":""}`,disabled:r}),t.cardholderName&&e.jsx("span",{className:"card-field-error",children:t.cardholderName})]}),e.jsxs("div",{className:"card-row-two-col",children:[e.jsxs("div",{className:"card-field-group",children:[e.jsxs("label",{className:"card-field-label",children:[e.jsx("span",{className:"required-star",children:"*"})," Expiry date"]}),e.jsx("input",{type:"text",inputMode:"numeric",autoComplete:"cc-exp",placeholder:"MM/YY",value:i.expiryDate,onChange:u,className:`card-input ${t.expiryDate?"has-error":""}`,maxLength:5,disabled:r}),t.expiryDate&&e.jsx("span",{className:"card-field-error",children:t.expiryDate})]}),e.jsxs("div",{className:"card-field-group",children:[e.jsxs("label",{className:"card-field-label",children:[e.jsx("span",{className:"required-star",children:"*"})," CVV",e.jsx("button",{type:"button",className:"cvv-info-btn",onClick:()=>x(!y),onMouseEnter:()=>x(!0),onMouseLeave:()=>x(!1),"aria-label":"CVV information",children:"ⓘ"}),y&&e.jsx("div",{className:"cvv-tooltip",children:"3 or 4 digit security code located on the back of your card."})]}),e.jsx("input",{type:"password",inputMode:"numeric",autoComplete:"cc-csc",placeholder:"•••",value:i.cvv,onChange:a,className:`card-input ${t.cvv?"has-error":""}`,maxLength:4,disabled:r}),t.cvv&&e.jsx("span",{className:"card-field-error",children:t.cvv})]})]}),e.jsxs("div",{className:"save-card-wrapper",children:[e.jsxs("label",{className:"save-card-checkbox-label",children:[e.jsx("input",{type:"checkbox",checked:i.saveCard,onChange:l=>g(h=>({...h,saveCard:l.target.checked})),className:"save-card-checkbox",disabled:r}),e.jsx("span",{className:"save-card-title",children:"Save Card for Express Rebooking"})]}),e.jsx("p",{className:"save-card-subtext",children:"Card details are encrypted with bank-grade 256-bit tokenization for your security."})]}),p&&e.jsxs("div",{className:"card-processing-status",children:[e.jsx("span",{className:"card-spinner"}),e.jsx("span",{children:p})]}),e.jsxs("div",{className:"card-actions-row",children:[b&&e.jsx("button",{type:"button",onClick:b,disabled:r,className:"ticket-secondary-button",children:"Back"}),e.jsx("button",{type:"submit",disabled:r,className:"pay-now-btn",children:r?e.jsxs("span",{className:"btn-loading-content",children:[e.jsx("span",{className:"btn-spinner"})," Processing Payment..."]}):c?`Pay Now • PKR ${c.toLocaleString()}`:"Pay Now"})]}),e.jsxs("div",{className:"card-security-footer",children:[e.jsx("span",{children:"🔒 256-Bit SSL Encrypted & PCI-DSS Compliant"}),e.jsx("span",{children:"⚡ Instant Verified QR Pass Delivery"})]})]}),e.jsx("style",{children:`
      ...
      `})]})}const ne=["Personal Info","Ticket Details","Payment Checkout","QR Pass"],oe={ticketType:"General",day:"Day 1",quantity:1,subtotal:1,serviceFee:0,discount:0,total:1,benefits:["Festival entry","Food court access","Partner discount offers"]};function be(){const c=q(),{user:s}=V(),{requestTicket:r,payWithCard:b,payWithJazzCash:i,payWithEasypaisa:g,initiatePayFastCheckout:t,completePayFastGateway:f,loading:y}=K(),[x,p]=m.useState(null),[d,j]=m.useState(!1),[z,u]=m.useState("payfast"),[a,k]=m.useState(null),[E,S]=m.useState(!1),[l,h]=m.useState(oe),[n,P]=m.useState(null),[A,D]=m.useState(!0),T=d?3:2;`${s?.firstName||""} ${s?.lastName||""}`.trim()||s?.name||s?.email;const R=!!n?.soldOut;m.useEffect(()=>{let v=!0;return(async()=>{D(!0);try{const C=await B.getAvailability();if(!v)return;P(C),C?.soldOut&&p({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."})}catch{v&&P(null)}finally{v&&D(!1)}})(),()=>{v=!1}},[]);const L=()=>{if(R){p({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."});return}c(`/login?returnTo=${encodeURIComponent("/tickets")}`)},I=async v=>{if(R){p({type:"error",message:"Tickets are sold out. The ticket portal is currently locked."});return}try{const N=await r(v);k(N),j(!0),p({type:"success",message:"Ticket reserved! Please complete payment below."});const C=await B.getAvailability().catch(()=>null);C&&P(C)}catch(N){const C=N?.response?.data?.message||N?.message||"Failed to request ticket. Please try again.";N?.response?.data?.availability&&P(N.response.data.availability),p({type:"error",message:C})}},M=async v=>{if(!a?.id){p({type:"error",message:"Ticket session expired. Please retry."});return}try{await b(a.id,v),p({type:"success",message:`Payment of PKR ${l.total.toLocaleString()} successful! Your QR pass is ready.`}),c(`/tickets/view/${a.id}`)}catch(N){const C=N?.response?.data?.message||N?.message||"Failed to process card payment.";p({type:"error",message:C})}},O=async v=>{if(!a?.id){p({type:"error",message:"Ticket session expired. Please retry."});return}try{await i(a.id,v),p({type:"success",message:"JazzCash payment successful! Your QR pass is ready."}),c(`/tickets/view/${a.id}`)}catch(N){const C=N?.response?.data?.message||N?.message||"Failed to process JazzCash payment.";p({type:"error",message:C})}},o=async v=>{if(!a?.id){p({type:"error",message:"Ticket session expired. Please retry."});return}try{await g(a.id,v),p({type:"success",message:"Easypaisa payment successful! Your QR pass is ready."}),c(`/tickets/view/${a.id}`)}catch(N){const C=N?.response?.data?.message||N?.message||"Failed to process Easypaisa payment.";p({type:"error",message:C})}},w=async()=>{if(!a?.id){p({type:"error",message:"Ticket session expired. Please retry."});return}try{await t(a.id),S(!0)}catch(v){p({type:"error",message:v?.response?.data?.message||v?.message||"Failed to initiate PayFast session."})}},F=async v=>{if(a?.id)try{await f(a.id,v),S(!1),p({type:"success",message:`PayFast payment of PKR ${l.total.toLocaleString()} confirmed! Official QR pass generated.`}),c(`/tickets/view/${a.id}?payment=success`)}catch(N){p({type:"error",message:N?.response?.data?.message||N?.message||"Failed to verify PayFast transaction."})}};return e.jsxs("main",{className:"ticket-portal-clean",children:[e.jsxs("section",{className:"ticket-clean-hero",children:[e.jsx(X,{nodeColor:"#EC4899",lineColor:"236, 72, 153",secondaryColor:"255, 90, 31",maxDistance:140,speed:.5}),e.jsx("div",{className:"hero-glow-blob"}),e.jsxs("div",{className:"ticket-clean-hero-content",children:[e.jsx("span",{className:"hero-eyebrow",children:"OZILLA FEST 2026"}),e.jsx("h1",{className:"hero-title",children:"Book Your Festival Passes"}),e.jsx("p",{className:"hero-subtitle",children:"Instant digital QR pass with access to 4 live stages, headline artists, and VIP amenities in Lahore."}),e.jsxs("div",{className:"hero-tags",children:[e.jsx("span",{children:"📅 Nov 01, 2026"}),e.jsx("span",{children:"📍 Lahore"}),e.jsx("span",{children:"⚡ Instant QR Pass"})]})]})]}),e.jsxs("section",{className:"ticket-clean-shell",children:[x&&e.jsx(W,{type:x.type,message:x.message,onClose:()=>p(null)}),e.jsx("div",{className:"ticket-clean-stepper",children:ne.map((v,N)=>e.jsxs("div",{className:`step-item ${N+1<=T?"is-active":""}`,children:[e.jsx("span",{className:"step-num",children:N+1}),e.jsx("span",{className:"step-text",children:v})]},v))}),R?e.jsxs("div",{className:"ticket-sold-out-box",style:{background:"linear-gradient(135deg, rgba(239, 68, 68, 0.15) 0%, rgba(30, 10, 15, 0.95) 100%)",border:"2px solid #ef4444",borderRadius:"24px",padding:"48px 24px",textAlign:"center",boxShadow:"0 20px 50px rgba(239, 68, 68, 0.25)",margin:"20px 0 40px"},children:[e.jsx("div",{style:{display:"inline-flex",alignItems:"center",gap:"8px",background:"#ef4444",color:"#ffffff",padding:"6px 16px",borderRadius:"9999px",fontSize:"13px",fontWeight:"800",letterSpacing:"2px",textTransform:"uppercase",marginBottom:"16px"},children:"🔒 PORTAL LOCKED"}),e.jsx("h2",{style:{fontSize:"clamp(26px, 5vw, 40px)",fontWeight:"900",color:"#ffffff",margin:"0 0 12px"},children:"Tickets Are Officially Sold Out!"}),e.jsxs("p",{style:{color:"#d1d5db",maxWidth:"600px",margin:"0 auto 24px",fontSize:"16px",lineHeight:"1.6"},children:["All General, VIP, and Premium passes for ",e.jsx("strong",{children:"OZILLA FEST 2026"})," have been fully booked. The ticket booking system is locked to prevent overbooking."]}),e.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:"14px",flexWrap:"wrap"},children:[e.jsx("button",{type:"button",onClick:()=>c("/#sponsorship"),style:{background:"linear-gradient(135deg, #d4af37 0%, #aa8420 100%)",color:"#111827",padding:"12px 28px",borderRadius:"12px",fontWeight:"700",fontSize:"14px",border:"none",cursor:"pointer"},children:"Inquire Corporate / Sponsor Passes"}),e.jsx("button",{type:"button",onClick:()=>c("/schedule"),style:{background:"rgba(255,255,255,0.08)",color:"#ffffff",border:"1px solid rgba(255,255,255,0.2)",padding:"12px 24px",borderRadius:"12px",fontWeight:"600",fontSize:"14px",cursor:"pointer"},children:"View Festival Schedule"})]})]}):s?e.jsxs("div",{className:"ticket-main-grid",children:[e.jsxs("div",{className:"ticket-form-card",children:[e.jsxs("div",{className:"ticket-form-header",children:[e.jsx("h2",{children:d?"Payment Checkout":"Pass Reservation"}),e.jsx("span",{className:"ticket-badge-pill",children:"Official Portal"})]}),d?e.jsxs("div",{className:"ticket-payment-wrapper",children:[e.jsx(ie,{activeMethod:z,onSelectMethod:u}),z==="payfast"&&e.jsx(re,{amount:l.total,onProceed:w,loading:y,onBack:()=>j(!1)}),z==="card"&&e.jsx(Z,{amount:l.total,onSubmit:M,loading:y,onBack:()=>j(!1)}),z==="jazzcash"&&e.jsx(ee,{amount:l.total,onSubmit:O,loading:y,onBack:()=>j(!1)}),z==="easypaisa"&&e.jsx(te,{amount:l.total,onSubmit:o,loading:y,onBack:()=>j(!1)})]}):e.jsx(Y,{onSubmit:I,loading:y,profileDefaults:s,onBookingChange:h,availability:n,availabilityLoading:A})]}),e.jsx(se,{isOpen:E,onClose:()=>S(!1),ticket:a,amount:l.total,onComplete:F}),e.jsx("aside",{className:"ticket-sidebar",children:e.jsxs("div",{className:"ticket-sidebar-summary",children:[e.jsx("h3",{children:"Order Summary"}),e.jsxs("div",{className:"summary-pass-type",children:[e.jsxs("strong",{children:[l.ticketType," Pass"]}),e.jsx("span",{children:l.day})]}),e.jsxs("div",{className:"summary-rows",children:[e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Quantity"}),e.jsx("strong",{children:l.quantity})]}),e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Price"}),e.jsxs("strong",{children:["PKR ",l.subtotal.toLocaleString()]})]}),e.jsxs("div",{className:"summary-row",children:[e.jsx("span",{children:"Fee"}),e.jsx("strong",{style:{color:"#10b981"},children:"Free (PKR 0)"})]}),l.discount>0&&e.jsxs("div",{className:"summary-row summary-discount",children:[e.jsx("span",{children:"Discount"}),e.jsxs("strong",{children:["- PKR ",l.discount.toLocaleString()]})]})]}),e.jsxs("div",{className:"summary-total-row",children:[e.jsx("span",{children:"Grand Total"}),e.jsxs("strong",{children:["PKR ",l.total.toLocaleString()]})]}),e.jsx("div",{className:"summary-pass-badge",children:e.jsx("span",{children:"🎟️ Verified Digital QR Pass"})})]})})]}):e.jsxs("div",{className:"ticket-auth-prompt",children:[e.jsxs("div",{children:[e.jsx("h2",{children:"Sign in to Book Passes"}),e.jsx("p",{children:"Secure ticket purchasing requires an account for verified QR pass generation."})]}),e.jsx("button",{type:"button",onClick:L,className:"ticket-primary-button",children:"Sign In to Continue →"})]})]}),e.jsx("style",{children:`
        .ticket-portal-clean {
          position: relative;
          min-height: 100vh;
          padding: 0 0 3rem;
